...
window.SCENES = {
  ...
  BX_C2: { title:'JAB SPAR', phase:3, sub:'1/3',
    ...
    say:'Jab when the target shows', dots:10, dotsOn:8, combos:['Jab!'] },
  BX_C3: { title:'COMBINATION', phase:3, sub:'2/3',
    coach:{num:'—',unit:'Combo'}, you:{num:'2',unit:'Combo'},
    say:'Keep the rhythm — jab, jab, hook', dots:10, dotsOn:9, combos:['2x Combo!'] },
  BX_C4: { title:'COOL DOWN', phase:3, sub:'3/3',
    coach:{num:'—',unit:''}, you:{num:'—',unit:''},
    say:'Breathe, drop your guard. Well done', dots:10, dotsOn:10, combos:[] },
};
