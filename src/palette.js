...
// ⚠ 키 이름이 통념과 반대다 — 고치지 말고 **읽을 때 주의할 것**(전 코드베이스가 이 키를 쓴다).
//   유저가 말하는 '주황'  = 이 파일의 `coral` (#FE6E3C, 휘도 147 — 진한 쪽)
//   유저가 말하는 '코랄'  = 이 파일의 `sand`  (#FEC389, 휘도 206 — 연한 쪽)
//   이걸 뒤집어 읽고 벽 인물 배분을 정반대로 맞춘 사고가 있었다(07-31).
export const PAL = {
  red:   '#FA3030',   // NEWTON RED · CMYK 0/90/78/0 · rgb(250,48,48)  · 색상각 0°  · 채도 81%
  coral: '#FE6E3C',   // 진한 주황  · CMYK 0/71/74/0 · rgb(254,110,60) · 색상각 16° · 채도 76% · 휘도 147
  sand:  '#FEC389',   // 연한 코랄  · CMYK 0/32/48/0 · rgb(254,195,137)· 색상각 30° · 채도 46% · 휘도 206
