...
void main(){
  ...
  [1, 2, 3].forEach(n => {
    ...
    b.style.cssText = 'width:30px;height:30px;border-radius:8px;border:1px solid #444;background:' + (n === 1 ? '#fa3030' : '#1c1f26') + ';color:#eee;cursor:pointer;font:700 13px sans-serif';
