...
void main(){
  ...
  const COACH_CFG = {
    ...
    READY:    { src: 'ready-view/assets/run/runner_green.mp4', cropOff: 0.0, cropScale: 1.0, w: 0.360, h: 0.482, fwd: 0.04, ph: 0.76 },   // 인물 판 상단을 캔버스 y≈980 으로 — 'Pace On'(786) 아래 190px 여유(유저 #113)
    BK_READY: { src: 'ready-view/assets/bk/dribble_green.mp4', cropOff: 0.0, cropScale: 1.0, w: 0.360, h: 0.482, fwd: 0.04, ph: 0.76 },   // 러닝과 동일 규격
