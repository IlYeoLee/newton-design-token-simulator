...
export const FXP = {
  ...
  // detail 0.42 → 0.16: 좁은 블러를 덜 섞어 넓은 블러로 간다 = 은은한 블러(유저 레퍼런스).
  //   실오라기·압축 노이즈가 그대로 보이던 것이 이 값이었다.
  // blur 0 → 1.0: 엣지 블러. 셰이더가 이 값을 읽게 되면서 처음으로 실제 손잡이가 됐다.
  person: { blur: 1.0, glow: 0, flow: 0, decay: 0, detail: 0.16, sweep: 0, depth: 0.34, grain: 0, tone: 1, ink: 0.30, inkT: 0.42 },
