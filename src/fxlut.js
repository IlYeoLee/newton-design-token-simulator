...
export const FXP = {
  ...
  person: { form: 1, blur: 0, glow: 0, flow: 0, decay: 0, detail: 0.42, sweep: 0, depth: 0.34, grain: 0, tone: 1, ink: 0.30, inkT: 0.42,
    ...
    // ★ 하드코딩 승인(유저 08-07) — 랩에서 고른 값을 기본으로 굽는다. 강조가 기본으로 켜져 있다.
    //   몸통은 t≈0(흰색)에 붙이고 강조만 뜨겁게 = 대비를 한쪽만 움직여 만든다.
    emph: { k: 0.95, t: 0.38, y0: 0, y1: 0.45, soft: 0.18 },
    // 몸통 대역 — 0.30/1.00 = 종전(전부 주황). 낮고 좁게 두면 흰-코랄로 간다.
    bandLo: 0.00, bandHi: 0.06,
