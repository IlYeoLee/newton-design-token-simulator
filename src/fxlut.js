...
export const FXP = {
  ...
  // form = 레퍼런스 규약(깊이 기반 밝기). 0 = 현행. 랩에서 켜고 비교한다 — public/refs/person 참조.
  person: { form: 0, blur: 0, glow: 0, flow: 0, decay: 0, detail: 0.42, sweep: 0, depth: 0.34, grain: 0, tone: 1, ink: 0.30, inkT: 0.42 },
