...
export const COACH_CFG = {
  ...
  // ★ 08-10 유저: 농구 스트레칭 인물이 너무 작다. 실측으로도 **전 스테이지 최소**였다 —
  //   0.512m(기준 93%)인데 같은 농구 워밍업 짝인 BK_A2 는 0.765m(139%)라, 둘이 나란히
  //   1.5배 차이로 읽혔다. 종횡비는 유지한 채 같은 배율(×1.494)로 올려 BK_A2 와 맞춘다.
  //   기준 0.55m 를 벗어나는 건 BK_A2·A3 와 같은 이유(유저 확인분)다. 겹치면 fwd 로 내릴 것.
  BK_A1: { src: 'ready-view/assets/bk_sidebend_pp.webm', cropOff: 0.0, cropScale: 1.0, w: 0.926, h: 0.956, fwd: -0.30, ph: 0.80, tone: 0.045 },   // 옆구리 스트레치
