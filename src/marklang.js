...
export const STAGE_TIME = {
  ...
  A2: { hold: 3.0, watch: 5.8, reps: 2 },    // 종아리 늘리기 — 홀드 3.0초 · 시범 5.8초 · 2렙(발 교대)
  //   ★ 2.15 는 레퍼런스 클립의 홀드→홀드 간격이었다. 유저가 화면에서 보고 되돌렸다(08-07):
  //     "오른발 구부리고 왼발 쭉 3.몇초, 다음 다리로 넘어와서 3초". 여유 있게 3.0 으로 두고
  //     유저가 편집에서 자른다. 1렙 = 3.0+0.35+1.25+0.55 = 5.15s · 전체 5.8+2×5.15 = 16.1s.
};
