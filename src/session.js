...
// ★ 좌표는 손대지 않는다(유저 08-11 확정: "니가 임의로 하지 마"). 아래 표가 정본이고,
//   룩시스템(marks.html)의 발자국 경로가 이 표에서 나온다 — 바꾸려면 유저와 룩시스템에서 정한다.
//   (08-10 523925a 재저작 → 08-11 실측 재생성 두 번 모두 유저가 기각, 이 표로 원복했다.
//    실측 도구는 scripts/_probe_sbfeet.mjs · _verify_sbpose_sync.mjs 로 남아 있다.)
