...
export const STAGES = {
  running: [
    ...
    { id:'P2', dur:20, live:true, label:'훈련 2 · 스트라이드 — 10초 가속 × 반복',
    ...
    { id:'P3', dur:24, live:true, label:'훈련 3 · 인터벌 — 30초 전력 · 회복 반복',
    ...
    { id:'P4', dur:13, live:true, label:'훈련 4 · 쓰레숄드 — 젖산 역치 페이스 유지',
