...
export const SB_POSE = [
  { t: 1.05, L: [-0.04, 0.80], R: [0.35, 1.00] },                        // 시작 = 좁은 스탠스, 앞줄(전진 자세)
  { t: 1.47, L: [-0.04, 0.80, 1], R: [-0.45, 0.28] },                    // ① 오른발 크로스 — 왼발 왼쪽으로 딛으며 살짝 뒤 · 왼발은 앞볼로 민다
  { t: 1.70, L: [-0.04, 0.80], R: [-0.40, -1.00, 0, 'slide'] },          // ② 오른발+몸이 뒤로 '싹' — 세로축 전체(실측 1.3m 등비)
  { t: 2.10, L: [-0.04, 0.80], R: [-0.07, 0.99] },                       // ③ 오른발을 싹 끌어와 모음(역재생 구간)
  { t: 2.20, L: [-0.04, 0.80], R: [0.02, 1.00] },                        //     그 자세로 유지(구간 끝)
];
