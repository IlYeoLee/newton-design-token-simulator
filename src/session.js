...
export const STAGES = {
  running: [
    ...
    { id:'P1', dur:8, live:true, label:'훈련 1 · 이지 런 — 편한 페이스로 몸 깨우기',
      ...
      loop:1, phases:[{ n:'Relaxed · conversational pace', c:0.9, i:0.32, f:1 }] },
    { id:'P2', dur:9, live:true, label:'훈련 2 · 스트라이드 — 10초 가속 × 반복',
      desc:'80% 힘으로 10초간 시원하게 가속했다가 자연스럽게 감속해요. 다리 회전 속도와 러닝 폼을 다듬는 훈련이에요.',
      voice:['션','스트라이드 갑니다! 10초만 경쾌하게 가속했다가 스르륵 풀어요. 발을 빠르게 굴리는 느낌!'], wear:'SAFE 착지 안정화',
      loop:2, phases:[{ n:'ACCELERATE ↑', c:1.4, i:0.92, f:0.34 }, { n:'TOP SPEED', c:1.22, i:0.7, f:0.22 }, { n:'EASE OFF ↓', c:0.9, i:0.32, f:0.44 }] },
    { id:'P3', dur:10, live:true, label:'훈련 3 · 인터벌 — 30초 전력 · 회복 반복',
      desc:'짧고 강하게 달린 뒤 충분히 회복하기를 반복해요. 심폐 지구력과 스피드를 동시에 끌어올리는 핵심 훈련이에요.',
      voice:['션','인터벌이에요! 30초 전력으로 갔다가, 회복하며 숨 고르기 — 이 반복이 스피드를 만들어요.'], wear:'BOOST 추진 보조',
      loop:2, phases:[{ n:'SPRINT 🔥', c:1.55, i:1.0, f:0.4 }, { n:'RECOVER · catch your breath', c:0.78, i:0.28, f:0.6 }] },
    { id:'P4', dur:9, live:true, label:'훈련 4 · 쓰레숄드 — 젖산 역치 페이스 유지',
      desc:"'약간 벅찬' 페이스를 꾸준히 유지해요. 더 빠른 속도를 더 오래 버티는 능력을 길러 주는, 실력이 붙는 구간이에요.",
      voice:['션','마지막 쓰레숄드! 살짝 힘든 페이스를 그대로 유지해요 — 여기서 진짜 실력이 붙어요.'], wear:'SAFE 착지 안정화',
      loop:1, phases:[{ n:'벅찬 페이스 유지', c:1.12, i:0.72, f:1 }] },
