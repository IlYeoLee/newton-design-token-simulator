...
export const STAGES = {
  running: [
    ...
    { id:'P2', dur:9, live:true, label:'훈련 2 · 스트라이드 — 10초 가속 × 반복',
      ...
      loop:2, phases:[{ n:'ACCELERATE', c:1.4, i:0.92, f:0.34, sec:10 }, { n:'TOP SPEED', c:1.22, i:0.7, f:0.22, sec:6 }, { n:'EASE OFF', c:0.9, i:0.32, f:0.44, sec:14 }] },
    { id:'P3', dur:10, live:true, label:'훈련 3 · 인터벌 — 30초 전력 · 회복 반복',
      ...
      loop:2, phases:[{ n:'SPRINT', c:1.55, i:1.0, f:0.4, sec:30 }, { n:'RECOVER', c:0.78, i:0.28, f:0.6, sec:60 }] },
    { id:'P4', dur:9, live:true, label:'훈련 4 · 쓰레숄드 — 젖산 역치 페이스 유지',
      ...
      loop:1, phases:[{ n:'HOLD PACE', c:1.12, i:0.72, f:1, sec:300 }] },
