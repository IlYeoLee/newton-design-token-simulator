...
export const STAGES = {
  running: [
    ...
    { id:'P1', dur:7, live:true, label:'훈련 1 · 이지 런 — 편한 페이스로 몸 깨우기',
      desc:'대화할 수 있을 만큼 편안한 속도로 달려요. 본격 훈련 전 워밍업이자, 다음 강도를 위한 회복 러닝이에요.',
      voice:['션','먼저 이지 런이에요. 숨이 편안한 속도로 가볍게 — 제 박자에 발만 살살 맞춰요.'], wear:'낮은 강도 보조 시작', cadence:0.9 },
    { id:'P2', dur:7, live:true, label:'훈련 2 · 스트라이드 — 10초 가속 × 반복',
      desc:'80% 힘으로 10초간 시원하게 가속했다가 자연스럽게 감속해요. 다리 회전 속도와 러닝 폼을 다듬는 훈련이에요.',
      voice:['션','스트라이드 갑니다! 10초만 경쾌하게 가속했다가 스르륵 풀어요. 발을 빠르게 굴리는 느낌!'], wear:'SAFE 착지 안정화', cadence:1.12 },
    { id:'P3', dur:7, live:true, label:'훈련 3 · 인터벌 — 30초 전력 · 회복 반복',
      desc:'짧고 강하게 달린 뒤 충분히 회복하기를 반복해요. 심폐 지구력과 스피드를 동시에 끌어올리는 핵심 훈련이에요.',
      voice:['션','인터벌이에요! 30초 전력으로 갔다가, 회복하며 숨 고르기 — 이 반복이 스피드를 만들어요.'], wear:'BOOST 추진 보조', cadence:1.22 },
    { id:'P4', dur:7, live:true, label:'훈련 4 · 쓰레숄드 — 젖산 역치 페이스 유지',
      desc:"'약간 벅찬' 페이스를 꾸준히 유지해요. 더 빠른 속도를 더 오래 버티는 능력을 길러 주는, 실력이 붙는 구간이에요.",
      voice:['션','마지막 쓰레숄드! 살짝 힘든 페이스를 그대로 유지해요 — 여기서 진짜 실력이 붙어요.'], wear:'SAFE 착지 안정화', cadence:1.08 },
