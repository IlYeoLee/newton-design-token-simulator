...
#define C_RED   ${K(O.red)}
#define C_CORAL ${K(O.coral)}
#define C_SAND  ${K(O.sand)}
#define C_ICE   ${K(O.prism)}
#define C_CREAM C_SAND
#define C_GRAYF ${K(H.hi)}
#define C_GRAYL ${K(H.lo)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function ut(t,o,e,c){t.lineWidth=4*o;const s=c.arrow;s.line==="dash"?t.setLineDash([12*o*s.gap,10*s.gap]):s.line==="dot"?(t.setLineDash([.5,12*s.gap]),t.lineCap="round",t.lineWidth=5*o):t.setLineDash([]),e!=null&&s.line!=="solid"&&s.line!=="taper"&&(t.lineDashOffset=-e*40*s.speed)}function yt(t,o,e,c,s,a={}){const i=s.lut,r=s.arrow||{},u=r.w??1,m=r.speed??1,d=r.glow??1,p=a.pulse??1,l=e/256,h=o/2,f=c*.9*m%1,v=a.prog!=null?Math.max(0,Math.min(1,a.prog)):Math.min(1,f/.55),T=a.prog!=null?1:f>.88?(1-f)/.12:1;t.clearRect(0,0,o,e);const C=T*(.45+.55*p),n=e-24*l,M=58*l,S=n+(M-n)*v,b=(R,D)=>i(R).replace("rgb(","rgba(").replace(")",`,${D.toFixed(3)})`),w=1.1*l*u,x=13*l*u,k=t.createLinearGradient(0,n,0,S);if(k.addColorStop(0,b(.55,0)),k.addColorStop(.1,b(.64,.45*C)),k.addColorStop(.32,b(.76,.85*C)),k.addColorStop(.62,b(.88,.98*C)),k.addColorStop(1,b(.97,C)),t.globalAlpha=1,t.fillStyle=k,t.beginPath(),t.moveTo(h-w/2,n),t.lineTo(h+w/2,n),t.lineTo(h+x/2,S),t.lineTo(h-x/2,S),t.closePath(),t.fill(),t.globalAlpha=C,v>.28&&!a.noTip){const R=34*l*(.7+.3*u),D=Math.min(1,(v-.28)/.22)*C,I=S+R*.3;t.globalAlpha=D;const A={color:i(.95),glowColor:i(.85),glow:12*d};s.glyph&&(s.glyph(t,"LIFT_TIP",h,I,R,A)||s.glyph(t,"TIP_TRI",h,I,R*.93,A))||(t.strokeStyle=i(.95),t.lineWidth=13*l*u,t.lineCap="round",t.lineJoin="round",t.shadowColor=i(.9),t.shadowBlur=18*l*d,t.beginPath(),t.moveTo(h-26*l,I+14*l),t.lineTo(h,I-16*l),t.lineTo(h+26*l,I+14*l),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function St(t,o,e,c,s,a,i={}){const r=a.lut,u=a.arrow||{},m=u.w??1,d=u.glow??1,p=e/256;t.clearRect(0,0,o,e);const l=c.map(([n,M])=>[n*o,M*e]);if(l.length<2)return;const h=48,f=[],v=n=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*n,l[0][1]+(l[1][1]-l[0][1])*n];const M=n*(l.length-1),S=Math.min(l.length-2,Math.floor(M)),b=M-S,w=l[Math.max(0,S-1)],x=l[S],k=l[S+1],R=l[Math.min(l.length-1,S+2)],D=(I,A,_,F)=>.5*(2*A+(-I+_)*b+(2*I-5*A+4*_-F)*b*b+(-I+3*A-3*_+F)*b*b*b);return[D(w[0],x[0],k[0],R[0]),D(w[1],x[1],k[1],R[1])]};for(let n=0;n<=h;n++)f.push(v(n/h));const T=Math.max(0,Math.min(1,i.prog!=null?i.prog:s*.55%1)),C=Math.max(1,Math.round(h*T));t.lineCap="round";for(let n=1;n<=C;n++){const M=n/C;t.globalAlpha=Math.pow(M,1.5),t.strokeStyle=r(.45+.5*M),t.lineWidth=(1.6+3.2*M)*p*m,t.beginPath(),t.moveTo(f[n-1][0],f[n-1][1]),t.lineTo(f[n][0],f[n][1]),t.stroke()}if(T>.25){const n=f[C][0],M=f[C][1],S=f[Math.max(0,C-2)][0],b=f[Math.max(0,C-2)][1],w=Math.atan2(M-b,n-S)+Math.PI/2,x=30*p*(.7+.3*m);t.save(),t.translate(n,M),t.rotate(w),t.globalAlpha=Math.min(1,(T-.25)/.2);const k={color:r(.95),glowColor:r(.85),glow:12*d};a.glyph&&(a.glyph(t,"LIFT_TIP",0,0,x,k)||a.glyph(t,"TIP_TRI",0,0,x*.93,k))||(t.strokeStyle=r(.95),t.lineWidth=9*p*m,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*p,12*p),t.lineTo(0,-14*p),t.lineTo(18*p,12*p),t.stroke()),t.restore()}t.globalAlpha=1}function st(t,o,e,c,s,a){s=s||{};const i=a.lut,r=s.style||a.arrow.line,u=!!s.closed,m=[0];for(let h=1;h<o.length;h++)m.push(m[h-1]+Math.hypot(o[h][0]-o[h-1][0],o[h][1]-o[h-1][1]));const d=m[m.length-1]||1,p=h=>{h=(h%d+d)%d;let f=1;for(;f<m.length-1&&m[f]<h;)f++;const v=(h-m[f-1])/Math.max(1e-4,m[f]-m[f-1]);return[o[f-1][0]+(o[f][0]-o[f-1][0])*v,o[f-1][1]+(o[f][1]-o[f-1][1])*v,Math.atan2(o[f][1]-o[f-1][1],o[f][0]-o[f-1][0])]},l=a.arrow;if(r==="chevron"){const h=(26*c+8)*l.gap,f=Math.max(2,Math.floor(d/h));t.shadowColor=i(Math.min(1,l.heat+.2)),t.shadowBlur=8*c*l.glow;for(let v=0;v<f;v++){const T=v*h+e*42*l.speed%h;if(!u&&T>d-4)continue;const[C,n,M]=p(T),S=7.5*c,b=8.5*c,w=.45+.4*Math.sin(T/d*6.283-e*2.2*l.speed);t.strokeStyle=i(l.heat-.05+w*.3),t.lineWidth=3.2*c,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(C,n),t.rotate(M),t.beginPath(),t.moveTo(-b*.5,-S),t.lineTo(b*.5,0),t.lineTo(-b*.5,S),t.stroke(),t.restore()}return!0}if(r==="comet"){const h=e*.35*l.speed%1*d,f=d*l.tail,v=Math.max(24,o.length*2);t.lineCap="round";for(let n=0;n<v;n++){const M=h-n/v*f,S=h-(n+1)/v*f;if(!u&&S<0)break;const b=1-n/v,[w,x]=p(M),[k,R]=p(S);!u&&Math.hypot(k-w,R-x)>d*.4||(t.globalAlpha=Math.pow(b,1.6),t.strokeStyle=i(Math.max(.05,l.heat-.2)+b*.55),t.lineWidth=(1.5+b*4.5)*c,b>.72?(t.shadowColor=i(Math.min(1,l.heat+.3)),t.shadowBlur=b*12*c*l.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(w,x),t.lineTo(k,R),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[T,C]=p(h);return t.fillStyle=rgba(H.ink,.95),t.shadowColor=i(.9),t.shadowBlur=16*c,t.beginPath(),t.arc(T,C,2.6*c,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=s.color||i(l.heat),t.shadowColor=i(Math.min(1,l.heat+.15)),t.shadowBlur=(s.glow??8)*c*l.glow,r==="taper")for(let h=1;h<o.length;h++)t.lineWidth=(.5+h/o.length*4.5)*c,t.beginPath(),t.moveTo(o[h-1][0],o[h-1][1]),t.lineTo(o[h][0],o[h][1]),t.stroke();else ut(t,c,e,a),t.beginPath(),o.forEach(([h,f],v)=>v?t.lineTo(h,f):t.moveTo(h,f)),u&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function vt(t,o,e,c,s,a){const i=13*c.halo,r=a.lut;t.clearRect(0,0,o,o),t.lineJoin="round";const u=o/220,m=o/2,d=18*e.round*u,p=40*u,l=48*u,h=o-80*u,f=o-96*u,v=[],T=(n,M,S,b)=>{for(let w=0;w<=1;w+=.12)v.push([n+(S-n)*w,M+(b-M)*w])};T(p+d,l,p+h-d,l),T(p+h,l+d,p+h,l+f-d),T(p+h-d,l+f,p+d,l+f),T(p,l+f-d,p,l+d),t.shadowColor=r(.6),t.shadowBlur=i*.8;const C=4*a.arrow.w*u;if(a.arrow.line==="solid"?(t.setLineDash([10*e.dash*u,8*u]),t.lineDashOffset=-s*22*u,t.strokeStyle=r(.45),t.lineWidth=C,t.beginPath(),t.roundRect(p,l,h,f,d),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):st(t,v,s,a.arrow.w*u,{color:r(.45),closed:!0},a),e.prog!=null&&e.prog>.001){const n=[],M=(A,_,F,P,E)=>{for(let q=1;q<=E;q++)n.push([A+(F-A)*q/E,_+(P-_)*q/E])},S=(A,_,F,P,E)=>{for(let q=1;q<=E;q++){const W=F+(P-F)*q/E;n.push([A+d*Math.cos(W),_+d*Math.sin(W)])}},b=Math.PI/2,w=p+h,x=l+f,k=p+h/2;n.push([k,l]),M(k,l,w-d,l,8),S(w-d,l+d,-b,0,6),M(w,l+d,w,x-d,10),S(w-d,x-d,0,b,6),M(w-d,x,p+d,x,14),S(p+d,x-d,b,Math.PI,6),M(p,x-d,p,l+d,10),S(p+d,l+d,Math.PI,Math.PI+b,6),M(p+d,l,k,l,8);let R=0;for(let A=1;A<n.length;A++)R+=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);const D=R*Math.min(1,e.prog);t.save(),t.setLineDash([10*e.dash*u,8*u]),t.lineDashOffset=-(h/2-d)-s*22*u,t.strokeStyle=r(.9),t.lineWidth=C*1.3,t.lineCap="round",t.shadowColor=r(.92),t.shadowBlur=i*1.3,t.beginPath(),t.moveTo(n[0][0],n[0][1]);let I=0;for(let A=1;A<n.length&&I<D;A++){const _=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);if(I+_<=D)t.lineTo(n[A][0],n[A][1]),I+=_;else{const F=(D-I)/_;t.lineTo(n[A-1][0]+(n[A][0]-n[A-1][0])*F,n[A-1][1]+(n[A][1]-n[A-1][1])*F),I=D}}t.stroke(),t.setLineDash([]),t.restore()}e.feet>.05&&a.foot&&(a.foot(t,!1,m-16*e.feet*u,m+6*u,26*e.feet*u),a.foot(t,!0,m+16*e.feet*u,m+6*u,26*e.feet*u)),t.shadowBlur=0}function kt(t,o,e,c,s,a,i,r){const u=13*c.halo,m=4*a.arrow.w*(o/220),d=a.lut;t.clearRect(0,0,o,o),t.lineJoin="round";const p=o/220,l=i||[[45*p,130*p],[110*p,60*p],[175*p,110*p]],h=r??s*.5%1,f=Math.min(1,h*1.25)*(l.length-1),v=Math.min(l.length-1,Math.floor(f+.35));t.shadowColor=d(.7),t.shadowBlur=u;const T=[[l[0][0],l[0][1]]];for(let C=1;C<=l.length-1;C++){const n=Math.max(0,Math.min(1,f-(C-1)));if(n<=0)break;T.push([l[C-1][0]+(l[C][0]-l[C-1][0])*n,l[C-1][1]+(l[C][1]-l[C-1][1])*n])}T.length>1&&st(t,T,s,a.arrow.w*p,{color:d(.62)},a),t.setLineDash([4*p,7*p]),t.lineDashOffset=0,t.globalAlpha=.3,t.strokeStyle=d(.45),t.lineWidth=m,t.beginPath(),l.forEach(([C,n],M)=>M?t.lineTo(C,n):t.moveTo(C,n)),t.stroke(),t.globalAlpha=1,t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,l.forEach(([C,n],M)=>{const S=M===v,b=S?1+Math.sin(s*6)*.14:1;t.strokeStyle=d(S?.8:.45),t.lineWidth=m*(S?1.3:.9),t.shadowBlur=S?u*1.6:u*.6,t.beginPath(),t.arc(C,n,12*e.node*b*p,0,Math.PI*2),t.stroke(),a.num&&(t.globalAlpha=M<=v?1:.45,a.num(t,String(M+1),C,n,16*e.numS*b*p,Math.round(14*e.numS*p)),t.globalAlpha=1)}),t.shadowBlur=0}function _t(t,o,e,c,s,a,i){const r=a.lut,u=13*c.halo,m=o/220,d=o/2,p=a.arrow&&a.arrow.w||1,l=(w,x)=>r(w).replace("rgb(","rgba(").replace(")",`,${x})`);t.clearRect(0,0,o,o),t.lineJoin="round",t.lineCap="round";const h=(e.r!=null?e.r:.42)*o,f=h*(e.rt!=null?e.rt:.36),v=3.4*p*m,T=i!=null?Math.max(0,Math.min(1,i)):s*(e.tempo||.6)%1,C=Math.pow(T,1.6),n=Math.max(0,(T-.9)/.1);t.save(),t.translate(d,d);const M=(w,x,k,R=1)=>{if(w<=.6)return;const D=v*2.6*R,I=Math.max(.1,w-D),A=w+D,_=t.createRadialGradient(0,0,I,0,0,A);_.addColorStop(0,l(x-.05,0)),_.addColorStop(.5,l(x,k*.85)),_.addColorStop(1,l(x-.05,0)),t.globalAlpha=1,t.fillStyle=_,t.shadowBlur=0,t.beginPath(),t.arc(0,0,A,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,k*1.1),t.lineWidth=v*.85,t.strokeStyle=r(Math.min(.98,x+.12)),t.shadowColor=r(.88),t.shadowBlur=u*.6,t.beginPath(),t.arc(0,0,w,0,Math.PI*2),t.stroke(),t.shadowBlur=0},S=t.createRadialGradient(0,0,0,0,0,f*1.08);S.addColorStop(0,l(.6,.1+.18*n)),S.addColorStop(.65,l(.5,.05+.08*n)),S.addColorStop(1,l(.5,0)),t.globalAlpha=1,t.fillStyle=S,t.beginPath(),t.arc(0,0,f*1.08,0,Math.PI*2),t.fill();const b=1+.02*Math.sin(s*2.6);M(f*b,.55+.4*n,.5+.45*n,.9);for(let w=2;w>=0;w--){const x=Math.pow(Math.max(0,T-w*.05),1.6),k=h-(h-f)*x,R=w===0?.6+.4*C:.18/w*(1-n);M(k,.55+.4*C,R*(1-n*.45),1.15-.35*C)}n>.01&&M(f*(1+1.4*n),.9,(1-n)*.8,1.1),t.globalAlpha=.6+.3*n,t.shadowColor=r(.85),t.shadowBlur=u*(.9+n),t.fillStyle=r(.62+.3*n),t.beginPath(),t.arc(0,0,v*.85+3*m*n,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function Tt(t,o,e,c,s,a,i,r){const u=a.lut,m=13*c.halo,d=o/220,p=o/2,l=a.arrow&&a.arrow.w||1,h=l*d,f=(y,L)=>u(y).replace("rgb(","rgba(").replace(")",","+L+")");t.clearRect(0,0,o,o),t.lineJoin="round",t.lineCap="round";const v=o*.42*(e.spread!=null?e.spread:1),C=(r||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([y,L])=>[p+y*v,p+L*v]),n=80,M=[];for(let y=0;y<=n;y++){const L=y/n*(C.length-1),B=Math.min(C.length-2,Math.floor(L)),G=L-B,U=C[Math.max(0,B-1)],$=C[B],N=C[B+1],V=C[Math.min(C.length-1,B+2)],g=(j,J,X,tt)=>.5*(2*J+(-j+X)*G+(2*j-5*J+4*X-tt)*G*G+(-j+3*J-3*X+tt)*G*G*G);M.push([g(U[0],$[0],N[0],V[0]),g(U[1],$[1],N[1],V[1])])}const S=y=>{const L=Math.max(0,Math.min(n,y*n)),B=Math.floor(L),G=L-B,U=M[B],$=M[Math.min(n,B+1)];return[U[0]+($[0]-U[0])*G,U[1]+($[1]-U[1])*G]},b=.68;let w,x,k;if(i!=null)w=Math.max(0,Math.min(1,i)),x=1,k=0;else{const y=s*(e.tempo||.42)%1;if(y<b)w=y/b,x=1,k=0;else{const L=(y-b)/(1-b);w=1,x=1-L*L,k=L}}if(x<=.012)return;const R=w*w*w*(w*(6*w-15)+10),D=Math.min(1,16*w*w*(1-w)*(1-w));e.taper!=null&&e.taper;const I=.36*(e.tail!=null?e.tail:1),A=e.width!=null?e.width:1;{const y=t.createLinearGradient(M[0][0],M[0][1],M[n][0],M[n][1]);y.addColorStop(0,f(.46,0)),y.addColorStop(.3,f(.46,.03*x)),y.addColorStop(.8,f(.46,.045*x)),y.addColorStop(1,f(.46,0)),t.globalAlpha=1,t.strokeStyle=y,t.lineWidth=9*h,t.shadowColor=u(.6),t.shadowBlur=m*2,t.beginPath(),M.forEach(([L,B],G)=>G?t.lineTo(L,B):t.moveTo(L,B)),t.stroke(),t.shadowBlur=0}const _=40,F=Math.max(0,R-I*(1-k)),P=[];for(let y=0;y<=_;y++)P.push(S(F+(R-F)*(y/_)));const E=()=>{t.beginPath(),P.forEach(([y,L],B)=>B?t.lineTo(y,L):t.moveTo(y,L)),t.stroke()},q=()=>{const y=t.createLinearGradient(P[0][0],P[0][1],P[_][0],P[_][1]);return y.addColorStop(0,f(.55,0)),y.addColorStop(.4,f(.56,0)),y.addColorStop(.68,f(.6,.09)),y.addColorStop(.88,f(.64,.24)),y.addColorStop(1,f(.68,.44)),y},W=1+.5*D;t.globalAlpha=x,t.strokeStyle=q(),t.lineWidth=(20+10*D)*h*A,t.shadowColor=u(.72),t.shadowBlur=m*2.2,E(),t.strokeStyle=q(),t.lineWidth=(10+5*D)*h*A,t.shadowBlur=m*1,E(),t.shadowBlur=0;for(let y=1;y<=_;y++){const L=y/_;t.globalAlpha=Math.pow(L,2.2)*.95*x,t.strokeStyle=u(.55+.38*L),t.lineWidth=(1.6+6.5*Math.pow(L,.7))*h*A*W,t.beginPath(),t.moveTo(P[y-1][0],P[y-1][1]),t.lineTo(P[y][0],P[y][1]),t.stroke()}const Z=P[_][0],z=P[_][1];t.globalAlpha=.8*x,t.fillStyle=u(.6),t.shadowColor=u(.8),t.shadowBlur=m*1.6,t.beginPath(),t.arc(Z,z,(9+5*D)*h*A,0,Math.PI*2),t.fill(),t.globalAlpha=x,t.fillStyle=u(.93),t.shadowBlur=m*.6,t.beginPath(),t.arc(Z,z,(3.4+1.8*D)*h*A,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function It(t,o,e,c,s,a,i){const r=a.lut,u=13*c.halo,m=o/220,d=o/2,p=a.arrow&&a.arrow.w||1;t.clearRect(0,0,o,o),t.lineJoin="round",t.lineCap="round";const l=(e.r!=null?e.r:.3)*o,h=e.width!=null?e.width:1,f=4.2*p*m*h,v=e.dir!=null?e.dir:1,T=(e.sweep!=null?e.sweep:.66)*Math.PI*2,C=i!=null?Math.max(0,Math.min(1,i)):s*(e.tempo||.5)%1,n=-Math.PI/2+v*C*Math.PI*2;t.save(),t.translate(d,d),t.globalAlpha=.16,t.lineWidth=f*.7,t.strokeStyle=r(.44),t.shadowColor=r(.6),t.shadowBlur=u*.4,t.beginPath(),t.arc(0,0,l,0,Math.PI*2),t.stroke(),t.shadowBlur=0;const M=16;for(let D=0;D<M;D++){const I=D/(M-1),A=n-v*I*T,_=n-v*(I+1.2/M)*T;t.globalAlpha=(1-I)*.9,t.strokeStyle=r(.55+.35*(1-I)),t.lineWidth=f*(.55+.55*(1-I)),t.shadowColor=r(.8),t.shadowBlur=u*(.4+.5*(1-I)),t.beginPath(),t.arc(0,0,l,Math.min(A,_),Math.max(A,_),!1),t.stroke()}t.shadowBlur=0;const S=Math.cos(n)*l,b=Math.sin(n)*l,w=n+v*Math.PI/2,x=8*m*h;t.save(),t.translate(S,b),t.rotate(w+Math.PI/2),t.globalAlpha=1;const k=3.4*x*(.7+.3*p),R={color:r(.96),glowColor:r(.9),glow:u*1.2};a.glyph&&(a.glyph(t,"LIFT_TIP",0,0,k,R)||a.glyph(t,"TIP_TRI",0,0,k*.93,R))||(t.rotate(-Math.PI/2),t.strokeStyle=r(.96),t.lineWidth=f*.9,t.shadowColor=r(.9),t.shadowBlur=u*1.2,t.beginPath(),t.moveTo(-x,-x*.9),t.lineTo(x*.5,0),t.lineTo(-x,x*.9),t.stroke()),t.restore(),t.globalAlpha=.62,t.shadowColor=r(.75),t.shadowBlur=u*.6,t.fillStyle=r(.6),t.beginPath(),t.arc(0,0,f*.6,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}export{bt as M,H as N,O as P,rt as S,kt as a,Ct as b,_t as c,vt as d,Tt as e,It as f,xt as g,yt as h,ft as i,st as j,pt as k,Mt as l,St as m,wt as n,At as o,it as p,mt as r,ht as s};
