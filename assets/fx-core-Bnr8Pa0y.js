...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(t,a,o,i){t.lineWidth=4*a;const s=i.arrow;s.line==="dash"?t.setLineDash([12*a*s.gap,10*s.gap]):s.line==="dot"?(t.setLineDash([.5,12*s.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(t.lineDashOffset=-o*40*s.speed)}function F0(t,a,o,i,s,l={}){const c=s.lut,r=s.arrow||{},u=r.w??1,m=r.speed??1,f=r.glow??1,p=l.pulse??1,e=o/256,h=a/2,d=i*.9*m%1,C=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,d/.55),v=l.prog!=null?1:d>.88?(1-d)/.12:1;t.clearRect(0,0,a,o);const w=v*(.45+.55*p),n=o-24*e,S=58*e,M=n+(S-n)*C,T=(P,k)=>c(P).replace("rgb(","rgba(").replace(")",`,${k.toFixed(3)})`),x=1.1*e*u,I=13*e*u,R=t.createLinearGradient(0,n,0,M);if(R.addColorStop(0,T(.55,0)),R.addColorStop(.1,T(.64,.45*w)),R.addColorStop(.32,T(.76,.85*w)),R.addColorStop(.62,T(.88,.98*w)),R.addColorStop(1,T(.97,w)),t.globalAlpha=1,t.fillStyle=R,t.beginPath(),t.moveTo(h-x/2,n),t.lineTo(h+x/2,n),t.lineTo(h+I/2,M),t.lineTo(h-I/2,M),t.closePath(),t.fill(),t.globalAlpha=w,C>.28&&!l.noTip){const P=34*e*(.7+.3*u),k=Math.min(1,(C-.28)/.22)*w,_=M+P*.3;t.globalAlpha=k;const A={color:c(.95),glowColor:c(.85),glow:12*f};s.glyph&&(s.glyph(t,"LIFT_TIP",h,_,P,A)||s.glyph(t,"TIP_TRI",h,_,P*.93,A))||(t.strokeStyle=c(.95),t.lineWidth=13*e*u,t.lineCap="round",t.lineJoin="round",t.shadowColor=c(.9),t.shadowBlur=18*e*f,t.beginPath(),t.moveTo(h-26*e,_+14*e),t.lineTo(h,_-16*e),t.lineTo(h+26*e,_+14*e),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function B0(t,a,o,i,s,l,c={}){const r=l.lut,u=l.arrow||{},m=u.w??1,f=u.glow??1,p=o/256;t.clearRect(0,0,a,o);const e=i.map(([n,S])=>[n*a,S*o]);if(e.length<2)return;const h=48,d=[],C=n=>{if(e.length===2)return[e[0][0]+(e[1][0]-e[0][0])*n,e[0][1]+(e[1][1]-e[0][1])*n];const S=n*(e.length-1),M=Math.min(e.length-2,Math.floor(S)),T=S-M,x=e[Math.max(0,M-1)],I=e[M],R=e[M+1],P=e[Math.min(e.length-1,M+2)],k=(_,A,y,B)=>.5*(2*A+(-_+y)*T+(2*_-5*A+4*y-B)*T*T+(-_+3*A-3*y+B)*T*T*T);return[k(x[0],I[0],R[0],P[0]),k(x[1],I[1],R[1],P[1])]};for(let n=0;n<=h;n++)d.push(C(n/h));const v=Math.max(0,Math.min(1,c.prog!=null?c.prog:s*.55%1)),w=Math.max(1,Math.round(h*v));t.lineCap="round";for(let n=1;n<=w;n++){const S=n/w;t.globalAlpha=Math.pow(S,1.5),t.strokeStyle=r(.45+.5*S),t.lineWidth=(1.6+3.2*S)*p*m,t.beginPath(),t.moveTo(d[n-1][0],d[n-1][1]),t.lineTo(d[n][0],d[n][1]),t.stroke()}if(v>.25){const n=d[w][0],S=d[w][1],M=d[Math.max(0,w-2)][0],T=d[Math.max(0,w-2)][1],x=Math.atan2(S-T,n-M)+Math.PI/2,I=30*p*(.7+.3*m);t.save(),t.translate(n,S),t.rotate(x),t.globalAlpha=Math.min(1,(v-.25)/.2);const R={color:r(.95),glowColor:r(.85),glow:12*f};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,I,R)||l.glyph(t,"TIP_TRI",0,0,I*.93,R))||(t.strokeStyle=r(.95),t.lineWidth=9*p*m,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*p,12*p),t.lineTo(0,-14*p),t.lineTo(18*p,12*p),t.stroke()),t.restore()}t.globalAlpha=1}function c0(t,a,o,i,s,l){s=s||{};const c=l.lut,r=s.style||l.arrow.line,u=!!s.closed,m=[0];for(let h=1;h<a.length;h++)m.push(m[h-1]+Math.hypot(a[h][0]-a[h-1][0],a[h][1]-a[h-1][1]));const f=m[m.length-1]||1,p=h=>{h=(h%f+f)%f;let d=1;for(;d<m.length-1&&m[d]<h;)d++;const C=(h-m[d-1])/Math.max(1e-4,m[d]-m[d-1]);return[a[d-1][0]+(a[d][0]-a[d-1][0])*C,a[d-1][1]+(a[d][1]-a[d-1][1])*C,Math.atan2(a[d][1]-a[d-1][1],a[d][0]-a[d-1][0])]},e=l.arrow;if(r==="chevron"){const h=(26*i+8)*e.gap,d=Math.max(2,Math.floor(f/h));t.shadowColor=c(Math.min(1,e.heat+.2)),t.shadowBlur=8*i*e.glow;for(let C=0;C<d;C++){const v=C*h+o*42*e.speed%h;if(!u&&v>f-4)continue;const[w,n,S]=p(v),M=7.5*i,T=8.5*i,x=.45+.4*Math.sin(v/f*6.283-o*2.2*e.speed);t.strokeStyle=c(e.heat-.05+x*.3),t.lineWidth=3.2*i,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(w,n),t.rotate(S),t.beginPath(),t.moveTo(-T*.5,-M),t.lineTo(T*.5,0),t.lineTo(-T*.5,M),t.stroke(),t.restore()}return!0}if(r==="comet"){const h=o*.35*e.speed%1*f,d=f*e.tail,C=Math.max(24,a.length*2);t.lineCap="round";for(let n=0;n<C;n++){const S=h-n/C*d,M=h-(n+1)/C*d;if(!u&&M<0)break;const T=1-n/C,[x,I]=p(S),[R,P]=p(M);!u&&Math.hypot(R-x,P-I)>f*.4||(t.globalAlpha=Math.pow(T,1.6),t.strokeStyle=c(Math.max(.05,e.heat-.2)+T*.55),t.lineWidth=(1.5+T*4.5)*i,T>.72?(t.shadowColor=c(Math.min(1,e.heat+.3)),t.shadowBlur=T*12*i*e.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(x,I),t.lineTo(R,P),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[v,w]=p(h);return t.fillStyle=rgba(W.ink,.95),t.shadowColor=c(.9),t.shadowBlur=16*i,t.beginPath(),t.arc(v,w,2.6*i,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=s.color||c(e.heat),t.shadowColor=c(Math.min(1,e.heat+.15)),t.shadowBlur=(s.glow??8)*i*e.glow,r==="taper")for(let h=1;h<a.length;h++)t.lineWidth=(.5+h/a.length*4.5)*i,t.beginPath(),t.moveTo(a[h-1][0],a[h-1][1]),t.lineTo(a[h][0],a[h][1]),t.stroke();else w0(t,i,o,l),t.beginPath(),a.forEach(([h,d],C)=>C?t.lineTo(h,d):t.moveTo(h,d)),u&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function E0(t,a,o,i,s,l){const c=13*i.halo,r=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const u=a/220,m=a/2,f=18*o.round*u,p=40*u,e=48*u,h=a-80*u,d=a-96*u,C=[],v=(n,S,M,T)=>{for(let x=0;x<=1;x+=.12)C.push([n+(M-n)*x,S+(T-S)*x])};v(p+f,e,p+h-f,e),v(p+h,e+f,p+h,e+d-f),v(p+h-f,e+d,p+f,e+d),v(p,e+d-f,p,e+f),t.shadowColor=r(.6),t.shadowBlur=c*.8;const w=4*l.arrow.w*u;if(l.arrow.line==="solid"?(t.setLineDash([10*o.dash*u,8*u]),t.lineDashOffset=-s*22*u,t.strokeStyle=r(.45),t.lineWidth=w,t.beginPath(),t.roundRect(p,e,h,d,f),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):c0(t,C,s,l.arrow.w*u,{color:r(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const n=[],S=(A,y,B,D,U)=>{for(let O=1;O<=U;O++)n.push([A+(B-A)*O/U,y+(D-y)*O/U])},M=(A,y,B,D,U)=>{for(let O=1;O<=U;O++){const j=B+(D-B)*O/U;n.push([A+f*Math.cos(j),y+f*Math.sin(j)])}},T=Math.PI/2,x=p+h,I=e+d,R=p+h/2;n.push([R,e]),S(R,e,x-f,e,8),M(x-f,e+f,-T,0,6),S(x,e+f,x,I-f,10),M(x-f,I-f,0,T,6),S(x-f,I,p+f,I,14),M(p+f,I-f,T,Math.PI,6),S(p,I-f,p,e+f,10),M(p+f,e+f,Math.PI,Math.PI+T,6),S(p+f,e,R,e,8);let P=0;for(let A=1;A<n.length;A++)P+=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);const k=P*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*u,8*u]),t.lineDashOffset=-(h/2-f)-s*22*u,t.strokeStyle=r(.9),t.lineWidth=w*1.3,t.lineCap="round",t.shadowColor=r(.92),t.shadowBlur=c*1.3,t.beginPath(),t.moveTo(n[0][0],n[0][1]);let _=0;for(let A=1;A<n.length&&_<k;A++){const y=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);if(_+y<=k)t.lineTo(n[A][0],n[A][1]),_+=y;else{const B=(k-_)/y;t.lineTo(n[A-1][0]+(n[A][0]-n[A-1][0])*B,n[A-1][1]+(n[A][1]-n[A-1][1])*B),_=k}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&l.foot&&(l.foot(t,!1,m-16*o.feet*u,m+6*u,26*o.feet*u),l.foot(t,!0,m+16*o.feet*u,m+6*u,26*o.feet*u)),t.shadowBlur=0}function O0(t,a,o,i,s,l,c,r){const u=13*i.halo,m=4*l.arrow.w*(a/220),f=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const p=a/220,e=c||[[45*p,130*p],[110*p,60*p],[175*p,110*p]],h=r??s*.5%1,d=Math.min(1,h*1.25)*(e.length-1),C=Math.min(e.length-1,Math.floor(d+.35));t.shadowColor=f(.7),t.shadowBlur=u;const v=[[e[0][0],e[0][1]]];for(let w=1;w<=e.length-1;w++){const n=Math.max(0,Math.min(1,d-(w-1)));if(n<=0)break;v.push([e[w-1][0]+(e[w][0]-e[w-1][0])*n,e[w-1][1]+(e[w][1]-e[w-1][1])*n])}v.length>1&&c0(t,v,s,l.arrow.w*p,{color:f(.62)},l),t.setLineDash([4*p,7*p]),t.lineDashOffset=0,t.globalAlpha=.3,t.strokeStyle=f(.45),t.lineWidth=m,t.beginPath(),e.forEach(([w,n],S)=>S?t.lineTo(w,n):t.moveTo(w,n)),t.stroke(),t.globalAlpha=1,t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,e.forEach(([w,n],S)=>{const M=S===C,T=M?1+Math.sin(s*6)*.14:1;t.strokeStyle=f(M?.8:.45),t.lineWidth=m*(M?1.3:.9),t.shadowBlur=M?u*1.6:u*.6,t.beginPath(),t.arc(w,n,12*o.node*T*p,0,Math.PI*2),t.stroke(),l.num&&(t.globalAlpha=S<=C?1:.45,l.num(t,String(S+1),w,n,16*o.numS*T*p,Math.round(14*o.numS*p)),t.globalAlpha=1)}),t.shadowBlur=0}function G0(t,a,o,i,s,l,c){const r=l.lut,u=13*i.halo,m=a/220,f=a/2,p=l.arrow&&l.arrow.w||1,e=(x,I)=>r(x).replace("rgb(","rgba(").replace(")",`,${I})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const h=(o.r!=null?o.r:.42)*a,d=h*(o.rt!=null?o.rt:.36),C=3.4*p*m,v=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.6)%1,w=Math.pow(v,1.6),n=Math.max(0,(v-.9)/.1);t.save(),t.translate(f,f);const S=(x,I,R,P=1)=>{if(x<=.6)return;const k=C*2.6*P,_=Math.max(.1,x-k),A=x+k,y=t.createRadialGradient(0,0,_,0,0,A);y.addColorStop(0,e(I-.05,0)),y.addColorStop(.5,e(I,R*.85)),y.addColorStop(1,e(I-.05,0)),t.globalAlpha=1,t.fillStyle=y,t.shadowBlur=0,t.beginPath(),t.arc(0,0,A,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,R*1.1),t.lineWidth=C*.85,t.strokeStyle=r(Math.min(.98,I+.12)),t.shadowColor=r(.88),t.shadowBlur=u*.6,t.beginPath(),t.arc(0,0,x,0,Math.PI*2),t.stroke(),t.shadowBlur=0},M=t.createRadialGradient(0,0,0,0,0,d*1.08);M.addColorStop(0,e(.6,.1+.18*n)),M.addColorStop(.65,e(.5,.05+.08*n)),M.addColorStop(1,e(.5,0)),t.globalAlpha=1,t.fillStyle=M,t.beginPath(),t.arc(0,0,d*1.08,0,Math.PI*2),t.fill();const T=1+.02*Math.sin(s*2.6);S(d*T,.55+.4*n,.5+.45*n,.9);for(let x=2;x>=0;x--){const I=Math.pow(Math.max(0,v-x*.05),1.6),R=h-(h-d)*I,P=x===0?.6+.4*w:.18/x*(1-n);S(R,.55+.4*w,P*(1-n*.45),1.15-.35*w)}n>.01&&S(d*(1+1.4*n),.9,(1-n)*.8,1.1),t.globalAlpha=.6+.3*n,t.shadowColor=r(.85),t.shadowBlur=u*(.9+n),t.fillStyle=r(.62+.3*n),t.beginPath(),t.arc(0,0,C*.85+3*m*n,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function U0(t,a,o,i,s,l,c,r){const u=l.lut,m=13*i.halo,f=a/220,p=a/2,e=l.arrow&&l.arrow.w||1,h=e*f,d=(b,L)=>u(b).replace("rgb(","rgba(").replace(")",","+L+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const C=a*.42*(o.spread!=null?o.spread:1),w=(r||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([b,L])=>[p+b*C,p+L*C]),n=80,S=[];for(let b=0;b<=n;b++){const L=b/n*(w.length-1),F=Math.min(w.length-2,Math.floor(L)),G=L-F,H=w[Math.max(0,F-1)],K=w[F],N=w[F+1],t0=w[Math.min(w.length-1,F+2)],a0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*G+(2*X-5*J+4*Y-o0)*G*G+(-X+3*J-3*Y+o0)*G*G*G);S.push([a0(H[0],K[0],N[0],t0[0]),a0(H[1],K[1],N[1],t0[1])])}const M=b=>{const L=Math.max(0,Math.min(n,b*n)),F=Math.floor(L),G=L-F,H=S[F],K=S[Math.min(n,F+1)];return[H[0]+(K[0]-H[0])*G,H[1]+(K[1]-H[1])*G]},T=.68;let x,I,R;if(c!=null)x=Math.max(0,Math.min(1,c)),I=1,R=0;else{const b=s*(o.tempo||.42)%1;if(b<T)x=b/T,I=1,R=0;else{const L=(b-T)/(1-T);x=1,I=1-L*L,R=L}}if(I<=.012)return;const P=x*x*x*(x*(6*x-15)+10),k=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const _=.36*(o.tail!=null?o.tail:1),A=o.width!=null?o.width:1;{const b=t.createLinearGradient(S[0][0],S[0][1],S[n][0],S[n][1]);b.addColorStop(0,d(.46,0)),b.addColorStop(.3,d(.46,.03*I)),b.addColorStop(.8,d(.46,.045*I)),b.addColorStop(1,d(.46,0)),t.globalAlpha=1,t.strokeStyle=b,t.lineWidth=9*h,t.shadowColor=u(.6),t.shadowBlur=m*2,t.beginPath(),S.forEach(([L,F],G)=>G?t.lineTo(L,F):t.moveTo(L,F)),t.stroke(),t.shadowBlur=0}const y=40,B=Math.max(0,P-_*(1-R)),D=[];for(let b=0;b<=y;b++)D.push(M(B+(P-B)*(b/y)));const U=()=>{t.beginPath(),D.forEach(([b,L],F)=>F?t.lineTo(b,L):t.moveTo(b,L)),t.stroke()},O=()=>{const b=t.createLinearGradient(D[0][0],D[0][1],D[y][0],D[y][1]);return b.addColorStop(0,d(.55,0)),b.addColorStop(.4,d(.56,0)),b.addColorStop(.68,d(.6,.09)),b.addColorStop(.88,d(.64,.24)),b.addColorStop(1,d(.68,.44)),b},j=1+.5*k;t.globalAlpha=I,t.strokeStyle=O(),t.lineWidth=(20+10*k)*h*A,t.shadowColor=u(.72),t.shadowBlur=m*2.2,U(),t.strokeStyle=O(),t.lineWidth=(10+5*k)*h*A,t.shadowBlur=m*1,U(),t.shadowBlur=0;for(let b=1;b<=y;b++){const L=b/y;t.globalAlpha=Math.pow(L,2.2)*.95*I,t.strokeStyle=u(.55+.38*L),t.lineWidth=(1.6+6.5*Math.pow(L,.7))*h*A*j,t.beginPath(),t.moveTo(D[b-1][0],D[b-1][1]),t.lineTo(D[b][0],D[b][1]),t.stroke()}const V=D[y][0],g=D[y][1];t.globalAlpha=.8*I,t.fillStyle=u(.6),t.shadowColor=u(.8),t.shadowBlur=m*1.6,t.beginPath(),t.arc(V,g,(9+5*k)*h*A,0,Math.PI*2),t.fill(),t.globalAlpha=I,t.fillStyle=u(.93),t.shadowBlur=m*.6,t.beginPath(),t.arc(V,g,(3.4+1.8*k)*h*A,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function H0(t,a,o,i,s,l,c){const r=l.lut,u=13*i.halo,m=a/220,f=a/2,p=l.arrow&&l.arrow.w||1;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const e=(o.r!=null?o.r:.3)*a,h=o.width!=null?o.width:1,d=4.2*p*m*h,C=o.dir!=null?o.dir:1,v=(o.sweep!=null?o.sweep:.66)*Math.PI*2,w=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.5)%1,n=-Math.PI/2+C*w*Math.PI*2;t.save(),t.translate(f,f),t.globalAlpha=.16,t.lineWidth=d*.7,t.strokeStyle=r(.44),t.shadowColor=r(.6),t.shadowBlur=u*.4,t.beginPath(),t.arc(0,0,e,0,Math.PI*2),t.stroke(),t.shadowBlur=0;const S=16;for(let k=0;k<S;k++){const _=k/(S-1),A=n-C*_*v,y=n-C*(_+1.2/S)*v;t.globalAlpha=(1-_)*.9,t.strokeStyle=r(.55+.35*(1-_)),t.lineWidth=d*(.55+.55*(1-_)),t.shadowColor=r(.8),t.shadowBlur=u*(.4+.5*(1-_)),t.beginPath(),t.arc(0,0,e,Math.min(A,y),Math.max(A,y),!1),t.stroke()}t.shadowBlur=0;const M=Math.cos(n)*e,T=Math.sin(n)*e,x=n+C*Math.PI/2,I=8*m*h;t.save(),t.translate(M,T),t.rotate(x+Math.PI/2),t.globalAlpha=1;const R=3.4*I*(.7+.3*p),P={color:r(.96),glowColor:r(.9),glow:u*1.2};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,R,P)||l.glyph(t,"TIP_TRI",0,0,R*.93,P))||(t.rotate(-Math.PI/2),t.strokeStyle=r(.96),t.lineWidth=d*.9,t.shadowColor=r(.9),t.shadowBlur=u*1.2,t.beginPath(),t.moveTo(-I,-I*.9),t.lineTo(I*.5,0),t.lineTo(-I,I*.9),t.stroke()),t.restore(),t.globalAlpha=.62,t.shadowColor=r(.75),t.shadowBlur=u*.6,t.fillStyle=r(.6),t.beginPath(),t.arc(0,0,d*.6,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}export{k0 as C,p0 as G,y0 as M,W as N,E as P,b0 as Q,P0 as R,T0 as S,M0 as Z,$ as a,f0 as b,A0 as c,v0 as d,I0 as e,E0 as f,O0 as g,G0 as h,R0 as i,U0 as j,H0 as k,_0 as l,F0 as m,D0 as n,z as o,c0 as p,x0 as q,B0 as r,i0 as s,S0 as t,C0 as u,L0 as v,h0 as w,d0 as x};
