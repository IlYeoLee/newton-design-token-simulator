import{q as at,a as Te,b as Me,n as Ke,Q as oe,M as re,Z as Xe,t as nt,P as kt,N as It,m as Ve}from"./fx-core-BRC0RuS3.js";import{aD as Ye,V as b,ap as vt,aE as dt,a7 as ne,aF as le,a3 as S,aG as Ze,ah as Qe,J as Fe,M as A,O as qe,$ as Ht,a0 as he,h as Q,aH as zt,av as Lt,aI as At,aJ as $e,aA as Je,v as lt,A as Mt,a as _t,aK as ti,u as ei,aL as ii,aM as si,aN as ai,aO as oi,aP as ri,aQ as ni,aR as li,aS as hi,W as ui,aT as ci,S as pi,aU as fi,H as di,aV as mi,Q as ue,P as K,ab as St,aB as ce,x as j,af as pe,au as fe,aW as gi,X as de,aX as vi,ag as me,p as _i,C as B,R as ot,c as Z,b as Qt,aY as wi,i as Dt,k as Ce,Y as ge,aZ as ve,a_ as xi,F as N,N as qt,f as bi,ak as Re,G as tt,aj as yi,ai as Pi}from"./fxlut-DaHgqg24.js";const _e={type:"change"},$t={type:"start"},Ee={type:"end"},Rt=new Ze,we=new Qe,Si=Math.cos(70*Fe.DEG2RAD),E=new b,z=2*Math.PI,P={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Xt=1e-6;class Ti extends Ye{constructor(t,e=null){super(t,e),this.state=P.NONE,this.target=new b,this.cursor=new b,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:vt.ROTATE,MIDDLE:vt.DOLLY,RIGHT:vt.PAN},this.touches={ONE:dt.ROTATE,TWO:dt.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new b,this._lastQuaternion=new ne,this._lastTargetPosition=new b,this._quat=new ne().setFromUnitVectors(t.up,new b(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new le,this._sphericalDelta=new le,this._scale=1,this._panOffset=new b,this._rotateStart=new S,this._rotateEnd=new S,this._rotateDelta=new S,this._panStart=new S,this._panEnd=new S,this._panDelta=new S,this._dollyStart=new S,this._dollyEnd=new S,this._dollyDelta=new S,this._dollyDirection=new b,this._mouse=new S,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Fi.bind(this),this._onPointerDown=Mi.bind(this),this._onPointerUp=Ci.bind(this),this._onContextMenu=Ni.bind(this),this._onMouseWheel=Li.bind(this),this._onKeyDown=Ai.bind(this),this._onTouchStart=Di.bind(this),this._onTouchMove=Oi.bind(this),this._onMouseDown=Ri.bind(this),this._onMouseMove=Ei.bind(this),this._interceptControlDown=Ui.bind(this),this._interceptControlUp=ki.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(_e),this.update(),this.state=P.NONE}update(t=null){const e=this.object.position;E.copy(e).sub(this.target),E.applyQuaternion(this._quat),this._spherical.setFromVector3(E),this.autoRotate&&this.state===P.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,o=this.maxAzimuthAngle;isFinite(i)&&isFinite(o)&&(i<-Math.PI?i+=z:i>Math.PI&&(i-=z),o<-Math.PI?o+=z:o>Math.PI&&(o-=z),i<=o?this._spherical.theta=Math.max(i,Math.min(o,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+o)/2?Math.max(i,this._spherical.theta):Math.min(o,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let a=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const s=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),a=s!=this._spherical.radius}if(E.setFromSpherical(this._spherical),E.applyQuaternion(this._quatInverse),e.copy(this.target).add(E),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let s=null;if(this.object.isPerspectiveCamera){const l=E.length();s=this._clampDistance(l*this._scale);const h=l-s;this.object.position.addScaledVector(this._dollyDirection,h),this.object.updateMatrixWorld(),a=!!h}else if(this.object.isOrthographicCamera){const l=new b(this._mouse.x,this._mouse.y,0);l.unproject(this.object);const h=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),a=h!==this.object.zoom;const p=new b(this._mouse.x,this._mouse.y,0);p.unproject(this.object),this.object.position.sub(p).add(l),this.object.updateMatrixWorld(),s=E.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;s!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(s).add(this.object.position):(Rt.origin.copy(this.object.position),Rt.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Rt.direction))<Si?this.object.lookAt(this.target):(we.setFromNormalAndCoplanarPoint(this.object.up,this.target),Rt.intersectPlane(we,this.target))))}else if(this.object.isOrthographicCamera){const s=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),s!==this.object.zoom&&(this.object.updateProjectionMatrix(),a=!0)}return this._scale=1,this._performCursorZoom=!1,a||this._lastPosition.distanceToSquared(this.object.position)>Xt||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Xt||this._lastTargetPosition.distanceToSquared(this.target)>Xt?(this.dispatchEvent(_e),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?z/60*this.autoRotateSpeed*t:z/60/60*this.autoRotateSpeed}_getZoomScale(t){const e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){E.setFromMatrixColumn(e,0),E.multiplyScalar(-t),this._panOffset.add(E)}_panUp(t,e){this.screenSpacePanning===!0?E.setFromMatrixColumn(e,1):(E.setFromMatrixColumn(e,0),E.crossVectors(this.object.up,E)),E.multiplyScalar(t),this._panOffset.add(E)}_pan(t,e){const i=this.domElement;if(this.object.isPerspectiveCamera){const o=this.object.position;E.copy(o).sub(this.target);let a=E.length();a*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*a/i.clientHeight,this.object.matrix),this._panUp(2*e*a/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),o=t-i.left,a=e-i.top,s=i.width,l=i.height;this._mouse.x=o/s*2-1,this._mouse.y=-(a/l)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(z*this._rotateDelta.x/e.clientHeight),this._rotateUp(z*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(z*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-z*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(z*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-z*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),o=.5*(t.pageY+e.y);this._rotateStart.set(i,o)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),o=.5*(t.pageY+e.y);this._panStart.set(i,o)}}_handleTouchStartDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,o=t.pageY-e.y,a=Math.sqrt(i*i+o*o);this._dollyStart.set(0,a)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),o=.5*(t.pageX+i.x),a=.5*(t.pageY+i.y);this._rotateEnd.set(o,a)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(z*this._rotateDelta.x/e.clientHeight),this._rotateUp(z*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),o=.5*(t.pageY+e.y);this._panEnd.set(i,o)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,o=t.pageY-e.y,a=Math.sqrt(i*i+o*o);this._dollyEnd.set(0,a),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const s=(t.pageX+e.x)*.5,l=(t.pageY+e.y)*.5;this._updateZoomParameters(s,l)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new S,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){const e=t.deltaMode,i={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function Mi(n){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(n.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(n)&&(this._addPointer(n),n.pointerType==="touch"?this._onTouchStart(n):this._onMouseDown(n)))}function Fi(n){this.enabled!==!1&&(n.pointerType==="touch"?this._onTouchMove(n):this._onMouseMove(n))}function Ci(n){switch(this._removePointer(n),this._pointers.length){case 0:this.domElement.releasePointerCapture(n.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Ee),this.state=P.NONE;break;case 1:const t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function Ri(n){let t;switch(n.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case vt.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(n),this.state=P.DOLLY;break;case vt.ROTATE:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=P.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=P.ROTATE}break;case vt.PAN:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=P.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=P.PAN}break;default:this.state=P.NONE}this.state!==P.NONE&&this.dispatchEvent($t)}function Ei(n){switch(this.state){case P.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(n);break;case P.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(n);break;case P.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(n);break}}function Li(n){this.enabled===!1||this.enableZoom===!1||this.state!==P.NONE||(n.preventDefault(),this.dispatchEvent($t),this._handleMouseWheel(this._customWheelEvent(n)),this.dispatchEvent(Ee))}function Ai(n){this.enabled!==!1&&this._handleKeyDown(n)}function Di(n){switch(this._trackPointer(n),this._pointers.length){case 1:switch(this.touches.ONE){case dt.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(n),this.state=P.TOUCH_ROTATE;break;case dt.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(n),this.state=P.TOUCH_PAN;break;default:this.state=P.NONE}break;case 2:switch(this.touches.TWO){case dt.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(n),this.state=P.TOUCH_DOLLY_PAN;break;case dt.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(n),this.state=P.TOUCH_DOLLY_ROTATE;break;default:this.state=P.NONE}break;default:this.state=P.NONE}this.state!==P.NONE&&this.dispatchEvent($t)}function Oi(n){switch(this._trackPointer(n),this.state){case P.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(n),this.update();break;case P.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(n),this.update();break;case P.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(n),this.update();break;case P.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(n),this.update();break;default:this.state=P.NONE}}function Ni(n){this.enabled!==!1&&n.preventDefault()}function Ui(n){n.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function ki(n){n.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const Ot={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}wt.BlurDirectionX=new S(1,0);wt.BlurDirectionY=new S(0,1);const Et={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
    ...
    void main(){
      ...
      if (uAlphaOut > 0.5) {
        ...
        gl_FragColor = vec4(c.rgb, clamp(g * 1.8, 0.0, 1.0));
    ...
    }`},mt=-1.8;function qs(n){const t=new URLSearchParams(location.search).get("alpha")==="1",e=new ui({antialias:!0,alpha:t,premultipliedAlpha:!1});t&&e.setClearColor(0,0),e.setPixelRatio(Math.min(window.devicePixelRatio,2));const i=e.capabilities.getMaxAnisotropy();e.setSize(n.clientWidth,n.clientHeight),e.shadowMap.enabled=!0,e.shadowMap.type=ci,e.localClippingEnabled=!0,n.appendChild(e.domElement);const o=new pi;o.background=new lt(790034),o.fog=new fi(790034,9,20);const a=new di(50,n.clientWidth/n.clientHeight,.05,60),s=new Ti(a,e.domElement);s.enableDamping=!0,s.dampingFactor=.08,s.maxPolarAngle=Math.PI*.495,s.minDistance=1.2,s.maxDistance=14,o.add(new mi(3752527,1119258,1.1));const l=new ue(16777215,1.5);l.position.set(3,6,4),l.castShadow=!0,l.shadow.mapSize.set(2048,2048),l.shadow.camera.left=-5,l.shadow.camera.right=5,l.shadow.camera.top=5,l.shadow.camera.bottom=-5,o.add(l);const h=new ue(5227511,.35);h.position.set(-4,3,-3),o.add(h);const p=new A(new K(120,120),new St({color:1514016,roughness:.92,metalness:.05}));p.rotation.x=-Math.PI/2,p.receiveShadow=!0,o.add(p);const r=new ce(120,240,2304051,1777706);r.position.y=.002,o.add(r);const v=new j,u=new A(new K(5,3.2),new St({color:1843240,roughness:.95}));u.position.set(0,1.6,mt),u.receiveShadow=!0,v.add(u);const x=new ce(5,10,2765120,2304567);x.rotation.x=Math.PI/2,x.position.set(0,1.6,mt+.005),v.add(x),o.add(v);const U=(()=>{const c=new j,g=3.05,d=-7,f=.225,m=d-.15,_=new St({color:2830134,roughness:.6,metalness:.3}),w=new A(new pe(1.8,1.05,.03),new St({color:15594231,roughness:.25,metalness:.05,transparent:!0,opacity:.55}));w.position.set(0,g+.375,m-.015),w.castShadow=!0,c.add(w);const I=new fe(new gi(new pe(.59,.45,.001)),new de({color:15229482}));I.position.set(0,g+.19,m+.02),c.add(I);const L=new A(new vi(f,.014,10,28),new St({color:15229482,roughness:.4,metalness:.5}));L.rotation.x=Math.PI/2,L.position.set(0,g,d),L.castShadow=!0,c.add(L);const R=12,H=.4,W=.09,G=(D,je)=>Array.from({length:R},(Ys,Be)=>{const ae=Be/R*Math.PI*2;return new b(Math.cos(ae)*D,je,d+Math.sin(ae)*D)}),ct=G(f,g),pt=G((f+W)/2,g-H*.5),st=G(W,g-H),jt=[];for(let D=0;D<R;D++)jt.push(ct[D],pt[D],pt[D],st[D]);for(let D=0;D<R;D++)jt.push(pt[D],pt[(D+1)%R],st[D],st[(D+1)%R]);const Ge=new fe(new Ht().setFromPoints(jt),new de({color:16119280,transparent:!0,opacity:.75}));c.add(Ge);const Bt=new A(new me(.05,.06,w.position.y+.4,12),_);Bt.position.set(0,(w.position.y+.4)/2,m-.35),Bt.castShadow=!0,c.add(Bt);const Kt=new A(new me(.035,.035,.36,10),_);return Kt.rotation.x=Math.PI/2,Kt.position.set(0,w.position.y,m-.18),c.add(Kt),c.visible=!1,c.name="hoop",o.add(c),c})();let C=null;function M(){U.visible=C==="basketball"&&["court","court_tile","court_gray","court_black"].includes(yt)}const F=new _i,T={},q="./";function bt(c,g,d){return new Promise(f=>{F.load(`${q}tex/${c}`,m=>{m.wrapS=m.wrapT=ot,m.repeat.set(g,d),m.anisotropy=i,m.colorSpace=Z,f(m)})})}async function $(c){if(T[c])return T[c];if(c==="grass")T.grass=await bt("grass.jpg",60,60);else if(c==="paving")T.paving=await bt("paving.jpg",50,50);else if(c==="plaster")T.plaster=await bt("plaster.jpg",2.5,1.6);else if(c==="court_tile"){const g=document.createElement("canvas");g.width=g.height=512;const d=g.getContext("2d"),f=128;d.fillStyle="#DCDEDF",d.fillRect(0,0,512,512);for(let _=0;_<4;_++)for(let w=0;w<4;w++){const I=w*f,L=_*f,R=(w*7+_*13)%5/5;d.fillStyle=`rgb(${214+R*10|0},${217+R*10|0},${219+R*10|0})`,d.fillRect(I,L,f,f),d.strokeStyle="rgba(150,156,161,0.5)",d.lineWidth=2,d.strokeRect(I+1,L+1,f-2,f-2),d.strokeStyle="rgba(156,163,169,0.62)",d.lineWidth=1.1;const H=f/4;for(let W=0;W<4;W++)for(let G=0;G<4;G++){const ct=I+W*H,pt=L+G*H;for(let st=0;st<2;st++)d.beginPath(),d.roundRect(ct+4+st*13,pt+5,11,H-10,3.5),d.stroke()}}const m=new B(g);m.wrapS=m.wrapT=ot,m.repeat.set(120,120),m.anisotropy=i,m.colorSpace=Z,T.court_tile=m}else if(c==="ivorywood"){const g=document.createElement("canvas");g.width=g.height=512;const d=g.getContext("2d"),f=(()=>{let w=11;return()=>(w=w*16807%2147483647)/2147483647})(),m=74;for(let w=0;w*m<512+m;w++){const I=w%2*190;for(let L=-1;L<3;L++){const R=L*380+I,H=w*m,W=.962+f()*.072;d.fillStyle=`rgb(${Math.min(255,238*W)|0}, ${Math.min(255,226*W)|0}, ${Math.min(255,212*W)|0})`,d.fillRect(R,H,380,m),d.strokeStyle="rgba(196,178,152,0.34)",d.lineWidth=1.4,d.strokeRect(R+.7,H+.7,380-1.4,m-1.4),d.strokeStyle="rgba(204,187,162,0.20)",d.lineWidth=1;for(let G=0;G<3;G++){const ct=H+12+f()*(m-24);d.beginPath(),d.moveTo(R+8,ct),d.lineTo(R+372,ct+(f()-.5)*5),d.stroke()}}}const _=new B(g);_.wrapS=_.wrapT=ot,_.repeat.set(46,46),_.anisotropy=i,_.colorSpace=Z,T.ivorywood=_}else if(c==="track"){const g=await new Promise(_=>{const w=new Image;w.onload=()=>_(w),w.src=`${q}tex/asphalt.jpg`}),d=document.createElement("canvas");d.width=d.height=512;const f=d.getContext("2d");f.fillStyle="#B7C6AA",f.fillRect(0,0,512,512),f.globalAlpha=.34,f.globalCompositeOperation="overlay",f.drawImage(g,0,0,512,512),f.globalAlpha=.12,f.globalCompositeOperation="saturation",f.fillStyle="#808080",f.fillRect(0,0,512,512),f.globalAlpha=1,f.globalCompositeOperation="source-over",f.fillStyle="rgba(248,248,244,0.85)",f.fillRect(96,0,7,512),f.fillRect(409,0,7,512);const m=new B(d);m.wrapS=m.wrapT=ot,m.repeat.set(60,60),m.anisotropy=i,m.colorSpace=Z,T.track=m}else if(c==="dirt"){const g=await new Promise(_=>{const w=new Image;w.onload=()=>_(w),w.src=`${q}tex/asphalt.jpg`}),d=document.createElement("canvas");d.width=d.height=512;const f=d.getContext("2d");f.fillStyle="#C4BBA4",f.fillRect(0,0,512,512),f.globalAlpha=.4,f.globalCompositeOperation="overlay",f.drawImage(g,0,0,512,512),f.globalAlpha=.16,f.globalCompositeOperation="saturation",f.fillStyle="#808080",f.fillRect(0,0,512,512),f.globalAlpha=1,f.globalCompositeOperation="source-over",f.strokeStyle="rgba(120,110,92,0.35)",f.lineWidth=2,f.beginPath(),f.moveTo(0,256),f.lineTo(512,262),f.moveTo(256,0),f.lineTo(250,512),f.stroke();const m=new B(d);m.wrapS=m.wrapT=ot,m.repeat.set(24,24),m.anisotropy=i,m.colorSpace=Z,T.dirt=m}else if(c==="indoorwood"){const g=document.createElement("canvas");g.width=g.height=512;const d=g.getContext("2d"),f=(()=>{let _=7;return()=>(_=_*16807%2147483647)/2147483647})();for(let _=0;_<8;_++){const w=_%2*128;for(let I=-1;I<3;I++){const L=I*256+w,R=_*64,H=.82+f()*.3;d.fillStyle=`rgb(${Math.round(168*H)}, ${Math.round(126*H)}, ${Math.round(84*H)})`,d.fillRect(L,R,256,64),d.strokeStyle="rgba(70,48,30,0.55)",d.lineWidth=2,d.strokeRect(L+1,R+1,254,62),d.strokeStyle="rgba(90,62,40,0.25)",d.lineWidth=1;for(let W=0;W<4;W++){const G=R+10+f()*46;d.beginPath(),d.moveTo(L+6,G),d.lineTo(L+250,G+(f()-.5)*6),d.stroke()}}}const m=new B(g);m.wrapS=m.wrapT=ot,m.repeat.set(26,26),m.anisotropy=i,m.colorSpace=Z,T.indoorwood=m}else if(c==="wallpaper"){const g=document.createElement("canvas");g.width=g.height=256;const d=g.getContext("2d");d.fillStyle="#F7F4EE",d.fillRect(0,0,256,256);const f=(()=>{let _=13;return()=>(_=_*16807%2147483647)/2147483647})();for(let _=0;_<256;_+=2){const w=.02+f()*.045;d.fillStyle=f()<.5?`rgba(210,202,188,${w})`:`rgba(255,255,255,${w})`,d.fillRect(_,0,1+f()*1.5,256)}for(let _=0;_<90;_++)d.fillStyle=`rgba(196,188,174,${.03+f()*.04})`,d.fillRect(f()*256,f()*256,1,3+f()*9);const m=new B(g);m.wrapS=m.wrapT=ot,m.repeat.set(9,5),m.anisotropy=i,m.colorSpace=Z,T.wallpaper=m}return T[c]}let Ft=0,yt=null;function te(){return yt==="indoor"?15723490:!yt||yt==="none"?8291727:12173514}function ee(){if(!k)return;const c=te();o.background.setHex(c),o.fog.color.setHex(c)}let X=null,V=null;async function Oe(c){const g=++Ft;if(yt=!c||c==="none"?null:c,!c||c==="none"){p.material.map=null,p.material.color.setHex(k?6712438:1514016),u.material.map=null,u.material.color.setHex(k?7765126:1843240),u.material.emissive?.setHex(0),p.material.needsUpdate=!0,u.material.needsUpdate=!0,r.visible=!0,x.visible=!0,X&&(X.visible=!1),V&&(V.visible=!1),M(),ee();return}const d=c==="court_gray"||c==="court_black",f=c==="indoor"?"ivorywood":c==="court"?"indoorwood":c,[m,_]=await Promise.all([d?null:$(f),$("plaster")]);if(g===Ft){if(!X){const I=new Q({uniforms:{uColor:{value:new lt(16448245)},uOpacity:{value:.85},uHalf:{value:.025}},vertexShader:"varying vec2 vUv; void main(){ vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }",fragmentShader:`
          ...
          }`,transparent:!0,depthWrite:!1});X=new A(new K(16,16),I),X.rotation.x=-Math.PI/2,X.position.y=.006,X.renderOrder=1,X.name="courtLines",o.add(X)}if(!V){const w=new Q({uniforms:{uTint:{value:new lt(11975358)},uOut:{value:.5},uKey:{value:.22}},vertexShader:"varying vec2 vUv; void main(){ vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }",fragmentShader:`
          ...
          }`,transparent:!0,depthWrite:!1});V=new A(new K(60,60),w),V.rotation.x=-Math.PI/2,V.position.y=.005,V.renderOrder=0,V.name="courtZones",o.add(V)}if(V.visible=c==="court_tile",X.visible=c==="court"||c==="court_tile"||d,p.material.map=d?null:m,u.material.map=_,d)p.material.color.setHex(c==="court_black"?2502721:2830912),p.material.roughness=c==="court_black"?.42:.6,p.material.metalness=c==="court_black"?.22:.12,u.material.map=await $("wallpaper"),u.material.color.setHex(16777215),u.material.emissive?.setHex(k?7236195:5722955);else if(c==="court_tile"||c==="track"){const w=c==="court_tile";p.material.roughness=w?.78:.92,p.material.metalness=w?.04:.05,p.material.color.setHex(k?14474975:12567753),u.material.map=await $("wallpaper"),u.material.color.setHex(16777215),u.material.emissive?.setHex(k?7236195:5722955)}else c==="indoor"||c==="court"?(p.material.roughness=.92,p.material.metalness=.05,p.material.color.setHex(c==="indoor"?k?16249577:14209218:k?16183784:14209218),u.material.map=await $("wallpaper"),u.material.color.setHex(16777215),u.material.emissive?.setHex(k?7236195:5722955)):(u.material.emissive?.setHex(0),p.material.roughness=.92,p.material.metalness=.05,p.material.color.setHex(k?14408667:9079434),u.material.color.setHex(k?14869218:10132122));p.material.needsUpdate=!0,u.material.needsUpdate=!0,r.visible=!1,x.visible=!1,M(),ee()}}const ie={running:{pos:[2.9,2.1,2.9],look:[0,.7,-.6]},boxing:{pos:[3.5,1.9,3.9],look:[0,1.1,-.1]},basketball:{pos:[3.4,2.6,2.6],look:[0,.6,-1]}};function Ne(c){const g=ie[c]||ie.running;a.position.set(...g.pos),s.target.set(...g.look),s.update()}function Ue(c,g){v.visible=!!g,C=c,M(),Ne(c)}const ht=o.children.find(c=>c.isHemisphereLight);let k=!1;function ke(c){if(k=!!c,O.day=k,k){const g=te();o.background.setHex(g),o.fog.color.setHex(g),o.fog.near=14,o.fog.far=40,ht.color.setHex(14476526),ht.groundColor.setHex(8291468),ht.intensity=1.1,l.intensity=1.6,l.color.setHex(16774112),h.intensity=.12,p.material.map||p.material.color.setHex(6712438),u.material.map||u.material.color.setHex(7765126),p.material.map&&p.material.color.setHex(14408667),u.material.map&&u.material.color.setHex(14869218)}else o.background.setHex(790034),o.fog.color.setHex(790034),o.fog.near=9,o.fog.far=20,ht.color.setHex(3752527),ht.groundColor.setHex(1119258),ht.intensity=1.1,l.intensity=1.5,l.color.setHex(16777215),h.intensity=.35,p.material.map||p.material.color.setHex(1514016),u.material.map||u.material.color.setHex(1843240),p.material.map&&p.material.color.setHex(9079434),u.material.map&&u.material.color.setHex(10132122);p.material.needsUpdate=!0,u.material.needsUpdate=!0}const J=new be(e),Gt=new Gi(o,a);J.addPass(Gt),J.addPass(new Nt({uniforms:{tDiffuse:{value:null}},vertexShader:"varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:"uniform sampler2D tDiffuse;varying vec2 vUv;void main(){vec4 c=texture2D(tDiffuse,vUv);if(c.r!=c.r||c.g!=c.g||c.b!=c.b||c.a!=c.a)c=vec4(0.0);gl_FragColor=clamp(c,0.0,60.0);}"}));const Pt=new wt(new S(n.clientWidth/2,n.clientHeight/2),O.bloomStrength,O.bloomRadius,O.bloomThreshold);J.addPass(Pt),J.renderToScreen=!1;const ut=new be(e);ut.addPass(Gt),ut.addPass(new Nt({uniforms:{tDiffuse:{value:null},tBloom:{value:J.renderTarget2.texture}},vertexShader:"varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:"uniform sampler2D tDiffuse,tBloom;varying vec2 vUv;void main(){gl_FragColor=texture2D(tDiffuse,vUv)+texture2D(tBloom,vUv);}"}));const it=new Nt(Ki);ut.addPass(it),ut.addPass(new Bi);const Ct=[];function Ie(){Ct.length=0,o.traverse(c=>{c.visible&&c.material?._noBloom&&(c.visible=!1,Ct.push(c))})}function He(){for(const c of Ct)c.visible=!0;Ct.length=0}function ze(c){Pt.threshold=O.bloomThreshold+(O.day?.38:0),Pt.strength=O.bloomStrength,Pt.radius=O.bloomRadius,it.uniforms.uGrain.value=O.grain,it.uniforms.uVignette.value=O.vignette,it.uniforms.uExposure.value=O.exposure,it.uniforms.uTime.value=c,it.uniforms.uAlphaOut.value=O.alphaOut?1:0,it.uniforms.uAlphaFloor.value=O.alphaFloor||0,Ie(),J.render(),He(),ut.render()}function se(){e.domElement.style.width="0px",e.domElement.style.height="0px";const c=n.clientWidth,g=n.clientHeight;a.aspect=c/g,a.updateProjectionMatrix(),e.setSize(c,g),J.setSize(c,g),ut.setSize(c,g),Pt.setSize(c/2,g/2)}window.addEventListener("resize",se);function We(c){const g=Math.round(c/2)*2;p.position.z=g,r.position.z=g}return{renderer:e,scene:o,camera:a,controls:s,setPackEnvironment:Ue,resize:se,renderFrame:ze,composer:J,setSurfaces:Oe,setDaylight:ke,followFloor:We,wall:u,wallGroup:v,hoop:U,setRenderCamera:c=>{Gt.camera=c}}}const Xi="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",Vi=.98,Yi=.83,Zi=-.043,Qi=-.031,qi=5.5,$i=.027,Ji=.25,ts=.26,es=.3,is=.74,ss=.038,as=.84,os=24,rs=1,ns=1.6,ls=.9,hs=.82,us=0,cs=.5,ps=.5,fs=.125,ds=.4,ms=1,gs=.34,vs=0,_s=3.4,ws=.01,xs=0,bs=.011,ys=-2,Ps=.8,Ss=-.085,Ts=.16,Ms=4,Fs=.6,Cs=1,Rs=1,Es="glow",Ls="add",As="offbit",Ds=.55,Os=.125,Ns=0,y={_:Xi,imp:Vi,scale:Yi,offx:Zi,offy:Qi,irot:qi,pitch:$i,dot:Ji,glow:ts,shade:es,sharp:is,edge:ss,plantar:as,bands:os,bandSoft:rs,w:ns,halo:ls,pool:hs,noise:us,rip:cs,ripReach:ps,ripWidth:fs,ripSpeed:ds,ripGrad:ms,edgeShade:gs,shadeRed:vs,shadeRedW:_s,edgeW:ws,edgeSoft:xs,dither:bs,tilt:ys,gsize:Ps,gx:Ss,gy:Ts,grot:Ms,gsh:Fs,shadeCol:Cs,ripCol:Rs,gShadow:Es,gBlend:Ls,numSrc:As,prog:Ds,bloom:Os,blur:Ns},Le=`
#include <common>
...
}`,Is={solid:0,dash:1,dot:2,chevron:3,comet:4,taper:5},Y={ox:0,oz:0,fx:0,fz:-1,rx:1,rz:0,halfL:0,halfW:0,feather:.3,amt:0};function Hs(n){const t=new Q({vertexShader:Le,fragmentShader:ks,uniforms:{uLUT:{value:Dt()},uTime:{value:0},uLen:{value:n},uW:{value:1},uHalo:{value:.9},uGain:{value:1},uLStyle:{value:1},uLSpeed:{value:1},uLGap:{value:1},uLHeat:{value:.5},uLTail:{value:.55},uDay:{value:0},uOut:{value:1},uFPOrigin:{value:new b},uFPFwd:{value:new b(0,0,-1)},uFPRight:{value:new b(1,0,0)},uFPNear:{value:-1e6},uFPFar:{value:1e6},uFPHalfN:{value:1e6},uFPHalfF:{value:1e6},uFPFadeM:{value:.15}},transparent:!0,blending:Mt,depthWrite:!1,side:Qt});return t.clipping=!0,t._src="LANEFX",t}const rt=Te/Me,Tt={core:y.w,halo:y.halo,pool:y.pool,sweep:.4,wobble:y.noise};function zs(n=null){const t=new Q({vertexShader:Le,fragmentShader:Us,uniforms:{uLUT:{value:Dt()},uUIOrigin:{value:new b},uUIFwd:{value:new b(0,0,-1)},uUIRight:{value:new b(1,0,0)},uUIHalfL:{value:0},uUIHalfW:{value:0},uUIFeather:{value:.3},uUIAmt:{value:0},uShape:{value:n?1:0},uRadius:{value:n?1:1.5652173913043477},uSDF2:{value:n||Dt()},uSDFWarn:{value:wi()||Dt()},uImp:{value:n?y.imp:0},uImpPitch:{value:y.pitch*rt},uImpDot:{value:y.dot},uImpGlow:{value:y.glow},uImpShade:{value:y.shade},uImpSharp:{value:y.sharp},uImpShadeCol:{value:y.shadeCol},uImpEdge:{value:y.edge*rt},uImpScale:{value:y.scale},uImpRot:{value:(n?._right?-5.5:y.irot)*Math.PI/180},uImpCtr:{value:new S(n?(n._inCx??.5)*2-1:0,n?1-(n._inCy??.5)*2:0)},uImpOff:{value:new S((n?._right?.043:y.offx)*rt,y.offy*rt)},uRip:{value:y.rip},uRipSpeed:{value:y.ripSpeed},uRipWidth:{value:y.ripWidth*rt},uRipReach:{value:y.ripReach*rt},uEdgeShade:{value:y.edgeShade},uEdgeW:{value:y.edgeW*rt},uEdgeSoft:{value:y.edgeSoft},uShadeRed:{value:y.shadeRed},uShadeRedW:{value:y.shadeRedW},uDither:{value:y.dither},uSilFit:{value:Te/Me},uPlantar:{value:y.plantar},uBands:{value:y.bands},uBandSoft:{value:y.bandSoft},uRipGrad:{value:y.ripGrad},uRipCol:{value:y.ripCol},uPhase:{value:0},uProg:{value:0},uFade:{value:1},uToe:{value:0},uStrong:{value:0},uContract:{value:0},uTime:{value:0},uSeed:{value:Math.random()*6.2832},uW:{value:1},uHalo:{value:.9},uPool:{value:.55},uGain:{value:1},uSweepA:{value:1},uNoise:{value:.5},uDay:{value:0},uOut:{value:1},uHT:{value:0},uHTPitch:{value:.055},uHTGain:{value:1.15},uHTSoft:{value:.55},uHTWave:{value:.6},uHTGlow:{value:0},uHTInner:{value:0},uNumTex:{value:null},uNumOn:{value:0},uNumScale:{value:.311},uNumOff:{value:new S},uFPOrigin:{value:new b},uFPFwd:{value:new b(0,0,-1)},uFPRight:{value:new b(1,0,0)},uFPNear:{value:-1e6},uFPFar:{value:1e6},uFPHalfN:{value:1e6},uFPHalfF:{value:1e6},uFPFadeM:{value:.28}},transparent:!0,blending:Mt,depthWrite:!1,side:Qt});return t.clipping=!0,t._src=n?"MARKFX(발형)":"MARKFX(존원)",t._noBloom=!0,t}const et={left:at.red,right:at.red,target:at.red,guide:at.coral,lane:at.red,success:at.prism,user:at.prism},Ae=[1,.75,.55,.38],Ws=[1,.78,.58,.42];let Wt=!1;function $s(n){Wt=!!n}const Zt=.26,Gs=.727,ye=Zt/Gs,Vt={base:Zt*.75,loose:Zt*1},gt={markScale:1,fillOpacity:.2,previewEdge:.5,cdContractFrom:1.9,cdGain:.6,lingerEdge:.9,linger:.35};gt.linger;const js={running:{mode:"advance",V:2.5,STRIKE_AHEAD:.15,X_SCALE:2,LANE_W:1.6,CAL:{right:{x:-.187,z:.049},left:{x:.128,z:0}}},boxing:{mode:"static",FLOOR_SCALE:1.6,WALL:{XS:2.2,Y0:.73,YS:1.2}},basketball:{mode:"spatial",SCALE:5}},Js=5,Yt={},ft=new Image;ft.src="./ready-view/assets/pace_foot.svg";function Bs(n){const t=n?"R":"L";if(Yt[t])return Yt[t];const e=document.createElement("canvas");e.width=e.height=128;const i=e.getContext("2d"),o=ft.complete&&ft.naturalWidth;if(o){const s=document.createElement("canvas");s.width=s.height=128;const l=s.getContext("2d"),h=ft.naturalWidth/ft.naturalHeight,p=100,r=p/h;l.save(),n&&(l.translate(128,0),l.scale(-1,1)),l.drawImage(ft,(128-p)/2,(128-r)/2,p,r),l.restore(),l.globalCompositeOperation="source-in",l.fillStyle=nt(It.ink,.95),l.fillRect(0,0,128,128),i.shadowColor=nt(kt.coral,.75),i.shadowBlur=12,i.drawImage(s,0,0),i.shadowBlur=0,i.drawImage(s,0,0)}else i.strokeStyle=nt(It.ink,.95),i.lineWidth=5,i.shadowColor=nt(kt.coral,.75),i.shadowBlur=12,i.beginPath(),i.ellipse(64,64,20,34,n?.12:-.12,0,Math.PI*2),i.stroke();const a=new B(e);return a.colorSpace=Z,a.anisotropy=4,o&&(Yt[t]=a),a}function De(n){const t=document.createElement("canvas");t.width=t.height=128;const e=t.getContext("2d");Re(e,String(n),64,64,96)||(e.fillStyle=nt(It.ink,.95),e.font="300 86px -apple-system, sans-serif",e.textAlign="center",e.textBaseline="middle",e.shadowColor=nt(kt.coral,.75),e.shadowBlur=14,e.fillText(String(n),64,70));const i=new B(t);return i.anisotropy=4,i}function Ks(n){const i=document.createElement("canvas");i.width=4,i.height=4;let o=i.getContext("2d");o.font="400 56px -apple-system, 'Apple SD Gothic Neo', sans-serif";const a=Math.ceil(o.measureText(n).width);i.width=a+40,i.height=56*1.7,o=i.getContext("2d"),o.font="400 56px -apple-system, 'Apple SD Gothic Neo', sans-serif",o.textAlign="center",o.textBaseline="middle",o.shadowColor=nt(kt.coral,.7),o.shadowBlur=56*.25,o.fillStyle=It.ink,o.fillText(n,i.width/2,i.height/2);const s=new B(i);return s.colorSpace=Z,s.anisotropy=8,{tex:s,aspect:i.width/i.height}}function Xs(n){const t=document.createElement("canvas");t.width=t.height=256;const e=t.getContext("2d"),i="#"+n.toString(16).padStart(6,"0");return e.strokeStyle=i,e.lineWidth=12,e.lineCap="butt",e.setLineDash([26,20]),e.beginPath(),e.arc(128,128,104,0,Math.PI*2),e.stroke(),new B(t)}class Pe{constructor(t,e,i,o=!1){this._footRight=o,this.group=new j,this.radius=t,this.color=e,this.surface=i,this.num=null;let a=null;if(i==="floor"&&N.markShape===1)try{a=bi(this._footRight===!0)}catch{a=null}this._isFoot=!!a;const s=(this._isFoot?ye:t*2.78)*oe;this.fx=new A(new K(s,s),zs(a)),this.fx.position.z=.002,this._baseGain=i==="wall"?.6:1,this.fx.material.uniforms.uGain.value=this._baseGain,this.group.add(this.fx),i==="floor"&&(this.group.rotation.x=-Math.PI/2,this.group.position.y=.012),this.group.renderOrder=5}setSelected(t){if(t&&!this.sel){this.sel=new j;const e=(i,o,a,s,l)=>{const h=new A(new Pi(i,o,48),new _t({color:a,transparent:!0,opacity:s,depthWrite:!1,side:Qt}));return h.renderOrder=l,h};this.sel.add(e(this.radius*1.44,this.radius*1.58,790034,.85,6)),this.sel.add(e(this.radius*1.32,this.radius*1.44,16777215,.95,7)),this.sel.position.z=.005,this.group.add(this.sel)}this.sel&&(this.sel.visible=!!t)}setNumber(t){this._numN=t;const e=new _t({map:De(t),transparent:!0,depthWrite:!1}),i=this.radius*2.78*re.RATIO/.75*(this._isFoot?1:Xe);this.num=new A(new K(i,i),e),this.num.position.z=.004;const o=this.fx?.material?.uniforms;o?.uNumTex&&(o.uNumTex.value=e.map,o.uNumScale.value=i/(this.radius*2.78)),this.group.add(this.num)}setContract(t="reach"){this.contract=t,this.fx.material.uniforms.uContract.value=t==="avoid"?1:0}render(t,e,i,o){const a=this.group;if(t==="hidden"){a.visible=!1,this._lastPhase="hidden";return}a.visible=!0;const s=performance.now()/1e3;t!==this._lastPhase&&((this._lastPhase==="hidden"||this._lastPhase==null)&&(t==="preview"||t==="countdown")&&(this._spawnT=s),t==="linger"&&(this._hitT=s),this._lastPhase=t);let l=1;if(this._spawnT!=null){const r=(s-this._spawnT)/.38;if(r<1){const v=1-Math.pow(1-r,3);l*=.55+.45*v+.1*Math.sin(Math.min(1,r)*Math.PI)}}if(this._hitT!=null){const r=(s-this._hitT)/.3;r<1&&(l*=1+.3*(1-r)*(1-r))}a.scale.setScalar(o*gt.markScale*l);const h=Wt?Ws:Ae,p=h[Math.min(i,h.length-1)];if(this.fx.visible){const r=this.fx.material.uniforms;r.uTime.value=performance.now()/1e3,r.uPhase.value=t==="preview"?0:t==="countdown"?1:t==="locked"?3:t==="miss"?4:2,r.uProg.value=e,r.uFade.value=p,r.uStrong.value=this.strongPreview?1:0,r.uW.value=Tt.core,r.uHalo.value=Tt.halo,r.uPool.value=Tt.pool,r.uSweepA.value=Tt.sweep,r.uNoise.value=Tt.wobble,r.uUIAmt&&(r.uUIOrigin.value.set(Y.ox,0,Y.oz),r.uUIFwd.value.set(Y.fx,0,Y.fz),r.uUIRight.value.set(Y.rx,0,Y.rz),r.uUIHalfL.value=Y.halfL,r.uUIHalfW.value=Y.halfW,r.uUIFeather.value=Y.feather,r.uUIAmt.value=this.surface==="wall"?0:Y.amt);const v=t==="linger"?1+.9*Math.max(0,1-e*2.2):1;r.uGain.value=this._baseGain*N.gainBoost*(Wt?1.35:1)*v;const u=1;r.uDay.value!==u&&(r.uDay.value=u,this.fx.material.blending=qt,this.fx.material.needsUpdate=!0)}if(this.num&&(this.num.material.opacity=N.hideOrderNums&&!this._numFoot?0:t==="preview"?(this.strongPreview?1:.5)*p:t==="countdown"?1:t==="linger"?.4*(1-e):t==="locked"?.48*p:t==="miss"?.3*(1-e):1),this.num&&this.fx?.material?.uniforms?.uHT){const r=this.fx.material.uniforms,v=r.uHT.value>.5;r.uNumOn.value=v&&this.num.material.opacity>.01?1:0,r.uNumOff.value.set(this.num.position.x/(this.radius*1.39),this.num.position.y/(this.radius*1.39)),v?this.num.visible=!1:this.num.visible||(this.num.visible=!0)}if(this.num&&this._isFoot&&N.numFoot){const r=N.numFoot,v=r[N.footCtx==="in"?"in":"out"]||r.L||(r.R?{x:1-r.R.x,y:r.R.y,s:r.R.s}:null);if(v){const u=re.anchor(v,this._footRight,ye*oe);this.num.position.set(u.x,u.y,.004),this.num.scale.setScalar(u.s)}}}}const Ut=[];function Se(n,{tips:t=1,wall:e=!1}={}){const i=new j,o=document.createElement("canvas");o.width=128,o.height=256;const a=new B(o);a.colorSpace=Z,a.anisotropy=4;const s=new A(new K(n*.5,n),new _t({map:a,transparent:!0,depthWrite:!1,blending:Mt}));return s.position.y=n/2,i.add(s),i._len=n,i._canvas=o,i._tex=a,i._mesh=s,i._paintT=-9,i._noTip=t===0,i._tips=[],e?(i.rotation.x=0,i.position.y=0):(i.rotation.x=-Math.PI/2,i.position.y=.014),i.renderOrder=6,i._wall=!!e,Ut.push(i),i}function Vs(n,t,e=0){const i=n?._fp;if(!i)return 1;const o=(u,x,U)=>{const C=Math.max(0,Math.min(1,(U-u)/(x-u)));return C*C*(3-2*C)},a=.25+e,s=t.x-i.ox,l=t.z-i.oz,h=s*i.fx+l*i.fz,p=s*i.rx+l*i.rz,r=Math.max(0,Math.min(1,(h-n.fpNear)/Math.max(.01,n.fpFar-n.fpNear))),v=n._halfAt(n.fpNear)+(n._halfAt(n.fpFar)-n._halfAt(n.fpNear))*r;return o(n.fpNear,n.fpNear+a,h)*o(n.fpFar,n.fpFar-a,h)*o(v,v-a,Math.abs(p))}function ta(n,t){tt.map.TIP_TRI||(tt.map.TIP_TRI="./ready-view/assets/arrow_tip.svg",tt.set(tt.map)),tt.map.LIFT_TIP||(tt.map.LIFT_TIP="./ready-view/assets/lift_tip.svg",tt.set(tt.map));const e=1,i={lut:yi,glyph:Re,arrow:N.arrow||{}};for(let o=Ut.length-1;o>=0;o--){const a=Ut[o];if(!a.parent){Ut.splice(o,1);continue}n-a._paintT>=1/24&&(a._paintT=n,Ve(a._canvas.getContext("2d"),128,256,n,i,{noTip:a._noTip,prog:a._prog}),a._tex.needsUpdate=!0);const s=t?._fp,l=a._mesh.material;if(s&&!a._wall){const h=v=>Vs(t,v),p=new b,r=new b;a.getWorldPosition(p),a._mesh.getWorldPosition(r),r.multiplyScalar(2).sub(p),l.opacity=Math.min(h(p),h(r))*(a._gain??1)}else l.opacity=a._gain??1;l._day!==e&&(l._day=e,l.blending=qt,l.needsUpdate=!0)}}class ea{constructor(t,e){this.scene=t,this.effects=e,this.params={lead:.7,size:1,maxVisible:3},this.root=new j,t.add(this.root),this.floorRoot=new j,this.wallRoot=new j,this.root.add(this.floorRoot,this.wallRoot),this.events=[],this.ambient=[],this.pack=null,this.layout=null,this.duration=0,this.onEvent=null,this.footprintTest=null,this.gazeTest=null,this.stats={inGaze:0,total:0},this.floorClip=null,this.wallClip=null}_applyClip(t,e){e&&t.traverse(i=>{i.material&&(i.material.clippingPlanes=e)})}_floorClipFor(){return this.layoutPreview?null:this.floorClip}setCompare(t){if(this._compareRoot){for(const s of this._compareRoot)s.removeFromParent();this._compareRoot=null}if(!t||!this.pack||t.sport!==this.pack.sport)return;const e=new j,i=new j,o=Xs(10134445),a=()=>new _t({map:o,transparent:!0,opacity:.5,depthWrite:!1});for(const s of t.tokens)if(s.type==="stepMark"){const l=this._mapFloor(s),h=new A(new K(.4,.4),a());h.rotation.x=-Math.PI/2,h.position.set(l.x,.011,l.z),h.renderOrder=3,this._applyClip(h,this._floorClipFor()),e.add(h)}else if(s.type==="targetMark"&&this.pack.hasWall){const l=this._mapWall(s),h=new A(new K(.34,.34),a());h.position.set(l.x,l.y,l.z-.005),h.renderOrder=3,this._applyClip(h,this.wallClip),i.add(h)}this.floorRoot.add(e),this.wallRoot.add(i),this._compareRoot=[e,i]}recolor(){for(const t of this.events)if(t.marker){const e=et[t.marker.role]??et.left;t.marker.color=e,t.color=e}}setParams(t){Object.assign(this.params,t)}setPack(t){this.floorRoot.clear(),this.wallRoot.clear(),this._compareRoot=null,this.laneFX=null,this.floorRoot.position.set(0,0,0),this.events=[],this.ambient=[],this.pack=t,this.layout=js[t.sport],this.duration=t.duration;const e=this.layout,i=new Map;for(const a of t.tokens){if(a.type==="pathLane"||a.lifetime>=t.duration*.85){this.ambient.push(a);continue}const l=Math.round(a.t*1e3);i.has(l)||i.set(l,{t:a.t,tokens:[]}),i.get(l).tokens.push(a)}const o=t.sport==="boxing";for(const a of[...i.values()].sort((s,l)=>s.t-l.t)){const s={t:a.t,fired:!1,marker:null,arrow:null,surface:"floor",pos:new b,color:16777215,foot:null};let l=null;for(const h of a.tokens)if(!(o&&(h.type==="orderPulse"&&(l=h.n),h.type!=="targetMark"))){if(h.type==="stepMark"||h.type==="targetMark"||h.type==="orderPulse"&&!s.marker){const p=h.type==="targetMark"&&this.pack.hasWall,r=h.type==="targetMark"?et.target:et[h.foot]??et.left,v=h.radiusCm?h.radiusCm/100:h.type==="targetMark"?Vt.loose:Vt.base,u=new Pe(v,r,p?"wall":"floor",h.foot==="right");!p&&(h.contract&&h.contract!=="reach"||h.holdRing)&&u.setContract(h.contract),u.role=h.type==="targetMark"?"target":h.foot??"left",s.marker=u,s.surface=p?"wall":"floor",s.color=r,s.foot=h.foot??null,s.srcToken=h,(p?this.wallRoot:this.floorRoot).add(u.group),this._applyClip(u.group,p?this.wallClip:this._floorClipFor())}if(h.type==="orderPulse"&&s.marker&&!s.marker.num&&!s.marker._skipNumber&&s.marker.setNumber(h.n),h.type==="directionGuide"){const p=Se(t.sport==="basketball"?.9:.55),r=this._mapFloor(h);p.position.x=r.x,p.position.z=r.z,p.rotation.z=Fe.degToRad(-(h.angle??0)),s.arrow={obj:p,t:h.t,lifetime:h.lifetime},this.floorRoot.add(p),this._applyClip(p,this._floorClipFor())}}o&&s.marker&&l!=null&&!s.marker.num&&(s.marker.setNumber(l),this._applyClip(s.marker.group,this.wallClip)),(s.marker||s.arrow)&&this.events.push(s)}if(t.sport==="basketball"){const a=this.events.filter(s=>s.surface==="floor"&&s.marker).sort((s,l)=>s.t-l.t);for(let s=0;s<a.length;s++){const l=a[s],h=a[s+1],p=a[s-1],r=this._mapFloor(l.srcToken);if(l.arrow&&h){const v=this._mapFloor(h.srcToken),u=v.x-r.x,x=v.z-r.z;l.arrow.obj.rotation.z=Math.atan2(-u,-x),l.arrow.obj.position.x=r.x,l.arrow.obj.position.z=r.z}if(p){const v=this._mapFloor(p.srcToken);let u=r.x-v.x,x=r.z-v.z;const U=Math.hypot(u,x)||1;u/=U,x/=U;const C=new j,M=Math.atan2(-u,-x);for(let F=0;F<3;F++){const T=Se(.5,{tips:0});T.rotation.z=M+Math.PI/2,T.position.set(r.x-u*(.4+F*.24),.011,r.z-x*(.4+F*.24)),T.renderOrder=4,T._gain=.55-F*.13,C.add(T)}l.stripes=C,this.floorRoot.add(C),this._applyClip(C,this._floorClipFor())}}}for(const a of this.ambient)if(a.type==="pathLane"&&this._buildLane(t),a.type==="stepMark"&&!o){const s=new Pe(Vt.base,et[a.foot]??et.left,"floor");s.role=a.foot??"left";const l=this._mapFloor(a);s.group.position.x=l.x,s.group.position.z=l.z,s.render("preview",0,0,1),s.isStance=!0,this.floorRoot.add(s.group),this._applyClip(s.group,this._floorClipFor()),this.stanceMarks=this.stanceMarks||[],this.stanceMarks.push(s)}{const a=(t.tokens||[]).filter(l=>l.type==="stepMark"&&l.t!=null).map(l=>l.t).sort((l,h)=>l-h),s=[];for(let l=1;l<a.length;l++){const h=a[l]-a[l-1];h>.05&&s.push(h)}s.sort((l,h)=>l-h),this._beatT=s.length?s[Math.floor(s.length/2)]:0,this._strideM=e.mode==="advance"&&this._beatT?e.V*this._beatT:0}if(o&&this.pack.hasWall){const a=this.events.filter(s=>s.surface==="wall"&&s.marker).sort((s,l)=>s.t-l.t);if(a.forEach((s,l)=>{!s.marker.num&&!s.marker._skipNumber&&s.marker.setNumber(l+1)}),a.length){const s=a.reduce((v,u)=>v+this._mapWall(u.srcToken).y,0)/a.length,l=this.layout.WALL,h=new ge(new Ht().setFromPoints([new b(-l.XS*.72,s,mt+.012),new b(l.XS*.72,s,mt+.012)]),new ve({color:16696201,dashSize:.05,gapSize:.07,transparent:!0,opacity:.3}));h.computeLineDistances(),this.wallRoot.add(h),this._applyClip(h,this.wallClip);const p=Ks(`타깃 ${Math.round(s*100)}cm`),r=new A(new K(p.aspect*.075,.075),new _t({map:p.tex,transparent:!0,opacity:.55,depthWrite:!1}));r.position.set(l.XS*.72-p.aspect*.075/2,s+.065,mt+.012),this.wallRoot.add(r),this._applyClip(r,this.wallClip)}}}_mapFloor(t){const e=this.layout;if(e.mode==="spatial")return{x:t.nx*e.SCALE,z:t.ny*e.SCALE};if(e.mode==="static")return{x:t.nx*e.FLOOR_SCALE,z:-t.ny*e.FLOOR_SCALE+(this.stanceOffsetZ||0)};const i=e.CAL&&e.CAL[t.foot]||{x:0,z:0};return{x:t.nx*e.X_SCALE+i.x,z:-e.V*t.t-e.STRIKE_AHEAD+i.z}}_mapWall(t){const e=this.layout.WALL;return{x:t.nx*e.XS,y:e.Y0+t.ny*e.YS,z:mt+.02}}_buildLane(t){const e=this.layout;if(e.mode==="advance"){const i=e.V*t.duration+3+1.2,o=new A(new K(.55,i),Hs(i));o.rotation.x=-Math.PI/2,o.position.set(0,.01,1.2-i/2),o.renderOrder=3,this.floorRoot.add(o),this._applyClip(o,this._floorClipFor()),this.laneFX=o}else if(e.mode==="spatial"){const i=this.pack.tokens.filter(o=>o.type==="stepMark").sort((o,a)=>o.t-a.t).map(o=>new b(o.nx*e.SCALE,.012,o.ny*e.SCALE));if(i.length>=2){const o=new xi(i),a=new Ht().setFromPoints(o.getPoints(60)),s=new ge(a,new ve({color:et.lane,dashSize:.14,gapSize:.1,transparent:!0,opacity:.7}));s.computeLineDistances(),this.floorRoot.add(s),this._applyClip(s,this._floorClipFor())}}}resetLoop(){for(const t of this.events)t.fired=!1,t._wasVisible=!1,t._verdict=null;this.stats={inGaze:0,total:0}}setShake(t,e){this.floorRoot.position.x=t,this.floorRoot.position.z=e+(this.loopShiftZ||0)}update(t,e){const{lead:i,size:o,maxVisible:a}=this.params;if(!this.layout)return;if(this.laneFX){const r=this.laneFX.material.uniforms,v=N.arrow||{};if(r.uTime.value=performance.now()/1e3,r.uW.value=N.graphics.width*(v.w||1),r.uHalo.value=N.graphics.halo*(v.glow??1),r.uGain.value=N.gainBoost*(Wt?1.25:1),r.uLStyle.value=Is[N.lane&&N.lane.style||"dash"]??1,r.uLSpeed.value=v.speed??1,r.uLGap.value=v.gap??1,this.pack?.sport==="running"&&this._beatT>0&&this._strideM>0){const U=r.uLStyle.value;if(U===1||U===2){const C=U===1?9:12;r.uLGap.value=C*this._strideM/(2*Math.PI),r.uLSpeed.value=2*Math.PI/(5.2*this._beatT)}}r.uLHeat.value=v.heat??.5,r.uLTail.value=v.tail??.55;const u=N.day||N.markBlend==="ink"?1:0;r.uDay.value!==u&&(r.uDay.value=u,this.laneFX.material.blending=u?qt:Mt,this.laneFX.material.needsUpdate=!0);const x=this.rig?._fp;x&&(r.uFPOrigin.value.set(x.ox,0,x.oz),r.uFPFwd.value.set(x.fx,0,x.fz),r.uFPRight.value.set(x.rx,0,x.rz),r.uFPNear.value=this.rig.fpNear,r.uFPFar.value=this.rig.fpFar,r.uFPHalfN.value=this.rig._halfAt(this.rig.fpNear),r.uFPHalfF.value=this.rig._halfAt(this.rig.fpFar))}const l=this.rig?._fp;if(l){const r=this.rig._halfAt(this.rig.fpNear),v=this.rig._halfAt(this.rig.fpFar);for(const u of this.events){const x=u.marker?.fx?.material?.uniforms;!x||!x.uFPNear||(x.uFPOrigin.value.set(l.ox,0,l.oz),x.uFPFwd.value.set(l.fx,0,l.fz),x.uFPRight.value.set(l.rx,0,l.rz),x.uFPNear.value=this.rig.fpNear,x.uFPFar.value=this.rig.fpFar,x.uFPHalfN.value=r,x.uFPHalfF.value=v)}}const h=this.events.filter(r=>r.t>=t-gt.linger),p=new Map;h.forEach((r,v)=>p.set(r,v));for(const r of this.events){const v=p.get(r)??99;let u="hidden",x=0;const U=gt.linger+.6;r._verdict==="miss"&&t>=r.t&&t<r.t+U?(u="miss",x=(t-r.t)/U,r.fired||(r.fired=!0,this._fire(r))):t>=r.t&&t<r.t+gt.linger?(u="linger",x=(t-r.t)/gt.linger,r.fired||(r.fired=!0,this._fire(r))):t>=r.t-i&&t<r.t?(u="countdown",x=(t-(r.t-i))/i):t<r.t-i&&(u=v<a?"preview":"locked"),this.layoutPreview&&r.surface!=="wall"&&(u="preview"),this.liveHideFloorMarks&&r.surface!=="wall"&&(u="hidden"),this.laneFX&&(this.laneFX.visible=!this.liveHideLane);const C=r.marker;if(C?.num&&r.surface!=="wall"&&r.foot){const M=!!N.hideOrderNums;M!==!!C._numFoot&&(C._numFoot=M,C.num.material.map=M?Bs(r.foot==="right"):De(C._numN??""),C.num.material.needsUpdate=!0)}if(r.marker){if(r.surface==="wall"){const F=this._mapWall(r.srcToken);r.marker.group.position.set(F.x,F.y,F.z)}else{const F=this._mapFloor(r.srcToken);if(r.marker.group.position.set(F.x,.012,F.z),this.footprintTest&&u!=="hidden"&&!this.layoutPreview){const T=F.x+this.floorRoot.position.x,q=F.z+this.floorRoot.position.z,bt=r.marker.radius*o*1.15;this.footprintTest(T,q,bt)||(u="hidden");const $=u==="preview"||u==="countdown";if($&&!r._wasVisible){const Ft=this.gazeTest?this.gazeTest(T,q):!0;this.stats.total++,Ft&&this.stats.inGaze++}r._wasVisible=$}}u==="preview"&&v>=a&&!this.layoutPreview&&(u="hidden");const M=this.layoutPreview?0:Math.min(v,Ae.length-1);r.marker.strongPreview=this.layoutPreview,r.marker.render(u,x,M,o),r.stripes&&(r.stripes.visible=u==="countdown"||u==="linger")}if(r.arrow){const M=r.arrow;let F=this.layoutPreview||t>=M.t-i&&t<M.t+M.lifetime;if(F&&this.footprintTest&&!this.layoutPreview&&(F=this.footprintTest(M.obj.position.x+this.floorRoot.position.x,M.obj.position.z+this.floorRoot.position.z)),M.obj.visible=F,F){const q=.35+.55*(this.layoutPreview?1:Math.min(1,(t-(M.t-i))/Math.max(i,.001)));M.obj._gain=q,M.obj.scale.setScalar(o)}}}}_fire(t){if(t.surface!=="wall"&&!this.floorRoot.visible)return;const e=t.t<.15,i=t.marker?t.marker.group.getWorldPosition(new b):new b,o=t.surface==="wall"?new b(0,0,1):new b(0,1,0),a=t.srcToken?.design?.burst,s=a&&a.on?{...a}:{};t.surface==="wall"&&(s.sizeM=(t.marker?.radius??.15)*3.4,s.intensity=(s.intensity??1)*.8,s.speed=(s.speed??1)*1.35),t.surface!=="wall"&&this.layout?.mode==="advance"&&(s.forward=!0,i.z-=.18,s.intensity=(s.intensity??1)*1.7,s.rings=Math.max(s.rings??1,1.8)),e||this.effects.burst(i,t.color,o,s),this.onEvent&&this.onEvent(t)}studioBurst(t){if(!this.layout||!t)return;const e=this._mapFloor({nx:t.nx,ny:t.ny??0,t:t.t,foot:t.foot}),i=new b(e.x+this.floorRoot.position.x,.02,e.z+this.floorRoot.position.z),o=t.design?.burst,a=t.design?.fill?.c0||"#fa3030";this.effects.burst(i,a,new b(0,1,0),{...o&&o.on?o:{},noClip:!0})}}export{Js as B,et as C,ye as F,y as L,Tt as M,Ti as O,ea as T,Y as U,mt as W,js as a,Vs as b,Hs as c,Se as d,qs as e,gt as f,O as g,zs as m,$s as s,ta as t};
