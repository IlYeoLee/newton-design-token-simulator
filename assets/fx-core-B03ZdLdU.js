import{v as g,P as H,N as X}from"./palette-Bj20GXDn.js";const h0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",u0=.98,f0=.83,p0=-.043,m0=-.031,w0=5.5,S0=.027,x0=.25,C0=.26,b0=.3,I0=.92,v0=.038,A0=1,R0=24,M0=1,T0=.95,y0=.45,L0=.88,P0=0,_0=.5,k0=.34,D0=.1,B0=.4,F0=1,E0=1.4,G0=0,O0=3.4,U0=.01,H0=0,q0=.011,W0=-2,g0=.75,K0=-.07,$0=.12,X0=4,j0=.6,J0=0,Y0=1,Q0="none",z0="add",Z0="offbit",V0=.55,N0=.14,tt=.5,at=4,ot=2,et=1,lt=.32,nt=1,st={punchLine:{node:1.58,numS:1,comet:1,tailLen:.71,rail:.6}},rt=-.095,it=.12,ct=10,dt=-.015,ht=.12,ut=-10,ft={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.9,edgeShadeW:2.45,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0},pt={_:h0,imp:u0,scale:f0,offx:p0,offy:m0,irot:w0,pitch:S0,dot:x0,glow:C0,shade:b0,sharp:I0,edge:v0,plantar:A0,bands:R0,bandSoft:M0,w:T0,halo:y0,pool:L0,noise:P0,rip:_0,ripReach:k0,ripWidth:D0,ripSpeed:B0,ripGrad:F0,edgeShade:E0,shadeRed:G0,shadeRedW:O0,edgeW:U0,edgeSoft:H0,dither:q0,tilt:W0,gsize:g0,gx:K0,gy:$0,grot:X0,gsh:j0,shadeCol:J0,ripCol:Y0,gShadow:Q0,gBlend:z0,numSrc:Z0,prog:V0,bloom:N0,blur:tt,edgeShadeW:at,edgeShadeCol:ot,edgeShadeGrad:et,edgeShadeG0:lt,edgeShadeG1:nt,prims:st,gxL:rt,gyL:it,grotL:ct,gxR:dt,gyR:ht,grotR:ut,tap:ft};function l0(t,a,o,i,n){let l=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let r=1;r<n;r++){let h=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);for(;h<=i[l];)l--,h=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);l++,o[l]=r,i[l]=h,i[l+1]=1e20}l=0;for(let r=0;r<n;r++){for(;i[l+1]<r;)l++;a[r]=(r-o[l])*(r-o[l])+t[o[l]]}}function n0(t,a){const o=new Float32Array(a),i=new Int32Array(a),n=new Float32Array(a+1),l=new Float32Array(a);for(let r=0;r<a;r++){for(let h=0;h<a;h++)l[h]=t[h*a+r];l0(l,o,i,n,a);for(let h=0;h<a;h++)t[h*a+r]=o[h]}for(let r=0;r<a;r++){for(let h=0;h<a;h++)l[h]=t[r*a+h];l0(l,o,i,n,a);for(let h=0;h<a;h++)t[r*a+h]=o[h]}}function i0(t,a){const i=new Float32Array(a*a),n=new Float32Array(a*a);let l=0,r=0,h=0;for(let x=0;x<a*a;x++){const d=t[x*4+3]/255;i[x]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),n[x]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(l+=x%a,r+=x/a|0,h++)}n0(i,a),n0(n,a);const f=new Float32Array(a*a);for(let x=0;x<a*a;x++)f[x]=(Math.sqrt(i[x])-Math.sqrt(n[x]))/a;return{data:f,N:a,cx:h?l/h/a:.5,cy:h?r/h/a:.5}}function Z(t,a=512){const o="_raster"+a;if(t[o])return t[o];const i=document.createElement("canvas");i.width=i.height=a;const n=i.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);n.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const r=n.getImageData(0,0,a,a).data;let h=a,f=a,x=-1,d=-1;for(let u=0;u<a;u++)for(let e=0;e<a;e++)r[(u*a+e)*4+3]>8&&(e<h&&(h=e),e>x&&(x=e),u<f&&(f=u),u>d&&(d=u));return t[o]=x<0?{canvas:i,x:0,y:0,w:a,h:a}:{canvas:i,x:h,y:f,w:x-h+1,h:d-f+1},t[o]}function It(t,a,o=!1){const i=Z(t,a),n=document.createElement("canvas");n.width=n.height=a;const l=n.getContext("2d"),r=Math.min(a*$/i.w,a*$/i.h),h=i.w*r,f=i.h*r;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(i.canvas,i.x,i.y,i.w,i.h,(a-h)/2,(a-f)/2,h,f),i0(l.getImageData(0,0,a,a).data,a)}function vt(t,a,o,i=!1){const n=Z(t,o),l=a?Z(a,o):null,r=Math.min(o*$/n.w,o*$/n.h),h=n.w*r,f=n.h*r,x=(o-h)/2,d=(o-f)/2,u=I=>{const P=document.createElement("canvas");P.width=P.height=o;const R=P.getContext("2d");return i&&(R.translate(0,o),R.scale(1,-1)),R.drawImage(I.canvas,n.x,n.y,n.w,n.h,x,d,h,f),i0(R.getImageData(0,0,o,o).data,o)},e=u(n),c=l?u(l):null,s=new Float32Array(o*o*2);for(let I=0;I<o*o;I++)s[I*2]=e.data[I],s[I*2+1]=c?c.data[I]:1;return{data:s,N:o,cx:e.cx,cy:e.cy,inCx:c?c.cx:e.cx,inCy:c?c.cy:e.cy,hasInner:!!c}}const At=1.9922,mt=.78,$=.52,Rt=mt/$,Mt=1.18,O=pt||{},c0={size:O.gsize??.85,gx:O.gx??-.025,gy:O.gy??.195,rot:O.grot??6,gxL:O.gxL,gyL:O.gyL,rotL:O.grotL,gxR:O.gxR,gyR:O.gyR,rotR:O.grotR,shadow:O.gShadow??"glow",shadowK:O.gsh??.75,blend:O.gBlend??"add"};function Tt(t,a=c0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function yt(t,a,o,i,n=c0){const l=Math.round(o*.75),r=n.shadow==="none"?0:n.shadowK??.75,h=f=>i(t,String(a),o/2,o/2,l,f);return n.shadow==="drop"&&r>.001?(t.save(),t.globalAlpha=Math.min(1,r*.7),t.translate(o*.018,o*.024),h({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),h({glow:0,glowColor:"rgba(0,0,0,0)"})):h(n.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),n.blend==="knock"}function Lt(t,a){const o=t.getImageData(0,0,a,a),i=t.createImageData(a,a);for(let n=0;n<a*a;n++){const l=o.data[n*4+3]/255,r=Math.round(255*(1-l));i.data[n*4]=i.data[n*4+1]=i.data[n*4+2]=r,i.data[n*4+3]=255}t.putImageData(i,0,0)}const Pt={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},Q=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),z=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function s0(t,a,o){t=Q(t),a=Q(a),o=Q(o);const i=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),n=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*i+.793617785*n-.0040720468*l,1.9779984951*i-2.428592205*n+.4505937099*l,.0259040371*i+.7827717662*n-.808675766*l]}function wt(t,a,o){const i=(t+.3963377774*a+.2158037573*o)**3,n=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[z(4.0767416621*i-3.3077115913*n+.2309699292*l),z(-1.2684380046*i+2.6097574011*n-.3413193965*l),z(-.0041960863*i-.7034186147*n+1.707614701*l)]}const r0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function _t(t,a=1,o=new Uint8Array(256*4)){const i=[...t].sort((n,l)=>n[1]-l[1]);for(let n=0;n<256;n++){const l=n/255;let r=0;for(;r<i.length-2&&l>i[r+1][1];)r++;const[h,f]=i[r],[x,d]=i[r+1],u=Math.max(0,Math.min(1,(l-f)/Math.max(1e-5,d-f))),e=s0(...r0(h)),c=s0(...r0(x)),s=wt(e[0]+(c[0]-e[0])*u,(e[1]+(c[1]-e[1])*u)*a,(e[2]+(c[2]-e[2])*u)*a);o.set([...s,255],n*4)}return o}const kt=`
