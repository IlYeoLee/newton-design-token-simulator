const G={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},K={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},i0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],Rt=Object.fromEntries(Object.entries({...G,...K}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),g=t=>`vec3(${i0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,Tt=(t,a=1)=>`rgba(${i0(t).join(",")},${a})`,u0=[[G.red,0],[G.red,.3],[G.coral,.56],[G.sand,.86],[G.prism,1]],f0=1;function p0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(K).some(o=>o.toUpperCase()===a)?!0:Object.values(G).some(o=>o.toUpperCase()===a)}function Mt(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>p0(o)))&&(t.stops=u0.map(o=>[...o])),t.sat=f0,t)}const m0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",w0=.98,x0=.83,S0=-.043,C0=-.031,b0=5.5,I0=.027,v0=.25,A0=.26,R0=.3,T0=.92,M0=.038,y0=1,L0=24,P0=1,_0=.95,k0=.45,D0=.88,F0=0,B0=.5,E0=.34,G0=.1,O0=.4,U0=1,H0=1.4,q0=0,W0=3.4,g0=.01,K0=0,$0=.011,j0=-2,X0=.75,J0=-.07,Y0=.12,Q0=4,z0=.6,Z0=0,V0=1,N0="none",tt="add",at="offbit",ot=.55,et=.14,lt=.5,nt=4,st=2,rt=1,it=.32,ct=1,dt={punchLine:{node:1.58,numS:1,comet:1,tailLen:.71,rail:.6}},ht=-.095,ut=.12,ft=10,pt=-.015,mt=.12,wt=-10,xt={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.9,edgeShadeW:2.45,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:0,edgeShadeCol:0,dotCol:0,ripCol:0},St={_:m0,imp:w0,scale:x0,offx:S0,offy:C0,irot:b0,pitch:I0,dot:v0,glow:A0,shade:R0,sharp:T0,edge:M0,plantar:y0,bands:L0,bandSoft:P0,w:_0,halo:k0,pool:D0,noise:F0,rip:B0,ripReach:E0,ripWidth:G0,ripSpeed:O0,ripGrad:U0,edgeShade:H0,shadeRed:q0,shadeRedW:W0,edgeW:g0,edgeSoft:K0,dither:$0,tilt:j0,gsize:X0,gx:J0,gy:Y0,grot:Q0,gsh:z0,shadeCol:Z0,ripCol:V0,gShadow:N0,gBlend:tt,numSrc:at,prog:ot,bloom:et,blur:lt,edgeShadeW:nt,edgeShadeCol:st,edgeShadeGrad:rt,edgeShadeG0:it,edgeShadeG1:ct,prims:dt,gxL:ht,gyL:ut,grotL:ft,gxR:pt,gyR:mt,grotR:wt,tap:xt};function l0(t,a,o,i,n){let l=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let r=1;r<n;r++){let h=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);for(;h<=i[l];)l--,h=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);l++,o[l]=r,i[l]=h,i[l+1]=1e20}l=0;for(let r=0;r<n;r++){for(;i[l+1]<r;)l++;a[r]=(r-o[l])*(r-o[l])+t[o[l]]}}function n0(t,a){const o=new Float32Array(a),i=new Int32Array(a),n=new Float32Array(a+1),l=new Float32Array(a);for(let r=0;r<a;r++){for(let h=0;h<a;h++)l[h]=t[h*a+r];l0(l,o,i,n,a);for(let h=0;h<a;h++)t[h*a+r]=o[h]}for(let r=0;r<a;r++){for(let h=0;h<a;h++)l[h]=t[r*a+h];l0(l,o,i,n,a);for(let h=0;h<a;h++)t[r*a+h]=o[h]}}function c0(t,a){const i=new Float32Array(a*a),n=new Float32Array(a*a);let l=0,r=0,h=0;for(let S=0;S<a*a;S++){const d=t[S*4+3]/255;i[S]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),n[S]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(l+=S%a,r+=S/a|0,h++)}n0(i,a),n0(n,a);const f=new Float32Array(a*a);for(let S=0;S<a*a;S++)f[S]=(Math.sqrt(i[S])-Math.sqrt(n[S]))/a;return{data:f,N:a,cx:h?l/h/a:.5,cy:h?r/h/a:.5}}function Z(t,a=512){const o="_raster"+a;if(t[o])return t[o];const i=document.createElement("canvas");i.width=i.height=a;const n=i.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);n.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const r=n.getImageData(0,0,a,a).data;let h=a,f=a,S=-1,d=-1;for(let u=0;u<a;u++)for(let e=0;e<a;e++)r[(u*a+e)*4+3]>8&&(e<h&&(h=e),e>S&&(S=e),u<f&&(f=u),u>d&&(d=u));return t[o]=S<0?{canvas:i,x:0,y:0,w:a,h:a}:{canvas:i,x:h,y:f,w:S-h+1,h:d-f+1},t[o]}function yt(t,a,o=!1){const i=Z(t,a),n=document.createElement("canvas");n.width=n.height=a;const l=n.getContext("2d"),r=Math.min(a*j/i.w,a*j/i.h),h=i.w*r,f=i.h*r;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(i.canvas,i.x,i.y,i.w,i.h,(a-h)/2,(a-f)/2,h,f),c0(l.getImageData(0,0,a,a).data,a)}function Lt(t,a,o,i=!1){const n=Z(t,o),l=a?Z(a,o):null,r=Math.min(o*j/n.w,o*j/n.h),h=n.w*r,f=n.h*r,S=(o-h)/2,d=(o-f)/2,u=I=>{const P=document.createElement("canvas");P.width=P.height=o;const R=P.getContext("2d");return i&&(R.translate(0,o),R.scale(1,-1)),R.drawImage(I.canvas,n.x,n.y,n.w,n.h,S,d,h,f),c0(R.getImageData(0,0,o,o).data,o)},e=u(n),c=l?u(l):null,s=new Float32Array(o*o*2);for(let I=0;I<o*o;I++)s[I*2]=e.data[I],s[I*2+1]=c?c.data[I]:1;return{data:s,N:o,cx:e.cx,cy:e.cy,inCx:c?c.cx:e.cx,inCy:c?c.cy:e.cy,hasInner:!!c}}const Pt=1.9922,Ct=.78,j=.52,_t=Ct/j,kt=1.18,U=St||{},d0={size:U.gsize??.85,gx:U.gx??-.025,gy:U.gy??.195,rot:U.grot??6,gxL:U.gxL,gyL:U.gyL,rotL:U.grotL,gxR:U.gxR,gyR:U.gyR,rotR:U.grotR,shadow:U.gShadow??"glow",shadowK:U.gsh??.75,blend:U.gBlend??"add"};function Dt(t,a=d0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function Ft(t,a,o,i,n=d0){const l=Math.round(o*.75),r=n.shadow==="none"?0:n.shadowK??.75,h=f=>i(t,String(a),o/2,o/2,l,f);return n.shadow==="drop"&&r>.001?(t.save(),t.globalAlpha=Math.min(1,r*.7),t.translate(o*.018,o*.024),h({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),h({glow:0,glowColor:"rgba(0,0,0,0)"})):h(n.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),n.blend==="knock"}function Bt(t,a){const o=t.getImageData(0,0,a,a),i=t.createImageData(a,a);for(let n=0;n<a*a;n++){const l=o.data[n*4+3]/255,r=Math.round(255*(1-l));i.data[n*4]=i.data[n*4+1]=i.data[n*4+2]=r,i.data[n*4+3]=255}t.putImageData(i,0,0)}const Et={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},Q=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),z=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function s0(t,a,o){t=Q(t),a=Q(a),o=Q(o);const i=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),n=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*i+.793617785*n-.0040720468*l,1.9779984951*i-2.428592205*n+.4505937099*l,.0259040371*i+.7827717662*n-.808675766*l]}function bt(t,a,o){const i=(t+.3963377774*a+.2158037573*o)**3,n=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[z(4.0767416621*i-3.3077115913*n+.2309699292*l),z(-1.2684380046*i+2.6097574011*n-.3413193965*l),z(-.0041960863*i-.7034186147*n+1.707614701*l)]}const r0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function Gt(t,a=1,o=new Uint8Array(256*4)){const i=[...t].sort((n,l)=>n[1]-l[1]);for(let n=0;n<256;n++){const l=n/255;let r=0;for(;r<i.length-2&&l>i[r+1][1];)r++;const[h,f]=i[r],[S,d]=i[r+1],u=Math.max(0,Math.min(1,(l-f)/Math.max(1e-5,d-f))),e=s0(...r0(h)),c=s0(...r0(S)),s=bt(e[0]+(c[0]-e[0])*u,(e[1]+(c[1]-e[1])*u)*a,(e[2]+(c[2]-e[2])*u)*a);o.set([...s,255],n*4)}return o}const Ot=`
...
#define C_RED   ${g(G.red)}
#define C_CORAL ${g(G.coral)}
#define C_SAND  ${g(G.sand)}
#define C_ICE   ${g(G.prism)}
#define C_CREAM C_SAND
#define C_GRAYF ${g(K.hi)}
#define C_GRAYL ${g(K.lo)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function It(t,a,o,i){t.lineWidth=4*a;const n=i.arrow;n.line==="dash"?t.setLineDash([12*a*n.gap,10*n.gap]):n.line==="dot"?(t.setLineDash([.5,12*n.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&n.line!=="solid"&&n.line!=="taper"&&(t.lineDashOffset=-o*40*n.speed)}function Wt(t,a,o,i,n,l={}){const r=n.lut,h=n.arrow||{},f=h.w??1,S=h.speed??1,d=h.glow??1,u=l.pulse??1,e=o/256,c=e*(l.scale??1),s=a/2,I=i*.9*S%1,P=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,I/.55),R=l.prog!=null?1:I>.88?(1-I)/.12:1;t.clearRect(0,0,a,o);const w=R*(.45+.55*u),M=o-24*e,_=58*e,y=M+(_-M)*P,x=(T,D)=>r(T).replace("rgb(","rgba(").replace(")",`,${D.toFixed(3)})`),p=1.1*c*f,m=13*c*f,C=42*c*(.7+.3*f),k=!l.noTip&&P>.28?Math.min(1,(P-.28)/.22)*C*.42:0,v=y+k,b=t.createLinearGradient(0,M,0,v);if(b.addColorStop(0,x(.55,0)),b.addColorStop(.18,x(.64,.3*w)),b.addColorStop(.4,x(.76,.8*w)),b.addColorStop(.65,x(.88,.98*w)),b.addColorStop(1,x(.97,w)),t.save(),t.filter=`blur(${7*c}px)`,t.globalAlpha=.55,t.fillStyle=b,t.beginPath(),t.moveTo(s-p,M),t.lineTo(s+p,M),t.lineTo(s+m*.95,v),t.lineTo(s-m*.95,v),t.closePath(),t.fill(),t.restore(),t.globalAlpha=1,t.fillStyle=b,t.beginPath(),t.moveTo(s-p/2,M),t.lineTo(s+p/2,M),t.lineTo(s+m/2,v),t.lineTo(s-m/2,v),t.closePath(),t.fill(),t.globalAlpha=w,P>.28&&!l.noTip){const T=C,D=Math.min(1,(P-.28)/.22)*w,L=y+T*.3;t.globalAlpha=D;const B={color:r(.95),glowColor:r(.85),glow:12*d};n.glyph&&(n.glyph(t,"LIFT_TIP",s,L,T,B)||n.glyph(t,"TIP_TRI",s,L,T*.93,B))||(t.strokeStyle=r(.95),t.lineWidth=13*c*f,t.lineCap="round",t.lineJoin="round",t.shadowColor=r(.9),t.shadowBlur=18*c*d,t.beginPath(),t.moveTo(s-26*c,L+14*c),t.lineTo(s,L-16*c),t.lineTo(s+26*c,L+14*c),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function vt(t,a,o,i,n,l,r={}){const h=l.lut,f=l.arrow||{},S=f.w??1,d=f.glow??1,u=o/256*(r.scale??1);t.clearRect(0,0,a,o);const e=i.map(([x,p])=>[x*a,p*o]);if(e.length<2)return;const c=48,s=[],I=x=>{if(e.length===2)return[e[0][0]+(e[1][0]-e[0][0])*x,e[0][1]+(e[1][1]-e[0][1])*x];const p=x*(e.length-1),m=Math.min(e.length-2,Math.floor(p)),C=p-m,k=e[Math.max(0,m-1)],v=e[m],b=e[m+1],T=e[Math.min(e.length-1,m+2)],D=(L,B,E,q)=>.5*(2*B+(-L+E)*C+(2*L-5*B+4*E-q)*C*C+(-L+3*B-3*E+q)*C*C*C);return[D(k[0],v[0],b[0],T[0]),D(k[1],v[1],b[1],T[1])]};for(let x=0;x<=c;x++)s.push(I(x/c));const P=Math.max(0,Math.min(1,r.prog!=null?r.prog:n*.55%1)),R=Math.max(1,Math.round(c*P)),w=r.alpha??1,M=r.tail??.22;t.lineCap="round";const _=42*u*(.7+.3*S);let y=R;if(P>.28){let x=0;const p=_*.42*Math.min(1,(P-.28)/.22);for(;y>1&&x<p;)x+=Math.hypot(s[y][0]-s[y-1][0],s[y][1]-s[y-1][1]),y--}for(const x of[0,1])for(let p=1;p<=y;p++){const m=p/R,C=Math.min(1,m/M),k=C*C*(3-2*C)*w;t.globalAlpha=x?k:k*.16*m,t.strokeStyle=h(.55+.42*m),t.lineWidth=(1.1+11.9*m)*u*S*(x?1:1.9),t.beginPath(),t.moveTo(s[p-1][0],s[p-1][1]),t.lineTo(s[p][0],s[p][1]),t.stroke()}if(P>.28){const x=s[Math.max(0,R-2)][0],p=s[Math.max(0,R-2)][1],m=Math.atan2(s[R][1]-p,s[R][0]-x)+Math.PI/2,C=s[R][0]-Math.sin(m)*_*.3,k=s[R][1]+Math.cos(m)*_*.3;t.save(),t.translate(C,k),t.rotate(m),t.globalAlpha=Math.min(1,(P-.28)/.22)*w;const v={color:h(.95),glowColor:h(.85),glow:12*d};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,_,v)||l.glyph(t,"TIP_TRI",0,0,_*.93,v))||(t.strokeStyle=h(.95),t.lineWidth=9*u*S,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*u,12*u),t.lineTo(0,-14*u),t.lineTo(18*u,12*u),t.stroke()),t.restore()}t.globalAlpha=1}function At(t,a,o,i,n,l){n=n||{};const r=l.lut,h=n.style||l.arrow.line,f=!!n.closed,S=[0];for(let c=1;c<a.length;c++)S.push(S[c-1]+Math.hypot(a[c][0]-a[c-1][0],a[c][1]-a[c-1][1]));const d=S[S.length-1]||1,u=c=>{c=(c%d+d)%d;let s=1;for(;s<S.length-1&&S[s]<c;)s++;const I=(c-S[s-1])/Math.max(1e-4,S[s]-S[s-1]);return[a[s-1][0]+(a[s][0]-a[s-1][0])*I,a[s-1][1]+(a[s][1]-a[s-1][1])*I,Math.atan2(a[s][1]-a[s-1][1],a[s][0]-a[s-1][0])]},e=l.arrow;if(h==="chevron"){const c=(26*i+8)*e.gap,s=Math.max(2,Math.floor(d/c));t.shadowColor=r(Math.min(1,e.heat+.2)),t.shadowBlur=8*i*e.glow;for(let I=0;I<s;I++){const P=I*c+o*42*e.speed%c;if(!f&&P>d-4)continue;const[R,w,M]=u(P),_=7.5*i,y=8.5*i,x=.45+.4*Math.sin(P/d*6.283-o*2.2*e.speed);t.strokeStyle=r(e.heat-.05+x*.3),t.lineWidth=3.2*i,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(R,w),t.rotate(M),t.beginPath(),t.moveTo(-y*.5,-_),t.lineTo(y*.5,0),t.lineTo(-y*.5,_),t.stroke(),t.restore()}return!0}if(h==="comet"){const c=o*.35*e.speed%1*d,s=d*e.tail,I=Math.max(24,a.length*2);t.lineCap="round";for(let w=0;w<I;w++){const M=c-w/I*s,_=c-(w+1)/I*s;if(!f&&_<0)break;const y=1-w/I,[x,p]=u(M),[m,C]=u(_);!f&&Math.hypot(m-x,C-p)>d*.4||(t.globalAlpha=Math.pow(y,1.6),t.strokeStyle=r(Math.max(.05,e.heat-.2)+y*.55),t.lineWidth=(1.5+y*4.5)*i,y>.72?(t.shadowColor=r(Math.min(1,e.heat+.3)),t.shadowBlur=y*12*i*e.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(x,p),t.lineTo(m,C),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[P,R]=u(c);return t.fillStyle=rgba(K.ink,.95),t.shadowColor=r(.9),t.shadowBlur=16*i,t.beginPath(),t.arc(P,R,2.6*i,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=n.color||r(e.heat),t.shadowColor=r(Math.min(1,e.heat+.15)),t.shadowBlur=(n.glow??8)*i*e.glow,h==="taper")for(let c=1;c<a.length;c++)t.lineWidth=(.5+c/a.length*4.5)*i,t.beginPath(),t.moveTo(a[c-1][0],a[c-1][1]),t.lineTo(a[c][0],a[c][1]),t.stroke();else It(t,i,o,l),t.beginPath(),a.forEach(([c,s],I)=>I?t.lineTo(c,s):t.moveTo(c,s)),f&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function gt(t,a,o,i,n,l){const r=13*i.halo,h=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const f=a/220,S=a/2,d=18*o.round*f,u=40*f,e=48*f,c=a-80*f,s=a-96*f,I=[],P=(w,M,_,y)=>{for(let x=0;x<=1;x+=.12)I.push([w+(_-w)*x,M+(y-M)*x])};P(u+d,e,u+c-d,e),P(u+c,e+d,u+c,e+s-d),P(u+c-d,e+s,u+d,e+s),P(u,e+s-d,u,e+d),t.shadowColor=h(.6),t.shadowBlur=r*.8;const R=4*l.arrow.w*f;if(l.arrow.line==="solid"?(t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-n*22*f,t.strokeStyle=h(.45),t.lineWidth=R,t.beginPath(),t.roundRect(u,e,c,s,d),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):At(t,I,n,l.arrow.w*f,{color:h(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const w=[],M=(b,T,D,L,B)=>{for(let E=1;E<=B;E++)w.push([b+(D-b)*E/B,T+(L-T)*E/B])},_=(b,T,D,L,B)=>{for(let E=1;E<=B;E++){const q=D+(L-D)*E/B;w.push([b+d*Math.cos(q),T+d*Math.sin(q)])}},y=Math.PI/2,x=u+c,p=e+s,m=u+c/2;w.push([m,e]),M(m,e,x-d,e,8),_(x-d,e+d,-y,0,6),M(x,e+d,x,p-d,10),_(x-d,p-d,0,y,6),M(x-d,p,u+d,p,14),_(u+d,p-d,y,Math.PI,6),M(u,p-d,u,e+d,10),_(u+d,e+d,Math.PI,Math.PI+y,6),M(u+d,e,m,e,8);let C=0;for(let b=1;b<w.length;b++)C+=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);const k=C*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-(c/2-d)-n*22*f,t.strokeStyle=h(.9),t.lineWidth=R*1.3,t.lineCap="round",t.shadowColor=h(.92),t.shadowBlur=r*1.3,t.beginPath(),t.moveTo(w[0][0],w[0][1]);let v=0;for(let b=1;b<w.length&&v<k;b++){const T=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);if(v+T<=k)t.lineTo(w[b][0],w[b][1]),v+=T;else{const D=(k-v)/T;t.lineTo(w[b-1][0]+(w[b][0]-w[b-1][0])*D,w[b-1][1]+(w[b][1]-w[b-1][1])*D),v=k}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&l.foot&&(l.foot(t,!1,S-16*o.feet*f,S+6*f,26*o.feet*f),l.foot(t,!0,S+16*o.feet*f,S+6*f,26*o.feet*f)),t.shadowBlur=0}function Kt(t,a,o,i,n,l,r,h){const f=13*i.halo,S=4*l.arrow.w*(a/220),d=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const u=a/220,e=r||[[45*u,130*u],[110*u,60*u],[175*u,110*u]],c=h??n*.5%1,s=Math.min(1,c*1.25)*(e.length-1),I=Math.min(e.length-1,Math.floor(s+.35));t.shadowColor=d(.7),t.shadowBlur=f;const P=p=>{const m=Math.max(0,Math.min(e.length-2,Math.floor(p))),C=p-m;return[e[m][0]+(e[m+1][0]-e[m][0])*C,e[m][1]+(e[m+1][1]-e[m][1])*C]},R=o.comet!=null?o.comet:1,w=o.tailLen!=null?o.tailLen:.5;if(t.save(),t.shadowBlur=0,t.globalAlpha=o.rail!=null?o.rail:.22,t.strokeStyle=d(.6),t.lineWidth=2.2*u,t.lineCap="round",t.setLineDash([.01,8*u]),t.beginPath(),e.forEach(([p,m],C)=>C?t.lineTo(p,m):t.moveTo(p,m)),t.stroke(),t.setLineDash([]),t.restore(),s>.02){const p=(m,C)=>d(m).replace("rgb(","rgba(").replace(")",`,${C.toFixed(3)})`);for(let m=0;m<26;m++){const C=m/25,k=s-w*C;if(k<=0)break;const v=P(k),b=4.7*u*R*(1-C*.75),T=b*2.1,D=(1-C)*(1-C)*.8,L=t.createRadialGradient(v[0],v[1],0,v[0],v[1],T);L.addColorStop(0,p(.55-.18*C,D)),L.addColorStop(.5,p(.5-.18*C,D*.35)),L.addColorStop(1,p(.45-.18*C,0)),t.save(),t.shadowBlur=0,t.globalAlpha=1,t.fillStyle=L,t.beginPath(),t.arc(v[0],v[1],T,0,Math.PI*2),t.fill(),t.restore()}if(s<e.length-1-.001&&s-Math.floor(s)>.03){const m=P(s);t.save(),t.fillStyle=d(.62),t.shadowColor=d(.8),t.shadowBlur=11*u*R,t.beginPath(),t.arc(m[0],m[1],5.6*u*R,0,Math.PI*2),t.fill(),t.fillStyle=d(.95),t.globalAlpha=.95,t.beginPath(),t.arc(m[0],m[1],2.1*u*R,0,Math.PI*2),t.fill(),t.restore()}}t.globalAlpha=1,t.lineCap="butt";const M=o.done!=null,_=o.done||0,y=o.vd||[],x=o.acc!=null?o.acc:e.length-1;if(e.forEach(([p,m],C)=>{const k=C<_,v=y[C]||null,b=!k&&C===I&&!M,T=b?1+Math.sin(n*6)*.14:1,D=o.pop!=null&&C===_-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,L=12*o.node*T*D*u*(C===x?1.34:1);k&&v!=="miss"&&(t.shadowBlur=f*1.4,t.shadowColor=d(.5),t.fillStyle=d(v==="near"?.5:.36),t.beginPath(),t.arc(p,m,L*.88,0,Math.PI*2),t.fill()),k||(t.save(),t.translate(p,m),h0(t,d,L,b?.8:.5,b?.9:.5,S*.9,f),t.restore()),t.strokeStyle=v==="hit"?G.prism:v==="near"?G.sand:v==="miss"?K.lo:d(k?.62:b?.8:.45),t.lineWidth=S*(b?1.3:v?1.15:.9),t.shadowBlur=b?f*1.6:v&&v!=="miss"?f*1.3:f*.6,v&&v!=="miss"&&(t.shadowColor=v==="hit"?G.prism:G.sand),t.beginPath(),t.arc(p,m,L,0,Math.PI*2),t.stroke(),l.num&&(k&&v!=="miss"?(t.save(),t.globalCompositeOperation="destination-out",t.shadowBlur=0,l.num(t,String(C+1),p,m,16*o.numS*T*u,Math.round(14*o.numS*u)),t.restore()):(t.globalAlpha=C<=I?1:.6,l.num(t,String(C+1),p,m,16*o.numS*T*u,Math.round(14*o.numS*u)),t.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&_>0&&e[_-1]){const[p,m]=e[_-1],C=1-o.pop/.38,k=C*C,v=12*o.node*u*(_-1===(o.acc!=null?o.acc:e.length-1)?1.34:1);t.save();const b=v*(1.6+1.9*(1-C)),T=t.createRadialGradient(p,m,0,p,m,b);T.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*k).toFixed(3)})`),T.addColorStop(.35,d(.92).replace("rgb(","rgba(").replace(")",`,${(.8*k).toFixed(3)})`)),T.addColorStop(1,d(.7).replace("rgb(","rgba(").replace(")",",0)")),t.fillStyle=T,t.beginPath(),t.arc(p,m,b,0,Math.PI*2),t.fill(),t.strokeStyle=d(.92),t.globalAlpha=k,t.lineWidth=Math.max(1,6*u*C),t.shadowColor=d(.85),t.shadowBlur=24*u*k,t.beginPath(),t.arc(p,m,v*(1.1+3.4*(1-C)),0,Math.PI*2),t.stroke();const D=Math.max(0,C-.35)/.65;D>0&&(t.globalAlpha=D*D*.6,t.lineWidth=Math.max(1,3.5*u*D),t.beginPath(),t.arc(p,m,v*(1.1+2*(1-D)),0,Math.PI*2),t.stroke()),t.restore()}t.shadowBlur=0}function h0(t,a,o,i,n,l,r,h=1){if(o<=.6)return;const f=(c,s)=>a(c).replace("rgb(","rgba(").replace(")",`,${s})`),S=l*2.6*h,d=Math.max(.1,o-S),u=o+S,e=t.createRadialGradient(0,0,d,0,0,u);e.addColorStop(0,f(i-.05,0)),e.addColorStop(.5,f(i,n*.85)),e.addColorStop(1,f(i-.05,0)),t.globalAlpha=1,t.fillStyle=e,t.shadowBlur=0,t.beginPath(),t.arc(0,0,u,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,n*1.1),t.lineWidth=l*.85,t.strokeStyle=a(Math.min(.98,i+.12)),t.shadowColor=a(.88),t.shadowBlur=r*.6,t.beginPath(),t.arc(0,0,o,0,Math.PI*2),t.stroke(),t.shadowBlur=0}function $t(t,a,o,i,n,l,r){const h=l.lut,f=13*i.halo,S=a/220,d=a/2,u=l.arrow&&l.arrow.w||1,e=(x,p)=>h(x).replace("rgb(","rgba(").replace(")",`,${p})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const c=(o.r!=null?o.r:.42)*a,s=c*(o.rt!=null?o.rt:.36),I=3.4*u*S,P=r!=null?Math.max(0,Math.min(1,r)):n*(o.tempo||.6)%1,R=Math.pow(P,1.6),w=Math.max(0,(P-.9)/.1);t.save(),t.translate(d,d);const M=(x,p,m,C=1)=>h0(t,h,x,p,m,I,f,C),_=t.createRadialGradient(0,0,0,0,0,s*1.08);_.addColorStop(0,e(.6,.1+.18*w)),_.addColorStop(.65,e(.5,.05+.08*w)),_.addColorStop(1,e(.5,0)),t.globalAlpha=1,t.fillStyle=_,t.beginPath(),t.arc(0,0,s*1.08,0,Math.PI*2),t.fill();const y=1+.02*Math.sin(n*2.6);M(s*y,.55+.4*w,.5+.45*w,.9);for(let x=2;x>=0;x--){const p=Math.pow(Math.max(0,P-x*.05),1.6),m=c-(c-s)*p,C=x===0?.6+.4*R:.18/x*(1-w);M(m,.55+.4*R,C*(1-w*.45),1.15-.35*R)}w>.01&&M(s*(1+1.4*w),.9,(1-w)*.8,1.1),t.globalAlpha=.6+.3*w,t.shadowColor=h(.85),t.shadowBlur=f*(.9+w),t.fillStyle=h(.62+.3*w),t.beginPath(),t.arc(0,0,I*.85+3*S*w,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function jt(t,a,o,i,n,l,r,h){const f=l.lut,S=13*i.halo,d=a/220,u=a/2,e=l.arrow&&l.arrow.w||1,c=e*d,s=(A,F)=>f(A).replace("rgb(","rgba(").replace(")",","+F+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const I=a*.42*(o.spread!=null?o.spread:1),R=(h||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([A,F])=>[u+A*I,u+F*I]),w=80,M=[];for(let A=0;A<=w;A++){const F=A/w*(R.length-1),O=Math.min(R.length-2,Math.floor(F)),H=F-O,W=R[Math.max(0,O-1)],$=R[O],t0=R[O+1],a0=R[Math.min(R.length-1,O+2)],o0=(X,J,Y,e0)=>.5*(2*J+(-X+Y)*H+(2*X-5*J+4*Y-e0)*H*H+(-X+3*J-3*Y+e0)*H*H*H);M.push([o0(W[0],$[0],t0[0],a0[0]),o0(W[1],$[1],t0[1],a0[1])])}const _=A=>{const F=Math.max(0,Math.min(w,A*w)),O=Math.floor(F),H=F-O,W=M[O],$=M[Math.min(w,O+1)];return[W[0]+($[0]-W[0])*H,W[1]+($[1]-W[1])*H]},y=.68;let x,p,m;if(r!=null)x=Math.max(0,Math.min(1,r)),p=1,m=0;else{const A=n*(o.tempo||.42)%1;if(A<y)x=A/y,p=1,m=0;else{const F=(A-y)/(1-y);x=1,p=1-F*F,m=F}}if(p<=.012)return;const C=x*x*x*(x*(6*x-15)+10),k=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const v=.36*(o.tail!=null?o.tail:1),b=o.width!=null?o.width:1;{const A=t.createLinearGradient(M[0][0],M[0][1],M[w][0],M[w][1]);A.addColorStop(0,s(.46,0)),A.addColorStop(.3,s(.46,.03*p)),A.addColorStop(.8,s(.46,.045*p)),A.addColorStop(1,s(.46,0)),t.globalAlpha=1,t.strokeStyle=A,t.lineWidth=9*c,t.shadowColor=f(.6),t.shadowBlur=S*2,t.beginPath(),M.forEach(([F,O],H)=>H?t.lineTo(F,O):t.moveTo(F,O)),t.stroke(),t.shadowBlur=0}const T=40,D=Math.max(0,C-v*(1-m)),L=[];for(let A=0;A<=T;A++)L.push(_(D+(C-D)*(A/T)));const B=()=>{t.beginPath(),L.forEach(([A,F],O)=>O?t.lineTo(A,F):t.moveTo(A,F)),t.stroke()},E=()=>{const A=t.createLinearGradient(L[0][0],L[0][1],L[T][0],L[T][1]);return A.addColorStop(0,s(.55,0)),A.addColorStop(.4,s(.56,0)),A.addColorStop(.68,s(.6,.09)),A.addColorStop(.88,s(.64,.24)),A.addColorStop(1,s(.68,.44)),A},q=1+.5*k;t.globalAlpha=p,t.strokeStyle=E(),t.lineWidth=(20+10*k)*c*b,t.shadowColor=f(.72),t.shadowBlur=S*2.2,B(),t.strokeStyle=E(),t.lineWidth=(10+5*k)*c*b,t.shadowBlur=S*1,B(),t.shadowBlur=0;for(let A=1;A<=T;A++){const F=A/T;t.globalAlpha=Math.pow(F,2.2)*.95*p,t.strokeStyle=f(.55+.38*F),t.lineWidth=(1.6+6.5*Math.pow(F,.7))*c*b*q,t.beginPath(),t.moveTo(L[A-1][0],L[A-1][1]),t.lineTo(L[A][0],L[A][1]),t.stroke()}const V=L[T][0],N=L[T][1];t.globalAlpha=.8*p,t.fillStyle=f(.6),t.shadowColor=f(.8),t.shadowBlur=S*1.6,t.beginPath(),t.arc(V,N,(9+5*k)*c*b,0,Math.PI*2),t.fill(),t.globalAlpha=p,t.fillStyle=f(.93),t.shadowBlur=S*.6,t.beginPath(),t.arc(V,N,(3.4+1.8*k)*c*b,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function Xt(t,a,o,i,n,l,r){const h=o.r!=null?o.r:.3,f=o.dir!=null?o.dir:1,S=(o.sweep!=null?o.sweep:.66)*Math.PI*2,d=r??n*(o.tempo!=null?o.tempo:.5)%1,u=-Math.PI/2+f*d*Math.PI*2,e=16,c=[];for(let s=0;s<=e;s++){const I=u-f*(1-s/e)*S;c.push([.5+Math.cos(I)*h,.5+Math.sin(I)*h])}vt(t,a,a,c,n,l,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}export{Ut as C,d0 as G,St as L,Et as M,K as N,G as P,_t as Q,Ot as R,Pt as S,kt as Z,j as a,Ct as b,$t as c,Ft as d,Xt as e,Wt as f,jt as g,Kt as h,Bt as i,Lt as j,yt as k,gt as l,Gt as m,qt as n,Z as o,At as p,Rt as q,vt as r,c0 as s,Dt as t,Tt as u,Mt as v,Ht as w,u0 as x,f0 as y};
