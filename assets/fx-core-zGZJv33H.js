...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(a,t,o,i){a.lineWidth=4*t;const s=i.arrow;s.line==="dash"?a.setLineDash([12*t*s.gap,10*s.gap]):s.line==="dot"?(a.setLineDash([.5,12*s.gap]),a.lineCap="round",a.lineWidth=5*t):a.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(a.lineDashOffset=-o*40*s.speed)}function B0(a,t,o,i,s,e={}){const c=s.lut,r=s.arrow||{},h=r.w??1,m=r.speed??1,d=r.glow??1,p=e.pulse??1,l=o/256,u=t/2,f=i*.9*m%1,C=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,f/.55),M=e.prog!=null?1:f>.88?(1-f)/.12:1;a.clearRect(0,0,t,o);const w=M*(.45+.55*p),n=o-24*l,S=58*l,T=n+(S-n)*C,A=(k,L)=>c(k).replace("rgb(","rgba(").replace(")",`,${L.toFixed(3)})`),x=1.1*l*h,b=13*l*h,P=a.createLinearGradient(0,n,0,T);if(P.addColorStop(0,A(.55,0)),P.addColorStop(.1,A(.64,.45*w)),P.addColorStop(.32,A(.76,.85*w)),P.addColorStop(.62,A(.88,.98*w)),P.addColorStop(1,A(.97,w)),a.globalAlpha=1,a.fillStyle=P,a.beginPath(),a.moveTo(u-x/2,n),a.lineTo(u+x/2,n),a.lineTo(u+b/2,T),a.lineTo(u-b/2,T),a.closePath(),a.fill(),a.globalAlpha=w,C>.28&&!e.noTip){const k=34*l*(.7+.3*h),L=Math.min(1,(C-.28)/.22)*w,y=T+k*.3;a.globalAlpha=L;const I={color:c(.95),glowColor:c(.85),glow:12*d};s.glyph&&(s.glyph(a,"LIFT_TIP",u,y,k,I)||s.glyph(a,"TIP_TRI",u,y,k*.93,I))||(a.strokeStyle=c(.95),a.lineWidth=13*l*h,a.lineCap="round",a.lineJoin="round",a.shadowColor=c(.9),a.shadowBlur=18*l*d,a.beginPath(),a.moveTo(u-26*l,y+14*l),a.lineTo(u,y-16*l),a.lineTo(u+26*l,y+14*l),a.stroke())}a.globalAlpha=1,a.shadowBlur=0}function F0(a,t,o,i,s,e,c={}){const r=e.lut,h=e.arrow||{},m=h.w??1,d=h.glow??1,p=o/256;a.clearRect(0,0,t,o);const l=i.map(([n,S])=>[n*t,S*o]);if(l.length<2)return;const u=48,f=[],C=n=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*n,l[0][1]+(l[1][1]-l[0][1])*n];const S=n*(l.length-1),T=Math.min(l.length-2,Math.floor(S)),A=S-T,x=l[Math.max(0,T-1)],b=l[T],P=l[T+1],k=l[Math.min(l.length-1,T+2)],L=(y,I,R,F)=>.5*(2*I+(-y+R)*A+(2*y-5*I+4*R-F)*A*A+(-y+3*I-3*R+F)*A*A*A);return[L(x[0],b[0],P[0],k[0]),L(x[1],b[1],P[1],k[1])]};for(let n=0;n<=u;n++)f.push(C(n/u));const M=Math.max(0,Math.min(1,c.prog!=null?c.prog:s*.55%1)),w=Math.max(1,Math.round(u*M));a.lineCap="round";for(let n=1;n<=w;n++){const S=n/w;a.globalAlpha=Math.pow(S,1.5),a.strokeStyle=r(.45+.5*S),a.lineWidth=(1.6+3.2*S)*p*m,a.beginPath(),a.moveTo(f[n-1][0],f[n-1][1]),a.lineTo(f[n][0],f[n][1]),a.stroke()}if(M>.25){const n=f[w][0],S=f[w][1],T=f[Math.max(0,w-2)][0],A=f[Math.max(0,w-2)][1],x=Math.atan2(S-A,n-T)+Math.PI/2,b=30*p*(.7+.3*m);a.save(),a.translate(n,S),a.rotate(x),a.globalAlpha=Math.min(1,(M-.25)/.2);const P={color:r(.95),glowColor:r(.85),glow:12*d};e.glyph&&(e.glyph(a,"LIFT_TIP",0,0,b,P)||e.glyph(a,"TIP_TRI",0,0,b*.93,P))||(a.strokeStyle=r(.95),a.lineWidth=9*p*m,a.lineJoin="round",a.lineCap="round",a.beginPath(),a.moveTo(-18*p,12*p),a.lineTo(0,-14*p),a.lineTo(18*p,12*p),a.stroke()),a.restore()}a.globalAlpha=1}function c0(a,t,o,i,s,e){s=s||{};const c=e.lut,r=s.style||e.arrow.line,h=!!s.closed,m=[0];for(let u=1;u<t.length;u++)m.push(m[u-1]+Math.hypot(t[u][0]-t[u-1][0],t[u][1]-t[u-1][1]));const d=m[m.length-1]||1,p=u=>{u=(u%d+d)%d;let f=1;for(;f<m.length-1&&m[f]<u;)f++;const C=(u-m[f-1])/Math.max(1e-4,m[f]-m[f-1]);return[t[f-1][0]+(t[f][0]-t[f-1][0])*C,t[f-1][1]+(t[f][1]-t[f-1][1])*C,Math.atan2(t[f][1]-t[f-1][1],t[f][0]-t[f-1][0])]},l=e.arrow;if(r==="chevron"){const u=(26*i+8)*l.gap,f=Math.max(2,Math.floor(d/u));a.shadowColor=c(Math.min(1,l.heat+.2)),a.shadowBlur=8*i*l.glow;for(let C=0;C<f;C++){const M=C*u+o*42*l.speed%u;if(!h&&M>d-4)continue;const[w,n,S]=p(M),T=7.5*i,A=8.5*i,x=.45+.4*Math.sin(M/d*6.283-o*2.2*l.speed);a.strokeStyle=c(l.heat-.05+x*.3),a.lineWidth=3.2*i,a.lineJoin="round",a.lineCap="round",a.save(),a.translate(w,n),a.rotate(S),a.beginPath(),a.moveTo(-A*.5,-T),a.lineTo(A*.5,0),a.lineTo(-A*.5,T),a.stroke(),a.restore()}return!0}if(r==="comet"){const u=o*.35*l.speed%1*d,f=d*l.tail,C=Math.max(24,t.length*2);a.lineCap="round";for(let n=0;n<C;n++){const S=u-n/C*f,T=u-(n+1)/C*f;if(!h&&T<0)break;const A=1-n/C,[x,b]=p(S),[P,k]=p(T);!h&&Math.hypot(P-x,k-b)>d*.4||(a.globalAlpha=Math.pow(A,1.6),a.strokeStyle=c(Math.max(.05,l.heat-.2)+A*.55),a.lineWidth=(1.5+A*4.5)*i,A>.72?(a.shadowColor=c(Math.min(1,l.heat+.3)),a.shadowBlur=A*12*i*l.glow):a.shadowBlur=0,a.beginPath(),a.moveTo(x,b),a.lineTo(P,k),a.stroke())}a.globalAlpha=1,a.lineCap="butt",a.shadowBlur=0;const[M,w]=p(u);return a.fillStyle=rgba(W.ink,.95),a.shadowColor=c(.9),a.shadowBlur=16*i,a.beginPath(),a.arc(M,w,2.6*i,0,7),a.fill(),a.shadowBlur=0,!0}if(a.strokeStyle=s.color||c(l.heat),a.shadowColor=c(Math.min(1,l.heat+.15)),a.shadowBlur=(s.glow??8)*i*l.glow,r==="taper")for(let u=1;u<t.length;u++)a.lineWidth=(.5+u/t.length*4.5)*i,a.beginPath(),a.moveTo(t[u-1][0],t[u-1][1]),a.lineTo(t[u][0],t[u][1]),a.stroke();else w0(a,i,o,e),a.beginPath(),t.forEach(([u,f],C)=>C?a.lineTo(u,f):a.moveTo(u,f)),h&&a.closePath(),a.stroke();return a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,a.shadowBlur=0,!0}function E0(a,t,o,i,s,e){const c=13*i.halo,r=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const h=t/220,m=t/2,d=18*o.round*h,p=40*h,l=48*h,u=t-80*h,f=t-96*h,C=[],M=(n,S,T,A)=>{for(let x=0;x<=1;x+=.12)C.push([n+(T-n)*x,S+(A-S)*x])};M(p+d,l,p+u-d,l),M(p+u,l+d,p+u,l+f-d),M(p+u-d,l+f,p+d,l+f),M(p,l+f-d,p,l+d),a.shadowColor=r(.6),a.shadowBlur=c*.8;const w=4*e.arrow.w*h;if(e.arrow.line==="solid"?(a.setLineDash([10*o.dash*h,8*h]),a.lineDashOffset=-s*22*h,a.strokeStyle=r(.45),a.lineWidth=w,a.beginPath(),a.roundRect(p,l,u,f,d),a.stroke(),a.setLineDash([]),a.lineDashOffset=0):c0(a,C,s,e.arrow.w*h,{color:r(.45),closed:!0},e),o.prog!=null&&o.prog>.001){const n=[],S=(I,R,F,D,U)=>{for(let O=1;O<=U;O++)n.push([I+(F-I)*O/U,R+(D-R)*O/U])},T=(I,R,F,D,U)=>{for(let O=1;O<=U;O++){const $=F+(D-F)*O/U;n.push([I+d*Math.cos($),R+d*Math.sin($)])}},A=Math.PI/2,x=p+u,b=l+f,P=p+u/2;n.push([P,l]),S(P,l,x-d,l,8),T(x-d,l+d,-A,0,6),S(x,l+d,x,b-d,10),T(x-d,b-d,0,A,6),S(x-d,b,p+d,b,14),T(p+d,b-d,A,Math.PI,6),S(p,b-d,p,l+d,10),T(p+d,l+d,Math.PI,Math.PI+A,6),S(p+d,l,P,l,8);let k=0;for(let I=1;I<n.length;I++)k+=Math.hypot(n[I][0]-n[I-1][0],n[I][1]-n[I-1][1]);const L=k*Math.min(1,o.prog);a.save(),a.setLineDash([10*o.dash*h,8*h]),a.lineDashOffset=-(u/2-d)-s*22*h,a.strokeStyle=r(.9),a.lineWidth=w*1.3,a.lineCap="round",a.shadowColor=r(.92),a.shadowBlur=c*1.3,a.beginPath(),a.moveTo(n[0][0],n[0][1]);let y=0;for(let I=1;I<n.length&&y<L;I++){const R=Math.hypot(n[I][0]-n[I-1][0],n[I][1]-n[I-1][1]);if(y+R<=L)a.lineTo(n[I][0],n[I][1]),y+=R;else{const F=(L-y)/R;a.lineTo(n[I-1][0]+(n[I][0]-n[I-1][0])*F,n[I-1][1]+(n[I][1]-n[I-1][1])*F),y=L}}a.stroke(),a.setLineDash([]),a.restore()}o.feet>.05&&e.foot&&(e.foot(a,!1,m-16*o.feet*h,m+6*h,26*o.feet*h),e.foot(a,!0,m+16*o.feet*h,m+6*h,26*o.feet*h)),a.shadowBlur=0}function O0(a,t,o,i,s,e,c,r){const h=13*i.halo,m=4*e.arrow.w*(t/220),d=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const p=t/220,l=c||[[45*p,130*p],[110*p,60*p],[175*p,110*p]],u=r??s*.5%1,f=Math.min(1,u*1.25)*(l.length-1),C=Math.min(l.length-1,Math.floor(f+.35));a.shadowColor=d(.7),a.shadowBlur=h;const M=[[l[0][0],l[0][1]]];for(let w=1;w<=l.length-1;w++){const n=Math.max(0,Math.min(1,f-(w-1)));if(n<=0)break;M.push([l[w-1][0]+(l[w][0]-l[w-1][0])*n,l[w-1][1]+(l[w][1]-l[w-1][1])*n])}M.length>1&&c0(a,M,s,e.arrow.w*p,{color:d(.62)},e),a.setLineDash([4*p,7*p]),a.lineDashOffset=0,a.globalAlpha=.3,a.strokeStyle=d(.45),a.lineWidth=m,a.beginPath(),l.forEach(([w,n],S)=>S?a.lineTo(w,n):a.moveTo(w,n)),a.stroke(),a.globalAlpha=1,a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,l.forEach(([w,n],S)=>{const T=S===C,A=T?1+Math.sin(s*6)*.14:1;a.strokeStyle=d(T?.8:.45),a.lineWidth=m*(T?1.3:.9),a.shadowBlur=T?h*1.6:h*.6,a.beginPath(),a.arc(w,n,12*o.node*A*p,0,Math.PI*2),a.stroke(),e.num&&(a.globalAlpha=S<=C?1:.45,e.num(a,String(S+1),w,n,16*o.numS*A*p,Math.round(14*o.numS*p)),a.globalAlpha=1)}),a.shadowBlur=0}function G0(a,t,o,i,s,e,c){const r=e.lut,h=13*i.halo,m=t/220,d=t/2,p=e.arrow&&e.arrow.w||1,l=(x,b)=>r(x).replace("rgb(","rgba(").replace(")",`,${b})`);a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const u=(o.r!=null?o.r:.42)*t,f=u*(o.rt!=null?o.rt:.36),C=3.4*p*m,M=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.6)%1,w=Math.pow(M,1.6),n=Math.max(0,(M-.9)/.1);a.save(),a.translate(d,d);const S=(x,b,P,k=1)=>{if(x<=.6)return;const L=C*2.6*k,y=Math.max(.1,x-L),I=x+L,R=a.createRadialGradient(0,0,y,0,0,I);R.addColorStop(0,l(b-.05,0)),R.addColorStop(.5,l(b,P*.85)),R.addColorStop(1,l(b-.05,0)),a.globalAlpha=1,a.fillStyle=R,a.shadowBlur=0,a.beginPath(),a.arc(0,0,I,0,Math.PI*2),a.fill(),a.globalAlpha=Math.min(1,P*1.1),a.lineWidth=C*.85,a.strokeStyle=r(Math.min(.98,b+.12)),a.shadowColor=r(.88),a.shadowBlur=h*.6,a.beginPath(),a.arc(0,0,x,0,Math.PI*2),a.stroke(),a.shadowBlur=0},T=a.createRadialGradient(0,0,0,0,0,f*1.08);T.addColorStop(0,l(.6,.1+.18*n)),T.addColorStop(.65,l(.5,.05+.08*n)),T.addColorStop(1,l(.5,0)),a.globalAlpha=1,a.fillStyle=T,a.beginPath(),a.arc(0,0,f*1.08,0,Math.PI*2),a.fill();const A=1+.02*Math.sin(s*2.6);S(f*A,.55+.4*n,.5+.45*n,.9);for(let x=2;x>=0;x--){const b=Math.pow(Math.max(0,M-x*.05),1.6),P=u-(u-f)*b,k=x===0?.6+.4*w:.18/x*(1-n);S(P,.55+.4*w,k*(1-n*.45),1.15-.35*w)}n>.01&&S(f*(1+1.4*n),.9,(1-n)*.8,1.1),a.globalAlpha=.6+.3*n,a.shadowColor=r(.85),a.shadowBlur=h*(.9+n),a.fillStyle=r(.62+.3*n),a.beginPath(),a.arc(0,0,C*.85+3*m*n,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}function U0(a,t,o,i,s,e,c,r){const h=e.lut,m=13*i.halo,d=t/220,p=t/2,l=e.arrow&&e.arrow.w||1,u=l*d,f=(v,_)=>h(v).replace("rgb(","rgba(").replace(")",","+_+")");a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const C=t*.42*(o.spread!=null?o.spread:1),w=(r||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([v,_])=>[p+v*C,p+_*C]),n=80,S=[];for(let v=0;v<=n;v++){const _=v/n*(w.length-1),B=Math.min(w.length-2,Math.floor(_)),G=_-B,H=w[Math.max(0,B-1)],K=w[B],N=w[B+1],a0=w[Math.min(w.length-1,B+2)],t0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*G+(2*X-5*J+4*Y-o0)*G*G+(-X+3*J-3*Y+o0)*G*G*G);S.push([t0(H[0],K[0],N[0],a0[0]),t0(H[1],K[1],N[1],a0[1])])}const T=v=>{const _=Math.max(0,Math.min(n,v*n)),B=Math.floor(_),G=_-B,H=S[B],K=S[Math.min(n,B+1)];return[H[0]+(K[0]-H[0])*G,H[1]+(K[1]-H[1])*G]},A=.68;let x,b,P;if(c!=null)x=Math.max(0,Math.min(1,c)),b=1,P=0;else{const v=s*(o.tempo||.42)%1;if(v<A)x=v/A,b=1,P=0;else{const _=(v-A)/(1-A);x=1,b=1-_*_,P=_}}if(b<=.012)return;const k=x*x*x*(x*(6*x-15)+10),L=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const y=.36*(o.tail!=null?o.tail:1),I=o.width!=null?o.width:1;{const v=a.createLinearGradient(S[0][0],S[0][1],S[n][0],S[n][1]);v.addColorStop(0,f(.46,0)),v.addColorStop(.3,f(.46,.03*b)),v.addColorStop(.8,f(.46,.045*b)),v.addColorStop(1,f(.46,0)),a.globalAlpha=1,a.strokeStyle=v,a.lineWidth=9*u,a.shadowColor=h(.6),a.shadowBlur=m*2,a.beginPath(),S.forEach(([_,B],G)=>G?a.lineTo(_,B):a.moveTo(_,B)),a.stroke(),a.shadowBlur=0}const R=40,F=Math.max(0,k-y*(1-P)),D=[];for(let v=0;v<=R;v++)D.push(T(F+(k-F)*(v/R)));const U=()=>{a.beginPath(),D.forEach(([v,_],B)=>B?a.lineTo(v,_):a.moveTo(v,_)),a.stroke()},O=()=>{const v=a.createLinearGradient(D[0][0],D[0][1],D[R][0],D[R][1]);return v.addColorStop(0,f(.55,0)),v.addColorStop(.4,f(.56,0)),v.addColorStop(.68,f(.6,.09)),v.addColorStop(.88,f(.64,.24)),v.addColorStop(1,f(.68,.44)),v},$=1+.5*L;a.globalAlpha=b,a.strokeStyle=O(),a.lineWidth=(20+10*L)*u*I,a.shadowColor=h(.72),a.shadowBlur=m*2.2,U(),a.strokeStyle=O(),a.lineWidth=(10+5*L)*u*I,a.shadowBlur=m*1,U(),a.shadowBlur=0;for(let v=1;v<=R;v++){const _=v/R;a.globalAlpha=Math.pow(_,2.2)*.95*b,a.strokeStyle=h(.55+.38*_),a.lineWidth=(1.6+6.5*Math.pow(_,.7))*u*I*$,a.beginPath(),a.moveTo(D[v-1][0],D[v-1][1]),a.lineTo(D[v][0],D[v][1]),a.stroke()}const V=D[R][0],g=D[R][1];a.globalAlpha=.8*b,a.fillStyle=h(.6),a.shadowColor=h(.8),a.shadowBlur=m*1.6,a.beginPath(),a.arc(V,g,(9+5*L)*u*I,0,Math.PI*2),a.fill(),a.globalAlpha=b,a.fillStyle=h(.93),a.shadowBlur=m*.6,a.beginPath(),a.arc(V,g,(3.4+1.8*L)*u*I,0,Math.PI*2),a.fill(),a.globalAlpha=1,a.shadowBlur=0}function H0(a,t,o,i,s,e,c){const r=e.lut,h=13*i.halo,m=t/220,d=t/2,p=e.arrow&&e.arrow.w||1;a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const l=(o.r!=null?o.r:.3)*t,u=o.width!=null?o.width:1,f=4.2*p*m*u,C=o.dir!=null?o.dir:1,M=(o.sweep!=null?o.sweep:.66)*Math.PI*2,w=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.5)%1,n=-Math.PI/2+C*w*Math.PI*2;a.save(),a.translate(d,d),a.globalAlpha=.16,a.lineWidth=f*.7,a.strokeStyle=r(.44),a.shadowColor=r(.6),a.shadowBlur=h*.4,a.beginPath(),a.arc(0,0,l,0,Math.PI*2),a.stroke(),a.shadowBlur=0;const S=16;for(let L=0;L<S;L++){const y=L/(S-1),I=n-C*y*M,R=n-C*(y+1.2/S)*M;a.globalAlpha=(1-y)*.9,a.strokeStyle=r(.55+.35*(1-y)),a.lineWidth=f*(.55+.55*(1-y)),a.shadowColor=r(.8),a.shadowBlur=h*(.4+.5*(1-y)),a.beginPath(),a.arc(0,0,l,Math.min(I,R),Math.max(I,R),!1),a.stroke()}a.shadowBlur=0;const T=Math.cos(n)*l,A=Math.sin(n)*l,x=n+C*Math.PI/2,b=8*m*u;a.save(),a.translate(T,A),a.rotate(x+Math.PI/2),a.globalAlpha=1;const P=3.4*b*(.7+.3*p),k={color:r(.96),glowColor:r(.9),glow:h*1.2};e.glyph&&(e.glyph(a,"LIFT_TIP",0,0,P,k)||e.glyph(a,"TIP_TRI",0,0,P*.93,k))||(a.rotate(-Math.PI/2),a.strokeStyle=r(.96),a.lineWidth=f*.9,a.shadowColor=r(.9),a.shadowBlur=h*1.2,a.beginPath(),a.moveTo(-b,-b*.9),a.lineTo(b*.5,0),a.lineTo(-b,b*.9),a.stroke()),a.restore(),a.globalAlpha=.62,a.shadowColor=r(.75),a.shadowBlur=h*.6,a.fillStyle=r(.6),a.beginPath(),a.arc(0,0,f*.6,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}export{L0 as C,p0 as G,R0 as M,W as N,E as P,v0 as Q,k0 as R,A0 as S,T0 as Z,j as a,d0 as b,I0 as c,M0 as d,b0 as e,E0 as f,O0 as g,G0 as h,P0 as i,U0 as j,H0 as k,y0 as l,B0 as m,D0 as n,z as o,c0 as p,x0 as q,F0 as r,i0 as s,S0 as t,C0 as u,_0 as v,u0 as w,f0 as x};
