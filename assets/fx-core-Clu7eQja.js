const K={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},o0={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},f0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],gt=Object.fromEntries(Object.entries({...K,...o0}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),t0=t=>`vec3(${f0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,$t=(t,a=1)=>`rgba(${f0(t).join(",")},${a})`,b0=[[K.red,0],[K.red,.3],[K.coral,.56],[K.sand,.86],[K.prism,1]],C0=1;function v0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(o0).some(o=>o.toUpperCase()===a)?!0:Object.values(K).some(o=>o.toUpperCase()===a)}function zt(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>v0(o)))&&(t.stops=b0.map(o=>[...o])),t.sat=C0,t)}const A0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",M0=.98,y0=1.16,T0=-.043,L0=-.031,I0=5.5,P0=.027,R0=.25,k0=0,F0=0,_0=.74,D0=.038,E0=.55,B0=24,G0=1,H0=1.6,O0=0,U0=.9,W0=0,q0=0,K0=.5,g0=.125,$0=.4,z0=1,j0=1.4,X0=0,Y0=0,J0=3.4,Q0=.035,Z0=1,V0=0,N0=-2,tt=.8,ot=-.085,at=.16,et=4,lt=.6,nt=1,st=1,rt="glow",it="add",ct="offbit",dt=.55,ut=.125,ht=0,pt=4,ft=4,mt=0,xt=1,wt=.55,St={punchLine:{node:1,numS:1,comet:1,tailLen:.5,rail:.22}},bt=-.095,Ct=.12,vt=10,At=-.015,Mt=.12,yt=-10,Tt={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15},Lt=.98,It=4,Pt={0:{sharp:0},1:{},2:{w:1.8,halo:.5,glow:.15,imp:0,dot:.2,pitch:.03,shade:0,sharp:.65,edge:.038,dotCol:4,rip:0},4:{glow:0,halo:.14,w:.7,shade:0,imp:0,edgeShadeGrad:0,pitch:.048,dot:.13,irot:21,dotCol:4,edge:.004,sharp:0,plantar:1,edgeShadeCol:4},tap:{op:.1,imp:0,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.7,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.028,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.26,w:1.15}},Rt=.45,kt=.06,Ft=.55,_t={_:"움직임 튜닝(markmotion.js 가 읽는다). 상태 8토큰과 직교 — 여기는 '어떻게 움직이나'만.",stepLead:.3,slideDecay:3,over:.14,overAt:.78,settle:.11,settleHz:2.4,popA:.16,popB:.18,popBAt:.11,airScale:.12,spawnDur:.44,hitDur:.34,arrowRamp:.16,arrowBreath:.06},Dt=0,Et=0,Bt=.35,Gt={_:A0,imp:M0,scale:y0,offx:T0,offy:L0,irot:I0,pitch:P0,dot:R0,glow:k0,shade:F0,sharp:_0,edge:D0,plantar:E0,bands:B0,bandSoft:G0,w:H0,halo:O0,pool:U0,noise:W0,rip:q0,ripReach:K0,ripWidth:g0,ripSpeed:$0,ripGrad:z0,edgeShade:j0,dotMode:X0,shadeRed:Y0,shadeRedW:J0,edgeW:Q0,edgeSoft:Z0,dither:V0,tilt:N0,gsize:tt,gx:ot,gy:at,grot:et,gsh:lt,shadeCol:nt,ripCol:st,gShadow:rt,gBlend:it,numSrc:ct,prog:dt,bloom:ut,blur:ht,edgeShadeW:pt,edgeShadeCol:ft,edgeShadeGrad:mt,edgeShadeG0:xt,edgeShadeG1:wt,prims:St,gxL:bt,gyL:Ct,grotL:vt,gxR:At,gyR:Mt,grotR:yt,tap:Tt,op:Lt,dotCol:It,states:Pt,loadGain:Rt,loadBase:kt,flow:Ft,motion:_t,tLo:Dt,tHi:Et,inkFloor:Bt};function d0(t,a,o,d,r){let l=0;o[0]=0,d[0]=-1e20,d[1]=1e20;for(let e=1;e<r;e++){let c=(t[e]+e*e-(t[o[l]]+o[l]*o[l]))/(2*e-2*o[l]);for(;c<=d[l];)l--,c=(t[e]+e*e-(t[o[l]]+o[l]*o[l]))/(2*e-2*o[l]);l++,o[l]=e,d[l]=c,d[l+1]=1e20}l=0;for(let e=0;e<r;e++){for(;d[l+1]<e;)l++;a[e]=(e-o[l])*(e-o[l])+t[o[l]]}}function u0(t,a){const o=new Float32Array(a),d=new Int32Array(a),r=new Float32Array(a+1),l=new Float32Array(a);for(let e=0;e<a;e++){for(let c=0;c<a;c++)l[c]=t[c*a+e];d0(l,o,d,r,a);for(let c=0;c<a;c++)t[c*a+e]=o[c]}for(let e=0;e<a;e++){for(let c=0;c<a;c++)l[c]=t[e*a+c];d0(l,o,d,r,a);for(let c=0;c<a;c++)t[e*a+c]=o[c]}}function m0(t,a){const d=new Float32Array(a*a),r=new Float32Array(a*a);let l=0,e=0,c=0;for(let A=0;A<a*a;A++){const p=t[A*4+3]/255;d[A]=p>=1?0:p<=0?1e20:Math.pow(Math.max(0,.5-p),2),r[A]=p>=1?1e20:p<=0?0:Math.pow(Math.max(0,p-.5),2),p>.5&&(l+=A%a,e+=A/a|0,c++)}u0(d,a),u0(r,a);const u=new Float32Array(a*a);for(let A=0;A<a*a;A++)u[A]=(Math.sqrt(d[A])-Math.sqrt(r[A]))/a;return{data:u,N:a,cx:c?l/c/a:.5,cy:c?e/c/a:.5}}const Ht={get k(){if(typeof window>"u")return 1;const t=+new URLSearchParams(location.search).get("fxq"),a=+window.__FXQ||t||1;return Math.min(4,Math.max(1,a))}};function i0(t,a=512*Ht.k){const o="_raster"+a;if(t[o])return t[o];const d=document.createElement("canvas");d.width=d.height=a;const r=d.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);r.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const e=r.getImageData(0,0,a,a).data;let c=a,u=a,A=-1,p=-1;for(let m=0;m<a;m++)for(let s=0;s<a;s++)e[(m*a+s)*4+3]>8&&(s<c&&(c=s),s>A&&(A=s),m<u&&(u=m),m>p&&(p=m));return t[o]=A<0?{canvas:d,x:0,y:0,w:a,h:a}:{canvas:d,x:c,y:u,w:A-c+1,h:p-u+1},t[o]}function jt(t,a,o=!1){const d=i0(t,a),r=document.createElement("canvas");r.width=r.height=a;const l=r.getContext("2d"),e=Math.min(a*e0/d.w,a*e0/d.h),c=d.w*e,u=d.h*e;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(d.canvas,d.x,d.y,d.w,d.h,(a-c)/2,(a-u)/2,c,u),m0(l.getImageData(0,0,a,a).data,a)}function Xt(t,a,o,d=!1){const r=i0(t,o),l=a?i0(a,o):null,e=Math.min(o*e0/r.w,o*e0/r.h),c=r.w*e,u=r.h*e,A=(o-c)/2,p=(o-u)/2,m=M=>{const E=document.createElement("canvas");E.width=E.height=o;const _=E.getContext("2d");return d&&(_.translate(0,o),_.scale(1,-1)),_.drawImage(M.canvas,r.x,r.y,r.w,r.h,A,p,c,u),m0(_.getImageData(0,0,o,o).data,o)},s=m(r),n=l?m(l):null,i=new Float32Array(o*o*2);for(let M=0;M<o*o;M++)i[M*2]=s.data[M],i[M*2+1]=n?n.data[M]:1;return{data:i,N:o,cx:s.cx,cy:s.cy,inCx:n?n.cx:s.cx,inCy:n?n.cy:s.cy,hasInner:!!n}}const Yt=1.9922,Ot=.78,e0=.52,Jt=Ot/e0,Qt=1.18,V=Gt||{},x0={size:V.gsize??.85,gx:V.gx??-.025,gy:V.gy??.195,rot:V.grot??6,gxL:V.gxL,gyL:V.gyL,rotL:V.grotL,gxR:V.gxR,gyR:V.gyR,rotR:V.grotR,shadow:V.gShadow??"glow",shadowK:V.gsh??.75,blend:V.gBlend??"add"};function Zt(t,a=x0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function Vt(t,a,o,d,r=x0){const l=Math.round(o*.75),e=r.shadow==="none"?0:r.shadowK??.75,c=u=>d(t,String(a),o/2,o/2,l,u);return r.shadow==="drop"&&e>.001?(t.save(),t.globalAlpha=Math.min(1,e*.7),t.translate(o*.018,o*.024),c({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),c({glow:0,glowColor:"rgba(0,0,0,0)"})):c(r.shadow==="glow"?{glow:26*e,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),r.blend==="knock"}function Nt(t,a){const o=t.getImageData(0,0,a,a),d=t.createImageData(a,a);for(let r=0;r<a*a;r++){const l=o.data[r*4+3]/255,e=Math.round(255*(1-l));d.data[r*4]=d.data[r*4+1]=d.data[r*4+2]=e,d.data[r*4+3]=255}t.putImageData(d,0,0)}const to={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},s0=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),r0=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function h0(t,a,o){t=s0(t),a=s0(a),o=s0(o);const d=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),r=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*d+.793617785*r-.0040720468*l,1.9779984951*d-2.428592205*r+.4505937099*l,.0259040371*d+.7827717662*r-.808675766*l]}function Ut(t,a,o){const d=(t+.3963377774*a+.2158037573*o)**3,r=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[r0(4.0767416621*d-3.3077115913*r+.2309699292*l),r0(-1.2684380046*d+2.6097574011*r-.3413193965*l),r0(-.0041960863*d-.7034186147*r+1.707614701*l)]}const p0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function oo(t,a=1,o=new Uint8Array(256*4)){const d=[...t].sort((r,l)=>r[1]-l[1]);for(let r=0;r<256;r++){const l=r/255;let e=0;for(;e<d.length-2&&l>d[e+1][1];)e++;const[c,u]=d[e],[A,p]=d[e+1],m=Math.max(0,Math.min(1,(l-u)/Math.max(1e-5,p-u))),s=h0(...p0(c)),n=h0(...p0(A)),i=Ut(s[0]+(n[0]-s[0])*m,(s[1]+(n[1]-s[1])*m)*a,(s[2]+(n[2]-s[2])*m)*a);o.set([...i,255],r*4)}return o}const ao=`
...
#define C_RED   ${t0(K.red)}
#define C_CORAL ${t0(K.coral)}
#define C_SAND  ${t0(K.sand)}
#define C_ICE   ${t0(K.prism)}
#define C_CREAM C_SAND
#define C_GRAYF ${t0(o0.hi)}
#define C_GRAYL ${t0(o0.lo)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function Wt(t,a,o,d){t.lineWidth=4*a;const r=d.arrow;r.line==="dash"?t.setLineDash([12*a*r.gap,10*r.gap]):r.line==="dot"?(t.setLineDash([.5,12*r.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&r.line!=="solid"&&r.line!=="taper"&&(t.lineDashOffset=-o*40*r.speed)}function so(t,a,o,d,r,l={}){const e=r.lut,c=r.arrow||{},u=c.w??1,A=c.speed??1,p=c.glow??1,m=l.pulse??1,s=o/256,n=s*(l.scale??1),i=a/2,M=d*.9*A%1,E=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,M/.55),_=l.prog!=null?1:M>.88?(1-M)/.12:1;t.clearRect(0,0,a,o);const x=_*(.45+.55*m),I=o-24*s,k=58*s,P=I+(k-I)*E,v=(T,O)=>e(T).replace("rgb(","rgba(").replace(")",`,${O.toFixed(3)})`),w=1.1*n*u,f=13*n*u,b=42*n*(.7+.3*u),R=!l.noTip&&E>.28?Math.min(1,(E-.28)/.22)*b*.42:0,L=P+R,C=t.createLinearGradient(0,I,0,L),F=T=>Math.max(.02,Math.min(.99,T+((c.heat??.5)-.5)*1.1));C.addColorStop(0,v(F(.55),0)),C.addColorStop(.18,v(F(.64),.3*x)),C.addColorStop(.4,v(F(.76),.8*x)),C.addColorStop(.65,v(F(.88),.98*x)),C.addColorStop(1,v(F(.97),x));const G=l.dots?(()=>{const T=Math.abs(L-I),O=Math.max(3,Math.round(T/(9.5*n))),W=d*1.15*A%1,J=(S,h,y)=>{const D=Math.max(0,Math.min(1,(y-S)/(h-S)));return D*D*(3-2*D)},Z=[];for(let S=0;S<O;S++){const h=((S+.5)/O+W/O)%1,y=1+.22*Math.sin((h*3-W*2)*Math.PI*2);Z.push({y:I+(L-I)*h,r:(w/2+(f/2-w/2)*h)*y,a:(1-.35*J(.72,.92,h))*(1-J(.92,1,h))})}return Z})():null;if(t.save(),t.filter=`blur(${7*n}px)`,t.globalAlpha=l.dots?.3:.55,t.fillStyle=C,l.dots){const T=t.globalAlpha;for(const O of G)t.globalAlpha=T*O.a,t.beginPath(),t.arc(i,O.y,Math.max(1.4*n,O.r*1.5),0,Math.PI*2),t.fill();t.globalAlpha=T}else t.beginPath(),t.moveTo(i-w,I),t.lineTo(i+w,I),t.lineTo(i+f*.95,L),t.lineTo(i-f*.95,L),t.closePath(),t.fill();if(t.restore(),t.globalAlpha=1,t.fillStyle=C,l.dots){for(const T of G)t.globalAlpha=T.a,t.beginPath(),t.arc(i,T.y,Math.max(.9*n,T.r*.92),0,Math.PI*2),t.fill();t.globalAlpha=1}else t.beginPath(),t.moveTo(i-w/2,I),t.lineTo(i+w/2,I),t.lineTo(i+f/2,L),t.lineTo(i-f/2,L),t.closePath(),t.fill();if(t.globalAlpha=x,E>.28&&!l.noTip){const T=b,O=Math.min(1,(E-.28)/.22)*x,W=P+T*.3;t.globalAlpha=O;const J={color:e(F(.95)),glowColor:e(F(.85)),glow:12*p};r.glyph&&(r.glyph(t,"LIFT_TIP",i,W,T,J)||r.glyph(t,"TIP_TRI",i,W,T*.93,J))||(t.strokeStyle=e(.95),t.lineWidth=13*n*u,t.lineCap="round",t.lineJoin="round",t.shadowColor=e(.9),t.shadowBlur=18*n*p,t.beginPath(),t.moveTo(i-26*n,W+14*n),t.lineTo(i,W-16*n),t.lineTo(i+26*n,W+14*n),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function qt(t,a,o,d,r,l,e={}){const c=l.lut,u=l.arrow||{},A=u.w??1,p=u.glow??1,m=w=>Math.max(.02,Math.min(.99,w+((u.heat??.5)-.5)*1.1)),s=o/256*(e.scale??1);t.clearRect(0,0,a,o);const n=d.map(([w,f])=>[w*a,f*o]);if(n.length<2)return;const i=48,M=[],E=w=>{if(n.length===2)return[n[0][0]+(n[1][0]-n[0][0])*w,n[0][1]+(n[1][1]-n[0][1])*w];const f=w*(n.length-1),b=Math.min(n.length-2,Math.floor(f)),R=f-b,L=n[Math.max(0,b-1)],C=n[b],F=n[b+1],G=n[Math.min(n.length-1,b+2)],T=(O,W,J,Z)=>.5*(2*W+(-O+J)*R+(2*O-5*W+4*J-Z)*R*R+(-O+3*W-3*J+Z)*R*R*R);return[T(L[0],C[0],F[0],G[0]),T(L[1],C[1],F[1],G[1])]};for(let w=0;w<=i;w++)M.push(E(w/i));const _=Math.max(0,Math.min(1,e.prog!=null?e.prog:r*.55%1)),x=Math.max(1,Math.round(i*_)),I=e.alpha??1,k=e.tail??.22;t.lineCap="round";const P=42*s*(.7+.3*A);let v=x;if(_>.28){let w=0;const f=P*.42*Math.min(1,(_-.28)/.22);for(;v>1&&w<f;)w+=Math.hypot(M[v][0]-M[v-1][0],M[v][1]-M[v-1][1]),v--}for(const w of[0,1])for(let f=1;f<=v;f++){const b=f/x,R=Math.min(1,b/k),L=R*R*(3-2*R)*I;t.globalAlpha=w?L:L*.16*b,t.strokeStyle=c(.55+.42*b),t.lineWidth=(1.1+11.9*b)*s*A*(w?1:1.9),t.beginPath(),t.moveTo(M[f-1][0],M[f-1][1]),t.lineTo(M[f][0],M[f][1]),t.stroke()}if(_>.28){const w=M[Math.max(0,x-2)][0],f=M[Math.max(0,x-2)][1],b=Math.atan2(M[x][1]-f,M[x][0]-w)+Math.PI/2,R=M[x][0]-Math.sin(b)*P*.3,L=M[x][1]+Math.cos(b)*P*.3;t.save(),t.translate(R,L),t.rotate(b),t.globalAlpha=Math.min(1,(_-.28)/.22)*I;const C={color:c(m(.95)),glowColor:c(m(.85)),glow:12*p};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,P,C)||l.glyph(t,"TIP_TRI",0,0,P*.93,C))||(t.strokeStyle=c(.95),t.lineWidth=9*s*A,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*s,12*s),t.lineTo(0,-14*s),t.lineTo(18*s,12*s),t.stroke()),t.restore()}t.globalAlpha=1}function Kt(t,a,o,d,r,l){r=r||{};const e=l.lut,c=r.style||l.arrow.line,u=!!r.closed,A=[0];for(let n=1;n<a.length;n++)A.push(A[n-1]+Math.hypot(a[n][0]-a[n-1][0],a[n][1]-a[n-1][1]));const p=A[A.length-1]||1,m=n=>{n=(n%p+p)%p;let i=1;for(;i<A.length-1&&A[i]<n;)i++;const M=(n-A[i-1])/Math.max(1e-4,A[i]-A[i-1]);return[a[i-1][0]+(a[i][0]-a[i-1][0])*M,a[i-1][1]+(a[i][1]-a[i-1][1])*M,Math.atan2(a[i][1]-a[i-1][1],a[i][0]-a[i-1][0])]},s=l.arrow;if(c==="chevron"){const n=(26*d+8)*s.gap,i=Math.max(2,Math.floor(p/n));t.shadowColor=e(Math.min(1,s.heat+.2)),t.shadowBlur=8*d*s.glow;for(let M=0;M<i;M++){const E=M*n+o*42*s.speed%n;if(!u&&E>p-4)continue;const[_,x,I]=m(E),k=7.5*d,P=8.5*d,v=.45+.4*Math.sin(E/p*6.283-o*2.2*s.speed);t.strokeStyle=e(s.heat-.05+v*.3),t.lineWidth=3.2*d,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(_,x),t.rotate(I),t.beginPath(),t.moveTo(-P*.5,-k),t.lineTo(P*.5,0),t.lineTo(-P*.5,k),t.stroke(),t.restore()}return!0}if(c==="comet"){const n=o*.35*s.speed%1*p,i=p*s.tail,M=Math.max(24,a.length*2);t.lineCap="round";for(let x=0;x<M;x++){const I=n-x/M*i,k=n-(x+1)/M*i;if(!u&&k<0)break;const P=1-x/M,[v,w]=m(I),[f,b]=m(k);!u&&Math.hypot(f-v,b-w)>p*.4||(t.globalAlpha=Math.pow(P,1.6),t.strokeStyle=e(Math.max(.05,s.heat-.2)+P*.55),t.lineWidth=(1.5+P*4.5)*d,P>.72?(t.shadowColor=e(Math.min(1,s.heat+.3)),t.shadowBlur=P*12*d*s.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(v,w),t.lineTo(f,b),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[E,_]=m(n);return t.fillStyle=rgba(o0.ink,.95),t.shadowColor=e(.9),t.shadowBlur=16*d,t.beginPath(),t.arc(E,_,2.6*d,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=r.color||e(s.heat),t.shadowColor=e(Math.min(1,s.heat+.15)),t.shadowBlur=(r.glow??8)*d*s.glow,c==="taper")for(let n=1;n<a.length;n++)t.lineWidth=(.5+n/a.length*4.5)*d,t.beginPath(),t.moveTo(a[n-1][0],a[n-1][1]),t.lineTo(a[n][0],a[n][1]),t.stroke();else Wt(t,d,o,l),t.beginPath(),a.forEach(([n,i],M)=>M?t.lineTo(n,i):t.moveTo(n,i)),u&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function ro(t,a,o,d,r,l){const e=13*d.halo,c=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const u=a/220,A=a/2,p=18*o.round*u,m=40*u,s=48*u,n=a-80*u,i=a-96*u,M=[],E=(x,I,k,P)=>{for(let v=0;v<=1;v+=.12)M.push([x+(k-x)*v,I+(P-I)*v])};E(m+p,s,m+n-p,s),E(m+n,s+p,m+n,s+i-p),E(m+n-p,s+i,m+p,s+i),E(m,s+i-p,m,s+p),t.shadowColor=c(.6),t.shadowBlur=e*.8;const _=4*l.arrow.w*u;if(l.arrow.line==="solid"?(t.setLineDash([10*o.dash*u,8*u]),t.lineDashOffset=-r*22*u,t.strokeStyle=c(.45),t.lineWidth=_,t.beginPath(),t.roundRect(m,s,n,i,p),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):Kt(t,M,r,l.arrow.w*u,{color:c(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const x=[],I=(C,F,G,T,O)=>{for(let W=1;W<=O;W++)x.push([C+(G-C)*W/O,F+(T-F)*W/O])},k=(C,F,G,T,O)=>{for(let W=1;W<=O;W++){const J=G+(T-G)*W/O;x.push([C+p*Math.cos(J),F+p*Math.sin(J)])}},P=Math.PI/2,v=m+n,w=s+i,f=m+n/2;x.push([f,s]),I(f,s,v-p,s,8),k(v-p,s+p,-P,0,6),I(v,s+p,v,w-p,10),k(v-p,w-p,0,P,6),I(v-p,w,m+p,w,14),k(m+p,w-p,P,Math.PI,6),I(m,w-p,m,s+p,10),k(m+p,s+p,Math.PI,Math.PI+P,6),I(m+p,s,f,s,8);let b=0;for(let C=1;C<x.length;C++)b+=Math.hypot(x[C][0]-x[C-1][0],x[C][1]-x[C-1][1]);const R=b*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*u,8*u]),t.lineDashOffset=-(n/2-p)-r*22*u,t.strokeStyle=c(.9),t.lineWidth=_*1.3,t.lineCap="round",t.shadowColor=c(.92),t.shadowBlur=e*1.3,t.beginPath(),t.moveTo(x[0][0],x[0][1]);let L=0;for(let C=1;C<x.length&&L<R;C++){const F=Math.hypot(x[C][0]-x[C-1][0],x[C][1]-x[C-1][1]);if(L+F<=R)t.lineTo(x[C][0],x[C][1]),L+=F;else{const G=(R-L)/F;t.lineTo(x[C-1][0]+(x[C][0]-x[C-1][0])*G,x[C-1][1]+(x[C][1]-x[C-1][1])*G),L=R}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&l.foot&&(l.foot(t,!1,A-16*o.feet*u,A+6*u,26*o.feet*u),l.foot(t,!0,A+16*o.feet*u,A+6*u,26*o.feet*u)),t.shadowBlur=0}function io(t,a,o,d,r,l,e,c){const u=13*d.halo,A=4*l.arrow.w*(a/220),p=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const m=a/220,s=e||[[45*m,130*m],[110*m,60*m],[175*m,110*m]],n=c??r*.5%1,i=Math.min(1,n*1.25)*(s.length-1),M=Math.min(s.length-1,Math.floor(i+.35));t.shadowColor=p(.7),t.shadowBlur=u;const E=w=>{const f=Math.max(0,Math.min(s.length-2,Math.floor(w))),b=w-f;return[s[f][0]+(s[f+1][0]-s[f][0])*b,s[f][1]+(s[f+1][1]-s[f][1])*b]},_=o.comet!=null?o.comet:1,x=o.tailLen!=null?o.tailLen:.5;if(t.save(),t.shadowBlur=0,t.globalAlpha=o.rail!=null?o.rail:.22,t.strokeStyle=p(.6),t.lineWidth=2.2*m,t.lineCap="round",t.setLineDash([.01,8*m]),t.beginPath(),s.forEach(([w,f],b)=>b?t.lineTo(w,f):t.moveTo(w,f)),t.stroke(),t.setLineDash([]),t.restore(),i>.02){const w=(f,b)=>p(f).replace("rgb(","rgba(").replace(")",`,${b.toFixed(3)})`);for(let f=0;f<26;f++){const b=f/25,R=i-x*b;if(R<=0)break;const L=E(R),C=4.7*m*_*(1-b*.75),F=C*2.1,G=(1-b)*(1-b)*.8,T=t.createRadialGradient(L[0],L[1],0,L[0],L[1],F);T.addColorStop(0,w(.55-.18*b,G)),T.addColorStop(.5,w(.5-.18*b,G*.35)),T.addColorStop(1,w(.45-.18*b,0)),t.save(),t.shadowBlur=0,t.globalAlpha=1,t.fillStyle=T,t.beginPath(),t.arc(L[0],L[1],F,0,Math.PI*2),t.fill(),t.restore()}if(i<s.length-1-.001&&i-Math.floor(i)>.03){const f=E(i);t.save(),t.fillStyle=p(.62),t.shadowColor=p(.8),t.shadowBlur=11*m*_,t.beginPath(),t.arc(f[0],f[1],5.6*m*_,0,Math.PI*2),t.fill(),t.fillStyle=p(.95),t.globalAlpha=.95,t.beginPath(),t.arc(f[0],f[1],2.1*m*_,0,Math.PI*2),t.fill(),t.restore()}}t.globalAlpha=1,t.lineCap="butt";const I=o.done!=null,k=o.done||0,P=o.vd||[],v=o.acc!=null?o.acc:s.length-1;if(s.forEach(([w,f],b)=>{const R=b<k,L=P[b]||null,C=!R&&b===M&&!I,F=C?1+Math.sin(r*6)*.14:1,G=o.pop!=null&&b===k-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,T=12*o.node*F*G*m*(b===v?1.34:1);R&&L!=="miss"&&(t.shadowBlur=u*1.4,t.shadowColor=p(.5),t.fillStyle=p(L==="near"?.5:.36),t.beginPath(),t.arc(w,f,T*.88,0,Math.PI*2),t.fill()),R||(t.save(),t.translate(w,f),a0(t,p,T,C?.8:.5,C?.9:.5,A*.9,u),t.restore()),t.strokeStyle=L==="hit"?K.prism:L==="near"?K.sand:L==="miss"?o0.lo:p(R?.62:C?.8:.45),t.lineWidth=A*(C?1.3:L?1.15:.9),t.shadowBlur=C?u*1.6:L&&L!=="miss"?u*1.3:u*.6,L&&L!=="miss"&&(t.shadowColor=L==="hit"?K.prism:K.sand),t.beginPath(),t.arc(w,f,T,0,Math.PI*2),t.stroke(),l.num&&(R&&L!=="miss"?(t.save(),t.globalCompositeOperation="destination-out",t.shadowBlur=0,l.num(t,String(b+1),w,f,16*o.numS*F*m,Math.round(14*o.numS*m)),t.restore()):(t.globalAlpha=b<=M?1:.6,l.num(t,String(b+1),w,f,16*o.numS*F*m,Math.round(14*o.numS*m)),t.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&k>0&&s[k-1]){const[w,f]=s[k-1],b=1-o.pop/.38,R=b*b,L=12*o.node*m*(k-1===(o.acc!=null?o.acc:s.length-1)?1.34:1);t.save();const C=L*(1.6+1.9*(1-b)),F=t.createRadialGradient(w,f,0,w,f,C);F.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*R).toFixed(3)})`),F.addColorStop(.35,p(.92).replace("rgb(","rgba(").replace(")",`,${(.8*R).toFixed(3)})`)),F.addColorStop(1,p(.7).replace("rgb(","rgba(").replace(")",",0)")),t.fillStyle=F,t.beginPath(),t.arc(w,f,C,0,Math.PI*2),t.fill(),t.strokeStyle=p(.92),t.globalAlpha=R,t.lineWidth=Math.max(1,6*m*b),t.shadowColor=p(.85),t.shadowBlur=24*m*R,t.beginPath(),t.arc(w,f,L*(1.1+3.4*(1-b)),0,Math.PI*2),t.stroke();const G=Math.max(0,b-.35)/.65;G>0&&(t.globalAlpha=G*G*.6,t.lineWidth=Math.max(1,3.5*m*G),t.beginPath(),t.arc(w,f,L*(1.1+2*(1-G)),0,Math.PI*2),t.stroke()),t.restore()}t.shadowBlur=0}function a0(t,a,o,d,r,l,e,c=1){if(o<=.6)return;const u=(n,i)=>a(n).replace("rgb(","rgba(").replace(")",`,${i})`),A=l*2.6*c,p=Math.max(.1,o-A),m=o+A,s=t.createRadialGradient(0,0,p,0,0,m);s.addColorStop(0,u(d-.05,0)),s.addColorStop(.5,u(d,r*.85)),s.addColorStop(1,u(d-.05,0)),t.globalAlpha=1,t.fillStyle=s,t.shadowBlur=0,t.beginPath(),t.arc(0,0,m,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,r*1.1),t.lineWidth=l*.85,t.strokeStyle=a(Math.min(.98,d+.12)),t.shadowColor=a(.88),t.shadowBlur=e*.6,t.beginPath(),t.arc(0,0,o,0,Math.PI*2),t.stroke(),t.shadowBlur=0}const l0=t=>1-Math.pow(1-Math.max(0,Math.min(1,t)),5);function co(t,a,o,d,r,l){const e=l.lut,c=a/512,u=l?.day?1:0,A=l.arrow&&l.arrow.w||1,p=(S,h)=>e(S).replace("rgb(","rgba(").replace(")",","+h+")"),m=u?.95:.86,s=(S,h)=>p(m,S),n=4*A*c;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const i=o.mat||{nx:.86,fx:.86,ny:-.86,fy:.86},M=o.in==null?1:Math.max(0,Math.min(1,o.in)),E=l0(M/.45),_=S=>l0((M-.28-S*.09)/.42),x=o.hit==null?9:o.hit,I=x<.34?Math.sin(Math.PI*(x/.34)):0,k=S=>a/2+S*a/2,P=S=>a/2-S*a/2,v=(S,h)=>e(S).replace("rgb(","rgba(").replace(")",","+h+")"),w=(S,h,y,D,B,q,U)=>{t.font="700 "+D+'px "Supreme", sans-serif',t.textAlign="center",t.textBaseline="middle";const H=Array.from(String(S)),$=D*q;let Y=-$;for(const z of H)Y+=t.measureText(z).width+$;let j=h-Y/2;t.fillStyle=B;for(const z of H){const g=t.measureText(z).width;t.fillText(z,j+g/2,y),j+=g+$}},f=.05*(o.round!=null?o.round/.35:1),b=(S,h,y,D)=>{};b(-i.fx+f,i.fy-f),b(-i.nx+f*.6,i.ny+f),b(i.nx-f*.6,i.ny+f),b(i.fx-f,i.fy-f);const R=o.center?o.center.x:0,L=o.center?o.center.y:0,C=(o.center&&o.center.r!=null?o.center.r:.26)*a/2*E*(1+.055*I+.008*Math.sin(r*2.4)),F=o.tgK==null?1:Math.max(0,Math.min(1,o.tgK)),G=F>.004?(o.targets||[]).slice().sort((S,h)=>(S.n||0)-(h.n||0)):[];if(G.length){t.save(),t.shadowBlur=0,t.globalAlpha=(u?.55:.22)*l0(M/.9),t.strokeStyle=e(u?.3:.6),t.lineWidth=(u?3.6:2.2)*c,t.lineCap="round",t.setLineDash([.01,(u?6:8)*c]);const S=o.travel||{};for(const h of G){const y=k(h.x),D=P(h.y),B=k(R)-y,q=P(L)-D,U=S.k>0&&S.k<1&&(h.n===S.from||h.n===S.to),H=Math.hypot(B,q)||1,$=(h.r!=null?h.r:.13)*a/2*1.25,Y=y+B/H*$,j=D+q/H*$,z=C*(o.center&&o.center.live?1.34:1),g=k(R)-B/H*z*1.12,X=P(L)-q/H*z*1.12;if(t.beginPath(),t.moveTo(Y,j),t.lineTo(g,X),t.stroke(),I>.01){const Q=1-I,N=.34,c0=t.createLinearGradient(g,X,Y,j),n0=(w0,S0)=>c0.addColorStop(Math.max(0,Math.min(1,w0)),e(.85).replace("rgb(","rgba(").replace(")",","+S0+")"));n0(Q-N,0),n0(Q,.9*I),n0(Q+N,0),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=c0,t.lineWidth=3.4*c,t.stroke(),t.restore()}if(U){const Q=t.createLinearGradient(Y,j,g,X),N=Math.sin(Math.PI*S.k)*.85;Q.addColorStop(0,e(.5).replace("rgb(","rgba(").replace(")",",0)")),Q.addColorStop(.5,e(.9).replace("rgb(","rgba(").replace(")",","+N+")")),Q.addColorStop(1,e(.5).replace("rgb(","rgba(").replace(")",",0)")),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=Q,t.lineWidth=3*c,t.stroke(),t.restore()}}t.setLineDash([]),t.restore()}const T=o.travel;if(T&&T.k>.001&&T.k<1){const S=G.find(y=>y.n===T.from),h=G.find(y=>y.n===T.to);if(S&&h){const y=k(S.x),D=P(S.y),B=k(h.x),q=P(h.y),U=k(R),H=P(L),$=l0(T.k),Y=N=>N<.5?[y+(U-y)*(N/.5),D+(H-D)*(N/.5)]:[U+(B-U)*((N-.5)/.5),H+(q-H)*((N-.5)/.5)],[j,z]=Y($),[g,X]=Y(Math.max(0,$-.28)),Q=t.createLinearGradient(g,X,j,z);Q.addColorStop(0,e(.5).replace("rgb(","rgba(").replace(")",",0)")),Q.addColorStop(1,e(.85).replace("rgb(","rgba(").replace(")",",0.85)")),t.strokeStyle=Q,t.lineWidth=3.2*c,t.lineCap="round",t.beginPath(),t.moveTo(g,X),t.lineTo(j,z),t.stroke(),t.fillStyle=e(.62),t.shadowColor=e(.8),t.shadowBlur=11*c,t.beginPath(),t.arc(j,z,5.6*c,0,Math.PI*2),t.fill(),t.fillStyle=e(.95),t.globalAlpha=.95,t.shadowBlur=0,t.beginPath(),t.arc(j,z,2.1*c,0,Math.PI*2),t.fill(),t.globalAlpha=1}}const O=13*d.halo*(u?.45:1);for(const S of o.targets||[]){const h=S.on!==!1,y=!!S.live,D=_(S.n?S.n-1:0)*F;if(D<=.001)continue;const B=k(S.x),q=P(S.y),U=(S.r!=null?S.r:.2)*a/2*(y?1.34:1)*(.9+.1*D);t.globalAlpha=D*(h?1:.45),t.shadowBlur=O*1.4,t.shadowColor=e(.5),t.fillStyle=e(u?y?.26:.62:y?.5:.36),t.beginPath(),t.arc(B,q,U*.88,0,Math.PI*2),t.fill(),t.shadowBlur=0,t.save(),t.translate(B,q),a0(t,e,U,y?.8:.5,y?.9:.5,n*.9,O),t.restore();const H=S.v;t.strokeStyle=H==="hit"?K.prism:H==="near"?K.sand:H==="miss"?o0.lo:e(y?.8:.45),t.lineWidth=n*(y?1.3:H?1.15:.9),t.shadowBlur=y?O*1.6:H&&H!=="miss"?O*1.3:O*.6,t.shadowColor=H==="hit"?K.prism:H==="near"?K.sand:e(.5),t.beginPath(),t.arc(B,q,U,0,Math.PI*2),t.stroke(),t.shadowBlur=0,l.num(t,S.n,B,q,U*.9,Math.round(U*.78)),t.globalAlpha=1}const W=(S,h,y,D)=>{const B=13*d.halo,q=o.per||.4,U=Math.max(0,Math.min(1,D/q)),H=Math.min(.16,q*.42),$=Math.max(0,Math.min(1,1-D/H)),Y=y*1.9;for(let g=2;g>=0;g--){const X=Math.pow(Math.max(0,U-g*.05),1.6),Q=Y-(Y-y)*X,N=g===0?.55+.35*X:.16/g;t.save(),t.translate(S,h),a0(t,e,Q,.5+.35*X,N,n*.45,B,1.15-.35*X),t.restore()}$>.01&&(t.save(),t.translate(S,h),a0(t,e,y*(1+1.5*(1-$)),.92,$*.9,n*1.7,B,1.1),t.restore());const j=Math.max(0,Math.min(1,1-D/.22)),z=j*j;if(z>.01){const g=Math.max(1,y*(1.5+1.8*(1-j))),X=t.createRadialGradient(S,h,0,S,h,g);X.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.15*z).toFixed(3)})`),X.addColorStop(.35,v(.92,(.8*z).toFixed(3))),X.addColorStop(1,v(.7,0)),t.save(),t.shadowBlur=0,t.fillStyle=X,t.beginPath(),t.arc(S,h,g,0,Math.PI*2),t.fill(),t.restore()}},J=(o.targets||[]).filter(S=>S&&S.hit!=null&&S.hit<1.2);for(const S of J){const h=(S.r!=null?S.r:.2)*a/2*(S.live?1.34:1);W(k(S.x),P(S.y),h,S.hit)}const Z=o.center?o.center.hit!=null?o.center.hit:o.hit!=null?x:null:null;if(Z!=null&&Z<1.2&&W(k(R),P(L),C,Z),o.center){const S=k(R),h=P(L),y=13*d.halo*(u?.45:1),D=t.createRadialGradient(S,h,C*.1,S,h,C*1.6);D.addColorStop(0,v(.42,.3)),D.addColorStop(.6,v(.35,.12)),D.addColorStop(1,v(.3,0)),t.fillStyle=D,t.beginPath(),t.arc(S,h,C*1.6,0,Math.PI*2),t.fill();const B=!!o.center.live,q=C*(B?1.34:1);t.shadowBlur=y*1.4,t.shadowColor=e(.5),t.fillStyle=e(u?B?.26:.62:B?.5:.36),t.beginPath(),t.arc(S,h,q*.88,0,Math.PI*2),t.fill(),t.shadowBlur=0,t.save(),t.translate(S,h),a0(t,e,q,B?.8:.5,B?.9:.5,n*.9,y),t.restore();const U=o.center.v;if(t.strokeStyle=U==="hit"?K.prism:U==="near"?K.sand:U==="miss"?o0.lo:e(B?.8:.45),t.lineWidth=n*(B?1.3:U?1.15:.9),t.shadowBlur=B?y*1.6:U&&U!=="miss"?y*1.3:y*.6,t.shadowColor=U==="hit"?K.prism:U==="near"?K.sand:e(.5),t.beginPath(),t.arc(S,h,q,0,Math.PI*2),t.stroke(),t.shadowBlur=0,o.brand&&l.logo&&l.logo.complete&&l.logo.naturalWidth){const H=C*.62,$=H*l.logo.naturalHeight/l.logo.naturalWidth;t.globalAlpha=.88*E,t.drawImage(l.logo,S-H/2,h-$/2,H,$),t.globalAlpha=1}if(o.center.label){const H=String(o.center.label).split(`
`);H.forEach(($,Y)=>w($,S,h+(Y-(H.length-1)/2)*15*c,12*c,s(.9),.14))}}if(o.prog>.001&&o.center){const S=k(R),h=P(L),y=I;t.strokeStyle=v(.34,.9+.1*y),t.lineWidth=n*(.85+.5*y),t.lineCap="round",t.shadowColor=e(.42),t.shadowBlur=(10+16*y)*c,t.beginPath(),t.arc(S,h,C,-Math.PI/2,-Math.PI/2+Math.PI*2*Math.min(1,o.prog)),t.stroke(),t.shadowBlur=0}}function uo(t,a,o,d,r,l,e){const c=l.lut,u=13*d.halo,A=a/220,p=a/2,m=l.arrow&&l.arrow.w||1,s=(v,w)=>c(v).replace("rgb(","rgba(").replace(")",`,${w})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const n=(o.r!=null?o.r:.42)*a,i=n*(o.rt!=null?o.rt:.36),M=3.4*m*A,E=e!=null?Math.max(0,Math.min(1,e)):r*(o.tempo||.6)%1,_=Math.pow(E,1.6),x=Math.max(0,(E-.9)/.1);t.save(),t.translate(p,p);const I=(v,w,f,b=1)=>a0(t,c,v,w,f,M,u,b),k=t.createRadialGradient(0,0,0,0,0,i*1.08);k.addColorStop(0,s(.6,.1+.18*x)),k.addColorStop(.65,s(.5,.05+.08*x)),k.addColorStop(1,s(.5,0)),t.globalAlpha=1,t.fillStyle=k,t.beginPath(),t.arc(0,0,i*1.08,0,Math.PI*2),t.fill();const P=1+.02*Math.sin(r*2.6);I(i*P,.55+.4*x,.5+.45*x,.9);for(let v=2;v>=0;v--){const w=Math.pow(Math.max(0,E-v*.05),1.6),f=n-(n-i)*w,b=v===0?.6+.4*_:.18/v*(1-x);I(f,.55+.4*_,b*(1-x*.45),1.15-.35*_)}x>.01&&I(i*(1+1.4*x),.9,(1-x)*.8,1.1),t.globalAlpha=.6+.3*x,t.shadowColor=c(.85),t.shadowBlur=u*(.9+x),t.fillStyle=c(.62+.3*x),t.beginPath(),t.arc(0,0,M*.85+3*A*x,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function ho(t,a,o,d,r,l,e,c){const u=l.lut,A=13*d.halo,p=a/220,m=a/2,s=l.arrow&&l.arrow.w||1,n=s*p,i=(h,y)=>u(h).replace("rgb(","rgba(").replace(")",","+y+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const M=a*.42*(o.spread!=null?o.spread:1),_=(c||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([h,y])=>[m+h*M,m+y*M]),x=80,I=[];for(let h=0;h<=x;h++){const y=h/x*(_.length-1),D=Math.min(_.length-2,Math.floor(y)),B=y-D,q=_[Math.max(0,D-1)],U=_[D],H=_[D+1],$=_[Math.min(_.length-1,D+2)],Y=(j,z,g,X)=>.5*(2*z+(-j+g)*B+(2*j-5*z+4*g-X)*B*B+(-j+3*z-3*g+X)*B*B*B);I.push([Y(q[0],U[0],H[0],$[0]),Y(q[1],U[1],H[1],$[1])])}const k=h=>{const y=Math.max(0,Math.min(x,h*x)),D=Math.floor(y),B=y-D,q=I[D],U=I[Math.min(x,D+1)];return[q[0]+(U[0]-q[0])*B,q[1]+(U[1]-q[1])*B]},P=.68;let v,w,f;if(e!=null)v=Math.max(0,Math.min(1,e)),w=1,f=0;else{const h=r*(o.tempo||.42)%1;if(h<P)v=h/P,w=1,f=0;else{const y=(h-P)/(1-P);v=1,w=1-y*y,f=y}}if(w<=.012)return;const b=v*v*v*(v*(6*v-15)+10),R=Math.min(1,16*v*v*(1-v)*(1-v));o.taper!=null&&o.taper;const L=.36*(o.tail!=null?o.tail:1),C=o.width!=null?o.width:1;{const h=t.createLinearGradient(I[0][0],I[0][1],I[x][0],I[x][1]);h.addColorStop(0,i(.46,0)),h.addColorStop(.3,i(.46,.03*w)),h.addColorStop(.8,i(.46,.045*w)),h.addColorStop(1,i(.46,0)),t.globalAlpha=1,t.strokeStyle=h,t.lineWidth=9*n,t.shadowColor=u(.6),t.shadowBlur=A*2,t.beginPath(),I.forEach(([y,D],B)=>B?t.lineTo(y,D):t.moveTo(y,D)),t.stroke(),t.shadowBlur=0}const F=40,G=Math.max(0,b-L*(1-f)),T=[];for(let h=0;h<=F;h++)T.push(k(G+(b-G)*(h/F)));const O=()=>{t.beginPath(),T.forEach(([h,y],D)=>D?t.lineTo(h,y):t.moveTo(h,y)),t.stroke()},W=()=>{const h=t.createLinearGradient(T[0][0],T[0][1],T[F][0],T[F][1]);return h.addColorStop(0,i(.55,0)),h.addColorStop(.4,i(.56,0)),h.addColorStop(.68,i(.6,.09)),h.addColorStop(.88,i(.64,.24)),h.addColorStop(1,i(.68,.44)),h},J=1+.5*R;t.globalAlpha=w,t.strokeStyle=W(),t.lineWidth=(20+10*R)*n*C,t.shadowColor=u(.72),t.shadowBlur=A*2.2,O(),t.strokeStyle=W(),t.lineWidth=(10+5*R)*n*C,t.shadowBlur=A*1,O(),t.shadowBlur=0;for(let h=1;h<=F;h++){const y=h/F;t.globalAlpha=Math.pow(y,2.2)*.95*w,t.strokeStyle=u(.55+.38*y),t.lineWidth=(1.6+6.5*Math.pow(y,.7))*n*C*J,t.beginPath(),t.moveTo(T[h-1][0],T[h-1][1]),t.lineTo(T[h][0],T[h][1]),t.stroke()}const Z=T[F][0],S=T[F][1];t.globalAlpha=.8*w,t.fillStyle=u(.6),t.shadowColor=u(.8),t.shadowBlur=A*1.6,t.beginPath(),t.arc(Z,S,(9+5*R)*n*C,0,Math.PI*2),t.fill(),t.globalAlpha=w,t.fillStyle=u(.93),t.shadowBlur=A*.6,t.beginPath(),t.arc(Z,S,(3.4+1.8*R)*n*C,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function po(t,a,o,d,r,l,e){const c=o.r!=null?o.r:.3,u=o.dir!=null?o.dir:1,A=(o.sweep!=null?o.sweep:.66)*Math.PI*2,p=e??r*(o.tempo!=null?o.tempo:.5)%1,m=-Math.PI/2+u*p*Math.PI*2,s=16,n=[];for(let i=0;i<=s;i++){const M=m-u*(1-i/s)*A;n.push([.5+Math.cos(M)*c,.5+Math.sin(M)*c])}qt(t,a,a,n,r,l,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}function fo(t,a,o,d,r,l,e={}){const c=Math.max(2,Math.round(e.count??7)),u=e.r??4.4,A=e.flow??.35,p=e.hair??.26,m=e.style||"chain",s=e.color||"255,246,234",n=e.inset??.12,i=e.alpha??1,M=d-a,E=r-o,_=Math.hypot(M,E);if(_<.001||i<=.004)return;const x=M/_,I=E/_,k=a+M*n,P=o+E*n,v=_*(1-n*2);if(v<=0)return;t.save(),m==="chain"&&p>0&&(t.strokeStyle=`rgba(${s},${(p*i).toFixed(3)})`,t.lineWidth=Math.max(1,u*.34),t.beginPath(),t.moveTo(k,P),t.lineTo(k+x*v,P+I*v),t.stroke());const w=l*A%1;for(let f=0;f<c;f++){let b=(f+.5)/c;if(m==="pulse"||m==="dots"||m==="chain"){const T=b-.5;if(b=.5+T+Math.sign(T)*(w/c%(1/c)),b<0||b>1)continue}const R=k+x*v*b,L=P+I*v*b,C=Math.abs(b-.5)*2;let F=u,G=i;if(m==="taper"&&(F=u*(.55+.75*C)),m==="pulse"){const T=((C-w)%1+1)%1;G=i*(.35+.65*Math.max(0,1-Math.abs(T-0)*3))}t.fillStyle=`rgba(${s},${(G*.96).toFixed(3)})`,t.beginPath(),t.arc(R,L,F,0,Math.PI*2),t.fill()}t.restore()}export{C0 as A,eo as C,Ht as F,x0 as G,Gt as L,to as M,o0 as N,K as P,Jt as Q,ao as R,Yt as S,Qt as Z,e0 as a,Ot as b,uo as c,Vt as d,po as e,so as f,ho as g,co as h,Nt as i,fo as j,io as k,Xt as l,jt as m,ro as n,oo as o,no as p,i0 as q,Kt as r,m0 as s,$t as t,zt as u,lo as v,gt as w,qt as x,Zt as y,b0 as z};
