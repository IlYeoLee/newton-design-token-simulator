const F={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},W={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},r0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)],S0=Object.fromEntries(Object.entries({...F,...W}).map(([a,t])=>[a,parseInt(t.slice(1),16)])),q=a=>`vec3(${r0(a).map(o=>(o/255).toFixed(4)).join(", ")})`,C0=(a,t=1)=>`rgba(${r0(a).join(",")},${t})`,u0=[[F.red,0],[F.red,.3],[F.coral,.56],[F.sand,.86],[F.prism,1]],d0=1;function f0(a){const t=String(a).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(t)||Object.values(W).some(o=>o.toUpperCase()===t)?!0:Object.values(F).some(o=>o.toUpperCase()===t)}function I0(a){return a&&((!Array.isArray(a.stops)||!a.stops.every(([o])=>f0(o)))&&(a.stops=u0.map(o=>[...o])),a.sat=d0,a)}function e0(a,t,o,c,n){let l=0;o[0]=0,c[0]=-1e20,c[1]=1e20;for(let s=1;s<n;s++){let u=(a[s]+s*s-(a[o[l]]+o[l]*o[l]))/(2*s-2*o[l]);for(;u<=c[l];)l--,u=(a[s]+s*s-(a[o[l]]+o[l]*o[l]))/(2*s-2*o[l]);l++,o[l]=s,c[l]=u,c[l+1]=1e20}l=0;for(let s=0;s<n;s++){for(;c[l+1]<s;)l++;t[s]=(s-o[l])*(s-o[l])+a[o[l]]}}function l0(a,t){const o=new Float32Array(t),c=new Int32Array(t),n=new Float32Array(t+1),l=new Float32Array(t);for(let s=0;s<t;s++){for(let u=0;u<t;u++)l[u]=a[u*t+s];e0(l,o,c,n,t);for(let u=0;u<t;u++)a[u*t+s]=o[u]}for(let s=0;s<t;s++){for(let u=0;u<t;u++)l[u]=a[s*t+u];e0(l,o,c,n,t);for(let u=0;u<t;u++)a[s*t+u]=o[u]}}function i0(a,t){const c=new Float32Array(t*t),n=new Float32Array(t*t);let l=0,s=0,u=0;for(let w=0;w<t*t;w++){const d=a[w*4+3]/255;c[w]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),n[w]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(l+=w%t,s+=w/t|0,u++)}l0(c,t),l0(n,t);const f=new Float32Array(t*t);for(let w=0;w<t*t;w++)f[w]=(Math.sqrt(c[w])-Math.sqrt(n[w]))/t;return{data:f,N:t,cx:u?l/u/t:.5,cy:u?s/u/t:.5}}function Z(a,t=512){const o="_raster"+t;if(a[o])return a[o];const c=document.createElement("canvas");c.width=c.height=t;const n=c.getContext("2d"),l=Math.min(t/a.naturalWidth,t/a.naturalHeight);n.drawImage(a,0,0,a.naturalWidth*l,a.naturalHeight*l);const s=n.getImageData(0,0,t,t).data;let u=t,f=t,w=-1,d=-1;for(let m=0;m<t;m++)for(let e=0;e<t;e++)s[(m*t+e)*4+3]>8&&(e<u&&(u=e),e>w&&(w=e),m<f&&(f=m),m>d&&(d=m));return a[o]=w<0?{canvas:c,x:0,y:0,w:t,h:t}:{canvas:c,x:u,y:f,w:w-u+1,h:d-f+1},a[o]}function v0(a,t,o=!1){const c=Z(a,t),n=document.createElement("canvas");n.width=n.height=t;const l=n.getContext("2d"),s=Math.min(t*j/c.w,t*j/c.h),u=c.w*s,f=c.h*s;return o&&(l.translate(0,t),l.scale(1,-1)),l.drawImage(c.canvas,c.x,c.y,c.w,c.h,(t-u)/2,(t-f)/2,u,f),i0(l.getImageData(0,0,t,t).data,t)}function A0(a,t,o,c=!1){const n=Z(a,o),l=t?Z(t,o):null,s=Math.min(o*j/n.w,o*j/n.h),u=n.w*s,f=n.h*s,w=(o-u)/2,d=(o-f)/2,m=v=>{const R=document.createElement("canvas");R.width=R.height=o;const b=R.getContext("2d");return c&&(b.translate(0,o),b.scale(1,-1)),b.drawImage(v.canvas,n.x,n.y,n.w,n.h,w,d,u,f),i0(b.getImageData(0,0,o,o).data,o)},e=m(n),r=l?m(l):null,i=new Float32Array(o*o*2);for(let v=0;v<o*o;v++)i[v*2]=e.data[v],i[v*2+1]=r?r.data[v]:1;return{data:i,N:o,cx:e.cx,cy:e.cy,inCx:r?r.cx:e.cx,inCy:r?r.cy:e.cy,hasInner:!!r}}const b0=1.9922,h0=.78,j=.52,T0=h0/j,M0=1.18,p0={size:.85,gx:-.025,gy:.195,rot:6,shadow:"glow",shadowK:.75,blend:"add"};function R0(a,t,o,c,n=p0){const l=Math.round(o*.75),s=n.shadow==="none"?0:n.shadowK??.75,u=f=>c(a,String(t),o/2,o/2,l,f);return n.shadow==="drop"&&s>.001?(a.save(),a.globalAlpha=Math.min(1,s*.7),a.translate(o*.018,o*.024),u({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),a.restore(),u({glow:0,glowColor:"rgba(0,0,0,0)"})):u(n.shadow==="glow"?{glow:26*s,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),n.blend==="knock"}function y0(a,t){const o=a.getImageData(0,0,t,t),c=a.createImageData(t,t);for(let n=0;n<t*t;n++){const l=o.data[n*4+3]/255,s=Math.round(255*(1-l));c.data[n*4]=c.data[n*4+1]=c.data[n*4+2]=s,c.data[n*4+3]=255}a.putImageData(c,0,0)}const P0={RATIO:140/600,opacity(a){return a===0?.5:a===2||a===4?0:1},anchor(a,t,o){return{x:((t?1-a.x:a.x)-.5)*o,y:(.5-a.y)*o,s:a.s||1}}},g=a=>(a/=255,a<=.04045?a/12.92:Math.pow((a+.055)/1.055,2.4)),Q=a=>(a=Math.max(0,Math.min(1,a)),Math.round(255*(a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055)));function n0(a,t,o){a=g(a),t=g(t),o=g(o);const c=Math.cbrt(.4122214708*a+.5363325363*t+.0514459929*o),n=Math.cbrt(.2119034982*a+.6806995451*t+.1073969566*o),l=Math.cbrt(.0883024619*a+.2817188376*t+.6299787005*o);return[.2104542553*c+.793617785*n-.0040720468*l,1.9779984951*c-2.428592205*n+.4505937099*l,.0259040371*c+.7827717662*n-.808675766*l]}function m0(a,t,o){const c=(a+.3963377774*t+.2158037573*o)**3,n=(a-.1055613458*t-.0638541728*o)**3,l=(a-.0894841775*t-1.291485548*o)**3;return[Q(4.0767416621*c-3.3077115913*n+.2309699292*l),Q(-1.2684380046*c+2.6097574011*n-.3413193965*l),Q(-.0041960863*c-.7034186147*n+1.707614701*l)]}const s0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)];function L0(a,t=1,o=new Uint8Array(256*4)){const c=[...a].sort((n,l)=>n[1]-l[1]);for(let n=0;n<256;n++){const l=n/255;let s=0;for(;s<c.length-2&&l>c[s+1][1];)s++;const[u,f]=c[s],[w,d]=c[s+1],m=Math.max(0,Math.min(1,(l-f)/Math.max(1e-5,d-f))),e=n0(...s0(u)),r=n0(...s0(w)),i=m0(e[0]+(r[0]-e[0])*m,(e[1]+(r[1]-e[1])*m)*t,(e[2]+(r[2]-e[2])*m)*t);o.set([...i,255],n*4)}return o}const k0=`
...
#define C_RED   ${q(F.red)}
#define C_CORAL ${q(F.coral)}
#define C_SAND  ${q(F.sand)}
#define C_ICE   ${q(F.prism)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(a,t,o,c){a.lineWidth=4*t;const n=c.arrow;n.line==="dash"?a.setLineDash([12*t*n.gap,10*n.gap]):n.line==="dot"?(a.setLineDash([.5,12*n.gap]),a.lineCap="round",a.lineWidth=5*t):a.setLineDash([]),o!=null&&n.line!=="solid"&&n.line!=="taper"&&(a.lineDashOffset=-o*40*n.speed)}function B0(a,t,o,c,n,l={}){const s=n.lut,u=n.arrow||{},f=u.w??1,w=u.speed??1,d=u.glow??1,m=l.pulse??1,e=o/256,r=e*(l.scale??1),i=t/2,v=c*.9*w%1,R=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,v/.55),b=l.prog!=null?1:v>.88?(1-v)/.12:1;a.clearRect(0,0,t,o);const p=b*(.45+.55*m),M=o-24*e,I=58*e,x=M+(I-M)*R,h=(y,D)=>s(y).replace("rgb(","rgba(").replace(")",`,${D.toFixed(3)})`),S=1.1*r*f,P=13*r*f,T=a.createLinearGradient(0,M,0,x);if(T.addColorStop(0,h(.55,0)),T.addColorStop(.1,h(.64,.45*p)),T.addColorStop(.32,h(.76,.85*p)),T.addColorStop(.62,h(.88,.98*p)),T.addColorStop(1,h(.97,p)),a.globalAlpha=1,a.fillStyle=T,a.beginPath(),a.moveTo(i-S/2,M),a.lineTo(i+S/2,M),a.lineTo(i+P/2,x),a.lineTo(i-P/2,x),a.closePath(),a.fill(),a.globalAlpha=p,R>.28&&!l.noTip){const y=34*r*(.7+.3*f),D=Math.min(1,(R-.28)/.22)*p,C=x+y*.3;a.globalAlpha=D;const L={color:s(.95),glowColor:s(.85),glow:12*d};n.glyph&&(n.glyph(a,"LIFT_TIP",i,C,y,L)||n.glyph(a,"TIP_TRI",i,C,y*.93,L))||(a.strokeStyle=s(.95),a.lineWidth=13*r*f,a.lineCap="round",a.lineJoin="round",a.shadowColor=s(.9),a.shadowBlur=18*r*d,a.beginPath(),a.moveTo(i-26*r,C+14*r),a.lineTo(i,C-16*r),a.lineTo(i+26*r,C+14*r),a.stroke())}a.globalAlpha=1,a.shadowBlur=0}function x0(a,t,o,c,n,l,s={}){const u=l.lut,f=l.arrow||{},w=f.w??1,d=f.glow??1,m=o/256*(s.scale??1);a.clearRect(0,0,t,o);const e=c.map(([I,x])=>[I*t,x*o]);if(e.length<2)return;const r=48,i=[],v=I=>{if(e.length===2)return[e[0][0]+(e[1][0]-e[0][0])*I,e[0][1]+(e[1][1]-e[0][1])*I];const x=I*(e.length-1),h=Math.min(e.length-2,Math.floor(x)),S=x-h,P=e[Math.max(0,h-1)],T=e[h],y=e[h+1],D=e[Math.min(e.length-1,h+2)],C=(L,B,_,G)=>.5*(2*B+(-L+_)*S+(2*L-5*B+4*_-G)*S*S+(-L+3*B-3*_+G)*S*S*S);return[C(P[0],T[0],y[0],D[0]),C(P[1],T[1],y[1],D[1])]};for(let I=0;I<=r;I++)i.push(v(I/r));const R=Math.max(0,Math.min(1,s.prog!=null?s.prog:n*.55%1)),b=Math.max(1,Math.round(r*R)),p=s.alpha??1,M=s.tail??.22;a.lineCap="round";for(let I=1;I<=b;I++){const x=I/b,h=Math.min(1,x/M);a.globalAlpha=h*h*(3-2*h)*p,a.strokeStyle=u(.55+.42*x),a.lineWidth=(1.1+11.9*x)*m*w,a.beginPath(),a.moveTo(i[I-1][0],i[I-1][1]),a.lineTo(i[I][0],i[I][1]),a.stroke()}if(R>.28){const I=34*m*(.7+.3*w),x=i[Math.max(0,b-2)][0],h=i[Math.max(0,b-2)][1],S=Math.atan2(i[b][1]-h,i[b][0]-x)+Math.PI/2,P=i[b][0]-Math.sin(S)*I*.3,T=i[b][1]+Math.cos(S)*I*.3;a.save(),a.translate(P,T),a.rotate(S),a.globalAlpha=Math.min(1,(R-.28)/.22)*p;const y={color:u(.95),glowColor:u(.85),glow:12*d};l.glyph&&(l.glyph(a,"LIFT_TIP",0,0,I,y)||l.glyph(a,"TIP_TRI",0,0,I*.93,y))||(a.strokeStyle=u(.95),a.lineWidth=9*m*w,a.lineJoin="round",a.lineCap="round",a.beginPath(),a.moveTo(-18*m,12*m),a.lineTo(0,-14*m),a.lineTo(18*m,12*m),a.stroke()),a.restore()}a.globalAlpha=1}function c0(a,t,o,c,n,l){n=n||{};const s=l.lut,u=n.style||l.arrow.line,f=!!n.closed,w=[0];for(let r=1;r<t.length;r++)w.push(w[r-1]+Math.hypot(t[r][0]-t[r-1][0],t[r][1]-t[r-1][1]));const d=w[w.length-1]||1,m=r=>{r=(r%d+d)%d;let i=1;for(;i<w.length-1&&w[i]<r;)i++;const v=(r-w[i-1])/Math.max(1e-4,w[i]-w[i-1]);return[t[i-1][0]+(t[i][0]-t[i-1][0])*v,t[i-1][1]+(t[i][1]-t[i-1][1])*v,Math.atan2(t[i][1]-t[i-1][1],t[i][0]-t[i-1][0])]},e=l.arrow;if(u==="chevron"){const r=(26*c+8)*e.gap,i=Math.max(2,Math.floor(d/r));a.shadowColor=s(Math.min(1,e.heat+.2)),a.shadowBlur=8*c*e.glow;for(let v=0;v<i;v++){const R=v*r+o*42*e.speed%r;if(!f&&R>d-4)continue;const[b,p,M]=m(R),I=7.5*c,x=8.5*c,h=.45+.4*Math.sin(R/d*6.283-o*2.2*e.speed);a.strokeStyle=s(e.heat-.05+h*.3),a.lineWidth=3.2*c,a.lineJoin="round",a.lineCap="round",a.save(),a.translate(b,p),a.rotate(M),a.beginPath(),a.moveTo(-x*.5,-I),a.lineTo(x*.5,0),a.lineTo(-x*.5,I),a.stroke(),a.restore()}return!0}if(u==="comet"){const r=o*.35*e.speed%1*d,i=d*e.tail,v=Math.max(24,t.length*2);a.lineCap="round";for(let p=0;p<v;p++){const M=r-p/v*i,I=r-(p+1)/v*i;if(!f&&I<0)break;const x=1-p/v,[h,S]=m(M),[P,T]=m(I);!f&&Math.hypot(P-h,T-S)>d*.4||(a.globalAlpha=Math.pow(x,1.6),a.strokeStyle=s(Math.max(.05,e.heat-.2)+x*.55),a.lineWidth=(1.5+x*4.5)*c,x>.72?(a.shadowColor=s(Math.min(1,e.heat+.3)),a.shadowBlur=x*12*c*e.glow):a.shadowBlur=0,a.beginPath(),a.moveTo(h,S),a.lineTo(P,T),a.stroke())}a.globalAlpha=1,a.lineCap="butt",a.shadowBlur=0;const[R,b]=m(r);return a.fillStyle=rgba(W.ink,.95),a.shadowColor=s(.9),a.shadowBlur=16*c,a.beginPath(),a.arc(R,b,2.6*c,0,7),a.fill(),a.shadowBlur=0,!0}if(a.strokeStyle=n.color||s(e.heat),a.shadowColor=s(Math.min(1,e.heat+.15)),a.shadowBlur=(n.glow??8)*c*e.glow,u==="taper")for(let r=1;r<t.length;r++)a.lineWidth=(.5+r/t.length*4.5)*c,a.beginPath(),a.moveTo(t[r-1][0],t[r-1][1]),a.lineTo(t[r][0],t[r][1]),a.stroke();else w0(a,c,o,l),a.beginPath(),t.forEach(([r,i],v)=>v?a.lineTo(r,i):a.moveTo(r,i)),f&&a.closePath(),a.stroke();return a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,a.shadowBlur=0,!0}function E0(a,t,o,c,n,l){const s=13*c.halo,u=l.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const f=t/220,w=t/2,d=18*o.round*f,m=40*f,e=48*f,r=t-80*f,i=t-96*f,v=[],R=(p,M,I,x)=>{for(let h=0;h<=1;h+=.12)v.push([p+(I-p)*h,M+(x-M)*h])};R(m+d,e,m+r-d,e),R(m+r,e+d,m+r,e+i-d),R(m+r-d,e+i,m+d,e+i),R(m,e+i-d,m,e+d),a.shadowColor=u(.6),a.shadowBlur=s*.8;const b=4*l.arrow.w*f;if(l.arrow.line==="solid"?(a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-n*22*f,a.strokeStyle=u(.45),a.lineWidth=b,a.beginPath(),a.roundRect(m,e,r,i,d),a.stroke(),a.setLineDash([]),a.lineDashOffset=0):c0(a,v,n,l.arrow.w*f,{color:u(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const p=[],M=(C,L,B,_,G)=>{for(let O=1;O<=G;O++)p.push([C+(B-C)*O/G,L+(_-L)*O/G])},I=(C,L,B,_,G)=>{for(let O=1;O<=G;O++){const $=B+(_-B)*O/G;p.push([C+d*Math.cos($),L+d*Math.sin($)])}},x=Math.PI/2,h=m+r,S=e+i,P=m+r/2;p.push([P,e]),M(P,e,h-d,e,8),I(h-d,e+d,-x,0,6),M(h,e+d,h,S-d,10),I(h-d,S-d,0,x,6),M(h-d,S,m+d,S,14),I(m+d,S-d,x,Math.PI,6),M(m,S-d,m,e+d,10),I(m+d,e+d,Math.PI,Math.PI+x,6),M(m+d,e,P,e,8);let T=0;for(let C=1;C<p.length;C++)T+=Math.hypot(p[C][0]-p[C-1][0],p[C][1]-p[C-1][1]);const y=T*Math.min(1,o.prog);a.save(),a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-(r/2-d)-n*22*f,a.strokeStyle=u(.9),a.lineWidth=b*1.3,a.lineCap="round",a.shadowColor=u(.92),a.shadowBlur=s*1.3,a.beginPath(),a.moveTo(p[0][0],p[0][1]);let D=0;for(let C=1;C<p.length&&D<y;C++){const L=Math.hypot(p[C][0]-p[C-1][0],p[C][1]-p[C-1][1]);if(D+L<=y)a.lineTo(p[C][0],p[C][1]),D+=L;else{const B=(y-D)/L;a.lineTo(p[C-1][0]+(p[C][0]-p[C-1][0])*B,p[C-1][1]+(p[C][1]-p[C-1][1])*B),D=y}}a.stroke(),a.setLineDash([]),a.restore()}o.feet>.05&&l.foot&&(l.foot(a,!1,w-16*o.feet*f,w+6*f,26*o.feet*f),l.foot(a,!0,w+16*o.feet*f,w+6*f,26*o.feet*f)),a.shadowBlur=0}function G0(a,t,o,c,n,l,s,u){const f=13*c.halo,w=4*l.arrow.w*(t/220),d=l.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const m=t/220,e=s||[[45*m,130*m],[110*m,60*m],[175*m,110*m]],r=u??n*.5%1,i=Math.min(1,r*1.25)*(e.length-1),v=Math.min(e.length-1,Math.floor(i+.35));a.shadowColor=d(.7),a.shadowBlur=f;const R=[[e[0][0],e[0][1]]];for(let x=1;x<=e.length-1;x++){const h=Math.max(0,Math.min(1,i-(x-1)));if(h<=0)break;R.push([e[x-1][0]+(e[x][0]-e[x-1][0])*h,e[x-1][1]+(e[x][1]-e[x-1][1])*h])}R.length>1&&c0(a,R,n,l.arrow.w*m,{color:d(.62)},l),a.setLineDash([]),a.lineDashOffset=0,a.globalAlpha=.5,a.strokeStyle=d(.55),a.lineWidth=w*.8,a.beginPath(),e.forEach(([x,h],S)=>S?a.lineTo(x,h):a.moveTo(x,h)),a.stroke(),a.globalAlpha=1,a.lineCap="butt";const b=o.done!=null,p=o.done||0,M=o.vd||[],I=o.acc!=null?o.acc:e.length-1;e.forEach(([x,h],S)=>{const P=S<p,T=M[S]||null,y=!P&&S===v&&!b,D=y?1+Math.sin(n*6)*.14:1,C=12*o.node*D*m*(S===I?1.34:1);P&&T!=="miss"&&(a.shadowBlur=f*1.4,a.shadowColor=d(.5),a.fillStyle=d(T==="near"?.5:.36),a.beginPath(),a.arc(x,h,C*.88,0,Math.PI*2),a.fill()),a.strokeStyle=T==="hit"?F.prism:T==="near"?F.sand:T==="miss"?W.lo:d(P?.62:y?.8:.45),a.lineWidth=w*(y?1.3:T?1.15:.9),a.shadowBlur=y?f*1.6:T&&T!=="miss"?f*1.3:f*.6,T&&T!=="miss"&&(a.shadowColor=T==="hit"?F.prism:F.sand),a.beginPath(),a.arc(x,h,C,0,Math.PI*2),a.stroke(),l.num&&(a.globalAlpha=S<=v||P?1:.45,l.num(a,String(S+1),x,h,16*o.numS*D*m,Math.round(14*o.numS*m)),a.globalAlpha=1)}),a.shadowBlur=0}function O0(a,t,o,c,n,l,s){const u=l.lut,f=13*c.halo,w=t/220,d=t/2,m=l.arrow&&l.arrow.w||1,e=(h,S)=>u(h).replace("rgb(","rgba(").replace(")",`,${S})`);a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const r=(o.r!=null?o.r:.42)*t,i=r*(o.rt!=null?o.rt:.36),v=3.4*m*w,R=s!=null?Math.max(0,Math.min(1,s)):n*(o.tempo||.6)%1,b=Math.pow(R,1.6),p=Math.max(0,(R-.9)/.1);a.save(),a.translate(d,d);const M=(h,S,P,T=1)=>{if(h<=.6)return;const y=v*2.6*T,D=Math.max(.1,h-y),C=h+y,L=a.createRadialGradient(0,0,D,0,0,C);L.addColorStop(0,e(S-.05,0)),L.addColorStop(.5,e(S,P*.85)),L.addColorStop(1,e(S-.05,0)),a.globalAlpha=1,a.fillStyle=L,a.shadowBlur=0,a.beginPath(),a.arc(0,0,C,0,Math.PI*2),a.fill(),a.globalAlpha=Math.min(1,P*1.1),a.lineWidth=v*.85,a.strokeStyle=u(Math.min(.98,S+.12)),a.shadowColor=u(.88),a.shadowBlur=f*.6,a.beginPath(),a.arc(0,0,h,0,Math.PI*2),a.stroke(),a.shadowBlur=0},I=a.createRadialGradient(0,0,0,0,0,i*1.08);I.addColorStop(0,e(.6,.1+.18*p)),I.addColorStop(.65,e(.5,.05+.08*p)),I.addColorStop(1,e(.5,0)),a.globalAlpha=1,a.fillStyle=I,a.beginPath(),a.arc(0,0,i*1.08,0,Math.PI*2),a.fill();const x=1+.02*Math.sin(n*2.6);M(i*x,.55+.4*p,.5+.45*p,.9);for(let h=2;h>=0;h--){const S=Math.pow(Math.max(0,R-h*.05),1.6),P=r-(r-i)*S,T=h===0?.6+.4*b:.18/h*(1-p);M(P,.55+.4*b,T*(1-p*.45),1.15-.35*b)}p>.01&&M(i*(1+1.4*p),.9,(1-p)*.8,1.1),a.globalAlpha=.6+.3*p,a.shadowColor=u(.85),a.shadowBlur=f*(.9+p),a.fillStyle=u(.62+.3*p),a.beginPath(),a.arc(0,0,v*.85+3*w*p,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}function U0(a,t,o,c,n,l,s,u){const f=l.lut,w=13*c.halo,d=t/220,m=t/2,e=l.arrow&&l.arrow.w||1,r=e*d,i=(A,k)=>f(A).replace("rgb(","rgba(").replace(")",","+k+")");a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const v=t*.42*(o.spread!=null?o.spread:1),b=(u||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([A,k])=>[m+A*v,m+k*v]),p=80,M=[];for(let A=0;A<=p;A++){const k=A/p*(b.length-1),E=Math.min(b.length-2,Math.floor(k)),U=k-E,H=b[Math.max(0,E-1)],K=b[E],N=b[E+1],a0=b[Math.min(b.length-1,E+2)],t0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*U+(2*X-5*J+4*Y-o0)*U*U+(-X+3*J-3*Y+o0)*U*U*U);M.push([t0(H[0],K[0],N[0],a0[0]),t0(H[1],K[1],N[1],a0[1])])}const I=A=>{const k=Math.max(0,Math.min(p,A*p)),E=Math.floor(k),U=k-E,H=M[E],K=M[Math.min(p,E+1)];return[H[0]+(K[0]-H[0])*U,H[1]+(K[1]-H[1])*U]},x=.68;let h,S,P;if(s!=null)h=Math.max(0,Math.min(1,s)),S=1,P=0;else{const A=n*(o.tempo||.42)%1;if(A<x)h=A/x,S=1,P=0;else{const k=(A-x)/(1-x);h=1,S=1-k*k,P=k}}if(S<=.012)return;const T=h*h*h*(h*(6*h-15)+10),y=Math.min(1,16*h*h*(1-h)*(1-h));o.taper!=null&&o.taper;const D=.36*(o.tail!=null?o.tail:1),C=o.width!=null?o.width:1;{const A=a.createLinearGradient(M[0][0],M[0][1],M[p][0],M[p][1]);A.addColorStop(0,i(.46,0)),A.addColorStop(.3,i(.46,.03*S)),A.addColorStop(.8,i(.46,.045*S)),A.addColorStop(1,i(.46,0)),a.globalAlpha=1,a.strokeStyle=A,a.lineWidth=9*r,a.shadowColor=f(.6),a.shadowBlur=w*2,a.beginPath(),M.forEach(([k,E],U)=>U?a.lineTo(k,E):a.moveTo(k,E)),a.stroke(),a.shadowBlur=0}const L=40,B=Math.max(0,T-D*(1-P)),_=[];for(let A=0;A<=L;A++)_.push(I(B+(T-B)*(A/L)));const G=()=>{a.beginPath(),_.forEach(([A,k],E)=>E?a.lineTo(A,k):a.moveTo(A,k)),a.stroke()},O=()=>{const A=a.createLinearGradient(_[0][0],_[0][1],_[L][0],_[L][1]);return A.addColorStop(0,i(.55,0)),A.addColorStop(.4,i(.56,0)),A.addColorStop(.68,i(.6,.09)),A.addColorStop(.88,i(.64,.24)),A.addColorStop(1,i(.68,.44)),A},$=1+.5*y;a.globalAlpha=S,a.strokeStyle=O(),a.lineWidth=(20+10*y)*r*C,a.shadowColor=f(.72),a.shadowBlur=w*2.2,G(),a.strokeStyle=O(),a.lineWidth=(10+5*y)*r*C,a.shadowBlur=w*1,G(),a.shadowBlur=0;for(let A=1;A<=L;A++){const k=A/L;a.globalAlpha=Math.pow(k,2.2)*.95*S,a.strokeStyle=f(.55+.38*k),a.lineWidth=(1.6+6.5*Math.pow(k,.7))*r*C*$,a.beginPath(),a.moveTo(_[A-1][0],_[A-1][1]),a.lineTo(_[A][0],_[A][1]),a.stroke()}const z=_[L][0],V=_[L][1];a.globalAlpha=.8*S,a.fillStyle=f(.6),a.shadowColor=f(.8),a.shadowBlur=w*1.6,a.beginPath(),a.arc(z,V,(9+5*y)*r*C,0,Math.PI*2),a.fill(),a.globalAlpha=S,a.fillStyle=f(.93),a.shadowBlur=w*.6,a.beginPath(),a.arc(z,V,(3.4+1.8*y)*r*C,0,Math.PI*2),a.fill(),a.globalAlpha=1,a.shadowBlur=0}function H0(a,t,o,c,n,l,s){const u=o.r!=null?o.r:.3,f=o.dir!=null?o.dir:1,w=(o.sweep!=null?o.sweep:.66)*Math.PI*2,d=s??n*(o.tempo!=null?o.tempo:.5)%1,m=-Math.PI/2+f*d*Math.PI*2,e=16,r=[];for(let i=0;i<=e;i++){const v=m-f*(1-i/e)*w;r.push([.5+Math.cos(v)*u,.5+Math.sin(v)*u])}x0(a,t,t,r,n,l,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}export{_0 as C,p0 as G,P0 as M,W as N,F as P,T0 as Q,k0 as R,b0 as S,M0 as Z,j as a,h0 as b,A0 as c,R0 as d,v0 as e,E0 as f,G0 as g,O0 as h,y0 as i,U0 as j,H0 as k,L0 as l,B0 as m,F0 as n,Z as o,c0 as p,S0 as q,x0 as r,i0 as s,C0 as t,I0 as u,D0 as v,u0 as w,d0 as x};
