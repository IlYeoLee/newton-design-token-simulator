import"./modulepreload-polyfill-B5Qt9EMX.js";import{W as _,S as q,O as H,C as I,c as O,h as j,M as z,P as Y,i as J}from"./fxlut-CMGqmTlk.js";import{v as K}from"./fx-core-s01SBT1z.js";const w=360,g=560,Q=document.getElementById("cv"),F=new _({canvas:Q,antialias:!0,preserveDrawingBuffer:!0});F.setPixelRatio(1);F.setSize(720,g,!1);const W=new q,X=new H(0,720,g,0,-1,1),d=document.createElement("video");d.src="ready-view/assets/bk_sidebend_pp.webm";d.muted=!0;d.loop=!0;d.playsInline=!0;d.crossOrigin="anonymous";d.style.display="none";document.body.appendChild(d);const h=256,k=()=>{const e=document.createElement("canvas");return e.width=e.height=h,e},P=k(),U=k(),$=k(),G=new I(P),L=new I(U),N=new I($);for(const e of[G,L,N])e.colorSpace=O;function Z(){if(d.readyState<2)return;const e=P.getContext("2d",{willReadFrequently:!0});e.clearRect(0,0,h,h),e.drawImage(d,0,0,h,h);const t=e.getImageData(0,0,h,h),o=t.data;for(let a=0;a<o.length;a+=4){const s=o[a]/255,u=o[a+1]/255,f=o[a+2]/255,y=1-Math.min(1,Math.max(0,(u-Math.max(s,f)-.04)/.1)),x=.299*s+.587*u+.114*f;o[a]=y*255,o[a+1]=y*x*255,o[a+2]=0,o[a+3]=255}e.putImageData(t,0,0);for(const[a,s]of[[U,12],[$,2]]){const u=a.getContext("2d");u.clearRect(0,0,h,h),u.filter=`blur(${s}px)`,u.drawImage(P,0,0),u.filter="none"}G.needsUpdate=L.needsUpdate=N.needsUpdate=!0}const ee=`
