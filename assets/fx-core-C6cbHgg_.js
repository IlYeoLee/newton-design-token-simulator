const E={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},W={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},r0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],x0=Object.fromEntries(Object.entries({...E,...W}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),q=t=>`vec3(${r0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,S0=(t,a=1)=>`rgba(${r0(t).join(",")},${a})`,u0=[[E.red,0],[E.red,.3],[E.coral,.56],[E.sand,.86],[E.prism,1]],h0=1;function f0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(W).some(o=>o.toUpperCase()===a)?!0:Object.values(E).some(o=>o.toUpperCase()===a)}function C0(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>f0(o)))&&(t.stops=u0.map(o=>[...o])),t.sat=h0,t)}function l0(t,a,o,i,s){let e=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let c=1;c<s;c++){let r=(t[c]+c*c-(t[o[e]]+o[e]*o[e]))/(2*c-2*o[e]);for(;r<=i[e];)e--,r=(t[c]+c*c-(t[o[e]]+o[e]*o[e]))/(2*c-2*o[e]);e++,o[e]=c,i[e]=r,i[e+1]=1e20}e=0;for(let c=0;c<s;c++){for(;i[e+1]<c;)e++;a[c]=(c-o[e])*(c-o[e])+t[o[e]]}}function e0(t,a){const o=new Float32Array(a),i=new Int32Array(a),s=new Float32Array(a+1),e=new Float32Array(a);for(let c=0;c<a;c++){for(let r=0;r<a;r++)e[r]=t[r*a+c];l0(e,o,i,s,a);for(let r=0;r<a;r++)t[r*a+c]=o[r]}for(let c=0;c<a;c++){for(let r=0;r<a;r++)e[r]=t[c*a+r];l0(e,o,i,s,a);for(let r=0;r<a;r++)t[c*a+r]=o[r]}}function i0(t,a){const i=new Float32Array(a*a),s=new Float32Array(a*a);let e=0,c=0,r=0;for(let m=0;m<a*a;m++){const d=t[m*4+3]/255;i[m]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),s[m]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(e+=m%a,c+=m/a|0,r++)}e0(i,a),e0(s,a);const f=new Float32Array(a*a);for(let m=0;m<a*a;m++)f[m]=(Math.sqrt(i[m])-Math.sqrt(s[m]))/a;return{data:f,N:a,cx:r?e/r/a:.5,cy:r?c/r/a:.5}}function z(t,a=512){const o="_raster"+a;if(t[o])return t[o];const i=document.createElement("canvas");i.width=i.height=a;const s=i.getContext("2d"),e=Math.min(a/t.naturalWidth,a/t.naturalHeight);s.drawImage(t,0,0,t.naturalWidth*e,t.naturalHeight*e);const c=s.getImageData(0,0,a,a).data;let r=a,f=a,m=-1,d=-1;for(let p=0;p<a;p++)for(let l=0;l<a;l++)c[(p*a+l)*4+3]>8&&(l<r&&(r=l),l>m&&(m=l),p<f&&(f=p),p>d&&(d=p));return t[o]=m<0?{canvas:i,x:0,y:0,w:a,h:a}:{canvas:i,x:r,y:f,w:m-r+1,h:d-f+1},t[o]}function I0(t,a,o=!1){const i=z(t,a),s=document.createElement("canvas");s.width=s.height=a;const e=s.getContext("2d"),c=Math.min(a*j/i.w,a*j/i.h),r=i.w*c,f=i.h*c;return o&&(e.translate(0,a),e.scale(1,-1)),e.drawImage(i.canvas,i.x,i.y,i.w,i.h,(a-r)/2,(a-f)/2,r,f),i0(e.getImageData(0,0,a,a).data,a)}function A0(t,a,o,i=!1){const s=z(t,o),e=a?z(a,o):null,c=Math.min(o*j/s.w,o*j/s.h),r=s.w*c,f=s.h*c,m=(o-r)/2,d=(o-f)/2,p=C=>{const M=document.createElement("canvas");M.width=M.height=o;const w=M.getContext("2d");return i&&(w.translate(0,o),w.scale(1,-1)),w.drawImage(C.canvas,s.x,s.y,s.w,s.h,m,d,r,f),i0(w.getImageData(0,0,o,o).data,o)},l=p(s),u=e?p(e):null,h=new Float32Array(o*o*2);for(let C=0;C<o*o;C++)h[C*2]=l.data[C],h[C*2+1]=u?u.data[C]:1;return{data:h,N:o,cx:l.cx,cy:l.cy,inCx:u?u.cx:l.cx,inCy:u?u.cy:l.cy,hasInner:!!u}}const b0=1.9922,d0=.78,j=.52,v0=d0/j,T0=1.18,p0={size:.85,gx:-.025,gy:.195,rot:6,shadow:"glow",shadowK:.75,blend:"add"};function M0(t,a,o,i,s=p0){const e=Math.round(o*.75),c=s.shadow==="none"?0:s.shadowK??.75,r=f=>i(t,String(a),o/2,o/2,e,f);return s.shadow==="drop"&&c>.001?(t.save(),t.globalAlpha=Math.min(1,c*.7),t.translate(o*.018,o*.024),r({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),r({glow:0,glowColor:"rgba(0,0,0,0)"})):r(s.shadow==="glow"?{glow:26*c,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),s.blend==="knock"}function R0(t,a){const o=t.getImageData(0,0,a,a),i=t.createImageData(a,a);for(let s=0;s<a*a;s++){const e=o.data[s*4+3]/255,c=Math.round(255*(1-e));i.data[s*4]=i.data[s*4+1]=i.data[s*4+2]=c,i.data[s*4+3]=255}t.putImageData(i,0,0)}const y0={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},Q=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),Z=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function n0(t,a,o){t=Q(t),a=Q(a),o=Q(o);const i=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),s=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),e=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*i+.793617785*s-.0040720468*e,1.9779984951*i-2.428592205*s+.4505937099*e,.0259040371*i+.7827717662*s-.808675766*e]}function m0(t,a,o){const i=(t+.3963377774*a+.2158037573*o)**3,s=(t-.1055613458*a-.0638541728*o)**3,e=(t-.0894841775*a-1.291485548*o)**3;return[Z(4.0767416621*i-3.3077115913*s+.2309699292*e),Z(-1.2684380046*i+2.6097574011*s-.3413193965*e),Z(-.0041960863*i-.7034186147*s+1.707614701*e)]}const s0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function P0(t,a=1,o=new Uint8Array(256*4)){const i=[...t].sort((s,e)=>s[1]-e[1]);for(let s=0;s<256;s++){const e=s/255;let c=0;for(;c<i.length-2&&e>i[c+1][1];)c++;const[r,f]=i[c],[m,d]=i[c+1],p=Math.max(0,Math.min(1,(e-f)/Math.max(1e-5,d-f))),l=n0(...s0(r)),u=n0(...s0(m)),h=m0(l[0]+(u[0]-l[0])*p,(l[1]+(u[1]-l[1])*p)*a,(l[2]+(u[2]-l[2])*p)*a);o.set([...h,255],s*4)}return o}const k0=`
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(t,a,o,i){t.lineWidth=4*a;const s=i.arrow;s.line==="dash"?t.setLineDash([12*a*s.gap,10*s.gap]):s.line==="dot"?(t.setLineDash([.5,12*s.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(t.lineDashOffset=-o*40*s.speed)}function F0(t,a,o,i,s,e={}){const c=s.lut,r=s.arrow||{},f=r.w??1,m=r.speed??1,d=r.glow??1,p=e.pulse??1,l=o/256,u=a/2,h=i*.9*m%1,C=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,h/.55),M=e.prog!=null?1:h>.88?(1-h)/.12:1;t.clearRect(0,0,a,o);const w=M*(.45+.55*p),n=o-24*l,S=58*l,T=n+(S-n)*C,b=(k,L)=>c(k).replace("rgb(","rgba(").replace(")",`,${L.toFixed(3)})`),x=1.1*l*f,I=13*l*f,R=t.createLinearGradient(0,n,0,T);if(R.addColorStop(0,b(.55,0)),R.addColorStop(.1,b(.64,.45*w)),R.addColorStop(.32,b(.76,.85*w)),R.addColorStop(.62,b(.88,.98*w)),R.addColorStop(1,b(.97,w)),t.globalAlpha=1,t.fillStyle=R,t.beginPath(),t.moveTo(u-x/2,n),t.lineTo(u+x/2,n),t.lineTo(u+I/2,T),t.lineTo(u-I/2,T),t.closePath(),t.fill(),t.globalAlpha=w,C>.28&&!e.noTip){const k=34*l*(.7+.3*f),L=Math.min(1,(C-.28)/.22)*w,P=T+k*.3;t.globalAlpha=L;const A={color:c(.95),glowColor:c(.85),glow:12*d};s.glyph&&(s.glyph(t,"LIFT_TIP",u,P,k,A)||s.glyph(t,"TIP_TRI",u,P,k*.93,A))||(t.strokeStyle=c(.95),t.lineWidth=13*l*f,t.lineCap="round",t.lineJoin="round",t.shadowColor=c(.9),t.shadowBlur=18*l*d,t.beginPath(),t.moveTo(u-26*l,P+14*l),t.lineTo(u,P-16*l),t.lineTo(u+26*l,P+14*l),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function B0(t,a,o,i,s,e,c={}){const r=e.lut,f=e.arrow||{},m=f.w??1,d=f.glow??1,p=o/256;t.clearRect(0,0,a,o);const l=i.map(([n,S])=>[n*a,S*o]);if(l.length<2)return;const u=48,h=[],C=n=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*n,l[0][1]+(l[1][1]-l[0][1])*n];const S=n*(l.length-1),T=Math.min(l.length-2,Math.floor(S)),b=S-T,x=l[Math.max(0,T-1)],I=l[T],R=l[T+1],k=l[Math.min(l.length-1,T+2)],L=(P,A,y,B)=>.5*(2*A+(-P+y)*b+(2*P-5*A+4*y-B)*b*b+(-P+3*A-3*y+B)*b*b*b);return[L(x[0],I[0],R[0],k[0]),L(x[1],I[1],R[1],k[1])]};for(let n=0;n<=u;n++)h.push(C(n/u));const M=Math.max(0,Math.min(1,c.prog!=null?c.prog:s*.55%1)),w=Math.max(1,Math.round(u*M));t.lineCap="round";for(let n=1;n<=w;n++){const S=n/w;t.globalAlpha=Math.pow(S,1.5),t.strokeStyle=r(.45+.5*S),t.lineWidth=(1.6+3.2*S)*p*m,t.beginPath(),t.moveTo(h[n-1][0],h[n-1][1]),t.lineTo(h[n][0],h[n][1]),t.stroke()}if(M>.25){const n=h[w][0],S=h[w][1],T=h[Math.max(0,w-2)][0],b=h[Math.max(0,w-2)][1],x=Math.atan2(S-b,n-T)+Math.PI/2,I=30*p*(.7+.3*m);t.save(),t.translate(n,S),t.rotate(x),t.globalAlpha=Math.min(1,(M-.25)/.2);const R={color:r(.95),glowColor:r(.85),glow:12*d};e.glyph&&(e.glyph(t,"LIFT_TIP",0,0,I,R)||e.glyph(t,"TIP_TRI",0,0,I*.93,R))||(t.strokeStyle=r(.95),t.lineWidth=9*p*m,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*p,12*p),t.lineTo(0,-14*p),t.lineTo(18*p,12*p),t.stroke()),t.restore()}t.globalAlpha=1}function c0(t,a,o,i,s,e){s=s||{};const c=e.lut,r=s.style||e.arrow.line,f=!!s.closed,m=[0];for(let u=1;u<a.length;u++)m.push(m[u-1]+Math.hypot(a[u][0]-a[u-1][0],a[u][1]-a[u-1][1]));const d=m[m.length-1]||1,p=u=>{u=(u%d+d)%d;let h=1;for(;h<m.length-1&&m[h]<u;)h++;const C=(u-m[h-1])/Math.max(1e-4,m[h]-m[h-1]);return[a[h-1][0]+(a[h][0]-a[h-1][0])*C,a[h-1][1]+(a[h][1]-a[h-1][1])*C,Math.atan2(a[h][1]-a[h-1][1],a[h][0]-a[h-1][0])]},l=e.arrow;if(r==="chevron"){const u=(26*i+8)*l.gap,h=Math.max(2,Math.floor(d/u));t.shadowColor=c(Math.min(1,l.heat+.2)),t.shadowBlur=8*i*l.glow;for(let C=0;C<h;C++){const M=C*u+o*42*l.speed%u;if(!f&&M>d-4)continue;const[w,n,S]=p(M),T=7.5*i,b=8.5*i,x=.45+.4*Math.sin(M/d*6.283-o*2.2*l.speed);t.strokeStyle=c(l.heat-.05+x*.3),t.lineWidth=3.2*i,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(w,n),t.rotate(S),t.beginPath(),t.moveTo(-b*.5,-T),t.lineTo(b*.5,0),t.lineTo(-b*.5,T),t.stroke(),t.restore()}return!0}if(r==="comet"){const u=o*.35*l.speed%1*d,h=d*l.tail,C=Math.max(24,a.length*2);t.lineCap="round";for(let n=0;n<C;n++){const S=u-n/C*h,T=u-(n+1)/C*h;if(!f&&T<0)break;const b=1-n/C,[x,I]=p(S),[R,k]=p(T);!f&&Math.hypot(R-x,k-I)>d*.4||(t.globalAlpha=Math.pow(b,1.6),t.strokeStyle=c(Math.max(.05,l.heat-.2)+b*.55),t.lineWidth=(1.5+b*4.5)*i,b>.72?(t.shadowColor=c(Math.min(1,l.heat+.3)),t.shadowBlur=b*12*i*l.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(x,I),t.lineTo(R,k),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[M,w]=p(u);return t.fillStyle=rgba(W.ink,.95),t.shadowColor=c(.9),t.shadowBlur=16*i,t.beginPath(),t.arc(M,w,2.6*i,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=s.color||c(l.heat),t.shadowColor=c(Math.min(1,l.heat+.15)),t.shadowBlur=(s.glow??8)*i*l.glow,r==="taper")for(let u=1;u<a.length;u++)t.lineWidth=(.5+u/a.length*4.5)*i,t.beginPath(),t.moveTo(a[u-1][0],a[u-1][1]),t.lineTo(a[u][0],a[u][1]),t.stroke();else w0(t,i,o,e),t.beginPath(),a.forEach(([u,h],C)=>C?t.lineTo(u,h):t.moveTo(u,h)),f&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function E0(t,a,o,i,s,e){const c=13*i.halo,r=e.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const f=a/220,m=a/2,d=18*o.round*f,p=40*f,l=48*f,u=a-80*f,h=a-96*f,C=[],M=(n,S,T,b)=>{for(let x=0;x<=1;x+=.12)C.push([n+(T-n)*x,S+(b-S)*x])};M(p+d,l,p+u-d,l),M(p+u,l+d,p+u,l+h-d),M(p+u-d,l+h,p+d,l+h),M(p,l+h-d,p,l+d),t.shadowColor=r(.6),t.shadowBlur=c*.8;const w=4*e.arrow.w*f;if(e.arrow.line==="solid"?(t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-s*22*f,t.strokeStyle=r(.45),t.lineWidth=w,t.beginPath(),t.roundRect(p,l,u,h,d),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):c0(t,C,s,e.arrow.w*f,{color:r(.45),closed:!0},e),o.prog!=null&&o.prog>.001){const n=[],S=(A,y,B,D,U)=>{for(let O=1;O<=U;O++)n.push([A+(B-A)*O/U,y+(D-y)*O/U])},T=(A,y,B,D,U)=>{for(let O=1;O<=U;O++){const $=B+(D-B)*O/U;n.push([A+d*Math.cos($),y+d*Math.sin($)])}},b=Math.PI/2,x=p+u,I=l+h,R=p+u/2;n.push([R,l]),S(R,l,x-d,l,8),T(x-d,l+d,-b,0,6),S(x,l+d,x,I-d,10),T(x-d,I-d,0,b,6),S(x-d,I,p+d,I,14),T(p+d,I-d,b,Math.PI,6),S(p,I-d,p,l+d,10),T(p+d,l+d,Math.PI,Math.PI+b,6),S(p+d,l,R,l,8);let k=0;for(let A=1;A<n.length;A++)k+=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);const L=k*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-(u/2-d)-s*22*f,t.strokeStyle=r(.9),t.lineWidth=w*1.3,t.lineCap="round",t.shadowColor=r(.92),t.shadowBlur=c*1.3,t.beginPath(),t.moveTo(n[0][0],n[0][1]);let P=0;for(let A=1;A<n.length&&P<L;A++){const y=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);if(P+y<=L)t.lineTo(n[A][0],n[A][1]),P+=y;else{const B=(L-P)/y;t.lineTo(n[A-1][0]+(n[A][0]-n[A-1][0])*B,n[A-1][1]+(n[A][1]-n[A-1][1])*B),P=L}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&e.foot&&(e.foot(t,!1,m-16*o.feet*f,m+6*f,26*o.feet*f),e.foot(t,!0,m+16*o.feet*f,m+6*f,26*o.feet*f)),t.shadowBlur=0}function O0(t,a,o,i,s,e,c,r){const f=13*i.halo,m=4*e.arrow.w*(a/220),d=e.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const p=a/220,l=c||[[45*p,130*p],[110*p,60*p],[175*p,110*p]],u=r??s*.5%1,h=Math.min(1,u*1.25)*(l.length-1),C=Math.min(l.length-1,Math.floor(h+.35));t.shadowColor=d(.7),t.shadowBlur=f;const M=[[l[0][0],l[0][1]]];for(let w=1;w<=l.length-1;w++){const n=Math.max(0,Math.min(1,h-(w-1)));if(n<=0)break;M.push([l[w-1][0]+(l[w][0]-l[w-1][0])*n,l[w-1][1]+(l[w][1]-l[w-1][1])*n])}M.length>1&&c0(t,M,s,e.arrow.w*p,{color:d(.62)},e),t.setLineDash([4*p,7*p]),t.lineDashOffset=0,t.globalAlpha=.3,t.strokeStyle=d(.45),t.lineWidth=m,t.beginPath(),l.forEach(([w,n],S)=>S?t.lineTo(w,n):t.moveTo(w,n)),t.stroke(),t.globalAlpha=1,t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,l.forEach(([w,n],S)=>{const T=S===C,b=T?1+Math.sin(s*6)*.14:1;t.strokeStyle=d(T?.8:.45),t.lineWidth=m*(T?1.3:.9),t.shadowBlur=T?f*1.6:f*.6,t.beginPath(),t.arc(w,n,12*o.node*b*p,0,Math.PI*2),t.stroke(),e.num&&(t.globalAlpha=S<=C?1:.45,e.num(t,String(S+1),w,n,16*o.numS*b*p,Math.round(14*o.numS*p)),t.globalAlpha=1)}),t.shadowBlur=0}function G0(t,a,o,i,s,e,c){const r=e.lut,f=13*i.halo,m=a/220,d=a/2,p=e.arrow&&e.arrow.w||1,l=(x,I)=>r(x).replace("rgb(","rgba(").replace(")",`,${I})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const u=(o.r!=null?o.r:.42)*a,h=u*(o.rt!=null?o.rt:.36),C=3.4*p*m,M=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.6)%1,w=Math.pow(M,1.6),n=Math.max(0,(M-.9)/.1);t.save(),t.translate(d,d);const S=(x,I,R,k=1)=>{if(x<=.6)return;const L=C*2.6*k,P=Math.max(.1,x-L),A=x+L,y=t.createRadialGradient(0,0,P,0,0,A);y.addColorStop(0,l(I-.05,0)),y.addColorStop(.5,l(I,R*.85)),y.addColorStop(1,l(I-.05,0)),t.globalAlpha=1,t.fillStyle=y,t.shadowBlur=0,t.beginPath(),t.arc(0,0,A,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,R*1.1),t.lineWidth=C*.85,t.strokeStyle=r(Math.min(.98,I+.12)),t.shadowColor=r(.88),t.shadowBlur=f*.6,t.beginPath(),t.arc(0,0,x,0,Math.PI*2),t.stroke(),t.shadowBlur=0},T=t.createRadialGradient(0,0,0,0,0,h*1.08);T.addColorStop(0,l(.6,.1+.18*n)),T.addColorStop(.65,l(.5,.05+.08*n)),T.addColorStop(1,l(.5,0)),t.globalAlpha=1,t.fillStyle=T,t.beginPath(),t.arc(0,0,h*1.08,0,Math.PI*2),t.fill();const b=1+.02*Math.sin(s*2.6);S(h*b,.55+.4*n,.5+.45*n,.9);for(let x=2;x>=0;x--){const I=Math.pow(Math.max(0,M-x*.05),1.6),R=u-(u-h)*I,k=x===0?.6+.4*w:.18/x*(1-n);S(R,.55+.4*w,k*(1-n*.45),1.15-.35*w)}n>.01&&S(h*(1+1.4*n),.9,(1-n)*.8,1.1),t.globalAlpha=.6+.3*n,t.shadowColor=r(.85),t.shadowBlur=f*(.9+n),t.fillStyle=r(.62+.3*n),t.beginPath(),t.arc(0,0,C*.85+3*m*n,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function U0(t,a,o,i,s,e,c,r){const f=e.lut,m=13*i.halo,d=a/220,p=a/2,l=e.arrow&&e.arrow.w||1,u=l*d,h=(v,_)=>f(v).replace("rgb(","rgba(").replace(")",","+_+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const C=a*.42*(o.spread!=null?o.spread:1),w=(r||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([v,_])=>[p+v*C,p+_*C]),n=80,S=[];for(let v=0;v<=n;v++){const _=v/n*(w.length-1),F=Math.min(w.length-2,Math.floor(_)),G=_-F,H=w[Math.max(0,F-1)],K=w[F],N=w[F+1],t0=w[Math.min(w.length-1,F+2)],a0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*G+(2*X-5*J+4*Y-o0)*G*G+(-X+3*J-3*Y+o0)*G*G*G);S.push([a0(H[0],K[0],N[0],t0[0]),a0(H[1],K[1],N[1],t0[1])])}const T=v=>{const _=Math.max(0,Math.min(n,v*n)),F=Math.floor(_),G=_-F,H=S[F],K=S[Math.min(n,F+1)];return[H[0]+(K[0]-H[0])*G,H[1]+(K[1]-H[1])*G]},b=.68;let x,I,R;if(c!=null)x=Math.max(0,Math.min(1,c)),I=1,R=0;else{const v=s*(o.tempo||.42)%1;if(v<b)x=v/b,I=1,R=0;else{const _=(v-b)/(1-b);x=1,I=1-_*_,R=_}}if(I<=.012)return;const k=x*x*x*(x*(6*x-15)+10),L=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const P=.36*(o.tail!=null?o.tail:1),A=o.width!=null?o.width:1;{const v=t.createLinearGradient(S[0][0],S[0][1],S[n][0],S[n][1]);v.addColorStop(0,h(.46,0)),v.addColorStop(.3,h(.46,.03*I)),v.addColorStop(.8,h(.46,.045*I)),v.addColorStop(1,h(.46,0)),t.globalAlpha=1,t.strokeStyle=v,t.lineWidth=9*u,t.shadowColor=f(.6),t.shadowBlur=m*2,t.beginPath(),S.forEach(([_,F],G)=>G?t.lineTo(_,F):t.moveTo(_,F)),t.stroke(),t.shadowBlur=0}const y=40,B=Math.max(0,k-P*(1-R)),D=[];for(let v=0;v<=y;v++)D.push(T(B+(k-B)*(v/y)));const U=()=>{t.beginPath(),D.forEach(([v,_],F)=>F?t.lineTo(v,_):t.moveTo(v,_)),t.stroke()},O=()=>{const v=t.createLinearGradient(D[0][0],D[0][1],D[y][0],D[y][1]);return v.addColorStop(0,h(.55,0)),v.addColorStop(.4,h(.56,0)),v.addColorStop(.68,h(.6,.09)),v.addColorStop(.88,h(.64,.24)),v.addColorStop(1,h(.68,.44)),v},$=1+.5*L;t.globalAlpha=I,t.strokeStyle=O(),t.lineWidth=(20+10*L)*u*A,t.shadowColor=f(.72),t.shadowBlur=m*2.2,U(),t.strokeStyle=O(),t.lineWidth=(10+5*L)*u*A,t.shadowBlur=m*1,U(),t.shadowBlur=0;for(let v=1;v<=y;v++){const _=v/y;t.globalAlpha=Math.pow(_,2.2)*.95*I,t.strokeStyle=f(.55+.38*_),t.lineWidth=(1.6+6.5*Math.pow(_,.7))*u*A*$,t.beginPath(),t.moveTo(D[v-1][0],D[v-1][1]),t.lineTo(D[v][0],D[v][1]),t.stroke()}const V=D[y][0],g=D[y][1];t.globalAlpha=.8*I,t.fillStyle=f(.6),t.shadowColor=f(.8),t.shadowBlur=m*1.6,t.beginPath(),t.arc(V,g,(9+5*L)*u*A,0,Math.PI*2),t.fill(),t.globalAlpha=I,t.fillStyle=f(.93),t.shadowBlur=m*.6,t.beginPath(),t.arc(V,g,(3.4+1.8*L)*u*A,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function H0(t,a,o,i,s,e,c){const r=e.lut,f=13*i.halo,m=a/220,d=a/2,p=e.arrow&&e.arrow.w||1;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const l=(o.r!=null?o.r:.3)*a,u=o.width!=null?o.width:1,h=4.2*p*m*u,C=o.dir!=null?o.dir:1,M=(o.sweep!=null?o.sweep:.66)*Math.PI*2,w=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.5)%1,n=-Math.PI/2+C*w*Math.PI*2;t.save(),t.translate(d,d),t.globalAlpha=.16,t.lineWidth=h*.7,t.strokeStyle=r(.44),t.shadowColor=r(.6),t.shadowBlur=f*.4,t.beginPath(),t.arc(0,0,l,0,Math.PI*2),t.stroke(),t.shadowBlur=0;const S=16;for(let L=0;L<S;L++){const P=L/(S-1),A=n-C*P*M,y=n-C*(P+1.2/S)*M;t.globalAlpha=(1-P)*.9,t.strokeStyle=r(.55+.35*(1-P)),t.lineWidth=h*(.55+.55*(1-P)),t.shadowColor=r(.8),t.shadowBlur=f*(.4+.5*(1-P)),t.beginPath(),t.arc(0,0,l,Math.min(A,y),Math.max(A,y),!1),t.stroke()}t.shadowBlur=0;const T=Math.cos(n)*l,b=Math.sin(n)*l,x=n+C*Math.PI/2,I=8*m*u;t.save(),t.translate(T,b),t.rotate(x+Math.PI/2),t.globalAlpha=1;const R=3.4*I*(.7+.3*p),k={color:r(.96),glowColor:r(.9),glow:f*1.2};e.glyph&&(e.glyph(t,"LIFT_TIP",0,0,R,k)||e.glyph(t,"TIP_TRI",0,0,R*.93,k))||(t.rotate(-Math.PI/2),t.strokeStyle=r(.96),t.lineWidth=h*.9,t.shadowColor=r(.9),t.shadowBlur=f*1.2,t.beginPath(),t.moveTo(-I,-I*.9),t.lineTo(I*.5,0),t.lineTo(-I,I*.9),t.stroke()),t.restore(),t.globalAlpha=.62,t.shadowColor=r(.75),t.shadowBlur=f*.6,t.fillStyle=r(.6),t.beginPath(),t.arc(0,0,h*.6,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}export{L0 as C,p0 as G,y0 as M,W as N,E as P,v0 as Q,k0 as R,b0 as S,T0 as Z,j as a,d0 as b,A0 as c,M0 as d,I0 as e,E0 as f,O0 as g,G0 as h,R0 as i,U0 as j,H0 as k,P0 as l,F0 as m,D0 as n,z as o,c0 as p,x0 as q,B0 as r,i0 as s,S0 as t,C0 as u,_0 as v,u0 as w,h0 as x};
