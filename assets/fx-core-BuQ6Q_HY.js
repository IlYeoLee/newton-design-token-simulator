const K={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},t0={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},p0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],Kt=Object.fromEntries(Object.entries({...K,...t0}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),N=t=>`vec3(${p0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,$t=(t,a=1)=>`rgba(${p0(t).join(",")},${a})`,S0=[[K.red,0],[K.red,.3],[K.coral,.56],[K.sand,.86],[K.prism,1]],b0=1;function C0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(t0).some(o=>o.toUpperCase()===a)?!0:Object.values(K).some(o=>o.toUpperCase()===a)}function gt(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>C0(o)))&&(t.stops=S0.map(o=>[...o])),t.sat=b0,t)}const v0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",A0=.98,M0=1.16,y0=-.043,T0=-.031,L0=5.5,I0=.027,P0=.25,R0=.26,k0=.3,F0=.74,_0=.038,D0=.55,E0=24,B0=1,G0=1.6,H0=.45,O0=.82,U0=0,W0=.5,q0=.5,K0=.125,$0=.4,g0=1,z0=1.4,j0=0,X0=0,Y0=3.4,J0=.01,Q0=0,Z0=.011,V0=-2,N0=.8,tt=-.085,ot=.16,at=4,et=.6,lt=1,nt=1,st="glow",rt="add",it="offbit",ct=.55,dt=.125,ut=0,ht=4,pt=4,ft=0,mt=1,xt=.55,wt={punchLine:{node:1,numS:1,comet:1,tailLen:.5,rail:.22}},St=-.095,bt=.12,Ct=10,vt=-.015,At=.12,Mt=-10,yt={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15},Tt=.98,Lt=4,It={0:{sharp:0},1:{},2:{w:1.8,halo:.5,glow:.15,imp:0,dot:.2,pitch:.03,shade:0,sharp:.65,edge:.038,dotCol:4,rip:0},4:{glow:0,halo:.14,w:.7,shade:0,imp:0,edgeShadeGrad:0,pitch:.048,dot:.13,irot:21,dotCol:4,edge:.004,sharp:0,plantar:1,edgeShadeCol:4},tap:{op:.1,imp:0,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.7,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.028,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.26,w:1.15}},Pt=.45,Rt=.06,kt=.55,Ft={_:"움직임 튜닝(markmotion.js 가 읽는다). 상태 8토큰과 직교 — 여기는 '어떻게 움직이나'만.",stepLead:.3,slideDecay:3,over:.14,overAt:.78,settle:.11,settleHz:2.4,popA:.16,popB:.18,popBAt:.11,airScale:.12,spawnDur:.44,hitDur:.34,arrowRamp:.16,arrowBreath:.06},_t=0,Dt=0,Et=.35,Bt={_:v0,imp:A0,scale:M0,offx:y0,offy:T0,irot:L0,pitch:I0,dot:P0,glow:R0,shade:k0,sharp:F0,edge:_0,plantar:D0,bands:E0,bandSoft:B0,w:G0,halo:H0,pool:O0,noise:U0,rip:W0,ripReach:q0,ripWidth:K0,ripSpeed:$0,ripGrad:g0,edgeShade:z0,dotMode:j0,shadeRed:X0,shadeRedW:Y0,edgeW:J0,edgeSoft:Q0,dither:Z0,tilt:V0,gsize:N0,gx:tt,gy:ot,grot:at,gsh:et,shadeCol:lt,ripCol:nt,gShadow:st,gBlend:rt,numSrc:it,prog:ct,bloom:dt,blur:ut,edgeShadeW:ht,edgeShadeCol:pt,edgeShadeGrad:ft,edgeShadeG0:mt,edgeShadeG1:xt,prims:wt,gxL:St,gyL:bt,grotL:Ct,gxR:vt,gyR:At,grotR:Mt,tap:yt,op:Tt,dotCol:Lt,states:It,loadGain:Pt,loadBase:Rt,flow:kt,motion:Ft,tLo:_t,tHi:Dt,inkFloor:Et};function c0(t,a,o,d,r){let l=0;o[0]=0,d[0]=-1e20,d[1]=1e20;for(let e=1;e<r;e++){let c=(t[e]+e*e-(t[o[l]]+o[l]*o[l]))/(2*e-2*o[l]);for(;c<=d[l];)l--,c=(t[e]+e*e-(t[o[l]]+o[l]*o[l]))/(2*e-2*o[l]);l++,o[l]=e,d[l]=c,d[l+1]=1e20}l=0;for(let e=0;e<r;e++){for(;d[l+1]<e;)l++;a[e]=(e-o[l])*(e-o[l])+t[o[l]]}}function d0(t,a){const o=new Float32Array(a),d=new Int32Array(a),r=new Float32Array(a+1),l=new Float32Array(a);for(let e=0;e<a;e++){for(let c=0;c<a;c++)l[c]=t[c*a+e];c0(l,o,d,r,a);for(let c=0;c<a;c++)t[c*a+e]=o[c]}for(let e=0;e<a;e++){for(let c=0;c<a;c++)l[c]=t[e*a+c];c0(l,o,d,r,a);for(let c=0;c<a;c++)t[e*a+c]=o[c]}}function f0(t,a){const d=new Float32Array(a*a),r=new Float32Array(a*a);let l=0,e=0,c=0;for(let A=0;A<a*a;A++){const h=t[A*4+3]/255;d[A]=h>=1?0:h<=0?1e20:Math.pow(Math.max(0,.5-h),2),r[A]=h>=1?1e20:h<=0?0:Math.pow(Math.max(0,h-.5),2),h>.5&&(l+=A%a,e+=A/a|0,c++)}d0(d,a),d0(r,a);const u=new Float32Array(a*a);for(let A=0;A<a*a;A++)u[A]=(Math.sqrt(d[A])-Math.sqrt(r[A]))/a;return{data:u,N:a,cx:c?l/c/a:.5,cy:c?e/c/a:.5}}const Gt={get k(){if(typeof window>"u")return 1;const t=+new URLSearchParams(location.search).get("fxq"),a=+window.__FXQ||t||1;return Math.min(4,Math.max(1,a))}};function r0(t,a=512*Gt.k){const o="_raster"+a;if(t[o])return t[o];const d=document.createElement("canvas");d.width=d.height=a;const r=d.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);r.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const e=r.getImageData(0,0,a,a).data;let c=a,u=a,A=-1,h=-1;for(let m=0;m<a;m++)for(let s=0;s<a;s++)e[(m*a+s)*4+3]>8&&(s<c&&(c=s),s>A&&(A=s),m<u&&(u=m),m>h&&(h=m));return t[o]=A<0?{canvas:d,x:0,y:0,w:a,h:a}:{canvas:d,x:c,y:u,w:A-c+1,h:h-u+1},t[o]}function zt(t,a,o=!1){const d=r0(t,a),r=document.createElement("canvas");r.width=r.height=a;const l=r.getContext("2d"),e=Math.min(a*a0/d.w,a*a0/d.h),c=d.w*e,u=d.h*e;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(d.canvas,d.x,d.y,d.w,d.h,(a-c)/2,(a-u)/2,c,u),f0(l.getImageData(0,0,a,a).data,a)}function jt(t,a,o,d=!1){const r=r0(t,o),l=a?r0(a,o):null,e=Math.min(o*a0/r.w,o*a0/r.h),c=r.w*e,u=r.h*e,A=(o-c)/2,h=(o-u)/2,m=M=>{const B=document.createElement("canvas");B.width=B.height=o;const D=B.getContext("2d");return d&&(D.translate(0,o),D.scale(1,-1)),D.drawImage(M.canvas,r.x,r.y,r.w,r.h,A,h,c,u),f0(D.getImageData(0,0,o,o).data,o)},s=m(r),n=l?m(l):null,i=new Float32Array(o*o*2);for(let M=0;M<o*o;M++)i[M*2]=s.data[M],i[M*2+1]=n?n.data[M]:1;return{data:i,N:o,cx:s.cx,cy:s.cy,inCx:n?n.cx:s.cx,inCy:n?n.cy:s.cy,hasInner:!!n}}const Xt=1.9922,Ht=.78,a0=.52,Yt=Ht/a0,Jt=1.18,Z=Bt||{},m0={size:Z.gsize??.85,gx:Z.gx??-.025,gy:Z.gy??.195,rot:Z.grot??6,gxL:Z.gxL,gyL:Z.gyL,rotL:Z.grotL,gxR:Z.gxR,gyR:Z.gyR,rotR:Z.grotR,shadow:Z.gShadow??"glow",shadowK:Z.gsh??.75,blend:Z.gBlend??"add"};function Qt(t,a=m0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function Zt(t,a,o,d,r=m0){const l=Math.round(o*.75),e=r.shadow==="none"?0:r.shadowK??.75,c=u=>d(t,String(a),o/2,o/2,l,u);return r.shadow==="drop"&&e>.001?(t.save(),t.globalAlpha=Math.min(1,e*.7),t.translate(o*.018,o*.024),c({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),c({glow:0,glowColor:"rgba(0,0,0,0)"})):c(r.shadow==="glow"?{glow:26*e,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),r.blend==="knock"}function Vt(t,a){const o=t.getImageData(0,0,a,a),d=t.createImageData(a,a);for(let r=0;r<a*a;r++){const l=o.data[r*4+3]/255,e=Math.round(255*(1-l));d.data[r*4]=d.data[r*4+1]=d.data[r*4+2]=e,d.data[r*4+3]=255}t.putImageData(d,0,0)}const Nt={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},n0=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),s0=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function u0(t,a,o){t=n0(t),a=n0(a),o=n0(o);const d=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),r=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*d+.793617785*r-.0040720468*l,1.9779984951*d-2.428592205*r+.4505937099*l,.0259040371*d+.7827717662*r-.808675766*l]}function Ot(t,a,o){const d=(t+.3963377774*a+.2158037573*o)**3,r=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[s0(4.0767416621*d-3.3077115913*r+.2309699292*l),s0(-1.2684380046*d+2.6097574011*r-.3413193965*l),s0(-.0041960863*d-.7034186147*r+1.707614701*l)]}const h0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function to(t,a=1,o=new Uint8Array(256*4)){const d=[...t].sort((r,l)=>r[1]-l[1]);for(let r=0;r<256;r++){const l=r/255;let e=0;for(;e<d.length-2&&l>d[e+1][1];)e++;const[c,u]=d[e],[A,h]=d[e+1],m=Math.max(0,Math.min(1,(l-u)/Math.max(1e-5,h-u))),s=u0(...h0(c)),n=u0(...h0(A)),i=Ot(s[0]+(n[0]-s[0])*m,(s[1]+(n[1]-s[1])*m)*a,(s[2]+(n[2]-s[2])*m)*a);o.set([...i,255],r*4)}return o}const oo=`
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function Ut(t,a,o,d){t.lineWidth=4*a;const r=d.arrow;r.line==="dash"?t.setLineDash([12*a*r.gap,10*r.gap]):r.line==="dot"?(t.setLineDash([.5,12*r.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&r.line!=="solid"&&r.line!=="taper"&&(t.lineDashOffset=-o*40*r.speed)}function no(t,a,o,d,r,l={}){const e=r.lut,c=r.arrow||{},u=c.w??1,A=c.speed??1,h=c.glow??1,m=l.pulse??1,s=o/256,n=s*(l.scale??1),i=a/2,M=d*.9*A%1,B=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,M/.55),D=l.prog!=null?1:M>.88?(1-M)/.12:1;t.clearRect(0,0,a,o);const x=D*(.45+.55*m),I=o-24*s,_=58*s,P=I+(_-I)*B,v=(T,W)=>e(T).replace("rgb(","rgba(").replace(")",`,${W.toFixed(3)})`),w=1.1*n*u,f=13*n*u,b=42*n*(.7+.3*u),k=!l.noTip&&B>.28?Math.min(1,(B-.28)/.22)*b*.42:0,y=P+k,C=t.createLinearGradient(0,I,0,y),F=T=>Math.max(.02,Math.min(.99,T+((c.heat??.5)-.5)*1.1));C.addColorStop(0,v(F(.55),0)),C.addColorStop(.18,v(F(.64),.3*x)),C.addColorStop(.4,v(F(.76),.8*x)),C.addColorStop(.65,v(F(.88),.98*x)),C.addColorStop(1,v(F(.97),x));const G=l.dots?(()=>{const T=Math.abs(y-I),W=Math.max(3,Math.round(T/(9.5*n))),q=d*1.15*A%1,X=(L,p,R)=>{const E=Math.max(0,Math.min(1,(R-L)/(p-L)));return E*E*(3-2*E)},S=[];for(let L=0;L<W;L++){const p=((L+.5)/W+q/W)%1,R=1+.22*Math.sin((p*3-q*2)*Math.PI*2);S.push({y:I+(y-I)*p,r:(w/2+(f/2-w/2)*p)*R,a:(1-.35*X(.72,.92,p))*(1-X(.92,1,p))})}return S})():null;if(t.save(),t.filter=`blur(${7*n}px)`,t.globalAlpha=l.dots?.3:.55,t.fillStyle=C,l.dots){const T=t.globalAlpha;for(const W of G)t.globalAlpha=T*W.a,t.beginPath(),t.arc(i,W.y,Math.max(1.4*n,W.r*1.5),0,Math.PI*2),t.fill();t.globalAlpha=T}else t.beginPath(),t.moveTo(i-w,I),t.lineTo(i+w,I),t.lineTo(i+f*.95,y),t.lineTo(i-f*.95,y),t.closePath(),t.fill();if(t.restore(),t.globalAlpha=1,t.fillStyle=C,l.dots){for(const T of G)t.globalAlpha=T.a,t.beginPath(),t.arc(i,T.y,Math.max(.9*n,T.r*.92),0,Math.PI*2),t.fill();t.globalAlpha=1}else t.beginPath(),t.moveTo(i-w/2,I),t.lineTo(i+w/2,I),t.lineTo(i+f/2,y),t.lineTo(i-f/2,y),t.closePath(),t.fill();if(t.globalAlpha=x,B>.28&&!l.noTip){const T=b,W=Math.min(1,(B-.28)/.22)*x,q=P+T*.3;t.globalAlpha=W;const X={color:e(F(.95)),glowColor:e(F(.85)),glow:12*h};r.glyph&&(r.glyph(t,"LIFT_TIP",i,q,T,X)||r.glyph(t,"TIP_TRI",i,q,T*.93,X))||(t.strokeStyle=e(.95),t.lineWidth=13*n*u,t.lineCap="round",t.lineJoin="round",t.shadowColor=e(.9),t.shadowBlur=18*n*h,t.beginPath(),t.moveTo(i-26*n,q+14*n),t.lineTo(i,q-16*n),t.lineTo(i+26*n,q+14*n),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function Wt(t,a,o,d,r,l,e={}){const c=l.lut,u=l.arrow||{},A=u.w??1,h=u.glow??1,m=w=>Math.max(.02,Math.min(.99,w+((u.heat??.5)-.5)*1.1)),s=o/256*(e.scale??1);t.clearRect(0,0,a,o);const n=d.map(([w,f])=>[w*a,f*o]);if(n.length<2)return;const i=48,M=[],B=w=>{if(n.length===2)return[n[0][0]+(n[1][0]-n[0][0])*w,n[0][1]+(n[1][1]-n[0][1])*w];const f=w*(n.length-1),b=Math.min(n.length-2,Math.floor(f)),k=f-b,y=n[Math.max(0,b-1)],C=n[b],F=n[b+1],G=n[Math.min(n.length-1,b+2)],T=(W,q,X,S)=>.5*(2*q+(-W+X)*k+(2*W-5*q+4*X-S)*k*k+(-W+3*q-3*X+S)*k*k*k);return[T(y[0],C[0],F[0],G[0]),T(y[1],C[1],F[1],G[1])]};for(let w=0;w<=i;w++)M.push(B(w/i));const D=Math.max(0,Math.min(1,e.prog!=null?e.prog:r*.55%1)),x=Math.max(1,Math.round(i*D)),I=e.alpha??1,_=e.tail??.22;t.lineCap="round";const P=42*s*(.7+.3*A);let v=x;if(D>.28){let w=0;const f=P*.42*Math.min(1,(D-.28)/.22);for(;v>1&&w<f;)w+=Math.hypot(M[v][0]-M[v-1][0],M[v][1]-M[v-1][1]),v--}for(const w of[0,1])for(let f=1;f<=v;f++){const b=f/x,k=Math.min(1,b/_),y=k*k*(3-2*k)*I;t.globalAlpha=w?y:y*.16*b,t.strokeStyle=c(.55+.42*b),t.lineWidth=(1.1+11.9*b)*s*A*(w?1:1.9),t.beginPath(),t.moveTo(M[f-1][0],M[f-1][1]),t.lineTo(M[f][0],M[f][1]),t.stroke()}if(D>.28){const w=M[Math.max(0,x-2)][0],f=M[Math.max(0,x-2)][1],b=Math.atan2(M[x][1]-f,M[x][0]-w)+Math.PI/2,k=M[x][0]-Math.sin(b)*P*.3,y=M[x][1]+Math.cos(b)*P*.3;t.save(),t.translate(k,y),t.rotate(b),t.globalAlpha=Math.min(1,(D-.28)/.22)*I;const C={color:c(m(.95)),glowColor:c(m(.85)),glow:12*h};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,P,C)||l.glyph(t,"TIP_TRI",0,0,P*.93,C))||(t.strokeStyle=c(.95),t.lineWidth=9*s*A,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*s,12*s),t.lineTo(0,-14*s),t.lineTo(18*s,12*s),t.stroke()),t.restore()}t.globalAlpha=1}function qt(t,a,o,d,r,l){r=r||{};const e=l.lut,c=r.style||l.arrow.line,u=!!r.closed,A=[0];for(let n=1;n<a.length;n++)A.push(A[n-1]+Math.hypot(a[n][0]-a[n-1][0],a[n][1]-a[n-1][1]));const h=A[A.length-1]||1,m=n=>{n=(n%h+h)%h;let i=1;for(;i<A.length-1&&A[i]<n;)i++;const M=(n-A[i-1])/Math.max(1e-4,A[i]-A[i-1]);return[a[i-1][0]+(a[i][0]-a[i-1][0])*M,a[i-1][1]+(a[i][1]-a[i-1][1])*M,Math.atan2(a[i][1]-a[i-1][1],a[i][0]-a[i-1][0])]},s=l.arrow;if(c==="chevron"){const n=(26*d+8)*s.gap,i=Math.max(2,Math.floor(h/n));t.shadowColor=e(Math.min(1,s.heat+.2)),t.shadowBlur=8*d*s.glow;for(let M=0;M<i;M++){const B=M*n+o*42*s.speed%n;if(!u&&B>h-4)continue;const[D,x,I]=m(B),_=7.5*d,P=8.5*d,v=.45+.4*Math.sin(B/h*6.283-o*2.2*s.speed);t.strokeStyle=e(s.heat-.05+v*.3),t.lineWidth=3.2*d,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(D,x),t.rotate(I),t.beginPath(),t.moveTo(-P*.5,-_),t.lineTo(P*.5,0),t.lineTo(-P*.5,_),t.stroke(),t.restore()}return!0}if(c==="comet"){const n=o*.35*s.speed%1*h,i=h*s.tail,M=Math.max(24,a.length*2);t.lineCap="round";for(let x=0;x<M;x++){const I=n-x/M*i,_=n-(x+1)/M*i;if(!u&&_<0)break;const P=1-x/M,[v,w]=m(I),[f,b]=m(_);!u&&Math.hypot(f-v,b-w)>h*.4||(t.globalAlpha=Math.pow(P,1.6),t.strokeStyle=e(Math.max(.05,s.heat-.2)+P*.55),t.lineWidth=(1.5+P*4.5)*d,P>.72?(t.shadowColor=e(Math.min(1,s.heat+.3)),t.shadowBlur=P*12*d*s.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(v,w),t.lineTo(f,b),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[B,D]=m(n);return t.fillStyle=rgba(t0.ink,.95),t.shadowColor=e(.9),t.shadowBlur=16*d,t.beginPath(),t.arc(B,D,2.6*d,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=r.color||e(s.heat),t.shadowColor=e(Math.min(1,s.heat+.15)),t.shadowBlur=(r.glow??8)*d*s.glow,c==="taper")for(let n=1;n<a.length;n++)t.lineWidth=(.5+n/a.length*4.5)*d,t.beginPath(),t.moveTo(a[n-1][0],a[n-1][1]),t.lineTo(a[n][0],a[n][1]),t.stroke();else Ut(t,d,o,l),t.beginPath(),a.forEach(([n,i],M)=>M?t.lineTo(n,i):t.moveTo(n,i)),u&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function so(t,a,o,d,r,l){const e=13*d.halo,c=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const u=a/220,A=a/2,h=18*o.round*u,m=40*u,s=48*u,n=a-80*u,i=a-96*u,M=[],B=(x,I,_,P)=>{for(let v=0;v<=1;v+=.12)M.push([x+(_-x)*v,I+(P-I)*v])};B(m+h,s,m+n-h,s),B(m+n,s+h,m+n,s+i-h),B(m+n-h,s+i,m+h,s+i),B(m,s+i-h,m,s+h),t.shadowColor=c(.6),t.shadowBlur=e*.8;const D=4*l.arrow.w*u;if(l.arrow.line==="solid"?(t.setLineDash([10*o.dash*u,8*u]),t.lineDashOffset=-r*22*u,t.strokeStyle=c(.45),t.lineWidth=D,t.beginPath(),t.roundRect(m,s,n,i,h),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):qt(t,M,r,l.arrow.w*u,{color:c(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const x=[],I=(C,F,G,T,W)=>{for(let q=1;q<=W;q++)x.push([C+(G-C)*q/W,F+(T-F)*q/W])},_=(C,F,G,T,W)=>{for(let q=1;q<=W;q++){const X=G+(T-G)*q/W;x.push([C+h*Math.cos(X),F+h*Math.sin(X)])}},P=Math.PI/2,v=m+n,w=s+i,f=m+n/2;x.push([f,s]),I(f,s,v-h,s,8),_(v-h,s+h,-P,0,6),I(v,s+h,v,w-h,10),_(v-h,w-h,0,P,6),I(v-h,w,m+h,w,14),_(m+h,w-h,P,Math.PI,6),I(m,w-h,m,s+h,10),_(m+h,s+h,Math.PI,Math.PI+P,6),I(m+h,s,f,s,8);let b=0;for(let C=1;C<x.length;C++)b+=Math.hypot(x[C][0]-x[C-1][0],x[C][1]-x[C-1][1]);const k=b*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*u,8*u]),t.lineDashOffset=-(n/2-h)-r*22*u,t.strokeStyle=c(.9),t.lineWidth=D*1.3,t.lineCap="round",t.shadowColor=c(.92),t.shadowBlur=e*1.3,t.beginPath(),t.moveTo(x[0][0],x[0][1]);let y=0;for(let C=1;C<x.length&&y<k;C++){const F=Math.hypot(x[C][0]-x[C-1][0],x[C][1]-x[C-1][1]);if(y+F<=k)t.lineTo(x[C][0],x[C][1]),y+=F;else{const G=(k-y)/F;t.lineTo(x[C-1][0]+(x[C][0]-x[C-1][0])*G,x[C-1][1]+(x[C][1]-x[C-1][1])*G),y=k}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&l.foot&&(l.foot(t,!1,A-16*o.feet*u,A+6*u,26*o.feet*u),l.foot(t,!0,A+16*o.feet*u,A+6*u,26*o.feet*u)),t.shadowBlur=0}function ro(t,a,o,d,r,l,e,c){const u=13*d.halo,A=4*l.arrow.w*(a/220),h=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const m=a/220,s=e||[[45*m,130*m],[110*m,60*m],[175*m,110*m]],n=c??r*.5%1,i=Math.min(1,n*1.25)*(s.length-1),M=Math.min(s.length-1,Math.floor(i+.35));t.shadowColor=h(.7),t.shadowBlur=u;const B=w=>{const f=Math.max(0,Math.min(s.length-2,Math.floor(w))),b=w-f;return[s[f][0]+(s[f+1][0]-s[f][0])*b,s[f][1]+(s[f+1][1]-s[f][1])*b]},D=o.comet!=null?o.comet:1,x=o.tailLen!=null?o.tailLen:.5;if(t.save(),t.shadowBlur=0,t.globalAlpha=o.rail!=null?o.rail:.22,t.strokeStyle=h(.6),t.lineWidth=2.2*m,t.lineCap="round",t.setLineDash([.01,8*m]),t.beginPath(),s.forEach(([w,f],b)=>b?t.lineTo(w,f):t.moveTo(w,f)),t.stroke(),t.setLineDash([]),t.restore(),i>.02){const w=(f,b)=>h(f).replace("rgb(","rgba(").replace(")",`,${b.toFixed(3)})`);for(let f=0;f<26;f++){const b=f/25,k=i-x*b;if(k<=0)break;const y=B(k),C=4.7*m*D*(1-b*.75),F=C*2.1,G=(1-b)*(1-b)*.8,T=t.createRadialGradient(y[0],y[1],0,y[0],y[1],F);T.addColorStop(0,w(.55-.18*b,G)),T.addColorStop(.5,w(.5-.18*b,G*.35)),T.addColorStop(1,w(.45-.18*b,0)),t.save(),t.shadowBlur=0,t.globalAlpha=1,t.fillStyle=T,t.beginPath(),t.arc(y[0],y[1],F,0,Math.PI*2),t.fill(),t.restore()}if(i<s.length-1-.001&&i-Math.floor(i)>.03){const f=B(i);t.save(),t.fillStyle=h(.62),t.shadowColor=h(.8),t.shadowBlur=11*m*D,t.beginPath(),t.arc(f[0],f[1],5.6*m*D,0,Math.PI*2),t.fill(),t.fillStyle=h(.95),t.globalAlpha=.95,t.beginPath(),t.arc(f[0],f[1],2.1*m*D,0,Math.PI*2),t.fill(),t.restore()}}t.globalAlpha=1,t.lineCap="butt";const I=o.done!=null,_=o.done||0,P=o.vd||[],v=o.acc!=null?o.acc:s.length-1;if(s.forEach(([w,f],b)=>{const k=b<_,y=P[b]||null,C=!k&&b===M&&!I,F=C?1+Math.sin(r*6)*.14:1,G=o.pop!=null&&b===_-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,T=12*o.node*F*G*m*(b===v?1.34:1);k&&y!=="miss"&&(t.shadowBlur=u*1.4,t.shadowColor=h(.5),t.fillStyle=h(y==="near"?.5:.36),t.beginPath(),t.arc(w,f,T*.88,0,Math.PI*2),t.fill()),k||(t.save(),t.translate(w,f),o0(t,h,T,C?.8:.5,C?.9:.5,A*.9,u),t.restore()),t.strokeStyle=y==="hit"?K.prism:y==="near"?K.sand:y==="miss"?t0.lo:h(k?.62:C?.8:.45),t.lineWidth=A*(C?1.3:y?1.15:.9),t.shadowBlur=C?u*1.6:y&&y!=="miss"?u*1.3:u*.6,y&&y!=="miss"&&(t.shadowColor=y==="hit"?K.prism:K.sand),t.beginPath(),t.arc(w,f,T,0,Math.PI*2),t.stroke(),l.num&&(k&&y!=="miss"?(t.save(),t.globalCompositeOperation="destination-out",t.shadowBlur=0,l.num(t,String(b+1),w,f,16*o.numS*F*m,Math.round(14*o.numS*m)),t.restore()):(t.globalAlpha=b<=M?1:.6,l.num(t,String(b+1),w,f,16*o.numS*F*m,Math.round(14*o.numS*m)),t.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&_>0&&s[_-1]){const[w,f]=s[_-1],b=1-o.pop/.38,k=b*b,y=12*o.node*m*(_-1===(o.acc!=null?o.acc:s.length-1)?1.34:1);t.save();const C=y*(1.6+1.9*(1-b)),F=t.createRadialGradient(w,f,0,w,f,C);F.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*k).toFixed(3)})`),F.addColorStop(.35,h(.92).replace("rgb(","rgba(").replace(")",`,${(.8*k).toFixed(3)})`)),F.addColorStop(1,h(.7).replace("rgb(","rgba(").replace(")",",0)")),t.fillStyle=F,t.beginPath(),t.arc(w,f,C,0,Math.PI*2),t.fill(),t.strokeStyle=h(.92),t.globalAlpha=k,t.lineWidth=Math.max(1,6*m*b),t.shadowColor=h(.85),t.shadowBlur=24*m*k,t.beginPath(),t.arc(w,f,y*(1.1+3.4*(1-b)),0,Math.PI*2),t.stroke();const G=Math.max(0,b-.35)/.65;G>0&&(t.globalAlpha=G*G*.6,t.lineWidth=Math.max(1,3.5*m*G),t.beginPath(),t.arc(w,f,y*(1.1+2*(1-G)),0,Math.PI*2),t.stroke()),t.restore()}t.shadowBlur=0}function o0(t,a,o,d,r,l,e,c=1){if(o<=.6)return;const u=(n,i)=>a(n).replace("rgb(","rgba(").replace(")",`,${i})`),A=l*2.6*c,h=Math.max(.1,o-A),m=o+A,s=t.createRadialGradient(0,0,h,0,0,m);s.addColorStop(0,u(d-.05,0)),s.addColorStop(.5,u(d,r*.85)),s.addColorStop(1,u(d-.05,0)),t.globalAlpha=1,t.fillStyle=s,t.shadowBlur=0,t.beginPath(),t.arc(0,0,m,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,r*1.1),t.lineWidth=l*.85,t.strokeStyle=a(Math.min(.98,d+.12)),t.shadowColor=a(.88),t.shadowBlur=e*.6,t.beginPath(),t.arc(0,0,o,0,Math.PI*2),t.stroke(),t.shadowBlur=0}const e0=t=>1-Math.pow(1-Math.max(0,Math.min(1,t)),5);function io(t,a,o,d,r,l){const e=l.lut,c=a/512,u=l?.day?1:0,A=l.arrow&&l.arrow.w||1,h=(S,L)=>e(S).replace("rgb(","rgba(").replace(")",","+L+")"),m=u?.95:.86,s=(S,L)=>h(m,S),n=4*A*c;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const i=o.mat||{nx:.86,fx:.86,ny:-.86,fy:.86},M=o.in==null?1:Math.max(0,Math.min(1,o.in)),B=e0(M/.45),D=S=>e0((M-.28-S*.09)/.42),x=o.hit==null?9:o.hit,I=x<.34?Math.sin(Math.PI*(x/.34)):0,_=S=>a/2+S*a/2,P=S=>a/2-S*a/2,v=(S,L)=>e(S).replace("rgb(","rgba(").replace(")",","+L+")"),w=(S,L,p,R,E,O,U)=>{t.font="700 "+R+'px "Supreme", sans-serif',t.textAlign="center",t.textBaseline="middle";const H=Array.from(String(S)),g=R*O;let J=-g;for(const z of H)J+=t.measureText(z).width+g;let Y=L-J/2;t.fillStyle=E;for(const z of H){const $=t.measureText(z).width;t.fillText(z,Y+$/2,p),Y+=$+g}},f=.05*(o.round!=null?o.round/.35:1),b=(S,L,p,R)=>{};b(-i.fx+f,i.fy-f),b(-i.nx+f*.6,i.ny+f),b(i.nx-f*.6,i.ny+f),b(i.fx-f,i.fy-f);const k=o.center?o.center.x:0,y=o.center?o.center.y:0,C=(o.center&&o.center.r!=null?o.center.r:.26)*a/2*B*(1+.055*I+.008*Math.sin(r*2.4)),F=(o.targets||[]).slice().sort((S,L)=>(S.n||0)-(L.n||0));if(F.length){t.save(),t.shadowBlur=0,t.globalAlpha=(u?.55:.22)*e0(M/.9),t.strokeStyle=e(u?.3:.6),t.lineWidth=(u?3.6:2.2)*c,t.lineCap="round",t.setLineDash([.01,(u?6:8)*c]);const S=o.travel||{};for(const L of F){const p=_(L.x),R=P(L.y),E=_(k)-p,O=P(y)-R,U=S.k>0&&S.k<1&&(L.n===S.from||L.n===S.to),H=Math.hypot(E,O)||1,g=(L.r!=null?L.r:.2)*a/2*1.16,J=p+E/H*g,Y=R+O/H*g,z=C*(o.center&&o.center.live?1.34:1),$=_(k)-E/H*z*1.12,j=P(y)-O/H*z*1.12;if(t.beginPath(),t.moveTo(J,Y),t.lineTo($,j),t.stroke(),I>.01){const Q=1-I,V=.34,i0=t.createLinearGradient($,j,J,Y),l0=(x0,w0)=>i0.addColorStop(Math.max(0,Math.min(1,x0)),e(.85).replace("rgb(","rgba(").replace(")",","+w0+")"));l0(Q-V,0),l0(Q,.9*I),l0(Q+V,0),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=i0,t.lineWidth=3.4*c,t.stroke(),t.restore()}if(U){const Q=t.createLinearGradient(J,Y,$,j),V=Math.sin(Math.PI*S.k)*.85;Q.addColorStop(0,e(.5).replace("rgb(","rgba(").replace(")",",0)")),Q.addColorStop(.5,e(.9).replace("rgb(","rgba(").replace(")",","+V+")")),Q.addColorStop(1,e(.5).replace("rgb(","rgba(").replace(")",",0)")),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=Q,t.lineWidth=3*c,t.stroke(),t.restore()}}t.setLineDash([]),t.restore()}const G=o.travel;if(G&&G.k>.001&&G.k<1){const S=F.find(p=>p.n===G.from),L=F.find(p=>p.n===G.to);if(S&&L){const p=_(S.x),R=P(S.y),E=_(L.x),O=P(L.y),U=_(k),H=P(y),g=e0(G.k),J=V=>V<.5?[p+(U-p)*(V/.5),R+(H-R)*(V/.5)]:[U+(E-U)*((V-.5)/.5),H+(O-H)*((V-.5)/.5)],[Y,z]=J(g),[$,j]=J(Math.max(0,g-.28)),Q=t.createLinearGradient($,j,Y,z);Q.addColorStop(0,e(.5).replace("rgb(","rgba(").replace(")",",0)")),Q.addColorStop(1,e(.85).replace("rgb(","rgba(").replace(")",",0.85)")),t.strokeStyle=Q,t.lineWidth=3.2*c,t.lineCap="round",t.beginPath(),t.moveTo($,j),t.lineTo(Y,z),t.stroke(),t.fillStyle=e(.62),t.shadowColor=e(.8),t.shadowBlur=11*c,t.beginPath(),t.arc(Y,z,5.6*c,0,Math.PI*2),t.fill(),t.fillStyle=e(.95),t.globalAlpha=.95,t.shadowBlur=0,t.beginPath(),t.arc(Y,z,2.1*c,0,Math.PI*2),t.fill(),t.globalAlpha=1}}const T=13*d.halo*(u?.45:1);for(const S of o.targets||[]){const L=S.on!==!1,p=!!S.live,R=D(S.n?S.n-1:0);if(R<=.001)continue;const E=_(S.x),O=P(S.y),U=(S.r!=null?S.r:.2)*a/2*(p?1.34:1)*(.9+.1*R);t.globalAlpha=R*(L?1:.45),t.shadowBlur=T*1.4,t.shadowColor=e(.5),t.fillStyle=e(u?p?.26:.62:p?.5:.36),t.beginPath(),t.arc(E,O,U*.88,0,Math.PI*2),t.fill(),t.shadowBlur=0,t.save(),t.translate(E,O),o0(t,e,U,p?.8:.5,p?.9:.5,n*.9,T),t.restore();const H=S.v;t.strokeStyle=H==="hit"?K.prism:H==="near"?K.sand:H==="miss"?t0.lo:e(p?.8:.45),t.lineWidth=n*(p?1.3:H?1.15:.9),t.shadowBlur=p?T*1.6:H&&H!=="miss"?T*1.3:T*.6,t.shadowColor=H==="hit"?K.prism:H==="near"?K.sand:e(.5),t.beginPath(),t.arc(E,O,U,0,Math.PI*2),t.stroke(),t.shadowBlur=0,l.num(t,S.n,E,O,U*.9,Math.round(U*.78)),t.globalAlpha=1}const W=(S,L,p,R)=>{const E=13*d.halo,O=o.per||.4,U=Math.max(0,Math.min(1,R/O)),H=Math.min(.16,O*.42),g=Math.max(0,Math.min(1,1-R/H)),J=p*1.9;for(let $=2;$>=0;$--){const j=Math.pow(Math.max(0,U-$*.05),1.6),Q=J-(J-p)*j,V=$===0?.55+.35*j:.16/$;t.save(),t.translate(S,L),o0(t,e,Q,.5+.35*j,V,n*.45,E,1.15-.35*j),t.restore()}g>.01&&(t.save(),t.translate(S,L),o0(t,e,p*(1+1.5*(1-g)),.92,g*.9,n*1.7,E,1.1),t.restore());const Y=Math.max(0,Math.min(1,1-R/.22)),z=Y*Y;if(z>.01){const $=Math.max(1,p*(1.5+1.8*(1-Y))),j=t.createRadialGradient(S,L,0,S,L,$);j.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.15*z).toFixed(3)})`),j.addColorStop(.35,v(.92,(.8*z).toFixed(3))),j.addColorStop(1,v(.7,0)),t.save(),t.shadowBlur=0,t.fillStyle=j,t.beginPath(),t.arc(S,L,$,0,Math.PI*2),t.fill(),t.restore()}},q=(o.targets||[]).filter(S=>S&&S.hit!=null&&S.hit<1.2);for(const S of q){const L=(S.r!=null?S.r:.2)*a/2*(S.live?1.34:1);W(_(S.x),P(S.y),L,S.hit)}const X=o.center?o.center.hit!=null?o.center.hit:o.hit!=null?x:null:null;if(X!=null&&X<1.2&&W(_(k),P(y),C,X),o.center){const S=_(k),L=P(y),p=13*d.halo*(u?.45:1),R=t.createRadialGradient(S,L,C*.1,S,L,C*1.6);R.addColorStop(0,v(.42,.3)),R.addColorStop(.6,v(.35,.12)),R.addColorStop(1,v(.3,0)),t.fillStyle=R,t.beginPath(),t.arc(S,L,C*1.6,0,Math.PI*2),t.fill();const E=!!o.center.live,O=C*(E?1.34:1);t.shadowBlur=p*1.4,t.shadowColor=e(.5),t.fillStyle=e(u?E?.26:.62:E?.5:.36),t.beginPath(),t.arc(S,L,O*.88,0,Math.PI*2),t.fill(),t.shadowBlur=0,t.save(),t.translate(S,L),o0(t,e,O,E?.8:.5,E?.9:.5,n*.9,p),t.restore();const U=o.center.v;if(t.strokeStyle=U==="hit"?K.prism:U==="near"?K.sand:U==="miss"?t0.lo:e(E?.8:.45),t.lineWidth=n*(E?1.3:U?1.15:.9),t.shadowBlur=E?p*1.6:U&&U!=="miss"?p*1.3:p*.6,t.shadowColor=U==="hit"?K.prism:U==="near"?K.sand:e(.5),t.beginPath(),t.arc(S,L,O,0,Math.PI*2),t.stroke(),t.shadowBlur=0,o.brand&&l.logo&&l.logo.complete&&l.logo.naturalWidth){const H=C*1.05,g=H*l.logo.naturalHeight/l.logo.naturalWidth;t.globalAlpha=.5*B,t.drawImage(l.logo,S-H/2,L-g/2,H,g),t.globalAlpha=1}if(o.center.label){const H=String(o.center.label).split(`
`);H.forEach((g,J)=>w(g,S,L+(J-(H.length-1)/2)*15*c,12*c,s(.9),.14))}}if(o.prog>.001&&o.center){const S=_(k),L=P(y),p=I;t.strokeStyle=v(.34,.9+.1*p),t.lineWidth=n*(.85+.5*p),t.lineCap="round",t.shadowColor=e(.42),t.shadowBlur=(10+16*p)*c,t.beginPath(),t.arc(S,L,C,-Math.PI/2,-Math.PI/2+Math.PI*2*Math.min(1,o.prog)),t.stroke(),t.shadowBlur=0}}function co(t,a,o,d,r,l,e){const c=l.lut,u=13*d.halo,A=a/220,h=a/2,m=l.arrow&&l.arrow.w||1,s=(v,w)=>c(v).replace("rgb(","rgba(").replace(")",`,${w})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const n=(o.r!=null?o.r:.42)*a,i=n*(o.rt!=null?o.rt:.36),M=3.4*m*A,B=e!=null?Math.max(0,Math.min(1,e)):r*(o.tempo||.6)%1,D=Math.pow(B,1.6),x=Math.max(0,(B-.9)/.1);t.save(),t.translate(h,h);const I=(v,w,f,b=1)=>o0(t,c,v,w,f,M,u,b),_=t.createRadialGradient(0,0,0,0,0,i*1.08);_.addColorStop(0,s(.6,.1+.18*x)),_.addColorStop(.65,s(.5,.05+.08*x)),_.addColorStop(1,s(.5,0)),t.globalAlpha=1,t.fillStyle=_,t.beginPath(),t.arc(0,0,i*1.08,0,Math.PI*2),t.fill();const P=1+.02*Math.sin(r*2.6);I(i*P,.55+.4*x,.5+.45*x,.9);for(let v=2;v>=0;v--){const w=Math.pow(Math.max(0,B-v*.05),1.6),f=n-(n-i)*w,b=v===0?.6+.4*D:.18/v*(1-x);I(f,.55+.4*D,b*(1-x*.45),1.15-.35*D)}x>.01&&I(i*(1+1.4*x),.9,(1-x)*.8,1.1),t.globalAlpha=.6+.3*x,t.shadowColor=c(.85),t.shadowBlur=u*(.9+x),t.fillStyle=c(.62+.3*x),t.beginPath(),t.arc(0,0,M*.85+3*A*x,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function uo(t,a,o,d,r,l,e,c){const u=l.lut,A=13*d.halo,h=a/220,m=a/2,s=l.arrow&&l.arrow.w||1,n=s*h,i=(p,R)=>u(p).replace("rgb(","rgba(").replace(")",","+R+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const M=a*.42*(o.spread!=null?o.spread:1),D=(c||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([p,R])=>[m+p*M,m+R*M]),x=80,I=[];for(let p=0;p<=x;p++){const R=p/x*(D.length-1),E=Math.min(D.length-2,Math.floor(R)),O=R-E,U=D[Math.max(0,E-1)],H=D[E],g=D[E+1],J=D[Math.min(D.length-1,E+2)],Y=(z,$,j,Q)=>.5*(2*$+(-z+j)*O+(2*z-5*$+4*j-Q)*O*O+(-z+3*$-3*j+Q)*O*O*O);I.push([Y(U[0],H[0],g[0],J[0]),Y(U[1],H[1],g[1],J[1])])}const _=p=>{const R=Math.max(0,Math.min(x,p*x)),E=Math.floor(R),O=R-E,U=I[E],H=I[Math.min(x,E+1)];return[U[0]+(H[0]-U[0])*O,U[1]+(H[1]-U[1])*O]},P=.68;let v,w,f;if(e!=null)v=Math.max(0,Math.min(1,e)),w=1,f=0;else{const p=r*(o.tempo||.42)%1;if(p<P)v=p/P,w=1,f=0;else{const R=(p-P)/(1-P);v=1,w=1-R*R,f=R}}if(w<=.012)return;const b=v*v*v*(v*(6*v-15)+10),k=Math.min(1,16*v*v*(1-v)*(1-v));o.taper!=null&&o.taper;const y=.36*(o.tail!=null?o.tail:1),C=o.width!=null?o.width:1;{const p=t.createLinearGradient(I[0][0],I[0][1],I[x][0],I[x][1]);p.addColorStop(0,i(.46,0)),p.addColorStop(.3,i(.46,.03*w)),p.addColorStop(.8,i(.46,.045*w)),p.addColorStop(1,i(.46,0)),t.globalAlpha=1,t.strokeStyle=p,t.lineWidth=9*n,t.shadowColor=u(.6),t.shadowBlur=A*2,t.beginPath(),I.forEach(([R,E],O)=>O?t.lineTo(R,E):t.moveTo(R,E)),t.stroke(),t.shadowBlur=0}const F=40,G=Math.max(0,b-y*(1-f)),T=[];for(let p=0;p<=F;p++)T.push(_(G+(b-G)*(p/F)));const W=()=>{t.beginPath(),T.forEach(([p,R],E)=>E?t.lineTo(p,R):t.moveTo(p,R)),t.stroke()},q=()=>{const p=t.createLinearGradient(T[0][0],T[0][1],T[F][0],T[F][1]);return p.addColorStop(0,i(.55,0)),p.addColorStop(.4,i(.56,0)),p.addColorStop(.68,i(.6,.09)),p.addColorStop(.88,i(.64,.24)),p.addColorStop(1,i(.68,.44)),p},X=1+.5*k;t.globalAlpha=w,t.strokeStyle=q(),t.lineWidth=(20+10*k)*n*C,t.shadowColor=u(.72),t.shadowBlur=A*2.2,W(),t.strokeStyle=q(),t.lineWidth=(10+5*k)*n*C,t.shadowBlur=A*1,W(),t.shadowBlur=0;for(let p=1;p<=F;p++){const R=p/F;t.globalAlpha=Math.pow(R,2.2)*.95*w,t.strokeStyle=u(.55+.38*R),t.lineWidth=(1.6+6.5*Math.pow(R,.7))*n*C*X,t.beginPath(),t.moveTo(T[p-1][0],T[p-1][1]),t.lineTo(T[p][0],T[p][1]),t.stroke()}const S=T[F][0],L=T[F][1];t.globalAlpha=.8*w,t.fillStyle=u(.6),t.shadowColor=u(.8),t.shadowBlur=A*1.6,t.beginPath(),t.arc(S,L,(9+5*k)*n*C,0,Math.PI*2),t.fill(),t.globalAlpha=w,t.fillStyle=u(.93),t.shadowBlur=A*.6,t.beginPath(),t.arc(S,L,(3.4+1.8*k)*n*C,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function ho(t,a,o,d,r,l,e){const c=o.r!=null?o.r:.3,u=o.dir!=null?o.dir:1,A=(o.sweep!=null?o.sweep:.66)*Math.PI*2,h=e??r*(o.tempo!=null?o.tempo:.5)%1,m=-Math.PI/2+u*h*Math.PI*2,s=16,n=[];for(let i=0;i<=s;i++){const M=m-u*(1-i/s)*A;n.push([.5+Math.cos(M)*c,.5+Math.sin(M)*c])}Wt(t,a,a,n,r,l,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}function po(t,a,o,d,r,l,e={}){const c=Math.max(2,Math.round(e.count??7)),u=e.r??4.4,A=e.flow??.35,h=e.hair??.26,m=e.style||"chain",s=e.color||"255,246,234",n=e.inset??.12,i=e.alpha??1,M=d-a,B=r-o,D=Math.hypot(M,B);if(D<.001||i<=.004)return;const x=M/D,I=B/D,_=a+M*n,P=o+B*n,v=D*(1-n*2);if(v<=0)return;t.save(),m==="chain"&&h>0&&(t.strokeStyle=`rgba(${s},${(h*i).toFixed(3)})`,t.lineWidth=Math.max(1,u*.34),t.beginPath(),t.moveTo(_,P),t.lineTo(_+x*v,P+I*v),t.stroke());const w=l*A%1;for(let f=0;f<c;f++){let b=(f+.5)/c;if(m==="pulse"||m==="dots"||m==="chain"){const T=b-.5;if(b=.5+T+Math.sign(T)*(w/c%(1/c)),b<0||b>1)continue}const k=_+x*v*b,y=P+I*v*b,C=Math.abs(b-.5)*2;let F=u,G=i;if(m==="taper"&&(F=u*(.55+.75*C)),m==="pulse"){const T=((C-w)%1+1)%1;G=i*(.35+.65*Math.max(0,1-Math.abs(T-0)*3))}t.fillStyle=`rgba(${s},${(G*.96).toFixed(3)})`,t.beginPath(),t.arc(k,y,F,0,Math.PI*2),t.fill()}t.restore()}export{b0 as A,ao as C,Gt as F,m0 as G,Bt as L,Nt as M,t0 as N,K as P,Yt as Q,oo as R,Xt as S,Jt as Z,a0 as a,Ht as b,co as c,Zt as d,ho as e,no as f,uo as g,io as h,Vt as i,po as j,ro as k,jt as l,zt as m,so as n,to as o,lo as p,r0 as q,qt as r,f0 as s,$t as t,gt as u,eo as v,Kt as w,Wt as x,Qt as y,S0 as z};
