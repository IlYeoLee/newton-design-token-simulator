const G={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},g={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},c0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],At=Object.fromEntries(Object.entries({...G,...g}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),K=t=>`vec3(${c0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,Tt=(t,a=1)=>`rgba(${c0(t).join(",")},${a})`,h0=[[G.red,0],[G.red,.3],[G.coral,.56],[G.sand,.86],[G.prism,1]],f0=1;function p0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(g).some(o=>o.toUpperCase()===a)?!0:Object.values(G).some(o=>o.toUpperCase()===a)}function Rt(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>p0(o)))&&(t.stops=h0.map(o=>[...o])),t.sat=f0,t)}const m0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",w0=.98,x0=.83,S0=-.043,C0=-.031,b0=5.5,v0=.027,I0=.25,A0=.26,T0=.3,R0=.92,M0=.038,y0=1,L0=24,P0=1,_0=.95,k0=.45,D0=.88,F0=0,B0=.5,E0=.34,G0=.1,O0=.4,U0=1,H0=1.4,q0=0,W0=3.4,K0=.01,g0=0,$0=.011,j0=-2,X0=.75,J0=-.07,Y0=.12,Q0=4,z0=.6,Z0=0,V0=1,N0="none",tt="add",at="offbit",ot=.55,et=.14,lt=.5,nt=4,st=2,rt=1,ct=.32,it=1,dt={punchLine:{node:1.58,numS:1,comet:1,tailLen:.71,rail:.6}},ut=-.095,ht=.12,ft=10,pt=-.015,mt=.12,wt=-10,xt={_:m0,imp:w0,scale:x0,offx:S0,offy:C0,irot:b0,pitch:v0,dot:I0,glow:A0,shade:T0,sharp:R0,edge:M0,plantar:y0,bands:L0,bandSoft:P0,w:_0,halo:k0,pool:D0,noise:F0,rip:B0,ripReach:E0,ripWidth:G0,ripSpeed:O0,ripGrad:U0,edgeShade:H0,shadeRed:q0,shadeRedW:W0,edgeW:K0,edgeSoft:g0,dither:$0,tilt:j0,gsize:X0,gx:J0,gy:Y0,grot:Q0,gsh:z0,shadeCol:Z0,ripCol:V0,gShadow:N0,gBlend:tt,numSrc:at,prog:ot,bloom:et,blur:lt,edgeShadeW:nt,edgeShadeCol:st,edgeShadeGrad:rt,edgeShadeG0:ct,edgeShadeG1:it,prims:dt,gxL:ut,gyL:ht,grotL:ft,gxR:pt,gyR:mt,grotR:wt};function l0(t,a,o,c,n){let l=0;o[0]=0,c[0]=-1e20,c[1]=1e20;for(let r=1;r<n;r++){let u=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);for(;u<=c[l];)l--,u=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);l++,o[l]=r,c[l]=u,c[l+1]=1e20}l=0;for(let r=0;r<n;r++){for(;c[l+1]<r;)l++;a[r]=(r-o[l])*(r-o[l])+t[o[l]]}}function n0(t,a){const o=new Float32Array(a),c=new Int32Array(a),n=new Float32Array(a+1),l=new Float32Array(a);for(let r=0;r<a;r++){for(let u=0;u<a;u++)l[u]=t[u*a+r];l0(l,o,c,n,a);for(let u=0;u<a;u++)t[u*a+r]=o[u]}for(let r=0;r<a;r++){for(let u=0;u<a;u++)l[u]=t[r*a+u];l0(l,o,c,n,a);for(let u=0;u<a;u++)t[r*a+u]=o[u]}}function i0(t,a){const c=new Float32Array(a*a),n=new Float32Array(a*a);let l=0,r=0,u=0;for(let S=0;S<a*a;S++){const d=t[S*4+3]/255;c[S]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),n[S]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(l+=S%a,r+=S/a|0,u++)}n0(c,a),n0(n,a);const f=new Float32Array(a*a);for(let S=0;S<a*a;S++)f[S]=(Math.sqrt(c[S])-Math.sqrt(n[S]))/a;return{data:f,N:a,cx:u?l/u/a:.5,cy:u?r/u/a:.5}}function Z(t,a=512){const o="_raster"+a;if(t[o])return t[o];const c=document.createElement("canvas");c.width=c.height=a;const n=c.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);n.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const r=n.getImageData(0,0,a,a).data;let u=a,f=a,S=-1,d=-1;for(let h=0;h<a;h++)for(let e=0;e<a;e++)r[(h*a+e)*4+3]>8&&(e<u&&(u=e),e>S&&(S=e),h<f&&(f=h),h>d&&(d=h));return t[o]=S<0?{canvas:c,x:0,y:0,w:a,h:a}:{canvas:c,x:u,y:f,w:S-u+1,h:d-f+1},t[o]}function Mt(t,a,o=!1){const c=Z(t,a),n=document.createElement("canvas");n.width=n.height=a;const l=n.getContext("2d"),r=Math.min(a*j/c.w,a*j/c.h),u=c.w*r,f=c.h*r;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(c.canvas,c.x,c.y,c.w,c.h,(a-u)/2,(a-f)/2,u,f),i0(l.getImageData(0,0,a,a).data,a)}function yt(t,a,o,c=!1){const n=Z(t,o),l=a?Z(a,o):null,r=Math.min(o*j/n.w,o*j/n.h),u=n.w*r,f=n.h*r,S=(o-u)/2,d=(o-f)/2,h=v=>{const P=document.createElement("canvas");P.width=P.height=o;const T=P.getContext("2d");return c&&(T.translate(0,o),T.scale(1,-1)),T.drawImage(v.canvas,n.x,n.y,n.w,n.h,S,d,u,f),i0(T.getImageData(0,0,o,o).data,o)},e=h(n),i=l?h(l):null,s=new Float32Array(o*o*2);for(let v=0;v<o*o;v++)s[v*2]=e.data[v],s[v*2+1]=i?i.data[v]:1;return{data:s,N:o,cx:e.cx,cy:e.cy,inCx:i?i.cx:e.cx,inCy:i?i.cy:e.cy,hasInner:!!i}}const Lt=1.9922,St=.78,j=.52,Pt=St/j,_t=1.18,U=xt||{},d0={size:U.gsize??.85,gx:U.gx??-.025,gy:U.gy??.195,rot:U.grot??6,gxL:U.gxL,gyL:U.gyL,rotL:U.grotL,gxR:U.gxR,gyR:U.gyR,rotR:U.grotR,shadow:U.gShadow??"glow",shadowK:U.gsh??.75,blend:U.gBlend??"add"};function kt(t,a=d0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function Dt(t,a,o,c,n=d0){const l=Math.round(o*.75),r=n.shadow==="none"?0:n.shadowK??.75,u=f=>c(t,String(a),o/2,o/2,l,f);return n.shadow==="drop"&&r>.001?(t.save(),t.globalAlpha=Math.min(1,r*.7),t.translate(o*.018,o*.024),u({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),u({glow:0,glowColor:"rgba(0,0,0,0)"})):u(n.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),n.blend==="knock"}function Ft(t,a){const o=t.getImageData(0,0,a,a),c=t.createImageData(a,a);for(let n=0;n<a*a;n++){const l=o.data[n*4+3]/255,r=Math.round(255*(1-l));c.data[n*4]=c.data[n*4+1]=c.data[n*4+2]=r,c.data[n*4+3]=255}t.putImageData(c,0,0)}const Bt={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},Q=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),z=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function s0(t,a,o){t=Q(t),a=Q(a),o=Q(o);const c=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),n=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*c+.793617785*n-.0040720468*l,1.9779984951*c-2.428592205*n+.4505937099*l,.0259040371*c+.7827717662*n-.808675766*l]}function Ct(t,a,o){const c=(t+.3963377774*a+.2158037573*o)**3,n=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[z(4.0767416621*c-3.3077115913*n+.2309699292*l),z(-1.2684380046*c+2.6097574011*n-.3413193965*l),z(-.0041960863*c-.7034186147*n+1.707614701*l)]}const r0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function Et(t,a=1,o=new Uint8Array(256*4)){const c=[...t].sort((n,l)=>n[1]-l[1]);for(let n=0;n<256;n++){const l=n/255;let r=0;for(;r<c.length-2&&l>c[r+1][1];)r++;const[u,f]=c[r],[S,d]=c[r+1],h=Math.max(0,Math.min(1,(l-f)/Math.max(1e-5,d-f))),e=s0(...r0(u)),i=s0(...r0(S)),s=Ct(e[0]+(i[0]-e[0])*h,(e[1]+(i[1]-e[1])*h)*a,(e[2]+(i[2]-e[2])*h)*a);o.set([...s,255],n*4)}return o}const Gt=`
...
#define C_GRAYF ${K(g.hi)}
#define C_GRAYL ${K(g.lo)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function bt(t,a,o,c){t.lineWidth=4*a;const n=c.arrow;n.line==="dash"?t.setLineDash([12*a*n.gap,10*n.gap]):n.line==="dot"?(t.setLineDash([.5,12*n.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&n.line!=="solid"&&n.line!=="taper"&&(t.lineDashOffset=-o*40*n.speed)}function qt(t,a,o,c,n,l={}){const r=n.lut,u=n.arrow||{},f=u.w??1,S=u.speed??1,d=u.glow??1,h=l.pulse??1,e=o/256,i=e*(l.scale??1),s=a/2,v=c*.9*S%1,P=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,v/.55),T=l.prog!=null?1:v>.88?(1-v)/.12:1;t.clearRect(0,0,a,o);const w=T*(.45+.55*h),M=o-24*e,_=58*e,y=M+(_-M)*P,x=(R,D)=>r(R).replace("rgb(","rgba(").replace(")",`,${D.toFixed(3)})`),p=1.1*i*f,m=13*i*f,C=42*i*(.7+.3*f),k=!l.noTip&&P>.28?Math.min(1,(P-.28)/.22)*C*.42:0,I=y+k,b=t.createLinearGradient(0,M,0,I);if(b.addColorStop(0,x(.55,0)),b.addColorStop(.18,x(.64,.3*w)),b.addColorStop(.4,x(.76,.8*w)),b.addColorStop(.65,x(.88,.98*w)),b.addColorStop(1,x(.97,w)),t.save(),t.filter=`blur(${7*i}px)`,t.globalAlpha=.55,t.fillStyle=b,t.beginPath(),t.moveTo(s-p,M),t.lineTo(s+p,M),t.lineTo(s+m*.95,I),t.lineTo(s-m*.95,I),t.closePath(),t.fill(),t.restore(),t.globalAlpha=1,t.fillStyle=b,t.beginPath(),t.moveTo(s-p/2,M),t.lineTo(s+p/2,M),t.lineTo(s+m/2,I),t.lineTo(s-m/2,I),t.closePath(),t.fill(),t.globalAlpha=w,P>.28&&!l.noTip){const R=C,D=Math.min(1,(P-.28)/.22)*w,L=y+R*.3;t.globalAlpha=D;const B={color:r(.95),glowColor:r(.85),glow:12*d};n.glyph&&(n.glyph(t,"LIFT_TIP",s,L,R,B)||n.glyph(t,"TIP_TRI",s,L,R*.93,B))||(t.strokeStyle=r(.95),t.lineWidth=13*i*f,t.lineCap="round",t.lineJoin="round",t.shadowColor=r(.9),t.shadowBlur=18*i*d,t.beginPath(),t.moveTo(s-26*i,L+14*i),t.lineTo(s,L-16*i),t.lineTo(s+26*i,L+14*i),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function vt(t,a,o,c,n,l,r={}){const u=l.lut,f=l.arrow||{},S=f.w??1,d=f.glow??1,h=o/256*(r.scale??1);t.clearRect(0,0,a,o);const e=c.map(([x,p])=>[x*a,p*o]);if(e.length<2)return;const i=48,s=[],v=x=>{if(e.length===2)return[e[0][0]+(e[1][0]-e[0][0])*x,e[0][1]+(e[1][1]-e[0][1])*x];const p=x*(e.length-1),m=Math.min(e.length-2,Math.floor(p)),C=p-m,k=e[Math.max(0,m-1)],I=e[m],b=e[m+1],R=e[Math.min(e.length-1,m+2)],D=(L,B,E,q)=>.5*(2*B+(-L+E)*C+(2*L-5*B+4*E-q)*C*C+(-L+3*B-3*E+q)*C*C*C);return[D(k[0],I[0],b[0],R[0]),D(k[1],I[1],b[1],R[1])]};for(let x=0;x<=i;x++)s.push(v(x/i));const P=Math.max(0,Math.min(1,r.prog!=null?r.prog:n*.55%1)),T=Math.max(1,Math.round(i*P)),w=r.alpha??1,M=r.tail??.22;t.lineCap="round";const _=42*h*(.7+.3*S);let y=T;if(P>.28){let x=0;const p=_*.42*Math.min(1,(P-.28)/.22);for(;y>1&&x<p;)x+=Math.hypot(s[y][0]-s[y-1][0],s[y][1]-s[y-1][1]),y--}for(const x of[0,1])for(let p=1;p<=y;p++){const m=p/T,C=Math.min(1,m/M),k=C*C*(3-2*C)*w;t.globalAlpha=x?k:k*.16*m,t.strokeStyle=u(.55+.42*m),t.lineWidth=(1.1+11.9*m)*h*S*(x?1:1.9),t.beginPath(),t.moveTo(s[p-1][0],s[p-1][1]),t.lineTo(s[p][0],s[p][1]),t.stroke()}if(P>.28){const x=s[Math.max(0,T-2)][0],p=s[Math.max(0,T-2)][1],m=Math.atan2(s[T][1]-p,s[T][0]-x)+Math.PI/2,C=s[T][0]-Math.sin(m)*_*.3,k=s[T][1]+Math.cos(m)*_*.3;t.save(),t.translate(C,k),t.rotate(m),t.globalAlpha=Math.min(1,(P-.28)/.22)*w;const I={color:u(.95),glowColor:u(.85),glow:12*d};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,_,I)||l.glyph(t,"TIP_TRI",0,0,_*.93,I))||(t.strokeStyle=u(.95),t.lineWidth=9*h*S,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*h,12*h),t.lineTo(0,-14*h),t.lineTo(18*h,12*h),t.stroke()),t.restore()}t.globalAlpha=1}function It(t,a,o,c,n,l){n=n||{};const r=l.lut,u=n.style||l.arrow.line,f=!!n.closed,S=[0];for(let i=1;i<a.length;i++)S.push(S[i-1]+Math.hypot(a[i][0]-a[i-1][0],a[i][1]-a[i-1][1]));const d=S[S.length-1]||1,h=i=>{i=(i%d+d)%d;let s=1;for(;s<S.length-1&&S[s]<i;)s++;const v=(i-S[s-1])/Math.max(1e-4,S[s]-S[s-1]);return[a[s-1][0]+(a[s][0]-a[s-1][0])*v,a[s-1][1]+(a[s][1]-a[s-1][1])*v,Math.atan2(a[s][1]-a[s-1][1],a[s][0]-a[s-1][0])]},e=l.arrow;if(u==="chevron"){const i=(26*c+8)*e.gap,s=Math.max(2,Math.floor(d/i));t.shadowColor=r(Math.min(1,e.heat+.2)),t.shadowBlur=8*c*e.glow;for(let v=0;v<s;v++){const P=v*i+o*42*e.speed%i;if(!f&&P>d-4)continue;const[T,w,M]=h(P),_=7.5*c,y=8.5*c,x=.45+.4*Math.sin(P/d*6.283-o*2.2*e.speed);t.strokeStyle=r(e.heat-.05+x*.3),t.lineWidth=3.2*c,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(T,w),t.rotate(M),t.beginPath(),t.moveTo(-y*.5,-_),t.lineTo(y*.5,0),t.lineTo(-y*.5,_),t.stroke(),t.restore()}return!0}if(u==="comet"){const i=o*.35*e.speed%1*d,s=d*e.tail,v=Math.max(24,a.length*2);t.lineCap="round";for(let w=0;w<v;w++){const M=i-w/v*s,_=i-(w+1)/v*s;if(!f&&_<0)break;const y=1-w/v,[x,p]=h(M),[m,C]=h(_);!f&&Math.hypot(m-x,C-p)>d*.4||(t.globalAlpha=Math.pow(y,1.6),t.strokeStyle=r(Math.max(.05,e.heat-.2)+y*.55),t.lineWidth=(1.5+y*4.5)*c,y>.72?(t.shadowColor=r(Math.min(1,e.heat+.3)),t.shadowBlur=y*12*c*e.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(x,p),t.lineTo(m,C),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[P,T]=h(i);return t.fillStyle=rgba(g.ink,.95),t.shadowColor=r(.9),t.shadowBlur=16*c,t.beginPath(),t.arc(P,T,2.6*c,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=n.color||r(e.heat),t.shadowColor=r(Math.min(1,e.heat+.15)),t.shadowBlur=(n.glow??8)*c*e.glow,u==="taper")for(let i=1;i<a.length;i++)t.lineWidth=(.5+i/a.length*4.5)*c,t.beginPath(),t.moveTo(a[i-1][0],a[i-1][1]),t.lineTo(a[i][0],a[i][1]),t.stroke();else bt(t,c,o,l),t.beginPath(),a.forEach(([i,s],v)=>v?t.lineTo(i,s):t.moveTo(i,s)),f&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function Wt(t,a,o,c,n,l){const r=13*c.halo,u=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const f=a/220,S=a/2,d=18*o.round*f,h=40*f,e=48*f,i=a-80*f,s=a-96*f,v=[],P=(w,M,_,y)=>{for(let x=0;x<=1;x+=.12)v.push([w+(_-w)*x,M+(y-M)*x])};P(h+d,e,h+i-d,e),P(h+i,e+d,h+i,e+s-d),P(h+i-d,e+s,h+d,e+s),P(h,e+s-d,h,e+d),t.shadowColor=u(.6),t.shadowBlur=r*.8;const T=4*l.arrow.w*f;if(l.arrow.line==="solid"?(t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-n*22*f,t.strokeStyle=u(.45),t.lineWidth=T,t.beginPath(),t.roundRect(h,e,i,s,d),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):It(t,v,n,l.arrow.w*f,{color:u(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const w=[],M=(b,R,D,L,B)=>{for(let E=1;E<=B;E++)w.push([b+(D-b)*E/B,R+(L-R)*E/B])},_=(b,R,D,L,B)=>{for(let E=1;E<=B;E++){const q=D+(L-D)*E/B;w.push([b+d*Math.cos(q),R+d*Math.sin(q)])}},y=Math.PI/2,x=h+i,p=e+s,m=h+i/2;w.push([m,e]),M(m,e,x-d,e,8),_(x-d,e+d,-y,0,6),M(x,e+d,x,p-d,10),_(x-d,p-d,0,y,6),M(x-d,p,h+d,p,14),_(h+d,p-d,y,Math.PI,6),M(h,p-d,h,e+d,10),_(h+d,e+d,Math.PI,Math.PI+y,6),M(h+d,e,m,e,8);let C=0;for(let b=1;b<w.length;b++)C+=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);const k=C*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-(i/2-d)-n*22*f,t.strokeStyle=u(.9),t.lineWidth=T*1.3,t.lineCap="round",t.shadowColor=u(.92),t.shadowBlur=r*1.3,t.beginPath(),t.moveTo(w[0][0],w[0][1]);let I=0;for(let b=1;b<w.length&&I<k;b++){const R=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);if(I+R<=k)t.lineTo(w[b][0],w[b][1]),I+=R;else{const D=(k-I)/R;t.lineTo(w[b-1][0]+(w[b][0]-w[b-1][0])*D,w[b-1][1]+(w[b][1]-w[b-1][1])*D),I=k}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&l.foot&&(l.foot(t,!1,S-16*o.feet*f,S+6*f,26*o.feet*f),l.foot(t,!0,S+16*o.feet*f,S+6*f,26*o.feet*f)),t.shadowBlur=0}function Kt(t,a,o,c,n,l,r,u){const f=13*c.halo,S=4*l.arrow.w*(a/220),d=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const h=a/220,e=r||[[45*h,130*h],[110*h,60*h],[175*h,110*h]],i=u??n*.5%1,s=Math.min(1,i*1.25)*(e.length-1),v=Math.min(e.length-1,Math.floor(s+.35));t.shadowColor=d(.7),t.shadowBlur=f;const P=p=>{const m=Math.max(0,Math.min(e.length-2,Math.floor(p))),C=p-m;return[e[m][0]+(e[m+1][0]-e[m][0])*C,e[m][1]+(e[m+1][1]-e[m][1])*C]},T=o.comet!=null?o.comet:1,w=o.tailLen!=null?o.tailLen:.5;if(t.save(),t.shadowBlur=0,t.globalAlpha=o.rail!=null?o.rail:.22,t.strokeStyle=d(.6),t.lineWidth=2.2*h,t.lineCap="round",t.setLineDash([.01,8*h]),t.beginPath(),e.forEach(([p,m],C)=>C?t.lineTo(p,m):t.moveTo(p,m)),t.stroke(),t.setLineDash([]),t.restore(),s>.02){const p=(m,C)=>d(m).replace("rgb(","rgba(").replace(")",`,${C.toFixed(3)})`);for(let m=0;m<26;m++){const C=m/25,k=s-w*C;if(k<=0)break;const I=P(k),b=4.7*h*T*(1-C*.75),R=b*2.1,D=(1-C)*(1-C)*.8,L=t.createRadialGradient(I[0],I[1],0,I[0],I[1],R);L.addColorStop(0,p(.55-.18*C,D)),L.addColorStop(.5,p(.5-.18*C,D*.35)),L.addColorStop(1,p(.45-.18*C,0)),t.save(),t.shadowBlur=0,t.globalAlpha=1,t.fillStyle=L,t.beginPath(),t.arc(I[0],I[1],R,0,Math.PI*2),t.fill(),t.restore()}if(s<e.length-1-.001&&s-Math.floor(s)>.03){const m=P(s);t.save(),t.fillStyle=d(.62),t.shadowColor=d(.8),t.shadowBlur=11*h*T,t.beginPath(),t.arc(m[0],m[1],5.6*h*T,0,Math.PI*2),t.fill(),t.fillStyle=d(.95),t.globalAlpha=.95,t.beginPath(),t.arc(m[0],m[1],2.1*h*T,0,Math.PI*2),t.fill(),t.restore()}}t.globalAlpha=1,t.lineCap="butt";const M=o.done!=null,_=o.done||0,y=o.vd||[],x=o.acc!=null?o.acc:e.length-1;if(e.forEach(([p,m],C)=>{const k=C<_,I=y[C]||null,b=!k&&C===v&&!M,R=b?1+Math.sin(n*6)*.14:1,D=o.pop!=null&&C===_-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,L=12*o.node*R*D*h*(C===x?1.34:1);k&&I!=="miss"&&(t.shadowBlur=f*1.4,t.shadowColor=d(.5),t.fillStyle=d(I==="near"?.5:.36),t.beginPath(),t.arc(p,m,L*.88,0,Math.PI*2),t.fill()),k||(t.save(),t.translate(p,m),u0(t,d,L,b?.8:.5,b?.9:.5,S*.9,f),t.restore()),t.strokeStyle=I==="hit"?G.prism:I==="near"?G.sand:I==="miss"?g.lo:d(k?.62:b?.8:.45),t.lineWidth=S*(b?1.3:I?1.15:.9),t.shadowBlur=b?f*1.6:I&&I!=="miss"?f*1.3:f*.6,I&&I!=="miss"&&(t.shadowColor=I==="hit"?G.prism:G.sand),t.beginPath(),t.arc(p,m,L,0,Math.PI*2),t.stroke(),l.num&&(k&&I!=="miss"?(t.save(),t.globalCompositeOperation="destination-out",t.shadowBlur=0,l.num(t,String(C+1),p,m,16*o.numS*R*h,Math.round(14*o.numS*h)),t.restore()):(t.globalAlpha=C<=v?1:.6,l.num(t,String(C+1),p,m,16*o.numS*R*h,Math.round(14*o.numS*h)),t.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&_>0&&e[_-1]){const[p,m]=e[_-1],C=1-o.pop/.38,k=C*C,I=12*o.node*h*(_-1===(o.acc!=null?o.acc:e.length-1)?1.34:1);t.save();const b=I*(1.6+1.9*(1-C)),R=t.createRadialGradient(p,m,0,p,m,b);R.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*k).toFixed(3)})`),R.addColorStop(.35,d(.92).replace("rgb(","rgba(").replace(")",`,${(.8*k).toFixed(3)})`)),R.addColorStop(1,d(.7).replace("rgb(","rgba(").replace(")",",0)")),t.fillStyle=R,t.beginPath(),t.arc(p,m,b,0,Math.PI*2),t.fill(),t.strokeStyle=d(.92),t.globalAlpha=k,t.lineWidth=Math.max(1,6*h*C),t.shadowColor=d(.85),t.shadowBlur=24*h*k,t.beginPath(),t.arc(p,m,I*(1.1+3.4*(1-C)),0,Math.PI*2),t.stroke();const D=Math.max(0,C-.35)/.65;D>0&&(t.globalAlpha=D*D*.6,t.lineWidth=Math.max(1,3.5*h*D),t.beginPath(),t.arc(p,m,I*(1.1+2*(1-D)),0,Math.PI*2),t.stroke()),t.restore()}t.shadowBlur=0}function u0(t,a,o,c,n,l,r,u=1){if(o<=.6)return;const f=(i,s)=>a(i).replace("rgb(","rgba(").replace(")",`,${s})`),S=l*2.6*u,d=Math.max(.1,o-S),h=o+S,e=t.createRadialGradient(0,0,d,0,0,h);e.addColorStop(0,f(c-.05,0)),e.addColorStop(.5,f(c,n*.85)),e.addColorStop(1,f(c-.05,0)),t.globalAlpha=1,t.fillStyle=e,t.shadowBlur=0,t.beginPath(),t.arc(0,0,h,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,n*1.1),t.lineWidth=l*.85,t.strokeStyle=a(Math.min(.98,c+.12)),t.shadowColor=a(.88),t.shadowBlur=r*.6,t.beginPath(),t.arc(0,0,o,0,Math.PI*2),t.stroke(),t.shadowBlur=0}function gt(t,a,o,c,n,l,r){const u=l.lut,f=13*c.halo,S=a/220,d=a/2,h=l.arrow&&l.arrow.w||1,e=(x,p)=>u(x).replace("rgb(","rgba(").replace(")",`,${p})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const i=(o.r!=null?o.r:.42)*a,s=i*(o.rt!=null?o.rt:.36),v=3.4*h*S,P=r!=null?Math.max(0,Math.min(1,r)):n*(o.tempo||.6)%1,T=Math.pow(P,1.6),w=Math.max(0,(P-.9)/.1);t.save(),t.translate(d,d);const M=(x,p,m,C=1)=>u0(t,u,x,p,m,v,f,C),_=t.createRadialGradient(0,0,0,0,0,s*1.08);_.addColorStop(0,e(.6,.1+.18*w)),_.addColorStop(.65,e(.5,.05+.08*w)),_.addColorStop(1,e(.5,0)),t.globalAlpha=1,t.fillStyle=_,t.beginPath(),t.arc(0,0,s*1.08,0,Math.PI*2),t.fill();const y=1+.02*Math.sin(n*2.6);M(s*y,.55+.4*w,.5+.45*w,.9);for(let x=2;x>=0;x--){const p=Math.pow(Math.max(0,P-x*.05),1.6),m=i-(i-s)*p,C=x===0?.6+.4*T:.18/x*(1-w);M(m,.55+.4*T,C*(1-w*.45),1.15-.35*T)}w>.01&&M(s*(1+1.4*w),.9,(1-w)*.8,1.1),t.globalAlpha=.6+.3*w,t.shadowColor=u(.85),t.shadowBlur=f*(.9+w),t.fillStyle=u(.62+.3*w),t.beginPath(),t.arc(0,0,v*.85+3*S*w,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function $t(t,a,o,c,n,l,r,u){const f=l.lut,S=13*c.halo,d=a/220,h=a/2,e=l.arrow&&l.arrow.w||1,i=e*d,s=(A,F)=>f(A).replace("rgb(","rgba(").replace(")",","+F+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const v=a*.42*(o.spread!=null?o.spread:1),T=(u||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([A,F])=>[h+A*v,h+F*v]),w=80,M=[];for(let A=0;A<=w;A++){const F=A/w*(T.length-1),O=Math.min(T.length-2,Math.floor(F)),H=F-O,W=T[Math.max(0,O-1)],$=T[O],t0=T[O+1],a0=T[Math.min(T.length-1,O+2)],o0=(X,J,Y,e0)=>.5*(2*J+(-X+Y)*H+(2*X-5*J+4*Y-e0)*H*H+(-X+3*J-3*Y+e0)*H*H*H);M.push([o0(W[0],$[0],t0[0],a0[0]),o0(W[1],$[1],t0[1],a0[1])])}const _=A=>{const F=Math.max(0,Math.min(w,A*w)),O=Math.floor(F),H=F-O,W=M[O],$=M[Math.min(w,O+1)];return[W[0]+($[0]-W[0])*H,W[1]+($[1]-W[1])*H]},y=.68;let x,p,m;if(r!=null)x=Math.max(0,Math.min(1,r)),p=1,m=0;else{const A=n*(o.tempo||.42)%1;if(A<y)x=A/y,p=1,m=0;else{const F=(A-y)/(1-y);x=1,p=1-F*F,m=F}}if(p<=.012)return;const C=x*x*x*(x*(6*x-15)+10),k=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const I=.36*(o.tail!=null?o.tail:1),b=o.width!=null?o.width:1;{const A=t.createLinearGradient(M[0][0],M[0][1],M[w][0],M[w][1]);A.addColorStop(0,s(.46,0)),A.addColorStop(.3,s(.46,.03*p)),A.addColorStop(.8,s(.46,.045*p)),A.addColorStop(1,s(.46,0)),t.globalAlpha=1,t.strokeStyle=A,t.lineWidth=9*i,t.shadowColor=f(.6),t.shadowBlur=S*2,t.beginPath(),M.forEach(([F,O],H)=>H?t.lineTo(F,O):t.moveTo(F,O)),t.stroke(),t.shadowBlur=0}const R=40,D=Math.max(0,C-I*(1-m)),L=[];for(let A=0;A<=R;A++)L.push(_(D+(C-D)*(A/R)));const B=()=>{t.beginPath(),L.forEach(([A,F],O)=>O?t.lineTo(A,F):t.moveTo(A,F)),t.stroke()},E=()=>{const A=t.createLinearGradient(L[0][0],L[0][1],L[R][0],L[R][1]);return A.addColorStop(0,s(.55,0)),A.addColorStop(.4,s(.56,0)),A.addColorStop(.68,s(.6,.09)),A.addColorStop(.88,s(.64,.24)),A.addColorStop(1,s(.68,.44)),A},q=1+.5*k;t.globalAlpha=p,t.strokeStyle=E(),t.lineWidth=(20+10*k)*i*b,t.shadowColor=f(.72),t.shadowBlur=S*2.2,B(),t.strokeStyle=E(),t.lineWidth=(10+5*k)*i*b,t.shadowBlur=S*1,B(),t.shadowBlur=0;for(let A=1;A<=R;A++){const F=A/R;t.globalAlpha=Math.pow(F,2.2)*.95*p,t.strokeStyle=f(.55+.38*F),t.lineWidth=(1.6+6.5*Math.pow(F,.7))*i*b*q,t.beginPath(),t.moveTo(L[A-1][0],L[A-1][1]),t.lineTo(L[A][0],L[A][1]),t.stroke()}const V=L[R][0],N=L[R][1];t.globalAlpha=.8*p,t.fillStyle=f(.6),t.shadowColor=f(.8),t.shadowBlur=S*1.6,t.beginPath(),t.arc(V,N,(9+5*k)*i*b,0,Math.PI*2),t.fill(),t.globalAlpha=p,t.fillStyle=f(.93),t.shadowBlur=S*.6,t.beginPath(),t.arc(V,N,(3.4+1.8*k)*i*b,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function jt(t,a,o,c,n,l,r){const u=o.r!=null?o.r:.3,f=o.dir!=null?o.dir:1,S=(o.sweep!=null?o.sweep:.66)*Math.PI*2,d=r??n*(o.tempo!=null?o.tempo:.5)%1,h=-Math.PI/2+f*d*Math.PI*2,e=16,i=[];for(let s=0;s<=e;s++){const v=h-f*(1-s/e)*S;i.push([.5+Math.cos(v)*u,.5+Math.sin(v)*u])}vt(t,a,a,i,n,l,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}export{Ot as C,d0 as G,xt as L,Bt as M,g as N,G as P,Pt as Q,Gt as R,Lt as S,_t as Z,j as a,St as b,gt as c,Dt as d,jt as e,qt as f,$t as g,Kt as h,Ft as i,yt as j,Mt as k,Wt as l,Et as m,Ht as n,Z as o,It as p,At as q,vt as r,i0 as s,kt as t,Tt as u,Rt as v,Ut as w,h0 as x,f0 as y};
