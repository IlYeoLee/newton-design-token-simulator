import{L as w,q as ne,a as je,b as Ke,n as $t,Q as ct,M as dt,Z as Jt,u as ue,P as He,N as ze,f as ei}from"./fx-core-CvIaicgI.js";import{aF as ti,V as P,aq as Se,aG as we,a9 as pt,aH as ft,a5 as M,aI as ii,aj as ai,Q as At,M as k,O as si,a1 as We,a2 as mt,i as q,aJ as Ge,av as De,ax as Oe,aK as oi,aB as ri,x as ce,A as pe,a as de,aL as ni,w as li,aM as hi,aN as ui,aO as ci,aP as di,aQ as pi,aR as fi,aS as mi,aT as gi,W as vi,aU as _i,S as wi,aV as xi,J as bi,aW as Si,X as gt,P as K,ad as Ce,aC as vt,z as j,ah as _t,au as wt,aX as Pi,Z as xt,aY as yi,ai as bt,q as Ti,C as X,R as le,c as Q,F as y,b as tt,aZ as Mi,j as ke,l as Dt,_ as St,a_ as Pt,a$ as Fi,N as it,f as Ci,g as Ot,G as se,al as Ri,ak as Ei}from"./fxlut-DZ58rvCH.js";const yt={type:"change"},at={type:"start"},kt={type:"end"},Le=new ii,Tt=new ai,Li=Math.cos(70*At.DEG2RAD),A=new P,W=2*Math.PI,T={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Qe=1e-6;class Ai extends ti{constructor(e,t=null){super(e,t),this.state=T.NONE,this.target=new P,this.cursor=new P,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Se.ROTATE,MIDDLE:Se.DOLLY,RIGHT:Se.PAN},this.touches={ONE:we.ROTATE,TWO:we.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new P,this._lastQuaternion=new pt,this._lastTargetPosition=new P,this._quat=new pt().setFromUnitVectors(e.up,new P(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new ft,this._sphericalDelta=new ft,this._scale=1,this._panOffset=new P,this._rotateStart=new M,this._rotateEnd=new M,this._rotateDelta=new M,this._panStart=new M,this._panEnd=new M,this._panDelta=new M,this._dollyStart=new M,this._dollyEnd=new M,this._dollyDelta=new M,this._dollyDirection=new P,this._mouse=new M,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Oi.bind(this),this._onPointerDown=Di.bind(this),this._onPointerUp=ki.bind(this),this._onContextMenu=Gi.bind(this),this._onMouseWheel=Ui.bind(this),this._onKeyDown=Hi.bind(this),this._onTouchStart=zi.bind(this),this._onTouchMove=Wi.bind(this),this._onMouseDown=Ii.bind(this),this._onMouseMove=Ni.bind(this),this._interceptControlDown=Bi.bind(this),this._interceptControlUp=ji.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(e){super.connect(e),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(yt),this.update(),this.state=T.NONE}update(e=null){const t=this.object.position;A.copy(t).sub(this.target),A.applyQuaternion(this._quat),this._spherical.setFromVector3(A),this.autoRotate&&this.state===T.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,a=this.maxAzimuthAngle;isFinite(i)&&isFinite(a)&&(i<-Math.PI?i+=W:i>Math.PI&&(i-=W),a<-Math.PI?a+=W:a>Math.PI&&(a-=W),i<=a?this._spherical.theta=Math.max(i,Math.min(a,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+a)/2?Math.max(i,this._spherical.theta):Math.min(a,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let o=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const s=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),o=s!=this._spherical.radius}if(A.setFromSpherical(this._spherical),A.applyQuaternion(this._quatInverse),t.copy(this.target).add(A),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let s=null;if(this.object.isPerspectiveCamera){const l=A.length();s=this._clampDistance(l*this._scale);const h=l-s;this.object.position.addScaledVector(this._dollyDirection,h),this.object.updateMatrixWorld(),o=!!h}else if(this.object.isOrthographicCamera){const l=new P(this._mouse.x,this._mouse.y,0);l.unproject(this.object);const h=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),o=h!==this.object.zoom;const d=new P(this._mouse.x,this._mouse.y,0);d.unproject(this.object),this.object.position.sub(d).add(l),this.object.updateMatrixWorld(),s=A.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;s!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(s).add(this.object.position):(Le.origin.copy(this.object.position),Le.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Le.direction))<Li?this.object.lookAt(this.target):(Tt.setFromNormalAndCoplanarPoint(this.object.up,this.target),Le.intersectPlane(Tt,this.target))))}else if(this.object.isOrthographicCamera){const s=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),s!==this.object.zoom&&(this.object.updateProjectionMatrix(),o=!0)}return this._scale=1,this._performCursorZoom=!1,o||this._lastPosition.distanceToSquared(this.object.position)>Qe||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Qe||this._lastTargetPosition.distanceToSquared(this.target)>Qe?(this.dispatchEvent(yt),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e!==null?W/60*this.autoRotateSpeed*e:W/60/60*this.autoRotateSpeed}_getZoomScale(e){const t=Math.abs(e*.01);return Math.pow(.95,this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){A.setFromMatrixColumn(t,0),A.multiplyScalar(-e),this._panOffset.add(A)}_panUp(e,t){this.screenSpacePanning===!0?A.setFromMatrixColumn(t,1):(A.setFromMatrixColumn(t,0),A.crossVectors(this.object.up,A)),A.multiplyScalar(e),this._panOffset.add(A)}_pan(e,t){const i=this.domElement;if(this.object.isPerspectiveCamera){const a=this.object.position;A.copy(a).sub(this.target);let o=A.length();o*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*o/i.clientHeight,this.object.matrix),this._panUp(2*t*o/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),a=e-i.left,o=t-i.top,s=i.width,l=i.height;this._mouse.x=a/s*2-1,this._mouse.y=-(o/l)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(W*this._rotateDelta.x/t.clientHeight),this._rotateUp(W*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(W*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-W*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(W*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-W*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),a=.5*(e.pageY+t.y);this._rotateStart.set(i,a)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),a=.5*(e.pageY+t.y);this._panStart.set(i,a)}}_handleTouchStartDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,a=e.pageY-t.y,o=Math.sqrt(i*i+a*a);this._dollyStart.set(0,o)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{const i=this._getSecondPointerPosition(e),a=.5*(e.pageX+i.x),o=.5*(e.pageY+i.y);this._rotateEnd.set(a,o)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const t=this.domElement;this._rotateLeft(W*this._rotateDelta.x/t.clientHeight),this._rotateUp(W*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{const t=this._getSecondPointerPosition(e),i=.5*(e.pageX+t.x),a=.5*(e.pageY+t.y);this._panEnd.set(i,a)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){const t=this._getSecondPointerPosition(e),i=e.pageX-t.x,a=e.pageY-t.y,o=Math.sqrt(i*i+a*a);this._dollyEnd.set(0,o),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const s=(e.pageX+t.x)*.5,l=(e.pageY+t.y)*.5;this._updateZoomParameters(s,l)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new M,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){const t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){const t=e.deltaMode,i={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function Di(r){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(r.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(r)&&(this._addPointer(r),r.pointerType==="touch"?this._onTouchStart(r):this._onMouseDown(r)))}function Oi(r){this.enabled!==!1&&(r.pointerType==="touch"?this._onTouchMove(r):this._onMouseMove(r))}function ki(r){switch(this._removePointer(r),this._pointers.length){case 0:this.domElement.releasePointerCapture(r.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(kt),this.state=T.NONE;break;case 1:const e=this._pointers[0],t=this._pointerPositions[e];this._onTouchStart({pointerId:e,pageX:t.x,pageY:t.y});break}}function Ii(r){let e;switch(r.button){case 0:e=this.mouseButtons.LEFT;break;case 1:e=this.mouseButtons.MIDDLE;break;case 2:e=this.mouseButtons.RIGHT;break;default:e=-1}switch(e){case Se.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(r),this.state=T.DOLLY;break;case Se.ROTATE:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=T.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=T.ROTATE}break;case Se.PAN:if(r.ctrlKey||r.metaKey||r.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(r),this.state=T.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(r),this.state=T.PAN}break;default:this.state=T.NONE}this.state!==T.NONE&&this.dispatchEvent(at)}function Ni(r){switch(this.state){case T.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(r);break;case T.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(r);break;case T.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(r);break}}function Ui(r){this.enabled===!1||this.enableZoom===!1||this.state!==T.NONE||(r.preventDefault(),this.dispatchEvent(at),this._handleMouseWheel(this._customWheelEvent(r)),this.dispatchEvent(kt))}function Hi(r){this.enabled!==!1&&this._handleKeyDown(r)}function zi(r){switch(this._trackPointer(r),this._pointers.length){case 1:switch(this.touches.ONE){case we.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(r),this.state=T.TOUCH_ROTATE;break;case we.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(r),this.state=T.TOUCH_PAN;break;default:this.state=T.NONE}break;case 2:switch(this.touches.TWO){case we.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(r),this.state=T.TOUCH_DOLLY_PAN;break;case we.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(r),this.state=T.TOUCH_DOLLY_ROTATE;break;default:this.state=T.NONE}break;default:this.state=T.NONE}this.state!==T.NONE&&this.dispatchEvent(at)}function Wi(r){switch(this._trackPointer(r),this.state){case T.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(r),this.update();break;case T.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(r),this.update();break;case T.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(r),this.update();break;case T.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(r),this.update();break;default:this.state=T.NONE}}function Gi(r){this.enabled!==!1&&r.preventDefault()}function Bi(r){r.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function ji(r){r.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const Ie={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class ye{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const Ki=new si(-1,1,1,-1,0,1);class Xi extends We{constructor(){super(),this.setAttribute("position",new mt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new mt([0,2,0,0,2,0],2))}}const Vi=new Xi;class st{constructor(e){this._mesh=new k(Vi,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Ki)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class Ne extends ye{constructor(e,t="tDiffuse"){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof q?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ge.clone(e.uniforms),this.material=new q({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new st(this.material)}render(e,t,i){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=i.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}}class Mt extends ye{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,i){const a=e.getContext(),o=e.state;o.buffers.color.setMask(!1),o.buffers.depth.setMask(!1),o.buffers.color.setLocked(!0),o.buffers.depth.setLocked(!0);let s,l;this.inverse?(s=0,l=1):(s=1,l=0),o.buffers.stencil.setTest(!0),o.buffers.stencil.setOp(a.REPLACE,a.REPLACE,a.REPLACE),o.buffers.stencil.setFunc(a.ALWAYS,s,4294967295),o.buffers.stencil.setClear(l),o.buffers.stencil.setLocked(!0),e.setRenderTarget(i),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),o.buffers.color.setLocked(!1),o.buffers.depth.setLocked(!1),o.buffers.color.setMask(!0),o.buffers.depth.setMask(!0),o.buffers.stencil.setLocked(!1),o.buffers.stencil.setFunc(a.EQUAL,1,4294967295),o.buffers.stencil.setOp(a.KEEP,a.KEEP,a.KEEP),o.buffers.stencil.setLocked(!0)}}class Yi extends ye{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class Ft{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const i=e.getSize(new M);this._width=i.width,this._height=i.height,t=new De(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Oe}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Ne(Ie),this.copyPass.material.blending=oi,this.clock=new ri}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let i=!1;for(let a=0,o=this.passes.length;a<o;a++){const s=this.passes[a];if(s.enabled!==!1){if(s.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(a),s.render(this.renderer,this.writeBuffer,this.readBuffer,e,i),s.needsSwap){if(i){const l=this.renderer.getContext(),h=this.renderer.state.buffers.stencil;h.setFunc(l.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),h.setFunc(l.EQUAL,1,4294967295)}this.swapBuffers()}Mt!==void 0&&(s instanceof Mt?i=!0:s instanceof Yi&&(i=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new M);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const i=this._width*this._pixelRatio,a=this._height*this._pixelRatio;this.renderTarget1.setSize(i,a),this.renderTarget2.setSize(i,a);for(let o=0;o<this.passes.length;o++)this.passes[o].setSize(i,a)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Zi extends ye{constructor(e,t,i=null,a=null,o=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=i,this.clearColor=a,this.clearAlpha=o,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new ce}render(e,t,i){const a=e.autoClear;e.autoClear=!1;let o,s;this.overrideMaterial!==null&&(s=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(o=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:i),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(o),this.overrideMaterial!==null&&(this.scene.overrideMaterial=s),e.autoClear=a}}const Qi={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new ce(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Pe.BlurDirectionX=new M(1,0);Pe.BlurDirectionY=new M(0,1);const Ae={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
    ...
    }`},xe=-1.8;function ga(r){const e=new URLSearchParams(location.search).get("alpha")==="1",t=new vi({antialias:!0,alpha:e,premultipliedAlpha:!1});e&&t.setClearColor(0,0),t.setPixelRatio(Math.min(window.devicePixelRatio,2));const i=t.capabilities.getMaxAnisotropy();t.setSize(r.clientWidth,r.clientHeight),t.shadowMap.enabled=!0,t.shadowMap.type=_i,t.localClippingEnabled=!0,r.appendChild(t.domElement);const a=new wi;a.background=new ce(790034),a.fog=new xi(790034,9,20);const o=new bi(50,r.clientWidth/r.clientHeight,.05,60),s=new Ai(o,t.domElement);s.enableDamping=!0,s.dampingFactor=.08,s.maxPolarAngle=Math.PI*.495,s.minDistance=1.2,s.maxDistance=14,a.add(new Si(3752527,1119258,1.1));const l=new gt(16777215,1.5);l.position.set(3,6,4),l.castShadow=!0,l.shadow.mapSize.set(2048,2048),l.shadow.camera.left=-5,l.shadow.camera.right=5,l.shadow.camera.top=5,l.shadow.camera.bottom=-5,a.add(l);const h=new gt(5227511,.35);h.position.set(-4,3,-3),a.add(h);const d=new k(new K(120,120),new Ce({color:1514016,roughness:.92,metalness:.05}));d.rotation.x=-Math.PI/2,d.receiveShadow=!0,a.add(d);const n=new vt(120,240,2304051,1777706);n.position.y=.002,a.add(n);const _=new j,c=new k(new K(5,3.2),new Ce({color:1843240,roughness:.95}));c.position.set(0,1.6,xe),c.receiveShadow=!0,_.add(c);const x=new vt(5,10,2765120,2304567);x.rotation.x=Math.PI/2,x.position.set(0,1.6,xe+.005),_.add(x),a.add(_);const D=(()=>{const u=new j,v=3.05,p=-7,f=.225,g=p-.15,b=new Ce({color:2830134,roughness:.6,metalness:.3}),S=new k(new _t(1.8,1.05,.03),new Ce({color:15594231,roughness:.25,metalness:.05,transparent:!0,opacity:.55}));S.position.set(0,v+.375,g-.015),S.castShadow=!0,u.add(S);const H=new wt(new Pi(new _t(.59,.45,.001)),new xt({color:15229482}));H.position.set(0,v+.19,g+.02),u.add(H);const I=new k(new yi(f,.014,10,28),new Ce({color:15229482,roughness:.4,metalness:.5}));I.rotation.x=Math.PI/2,I.position.set(0,v,p),I.castShadow=!0,u.add(I);const L=12,z=.4,G=.09,B=(N,Qt)=>Array.from({length:L},(pa,qt)=>{const ut=qt/L*Math.PI*2;return new P(Math.cos(ut)*N,Qt,p+Math.sin(ut)*N)}),ge=B(f,v),ve=B((f+G)/2,v-z*.5),re=B(G,v-z),Ve=[];for(let N=0;N<L;N++)Ve.push(ge[N],ve[N],ve[N],re[N]);for(let N=0;N<L;N++)Ve.push(ve[N],ve[(N+1)%L],re[N],re[(N+1)%L]);const Zt=new wt(new We().setFromPoints(Ve),new xt({color:16119280,transparent:!0,opacity:.75}));u.add(Zt);const Ye=new k(new bt(.05,.06,S.position.y+.4,12),b);Ye.position.set(0,(S.position.y+.4)/2,g-.35),Ye.castShadow=!0,u.add(Ye);const Ze=new k(new bt(.035,.035,.36,10),b);return Ze.rotation.x=Math.PI/2,Ze.position.set(0,S.position.y,g-.18),u.add(Ze),u.visible=!1,u.name="hoop",a.add(u),u})();let E=null;function C(){D.visible=E==="basketball"&&["court","court_tile","court_gray","court_black"].includes(Me)}const R=new Ti,F={},ee="./";function Te(u,v,p){return new Promise(f=>{R.load(`${ee}tex/${u}`,g=>{g.wrapS=g.wrapT=le,g.repeat.set(v,p),g.anisotropy=i,g.colorSpace=Q,f(g)})})}async function te(u){if(F[u])return F[u];if(u==="grass")F.grass=await Te("grass.jpg",60,60);else if(u==="paving")F.paving=await Te("paving.jpg",50,50);else if(u==="plaster")F.plaster=await Te("plaster.jpg",2.5,1.6);else if(u==="court_tile"){const v=document.createElement("canvas");v.width=v.height=512;const p=v.getContext("2d"),f=128;p.fillStyle="#DCDEDF",p.fillRect(0,0,512,512);for(let b=0;b<4;b++)for(let S=0;S<4;S++){const H=S*f,I=b*f,L=(S*7+b*13)%5/5;p.fillStyle=`rgb(${214+L*10|0},${217+L*10|0},${219+L*10|0})`,p.fillRect(H,I,f,f),p.strokeStyle="rgba(150,156,161,0.5)",p.lineWidth=2,p.strokeRect(H+1,I+1,f-2,f-2),p.strokeStyle="rgba(156,163,169,0.62)",p.lineWidth=1.1;const z=f/4;for(let G=0;G<4;G++)for(let B=0;B<4;B++){const ge=H+G*z,ve=I+B*z;for(let re=0;re<2;re++)p.beginPath(),p.roundRect(ge+4+re*13,ve+5,11,z-10,3.5),p.stroke()}}const g=new X(v);g.wrapS=g.wrapT=le,g.repeat.set(120,120),g.anisotropy=i,g.colorSpace=Q,F.court_tile=g}else if(u==="ivorywood"){const v=document.createElement("canvas");v.width=v.height=512;const p=v.getContext("2d"),f=(()=>{let S=11;return()=>(S=S*16807%2147483647)/2147483647})(),g=74;for(let S=0;S*g<512+g;S++){const H=S%2*190;for(let I=-1;I<3;I++){const L=I*380+H,z=S*g,G=.962+f()*.072;p.fillStyle=`rgb(${Math.min(255,236*G)|0}, ${Math.min(255,230*G)|0}, ${Math.min(255,222*G)|0})`,p.fillRect(L,z,380,g),p.strokeStyle="rgba(196,186,170,0.34)",p.lineWidth=1.4,p.strokeRect(L+.7,z+.7,380-1.4,g-1.4),p.strokeStyle="rgba(204,195,180,0.20)",p.lineWidth=1;for(let B=0;B<3;B++){const ge=z+12+f()*(g-24);p.beginPath(),p.moveTo(L+8,ge),p.lineTo(L+372,ge+(f()-.5)*5),p.stroke()}}}const b=new X(v);b.wrapS=b.wrapT=le,b.repeat.set(46,46),b.anisotropy=i,b.colorSpace=Q,F.ivorywood=b}else if(u==="track"){const v=await new Promise(b=>{const S=new Image;S.onload=()=>b(S),S.src=`${ee}tex/asphalt.jpg`}),p=document.createElement("canvas");p.width=p.height=512;const f=p.getContext("2d");f.fillStyle="#B7C6AA",f.fillRect(0,0,512,512),f.globalAlpha=.34,f.globalCompositeOperation="overlay",f.drawImage(v,0,0,512,512),f.globalAlpha=.12,f.globalCompositeOperation="saturation",f.fillStyle="#808080",f.fillRect(0,0,512,512),f.globalAlpha=1,f.globalCompositeOperation="source-over";const g=new X(p);g.wrapS=g.wrapT=le,g.repeat.set(60,60),g.anisotropy=i,g.colorSpace=Q,F.track=g}else if(u==="dirt"){const v=await new Promise(b=>{const S=new Image;S.onload=()=>b(S),S.src=`${ee}tex/asphalt.jpg`}),p=document.createElement("canvas");p.width=p.height=512;const f=p.getContext("2d");f.fillStyle="#C4BBA4",f.fillRect(0,0,512,512),f.globalAlpha=.4,f.globalCompositeOperation="overlay",f.drawImage(v,0,0,512,512),f.globalAlpha=.16,f.globalCompositeOperation="saturation",f.fillStyle="#808080",f.fillRect(0,0,512,512),f.globalAlpha=1,f.globalCompositeOperation="source-over",f.strokeStyle="rgba(120,110,92,0.35)",f.lineWidth=2,f.beginPath(),f.moveTo(0,256),f.lineTo(512,262),f.moveTo(256,0),f.lineTo(250,512),f.stroke();const g=new X(p);g.wrapS=g.wrapT=le,g.repeat.set(24,24),g.anisotropy=i,g.colorSpace=Q,F.dirt=g}else if(u==="indoorwood"){const v=document.createElement("canvas");v.width=v.height=512;const p=v.getContext("2d"),f=(()=>{let b=7;return()=>(b=b*16807%2147483647)/2147483647})();for(let b=0;b<8;b++){const S=b%2*128;for(let H=-1;H<3;H++){const I=H*256+S,L=b*64,z=.82+f()*.3;p.fillStyle=`rgb(${Math.round(168*z)}, ${Math.round(126*z)}, ${Math.round(84*z)})`,p.fillRect(I,L,256,64),p.strokeStyle="rgba(70,48,30,0.55)",p.lineWidth=2,p.strokeRect(I+1,L+1,254,62),p.strokeStyle="rgba(90,62,40,0.25)",p.lineWidth=1;for(let G=0;G<4;G++){const B=L+10+f()*46;p.beginPath(),p.moveTo(I+6,B),p.lineTo(I+250,B+(f()-.5)*6),p.stroke()}}}const g=new X(v);g.wrapS=g.wrapT=le,g.repeat.set(26,26),g.anisotropy=i,g.colorSpace=Q,F.indoorwood=g}else if(u==="wallpaper"){const v=document.createElement("canvas");v.width=v.height=256;const p=v.getContext("2d");p.fillStyle="#F6F5F2",p.fillRect(0,0,256,256);const f=(()=>{let b=13;return()=>(b=b*16807%2147483647)/2147483647})();for(let b=0;b<256;b+=2){const S=.02+f()*.045;p.fillStyle=f()<.5?`rgba(208,205,198,${S})`:`rgba(255,255,255,${S})`,p.fillRect(b,0,1+f()*1.5,256)}for(let b=0;b<90;b++)p.fillStyle=`rgba(196,188,174,${.03+f()*.04})`,p.fillRect(f()*256,f()*256,1,3+f()*9);const g=new X(v);g.wrapS=g.wrapT=le,g.repeat.set(9,5),g.anisotropy=i,g.colorSpace=Q,F.wallpaper=g}return F[u]}let Re=0,Me=null;function ot(){return Me==="indoor"?15723490:!Me||Me==="none"?8291727:12173514}function rt(){if(!U)return;const u=ot();a.background.setHex(u),a.fog.color.setHex(u)}let V=null,Y=null,$=null;function zt(){if($)return $;$=new j;const u=new de({color:16316660,transparent:!0,opacity:.85,depthWrite:!1}),v=[.95,2.85,4.75];for(const p of v)for(const f of[-1,1]){const g=new k(new K(.055,80),u);g.rotation.x=-Math.PI/2,g.position.set(f*p,.002,0),$.add(g)}return $.renderOrder=1,a.add($),$}async function Wt(u){const v=++Re;if(Me=!u||u==="none"?null:u,!u||u==="none"){d.material.map=null,d.material.color.setHex(U?6712438:1514016),c.material.map=null,c.material.color.setHex(U?7765126:1843240),c.material.emissive?.setHex(0),d.material.needsUpdate=!0,c.material.needsUpdate=!0,n.visible=!0,x.visible=!0,V&&(V.visible=!1),Y&&(Y.visible=!1),C(),rt();return}const p=u==="court_gray"||u==="court_black",f=u==="indoor"?"ivorywood":u==="court"?"indoorwood":u,[g,b]=await Promise.all([p?null:te(f),te("plaster")]);if(v===Re){if(!V){const H=new q({uniforms:{uColor:{value:new ce(16448245)},uOpacity:{value:.85},uHalf:{value:.025}},vertexShader:"varying vec2 vUv; void main(){ vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0); }",fragmentShader:`
...
}`,ta={solid:0,dash:1,dot:2,chevron:3,comet:4,taper:5},Z={ox:0,oz:0,fx:0,fz:-1,rx:1,rz:0,halfL:0,halfW:0,feather:.3,amt:0};function ia(r){const e=new q({vertexShader:It,fragmentShader:ea,uniforms:{uLUT:{value:ke()},uTime:{value:0},uLen:{value:r},uW:{value:1},uHalo:{value:.9},uGain:{value:1},uLStyle:{value:1},uLSpeed:{value:1},uLGap:{value:1},uLHeat:{value:.5},uLTail:{value:.55},uDay:{value:0},uOut:{value:1},uFPOrigin:{value:new P},uFPFwd:{value:new P(0,0,-1)},uFPRight:{value:new P(1,0,0)},uFPNear:{value:-1e6},uFPFar:{value:1e6},uFPHalfN:{value:1e6},uFPHalfF:{value:1e6},uFPFadeM:{value:.15}},transparent:!0,blending:pe,depthWrite:!1,side:tt});return e.clipping=!0,e._src="LANEFX",e}const he=je/Ke,J={core:w.w,halo:w.halo,pool:w.pool,sweep:.4,wobble:w.noise,tap:w.tap||null};if(w.prims){y.prims=y.prims||{};for(const r in w.prims)y.prims[r]={...y.prims[r]||{},...w.prims[r]}}y.primBloom=w.bloom;function aa(r=null){const e=new q({vertexShader:It,fragmentShader:Ji,uniforms:{uLUT:{value:ke()},uUIOrigin:{value:new P},uUIFwd:{value:new P(0,0,-1)},uUIRight:{value:new P(1,0,0)},uUIHalfL:{value:0},uUIHalfW:{value:0},uUIFeather:{value:.3},uUIAmt:{value:0},uShape:{value:r?1:0},uRadius:{value:r?1:1.5652173913043477},uSDF2:{value:r||ke()},uSDFWarn:{value:Mi()||ke()},uImp:{value:r?w.imp:0},uImpPitch:{value:w.pitch*he},uImpDot:{value:w.dot},uImpGlow:{value:w.glow},uImpShade:{value:w.shade},uImpSharp:{value:w.sharp},uImpShadeCol:{value:w.shadeCol},uImpDotCol:{value:w.dotCol??1},uImpEdge:{value:w.edge*he},uImpScale:{value:w.scale},uImpRot:{value:(r?._right?-5.5:w.irot)*Math.PI/180},uImpCtr:{value:new M(r?(r._inCx??.5)*2-1:0,r?1-(r._inCy??.5)*2:0)},uImpOff:{value:new M((r?._right?.043:w.offx)*he,w.offy*he)},uRip:{value:w.rip},uRipSpeed:{value:w.ripSpeed},uRipWidth:{value:w.ripWidth*he},uRipReach:{value:w.ripReach*he},uEdgeShade:{value:w.edgeShade},uEdgeW:{value:w.edgeW*he},uEdgeSoft:{value:w.edgeSoft},uEdgeShadeW:{value:w.edgeShadeW},uEdgeShadeCol:{value:w.edgeShadeCol},uIceOld:{value:0},uStatePrev:{value:0},uPrevProg:{value:0},uXfade:{value:1},uEdgeShadeGrad:{value:w.edgeShadeGrad},uEdgeShadeG0:{value:w.edgeShadeG0},uEdgeShadeG1:{value:w.edgeShadeG1},uShadeRed:{value:w.shadeRed},uShadeRedW:{value:w.shadeRedW},uDither:{value:w.dither},uSilFit:{value:je/Ke},uPlantar:{value:w.plantar},uBands:{value:w.bands},uBandSoft:{value:w.bandSoft},uRipGrad:{value:w.ripGrad},uRipCol:{value:w.ripCol},uPhase:{value:0},uProg:{value:0},uFade:{value:1},uFillOp:{value:1},uToe:{value:0},uStrong:{value:0},uContract:{value:0},uTime:{value:0},uSeed:{value:Math.random()*6.2832},uW:{value:1},uHalo:{value:.9},uPool:{value:.55},uGain:{value:1},uSweepA:{value:1},uNoise:{value:.5},uDay:{value:0},uOut:{value:1},uHT:{value:0},uHTPitch:{value:.055},uHTGain:{value:1.15},uHTSoft:{value:.55},uHTWave:{value:.6},uHTGlow:{value:0},uHTInner:{value:0},uNumTex:{value:null},uNumOn:{value:0},uNumScale:{value:.311},uNumOff:{value:new M},uFPOrigin:{value:new P},uFPFwd:{value:new P(0,0,-1)},uFPRight:{value:new P(1,0,0)},uFPNear:{value:-1e6},uFPFar:{value:1e6},uFPHalfN:{value:1e6},uFPHalfF:{value:1e6},uFPFadeM:{value:.28}},transparent:!0,blending:pe,depthWrite:!1,side:tt});return e.clipping=!0,e._src=r?"MARKFX(발형)":"MARKFX(존원)",e._noBloom=!0,Nt.push(e),e}const Nt=[];function Ct(r,e={}){const t=je/Ke,i={imp:"uImp",dot:"uImpDot",glow:"uImpGlow",shade:"uImpShade",sharp:"uImpSharp",shadeCol:"uImpShadeCol",dotCol:"uImpDotCol",scale:"uImpScale",plantar:"uPlantar",bands:"uBands",bandSoft:"uBandSoft",edgeShade:"uEdgeShade",edgeShadeW:"uEdgeShadeW",edgeShadeCol:"uEdgeShadeCol",edgeShadeGrad:"uEdgeShadeGrad",edgeShadeG0:"uEdgeShadeG0",edgeShadeG1:"uEdgeShadeG1",shadeRed:"uShadeRed",shadeRedW:"uShadeRedW",edgeSoft:"uEdgeSoft",dither:"uDither",rip:"uRip",ripSpeed:"uRipSpeed",ripGrad:"uRipGrad",ripCol:"uRipCol",op:"uFillOp"},a={pitch:"uImpPitch",edge:"uImpEdge",edgeW:"uEdgeW",ripWidth:"uRipWidth",ripReach:"uRipReach"},o=r.uniforms;for(const s in i)e[s]!=null&&o[i[s]]&&(o[i[s]].value=e[s]);for(const s in a)e[s]!=null&&o[a[s]]&&(o[a[s]].value=e[s]*t)}const qe=new WeakMap;function sa(r,e){if(!r?.uniforms)return;const t=(w.states||{})[e]||(w.states||{})[String(e)],i=["imp","dot","glow","shade","sharp","scale","plantar","bands","bandSoft","edgeShade","edgeShadeW","edgeShadeGrad","edgeShadeG0","edgeShadeG1","dither","pitch","edge","edgeW"];if(!qe.has(r)){const a={};for(const o of i)w[o]!=null&&(a[o]=w[o]);qe.set(r,a)}Ct(r,qe.get(r)),t&&Ct(r,t)}function va(r={}){const e=je/Ke,t={imp:"uImp",dot:"uImpDot",glow:"uImpGlow",shade:"uImpShade",sharp:"uImpSharp",shadeCol:"uImpShadeCol",dotCol:"uImpDotCol",scale:"uImpScale",plantar:"uPlantar",bands:"uBands",bandSoft:"uBandSoft",edgeShade:"uEdgeShade",edgeShadeW:"uEdgeShadeW",edgeShadeCol:"uEdgeShadeCol",edgeShadeGrad:"uEdgeShadeGrad",edgeShadeG0:"uEdgeShadeG0",edgeShadeG1:"uEdgeShadeG1",shadeRed:"uShadeRed",shadeRedW:"uShadeRedW",edgeSoft:"uEdgeSoft",dither:"uDither",rip:"uRip",ripSpeed:"uRipSpeed",ripGrad:"uRipGrad",ripCol:"uRipCol",iceOld:"uIceOld"},i={pitch:"uImpPitch",edge:"uImpEdge",edgeW:"uEdgeW",ripWidth:"uRipWidth",ripReach:"uRipReach"};for(const a of Nt){const o=a.uniforms,s=o.uShape?.value===1;for(const l in t)r[l]==null||!o[t[l]]||l==="imp"&&!s||(o[t[l]].value=r[l]);for(const l in i)r[l]!=null&&o[i[l]]&&(o[i[l]].value=r[l]*e)}if(r.halo!=null&&(y.mark.halo=r.halo),r.w!=null&&(y.mark.core=r.w,y.arrow&&(y.arrow.w=r.w)),r.w!=null&&(J.core=r.w),r.halo!=null&&(J.halo=r.halo),r.pool!=null&&(J.pool=r.pool),r.noise!=null&&(J.wobble=r.noise),r.bloom!=null&&(y.primBloom=r.bloom),r.prims){y.prims=y.prims||{};for(const a in r.prims)y.prims[a]={...y.prims[a]||{},...r.prims[a]}}}const oe={left:ne.red,right:ne.red,target:ne.red,guide:ne.coral,lane:ne.red,success:ne.prism,user:ne.prism},Ut=[1,.75,.55,.38],oa=typeof location>"u"||new URLSearchParams(location.search).get("xfade")!=="0",ra=[1,.78,.58,.42];let Be=!1;function _a(r){Be=!!r}const et=.3,na=.727,Rt=et/na,$e={base:et*.65,loose:et*1},be={markScale:1,fillOpacity:.2,previewEdge:.5,cdContractFrom:1.9,cdGain:.6,lingerEdge:.9,linger:.35};be.linger;const la={running:{mode:"advance",V:2.5,STRIKE_AHEAD:.15,X_SCALE:2,LANE_W:1.6,CAL:{right:{x:-.187,z:.049},left:{x:.128,z:0}}},boxing:{mode:"static",FLOOR_SCALE:1.6,WALL:{XS:2.2,Y0:.73,YS:1.2}},basketball:{mode:"spatial",SCALE:5}},wa=5,Je={},_e=new Image;_e.src="./ready-view/assets/pace_foot.svg";function ha(r){const e=r?"R":"L";if(Je[e])return Je[e];const t=document.createElement("canvas");t.width=t.height=128;const i=t.getContext("2d"),a=_e.complete&&_e.naturalWidth;if(a){const s=document.createElement("canvas");s.width=s.height=128;const l=s.getContext("2d"),h=_e.naturalWidth/_e.naturalHeight,d=100,n=d/h;l.save(),r&&(l.translate(128,0),l.scale(-1,1)),l.drawImage(_e,(128-d)/2,(128-n)/2,d,n),l.restore(),l.globalCompositeOperation="source-in",l.fillStyle=ue(ze.ink,.95),l.fillRect(0,0,128,128),i.shadowColor=ue(He.coral,.75),i.shadowBlur=12,i.drawImage(s,0,0),i.shadowBlur=0,i.drawImage(s,0,0)}else i.strokeStyle=ue(ze.ink,.95),i.lineWidth=5,i.shadowColor=ue(He.coral,.75),i.shadowBlur=12,i.beginPath(),i.ellipse(64,64,20,34,r?.12:-.12,0,Math.PI*2),i.stroke();const o=new X(t);return o.colorSpace=Q,o.anisotropy=4,a&&(Je[e]=o),o}function Ht(r){const e=document.createElement("canvas");e.width=e.height=128;const t=e.getContext("2d");Ot(t,String(r),64,64,96)||(t.fillStyle=ue(ze.ink,.95),t.font="300 86px -apple-system, sans-serif",t.textAlign="center",t.textBaseline="middle",t.shadowColor=ue(He.coral,.75),t.shadowBlur=14,t.fillText(String(r),64,70));const i=new X(e);return i.anisotropy=4,i}function ua(r){const i=document.createElement("canvas");i.width=4,i.height=4;let a=i.getContext("2d");a.font="400 56px -apple-system, 'Apple SD Gothic Neo', sans-serif";const o=Math.ceil(a.measureText(r).width);i.width=o+40,i.height=56*1.7,a=i.getContext("2d"),a.font="400 56px -apple-system, 'Apple SD Gothic Neo', sans-serif",a.textAlign="center",a.textBaseline="middle",a.shadowColor=ue(He.coral,.7),a.shadowBlur=56*.25,a.fillStyle=ze.ink,a.fillText(r,i.width/2,i.height/2);const s=new X(i);return s.colorSpace=Q,s.anisotropy=8,{tex:s,aspect:i.width/i.height}}function ca(r){const e=document.createElement("canvas");e.width=e.height=256;const t=e.getContext("2d"),i="#"+r.toString(16).padStart(6,"0");return t.strokeStyle=i,t.lineWidth=12,t.lineCap="butt",t.setLineDash([26,20]),t.beginPath(),t.arc(128,128,104,0,Math.PI*2),t.stroke(),new X(e)}class Et{constructor(e,t,i,a=!1){this._footRight=a,this.group=new j,this.radius=e,this.color=t,this.surface=i,this.num=null;let o=null;if(i==="floor"&&y.markShape===1)try{o=Ci(this._footRight===!0)}catch{o=null}this._isFoot=!!o;const s=(this._isFoot?Rt:e*2.78)*ct;this.fx=new k(new K(s,s),aa(o)),this.fx.position.z=.002,this._baseGain=i==="wall"?.6:1,this.fx.material.uniforms.uGain.value=this._baseGain,this.group.add(this.fx),i==="floor"&&(this.group.rotation.x=-Math.PI/2,this.group.position.y=.012),this.group.renderOrder=5}setSelected(e){if(e&&!this.sel){this.sel=new j;const t=(i,a,o,s,l)=>{const h=new k(new Ei(i,a,48),new de({color:o,transparent:!0,opacity:s,depthWrite:!1,side:tt}));return h.renderOrder=l,h};this.sel.add(t(this.radius*1.44,this.radius*1.58,790034,.85,6)),this.sel.add(t(this.radius*1.32,this.radius*1.44,16777215,.95,7)),this.sel.position.z=.005,this.group.add(this.sel)}this.sel&&(this.sel.visible=!!e)}setNumber(e){this._numN=e;const t=new de({map:Ht(e),transparent:!0,depthWrite:!1}),i=this.radius*2.78*dt.RATIO/.75*(this._isFoot?1:Jt);this.num=new k(new K(i,i),t),this.num.position.z=.004;const a=this.fx?.material?.uniforms;a?.uNumTex&&(a.uNumTex.value=t.map,a.uNumScale.value=i/(this.radius*2.78)),this.group.add(this.num)}setContract(e="reach"){this.contract=e,this.fx.material.uniforms.uContract.value=e==="avoid"?1:0}render(e,t,i,a){const o=this.group;if(e==="hidden"){o.visible=!1,this._lastPhase="hidden";return}o.visible=!0;const s=performance.now()/1e3;e!==this._lastPhase&&((this._lastPhase==="hidden"||this._lastPhase==null)&&(e==="preview"||e==="countdown")&&(this._spawnT=s),e==="linger"&&(this._hitT=s),this._lastPhase=e);let l=1;if(this._spawnT!=null){const n=(s-this._spawnT)/.38;if(n<1){const _=1-Math.pow(1-n,3);l*=.55+.45*_+.1*Math.sin(Math.min(1,n)*Math.PI)}}if(this._hitT!=null){const n=(s-this._hitT)/.3;n<1&&(l*=1+.3*(1-n)*(1-n))}o.scale.setScalar(a*be.markScale*l);const h=Be?ra:Ut,d=h[Math.min(i,h.length-1)];if(this.fx.visible){const n=this.fx.material.uniforms;n.uTime.value=performance.now()/1e3;const _=e==="preview"?0:e==="countdown"?1:e==="locked"?3:e==="miss"?4:2;if(n.uPhase.value!==_&&oa&&(n.uStatePrev.value=n.uPhase.value,n.uPrevProg.value=n.uProg.value,this._xfT=s),n.uPhase.value=_,sa(this.fx?.material||m,_),this._xfT!=null){const D=(s-this._xfT)/.28;n.uXfade.value=D>=1?1:D,D>=1&&(this._xfT=null)}n.uProg.value=t,n.uFade.value=d,n.uStrong.value=this.strongPreview?1:0,n.uW.value=J.core,n.uHalo.value=J.halo,n.uPool.value=J.pool,n.uSweepA.value=J.sweep,n.uNoise.value=J.wobble,n.uUIAmt&&(n.uUIOrigin.value.set(Z.ox,0,Z.oz),n.uUIFwd.value.set(Z.fx,0,Z.fz),n.uUIRight.value.set(Z.rx,0,Z.rz),n.uUIHalfL.value=Z.halfL,n.uUIHalfW.value=Z.halfW,n.uUIFeather.value=Z.feather,n.uUIAmt.value=this.surface==="wall"?0:Z.amt);const c=e==="linger"?1+.9*Math.max(0,1-t*2.2):1;n.uGain.value=this._baseGain*y.gainBoost*(Be?1.35:1)*c;const x=y.day||y.markBlend==="ink"?1:0;n.uDay.value!==x&&(n.uDay.value=x,this.fx.material.blending=x?it:pe,this.fx.material.needsUpdate=!0)}if(this.num&&(this.num.material.opacity=y.hideOrderNums&&!this._numFoot?0:e==="preview"?(this.strongPreview?1:.5)*d:e==="countdown"?1:e==="linger"?.4*(1-t):e==="locked"?.48*d:e==="miss"?.3*(1-t):1),this.num&&this.fx?.material?.uniforms?.uHT){const n=this.fx.material.uniforms,_=n.uHT.value>.5;n.uNumOn.value=_&&this.num.material.opacity>.01?1:0,n.uNumOff.value.set(this.num.position.x/(this.radius*1.39),this.num.position.y/(this.radius*1.39)),_?this.num.visible=!1:this.num.visible||(this.num.visible=!0)}if(this.num&&this._isFoot&&y.numFoot){const n=y.numFoot,_=n[y.footCtx==="in"?"in":"out"]||n.L||(n.R?{x:1-n.R.x,y:n.R.y,s:n.R.s}:null);if(_){const c=dt.anchor(_,this._footRight,Rt*ct);this.num.position.set(c.x,c.y,.004),this.num.scale.setScalar(c.s)}}}}const Ue=[];function Lt(r,{tips:e=1,wall:t=!1,scale:i=1}={}){const a=new j,o=document.createElement("canvas");o.width=128,o.height=256;const s=new X(o);s.colorSpace=Q,s.anisotropy=4;const l=new k(new K(r*.5,r),new de({map:s,transparent:!0,depthWrite:!1,blending:pe}));return l.position.y=r/2,a.add(l),a._len=r,a._canvas=o,a._tex=s,a._mesh=l,a._paintT=-9,a._noTip=e===0,a._tips=[],a._scale=i,t?(a.rotation.x=0,a.position.y=0):(a.rotation.x=-Math.PI/2,a.position.y=.014),a.renderOrder=6,a._wall=!!t,Ue.push(a),a}function da(r,e,t=0){const i=r?._fp;if(!i)return 1;const a=(c,x,D)=>{const E=Math.max(0,Math.min(1,(D-c)/(x-c)));return E*E*(3-2*E)},o=.25+t,s=e.x-i.ox,l=e.z-i.oz,h=s*i.fx+l*i.fz,d=s*i.rx+l*i.rz,n=Math.max(0,Math.min(1,(h-r.fpNear)/Math.max(.01,r.fpFar-r.fpNear))),_=r._halfAt(r.fpNear)+(r._halfAt(r.fpFar)-r._halfAt(r.fpNear))*n;return a(r.fpNear,r.fpNear+o,h)*a(r.fpFar,r.fpFar-o,h)*a(_,_-o,Math.abs(d))}function xa(r,e){se.map.TIP_TRI||(se.map.TIP_TRI="./ready-view/assets/arrow_tip.svg",se.set(se.map)),se.map.LIFT_TIP||(se.map.LIFT_TIP="./ready-view/assets/lift_tip.svg",se.set(se.map));const t=y.day||y.markBlend==="ink"?1:0,i={lut:Ri,glyph:Ot,arrow:y.arrow||{}};for(let a=Ue.length-1;a>=0;a--){const o=Ue[a];if(!o.parent){Ue.splice(a,1);continue}r-o._paintT>=1/24&&(o._paintT=r,ei(o._canvas.getContext("2d"),128,256,r,i,{noTip:o._noTip,prog:o._prog,scale:o._scale}),o._tex.needsUpdate=!0);const s=e?._fp,l=o._mesh.material;if(s&&!o._wall){const h=_=>da(e,_),d=new P,n=new P;o.getWorldPosition(d),o._mesh.getWorldPosition(n),n.multiplyScalar(2).sub(d),l.opacity=Math.min(h(d),h(n))*(o._gain??1)}else l.opacity=o._gain??1;l._day!==t&&(l._day=t,l.blending=t?it:pe,l.needsUpdate=!0)}}class ba{constructor(e,t){this.scene=e,this.effects=t,this.params={lead:.7,size:1,maxVisible:3},this.root=new j,e.add(this.root),this.floorRoot=new j,this.wallRoot=new j,this.root.add(this.floorRoot,this.wallRoot),this.events=[],this.ambient=[],this.pack=null,this.layout=null,this.duration=0,this.onEvent=null,this.footprintTest=null,this.gazeTest=null,this.stats={inGaze:0,total:0},this.floorClip=null,this.wallClip=null}_applyClip(e,t){t&&e.traverse(i=>{i.material&&(i.material.clippingPlanes=t)})}_floorClipFor(){return this.layoutPreview?null:this.floorClip}setCompare(e){if(this._compareRoot){for(const s of this._compareRoot)s.removeFromParent();this._compareRoot=null}if(!e||!this.pack||e.sport!==this.pack.sport)return;const t=new j,i=new j,a=ca(10134445),o=()=>new de({map:a,transparent:!0,opacity:.5,depthWrite:!1});for(const s of e.tokens)if(s.type==="stepMark"){const l=this._mapFloor(s),h=new k(new K(.4,.4),o());h.rotation.x=-Math.PI/2,h.position.set(l.x,.011,l.z),h.renderOrder=3,this._applyClip(h,this._floorClipFor()),t.add(h)}else if(s.type==="targetMark"&&this.pack.hasWall){const l=this._mapWall(s),h=new k(new K(.34,.34),o());h.position.set(l.x,l.y,l.z-.005),h.renderOrder=3,this._applyClip(h,this.wallClip),i.add(h)}this.floorRoot.add(t),this.wallRoot.add(i),this._compareRoot=[t,i]}recolor(){for(const e of this.events)if(e.marker){const t=oe[e.marker.role]??oe.left;e.marker.color=t,e.color=t}}setParams(e){Object.assign(this.params,e)}setPack(e){this.floorRoot.clear(),this.wallRoot.clear(),this._compareRoot=null,this.laneFX=null,this.floorRoot.position.set(0,0,0),this.events=[],this.ambient=[],this.pack=e,this.layout=la[e.sport],this.duration=e.duration;const t=this.layout,i=new Map;for(const o of e.tokens){if(o.type==="pathLane"||o.lifetime>=e.duration*.85){this.ambient.push(o);continue}const l=Math.round(o.t*1e3);i.has(l)||i.set(l,{t:o.t,tokens:[]}),i.get(l).tokens.push(o)}const a=e.sport==="boxing";for(const o of[...i.values()].sort((s,l)=>s.t-l.t)){const s={t:o.t,fired:!1,marker:null,arrow:null,surface:"floor",pos:new P,color:16777215,foot:null};let l=null;for(const h of o.tokens)if(!(a&&(h.type==="orderPulse"&&(l=h.n),h.type!=="targetMark"))){if(h.type==="stepMark"||h.type==="targetMark"||h.type==="orderPulse"&&!s.marker){const d=h.type==="targetMark"&&this.pack.hasWall,n=h.type==="targetMark"?oe.target:oe[h.foot]??oe.left,_=h.radiusCm?h.radiusCm/100:h.type==="targetMark"?$e.loose:$e.base,c=new Et(_,n,d?"wall":"floor",h.foot==="right");!d&&(h.contract&&h.contract!=="reach"||h.holdRing)&&c.setContract(h.contract),c.role=h.type==="targetMark"?"target":h.foot??"left",s.marker=c,s.surface=d?"wall":"floor",s.color=n,s.foot=h.foot??null,s.srcToken=h,(d?this.wallRoot:this.floorRoot).add(c.group),this._applyClip(c.group,d?this.wallClip:this._floorClipFor())}if(h.type==="orderPulse"&&s.marker&&!s.marker.num&&!s.marker._skipNumber&&s.marker.setNumber(h.n),h.type==="directionGuide"){const d=Lt(e.sport==="basketball"?.9:.55),n=this._mapFloor(h);d.position.x=n.x,d.position.z=n.z,d.rotation.z=At.degToRad(-(h.angle??0)),s.arrow={obj:d,t:h.t,lifetime:h.lifetime},this.floorRoot.add(d),this._applyClip(d,this._floorClipFor())}}a&&s.marker&&l!=null&&!s.marker.num&&(s.marker.setNumber(l),this._applyClip(s.marker.group,this.wallClip)),(s.marker||s.arrow)&&this.events.push(s)}if(e.sport==="basketball"){const o=this.events.filter(s=>s.surface==="floor"&&s.marker).sort((s,l)=>s.t-l.t);for(let s=0;s<o.length;s++){const l=o[s],h=o[s+1],d=o[s-1],n=this._mapFloor(l.srcToken);if(l.arrow&&h){const _=this._mapFloor(h.srcToken),c=_.x-n.x,x=_.z-n.z;l.arrow.obj.rotation.z=Math.atan2(-c,-x),l.arrow.obj.position.x=n.x,l.arrow.obj.position.z=n.z}if(d){const _=this._mapFloor(d.srcToken);let c=n.x-_.x,x=n.z-_.z;const D=Math.hypot(c,x)||1;c/=D,x/=D;const E=new j,C=Math.atan2(-c,-x);for(let R=0;R<3;R++){const F=Lt(.5,{tips:0});F.rotation.z=C+Math.PI/2,F.position.set(n.x-c*(.4+R*.24),.011,n.z-x*(.4+R*.24)),F.renderOrder=4,F._gain=.55-R*.13,E.add(F)}l.stripes=E,this.floorRoot.add(E),this._applyClip(E,this._floorClipFor())}}}for(const o of this.ambient)if(o.type==="pathLane"&&this._buildLane(e),o.type==="stepMark"&&!a){const s=new Et($e.base,oe[o.foot]??oe.left,"floor");s.role=o.foot??"left";const l=this._mapFloor(o);s.group.position.x=l.x,s.group.position.z=l.z,s.render("preview",0,0,1),s.isStance=!0,this.floorRoot.add(s.group),this._applyClip(s.group,this._floorClipFor()),this.stanceMarks=this.stanceMarks||[],this.stanceMarks.push(s)}{const o=(e.tokens||[]).filter(l=>l.type==="stepMark"&&l.t!=null).map(l=>l.t).sort((l,h)=>l-h),s=[];for(let l=1;l<o.length;l++){const h=o[l]-o[l-1];h>.05&&s.push(h)}s.sort((l,h)=>l-h),this._beatT=s.length?s[Math.floor(s.length/2)]:0,this._strideM=t.mode==="advance"&&this._beatT?t.V*this._beatT:0}if(a&&this.pack.hasWall){const o=this.events.filter(s=>s.surface==="wall"&&s.marker).sort((s,l)=>s.t-l.t);if(o.forEach((s,l)=>{!s.marker.num&&!s.marker._skipNumber&&s.marker.setNumber(l+1)}),o.length){const s=o.reduce((_,c)=>_+this._mapWall(c.srcToken).y,0)/o.length,l=this.layout.WALL,h=new St(new We().setFromPoints([new P(-l.XS*.72,s,xe+.012),new P(l.XS*.72,s,xe+.012)]),new Pt({color:16696201,dashSize:.05,gapSize:.07,transparent:!0,opacity:.3}));h.computeLineDistances(),this.wallRoot.add(h),this._applyClip(h,this.wallClip);const d=ua(`타깃 ${Math.round(s*100)}cm`),n=new k(new K(d.aspect*.075,.075),new de({map:d.tex,transparent:!0,opacity:.55,depthWrite:!1}));n.position.set(l.XS*.72-d.aspect*.075/2,s+.065,xe+.012),this.wallRoot.add(n),this._applyClip(n,this.wallClip)}}}_mapFloor(e){const t=this.layout;if(t.mode==="spatial")return{x:e.nx*t.SCALE,z:e.ny*t.SCALE};if(t.mode==="static")return{x:e.nx*t.FLOOR_SCALE,z:-e.ny*t.FLOOR_SCALE+(this.stanceOffsetZ||0)};const i=t.CAL&&t.CAL[e.foot]||{x:0,z:0};return{x:e.nx*t.X_SCALE+i.x,z:-t.V*e.t-t.STRIKE_AHEAD+i.z}}_mapWall(e){const t=this.layout.WALL;return{x:e.nx*t.XS,y:t.Y0+e.ny*t.YS,z:xe+.02}}_buildLane(e){const t=this.layout;if(t.mode==="advance"){const i=t.V*e.duration+3+1.2,a=new k(new K(.55,i),ia(i));a.rotation.x=-Math.PI/2,a.position.set(0,.01,1.2-i/2),a.renderOrder=3,this.floorRoot.add(a),this._applyClip(a,this._floorClipFor()),this.laneFX=a}else if(t.mode==="spatial"){const i=this.pack.tokens.filter(a=>a.type==="stepMark").sort((a,o)=>a.t-o.t).map(a=>new P(a.nx*t.SCALE,.012,a.ny*t.SCALE));if(i.length>=2){const a=new Fi(i),o=new We().setFromPoints(a.getPoints(60)),s=new St(o,new Pt({color:oe.lane,dashSize:.14,gapSize:.1,transparent:!0,opacity:.7}));s.computeLineDistances(),this.floorRoot.add(s),this._applyClip(s,this._floorClipFor())}}}resetLoop(){for(const e of this.events)e.fired=!1,e._wasVisible=!1,e._verdict=null;this.stats={inGaze:0,total:0}}setShake(e,t){this.floorRoot.position.x=e,this.floorRoot.position.z=t+(this.loopShiftZ||0)}update(e,t){const{lead:i,size:a,maxVisible:o}=this.params;if(!this.layout)return;if(this.laneFX){const n=this.laneFX.material.uniforms,_=y.arrow||{};if(n.uTime.value=performance.now()/1e3,n.uW.value=y.graphics.width*(_.w||1),n.uHalo.value=y.graphics.halo*(_.glow??1),n.uGain.value=y.gainBoost*(Be?1.25:1),n.uLStyle.value=ta[y.lane&&y.lane.style||"dash"]??1,n.uLSpeed.value=_.speed??1,n.uLGap.value=_.gap??1,this.pack?.sport==="running"&&this._beatT>0&&this._strideM>0){const D=n.uLStyle.value;if(D===1||D===2){const E=D===1?9:12;n.uLGap.value=E*this._strideM/(2*Math.PI),n.uLSpeed.value=2*Math.PI/(5.2*this._beatT)}}n.uLHeat.value=_.heat??.5,n.uLTail.value=_.tail??.55;const c=y.day||y.markBlend==="ink"?1:0;n.uDay.value!==c&&(n.uDay.value=c,this.laneFX.material.blending=c?it:pe,this.laneFX.material.needsUpdate=!0);const x=this.rig?._fp;x&&(n.uFPOrigin.value.set(x.ox,0,x.oz),n.uFPFwd.value.set(x.fx,0,x.fz),n.uFPRight.value.set(x.rx,0,x.rz),n.uFPNear.value=this.rig.fpNear,n.uFPFar.value=this.rig.fpFar,n.uFPHalfN.value=this.rig._halfAt(this.rig.fpNear),n.uFPHalfF.value=this.rig._halfAt(this.rig.fpFar))}const l=this.rig?._fp;if(l){const n=this.rig._halfAt(this.rig.fpNear),_=this.rig._halfAt(this.rig.fpFar);for(const c of this.events){const x=c.marker?.fx?.material?.uniforms;!x||!x.uFPNear||(x.uFPOrigin.value.set(l.ox,0,l.oz),x.uFPFwd.value.set(l.fx,0,l.fz),x.uFPRight.value.set(l.rx,0,l.rz),x.uFPNear.value=this.rig.fpNear,x.uFPFar.value=this.rig.fpFar,x.uFPHalfN.value=n,x.uFPHalfF.value=_)}}const h=this.events.filter(n=>n.t>=e-be.linger),d=new Map;h.forEach((n,_)=>d.set(n,_));for(const n of this.events){const _=d.get(n)??99;let c="hidden",x=0;const D=be.linger+.6;n._verdict==="miss"&&e>=n.t&&e<n.t+D?(c="miss",x=(e-n.t)/D,n.fired||(n.fired=!0,this._fire(n))):e>=n.t&&e<n.t+be.linger?(c="linger",x=(e-n.t)/be.linger,n.fired||(n.fired=!0,this._fire(n))):e>=n.t-i&&e<n.t?(c="countdown",x=(e-(n.t-i))/i):e<n.t-i&&(c=_<o?"preview":"locked"),this.layoutPreview&&n.surface!=="wall"&&(c="preview"),this.liveHideFloorMarks&&n.surface!=="wall"&&(c="hidden"),this.laneFX&&(this.laneFX.visible=!this.liveHideLane);const E=n.marker;if(E?.num&&n.surface!=="wall"&&n.foot){const C=!!y.hideOrderNums;C!==!!E._numFoot&&(E._numFoot=C,E.num.material.map=C?ha(n.foot==="right"):Ht(E._numN??""),E.num.material.needsUpdate=!0)}if(n.marker){if(n.surface==="wall"){const R=this._mapWall(n.srcToken);n.marker.group.position.set(R.x,R.y,R.z)}else{const R=this._mapFloor(n.srcToken);if(n.marker.group.position.set(R.x,.012,R.z),this.footprintTest&&c!=="hidden"&&!this.layoutPreview){const F=R.x+this.floorRoot.position.x,ee=R.z+this.floorRoot.position.z,Te=n.marker.radius*a*1.15;this.footprintTest(F,ee,Te)||(c="hidden");const te=c==="preview"||c==="countdown";if(te&&!n._wasVisible){const Re=this.gazeTest?this.gazeTest(F,ee):!0;this.stats.total++,Re&&this.stats.inGaze++}n._wasVisible=te}}c==="preview"&&_>=o&&!this.layoutPreview&&(c="hidden");const C=this.layoutPreview?0:Math.min(_,Ut.length-1);n.marker.strongPreview=this.layoutPreview,n.marker.render(c,x,C,a),n.stripes&&(n.stripes.visible=c==="countdown"||c==="linger")}if(n.arrow){const C=n.arrow;let R=this.layoutPreview||e>=C.t-i&&e<C.t+C.lifetime;if(R&&this.footprintTest&&!this.layoutPreview&&(R=this.footprintTest(C.obj.position.x+this.floorRoot.position.x,C.obj.position.z+this.floorRoot.position.z)),C.obj.visible=R,R){const ee=.35+.55*(this.layoutPreview?1:Math.min(1,(e-(C.t-i))/Math.max(i,.001)));C.obj._gain=ee,C.obj.scale.setScalar(a)}}}}fieldVisible(e){return this.root.visible&&(e==="wall"?this.wallRoot:this.floorRoot).visible}_fire(e){if(!this.fieldVisible(e.surface))return;const t=e.t<.15,i=e.marker?e.marker.group.getWorldPosition(new P):new P,a=e.surface==="wall"?new P(0,0,1):new P(0,1,0),o=e.srcToken?.design?.burst,s=o&&o.on?{...o}:{};e.surface==="wall"&&(s.sizeM=(e.marker?.radius??.15)*1.9,s.intensity=(s.intensity??1)*.8,s.speed=(s.speed??1)*1.35),e.surface!=="wall"&&this.layout?.mode==="advance"&&(s.forward=!0,i.z-=.18,s.intensity=(s.intensity??1)*1.7,s.rings=Math.max(s.rings??1,1.8)),t||this.effects.burst(i,e.color,a,s),this.onEvent&&this.onEvent(e)}studioBurst(e){if(!this.layout||!e)return;const t=this._mapFloor({nx:e.nx,ny:e.ny??0,t:e.t,foot:e.foot}),i=new P(t.x+this.floorRoot.position.x,.02,t.z+this.floorRoot.position.z),a=e.design?.burst,o=e.design?.fill?.c0||"#fa3030";this.effects.burst(i,o,new P(0,1,0),{...a&&a.on?a:{},noClip:!0})}}export{wa as B,oe as C,Rt as F,la as L,J as M,Ai as O,ba as T,Z as U,xe as W,Lt as a,da as b,Ct as c,ia as d,ga as e,be as f,va as g,O as h,aa as m,_a as s,xa as t};
