import{v as g,P as W,N as X}from"./palette-Bj20GXDn.js";const h0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다. 2026-08-05 유저: 발자국이 캡슐 광에 비해 흐리다 → 번짐 계열(blur/halo/pool)을 낮추고 코어(glow/dot/sharp)를 올려 쨍하게. 미세 조정은 footlab 슬라이더로.",u0=.98,f0=.83,p0=-.043,m0=-.031,w0=5.5,x0=.027,S0=.34,b0=.34,C0=.3,I0=.97,v0=.038,M0=1,R0=24,A0=1,T0=.95,y0=.3,L0=.7,P0=0,_0=.5,k0=.34,D0=.1,B0=.4,F0=1,E0=1.4,G0=0,O0=3.4,U0=.01,H0=0,W0=.011,q0=-2,g0=.75,K0=-.07,$0=.12,X0=4,j0=.6,J0=4,Y0=1,Q0="drop",z0="add",Z0="offbit",V0=.55,N0=.14,tt=.26,at=4,ot=4,et=1,lt=.32,nt=1,st={punchLine:{node:1.58,numS:1,comet:1,tailLen:.71,rail:.6}},rt=-.095,it=.12,ct=10,dt=-.015,ht=.12,ut=-10,ft={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15},pt=1,mt=4,wt={tap:{op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15}},xt={_:h0,imp:u0,scale:f0,offx:p0,offy:m0,irot:w0,pitch:x0,dot:S0,glow:b0,shade:C0,sharp:I0,edge:v0,plantar:M0,bands:R0,bandSoft:A0,w:T0,halo:y0,pool:L0,noise:P0,rip:_0,ripReach:k0,ripWidth:D0,ripSpeed:B0,ripGrad:F0,edgeShade:E0,shadeRed:G0,shadeRedW:O0,edgeW:U0,edgeSoft:H0,dither:W0,tilt:q0,gsize:g0,gx:K0,gy:$0,grot:X0,gsh:j0,shadeCol:J0,ripCol:Y0,gShadow:Q0,gBlend:z0,numSrc:Z0,prog:V0,bloom:N0,blur:tt,edgeShadeW:at,edgeShadeCol:ot,edgeShadeGrad:et,edgeShadeG0:lt,edgeShadeG1:nt,prims:st,gxL:rt,gyL:it,grotL:ct,gxR:dt,gyR:ht,grotR:ut,tap:ft,op:pt,dotCol:mt,states:wt};function l0(t,a,o,c,s){let l=0;o[0]=0,c[0]=-1e20,c[1]=1e20;for(let r=1;r<s;r++){let u=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);for(;u<=c[l];)l--,u=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);l++,o[l]=r,c[l]=u,c[l+1]=1e20}l=0;for(let r=0;r<s;r++){for(;c[l+1]<r;)l++;a[r]=(r-o[l])*(r-o[l])+t[o[l]]}}function n0(t,a){const o=new Float32Array(a),c=new Int32Array(a),s=new Float32Array(a+1),l=new Float32Array(a);for(let r=0;r<a;r++){for(let u=0;u<a;u++)l[u]=t[u*a+r];l0(l,o,c,s,a);for(let u=0;u<a;u++)t[u*a+r]=o[u]}for(let r=0;r<a;r++){for(let u=0;u<a;u++)l[u]=t[r*a+u];l0(l,o,c,s,a);for(let u=0;u<a;u++)t[r*a+u]=o[u]}}function i0(t,a){const c=new Float32Array(a*a),s=new Float32Array(a*a);let l=0,r=0,u=0;for(let b=0;b<a*a;b++){const h=t[b*4+3]/255;c[b]=h>=1?0:h<=0?1e20:Math.pow(Math.max(0,.5-h),2),s[b]=h>=1?1e20:h<=0?0:Math.pow(Math.max(0,h-.5),2),h>.5&&(l+=b%a,r+=b/a|0,u++)}n0(c,a),n0(s,a);const f=new Float32Array(a*a);for(let b=0;b<a*a;b++)f[b]=(Math.sqrt(c[b])-Math.sqrt(s[b]))/a;return{data:f,N:a,cx:u?l/u/a:.5,cy:u?r/u/a:.5}}function Z(t,a=512){const o="_raster"+a;if(t[o])return t[o];const c=document.createElement("canvas");c.width=c.height=a;const s=c.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);s.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const r=s.getImageData(0,0,a,a).data;let u=a,f=a,b=-1,h=-1;for(let d=0;d<a;d++)for(let e=0;e<a;e++)r[(d*a+e)*4+3]>8&&(e<u&&(u=e),e>b&&(b=e),d<f&&(f=d),d>h&&(h=d));return t[o]=b<0?{canvas:c,x:0,y:0,w:a,h:a}:{canvas:c,x:u,y:f,w:b-u+1,h:h-f+1},t[o]}function Rt(t,a,o=!1){const c=Z(t,a),s=document.createElement("canvas");s.width=s.height=a;const l=s.getContext("2d"),r=Math.min(a*$/c.w,a*$/c.h),u=c.w*r,f=c.h*r;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(c.canvas,c.x,c.y,c.w,c.h,(a-u)/2,(a-f)/2,u,f),i0(l.getImageData(0,0,a,a).data,a)}function At(t,a,o,c=!1){const s=Z(t,o),l=a?Z(a,o):null,r=Math.min(o*$/s.w,o*$/s.h),u=s.w*r,f=s.h*r,b=(o-u)/2,h=(o-f)/2,d=M=>{const P=document.createElement("canvas");P.width=P.height=o;const T=P.getContext("2d");return c&&(T.translate(0,o),T.scale(1,-1)),T.drawImage(M.canvas,s.x,s.y,s.w,s.h,b,h,u,f),i0(T.getImageData(0,0,o,o).data,o)},e=d(s),i=l?d(l):null,n=new Float32Array(o*o*2);for(let M=0;M<o*o;M++)n[M*2]=e.data[M],n[M*2+1]=i?i.data[M]:1;return{data:n,N:o,cx:e.cx,cy:e.cy,inCx:i?i.cx:e.cx,inCy:i?i.cy:e.cy,hasInner:!!i}}const Tt=1.9922,St=.78,$=.52,yt=St/$,Lt=1.18,O=xt||{},c0={size:O.gsize??.85,gx:O.gx??-.025,gy:O.gy??.195,rot:O.grot??6,gxL:O.gxL,gyL:O.gyL,rotL:O.grotL,gxR:O.gxR,gyR:O.gyR,rotR:O.grotR,shadow:O.gShadow??"glow",shadowK:O.gsh??.75,blend:O.gBlend??"add"};function Pt(t,a=c0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function _t(t,a,o,c,s=c0){const l=Math.round(o*.75),r=s.shadow==="none"?0:s.shadowK??.75,u=f=>c(t,String(a),o/2,o/2,l,f);return s.shadow==="drop"&&r>.001?(t.save(),t.globalAlpha=Math.min(1,r*.7),t.translate(o*.018,o*.024),u({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),u({glow:0,glowColor:"rgba(0,0,0,0)"})):u(s.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),s.blend==="knock"}function kt(t,a){const o=t.getImageData(0,0,a,a),c=t.createImageData(a,a);for(let s=0;s<a*a;s++){const l=o.data[s*4+3]/255,r=Math.round(255*(1-l));c.data[s*4]=c.data[s*4+1]=c.data[s*4+2]=r,c.data[s*4+3]=255}t.putImageData(c,0,0)}const Dt={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},Q=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),z=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function s0(t,a,o){t=Q(t),a=Q(a),o=Q(o);const c=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),s=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*c+.793617785*s-.0040720468*l,1.9779984951*c-2.428592205*s+.4505937099*l,.0259040371*c+.7827717662*s-.808675766*l]}function bt(t,a,o){const c=(t+.3963377774*a+.2158037573*o)**3,s=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[z(4.0767416621*c-3.3077115913*s+.2309699292*l),z(-1.2684380046*c+2.6097574011*s-.3413193965*l),z(-.0041960863*c-.7034186147*s+1.707614701*l)]}const r0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function Bt(t,a=1,o=new Uint8Array(256*4)){const c=[...t].sort((s,l)=>s[1]-l[1]);for(let s=0;s<256;s++){const l=s/255;let r=0;for(;r<c.length-2&&l>c[r+1][1];)r++;const[u,f]=c[r],[b,h]=c[r+1],d=Math.max(0,Math.min(1,(l-f)/Math.max(1e-5,h-f))),e=s0(...r0(u)),i=s0(...r0(b)),n=bt(e[0]+(i[0]-e[0])*d,(e[1]+(i[1]-e[1])*d)*a,(e[2]+(i[2]-e[2])*d)*a);o.set([...n,255],s*4)}return o}const Ft=`
...
#define C_RED   ${g(W.red)}
#define C_CORAL ${g(W.coral)}
#define C_SAND  ${g(W.sand)}
#define C_ICE   ${g(W.prism)}
#define C_CREAM C_SAND
#define C_GRAYF ${g(X.hi)}
#define C_GRAYL ${g(X.lo)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function Ct(t,a,o,c){t.lineWidth=4*a;const s=c.arrow;s.line==="dash"?t.setLineDash([12*a*s.gap,10*s.gap]):s.line==="dot"?(t.setLineDash([.5,12*s.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(t.lineDashOffset=-o*40*s.speed)}function Ut(t,a,o,c,s,l={}){const r=s.lut,u=s.arrow||{},f=u.w??1,b=u.speed??1,h=u.glow??1,d=l.pulse??1,e=o/256,i=e*(l.scale??1),n=a/2,M=c*.9*b%1,P=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,M/.55),T=l.prog!=null?1:M>.88?(1-M)/.12:1;t.clearRect(0,0,a,o);const w=T*(.45+.55*d),R=o-24*e,_=58*e,L=R+(_-R)*P,x=(A,k)=>r(A).replace("rgb(","rgba(").replace(")",`,${k.toFixed(3)})`),p=1.1*i*f,m=13*i*f,S=42*i*(.7+.3*f),D=!l.noTip&&P>.28?Math.min(1,(P-.28)/.22)*S*.42:0,I=L+D,C=t.createLinearGradient(0,R,0,I);if(C.addColorStop(0,x(.55,0)),C.addColorStop(.18,x(.64,.3*w)),C.addColorStop(.4,x(.76,.8*w)),C.addColorStop(.65,x(.88,.98*w)),C.addColorStop(1,x(.97,w)),t.save(),t.filter=`blur(${7*i}px)`,t.globalAlpha=l.dots?.3:.55,t.fillStyle=C,l.dots){const A=Math.abs(I-R),k=Math.max(3,Math.round(A/(13*i)));for(let v=0;v<k;v++){const F=(v+.5)/k,E=R+(I-R)*F,U=(p/2+(m/2-p/2)*F)*1.5;t.beginPath(),t.arc(n,E,Math.max(1.4*i,U),0,Math.PI*2),t.fill()}}else t.beginPath(),t.moveTo(n-p,R),t.lineTo(n+p,R),t.lineTo(n+m*.95,I),t.lineTo(n-m*.95,I),t.closePath(),t.fill();if(t.restore(),t.globalAlpha=1,t.fillStyle=C,l.dots){const A=Math.abs(I-R),k=Math.max(3,Math.round(A/(13*i)));for(let v=0;v<k;v++){const F=(v+.5)/k,E=R+(I-R)*F,U=(p/2+(m/2-p/2)*F)*.92;t.beginPath(),t.arc(n,E,Math.max(.9*i,U),0,Math.PI*2),t.fill()}}else t.beginPath(),t.moveTo(n-p/2,R),t.lineTo(n+p/2,R),t.lineTo(n+m/2,I),t.lineTo(n-m/2,I),t.closePath(),t.fill();if(t.globalAlpha=w,P>.28&&!l.noTip){const A=S,k=Math.min(1,(P-.28)/.22)*w,v=L+A*.3;t.globalAlpha=k;const F={color:r(.95),glowColor:r(.85),glow:12*h};s.glyph&&(s.glyph(t,"LIFT_TIP",n,v,A,F)||s.glyph(t,"TIP_TRI",n,v,A*.93,F))||(t.strokeStyle=r(.95),t.lineWidth=13*i*f,t.lineCap="round",t.lineJoin="round",t.shadowColor=r(.9),t.shadowBlur=18*i*h,t.beginPath(),t.moveTo(n-26*i,v+14*i),t.lineTo(n,v-16*i),t.lineTo(n+26*i,v+14*i),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function It(t,a,o,c,s,l,r={}){const u=l.lut,f=l.arrow||{},b=f.w??1,h=f.glow??1,d=o/256*(r.scale??1);t.clearRect(0,0,a,o);const e=c.map(([x,p])=>[x*a,p*o]);if(e.length<2)return;const i=48,n=[],M=x=>{if(e.length===2)return[e[0][0]+(e[1][0]-e[0][0])*x,e[0][1]+(e[1][1]-e[0][1])*x];const p=x*(e.length-1),m=Math.min(e.length-2,Math.floor(p)),S=p-m,D=e[Math.max(0,m-1)],I=e[m],C=e[m+1],A=e[Math.min(e.length-1,m+2)],k=(v,F,E,U)=>.5*(2*F+(-v+E)*S+(2*v-5*F+4*E-U)*S*S+(-v+3*F-3*E+U)*S*S*S);return[k(D[0],I[0],C[0],A[0]),k(D[1],I[1],C[1],A[1])]};for(let x=0;x<=i;x++)n.push(M(x/i));const P=Math.max(0,Math.min(1,r.prog!=null?r.prog:s*.55%1)),T=Math.max(1,Math.round(i*P)),w=r.alpha??1,R=r.tail??.22;t.lineCap="round";const _=42*d*(.7+.3*b);let L=T;if(P>.28){let x=0;const p=_*.42*Math.min(1,(P-.28)/.22);for(;L>1&&x<p;)x+=Math.hypot(n[L][0]-n[L-1][0],n[L][1]-n[L-1][1]),L--}for(const x of[0,1])for(let p=1;p<=L;p++){const m=p/T,S=Math.min(1,m/R),D=S*S*(3-2*S)*w;t.globalAlpha=x?D:D*.16*m,t.strokeStyle=u(.55+.42*m),t.lineWidth=(1.1+11.9*m)*d*b*(x?1:1.9),t.beginPath(),t.moveTo(n[p-1][0],n[p-1][1]),t.lineTo(n[p][0],n[p][1]),t.stroke()}if(P>.28){const x=n[Math.max(0,T-2)][0],p=n[Math.max(0,T-2)][1],m=Math.atan2(n[T][1]-p,n[T][0]-x)+Math.PI/2,S=n[T][0]-Math.sin(m)*_*.3,D=n[T][1]+Math.cos(m)*_*.3;t.save(),t.translate(S,D),t.rotate(m),t.globalAlpha=Math.min(1,(P-.28)/.22)*w;const I={color:u(.95),glowColor:u(.85),glow:12*h};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,_,I)||l.glyph(t,"TIP_TRI",0,0,_*.93,I))||(t.strokeStyle=u(.95),t.lineWidth=9*d*b,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*d,12*d),t.lineTo(0,-14*d),t.lineTo(18*d,12*d),t.stroke()),t.restore()}t.globalAlpha=1}function vt(t,a,o,c,s,l){s=s||{};const r=l.lut,u=s.style||l.arrow.line,f=!!s.closed,b=[0];for(let i=1;i<a.length;i++)b.push(b[i-1]+Math.hypot(a[i][0]-a[i-1][0],a[i][1]-a[i-1][1]));const h=b[b.length-1]||1,d=i=>{i=(i%h+h)%h;let n=1;for(;n<b.length-1&&b[n]<i;)n++;const M=(i-b[n-1])/Math.max(1e-4,b[n]-b[n-1]);return[a[n-1][0]+(a[n][0]-a[n-1][0])*M,a[n-1][1]+(a[n][1]-a[n-1][1])*M,Math.atan2(a[n][1]-a[n-1][1],a[n][0]-a[n-1][0])]},e=l.arrow;if(u==="chevron"){const i=(26*c+8)*e.gap,n=Math.max(2,Math.floor(h/i));t.shadowColor=r(Math.min(1,e.heat+.2)),t.shadowBlur=8*c*e.glow;for(let M=0;M<n;M++){const P=M*i+o*42*e.speed%i;if(!f&&P>h-4)continue;const[T,w,R]=d(P),_=7.5*c,L=8.5*c,x=.45+.4*Math.sin(P/h*6.283-o*2.2*e.speed);t.strokeStyle=r(e.heat-.05+x*.3),t.lineWidth=3.2*c,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(T,w),t.rotate(R),t.beginPath(),t.moveTo(-L*.5,-_),t.lineTo(L*.5,0),t.lineTo(-L*.5,_),t.stroke(),t.restore()}return!0}if(u==="comet"){const i=o*.35*e.speed%1*h,n=h*e.tail,M=Math.max(24,a.length*2);t.lineCap="round";for(let w=0;w<M;w++){const R=i-w/M*n,_=i-(w+1)/M*n;if(!f&&_<0)break;const L=1-w/M,[x,p]=d(R),[m,S]=d(_);!f&&Math.hypot(m-x,S-p)>h*.4||(t.globalAlpha=Math.pow(L,1.6),t.strokeStyle=r(Math.max(.05,e.heat-.2)+L*.55),t.lineWidth=(1.5+L*4.5)*c,L>.72?(t.shadowColor=r(Math.min(1,e.heat+.3)),t.shadowBlur=L*12*c*e.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(x,p),t.lineTo(m,S),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[P,T]=d(i);return t.fillStyle=rgba(X.ink,.95),t.shadowColor=r(.9),t.shadowBlur=16*c,t.beginPath(),t.arc(P,T,2.6*c,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=s.color||r(e.heat),t.shadowColor=r(Math.min(1,e.heat+.15)),t.shadowBlur=(s.glow??8)*c*e.glow,u==="taper")for(let i=1;i<a.length;i++)t.lineWidth=(.5+i/a.length*4.5)*c,t.beginPath(),t.moveTo(a[i-1][0],a[i-1][1]),t.lineTo(a[i][0],a[i][1]),t.stroke();else Ct(t,c,o,l),t.beginPath(),a.forEach(([i,n],M)=>M?t.lineTo(i,n):t.moveTo(i,n)),f&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function Ht(t,a,o,c,s,l){const r=13*c.halo,u=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const f=a/220,b=a/2,h=18*o.round*f,d=40*f,e=48*f,i=a-80*f,n=a-96*f,M=[],P=(w,R,_,L)=>{for(let x=0;x<=1;x+=.12)M.push([w+(_-w)*x,R+(L-R)*x])};P(d+h,e,d+i-h,e),P(d+i,e+h,d+i,e+n-h),P(d+i-h,e+n,d+h,e+n),P(d,e+n-h,d,e+h),t.shadowColor=u(.6),t.shadowBlur=r*.8;const T=4*l.arrow.w*f;if(l.arrow.line==="solid"?(t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-s*22*f,t.strokeStyle=u(.45),t.lineWidth=T,t.beginPath(),t.roundRect(d,e,i,n,h),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):vt(t,M,s,l.arrow.w*f,{color:u(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const w=[],R=(C,A,k,v,F)=>{for(let E=1;E<=F;E++)w.push([C+(k-C)*E/F,A+(v-A)*E/F])},_=(C,A,k,v,F)=>{for(let E=1;E<=F;E++){const U=k+(v-k)*E/F;w.push([C+h*Math.cos(U),A+h*Math.sin(U)])}},L=Math.PI/2,x=d+i,p=e+n,m=d+i/2;w.push([m,e]),R(m,e,x-h,e,8),_(x-h,e+h,-L,0,6),R(x,e+h,x,p-h,10),_(x-h,p-h,0,L,6),R(x-h,p,d+h,p,14),_(d+h,p-h,L,Math.PI,6),R(d,p-h,d,e+h,10),_(d+h,e+h,Math.PI,Math.PI+L,6),R(d+h,e,m,e,8);let S=0;for(let C=1;C<w.length;C++)S+=Math.hypot(w[C][0]-w[C-1][0],w[C][1]-w[C-1][1]);const D=S*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-(i/2-h)-s*22*f,t.strokeStyle=u(.9),t.lineWidth=T*1.3,t.lineCap="round",t.shadowColor=u(.92),t.shadowBlur=r*1.3,t.beginPath(),t.moveTo(w[0][0],w[0][1]);let I=0;for(let C=1;C<w.length&&I<D;C++){const A=Math.hypot(w[C][0]-w[C-1][0],w[C][1]-w[C-1][1]);if(I+A<=D)t.lineTo(w[C][0],w[C][1]),I+=A;else{const k=(D-I)/A;t.lineTo(w[C-1][0]+(w[C][0]-w[C-1][0])*k,w[C-1][1]+(w[C][1]-w[C-1][1])*k),I=D}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&l.foot&&(l.foot(t,!1,b-16*o.feet*f,b+6*f,26*o.feet*f),l.foot(t,!0,b+16*o.feet*f,b+6*f,26*o.feet*f)),t.shadowBlur=0}function Wt(t,a,o,c,s,l,r,u){const f=13*c.halo,b=4*l.arrow.w*(a/220),h=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const d=a/220,e=r||[[45*d,130*d],[110*d,60*d],[175*d,110*d]],i=u??s*.5%1,n=Math.min(1,i*1.25)*(e.length-1),M=Math.min(e.length-1,Math.floor(n+.35));t.shadowColor=h(.7),t.shadowBlur=f;const P=p=>{const m=Math.max(0,Math.min(e.length-2,Math.floor(p))),S=p-m;return[e[m][0]+(e[m+1][0]-e[m][0])*S,e[m][1]+(e[m+1][1]-e[m][1])*S]},T=o.comet!=null?o.comet:1,w=o.tailLen!=null?o.tailLen:.5;if(t.save(),t.shadowBlur=0,t.globalAlpha=o.rail!=null?o.rail:.22,t.strokeStyle=h(.6),t.lineWidth=2.2*d,t.lineCap="round",t.setLineDash([.01,8*d]),t.beginPath(),e.forEach(([p,m],S)=>S?t.lineTo(p,m):t.moveTo(p,m)),t.stroke(),t.setLineDash([]),t.restore(),n>.02){const p=(m,S)=>h(m).replace("rgb(","rgba(").replace(")",`,${S.toFixed(3)})`);for(let m=0;m<26;m++){const S=m/25,D=n-w*S;if(D<=0)break;const I=P(D),C=4.7*d*T*(1-S*.75),A=C*2.1,k=(1-S)*(1-S)*.8,v=t.createRadialGradient(I[0],I[1],0,I[0],I[1],A);v.addColorStop(0,p(.55-.18*S,k)),v.addColorStop(.5,p(.5-.18*S,k*.35)),v.addColorStop(1,p(.45-.18*S,0)),t.save(),t.shadowBlur=0,t.globalAlpha=1,t.fillStyle=v,t.beginPath(),t.arc(I[0],I[1],A,0,Math.PI*2),t.fill(),t.restore()}if(n<e.length-1-.001&&n-Math.floor(n)>.03){const m=P(n);t.save(),t.fillStyle=h(.62),t.shadowColor=h(.8),t.shadowBlur=11*d*T,t.beginPath(),t.arc(m[0],m[1],5.6*d*T,0,Math.PI*2),t.fill(),t.fillStyle=h(.95),t.globalAlpha=.95,t.beginPath(),t.arc(m[0],m[1],2.1*d*T,0,Math.PI*2),t.fill(),t.restore()}}t.globalAlpha=1,t.lineCap="butt";const R=o.done!=null,_=o.done||0,L=o.vd||[],x=o.acc!=null?o.acc:e.length-1;if(e.forEach(([p,m],S)=>{const D=S<_,I=L[S]||null,C=!D&&S===M&&!R,A=C?1+Math.sin(s*6)*.14:1,k=o.pop!=null&&S===_-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,v=12*o.node*A*k*d*(S===x?1.34:1);D&&I!=="miss"&&(t.shadowBlur=f*1.4,t.shadowColor=h(.5),t.fillStyle=h(I==="near"?.5:.36),t.beginPath(),t.arc(p,m,v*.88,0,Math.PI*2),t.fill()),D||(t.save(),t.translate(p,m),d0(t,h,v,C?.8:.5,C?.9:.5,b*.9,f),t.restore()),t.strokeStyle=I==="hit"?W.prism:I==="near"?W.sand:I==="miss"?X.lo:h(D?.62:C?.8:.45),t.lineWidth=b*(C?1.3:I?1.15:.9),t.shadowBlur=C?f*1.6:I&&I!=="miss"?f*1.3:f*.6,I&&I!=="miss"&&(t.shadowColor=I==="hit"?W.prism:W.sand),t.beginPath(),t.arc(p,m,v,0,Math.PI*2),t.stroke(),l.num&&(D&&I!=="miss"?(t.save(),t.globalCompositeOperation="destination-out",t.shadowBlur=0,l.num(t,String(S+1),p,m,16*o.numS*A*d,Math.round(14*o.numS*d)),t.restore()):(t.globalAlpha=S<=M?1:.6,l.num(t,String(S+1),p,m,16*o.numS*A*d,Math.round(14*o.numS*d)),t.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&_>0&&e[_-1]){const[p,m]=e[_-1],S=1-o.pop/.38,D=S*S,I=12*o.node*d*(_-1===(o.acc!=null?o.acc:e.length-1)?1.34:1);t.save();const C=I*(1.6+1.9*(1-S)),A=t.createRadialGradient(p,m,0,p,m,C);A.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*D).toFixed(3)})`),A.addColorStop(.35,h(.92).replace("rgb(","rgba(").replace(")",`,${(.8*D).toFixed(3)})`)),A.addColorStop(1,h(.7).replace("rgb(","rgba(").replace(")",",0)")),t.fillStyle=A,t.beginPath(),t.arc(p,m,C,0,Math.PI*2),t.fill(),t.strokeStyle=h(.92),t.globalAlpha=D,t.lineWidth=Math.max(1,6*d*S),t.shadowColor=h(.85),t.shadowBlur=24*d*D,t.beginPath(),t.arc(p,m,I*(1.1+3.4*(1-S)),0,Math.PI*2),t.stroke();const k=Math.max(0,S-.35)/.65;k>0&&(t.globalAlpha=k*k*.6,t.lineWidth=Math.max(1,3.5*d*k),t.beginPath(),t.arc(p,m,I*(1.1+2*(1-k)),0,Math.PI*2),t.stroke()),t.restore()}t.shadowBlur=0}function d0(t,a,o,c,s,l,r,u=1){if(o<=.6)return;const f=(i,n)=>a(i).replace("rgb(","rgba(").replace(")",`,${n})`),b=l*2.6*u,h=Math.max(.1,o-b),d=o+b,e=t.createRadialGradient(0,0,h,0,0,d);e.addColorStop(0,f(c-.05,0)),e.addColorStop(.5,f(c,s*.85)),e.addColorStop(1,f(c-.05,0)),t.globalAlpha=1,t.fillStyle=e,t.shadowBlur=0,t.beginPath(),t.arc(0,0,d,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,s*1.1),t.lineWidth=l*.85,t.strokeStyle=a(Math.min(.98,c+.12)),t.shadowColor=a(.88),t.shadowBlur=r*.6,t.beginPath(),t.arc(0,0,o,0,Math.PI*2),t.stroke(),t.shadowBlur=0}function qt(t,a,o,c,s,l,r){const u=l.lut,f=13*c.halo,b=a/220,h=a/2,d=l.arrow&&l.arrow.w||1,e=(x,p)=>u(x).replace("rgb(","rgba(").replace(")",`,${p})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const i=(o.r!=null?o.r:.42)*a,n=i*(o.rt!=null?o.rt:.36),M=3.4*d*b,P=r!=null?Math.max(0,Math.min(1,r)):s*(o.tempo||.6)%1,T=Math.pow(P,1.6),w=Math.max(0,(P-.9)/.1);t.save(),t.translate(h,h);const R=(x,p,m,S=1)=>d0(t,u,x,p,m,M,f,S),_=t.createRadialGradient(0,0,0,0,0,n*1.08);_.addColorStop(0,e(.6,.1+.18*w)),_.addColorStop(.65,e(.5,.05+.08*w)),_.addColorStop(1,e(.5,0)),t.globalAlpha=1,t.fillStyle=_,t.beginPath(),t.arc(0,0,n*1.08,0,Math.PI*2),t.fill();const L=1+.02*Math.sin(s*2.6);R(n*L,.55+.4*w,.5+.45*w,.9);for(let x=2;x>=0;x--){const p=Math.pow(Math.max(0,P-x*.05),1.6),m=i-(i-n)*p,S=x===0?.6+.4*T:.18/x*(1-w);R(m,.55+.4*T,S*(1-w*.45),1.15-.35*T)}w>.01&&R(n*(1+1.4*w),.9,(1-w)*.8,1.1),t.globalAlpha=.6+.3*w,t.shadowColor=u(.85),t.shadowBlur=f*(.9+w),t.fillStyle=u(.62+.3*w),t.beginPath(),t.arc(0,0,M*.85+3*b*w,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function gt(t,a,o,c,s,l,r,u){const f=l.lut,b=13*c.halo,h=a/220,d=a/2,e=l.arrow&&l.arrow.w||1,i=e*h,n=(y,B)=>f(y).replace("rgb(","rgba(").replace(")",","+B+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const M=a*.42*(o.spread!=null?o.spread:1),T=(u||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([y,B])=>[d+y*M,d+B*M]),w=80,R=[];for(let y=0;y<=w;y++){const B=y/w*(T.length-1),G=Math.min(T.length-2,Math.floor(B)),H=B-G,q=T[Math.max(0,G-1)],K=T[G],t0=T[G+1],a0=T[Math.min(T.length-1,G+2)],o0=(j,J,Y,e0)=>.5*(2*J+(-j+Y)*H+(2*j-5*J+4*Y-e0)*H*H+(-j+3*J-3*Y+e0)*H*H*H);R.push([o0(q[0],K[0],t0[0],a0[0]),o0(q[1],K[1],t0[1],a0[1])])}const _=y=>{const B=Math.max(0,Math.min(w,y*w)),G=Math.floor(B),H=B-G,q=R[G],K=R[Math.min(w,G+1)];return[q[0]+(K[0]-q[0])*H,q[1]+(K[1]-q[1])*H]},L=.68;let x,p,m;if(r!=null)x=Math.max(0,Math.min(1,r)),p=1,m=0;else{const y=s*(o.tempo||.42)%1;if(y<L)x=y/L,p=1,m=0;else{const B=(y-L)/(1-L);x=1,p=1-B*B,m=B}}if(p<=.012)return;const S=x*x*x*(x*(6*x-15)+10),D=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const I=.36*(o.tail!=null?o.tail:1),C=o.width!=null?o.width:1;{const y=t.createLinearGradient(R[0][0],R[0][1],R[w][0],R[w][1]);y.addColorStop(0,n(.46,0)),y.addColorStop(.3,n(.46,.03*p)),y.addColorStop(.8,n(.46,.045*p)),y.addColorStop(1,n(.46,0)),t.globalAlpha=1,t.strokeStyle=y,t.lineWidth=9*i,t.shadowColor=f(.6),t.shadowBlur=b*2,t.beginPath(),R.forEach(([B,G],H)=>H?t.lineTo(B,G):t.moveTo(B,G)),t.stroke(),t.shadowBlur=0}const A=40,k=Math.max(0,S-I*(1-m)),v=[];for(let y=0;y<=A;y++)v.push(_(k+(S-k)*(y/A)));const F=()=>{t.beginPath(),v.forEach(([y,B],G)=>G?t.lineTo(y,B):t.moveTo(y,B)),t.stroke()},E=()=>{const y=t.createLinearGradient(v[0][0],v[0][1],v[A][0],v[A][1]);return y.addColorStop(0,n(.55,0)),y.addColorStop(.4,n(.56,0)),y.addColorStop(.68,n(.6,.09)),y.addColorStop(.88,n(.64,.24)),y.addColorStop(1,n(.68,.44)),y},U=1+.5*D;t.globalAlpha=p,t.strokeStyle=E(),t.lineWidth=(20+10*D)*i*C,t.shadowColor=f(.72),t.shadowBlur=b*2.2,F(),t.strokeStyle=E(),t.lineWidth=(10+5*D)*i*C,t.shadowBlur=b*1,F(),t.shadowBlur=0;for(let y=1;y<=A;y++){const B=y/A;t.globalAlpha=Math.pow(B,2.2)*.95*p,t.strokeStyle=f(.55+.38*B),t.lineWidth=(1.6+6.5*Math.pow(B,.7))*i*C*U,t.beginPath(),t.moveTo(v[y-1][0],v[y-1][1]),t.lineTo(v[y][0],v[y][1]),t.stroke()}const V=v[A][0],N=v[A][1];t.globalAlpha=.8*p,t.fillStyle=f(.6),t.shadowColor=f(.8),t.shadowBlur=b*1.6,t.beginPath(),t.arc(V,N,(9+5*D)*i*C,0,Math.PI*2),t.fill(),t.globalAlpha=p,t.fillStyle=f(.93),t.shadowBlur=b*.6,t.beginPath(),t.arc(V,N,(3.4+1.8*D)*i*C,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function Kt(t,a,o,c,s,l,r){const u=o.r!=null?o.r:.3,f=o.dir!=null?o.dir:1,b=(o.sweep!=null?o.sweep:.66)*Math.PI*2,h=r??s*(o.tempo!=null?o.tempo:.5)%1,d=-Math.PI/2+f*h*Math.PI*2,e=16,i=[];for(let n=0;n<=e;n++){const M=d-f*(1-n/e)*b;i.push([.5+Math.cos(M)*u,.5+Math.sin(M)*u])}It(t,a,a,i,s,l,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}function $t(t,a,o,c,s,l,r={}){const u=Math.max(2,Math.round(r.count??7)),f=r.r??4.4,b=r.flow??.35,h=r.hair??.26,d=r.style||"chain",e=r.color||"255,246,234",i=r.inset??.12,n=r.alpha??1,M=c-a,P=s-o,T=Math.hypot(M,P);if(T<.001||n<=.004)return;const w=M/T,R=P/T,_=a+M*i,L=o+P*i,x=T*(1-i*2);if(x<=0)return;t.save(),d==="chain"&&h>0&&(t.strokeStyle=`rgba(${e},${(h*n).toFixed(3)})`,t.lineWidth=Math.max(1,f*.34),t.beginPath(),t.moveTo(_,L),t.lineTo(_+w*x,L+R*x),t.stroke());const p=l*b%1;for(let m=0;m<u;m++){let S=(m+.5)/u;if(d==="pulse"||d==="dots"||d==="chain"){const v=S-.5;if(S=.5+v+Math.sign(v)*(p/u%(1/u)),S<0||S>1)continue}const D=_+w*x*S,I=L+R*x*S,C=Math.abs(S-.5)*2;let A=f,k=n;if(d==="taper"&&(A=f*(.55+.75*C)),d==="pulse"){const v=((C-p)%1+1)%1;k=n*(.35+.65*Math.max(0,1-Math.abs(v-0)*3))}t.fillStyle=`rgba(${e},${(k*.96).toFixed(3)})`,t.beginPath(),t.arc(D,I,A,0,Math.PI*2),t.fill()}t.restore()}export{Et as C,c0 as G,xt as L,Dt as M,Gt as P,yt as Q,Ft as R,Tt as S,Lt as Z,$ as a,St as b,qt as c,_t as d,Kt as e,Ut as f,gt as g,$t as h,kt as i,Wt as j,At as k,Rt as l,Ht as m,Bt as n,Ot as o,Z as p,vt as q,It as r,i0 as s,Pt as t};
