const K={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},t0={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},p0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],$t=Object.fromEntries(Object.entries({...K,...t0}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),N=t=>`vec3(${p0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,zt=(t,a=1)=>`rgba(${p0(t).join(",")},${a})`,S0=[[K.red,0],[K.red,.3],[K.coral,.56],[K.sand,.86],[K.prism,1]],b0=1;function C0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(t0).some(o=>o.toUpperCase()===a)?!0:Object.values(K).some(o=>o.toUpperCase()===a)}function jt(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>C0(o)))&&(t.stops=S0.map(o=>[...o])),t.sat=b0,t)}const v0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",M0=.98,A0=.81,y0=-.043,T0=-.056,I0=5.5,L0=.027,P0=.25,R0=.26,k0=.3,F0=.74,_0=.038,D0=.55,B0=24,E0=1,G0=1.6,H0=.45,O0=.82,U0=0,W0=.5,q0=.5,K0=.125,$0=.4,z0=1,j0=1.4,X0=0,Y0=0,J0=3.4,Q0=.01,Z0=0,g0=.011,V0=-2,N0=.8,tt=-.085,ot=.16,at=4,et=.6,lt=0,nt=1,st="glow",rt="normal",it="offbit",ct=.55,dt=.125,ht=0,ut=4,pt=4,ft=0,mt=1,xt=.55,wt={punchLine:{node:1,numS:1,comet:1,tailLen:.5,rail:.22}},St=-.095,bt=.12,Ct=10,vt=-.015,Mt=.12,At=-10,yt={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15},Tt=.98,It=4,Lt={0:{sharp:0},1:{},2:{w:1.8,halo:.5,glow:.15,imp:0,dot:.2,pitch:.03,shade:0,sharp:.65,edge:.038,dotCol:4,rip:0},4:{glow:0,halo:.14,w:.7,shade:0,imp:0,edgeShadeGrad:0,pitch:.048,dot:.13,irot:21,dotCol:4,edge:.004,sharp:0,plantar:1,edgeShadeCol:4},tap:{op:.1,imp:0,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.7,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.028,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.26,w:1.15}},Pt=.45,Rt=.06,kt=.55,Ft={_:"움직임 튜닝(markmotion.js 가 읽는다). 상태 8토큰과 직교 — 여기는 '어떻게 움직이나'만.",stepLead:.3,slideDecay:3,over:.14,overAt:.78,settle:.11,settleHz:2.4,popA:.16,popB:.18,popBAt:.11,airScale:.12,spawnDur:.44,hitDur:.34,arrowRamp:.16,arrowBreath:.06},_t=0,Dt=0,Bt=.35,Et={_:v0,imp:M0,scale:A0,offx:y0,offy:T0,irot:I0,pitch:L0,dot:P0,glow:R0,shade:k0,sharp:F0,edge:_0,plantar:D0,bands:B0,bandSoft:E0,w:G0,halo:H0,pool:O0,noise:U0,rip:W0,ripReach:q0,ripWidth:K0,ripSpeed:$0,ripGrad:z0,edgeShade:j0,dotMode:X0,shadeRed:Y0,shadeRedW:J0,edgeW:Q0,edgeSoft:Z0,dither:g0,tilt:V0,gsize:N0,gx:tt,gy:ot,grot:at,gsh:et,shadeCol:lt,ripCol:nt,gShadow:st,gBlend:rt,numSrc:it,prog:ct,bloom:dt,blur:ht,edgeShadeW:ut,edgeShadeCol:pt,edgeShadeGrad:ft,edgeShadeG0:mt,edgeShadeG1:xt,prims:wt,gxL:St,gyL:bt,grotL:Ct,gxR:vt,gyR:Mt,grotR:At,tap:yt,op:Tt,dotCol:It,states:Lt,loadGain:Pt,loadBase:Rt,flow:kt,motion:Ft,tLo:_t,tHi:Dt,inkFloor:Bt};function c0(t,a,o,d,i){let l=0;o[0]=0,d[0]=-1e20,d[1]=1e20;for(let e=1;e<i;e++){let c=(t[e]+e*e-(t[o[l]]+o[l]*o[l]))/(2*e-2*o[l]);for(;c<=d[l];)l--,c=(t[e]+e*e-(t[o[l]]+o[l]*o[l]))/(2*e-2*o[l]);l++,o[l]=e,d[l]=c,d[l+1]=1e20}l=0;for(let e=0;e<i;e++){for(;d[l+1]<e;)l++;a[e]=(e-o[l])*(e-o[l])+t[o[l]]}}function d0(t,a){const o=new Float32Array(a),d=new Int32Array(a),i=new Float32Array(a+1),l=new Float32Array(a);for(let e=0;e<a;e++){for(let c=0;c<a;c++)l[c]=t[c*a+e];c0(l,o,d,i,a);for(let c=0;c<a;c++)t[c*a+e]=o[c]}for(let e=0;e<a;e++){for(let c=0;c<a;c++)l[c]=t[e*a+c];c0(l,o,d,i,a);for(let c=0;c<a;c++)t[e*a+c]=o[c]}}function f0(t,a){const d=new Float32Array(a*a),i=new Float32Array(a*a);let l=0,e=0,c=0;for(let v=0;v<a*a;v++){const u=t[v*4+3]/255;d[v]=u>=1?0:u<=0?1e20:Math.pow(Math.max(0,.5-u),2),i[v]=u>=1?1e20:u<=0?0:Math.pow(Math.max(0,u-.5),2),u>.5&&(l+=v%a,e+=v/a|0,c++)}d0(d,a),d0(i,a);const h=new Float32Array(a*a);for(let v=0;v<a*a;v++)h[v]=(Math.sqrt(d[v])-Math.sqrt(i[v]))/a;return{data:h,N:a,cx:c?l/c/a:.5,cy:c?e/c/a:.5}}const Gt={get k(){if(typeof window>"u")return 1;const t=+new URLSearchParams(location.search).get("fxq"),a=+window.__FXQ||t||1;return Math.min(4,Math.max(1,a))}};function r0(t,a=512*Gt.k){const o="_raster"+a;if(t[o])return t[o];const d=document.createElement("canvas");d.width=d.height=a;const i=d.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);i.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const e=i.getImageData(0,0,a,a).data;let c=a,h=a,v=-1,u=-1;for(let x=0;x<a;x++)for(let r=0;r<a;r++)e[(x*a+r)*4+3]>8&&(r<c&&(c=r),r>v&&(v=r),x<h&&(h=x),x>u&&(u=x));return t[o]=v<0?{canvas:d,x:0,y:0,w:a,h:a}:{canvas:d,x:c,y:h,w:v-c+1,h:u-h+1},t[o]}function Xt(t,a,o=!1){const d=r0(t,a),i=document.createElement("canvas");i.width=i.height=a;const l=i.getContext("2d"),e=Math.min(a*a0/d.w,a*a0/d.h),c=d.w*e,h=d.h*e;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(d.canvas,d.x,d.y,d.w,d.h,(a-c)/2,(a-h)/2,c,h),f0(l.getImageData(0,0,a,a).data,a)}function Yt(t,a,o,d=!1){const i=r0(t,o),l=a?r0(a,o):null,e=Math.min(o*a0/i.w,o*a0/i.h),c=i.w*e,h=i.h*e,v=(o-c)/2,u=(o-h)/2,x=A=>{const B=document.createElement("canvas");B.width=B.height=o;const D=B.getContext("2d");return d&&(D.translate(0,o),D.scale(1,-1)),D.drawImage(A.canvas,i.x,i.y,i.w,i.h,v,u,c,h),f0(D.getImageData(0,0,o,o).data,o)},r=x(i),n=l?x(l):null,s=new Float32Array(o*o*2);for(let A=0;A<o*o;A++)s[A*2]=r.data[A],s[A*2+1]=n?n.data[A]:1;return{data:s,N:o,cx:r.cx,cy:r.cy,inCx:n?n.cx:r.cx,inCy:n?n.cy:r.cy,hasInner:!!n}}const Jt=1.9922,Ht=.78,a0=.52,Qt=Ht/a0,Zt=1.18,g=Et||{},m0={size:g.gsize??.85,gx:g.gx??-.025,gy:g.gy??.195,rot:g.grot??6,gxL:g.gxL,gyL:g.gyL,rotL:g.grotL,gxR:g.gxR,gyR:g.gyR,rotR:g.grotR,shadow:g.gShadow??"glow",shadowK:g.gsh??.75,blend:g.gBlend??"add"};function gt(t,a=m0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function Vt(t,a,o,d,i=m0){const l=Math.round(o*.75),e=i.shadow==="none"?0:i.shadowK??.75,c=h=>d(t,String(a),o/2,o/2,l,h);return i.shadow==="drop"&&e>.001?(t.save(),t.globalAlpha=Math.min(1,e*.7),t.translate(o*.018,o*.024),c({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),c({glow:0,glowColor:"rgba(0,0,0,0)"})):c(i.shadow==="glow"?{glow:26*e,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),i.blend==="knock"}function Nt(t,a){const o=t.getImageData(0,0,a,a),d=t.createImageData(a,a);for(let i=0;i<a*a;i++){const l=o.data[i*4+3]/255,e=Math.round(255*(1-l));d.data[i*4]=d.data[i*4+1]=d.data[i*4+2]=e,d.data[i*4+3]=255}t.putImageData(d,0,0)}const to={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},n0=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),s0=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function h0(t,a,o){t=n0(t),a=n0(a),o=n0(o);const d=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),i=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*d+.793617785*i-.0040720468*l,1.9779984951*d-2.428592205*i+.4505937099*l,.0259040371*d+.7827717662*i-.808675766*l]}function Ot(t,a,o){const d=(t+.3963377774*a+.2158037573*o)**3,i=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[s0(4.0767416621*d-3.3077115913*i+.2309699292*l),s0(-1.2684380046*d+2.6097574011*i-.3413193965*l),s0(-.0041960863*d-.7034186147*i+1.707614701*l)]}const u0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function oo(t,a=1,o=new Uint8Array(256*4)){const d=[...t].sort((i,l)=>i[1]-l[1]);for(let i=0;i<256;i++){const l=i/255;let e=0;for(;e<d.length-2&&l>d[e+1][1];)e++;const[c,h]=d[e],[v,u]=d[e+1],x=Math.max(0,Math.min(1,(l-h)/Math.max(1e-5,u-h))),r=h0(...u0(c)),n=h0(...u0(v)),s=Ot(r[0]+(n[0]-r[0])*x,(r[1]+(n[1]-r[1])*x)*a,(r[2]+(n[2]-r[2])*x)*a);o.set([...s,255],i*4)}return o}const ao=`
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function Ut(t,a,o,d){t.lineWidth=4*a;const i=d.arrow;i.line==="dash"?t.setLineDash([12*a*i.gap,10*i.gap]):i.line==="dot"?(t.setLineDash([.5,12*i.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&i.line!=="solid"&&i.line!=="taper"&&(t.lineDashOffset=-o*40*i.speed)}function so(t,a,o,d,i,l={}){const e=i.lut,c=i.arrow||{},h=c.w??1,v=c.speed??1,u=c.glow??1,x=l.pulse??1,r=o/256,n=r*(l.scale??1),s=a/2,A=d*.9*v%1,B=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,A/.55),D=l.prog!=null?1:A>.88?(1-A)/.12:1;t.clearRect(0,0,a,o);const f=D*(.45+.55*x),I=o-24*r,L=58*r,R=I+(L-I)*B,M=(y,W)=>e(y).replace("rgb(","rgba(").replace(")",`,${W.toFixed(3)})`),w=1.1*n*h,m=13*n*h,b=42*n*(.7+.3*h),F=!l.noTip&&B>.28?Math.min(1,(B-.28)/.22)*b*.42:0,T=R+F,C=t.createLinearGradient(0,I,0,T),_=y=>Math.max(.02,Math.min(.99,y+((c.heat??.5)-.5)*1.1));C.addColorStop(0,M(_(.55),0)),C.addColorStop(.18,M(_(.64),.3*f)),C.addColorStop(.4,M(_(.76),.8*f)),C.addColorStop(.65,M(_(.88),.98*f)),C.addColorStop(1,M(_(.97),f));const G=l.dots?(()=>{const y=Math.abs(T-I),W=Math.max(3,Math.round(y/(9.5*n))),q=d*1.15*v%1,Y=(P,p,k)=>{const E=Math.max(0,Math.min(1,(k-P)/(p-P)));return E*E*(3-2*E)},S=[];for(let P=0;P<W;P++){const p=((P+.5)/W+q/W)%1,k=1+.22*Math.sin((p*3-q*2)*Math.PI*2);S.push({y:I+(T-I)*p,r:(w/2+(m/2-w/2)*p)*k,a:(1-.35*Y(.72,.92,p))*(1-Y(.92,1,p))})}return S})():null;if(t.save(),t.filter=`blur(${7*n}px)`,t.globalAlpha=l.dots?.3:.55,t.fillStyle=C,l.dots){const y=t.globalAlpha;for(const W of G)t.globalAlpha=y*W.a,t.beginPath(),t.arc(s,W.y,Math.max(1.4*n,W.r*1.5),0,Math.PI*2),t.fill();t.globalAlpha=y}else t.beginPath(),t.moveTo(s-w,I),t.lineTo(s+w,I),t.lineTo(s+m*.95,T),t.lineTo(s-m*.95,T),t.closePath(),t.fill();if(t.restore(),t.globalAlpha=1,t.fillStyle=C,l.dots){for(const y of G)t.globalAlpha=y.a,t.beginPath(),t.arc(s,y.y,Math.max(.9*n,y.r*.92),0,Math.PI*2),t.fill();t.globalAlpha=1}else t.beginPath(),t.moveTo(s-w/2,I),t.lineTo(s+w/2,I),t.lineTo(s+m/2,T),t.lineTo(s-m/2,T),t.closePath(),t.fill();if(t.fillStyle="rgba(255,255,255,0.94)",l.dots){for(const y of G)t.globalAlpha=y.a*f,t.beginPath(),t.arc(s,y.y,Math.max(.6*n,y.r*.46),0,Math.PI*2),t.fill();t.globalAlpha=1}else{t.save(),t.globalAlpha=.9*f;const y=w*.2,W=m*.3;t.beginPath(),t.moveTo(s-y,I),t.lineTo(s+y,I),t.lineTo(s+W,T),t.lineTo(s-W,T),t.closePath(),t.fill(),t.restore()}if(t.globalAlpha=f,B>.28&&!l.noTip){const y=b,W=Math.min(1,(B-.28)/.22)*f,q=R+y*.3;t.globalAlpha=W;const Y={color:e(_(.95)),glowColor:e(_(.85)),glow:12*u};i.glyph&&(i.glyph(t,"LIFT_TIP",s,q,y,Y)||i.glyph(t,"TIP_TRI",s,q,y*.93,Y))||(t.strokeStyle=e(.95),t.lineWidth=13*n*h,t.lineCap="round",t.lineJoin="round",t.shadowColor=e(.9),t.shadowBlur=18*n*u,t.beginPath(),t.moveTo(s-26*n,q+14*n),t.lineTo(s,q-16*n),t.lineTo(s+26*n,q+14*n),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function Wt(t,a,o,d,i,l,e={}){const c=l.lut,h=l.arrow||{},v=h.w??1,u=h.glow??1,x=w=>Math.max(.02,Math.min(.99,w+((h.heat??.5)-.5)*1.1)),r=o/256*(e.scale??1);t.clearRect(0,0,a,o);const n=d.map(([w,m])=>[w*a,m*o]);if(n.length<2)return;const s=48,A=[],B=w=>{if(n.length===2)return[n[0][0]+(n[1][0]-n[0][0])*w,n[0][1]+(n[1][1]-n[0][1])*w];const m=w*(n.length-1),b=Math.min(n.length-2,Math.floor(m)),F=m-b,T=n[Math.max(0,b-1)],C=n[b],_=n[b+1],G=n[Math.min(n.length-1,b+2)],y=(W,q,Y,S)=>.5*(2*q+(-W+Y)*F+(2*W-5*q+4*Y-S)*F*F+(-W+3*q-3*Y+S)*F*F*F);return[y(T[0],C[0],_[0],G[0]),y(T[1],C[1],_[1],G[1])]};for(let w=0;w<=s;w++)A.push(B(w/s));const D=Math.max(0,Math.min(1,e.prog!=null?e.prog:i*.55%1)),f=Math.max(1,Math.round(s*D)),I=e.alpha??1,L=e.tail??.22;t.lineCap="round";const R=42*r*(.7+.3*v);let M=f;if(D>.28){let w=0;const m=R*.42*Math.min(1,(D-.28)/.22);for(;M>1&&w<m;)w+=Math.hypot(A[M][0]-A[M-1][0],A[M][1]-A[M-1][1]),M--}for(const w of[0,1])for(let m=1;m<=M;m++){const b=m/f,F=Math.min(1,b/L),T=F*F*(3-2*F)*I;t.globalAlpha=w?T:T*.16*b,t.strokeStyle=c(.55+.42*b),t.lineWidth=(1.1+11.9*b)*r*v*(w?1:1.9),t.beginPath(),t.moveTo(A[m-1][0],A[m-1][1]),t.lineTo(A[m][0],A[m][1]),t.stroke()}if(D>.28){const w=A[Math.max(0,f-2)][0],m=A[Math.max(0,f-2)][1],b=Math.atan2(A[f][1]-m,A[f][0]-w)+Math.PI/2,F=A[f][0]-Math.sin(b)*R*.3,T=A[f][1]+Math.cos(b)*R*.3;t.save(),t.translate(F,T),t.rotate(b),t.globalAlpha=Math.min(1,(D-.28)/.22)*I;const C={color:c(x(.95)),glowColor:c(x(.85)),glow:12*u};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,R,C)||l.glyph(t,"TIP_TRI",0,0,R*.93,C))||(t.strokeStyle=c(.95),t.lineWidth=9*r*v,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*r,12*r),t.lineTo(0,-14*r),t.lineTo(18*r,12*r),t.stroke()),t.restore()}t.globalAlpha=1}function qt(t,a,o,d,i,l){i=i||{};const e=l.lut,c=i.style||l.arrow.line,h=!!i.closed,v=[0];for(let n=1;n<a.length;n++)v.push(v[n-1]+Math.hypot(a[n][0]-a[n-1][0],a[n][1]-a[n-1][1]));const u=v[v.length-1]||1,x=n=>{n=(n%u+u)%u;let s=1;for(;s<v.length-1&&v[s]<n;)s++;const A=(n-v[s-1])/Math.max(1e-4,v[s]-v[s-1]);return[a[s-1][0]+(a[s][0]-a[s-1][0])*A,a[s-1][1]+(a[s][1]-a[s-1][1])*A,Math.atan2(a[s][1]-a[s-1][1],a[s][0]-a[s-1][0])]},r=l.arrow;if(c==="chevron"){const n=(26*d+8)*r.gap,s=Math.max(2,Math.floor(u/n));t.shadowColor=e(Math.min(1,r.heat+.2)),t.shadowBlur=8*d*r.glow;for(let A=0;A<s;A++){const B=A*n+o*42*r.speed%n;if(!h&&B>u-4)continue;const[D,f,I]=x(B),L=7.5*d,R=8.5*d,M=.45+.4*Math.sin(B/u*6.283-o*2.2*r.speed);t.strokeStyle=e(r.heat-.05+M*.3),t.lineWidth=3.2*d,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(D,f),t.rotate(I),t.beginPath(),t.moveTo(-R*.5,-L),t.lineTo(R*.5,0),t.lineTo(-R*.5,L),t.stroke(),t.restore()}return!0}if(c==="comet"){const n=o*.35*r.speed%1*u,s=u*r.tail,A=Math.max(24,a.length*2);t.lineCap="round";for(let f=0;f<A;f++){const I=n-f/A*s,L=n-(f+1)/A*s;if(!h&&L<0)break;const R=1-f/A,[M,w]=x(I),[m,b]=x(L);!h&&Math.hypot(m-M,b-w)>u*.4||(t.globalAlpha=Math.pow(R,1.6),t.strokeStyle=e(Math.max(.05,r.heat-.2)+R*.55),t.lineWidth=(1.5+R*4.5)*d,R>.72?(t.shadowColor=e(Math.min(1,r.heat+.3)),t.shadowBlur=R*12*d*r.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(M,w),t.lineTo(m,b),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[B,D]=x(n);return t.fillStyle=rgba(t0.ink,.95),t.shadowColor=e(.9),t.shadowBlur=16*d,t.beginPath(),t.arc(B,D,2.6*d,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=i.color||e(r.heat),t.shadowColor=e(Math.min(1,r.heat+.15)),t.shadowBlur=(i.glow??8)*d*r.glow,c==="taper")for(let n=1;n<a.length;n++)t.lineWidth=(.5+n/a.length*4.5)*d,t.beginPath(),t.moveTo(a[n-1][0],a[n-1][1]),t.lineTo(a[n][0],a[n][1]),t.stroke();else Ut(t,d,o,l),t.beginPath(),a.forEach(([n,s],A)=>A?t.lineTo(n,s):t.moveTo(n,s)),h&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function Kt(t,a,o,d,i,l){const e=l.lut,c=a/220,h=a/2,v=13*d.halo*(o.glow??1),u=h-26*c,x=32,r=Math.max(0,Math.min(1,o.prog??0)),n=r*x,s=2.9*c*(o.dash??1),A=1+.05*Math.sin(i*2.2);t.save(),t.translate(h,h);for(let B=0;B<x;B++){const D=-Math.PI/2+B/x*Math.PI*2,f=u*Math.cos(D),I=u*Math.sin(D),L=Math.max(0,Math.min(1,n-B));L>0?(t.shadowColor=e(.8),t.shadowBlur=v*(.8+.6*L),t.fillStyle=e(.55+.35*L),t.globalAlpha=.35+.65*L,t.beginPath(),t.arc(f,I,s*(.85+.45*L),0,Math.PI*2),t.fill()):(t.shadowColor=e(.45),t.shadowBlur=v*.35,t.fillStyle=e(.42),t.globalAlpha=.3*A,t.beginPath(),t.arc(f,I,s*.72,0,Math.PI*2),t.fill())}if(r>.995){const B=i*1.6%1;t.globalAlpha=(1-B)*.5,t.shadowBlur=v*.6,t.shadowColor=e(.85),t.strokeStyle=e(.8),t.lineWidth=2.2*c,t.beginPath(),t.arc(0,0,u*(1+.22*B),0,Math.PI*2),t.stroke()}t.globalAlpha=1,t.shadowBlur=0,t.restore()}function ro(t,a,o,d,i,l){const e=13*d.halo,c=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const h=a/220,v=a/2,u=18*o.round*h,x=40*h,r=48*h,n=a-80*h,s=a-96*h;if(u>=Math.min(n,s)/2-1){Kt(t,a,o,d,i,l);return}const A=[],B=(f,I,L,R)=>{for(let M=0;M<=1;M+=.12)A.push([f+(L-f)*M,I+(R-I)*M])};B(x+u,r,x+n-u,r),B(x+n,r+u,x+n,r+s-u),B(x+n-u,r+s,x+u,r+s),B(x,r+s-u,x,r+u),t.shadowColor=c(.6),t.shadowBlur=e*.8;const D=4*l.arrow.w*h;if(l.arrow.line==="solid"?(t.setLineDash([10*o.dash*h,8*h]),t.lineDashOffset=-i*22*h,t.strokeStyle=c(.45),t.lineWidth=D,t.beginPath(),t.roundRect(x,r,n,s,u),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):qt(t,A,i,l.arrow.w*h,{color:c(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const f=[],I=(C,_,G,y,W)=>{for(let q=1;q<=W;q++)f.push([C+(G-C)*q/W,_+(y-_)*q/W])},L=(C,_,G,y,W)=>{for(let q=1;q<=W;q++){const Y=G+(y-G)*q/W;f.push([C+u*Math.cos(Y),_+u*Math.sin(Y)])}},R=Math.PI/2,M=x+n,w=r+s,m=x+n/2;f.push([m,r]),I(m,r,M-u,r,8),L(M-u,r+u,-R,0,6),I(M,r+u,M,w-u,10),L(M-u,w-u,0,R,6),I(M-u,w,x+u,w,14),L(x+u,w-u,R,Math.PI,6),I(x,w-u,x,r+u,10),L(x+u,r+u,Math.PI,Math.PI+R,6),I(x+u,r,m,r,8);let b=0;for(let C=1;C<f.length;C++)b+=Math.hypot(f[C][0]-f[C-1][0],f[C][1]-f[C-1][1]);const F=b*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*h,8*h]),t.lineDashOffset=-(n/2-u)-i*22*h,t.strokeStyle=c(.9),t.lineWidth=D*1.3,t.lineCap="round",t.shadowColor=c(.92),t.shadowBlur=e*1.3,t.beginPath(),t.moveTo(f[0][0],f[0][1]);let T=0;for(let C=1;C<f.length&&T<F;C++){const _=Math.hypot(f[C][0]-f[C-1][0],f[C][1]-f[C-1][1]);if(T+_<=F)t.lineTo(f[C][0],f[C][1]),T+=_;else{const G=(F-T)/_;t.lineTo(f[C-1][0]+(f[C][0]-f[C-1][0])*G,f[C-1][1]+(f[C][1]-f[C-1][1])*G),T=F}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&l.foot&&(l.foot(t,!1,v-16*o.feet*h,v+6*h,26*o.feet*h),l.foot(t,!0,v+16*o.feet*h,v+6*h,26*o.feet*h)),t.shadowBlur=0}function io(t,a,o,d,i,l,e,c){const h=13*d.halo,v=4*l.arrow.w*(a/220),u=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const x=a/220,r=e||[[45*x,130*x],[110*x,60*x],[175*x,110*x]],n=c??i*.5%1,s=Math.min(1,n*1.25)*(r.length-1),A=Math.min(r.length-1,Math.floor(s+.35));t.shadowColor=u(.7),t.shadowBlur=h;const B=w=>{const m=Math.max(0,Math.min(r.length-2,Math.floor(w))),b=w-m;return[r[m][0]+(r[m+1][0]-r[m][0])*b,r[m][1]+(r[m+1][1]-r[m][1])*b]},D=o.comet!=null?o.comet:1,f=o.tailLen!=null?o.tailLen:.5;if(t.save(),t.shadowBlur=0,t.globalAlpha=o.rail!=null?o.rail:.22,t.strokeStyle=u(.6),t.lineWidth=2.2*x,t.lineCap="round",t.setLineDash([.01,8*x]),t.beginPath(),r.forEach(([w,m],b)=>b?t.lineTo(w,m):t.moveTo(w,m)),t.stroke(),t.setLineDash([]),t.restore(),s>.02){const w=(m,b)=>u(m).replace("rgb(","rgba(").replace(")",`,${b.toFixed(3)})`);for(let m=0;m<26;m++){const b=m/25,F=s-f*b;if(F<=0)break;const T=B(F),C=4.7*x*D*(1-b*.75),_=C*2.1,G=(1-b)*(1-b)*.8,y=t.createRadialGradient(T[0],T[1],0,T[0],T[1],_);y.addColorStop(0,w(.55-.18*b,G)),y.addColorStop(.5,w(.5-.18*b,G*.35)),y.addColorStop(1,w(.45-.18*b,0)),t.save(),t.shadowBlur=0,t.globalAlpha=1,t.fillStyle=y,t.beginPath(),t.arc(T[0],T[1],_,0,Math.PI*2),t.fill(),t.restore()}if(s<r.length-1-.001&&s-Math.floor(s)>.03){const m=B(s);t.save(),t.fillStyle=u(.62),t.shadowColor=u(.8),t.shadowBlur=11*x*D,t.beginPath(),t.arc(m[0],m[1],5.6*x*D,0,Math.PI*2),t.fill(),t.fillStyle=u(.95),t.globalAlpha=.95,t.beginPath(),t.arc(m[0],m[1],2.1*x*D,0,Math.PI*2),t.fill(),t.restore()}}t.globalAlpha=1,t.lineCap="butt";const I=o.done!=null,L=o.done||0,R=o.vd||[],M=o.acc!=null?o.acc:r.length-1;if(r.forEach(([w,m],b)=>{const F=b<L,T=R[b]||null,C=!F&&b===A&&!I,_=C?1+Math.sin(i*6)*.14:1,G=o.pop!=null&&b===L-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,y=12*o.node*_*G*x*(b===M?1.34:1);F&&T!=="miss"&&(t.shadowBlur=h*1.4,t.shadowColor=u(.5),t.fillStyle=u(T==="near"?.5:.36),t.beginPath(),t.arc(w,m,y*.88,0,Math.PI*2),t.fill()),F||(t.save(),t.translate(w,m),o0(t,u,y,C?.8:.5,C?.9:.5,v*.9,h),t.restore()),t.strokeStyle=T==="hit"?K.prism:T==="near"?K.sand:T==="miss"?t0.lo:u(F?.62:C?.8:.45),t.lineWidth=v*(C?1.3:T?1.15:.9),t.shadowBlur=C?h*1.6:T&&T!=="miss"?h*1.3:h*.6,T&&T!=="miss"&&(t.shadowColor=T==="hit"?K.prism:K.sand),t.beginPath(),t.arc(w,m,y,0,Math.PI*2),t.stroke(),l.num&&(F&&T!=="miss"?(t.save(),t.globalCompositeOperation="destination-out",t.shadowBlur=0,l.num(t,String(b+1),w,m,16*o.numS*_*x,Math.round(14*o.numS*x)),t.restore()):(t.globalAlpha=b<=A?1:.6,l.num(t,String(b+1),w,m,16*o.numS*_*x,Math.round(14*o.numS*x)),t.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&L>0&&r[L-1]){const[w,m]=r[L-1],b=1-o.pop/.38,F=b*b,T=12*o.node*x*(L-1===(o.acc!=null?o.acc:r.length-1)?1.34:1);t.save();const C=T*(1.6+1.9*(1-b)),_=t.createRadialGradient(w,m,0,w,m,C);_.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*F).toFixed(3)})`),_.addColorStop(.35,u(.92).replace("rgb(","rgba(").replace(")",`,${(.8*F).toFixed(3)})`)),_.addColorStop(1,u(.7).replace("rgb(","rgba(").replace(")",",0)")),t.fillStyle=_,t.beginPath(),t.arc(w,m,C,0,Math.PI*2),t.fill(),t.strokeStyle=u(.92),t.globalAlpha=F,t.lineWidth=Math.max(1,6*x*b),t.shadowColor=u(.85),t.shadowBlur=24*x*F,t.beginPath(),t.arc(w,m,T*(1.1+3.4*(1-b)),0,Math.PI*2),t.stroke();const G=Math.max(0,b-.35)/.65;G>0&&(t.globalAlpha=G*G*.6,t.lineWidth=Math.max(1,3.5*x*G),t.beginPath(),t.arc(w,m,T*(1.1+2*(1-G)),0,Math.PI*2),t.stroke()),t.restore()}t.shadowBlur=0}function o0(t,a,o,d,i,l,e,c=1){if(o<=.6)return;const h=(n,s)=>a(n).replace("rgb(","rgba(").replace(")",`,${s})`),v=l*2.6*c,u=Math.max(.1,o-v),x=o+v,r=t.createRadialGradient(0,0,u,0,0,x);r.addColorStop(0,h(d-.05,0)),r.addColorStop(.5,h(d,i*.85)),r.addColorStop(1,h(d-.05,0)),t.globalAlpha=1,t.fillStyle=r,t.shadowBlur=0,t.beginPath(),t.arc(0,0,x,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,i*1.1),t.lineWidth=l*.85,t.strokeStyle=a(Math.min(.98,d+.12)),t.shadowColor=a(.88),t.shadowBlur=e*.6,t.beginPath(),t.arc(0,0,o,0,Math.PI*2),t.stroke(),t.shadowBlur=0}const e0=t=>1-Math.pow(1-Math.max(0,Math.min(1,t)),5);function co(t,a,o,d,i,l){const e=l.lut,c=a/512,h=l?.day?1:0,v=l.arrow&&l.arrow.w||1,u=(S,P)=>e(S).replace("rgb(","rgba(").replace(")",","+P+")"),x=h?.95:.86,r=(S,P)=>u(x,S),n=4*v*c;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const s=o.mat||{nx:.86,fx:.86,ny:-.86,fy:.86},A=o.in==null?1:Math.max(0,Math.min(1,o.in)),B=e0(A/.45),D=S=>e0((A-.28-S*.09)/.42),f=o.hit==null?9:o.hit,I=f<.34?Math.sin(Math.PI*(f/.34)):0,L=S=>a/2+S*a/2,R=S=>a/2-S*a/2,M=(S,P)=>e(S).replace("rgb(","rgba(").replace(")",","+P+")"),w=(S,P,p,k,E,O,U)=>{t.font="700 "+k+'px "Supreme", sans-serif',t.textAlign="center",t.textBaseline="middle";const H=Array.from(String(S)),z=k*O;let Q=-z;for(const j of H)Q+=t.measureText(j).width+z;let J=P-Q/2;t.fillStyle=E;for(const j of H){const $=t.measureText(j).width;t.fillText(j,J+$/2,p),J+=$+z}},m=.05*(o.round!=null?o.round/.35:1),b=(S,P,p,k)=>{};b(-s.fx+m,s.fy-m),b(-s.nx+m*.6,s.ny+m),b(s.nx-m*.6,s.ny+m),b(s.fx-m,s.fy-m);const F=o.center?o.center.x:0,T=o.center?o.center.y:0,C=(o.center&&o.center.r!=null?o.center.r:.26)*a/2*B*(1+.055*I+.008*Math.sin(i*2.4)),_=(o.targets||[]).slice().sort((S,P)=>(S.n||0)-(P.n||0));if(_.length){t.save(),t.shadowBlur=0,t.globalAlpha=(h?.55:.22)*e0(A/.9),t.strokeStyle=e(h?.3:.6),t.lineWidth=(h?3.6:2.2)*c,t.lineCap="round",t.setLineDash([.01,(h?6:8)*c]);const S=o.travel||{};for(const P of _){const p=L(P.x),k=R(P.y),E=L(F)-p,O=R(T)-k,U=S.k>0&&S.k<1&&(P.n===S.from||P.n===S.to),H=Math.hypot(E,O)||1,z=(P.r!=null?P.r:.2)*a/2*1.16,Q=p+E/H*z,J=k+O/H*z,j=C*(o.center&&o.center.live?1.34:1),$=L(F)-E/H*j*1.12,X=R(T)-O/H*j*1.12;if(t.beginPath(),t.moveTo(Q,J),t.lineTo($,X),t.stroke(),I>.01){const Z=1-I,V=.34,i0=t.createLinearGradient($,X,Q,J),l0=(x0,w0)=>i0.addColorStop(Math.max(0,Math.min(1,x0)),e(.85).replace("rgb(","rgba(").replace(")",","+w0+")"));l0(Z-V,0),l0(Z,.9*I),l0(Z+V,0),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=i0,t.lineWidth=3.4*c,t.stroke(),t.restore()}if(U){const Z=t.createLinearGradient(Q,J,$,X),V=Math.sin(Math.PI*S.k)*.85;Z.addColorStop(0,e(.5).replace("rgb(","rgba(").replace(")",",0)")),Z.addColorStop(.5,e(.9).replace("rgb(","rgba(").replace(")",","+V+")")),Z.addColorStop(1,e(.5).replace("rgb(","rgba(").replace(")",",0)")),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=Z,t.lineWidth=3*c,t.stroke(),t.restore()}}t.setLineDash([]),t.restore()}const G=o.travel;if(G&&G.k>.001&&G.k<1){const S=_.find(p=>p.n===G.from),P=_.find(p=>p.n===G.to);if(S&&P){const p=L(S.x),k=R(S.y),E=L(P.x),O=R(P.y),U=L(F),H=R(T),z=e0(G.k),Q=V=>V<.5?[p+(U-p)*(V/.5),k+(H-k)*(V/.5)]:[U+(E-U)*((V-.5)/.5),H+(O-H)*((V-.5)/.5)],[J,j]=Q(z),[$,X]=Q(Math.max(0,z-.28)),Z=t.createLinearGradient($,X,J,j);Z.addColorStop(0,e(.5).replace("rgb(","rgba(").replace(")",",0)")),Z.addColorStop(1,e(.85).replace("rgb(","rgba(").replace(")",",0.85)")),t.strokeStyle=Z,t.lineWidth=3.2*c,t.lineCap="round",t.beginPath(),t.moveTo($,X),t.lineTo(J,j),t.stroke(),t.fillStyle=e(.62),t.shadowColor=e(.8),t.shadowBlur=11*c,t.beginPath(),t.arc(J,j,5.6*c,0,Math.PI*2),t.fill(),t.fillStyle=e(.95),t.globalAlpha=.95,t.shadowBlur=0,t.beginPath(),t.arc(J,j,2.1*c,0,Math.PI*2),t.fill(),t.globalAlpha=1}}const y=13*d.halo*(h?.45:1);for(const S of o.targets||[]){const P=S.on!==!1,p=!!S.live,k=D(S.n?S.n-1:0);if(k<=.001)continue;const E=L(S.x),O=R(S.y),U=(S.r!=null?S.r:.2)*a/2*(p?1.34:1)*(.9+.1*k);t.globalAlpha=k*(P?1:.45),t.shadowBlur=y*1.4,t.shadowColor=e(.5),P||p?(t.fillStyle=e(h?p?.26:.62:p?.5:.36),t.beginPath(),t.arc(E,O,U*.88,0,Math.PI*2),t.fill(),t.shadowBlur=0,t.save(),t.translate(E,O),o0(t,e,U,p?.8:.5,p?.9:.5,n*.9,y),t.restore()):(t.shadowBlur=y*.5,t.strokeStyle=e(.55),t.lineWidth=n*.9,t.setLineDash([n*1.1,n*1.35]),t.beginPath(),t.arc(E,O,U*.94,0,Math.PI*2),t.stroke(),t.setLineDash([]));const H=S.v;t.strokeStyle=H==="hit"?K.prism:H==="near"?K.sand:H==="miss"?t0.lo:e(p?.8:.45),t.lineWidth=n*(p?1.3:H?1.15:.9),t.shadowBlur=p?y*1.6:H&&H!=="miss"?y*1.3:y*.6,t.shadowColor=H==="hit"?K.prism:H==="near"?K.sand:e(.5),t.beginPath(),t.arc(E,O,U,0,Math.PI*2),t.stroke(),t.shadowBlur=0,l.num(t,S.n,E,O,U*.9,Math.round(U*.78)),t.globalAlpha=1}const W=(S,P,p,k)=>{const E=13*d.halo,O=o.per||.4,U=Math.max(0,Math.min(1,k/O)),H=Math.min(.16,O*.42),z=Math.max(0,Math.min(1,1-k/H)),Q=p*1.9;for(let $=2;$>=0;$--){const X=Math.pow(Math.max(0,U-$*.05),1.6),Z=Q-(Q-p)*X,V=$===0?.55+.35*X:.16/$;t.save(),t.translate(S,P),o0(t,e,Z,.5+.35*X,V,n*.45,E,1.15-.35*X),t.restore()}z>.01&&(t.save(),t.translate(S,P),o0(t,e,p*(1+1.5*(1-z)),.92,z*.9,n*1.7,E,1.1),t.restore());const J=Math.max(0,Math.min(1,1-k/.22)),j=J*J;if(j>.01){const $=Math.max(1,p*(1.5+1.8*(1-J))),X=t.createRadialGradient(S,P,0,S,P,$);X.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.15*j).toFixed(3)})`),X.addColorStop(.35,M(.92,(.8*j).toFixed(3))),X.addColorStop(1,M(.7,0)),t.save(),t.shadowBlur=0,t.fillStyle=X,t.beginPath(),t.arc(S,P,$,0,Math.PI*2),t.fill(),t.restore()}},q=(o.targets||[]).filter(S=>S&&S.hit!=null&&S.hit<1.2);for(const S of q){const P=(S.r!=null?S.r:.2)*a/2*(S.live?1.34:1);W(L(S.x),R(S.y),P,S.hit)}const Y=o.center?o.center.hit!=null?o.center.hit:o.hit!=null?f:null:null;if(Y!=null&&Y<1.2&&W(L(F),R(T),C,Y),o.center){const S=L(F),P=R(T),p=13*d.halo*(h?.45:1),k=t.createRadialGradient(S,P,C*.1,S,P,C*1.6);k.addColorStop(0,M(.42,.3)),k.addColorStop(.6,M(.35,.12)),k.addColorStop(1,M(.3,0)),t.fillStyle=k,t.beginPath(),t.arc(S,P,C*1.6,0,Math.PI*2),t.fill();const E=!!o.center.live,O=C*(E?1.34:1);t.shadowBlur=p*1.4,t.shadowColor=e(.5),t.fillStyle=e(h?E?.26:.62:E?.5:.36),t.beginPath(),t.arc(S,P,O*.88,0,Math.PI*2),t.fill(),t.shadowBlur=0,t.save(),t.translate(S,P),o0(t,e,O,E?.8:.5,E?.9:.5,n*.9,p),t.restore();const U=o.center.v;if(t.strokeStyle=U==="hit"?K.prism:U==="near"?K.sand:U==="miss"?t0.lo:e(E?.8:.45),t.lineWidth=n*(E?1.3:U?1.15:.9),t.shadowBlur=E?p*1.6:U&&U!=="miss"?p*1.3:p*.6,t.shadowColor=U==="hit"?K.prism:U==="near"?K.sand:e(.5),t.beginPath(),t.arc(S,P,O,0,Math.PI*2),t.stroke(),t.shadowBlur=0,o.brand&&l.logo&&l.logo.complete&&l.logo.naturalWidth){const H=C*1.05,z=H*l.logo.naturalHeight/l.logo.naturalWidth;t.globalAlpha=.5*B,t.drawImage(l.logo,S-H/2,P-z/2,H,z),t.globalAlpha=1}if(o.center.label){const H=String(o.center.label).split(`
`);H.forEach((z,Q)=>w(z,S,P+(Q-(H.length-1)/2)*15*c,12*c,r(.9),.14))}}if(o.prog>.001&&o.center){const S=L(F),P=R(T),p=I;t.strokeStyle=M(.34,.9+.1*p),t.lineWidth=n*(.85+.5*p),t.lineCap="round",t.shadowColor=e(.42),t.shadowBlur=(10+16*p)*c,t.beginPath(),t.arc(S,P,C,-Math.PI/2,-Math.PI/2+Math.PI*2*Math.min(1,o.prog)),t.stroke(),t.shadowBlur=0}}function ho(t,a,o,d,i,l,e){const c=l.lut,h=13*d.halo,v=a/220,u=a/2,x=l.arrow&&l.arrow.w||1,r=(M,w)=>c(M).replace("rgb(","rgba(").replace(")",`,${w})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const n=(o.r!=null?o.r:.42)*a,s=n*(o.rt!=null?o.rt:.36),A=3.4*x*v,B=e!=null?Math.max(0,Math.min(1,e)):i*(o.tempo||.6)%1,D=Math.pow(B,1.6),f=Math.max(0,(B-.9)/.1);t.save(),t.translate(u,u);const I=(M,w,m,b=1)=>o0(t,c,M,w,m,A,h,b),L=t.createRadialGradient(0,0,0,0,0,s*1.08);L.addColorStop(0,r(.6,.1+.18*f)),L.addColorStop(.65,r(.5,.05+.08*f)),L.addColorStop(1,r(.5,0)),t.globalAlpha=1,t.fillStyle=L,t.beginPath(),t.arc(0,0,s*1.08,0,Math.PI*2),t.fill();const R=1+.02*Math.sin(i*2.6);I(s*R,.55+.4*f,.5+.45*f,.9);for(let M=2;M>=0;M--){const w=Math.pow(Math.max(0,B-M*.05),1.6),m=n-(n-s)*w,b=M===0?.6+.4*D:.18/M*(1-f);I(m,.55+.4*D,b*(1-f*.45),1.15-.35*D)}f>.01&&I(s*(1+1.4*f),.9,(1-f)*.8,1.1),t.globalAlpha=.6+.3*f,t.shadowColor=c(.85),t.shadowBlur=h*(.9+f),t.fillStyle=c(.62+.3*f),t.beginPath(),t.arc(0,0,A*.85+3*v*f,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function uo(t,a,o,d,i,l,e,c){const h=l.lut,v=13*d.halo,u=a/220,x=a/2,r=l.arrow&&l.arrow.w||1,n=r*u,s=(p,k)=>h(p).replace("rgb(","rgba(").replace(")",","+k+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const A=a*.42*(o.spread!=null?o.spread:1),D=(c||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([p,k])=>[x+p*A,x+k*A]),f=80,I=[];for(let p=0;p<=f;p++){const k=p/f*(D.length-1),E=Math.min(D.length-2,Math.floor(k)),O=k-E,U=D[Math.max(0,E-1)],H=D[E],z=D[E+1],Q=D[Math.min(D.length-1,E+2)],J=(j,$,X,Z)=>.5*(2*$+(-j+X)*O+(2*j-5*$+4*X-Z)*O*O+(-j+3*$-3*X+Z)*O*O*O);I.push([J(U[0],H[0],z[0],Q[0]),J(U[1],H[1],z[1],Q[1])])}const L=p=>{const k=Math.max(0,Math.min(f,p*f)),E=Math.floor(k),O=k-E,U=I[E],H=I[Math.min(f,E+1)];return[U[0]+(H[0]-U[0])*O,U[1]+(H[1]-U[1])*O]},R=.68;let M,w,m;if(e!=null)M=Math.max(0,Math.min(1,e)),w=1,m=0;else{const p=i*(o.tempo||.42)%1;if(p<R)M=p/R,w=1,m=0;else{const k=(p-R)/(1-R);M=1,w=1-k*k,m=k}}if(w<=.012)return;const b=M*M*M*(M*(6*M-15)+10),F=Math.min(1,16*M*M*(1-M)*(1-M));o.taper!=null&&o.taper;const T=.36*(o.tail!=null?o.tail:1),C=o.width!=null?o.width:1;{const p=t.createLinearGradient(I[0][0],I[0][1],I[f][0],I[f][1]);p.addColorStop(0,s(.46,0)),p.addColorStop(.3,s(.46,.03*w)),p.addColorStop(.8,s(.46,.045*w)),p.addColorStop(1,s(.46,0)),t.globalAlpha=1,t.strokeStyle=p,t.lineWidth=9*n,t.shadowColor=h(.6),t.shadowBlur=v*2,t.beginPath(),I.forEach(([k,E],O)=>O?t.lineTo(k,E):t.moveTo(k,E)),t.stroke(),t.shadowBlur=0}const _=40,G=Math.max(0,b-T*(1-m)),y=[];for(let p=0;p<=_;p++)y.push(L(G+(b-G)*(p/_)));const W=()=>{t.beginPath(),y.forEach(([p,k],E)=>E?t.lineTo(p,k):t.moveTo(p,k)),t.stroke()},q=()=>{const p=t.createLinearGradient(y[0][0],y[0][1],y[_][0],y[_][1]);return p.addColorStop(0,s(.55,0)),p.addColorStop(.4,s(.56,0)),p.addColorStop(.68,s(.6,.09)),p.addColorStop(.88,s(.64,.24)),p.addColorStop(1,s(.68,.44)),p},Y=1+.5*F;t.globalAlpha=w,t.strokeStyle=q(),t.lineWidth=(20+10*F)*n*C,t.shadowColor=h(.72),t.shadowBlur=v*2.2,W(),t.strokeStyle=q(),t.lineWidth=(10+5*F)*n*C,t.shadowBlur=v*1,W(),t.shadowBlur=0;for(let p=1;p<=_;p++){const k=p/_;t.globalAlpha=Math.pow(k,2.2)*.95*w,t.strokeStyle=h(.55+.38*k),t.lineWidth=(1.6+6.5*Math.pow(k,.7))*n*C*Y,t.beginPath(),t.moveTo(y[p-1][0],y[p-1][1]),t.lineTo(y[p][0],y[p][1]),t.stroke()}const S=y[_][0],P=y[_][1];t.globalAlpha=.8*w,t.fillStyle=h(.6),t.shadowColor=h(.8),t.shadowBlur=v*1.6,t.beginPath(),t.arc(S,P,(9+5*F)*n*C,0,Math.PI*2),t.fill(),t.globalAlpha=w,t.fillStyle=h(.93),t.shadowBlur=v*.6,t.beginPath(),t.arc(S,P,(3.4+1.8*F)*n*C,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function po(t,a,o,d,i,l,e){const c=o.r!=null?o.r:.3,h=o.dir!=null?o.dir:1,v=(o.sweep!=null?o.sweep:.66)*Math.PI*2,u=e??i*(o.tempo!=null?o.tempo:.5)%1,x=-Math.PI/2+h*u*Math.PI*2,r=16,n=[];for(let s=0;s<=r;s++){const A=x-h*(1-s/r)*v;n.push([.5+Math.cos(A)*c,.5+Math.sin(A)*c])}Wt(t,a,a,n,i,l,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}function fo(t,a,o,d,i,l,e={}){const c=Math.max(2,Math.round(e.count??7)),h=e.r??4.4,v=e.flow??.35,u=e.hair??.26,x=e.style||"chain",r=e.color||"255,246,234",n=e.inset??.12,s=e.alpha??1,A=d-a,B=i-o,D=Math.hypot(A,B);if(D<.001||s<=.004)return;const f=A/D,I=B/D,L=a+A*n,R=o+B*n,M=D*(1-n*2);if(M<=0)return;t.save(),x==="chain"&&u>0&&(t.strokeStyle=`rgba(${r},${(u*s*.6).toFixed(3)})`,t.lineWidth=1,t.beginPath(),t.moveTo(L,R),t.lineTo(L+f*M,R+I*M),t.stroke());const w=l*v%1;t.shadowColor=`rgba(${r},${(.5*s).toFixed(3)})`,t.shadowBlur=h*2.4;for(let m=0;m<c;m++){const b=(m+.5)/c,F=L+f*M*b,T=R+I*M*b;let C=.85;if(x==="taper")C=.3+.7*b;else if(x==="pulse"||x==="chain"){const _=((b-w)%1+1)%1,G=Math.min(_,1-_);C=.45+.55*Math.exp(-(G*G)/.028)}t.fillStyle=`rgba(${r},${(C*s).toFixed(3)})`,t.beginPath(),t.arc(F,T,h*.82,0,Math.PI*2),t.fill()}t.restore()}export{b0 as A,eo as C,Gt as F,m0 as G,Et as L,to as M,t0 as N,K as P,Qt as Q,ao as R,Jt as S,Zt as Z,a0 as a,Ht as b,ho as c,Vt as d,po as e,so as f,uo as g,co as h,Nt as i,fo as j,io as k,Yt as l,Xt as m,ro as n,oo as o,no as p,r0 as q,qt as r,f0 as s,zt as t,jt as u,lo as v,$t as w,Wt as x,gt as y,S0 as z};
