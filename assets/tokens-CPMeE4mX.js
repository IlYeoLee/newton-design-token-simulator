...
#define LOW_PRECISION`),t}function o_(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===pc?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===mc?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===vn&&(t="SHADOWMAP_TYPE_VSM"),t}function l_(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Di:case Ui:t="ENVMAP_TYPE_CUBE";break;case xr:t="ENVMAP_TYPE_CUBE_UV";break}return t}function c_(i){let t="ENVMAP_MODE_REFLECTION";return i.envMap&&i.envMapMode===Ui&&(t="ENVMAP_MODE_REFRACTION"),t}function h_(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case vr:t="ENVMAP_BLENDING_MULTIPLY";break;case Vh:t="ENVMAP_BLENDING_MIX";break;case Gh:t="ENVMAP_BLENDING_ADD";break}return t}function u_(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function d_(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=o_(e),c=l_(e),h=c_(e),u=h_(e),d=u_(e),f=Qg(e),g=t_(r),_=s.createProgram();let m,p,T=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const E=T+m+a,x=T+p+o,I=$l(s,s.VERTEX_SHADER,E),A=$l(s,s.FRAGMENT_SHADER,x);s.attachShader(_,I),s.attachShader(_,A),e.index0AttributeName!==void 0?s.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function C(P){if(i.debug.checkShaderErrors){const H=s.getProgramInfoLog(_).trim(),B=s.getShaderInfoLog(I).trim(),V=s.getShaderInfoLog(A).trim();let K=!0,Y=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,I,A);else{const nt=Ql(s,I,"vertex"),G=Ql(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class F_{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const s=new Ee,r=t.properties.get(s);r.__webglTexture=e.texture,(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=s}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,n=new Te({vertexShader:D_,fragmentShader:U_,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new re(new Oe(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class N_ extends zn{constructor(t,e){super();const n=this;let s=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,d=null,f=null,g=null;const _=new F_,m=e.getContextAttributes();let p=null,T=null;const E=[],x=[],I=new xt;let A=null;const C=new Fe;C.viewport=new Zt;const D=new Fe;D.viewport=new Zt;const S=[C,D],y=new Vd;let P=null,H=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(F){let q=E[F];return q===void 0&&(q=new Kr,E[F]=q),q.getTargetRaySpace()},this.getControllerGrip=function(F){let q=E[F];return q===void 0&&(q=new Kr,E[F]=q),q.getGripSpace()},this.getHand=function(F){let q=E[F];return q===void 0&&(q=new Kr,E[F]=q),q.getHandSpace()};function B(F){const q=x.indexOf(F.inputSource);if(q===-1)return;const tt=E[q];tt!==void 0&&(tt.update(F.inputSource,F.frame,c||a),tt.dispatchEvent({type:F.type,data:F.inputSource}))}function V(){s.removeEventListener("select",B),s.removeEventListener("selectstart",B),s.removeEventListener("selectend",B),s.removeEventListener("squeeze",B),s.removeEventListener("squeezestart",B),s.removeEventListener("squeezeend",B),s.removeEventListener("end",V),s.removeEventListener("inputsourceschange",K);for(let F=0;F<E.length;F++){const q=x[F];q!==null&&(x[F]=null,E[F].disconnect(q))}P=null,H=null,_.reset(),t.setRenderTarget(p),f=null,d=null,u=null,s=null,T=null,$t.stop(),n.isPresenting=!1,t.setPixelRatio(A),t.setSize(I.width,I.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(F){r=F,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(F){o=F,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(F){c=F},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return s},this.setSession=async function(F){if(s=F,s!==null){if(p=t.getRenderTarget(),s.addEventListener("select",B),s.addEventListener("selectstart",B),s.addEventListener("selectend",B),s.addEventListener("squeeze",B),s.addEventListener("squeezestart",B),s.addEventListener("squeezeend",B),s.addEventListener("end",V),s.addEventListener("inputsourceschange",K),m.xrCompatible!==!0&&await e.makeXRCompatible(),A=t.getPixelRatio(),t.getSize(I),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let tt=null,W=null,Q=null;m.depth&&(Q=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,tt=m.stencil?os:as,W=m.stencil?rs:ti);const yt={colorFormat:e.RGBA8,depthFormat:Q,scaleFactor:r};u=new XRWebGLBinding(s,e),d=u.createProjectionLayer(yt),s.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),T=new rn(d.textureWidth,d.textureHeight,{format:Ge,type:hn,depthTexture:new Vc(d.textureWidth,d.textureHeight,W,void 0,void 0,void 0,void 0,void 0,void 0,tt),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const tt={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};f=new XRWebGLLayer(s,e,tt),s.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),T=new rn(f.framebufferWidth,f.framebufferHeight,{format:Ge,type:hn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await s.requestReferenceSpace(o),$t.setContext(s),$t.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function K(F){for(let q=0;q<F.removed.length;q++){const tt=F.removed[q],W=x.indexOf(tt);W>=0&&(x[W]=null,E[W].disconnect(tt))}for(let q=0;q<F.added.length;q++){const tt=F.added[q];let W=x.indexOf(tt);if(W===-1){for(let yt=0;yt<E.length;yt++)if(yt>=x.length){x.push(tt),W=yt;break}else if(x[yt]===null){x[yt]=tt,W=yt;break}if(W===-1)break}const Q=E[W];Q&&Q.connect(tt)}}const Y=new w,nt=new w;function G(F,q,tt){Y.setFromMatrixPosition(q.matrixWorld),nt.setFromMatrixPosition(tt.matrixWorld);const W=Y.distanceTo(nt),Q=q.projectionMatrix.elements,yt=tt.projectionMatrix.elements,ct=Q[14]/(Q[10]-1),Wt=Q[14]/(Q[10]+1),Bt=(Q[9]+1)/Q[5],It=(Q[9]-1)/Q[5],R=(Q[8]-1)/Q[0],ae=(yt[8]+1)/yt[0],Nt=ct*R,jt=ct*ae,ft=W/(-R+ae),Ht=ft*-R;if(q.matrixWorld.decompose(F.position,F.quaternion,F.scale),F.translateX(Ht),F.translateZ(ft),F.matrixWorld.compose(F.position,F.quaternion,F.scale),F.matrixWorldInverse.copy(F.matrixWorld).invert(),Q[10]===-1)F.projectionMatrix.copy(q.projectionMatrix),F.projectionMatrixInverse.copy(q.projectionMatrixInverse);else{const St=ct+ft,Ot=Wt+ft,ue=Nt-Ht,b=jt+(W-Ht),v=Bt*Wt/Ot*St,O=It*Wt/Ot*St;F.projectionMatrix.makePerspective(ue,b,v,O,St,Ot),F.projectionMatrixInverse.copy(F.projectionMatrix).invert()}}function rt(F,q){q===null?F.matrixWorld.copy(F.matrix):F.matrixWorld.multiplyMatrices(q.matrixWorld,F.matrix),F.matrixWorldInverse.copy(F.matrixWorld).invert()}this.updateCamera=function(F){if(s===null)return;let q=F.near,tt=F.far;_.texture!==null&&(_.depthNear>0&&(q=_.depthNear),_.depthFar>0&&(tt=_.depthFar)),y.near=D.near=C.near=q,y.far=D.far=C.far=tt,(P!==y.near||H!==y.far)&&(s.updateRenderState({depthNear:y.near,depthFar:y.far}),P=y.near,H=y.far),C.layers.mask=F.layers.mask|2,D.layers.mask=F.layers.mask|4,y.layers.mask=C.layers.mask|D.layers.mask;const W=F.parent,Q=y.cameras;rt(y,W);for(let yt=0;yt<Q.length;yt++)rt(Q[yt],W);Q.length===2?G(y,C,D):y.projectionMatrix.copy(C.projectionMatrix),dt(F,y,W)};function dt(F,q,tt){tt===null?F.matrix.copy(q.matrixWorld):(F.matrix.copy(tt.matrixWorld),F.matrix.invert(),F.matrix.multiply(q.matrixWorld)),F.matrix.decompose(F.position,F.quaternion,F.scale),F.updateMatrixWorld(!0),F.projectionMatrix.copy(q.projectionMatrix),F.projectionMatrixInverse.copy(q.projectionMatrixInverse),F.isPerspectiveCamera&&(F.fov=Ni*2*Math.atan(1/F.projectionMatrix.elements[5]),F.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(d===null&&f===null))return l},this.setFoveation=function(F){l=F,d!==null&&(d.fixedFoveation=F),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=F)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(y)};let bt=null;function kt(F,q){if(h=q.getViewerPose(c||a),g=q,h!==null){const tt=h.views;f!==null&&(t.setRenderTargetFramebuffer(T,f.framebuffer),t.setRenderTarget(T));let W=!1;tt.length!==y.cameras.length&&(y.cameras.length=0,W=!0);for(let ct=0;ct<tt.length;ct++){const Wt=tt[ct];let Bt=null;if(f!==null)Bt=f.getViewport(Wt);else{const R=u.getViewSubImage(d,Wt);Bt=R.viewport,ct===0&&(t.setRenderTargetTextures(T,R.colorTexture,R.depthStencilTexture),t.setRenderTarget(T))}let It=S[ct];It===void 0&&(It=new Fe,It.layers.enable(ct),It.viewport=new Zt,S[ct]=It),It.matrix.fromArray(Wt.transform.matrix),It.matrix.decompose(It.position,It.quaternion,It.scale),It.projectionMatrix.fromArray(Wt.projectionMatrix),It.projectionMatrixInverse.copy(It.projectionMatrix).invert(),It.viewport.set(Bt.x,Bt.y,Bt.width,Bt.height),ct===0&&(y.matrix.copy(It.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),W===!0&&y.cameras.push(It)}const Q=s.enabledFeatures;if(Q&&Q.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&u){const ct=u.getDepthInformation(tt[0]);ct&&ct.isValid&&ct.texture&&_.init(t,ct,s.renderState)}}for(let tt=0;tt<E.length;tt++){const W=x[tt],Q=E[tt];W!==null&&Q!==void 0&&Q.update(W,q,c||a)}bt&&bt(F,q),q.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:q}),g=null}const $t=new Qc;$t.setAnimationLoop(kt),this.setAnimationLoop=function(F){bt=F},this.dispose=function(){}}}const Kn=new Ze,O_=new Yt;function B_(i,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Bc(i)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function s(m,p,T,E,x){p.isMeshBasicMaterial||p.isMeshLambertMaterial?r(m,p):p.isMeshToonMaterial?(r(m,p),u(m,p)):p.isMeshPhongMaterial?(r(m,p),h(m,p)):p.isMeshStandardMaterial?(r(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,x)):p.isMeshMatcapMaterial?(r(m,p),g(m,p)):p.isMeshDepthMaterial?r(m,p):p.isMeshDistanceMaterial?(r(m,p),_(m,p)):p.isMeshNormalMaterial?r(m,p):p.isLineBasicMaterial?(a(m,p),p.isLineDashedMaterial&&o(m,p)):p.isPointsMaterial?l(m,p,T,E):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function r(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Be&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Be&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const T=t.get(p),E=T.envMap,x=T.envMapRotation;E&&(m.envMap.value=E,Kn.copy(x),Kn.x*=-1,Kn.y*=-1,Kn.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&(Kn.y*=-1,Kn.z*=-1),m.envMapRotation.value.setFromMatrix4(O_.makeRotationFromEuler(Kn)),m.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,e(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function a(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function o(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,T,E){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*T,m.scale.value=E*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function u(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,T){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Be&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function _(m,p){const T=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function z_(i,t,e,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,E){const x=E.program;n.uniformBlockBinding(T,x)}function c(T,E){let x=s[T.id];x===void 0&&(g(T),x=h(T),s[T.id]=x,T.addEventListener("dispose",m));const I=E.program;n.updateUBOMapping(T,I);const A=t.render.frame;r[T.id]!==A&&(d(T),r[T.id]=A)}function h(T){const E=u();T.__bindingPointIndex=E;const x=i.createBuffer(),I=T.__size,A=T.usage;return i.bindBuffer(i.UNIFORM_BUFFER,x),i.bufferData(i.UNIFORM_BUFFER,I,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,E,x),x}function u(){for(let T=0;T<o;T++)if(a.indexOf(T)===-1)return a.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(T){const E=s[T.id],x=T.uniforms,I=T.__cache;i.bindBuffer(i.UNIFORM_BUFFER,E);for(let A=0,C=x.length;A<C;A++){const D=Array.isArray(x[A])?x[A]:[x[A]];for(let S=0,y=D.length;S<y;S++){const P=D[S];if(f(P,A,S,I)===!0){const H=P.__offset,B=Array.isArray(P.value)?P.value:[P.value];let V=0;for(let K=0;K<B.length;K++){const Y=B[K],nt=_(Y);typeof Y=="number"||typeof Y=="boolean"?(P.__data[0]=Y,i.bufferSubData(i.UNIFORM_BUFFER,H+V,P.__data)):Y.isMatrix3?(P.__data[0]=Y.elements[0],P.__data[1]=Y.elements[1],P.__data[2]=Y.elements[2],P.__data[3]=0,P.__data[4]=Y.elements[3],P.__data[5]=Y.elements[4],P.__data[6]=Y.elements[5],P.__data[7]=0,P.__data[8]=Y.elements[6],P.__data[9]=Y.elements[7],P.__data[10]=Y.elements[8],P.__data[11]=0):(Y.toArray(P.__data,V),V+=nt.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,H,P.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function f(T,E,x,I){const A=T.value,C=E+"_"+x;if(I[C]===void 0)return typeof A=="number"||typeof A=="boolean"?I[C]=A:I[C]=A.clone(),!0;{const D=I[C];if(typeof A=="number"||typeof A=="boolean"){if(D!==A)return I[C]=A,!0}else if(D.equals(A)===!1)return D.copy(A),!0}return!1}function g(T){const E=T.uniforms;let x=0;const I=16;for(let C=0,D=E.length;C<D;C++){const S=Array.isArray(E[C])?E[C]:[E[C]];for(let y=0,P=S.length;y<P;y++){const H=S[y],B=Array.isArray(H.value)?H.value:[H.value];for(let V=0,K=B.length;V<K;V++){const Y=B[V],nt=_(Y),G=x%I,rt=G%nt.boundary,dt=G+rt;x+=rt,dt!==0&&I-dt<nt.storage&&(x+=I-dt),H.__data=new Float32Array(nt.storage/Float32Array.BYTES_PER_ELEMENT),H.__offset=x,x+=nt.storage}}}const A=x%I;return A>0&&(x+=I-A),T.__size=x,T.__cache={},this}function _(T){const E={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(E.boundary=4,E.storage=4):T.isVector2?(E.boundary=8,E.storage=8):T.isVector3||T.isColor?(E.boundary=16,E.storage=12):T.isVector4?(E.boundary=16,E.storage=16):T.isMatrix3?(E.boundary=48,E.storage=48):T.isMatrix4?(E.boundary=64,E.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),E}function m(T){const E=T.target;E.removeEventListener("dispose",m);const x=a.indexOf(E.__bindingPointIndex);a.splice(x,1),i.deleteBuffer(s[E.id]),delete s[E.id],delete r[E.id]}function p(){for(const T in s)i.deleteBuffer(s[T]);a=[],s={},r={}}return{bind:l,update:c,dispose:p}}class k_{constructor(t={}){const{canvas:e=Su(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:d=!1}=t;this.isWebGLRenderer=!0;let f;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=n.getContextAttributes().alpha}else f=a;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,p=null;const T=[],E=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=On,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const x=this;let I=!1;this._outputColorSpace=me;let A=0,C=0,D=null,S=-1,y=null;const P=new Zt,H=new Zt;let B=null;const V=new Lt(0);let K=0,Y=e.width,nt=e.height,G=1,rt=null,dt=null;const bt=new Zt(0,0,Y,nt),kt=new Zt(0,0,Y,nt);let $t=!1;const F=new So;let q=!1,tt=!1;const W=new Yt,Q=new Yt,yt=new w,ct=new Zt,Wt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Bt=!1;function It(){return D===null?G:1}let R=n;function ae(M,U){return e.getContext(M,U)}try{const M={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${oo}`),e.addEventListener("webglcontextlost",gt,!1),e.addEventListener("webglcontextrestored",it,!1),e.addEventListener("webglcontextcreationerror",Z,!1),R===null){const U="webgl2";if(R=ae(U,M),R===null)throw ae(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let Nt,jt,ft,Ht,St,Ot,ue,b,v,O,j,$,X,Et,lt,Mt,Tt,J,pt,Ct,Rt,at,Ut,L;function ht(){Nt=new Zm(R),Nt.init(),at=new I_(R,Nt),jt=new Gm(R,Nt,t,at),ft=new P_(R,Nt),jt.reverseDepthBuffer&&d&&ft.buffers.depth.setReversed(!0),Ht=new Qm(R),St=new __,Ot=new L_(R,Nt,ft,St,jt,at,Ht),ue=new Xm(x),b=new Km(x),v=new rf(R),Ut=new Hm(R,v),O=new $m(R,v,Ht,Ut),j=new eg(R,O,v,Ht),pt=new tg(R,jt,Ot),Mt=new Wm(St),$=new g_(x,ue,b,Nt,jt,Ut,Mt),X=new B_(x,St),Et=new x_,lt=new b_(Nt),J=new km(x,ue,b,ft,j,f,l),Tt=new R_(x,j,jt),L=new z_(R,Ht,jt,ft),Ct=new Vm(R,Nt,Ht),Rt=new Jm(R,Nt,Ht),Ht.programs=$.programs,x.capabilities=jt,x.extensions=Nt,x.properties=St,x.renderLists=Et,x.shadowMap=Tt,x.state=ft,x.info=Ht}ht();const et=new N_(x,R);this.xr=et,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const M=Nt.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=Nt.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return G},this.setPixelRatio=function(M){M!==void 0&&(G=M,this.setSize(Y,nt,!1))},this.getSize=function(M){return M.set(Y,nt)},this.setSize=function(M,U,z=!0){if(et.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}Y=M,nt=U,e.width=Math.floor(M*G),e.height=Math.floor(U*G),z===!0&&(e.style.width=M+"px",e.style.height=U+"px"),this.setViewport(0,0,M,U)},this.getDrawingBufferSize=function(M){return M.set(Y*G,nt*G).floor()},this.setDrawingBufferSize=function(M,U,z){Y=M,nt=U,G=z,e.width=Math.floor(M*z),e.height=Math.floor(U*z),this.setViewport(0,0,M,U)},this.getCurrentViewport=function(M){return M.copy(P)},this.getViewport=function(M){return M.copy(bt)},this.setViewport=function(M,U,z,k){M.isVector4?bt.set(M.x,M.y,M.z,M.w):bt.set(M,U,z,k),ft.viewport(P.copy(bt).multiplyScalar(G).round())},this.getScissor=function(M){return M.copy(kt)},this.setScissor=function(M,U,z,k){M.isVector4?kt.set(M.x,M.y,M.z,M.w):kt.set(M,U,z,k),ft.scissor(H.copy(kt).multiplyScalar(G).round())},this.getScissorTest=function(){return $t},this.setScissorTest=function(M){ft.setScissorTest($t=M)},this.setOpaqueSort=function(M){rt=M},this.setTransparentSort=function(M){dt=M},this.getClearColor=function(M){return M.copy(J.getClearColor())},this.setClearColor=function(){J.setClearColor(...arguments)},this.getClearAlpha=function(){return J.getClearAlpha()},this.setClearAlpha=function(){J.setClearAlpha(...arguments)},this.clear=function(M=!0,U=!0,z=!0){let k=0;if(M){let N=!1;if(D!==null){const st=D.texture.format;N=st===mo||st===po||st===fo}if(N){const st=D.texture.type,ut=st===hn||st===ti||st===ss||st===rs||st===co||st===ho,vt=J.getClearColor(),mt=J.getClearAlpha(),Pt=vt.r,Dt=vt.g,wt=vt.b;ut?(g[0]=Pt,g[1]=Dt,g[2]=wt,g[3]=mt,R.clearBufferuiv(R.COLOR,0,g)):(_[0]=Pt,_[1]=Dt,_[2]=wt,_[3]=mt,R.clearBufferiv(R.COLOR,0,_))}else k|=R.COLOR_BUFFER_BIT}U&&(k|=R.DEPTH_BUFFER_BIT),z&&(k|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),R.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",gt,!1),e.removeEventListener("webglcontextrestored",it,!1),e.removeEventListener("webglcontextcreationerror",Z,!1),J.dispose(),Et.dispose(),lt.dispose(),St.dispose(),ue.dispose(),b.dispose(),j.dispose(),Ut.dispose(),L.dispose(),$.dispose(),et.dispose(),et.removeEventListener("sessionstart",Do),et.removeEventListener("sessionend",Uo),Vn.stop()};function gt(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),I=!0}function it(){console.log("THREE.WebGLRenderer: Context Restored."),I=!1;const M=Ht.autoReset,U=Tt.enabled,z=Tt.autoUpdate,k=Tt.needsUpdate,N=Tt.type;ht(),Ht.autoReset=M,Tt.enabled=U,Tt.autoUpdate=z,Tt.needsUpdate=k,Tt.type=N}function Z(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function _t(M){const U=M.target;U.removeEventListener("dispose",_t),Ft(U)}function Ft(M){oe(M),St.remove(M)}function oe(M){const U=St.get(M).programs;U!==void 0&&(U.forEach(function(z){$.releaseProgram(z)}),M.isShaderMaterial&&$.releaseShaderCache(M))}this.renderBufferDirect=function(M,U,z,k,N,st){U===null&&(U=Wt);const ut=N.isMesh&&N.matrixWorld.determinant()<0,vt=uh(M,U,z,k,N);ft.setMaterial(k,ut);let mt=z.index,Pt=1;if(k.wireframe===!0){if(mt=O.getWireframeAttribute(z),mt===void 0)return;Pt=2}const Dt=z.drawRange,wt=z.attributes.position;let Xt=Dt.start*Pt,ne=(Dt.start+Dt.count)*Pt;st!==null&&(Xt=Math.max(Xt,st.start*Pt),ne=Math.min(ne,(st.start+st.count)*Pt)),mt!==null?(Xt=Math.max(Xt,0),ne=Math.min(ne,mt.count)):wt!=null&&(Xt=Math.max(Xt,0),ne=Math.min(ne,wt.count));const pe=ne-Xt;if(pe<0||pe===1/0)return;Ut.setup(N,k,vt,z,mt);let le,se=Ct;if(mt!==null&&(le=v.get(mt),se=Rt,se.setIndex(le)),N.isMesh)k.wireframe===!0?(ft.setLineWidth(k.wireframeLinewidth*It()),se.setMode(R.LINES)):se.setMode(R.TRIANGLES);else if(N.isLine){let At=k.linewidth;At===void 0&&(At=1),ft.setLineWidth(At*It()),N.isLineSegments?se.setMode(R.LINES):N.isLineLoop?se.setMode(R.LINE_LOOP):se.setMode(R.LINE_STRIP)}else N.isPoints?se.setMode(R.POINTS):N.isSprite&&se.setMode(R.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)Ci("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),se.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(Nt.get("WEBGL_multi_draw"))se.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const At=N._multiDrawStarts,de=N._multiDrawCounts,Kt=N._multiDrawCount,ze=mt?v.get(mt).bytesPerElement:1,ii=St.get(k).currentProgram.getUniforms();for(let ke=0;ke<Kt;ke++)ii.setValue(R,"_gl_DrawID",ke),se.render(At[ke]/ze,de[ke])}else if(N.isInstancedMesh)se.renderInstances(Xt,pe,N.count);else if(z.isInstancedBufferGeometry){const At=z._maxInstanceCount!==void 0?z._maxInstanceCount:1/0,de=Math.min(z.instanceCount,At);se.renderInstances(Xt,pe,de)}else se.render(Xt,pe)};function Jt(M,U,z){M.transparent===!0&&M.side===je&&M.forceSinglePass===!1?(M.side=Be,M.needsUpdate=!0,_s(M,U,z),M.side=Bn,M.needsUpdate=!0,_s(M,U,z),M.side=je):_s(M,U,z)}this.compile=function(M,U,z=null){z===null&&(z=M),p=lt.get(z),p.init(U),E.push(p),z.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(p.pushLight(N),N.castShadow&&p.pushShadow(N))}),M!==z&&M.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(p.pushLight(N),N.castShadow&&p.pushShadow(N))}),p.setupLights();const k=new Set;return M.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const st=N.material;if(st)if(Array.isArray(st))for(let ut=0;ut<st.length;ut++){const vt=st[ut];Jt(vt,z,N),k.add(vt)}else Jt(st,z,N),k.add(st)}),p=E.pop(),k},this.compileAsync=function(M,U,z=null){const k=this.compile(M,U,z);return new Promise(N=>{function st(){if(k.forEach(function(ut){St.get(ut).currentProgram.isReady()&&k.delete(ut)}),k.size===0){N(M);return}setTimeout(st,10)}Nt.get("KHR_parallel_shader_compile")!==null?st():setTimeout(st,10)})};let $e=null;function un(M){$e&&$e(M)}function Do(){Vn.stop()}function Uo(){Vn.start()}const Vn=new Qc;Vn.setAnimationLoop(un),typeof self<"u"&&Vn.setContext(self),this.setAnimationLoop=function(M){$e=M,et.setAnimationLoop(M),M===null?Vn.stop():Vn.start()},et.addEventListener("sessionstart",Do),et.addEventListener("sessionend",Uo),this.render=function(M,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),et.enabled===!0&&et.isPresenting===!0&&(et.cameraAutoUpdate===!0&&et.updateCamera(U),U=et.getCamera()),M.isScene===!0&&M.onBeforeRender(x,M,U,D),p=lt.get(M,E.length),p.init(U),E.push(p),Q.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),F.setFromProjectionMatrix(Q),tt=this.localClippingEnabled,q=Mt.init(this.clippingPlanes,tt),m=Et.get(M,T.length),m.init(),T.push(m),et.enabled===!0&&et.isPresenting===!0){const st=x.xr.getDepthSensingMesh();st!==null&&br(st,U,-1/0,x.sortObjects)}br(M,U,0,x.sortObjects),m.finish(),x.sortObjects===!0&&m.sort(rt,dt),Bt=et.enabled===!1||et.isPresenting===!1||et.hasDepthSensing()===!1,Bt&&J.addToRenderList(m,M),this.info.render.frame++,q===!0&&Mt.beginShadows();const z=p.state.shadowsArray;Tt.render(z,M,U),q===!0&&Mt.endShadows(),this.info.autoReset===!0&&this.info.reset();const k=m.opaque,N=m.transmissive;if(p.setupLights(),U.isArrayCamera){const st=U.cameras;if(N.length>0)for(let ut=0,vt=st.length;ut<vt;ut++){const mt=st[ut];No(k,N,M,mt)}Bt&&J.render(M);for(let ut=0,vt=st.length;ut<vt;ut++){const mt=st[ut];Fo(m,M,mt,mt.viewport)}}else N.length>0&&No(k,N,M,U),Bt&&J.render(M),Fo(m,M,U);D!==null&&C===0&&(Ot.updateMultisampleRenderTarget(D),Ot.updateRenderTargetMipmap(D)),M.isScene===!0&&M.onAfterRender(x,M,U),Ut.resetDefaultState(),S=-1,y=null,E.pop(),E.length>0?(p=E[E.length-1],q===!0&&Mt.setGlobalState(x.clippingPlanes,p.state.camera)):p=null,T.pop(),T.length>0?m=T[T.length-1]:m=null};function br(M,U,z,k){if(M.visible===!1)return;if(M.layers.test(U.layers)){if(M.isGroup)z=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(U);else if(M.isLight)p.pushLight(M),M.castShadow&&p.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||F.intersectsSprite(M)){k&&ct.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Q);const ut=j.update(M),vt=M.material;vt.visible&&m.push(M,ut,vt,z,ct.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||F.intersectsObject(M))){const ut=j.update(M),vt=M.material;if(k&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),ct.copy(M.boundingSphere.center)):(ut.boundingSphere===null&&ut.computeBoundingSphere(),ct.copy(ut.boundingSphere.center)),ct.applyMatrix4(M.matrixWorld).applyMatrix4(Q)),Array.isArray(vt)){const mt=ut.groups;for(let Pt=0,Dt=mt.length;Pt<Dt;Pt++){const wt=mt[Pt],Xt=vt[wt.materialIndex];Xt&&Xt.visible&&m.push(M,ut,Xt,z,ct.z,wt)}}else vt.visible&&m.push(M,ut,vt,z,ct.z,null)}}const st=M.children;for(let ut=0,vt=st.length;ut<vt;ut++)br(st[ut],U,z,k)}function Fo(M,U,z,k){const N=M.opaque,st=M.transmissive,ut=M.transparent;p.setupLightsView(z),q===!0&&Mt.setGlobalState(x.clippingPlanes,z),k&&ft.viewport(P.copy(k)),N.length>0&&gs(N,U,z),st.length>0&&gs(st,U,z),ut.length>0&&gs(ut,U,z),ft.buffers.depth.setTest(!0),ft.buffers.depth.setMask(!0),ft.buffers.color.setMask(!0),ft.setPolygonOffset(!1)}function No(M,U,z,k){if((z.isScene===!0?z.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[k.id]===void 0&&(p.state.transmissionRenderTarget[k.id]=new rn(1,1,{generateMipmaps:!0,type:Nt.has("EXT_color_buffer_half_float")||Nt.has("EXT_color_buffer_float")?Sn:hn,minFilter:Qn,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:qt.workingColorSpace}));const st=p.state.transmissionRenderTarget[k.id],ut=k.viewport||P;st.setSize(ut.z*x.transmissionResolutionScale,ut.w*x.transmissionResolutionScale);const vt=x.getRenderTarget(),mt=x.getActiveCubeFace(),Pt=x.getActiveMipmapLevel();x.setRenderTarget(st),x.getClearColor(V),K=x.getClearAlpha(),K<1&&x.setClearColor(16777215,.5),x.clear(),Bt&&J.render(z);const Dt=x.toneMapping;x.toneMapping=On;const wt=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),p.setupLightsView(k),q===!0&&Mt.setGlobalState(x.clippingPlanes,k),gs(M,z,k),Ot.updateMultisampleRenderTarget(st),Ot.updateRenderTargetMipmap(st),Nt.has("WEBGL_multisampled_render_to_texture")===!1){let Xt=!1;for(let ne=0,pe=U.length;ne<pe;ne++){const le=U[ne],se=le.object,At=le.geometry,de=le.material,Kt=le.group;if(de.side===je&&se.layers.test(k.layers)){const ze=de.side;de.side=Be,de.needsUpdate=!0,Oo(se,z,k,At,de,Kt),de.side=ze,de.needsUpdate=!0,Xt=!0}}Xt===!0&&(Ot.updateMultisampleRenderTarget(st),Ot.updateRenderTargetMipmap(st))}x.setRenderTarget(vt,mt,Pt),x.setClearColor(V,K),wt!==void 0&&(k.viewport=wt),x.toneMapping=Dt}function gs(M,U,z){const k=U.isScene===!0?U.overrideMaterial:null;for(let N=0,st=M.length;N<st;N++){const ut=M[N],vt=ut.object,mt=ut.geometry,Pt=ut.group;let Dt=ut.material;Dt.allowOverride===!0&&k!==null&&(Dt=k),vt.layers.test(z.layers)&&Oo(vt,U,z,mt,Dt,Pt)}}function Oo(M,U,z,k,N,st){M.onBeforeRender(x,U,z,k,N,st),M.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),N.onBeforeRender(x,U,z,k,M,st),N.transparent===!0&&N.side===je&&N.forceSinglePass===!1?(N.side=Be,N.needsUpdate=!0,x.renderBufferDirect(z,U,k,N,M,st),N.side=Bn,N.needsUpdate=!0,x.renderBufferDirect(z,U,k,N,M,st),N.side=je):x.renderBufferDirect(z,U,k,N,M,st),M.onAfterRender(x,U,z,k,N,st)}function _s(M,U,z){U.isScene!==!0&&(U=Wt);const k=St.get(M),N=p.state.lights,st=p.state.shadowsArray,ut=N.state.version,vt=$.getParameters(M,N.state,st,U,z),mt=$.getProgramCacheKey(vt);let Pt=k.programs;k.environment=M.isMeshStandardMaterial?U.environment:null,k.fog=U.fog,k.envMap=(M.isMeshStandardMaterial?b:ue).get(M.envMap||k.environment),k.envMapRotation=k.environment!==null&&M.envMap===null?U.environmentRotation:M.envMapRotation,Pt===void 0&&(M.addEventListener("dispose",_t),Pt=new Map,k.programs=Pt);let Dt=Pt.get(mt);if(Dt!==void 0){if(k.currentProgram===Dt&&k.lightsStateVersion===ut)return zo(M,vt),Dt}else vt.uniforms=$.getUniforms(M),M.onBeforeCompile(vt,x),Dt=$.acquireProgram(vt,mt),Pt.set(mt,Dt),k.uniforms=vt.uniforms;const wt=k.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(wt.clippingPlanes=Mt.uniform),zo(M,vt),k.needsLights=fh(M),k.lightsStateVersion=ut,k.needsLights&&(wt.ambientLightColor.value=N.state.ambient,wt.lightProbe.value=N.state.probe,wt.directionalLights.value=N.state.directional,wt.directionalLightShadows.value=N.state.directionalShadow,wt.spotLights.value=N.state.spot,wt.spotLightShadows.value=N.state.spotShadow,wt.rectAreaLights.value=N.state.rectArea,wt.ltc_1.value=N.state.rectAreaLTC1,wt.ltc_2.value=N.state.rectAreaLTC2,wt.pointLights.value=N.state.point,wt.pointLightShadows.value=N.state.pointShadow,wt.hemisphereLights.value=N.state.hemi,wt.directionalShadowMap.value=N.state.directionalShadowMap,wt.directionalShadowMatrix.value=N.state.directionalShadowMatrix,wt.spotShadowMap.value=N.state.spotShadowMap,wt.spotLightMatrix.value=N.state.spotLightMatrix,wt.spotLightMap.value=N.state.spotLightMap,wt.pointShadowMap.value=N.state.pointShadowMap,wt.pointShadowMatrix.value=N.state.pointShadowMatrix),k.currentProgram=Dt,k.uniformsList=null,Dt}function Bo(M){if(M.uniformsList===null){const U=M.currentProgram.getUniforms();M.uniformsList=ir.seqWithValue(U.seq,M.uniforms)}return M.uniformsList}function zo(M,U){const z=St.get(M);z.outputColorSpace=U.outputColorSpace,z.batching=U.batching,z.batchingColor=U.batchingColor,z.instancing=U.instancing,z.instancingColor=U.instancingColor,z.instancingMorph=U.instancingMorph,z.skinning=U.skinning,z.morphTargets=U.morphTargets,z.morphNormals=U.morphNormals,z.morphColors=U.morphColors,z.morphTargetsCount=U.morphTargetsCount,z.numClippingPlanes=U.numClippingPlanes,z.numIntersection=U.numClipIntersection,z.vertexAlphas=U.vertexAlphas,z.vertexTangents=U.vertexTangents,z.toneMapping=U.toneMapping}function uh(M,U,z,k,N){U.isScene!==!0&&(U=Wt),Ot.resetTextureUnits();const st=U.fog,ut=k.isMeshStandardMaterial?U.environment:null,vt=D===null?x.outputColorSpace:D.isXRRenderTarget===!0?D.texture.colorSpace:Fi,mt=(k.isMeshStandardMaterial?b:ue).get(k.envMap||ut),Pt=k.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,Dt=!!z.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),wt=!!z.morphAttributes.position,Xt=!!z.morphAttributes.normal,ne=!!z.morphAttributes.color;let pe=On;k.toneMapped&&(D===null||D.isXRRenderTarget===!0)&&(pe=x.toneMapping);const le=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,se=le!==void 0?le.length:0,At=St.get(k),de=p.state.lights;if(q===!0&&(tt===!0||M!==y)){const Re=M===y&&k.id===S;Mt.setState(k,M,Re)}let Kt=!1;k.version===At.__version?(At.needsLights&&At.lightsStateVersion!==de.state.version||At.outputColorSpace!==vt||N.isBatchedMesh&&At.batching===!1||!N.isBatchedMesh&&At.batching===!0||N.isBatchedMesh&&At.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&At.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&At.instancing===!1||!N.isInstancedMesh&&At.instancing===!0||N.isSkinnedMesh&&At.skinning===!1||!N.isSkinnedMesh&&At.skinning===!0||N.isInstancedMesh&&At.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&At.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&At.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&At.instancingMorph===!1&&N.morphTexture!==null||At.envMap!==mt||k.fog===!0&&At.fog!==st||At.numClippingPlanes!==void 0&&(At.numClippingPlanes!==Mt.numPlanes||At.numIntersection!==Mt.numIntersection)||At.vertexAlphas!==Pt||At.vertexTangents!==Dt||At.morphTargets!==wt||At.morphNormals!==Xt||At.morphColors!==ne||At.toneMapping!==pe||At.morphTargetsCount!==se)&&(Kt=!0):(Kt=!0,At.__version=k.version);let ze=At.currentProgram;Kt===!0&&(ze=_s(k,U,N));let ii=!1,ke=!1,Yi=!1;const he=ze.getUniforms(),Xe=At.uniforms;if(ft.useProgram(ze.program)&&(ii=!0,ke=!0,Yi=!0),k.id!==S&&(S=k.id,ke=!0),ii||y!==M){ft.buffers.depth.getReversed()?(W.copy(M.projectionMatrix),Tu(W),bu(W),he.setValue(R,"projectionMatrix",W)):he.setValue(R,"projectionMatrix",M.projectionMatrix),he.setValue(R,"viewMatrix",M.matrixWorldInverse);const Ie=he.map.cameraPosition;Ie!==void 0&&Ie.setValue(R,yt.setFromMatrixPosition(M.matrixWorld)),jt.logarithmicDepthBuffer&&he.setValue(R,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&he.setValue(R,"isOrthographic",M.isOrthographicCamera===!0),y!==M&&(y=M,ke=!0,Yi=!0)}if(N.isSkinnedMesh){he.setOptional(R,N,"bindMatrix"),he.setOptional(R,N,"bindMatrixInverse");const Re=N.skeleton;Re&&(Re.boneTexture===null&&Re.computeBoneTexture(),he.setValue(R,"boneTexture",Re.boneTexture,Ot))}N.isBatchedMesh&&(he.setOptional(R,N,"batchingTexture"),he.setValue(R,"batchingTexture",N._matricesTexture,Ot),he.setOptional(R,N,"batchingIdTexture"),he.setValue(R,"batchingIdTexture",N._indirectTexture,Ot),he.setOptional(R,N,"batchingColorTexture"),N._colorsTexture!==null&&he.setValue(R,"batchingColorTexture",N._colorsTexture,Ot));const Ye=z.morphAttributes;if((Ye.position!==void 0||Ye.normal!==void 0||Ye.color!==void 0)&&pt.update(N,z,ze),(ke||At.receiveShadow!==N.receiveShadow)&&(At.receiveShadow=N.receiveShadow,he.setValue(R,"receiveShadow",N.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(Xe.envMap.value=mt,Xe.flipEnvMap.value=mt.isCubeTexture&&mt.isRenderTargetTexture===!1?-1:1),k.isMeshStandardMaterial&&k.envMap===null&&U.environment!==null&&(Xe.envMapIntensity.value=U.environmentIntensity),ke&&(he.setValue(R,"toneMappingExposure",x.toneMappingExposure),At.needsLights&&dh(Xe,Yi),st&&k.fog===!0&&X.refreshFogUniforms(Xe,st),X.refreshMaterialUniforms(Xe,k,G,nt,p.state.transmissionRenderTarget[M.id]),ir.upload(R,Bo(At),Xe,Ot)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(ir.upload(R,Bo(At),Xe,Ot),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&he.setValue(R,"center",N.center),he.setValue(R,"modelViewMatrix",N.modelViewMatrix),he.setValue(R,"normalMatrix",N.normalMatrix),he.setValue(R,"modelMatrix",N.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const Re=k.uniformsGroups;for(let Ie=0,wr=Re.length;Ie<wr;Ie++){const Gn=Re[Ie];L.update(Gn,ze),L.bind(Gn,ze)}}return ze}function dh(M,U){M.ambientLightColor.needsUpdate=U,M.lightProbe.needsUpdate=U,M.directionalLights.needsUpdate=U,M.directionalLightShadows.needsUpdate=U,M.pointLights.needsUpdate=U,M.pointLightShadows.needsUpdate=U,M.spotLights.needsUpdate=U,M.spotLightShadows.needsUpdate=U,M.rectAreaLights.needsUpdate=U,M.hemisphereLights.needsUpdate=U}function fh(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return D},this.setRenderTargetTextures=function(M,U,z){const k=St.get(M);k.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,k.__autoAllocateDepthBuffer===!1&&(k.__useRenderToTexture=!1),St.get(M.texture).__webglTexture=U,St.get(M.depthTexture).__webglTexture=k.__autoAllocateDepthBuffer?void 0:z,k.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,U){const z=St.get(M);z.__webglFramebuffer=U,z.__useDefaultFramebuffer=U===void 0};const ph=R.createFramebuffer();this.setRenderTarget=function(M,U=0,z=0){D=M,A=U,C=z;let k=!0,N=null,st=!1,ut=!1;if(M){const mt=St.get(M);if(mt.__useDefaultFramebuffer!==void 0)ft.bindFramebuffer(R.FRAMEBUFFER,null),k=!1;else if(mt.__webglFramebuffer===void 0)Ot.setupRenderTarget(M);else if(mt.__hasExternalTextures)Ot.rebindTextures(M,St.get(M.texture).__webglTexture,St.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const wt=M.depthTexture;if(mt.__boundDepthTexture!==wt){if(wt!==null&&St.has(wt)&&(M.width!==wt.image.width||M.height!==wt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Ot.setupDepthRenderbuffer(M)}}const Pt=M.texture;(Pt.isData3DTexture||Pt.isDataArrayTexture||Pt.isCompressedArrayTexture)&&(ut=!0);const Dt=St.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Dt[U])?N=Dt[U][z]:N=Dt[U],st=!0):M.samples>0&&Ot.useMultisampledRTT(M)===!1?N=St.get(M).__webglMultisampledFramebuffer:Array.isArray(Dt)?N=Dt[z]:N=Dt,P.copy(M.viewport),H.copy(M.scissor),B=M.scissorTest}else P.copy(bt).multiplyScalar(G).floor(),H.copy(kt).multiplyScalar(G).floor(),B=$t;if(z!==0&&(N=ph),ft.bindFramebuffer(R.FRAMEBUFFER,N)&&k&&ft.drawBuffers(M,N),ft.viewport(P),ft.scissor(H),ft.setScissorTest(B),st){const mt=St.get(M.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+U,mt.__webglTexture,z)}else if(ut){const mt=St.get(M.texture),Pt=U;R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,mt.__webglTexture,z,Pt)}else if(M!==null&&z!==0){const mt=St.get(M.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,mt.__webglTexture,z)}S=-1},this.readRenderTargetPixels=function(M,U,z,k,N,st,ut,vt=0){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let mt=St.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&ut!==void 0&&(mt=mt[ut]),mt){ft.bindFramebuffer(R.FRAMEBUFFER,mt);try{const Pt=M.textures[vt],Dt=Pt.format,wt=Pt.type;if(!jt.textureFormatReadable(Dt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!jt.textureTypeReadable(wt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=M.width-k&&z>=0&&z<=M.height-N&&(M.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+vt),R.readPixels(U,z,k,N,at.convert(Dt),at.convert(wt),st))}finally{const Pt=D!==null?St.get(D).__webglFramebuffer:null;ft.bindFramebuffer(R.FRAMEBUFFER,Pt)}}},this.readRenderTargetPixelsAsync=async function(M,U,z,k,N,st,ut,vt=0){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let mt=St.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&ut!==void 0&&(mt=mt[ut]),mt)if(U>=0&&U<=M.width-k&&z>=0&&z<=M.height-N){ft.bindFramebuffer(R.FRAMEBUFFER,mt);const Pt=M.textures[vt],Dt=Pt.format,wt=Pt.type;if(!jt.textureFormatReadable(Dt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!jt.textureTypeReadable(wt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Xt=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,Xt),R.bufferData(R.PIXEL_PACK_BUFFER,st.byteLength,R.STREAM_READ),M.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+vt),R.readPixels(U,z,k,N,at.convert(Dt),at.convert(wt),0);const ne=D!==null?St.get(D).__webglFramebuffer:null;ft.bindFramebuffer(R.FRAMEBUFFER,ne);const pe=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await Eu(R,pe,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,Xt),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,st),R.deleteBuffer(Xt),R.deleteSync(pe),st}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(M,U=null,z=0){const k=Math.pow(2,-z),N=Math.floor(M.image.width*k),st=Math.floor(M.image.height*k),ut=U!==null?U.x:0,vt=U!==null?U.y:0;Ot.setTexture2D(M,0),R.copyTexSubImage2D(R.TEXTURE_2D,z,0,0,ut,vt,N,st),ft.unbindTexture()};const mh=R.createFramebuffer(),gh=R.createFramebuffer();this.copyTextureToTexture=function(M,U,z=null,k=null,N=0,st=null){st===null&&(N!==0?(Ci("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),st=N,N=0):st=0);let ut,vt,mt,Pt,Dt,wt,Xt,ne,pe;const le=M.isCompressedTexture?M.mipmaps[st]:M.image;if(z!==null)ut=z.max.x-z.min.x,vt=z.max.y-z.min.y,mt=z.isBox3?z.max.z-z.min.z:1,Pt=z.min.x,Dt=z.min.y,wt=z.isBox3?z.min.z:0;else{const Ye=Math.pow(2,-N);ut=Math.floor(le.width*Ye),vt=Math.floor(le.height*Ye),M.isDataArrayTexture?mt=le.depth:M.isData3DTexture?mt=Math.floor(le.depth*Ye):mt=1,Pt=0,Dt=0,wt=0}k!==null?(Xt=k.x,ne=k.y,pe=k.z):(Xt=0,ne=0,pe=0);const se=at.convert(U.format),At=at.convert(U.type);let de;U.isData3DTexture?(Ot.setTexture3D(U,0),de=R.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(Ot.setTexture2DArray(U,0),de=R.TEXTURE_2D_ARRAY):(Ot.setTexture2D(U,0),de=R.TEXTURE_2D),R.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,U.flipY),R.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),R.pixelStorei(R.UNPACK_ALIGNMENT,U.unpackAlignment);const Kt=R.getParameter(R.UNPACK_ROW_LENGTH),ze=R.getParameter(R.UNPACK_IMAGE_HEIGHT),ii=R.getParameter(R.UNPACK_SKIP_PIXELS),ke=R.getParameter(R.UNPACK_SKIP_ROWS),Yi=R.getParameter(R.UNPACK_SKIP_IMAGES);R.pixelStorei(R.UNPACK_ROW_LENGTH,le.width),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,le.height),R.pixelStorei(R.UNPACK_SKIP_PIXELS,Pt),R.pixelStorei(R.UNPACK_SKIP_ROWS,Dt),R.pixelStorei(R.UNPACK_SKIP_IMAGES,wt);const he=M.isDataArrayTexture||M.isData3DTexture,Xe=U.isDataArrayTexture||U.isData3DTexture;if(M.isDepthTexture){const Ye=St.get(M),Re=St.get(U),Ie=St.get(Ye.__renderTarget),wr=St.get(Re.__renderTarget);ft.bindFramebuffer(R.READ_FRAMEBUFFER,Ie.__webglFramebuffer),ft.bindFramebuffer(R.DRAW_FRAMEBUFFER,wr.__webglFramebuffer);for(let Gn=0;Gn<mt;Gn++)he&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,St.get(M).__webglTexture,N,wt+Gn),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,St.get(U).__webglTexture,st,pe+Gn)),R.blitFramebuffer(Pt,Dt,ut,vt,Xt,ne,ut,vt,R.DEPTH_BUFFER_BIT,R.NEAREST);ft.bindFramebuffer(R.READ_FRAMEBUFFER,null),ft.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(N!==0||M.isRenderTargetTexture||St.has(M)){const Ye=St.get(M),Re=St.get(U);ft.bindFramebuffer(R.READ_FRAMEBUFFER,mh),ft.bindFramebuffer(R.DRAW_FRAMEBUFFER,gh);for(let Ie=0;Ie<mt;Ie++)he?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,Ye.__webglTexture,N,wt+Ie):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,Ye.__webglTexture,N),Xe?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,Re.__webglTexture,st,pe+Ie):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,Re.__webglTexture,st),N!==0?R.blitFramebuffer(Pt,Dt,ut,vt,Xt,ne,ut,vt,R.COLOR_BUFFER_BIT,R.NEAREST):Xe?R.copyTexSubImage3D(de,st,Xt,ne,pe+Ie,Pt,Dt,ut,vt):R.copyTexSubImage2D(de,st,Xt,ne,Pt,Dt,ut,vt);ft.bindFramebuffer(R.READ_FRAMEBUFFER,null),ft.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else Xe?M.isDataTexture||M.isData3DTexture?R.texSubImage3D(de,st,Xt,ne,pe,ut,vt,mt,se,At,le.data):U.isCompressedArrayTexture?R.compressedTexSubImage3D(de,st,Xt,ne,pe,ut,vt,mt,se,le.data):R.texSubImage3D(de,st,Xt,ne,pe,ut,vt,mt,se,At,le):M.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,st,Xt,ne,ut,vt,se,At,le.data):M.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,st,Xt,ne,le.width,le.height,se,le.data):R.texSubImage2D(R.TEXTURE_2D,st,Xt,ne,ut,vt,se,At,le);R.pixelStorei(R.UNPACK_ROW_LENGTH,Kt),R.pixelStorei(R.UNPACK_IMAGE_HEIGHT,ze),R.pixelStorei(R.UNPACK_SKIP_PIXELS,ii),R.pixelStorei(R.UNPACK_SKIP_ROWS,ke),R.pixelStorei(R.UNPACK_SKIP_IMAGES,Yi),st===0&&U.generateMipmaps&&R.generateMipmap(de),ft.unbindTexture()},this.copyTextureToTexture3D=function(M,U,z=null,k=null,N=0){return Ci('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(M,U,z,k,N)},this.initRenderTarget=function(M){St.get(M).__webglFramebuffer===void 0&&Ot.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?Ot.setTextureCube(M,0):M.isData3DTexture?Ot.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?Ot.setTexture2DArray(M,0):Ot.setTexture2D(M,0),ft.unbindTexture()},this.resetState=function(){A=0,C=0,D=null,ft.reset(),Ut.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return xn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=qt._getDrawingBufferColorSpace(t),e.unpackColorSpace=qt._getUnpackColorSpace()}}const oc={type:"change"},Lo={type:"start"},sh={type:"end"},Ks=new ps,lc=new Dn,H_=Math.cos(70*Ic.DEG2RAD),ve=new w,De=2*Math.PI,ie={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},da=1e-6;class V_ extends nf{constructor(t,e=null){super(t,e),this.state=ie.NONE,this.target=new w,this.cursor=new w,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:Ai.ROTATE,MIDDLE:Ai.DOLLY,RIGHT:Ai.PAN},this.touches={ONE:yi.ROTATE,TWO:yi.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new w,this._lastQuaternion=new sn,this._lastTargetPosition=new w,this._quat=new sn().setFromUnitVectors(t.up,new w(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Ul,this._sphericalDelta=new Ul,this._scale=1,this._panOffset=new w,this._rotateStart=new xt,this._rotateEnd=new xt,this._rotateDelta=new xt,this._panStart=new xt,this._panEnd=new xt,this._panDelta=new xt,this._dollyStart=new xt,this._dollyEnd=new xt,this._dollyDelta=new xt,this._dollyDirection=new w,this._mouse=new xt,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=W_.bind(this),this._onPointerDown=G_.bind(this),this._onPointerUp=X_.bind(this),this._onContextMenu=J_.bind(this),this._onMouseWheel=j_.bind(this),this._onKeyDown=K_.bind(this),this._onTouchStart=Z_.bind(this),this._onTouchMove=$_.bind(this),this._onMouseDown=Y_.bind(this),this._onMouseMove=q_.bind(this),this._interceptControlDown=Q_.bind(this),this._interceptControlUp=t0.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}connect(t){super.connect(t),this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(oc),this.update(),this.state=ie.NONE}update(t=null){const e=this.object.position;ve.copy(e).sub(this.target),ve.applyQuaternion(this._quat),this._spherical.setFromVector3(ve),this.autoRotate&&this.state===ie.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,s=this.maxAzimuthAngle;isFinite(n)&&isFinite(s)&&(n<-Math.PI?n+=De:n>Math.PI&&(n-=De),s<-Math.PI?s+=De:s>Math.PI&&(s-=De),n<=s?this._spherical.theta=Math.max(n,Math.min(s,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+s)/2?Math.max(n,this._spherical.theta):Math.min(s,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let r=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const a=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),r=a!=this._spherical.radius}if(ve.setFromSpherical(this._spherical),ve.applyQuaternion(this._quatInverse),e.copy(this.target).add(ve),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let a=null;if(this.object.isPerspectiveCamera){const o=ve.length();a=this._clampDistance(o*this._scale);const l=o-a;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),r=!!l}else if(this.object.isOrthographicCamera){const o=new w(this._mouse.x,this._mouse.y,0);o.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),r=l!==this.object.zoom;const c=new w(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(o),this.object.updateMatrixWorld(),a=ve.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;a!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(a).add(this.object.position):(Ks.origin.copy(this.object.position),Ks.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Ks.direction))<H_?this.object.lookAt(this.target):(lc.setFromNormalAndCoplanarPoint(this.object.up,this.target),Ks.intersectPlane(lc,this.target))))}else if(this.object.isOrthographicCamera){const a=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),a!==this.object.zoom&&(this.object.updateProjectionMatrix(),r=!0)}return this._scale=1,this._performCursorZoom=!1,r||this._lastPosition.distanceToSquared(this.object.position)>da||8*(1-this._lastQuaternion.dot(this.object.quaternion))>da||this._lastTargetPosition.distanceToSquared(this.target)>da?(this.dispatchEvent(oc),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?De/60*this.autoRotateSpeed*t:De/60/60*this.autoRotateSpeed}_getZoomScale(t){const e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){ve.setFromMatrixColumn(e,0),ve.multiplyScalar(-t),this._panOffset.add(ve)}_panUp(t,e){this.screenSpacePanning===!0?ve.setFromMatrixColumn(e,1):(ve.setFromMatrixColumn(e,0),ve.crossVectors(this.object.up,ve)),ve.multiplyScalar(t),this._panOffset.add(ve)}_pan(t,e){const n=this.domElement;if(this.object.isPerspectiveCamera){const s=this.object.position;ve.copy(s).sub(this.target);let r=ve.length();r*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*r/n.clientHeight,this.object.matrix),this._panUp(2*e*r/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const n=this.domElement.getBoundingClientRect(),s=t-n.left,r=e-n.top,a=n.width,o=n.height;this._mouse.x=s/a*2-1,this._mouse.y=-(r/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(De*this._rotateDelta.x/e.clientHeight),this._rotateUp(De*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(De*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-De*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(De*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-De*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._rotateStart.set(n,s)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panStart.set(n,s)}}_handleTouchStartDolly(t){const e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyStart.set(0,r)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const n=this._getSecondPointerPosition(t),s=.5*(t.pageX+n.x),r=.5*(t.pageY+n.y);this._rotateEnd.set(s,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(De*this._rotateDelta.x/e.clientHeight),this._rotateUp(De*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),n=.5*(t.pageX+e.x),s=.5*(t.pageY+e.y);this._panEnd.set(n,s)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const e=this._getSecondPointerPosition(t),n=t.pageX-e.x,s=t.pageY-e.y,r=Math.sqrt(n*n+s*s);this._dollyEnd.set(0,r),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const a=(t.pageX+e.x)*.5,o=(t.pageY+e.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new xt,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){const e=t.deltaMode,n={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}}function G_(i){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(i.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(i)&&(this._addPointer(i),i.pointerType==="touch"?this._onTouchStart(i):this._onMouseDown(i)))}function W_(i){this.enabled!==!1&&(i.pointerType==="touch"?this._onTouchMove(i):this._onMouseMove(i))}function X_(i){switch(this._removePointer(i),this._pointers.length){case 0:this.domElement.releasePointerCapture(i.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(sh),this.state=ie.NONE;break;case 1:const t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function Y_(i){let t;switch(i.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case Ai.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(i),this.state=ie.DOLLY;break;case Ai.ROTATE:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=ie.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=ie.ROTATE}break;case Ai.PAN:if(i.ctrlKey||i.metaKey||i.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(i),this.state=ie.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(i),this.state=ie.PAN}break;default:this.state=ie.NONE}this.state!==ie.NONE&&this.dispatchEvent(Lo)}function q_(i){switch(this.state){case ie.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(i);break;case ie.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(i);break;case ie.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(i);break}}function j_(i){this.enabled===!1||this.enableZoom===!1||this.state!==ie.NONE||(i.preventDefault(),this.dispatchEvent(Lo),this._handleMouseWheel(this._customWheelEvent(i)),this.dispatchEvent(sh))}function K_(i){this.enabled!==!1&&this._handleKeyDown(i)}function Z_(i){switch(this._trackPointer(i),this._pointers.length){case 1:switch(this.touches.ONE){case yi.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(i),this.state=ie.TOUCH_ROTATE;break;case yi.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(i),this.state=ie.TOUCH_PAN;break;default:this.state=ie.NONE}break;case 2:switch(this.touches.TWO){case yi.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(i),this.state=ie.TOUCH_DOLLY_PAN;break;case yi.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(i),this.state=ie.TOUCH_DOLLY_ROTATE;break;default:this.state=ie.NONE}break;default:this.state=ie.NONE}this.state!==ie.NONE&&this.dispatchEvent(Lo)}function $_(i){switch(this._trackPointer(i),this.state){case ie.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(i),this.update();break;case ie.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(i),this.update();break;case ie.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(i),this.update();break;case ie.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(i),this.update();break;default:this.state=ie.NONE}}function J_(i){this.enabled!==!1&&i.preventDefault()}function Q_(i){i.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function t0(i){i.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}const sr={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}zi.BlurDirectionX=new xt(1,0);zi.BlurDirectionY=new xt(0,1);const Zs={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
    ...
    void main(){
      ...
      gl_FragColor = c;
    }`},bi=-1.8;function O0(i){const t=new k_({antialias:!0});t.setPixelRatio(Math.min(window.devicePixelRatio,2));const e=t.capabilities.getMaxAnisotropy();t.setSize(i.clientWidth,i.clientHeight),t.shadowMap.enabled=!0,t.shadowMap.type=mc,t.localClippingEnabled=!0,i.appendChild(t.domElement);const n=new Ku;n.background=new Lt(790034),n.fog=new Mo(790034,9,20);const s=new Fe(50,i.clientWidth/i.clientHeight,.05,60),r=new V_(s,t.domElement);r.enableDamping=!0,r.dampingFactor=.08,r.maxPolarAngle=Math.PI*.495,r.minDistance=1.2,r.maxDistance=14,n.add(new Bd(3752527,1119258,1.1));const a=new Ll(16777215,1.5);a.position.set(3,6,4),a.castShadow=!0,a.shadow.mapSize.set(2048,2048),a.shadow.camera.left=-5,a.shadow.camera.right=5,a.shadow.camera.top=5,a.shadow.camera.bottom=-5,n.add(a);const o=new Ll(5227511,.35);o.position.set(-4,3,-3),n.add(o);const l=new re(new Oe(120,120),new Ji({color:1514016,roughness:.92,metalness:.05}));l.rotation.x=-Math.PI/2,l.receiveShadow=!0,n.add(l);const c=new Fl(120,240,2304051,1777706);c.position.y=.002,n.add(c);const h=new Le,u=new re(new Oe(5,3.2),new Ji({color:1843240,roughness:.95}));u.position.set(0,1.6,bi),u.receiveShadow=!0,h.add(u);const d=new Fl(5,10,2765120,2304567);d.rotation.x=Math.PI/2,d.position.set(0,1.6,bi+.005),h.add(d),n.add(h);const f=(()=>{const F=new Le,q=3.05,tt=-7,W=.225,Q=tt-.15,yt=new Ji({color:2830134,roughness:.6,metalness:.3}),ct=new re(new ei(1.8,1.05,.03),new Ji({color:15594231,roughness:.25,metalness:.05,transparent:!0,opacity:.55}));ct.position.set(0,q+.375,Q-.015),ct.castShadow=!0,F.add(ct);const Wt=new eo(new nd(new ei(.59,.45,.001)),new hs({color:15229482}));Wt.position.set(0,q+.19,Q+.02),F.add(Wt);const Bt=new re(new bo(W,.014,10,28),new Ji({color:15229482,roughness:.4,metalness:.5}));Bt.rotation.x=Math.PI/2,Bt.position.set(0,q,tt),Bt.castShadow=!0,F.add(Bt);const It=12,R=.4,ae=.09,Nt=(v,O)=>Array.from({length:It},(j,$)=>{const X=$/It*Math.PI*2;return new w(Math.cos(X)*v,O,tt+Math.sin(X)*v)}),jt=Nt(W,q),ft=Nt((W+ae)/2,q-R*.5),Ht=Nt(ae,q-R),St=[];for(let v=0;v<It;v++)St.push(jt[v],ft[v],ft[v],Ht[v]);for(let v=0;v<It;v++)St.push(ft[v],ft[(v+1)%It],Ht[v],Ht[(v+1)%It]);const Ot=new eo(new xe().setFromPoints(St),new hs({color:16119280,transparent:!0,opacity:.75}));F.add(Ot);const ue=new re(new fr(.05,.06,ct.position.y+.4,12),yt);ue.position.set(0,(ct.position.y+.4)/2,Q-.35),ue.castShadow=!0,F.add(ue);const b=new re(new fr(.035,.035,.36,10),yt);return b.rotation.x=Math.PI/2,b.position.set(0,ct.position.y,Q-.18),F.add(b),F.visible=!1,n.add(F),F})();let g=null;function _(){f.visible=g==="basketball"&&["court","court_gray","court_black"].includes(A)}const m=new Od,p={},T="./";function E(F,q,tt){return new Promise(W=>{m.load(`${T}tex/${F}`,Q=>{Q.wrapS=Q.wrapT=Un,Q.repeat.set(q,tt),Q.anisotropy=e,Q.colorSpace=me,W(Q)})})}async function x(F){if(p[F])return p[F];if(F==="grass")p.grass=await E("grass.jpg",60,60);else if(F==="paving")p.paving=await E("paving.jpg",50,50);else if(F==="plaster")p.plaster=await E("plaster.jpg",2.5,1.6);else if(F==="track"){const q=await new Promise(yt=>{const ct=new Image;ct.onload=()=>yt(ct),ct.src=`${T}tex/asphalt.jpg`}),tt=document.createElement("canvas");tt.width=tt.height=512;const W=tt.getContext("2d");W.fillStyle="#6FA88C",W.fillRect(0,0,512,512),W.globalAlpha=.34,W.globalCompositeOperation="overlay",W.drawImage(q,0,0,512,512),W.globalAlpha=.12,W.globalCompositeOperation="saturation",W.fillStyle="#808080",W.fillRect(0,0,512,512),W.globalAlpha=1,W.globalCompositeOperation="source-over",W.fillStyle="rgba(248,248,244,0.85)",W.fillRect(96,0,7,512),W.fillRect(409,0,7,512);const Q=new ln(tt);Q.wrapS=Q.wrapT=Un,Q.repeat.set(60,60),Q.anisotropy=e,Q.colorSpace=me,p.track=Q}else if(F==="dirt"){const q=await new Promise(yt=>{const ct=new Image;ct.onload=()=>yt(ct),ct.src=`${T}tex/asphalt.jpg`}),tt=document.createElement("canvas");tt.width=tt.height=512;const W=tt.getContext("2d");W.fillStyle="#C4BBA4",W.fillRect(0,0,512,512),W.globalAlpha=.4,W.globalCompositeOperation="overlay",W.drawImage(q,0,0,512,512),W.globalAlpha=.16,W.globalCompositeOperation="saturation",W.fillStyle="#808080",W.fillRect(0,0,512,512),W.globalAlpha=1,W.globalCompositeOperation="source-over",W.strokeStyle="rgba(120,110,92,0.35)",W.lineWidth=2,W.beginPath(),W.moveTo(0,256),W.lineTo(512,262),W.moveTo(256,0),W.lineTo(250,512),W.stroke();const Q=new ln(tt);Q.wrapS=Q.wrapT=Un,Q.repeat.set(24,24),Q.anisotropy=e,Q.colorSpace=me,p.dirt=Q}else if(F==="indoorwood"){const q=document.createElement("canvas");q.width=q.height=512;const tt=q.getContext("2d"),W=(()=>{let yt=7;return()=>(yt=yt*16807%2147483647)/2147483647})();for(let yt=0;yt<8;yt++){const ct=yt%2*128;for(let Wt=-1;Wt<3;Wt++){const Bt=Wt*256+ct,It=yt*64,R=.82+W()*.3;tt.fillStyle=`rgb(${Math.round(168*R)}, ${Math.round(126*R)}, ${Math.round(84*R)})`,tt.fillRect(Bt,It,256,64),tt.strokeStyle="rgba(70,48,30,0.55)",tt.lineWidth=2,tt.strokeRect(Bt+1,It+1,254,62),tt.strokeStyle="rgba(90,62,40,0.25)",tt.lineWidth=1;for(let ae=0;ae<4;ae++){const Nt=It+10+W()*46;tt.beginPath(),tt.moveTo(Bt+6,Nt),tt.lineTo(Bt+250,Nt+(W()-.5)*6),tt.stroke()}}}const Q=new ln(q);Q.wrapS=Q.wrapT=Un,Q.repeat.set(26,26),Q.anisotropy=e,Q.colorSpace=me,p.indoorwood=Q}else if(F==="wallpaper"){const q=document.createElement("canvas");q.width=q.height=256;const tt=q.getContext("2d");tt.fillStyle="#F7F4EE",tt.fillRect(0,0,256,256);const W=(()=>{let yt=13;return()=>(yt=yt*16807%2147483647)/2147483647})();for(let yt=0;yt<256;yt+=2){const ct=.02+W()*.045;tt.fillStyle=W()<.5?`rgba(210,202,188,${ct})`:`rgba(255,255,255,${ct})`,tt.fillRect(yt,0,1+W()*1.5,256)}for(let yt=0;yt<90;yt++)tt.fillStyle=`rgba(196,188,174,${.03+W()*.04})`,tt.fillRect(W()*256,W()*256,1,3+W()*9);const Q=new ln(q);Q.wrapS=Q.wrapT=Un,Q.repeat.set(9,5),Q.anisotropy=e,Q.colorSpace=me,p.wallpaper=Q}return p[F]}let I=0,A=null;function C(){return A==="indoor"?15723490:!A||A==="none"?8291727:12173514}function D(){if(!K)return;const F=C();n.background.setHex(F),n.fog.color.setHex(F)}let S=null;async function y(F){const q=++I;if(A=!F||F==="none"?null:F,!F||F==="none"){l.material.map=null,l.material.color.setHex(K?6712438:1514016),u.material.map=null,u.material.color.setHex(K?7765126:1843240),u.material.emissive?.setHex(0),l.material.needsUpdate=!0,u.material.needsUpdate=!0,c.visible=!0,d.visible=!0,S&&(S.visible=!1),_(),D();return}const tt=F==="court_gray"||F==="court_black",W=F==="indoor"||F==="court"?"indoorwood":F,[Q,yt]=await Promise.all([tt?null:x(W),x("plaster")]);if(q===I){if(!S){const ct=document.createElement("canvas");ct.width=ct.height=2048;const Wt=ct.getContext("2d"),Bt=2048/16;Wt.strokeStyle="rgba(250,250,245,0.85)",Wt.lineWidth=14,Wt.lineJoin="round";const It=(Nt,jt,ft,Ht)=>Wt.strokeRect((Nt+8)*Bt,(jt+8)*Bt,ft*Bt,Ht*Bt),R=(Nt,jt,ft,Ht,St)=>{Wt.beginPath(),Wt.arc((Nt+8)*Bt,(jt+8)*Bt,ft*Bt,Ht,St),Wt.stroke()};It(-7.5,-7.5,15,15),It(-2.45,-7.5,4.9,5.8),R(0,-1.7,1.8,0,Math.PI),R(0,-6.325,6.75,.18,Math.PI-.18),R(0,7.5,1.8,Math.PI,Math.PI*2);const ae=new ln(ct);ae.colorSpace=me,ae.anisotropy=e,S=new re(new Oe(16,16),new bn({map:ae,transparent:!0,depthWrite:!1})),S.rotation.x=-Math.PI/2,S.position.y=.006,S.renderOrder=1,n.add(S)}S.visible=F==="court"||tt,l.material.map=tt?null:Q,u.material.map=yt,tt?(l.material.color.setHex(F==="court_black"?988192:2830912),u.material.map=await x("wallpaper"),u.material.color.setHex(16777215),u.material.emissive?.setHex(K?7236195:5722955)):F==="indoor"||F==="court"?(l.material.color.setHex(K?16183784:14209218),u.material.map=await x("wallpaper"),u.material.color.setHex(16777215),u.material.emissive?.setHex(K?7236195:5722955)):(u.material.emissive?.setHex(0),l.material.color.setHex(K?14408667:9079434),u.material.color.setHex(K?14869218:10132122)),l.material.needsUpdate=!0,u.material.needsUpdate=!0,c.visible=!1,d.visible=!1,_(),D()}}const P={running:{pos:[2.9,2.1,2.9],look:[0,.7,-.6]},boxing:{pos:[3.5,1.9,3.9],look:[0,1.1,-.1]},basketball:{pos:[3.4,2.6,2.6],look:[0,.6,-1]}};function H(F){const q=P[F]||P.running;s.position.set(...q.pos),r.target.set(...q.look),r.update()}function B(F,q){h.visible=!!q,g=F,_(),H(F)}const V=n.children.find(F=>F.isHemisphereLight);let K=!1;function Y(F){if(K=!!F,Ue.day=K,K){const q=C();n.background.setHex(q),n.fog.color.setHex(q),n.fog.near=14,n.fog.far=40,V.color.setHex(14476526),V.groundColor.setHex(8291468),V.intensity=1.1,a.intensity=1.6,a.color.setHex(16774112),o.intensity=.12,l.material.map||l.material.color.setHex(6712438),u.material.map||u.material.color.setHex(7765126),l.material.map&&l.material.color.setHex(14408667),u.material.map&&u.material.color.setHex(14869218)}else n.background.setHex(790034),n.fog.color.setHex(790034),n.fog.near=9,n.fog.far=20,V.color.setHex(3752527),V.groundColor.setHex(1119258),V.intensity=1.1,a.intensity=1.5,a.color.setHex(16777215),o.intensity=.35,l.material.map||l.material.color.setHex(1514016),u.material.map||u.material.color.setHex(1843240),l.material.map&&l.material.color.setHex(9079434),u.material.map&&u.material.color.setHex(10132122);l.material.needsUpdate=!0,u.material.needsUpdate=!0}const nt=new r0(t),G=new a0(n,s);nt.addPass(G),nt.addPass(new ao({uniforms:{tDiffuse:{value:null}},vertexShader:"varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.);}",fragmentShader:"uniform sampler2D tDiffuse;varying vec2 vUv;void main(){vec4 c=texture2D(tDiffuse,vUv);if(c.r!=c.r||c.g!=c.g||c.b!=c.b||c.a!=c.a)c=vec4(0.0);gl_FragColor=clamp(c,0.0,60.0);}"}));const rt=new zi(new xt(i.clientWidth/2,i.clientHeight/2),Ue.bloomStrength,Ue.bloomRadius,Ue.bloomThreshold);nt.addPass(rt);const dt=new ao(c0);nt.addPass(dt),nt.addPass(new l0);function bt(F){rt.threshold=Ue.bloomThreshold+(Ue.day?.38:0),rt.strength=Ue.bloomStrength,rt.radius=Ue.bloomRadius,dt.uniforms.uGrain.value=Ue.grain,dt.uniforms.uVignette.value=Ue.vignette,dt.uniforms.uExposure.value=Ue.exposure,dt.uniforms.uTime.value=F,nt.render()}function kt(){t.domElement.style.width="0px",t.domElement.style.height="0px";const F=i.clientWidth,q=i.clientHeight;s.aspect=F/q,s.updateProjectionMatrix(),t.setSize(F,q),nt.setSize(F,q),rt.setSize(F/2,q/2)}window.addEventListener("resize",kt);function $t(F){const q=Math.round(F/2)*2;l.position.z=q,c.position.z=q}return{renderer:t,scene:n,camera:s,controls:r,setPackEnvironment:B,resize:kt,renderFrame:bt,composer:nt,setSurfaces:y,setDaylight:Y,followFloor:$t,wall:u,wallGroup:h,hoop:f,setRenderCamera:F=>{G.camera=F}}}const ce={stops:[["#B7231F",0],["#FA3030",.3],["#FE6E3C",.56],["#FEA35F",.74],["#FEC389",.86],["#FFF3DC",1]],sat:1,graphics:{width:1,halo:.9,noise:.5,ember:.3,duration:1.05,size:1.5},mark:{radius:1,core:1,halo:.9,pool:.55,sweep:1,wobble:.5},person:{blur:1,glow:0,flow:.4,decay:.04,detail:.6,grain:.07,tone:1},gainBoost:1,a3Arrow:4,liveUI:3,arrow:{line:"solid",w:1,speed:1,gap:1,glow:1,heat:.5,tail:.55},lane:{style:"dash"},card:{titleZ:2.68,eyebrow:.3,footerZ:1.28,titleCap:.13,eyeCap:.07,footCap:.065,cta:1}},Li=new Uint8Array(256*4);let en=null;function rh(){return _h(ce.stops,ce.sat,Li),en&&(en.needsUpdate=!0),Li}function rr(){return en||(rh(),en=new yo(Li,256,1,Ge),en.minFilter=en.magFilter=Ne,en.wrapS=en.wrapT=Nn,en.needsUpdate=!0),en}function h0(i){const t=Math.max(0,Math.min(255,Math.round(i*255)))*4;return en||rh(),`rgb(${Li[t]},${Li[t+1]},${Li[t+2]})`}const ah=`
