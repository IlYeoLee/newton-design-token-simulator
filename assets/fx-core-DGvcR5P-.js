const $={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},V={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},d0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],Gt=Object.fromEntries(Object.entries({...$,...V}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),Q=t=>`vec3(${d0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,Ht=(t,a=1)=>`rgba(${d0(t).join(",")},${a})`,f0=[[$.red,0],[$.red,.3],[$.coral,.56],[$.sand,.86],[$.prism,1]],m0=1;function x0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(V).some(o=>o.toUpperCase()===a)?!0:Object.values($).some(o=>o.toUpperCase()===a)}function Ot(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>x0(o)))&&(t.stops=f0.map(o=>[...o])),t.sat=m0,t)}const w0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",S0=.98,b0=.83,C0=-.043,v0=-.031,y0=5.5,A0=.027,M0=.25,T0=.26,I0=.3,L0=.4,R0=.038,k0=.84,P0=24,_0=1,F0=1.6,D0=.45,B0=.82,E0=0,G0=.5,H0=.5,O0=.125,U0=.4,W0=1,q0=.13,K0=0,$0=3.4,g0=.01,z0=0,j0=.011,X0=-2,J0=.8,Y0=-.085,Q0=.16,Z0=4,V0=.6,N0=1,tt=1,ot="glow",at="add",et="offbit",lt=.55,nt=.125,st=0,rt=1.55,it=0,ct=0,dt=1,ut=.55,ht={punchLine:{node:1,numS:1,comet:1,tailLen:.5,rail:.22}},pt=-.095,ft=.12,mt=10,xt=-.015,wt=.12,St=-10,bt={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15},Ct=.98,vt=1,yt={0:{sharp:0,op:.56},1:{tLo:.12,tHi:.84,op:.88,bloom:.1},2:{glow:0,halo:.16,w:.72,bloom:.07,shade:0,imp:1,sharp:0,edge:.004},4:{glow:0,halo:.14,w:.7,bloom:.06,shade:0,imp:1,edgeShadeGrad:0,pitch:.048,dot:.13,irot:21,dotCol:4,edge:.004,sharp:0,plantar:1,edgeShadeCol:4,op:.71},tap:{op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15}},At=1.45,Mt=.22,Tt=.55,It={_:"움직임 튜닝(markmotion.js 가 읽는다). 상태 8토큰과 직교 — 여기는 '어떻게 움직이나'만.",stepLead:.3,slideDecay:3,over:.14,overAt:.78,settle:.11,settleHz:2.4,popA:.16,popB:.18,popBAt:.11,airScale:.12,spawnDur:.44,hitDur:.34,arrowRamp:.16,arrowBreath:.06},Lt=0,Rt=0,kt=0,Pt={_:w0,imp:S0,scale:b0,offx:C0,offy:v0,irot:y0,pitch:A0,dot:M0,glow:T0,shade:I0,sharp:L0,edge:R0,plantar:k0,bands:P0,bandSoft:_0,w:F0,halo:D0,pool:B0,noise:E0,rip:G0,ripReach:H0,ripWidth:O0,ripSpeed:U0,ripGrad:W0,edgeShade:q0,shadeRed:K0,shadeRedW:$0,edgeW:g0,edgeSoft:z0,dither:j0,tilt:X0,gsize:J0,gx:Y0,gy:Q0,grot:Z0,gsh:V0,shadeCol:N0,ripCol:tt,gShadow:ot,gBlend:at,numSrc:et,prog:lt,bloom:nt,blur:st,edgeShadeW:rt,edgeShadeCol:it,edgeShadeGrad:ct,edgeShadeG0:dt,edgeShadeG1:ut,prims:ht,gxL:pt,gyL:ft,grotL:mt,gxR:xt,gyR:wt,grotR:St,tap:bt,op:Ct,dotCol:vt,states:yt,loadGain:At,loadBase:Mt,flow:Tt,motion:It,tLo:Lt,tHi:Rt,dotMode:kt};function s0(t,a,o,d,i){let e=0;o[0]=0,d[0]=-1e20,d[1]=1e20;for(let l=1;l<i;l++){let r=(t[l]+l*l-(t[o[e]]+o[e]*o[e]))/(2*l-2*o[e]);for(;r<=d[e];)e--,r=(t[l]+l*l-(t[o[e]]+o[e]*o[e]))/(2*l-2*o[e]);e++,o[e]=l,d[e]=r,d[e+1]=1e20}e=0;for(let l=0;l<i;l++){for(;d[e+1]<l;)e++;a[l]=(l-o[e])*(l-o[e])+t[o[e]]}}function r0(t,a){const o=new Float32Array(a),d=new Int32Array(a),i=new Float32Array(a+1),e=new Float32Array(a);for(let l=0;l<a;l++){for(let r=0;r<a;r++)e[r]=t[r*a+l];s0(e,o,d,i,a);for(let r=0;r<a;r++)t[r*a+l]=o[r]}for(let l=0;l<a;l++){for(let r=0;r<a;r++)e[r]=t[l*a+r];s0(e,o,d,i,a);for(let r=0;r<a;r++)t[l*a+r]=o[r]}}function u0(t,a){const d=new Float32Array(a*a),i=new Float32Array(a*a);let e=0,l=0,r=0;for(let C=0;C<a*a;C++){const h=t[C*4+3]/255;d[C]=h>=1?0:h<=0?1e20:Math.pow(Math.max(0,.5-h),2),i[C]=h>=1?1e20:h<=0?0:Math.pow(Math.max(0,h-.5),2),h>.5&&(e+=C%a,l+=C/a|0,r++)}r0(d,a),r0(i,a);const f=new Float32Array(a*a);for(let C=0;C<a*a;C++)f[C]=(Math.sqrt(d[C])-Math.sqrt(i[C]))/a;return{data:f,N:a,cx:r?e/r/a:.5,cy:r?l/r/a:.5}}function n0(t,a=512){const o="_raster"+a;if(t[o])return t[o];const d=document.createElement("canvas");d.width=d.height=a;const i=d.getContext("2d"),e=Math.min(a/t.naturalWidth,a/t.naturalHeight);i.drawImage(t,0,0,t.naturalWidth*e,t.naturalHeight*e);const l=i.getImageData(0,0,a,a).data;let r=a,f=a,C=-1,h=-1;for(let u=0;u<a;u++)for(let n=0;n<a;n++)l[(u*a+n)*4+3]>8&&(n<r&&(r=n),n>C&&(C=n),u<f&&(f=u),u>h&&(h=u));return t[o]=C<0?{canvas:d,x:0,y:0,w:a,h:a}:{canvas:d,x:r,y:f,w:C-r+1,h:h-f+1},t[o]}function Ut(t,a,o=!1){const d=n0(t,a),i=document.createElement("canvas");i.width=i.height=a;const e=i.getContext("2d"),l=Math.min(a*t0/d.w,a*t0/d.h),r=d.w*l,f=d.h*l;return o&&(e.translate(0,a),e.scale(1,-1)),e.drawImage(d.canvas,d.x,d.y,d.w,d.h,(a-r)/2,(a-f)/2,r,f),u0(e.getImageData(0,0,a,a).data,a)}function Wt(t,a,o,d=!1){const i=n0(t,o),e=a?n0(a,o):null,l=Math.min(o*t0/i.w,o*t0/i.h),r=i.w*l,f=i.h*l,C=(o-r)/2,h=(o-f)/2,u=L=>{const G=document.createElement("canvas");G.width=G.height=o;const k=G.getContext("2d");return d&&(k.translate(0,o),k.scale(1,-1)),k.drawImage(L.canvas,i.x,i.y,i.w,i.h,C,h,r,f),u0(k.getImageData(0,0,o,o).data,o)},n=u(i),c=e?u(e):null,s=new Float32Array(o*o*2);for(let L=0;L<o*o;L++)s[L*2]=n.data[L],s[L*2+1]=c?c.data[L]:1;return{data:s,N:o,cx:n.cx,cy:n.cy,inCx:c?c.cx:n.cx,inCy:c?c.cy:n.cy,hasInner:!!c}}const qt=1.9922,_t=.78,t0=.52,Kt=_t/t0,$t=1.18,j=Pt||{},h0={size:j.gsize??.85,gx:j.gx??-.025,gy:j.gy??.195,rot:j.grot??6,gxL:j.gxL,gyL:j.gyL,rotL:j.grotL,gxR:j.gxR,gyR:j.gyR,rotR:j.grotR,shadow:j.gShadow??"glow",shadowK:j.gsh??.75,blend:j.gBlend??"add"};function gt(t,a=h0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function zt(t,a,o,d,i=h0){const e=Math.round(o*.75),l=i.shadow==="none"?0:i.shadowK??.75,r=f=>d(t,String(a),o/2,o/2,e,f);return i.shadow==="drop"&&l>.001?(t.save(),t.globalAlpha=Math.min(1,l*.7),t.translate(o*.018,o*.024),r({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),r({glow:0,glowColor:"rgba(0,0,0,0)"})):r(i.shadow==="glow"?{glow:26*l,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),i.blend==="knock"}function jt(t,a){const o=t.getImageData(0,0,a,a),d=t.createImageData(a,a);for(let i=0;i<a*a;i++){const e=o.data[i*4+3]/255,l=Math.round(255*(1-e));d.data[i*4]=d.data[i*4+1]=d.data[i*4+2]=l,d.data[i*4+3]=255}t.putImageData(d,0,0)}const Xt={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},e0=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),l0=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function i0(t,a,o){t=e0(t),a=e0(a),o=e0(o);const d=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),i=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),e=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*d+.793617785*i-.0040720468*e,1.9779984951*d-2.428592205*i+.4505937099*e,.0259040371*d+.7827717662*i-.808675766*e]}function Ft(t,a,o){const d=(t+.3963377774*a+.2158037573*o)**3,i=(t-.1055613458*a-.0638541728*o)**3,e=(t-.0894841775*a-1.291485548*o)**3;return[l0(4.0767416621*d-3.3077115913*i+.2309699292*e),l0(-1.2684380046*d+2.6097574011*i-.3413193965*e),l0(-.0041960863*d-.7034186147*i+1.707614701*e)]}const c0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function Jt(t,a=1,o=new Uint8Array(256*4)){const d=[...t].sort((i,e)=>i[1]-e[1]);for(let i=0;i<256;i++){const e=i/255;let l=0;for(;l<d.length-2&&e>d[l+1][1];)l++;const[r,f]=d[l],[C,h]=d[l+1],u=Math.max(0,Math.min(1,(e-f)/Math.max(1e-5,h-f))),n=i0(...c0(r)),c=i0(...c0(C)),s=Ft(n[0]+(c[0]-n[0])*u,(n[1]+(c[1]-n[1])*u)*a,(n[2]+(c[2]-n[2])*u)*a);o.set([...s,255],i*4)}return o}const Yt=`
...
#define C_GRAYF ${Q(V.hi)}
#define C_GRAYL ${Q(V.lo)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function Dt(t,a,o,d){t.lineWidth=4*a;const i=d.arrow;i.line==="dash"?t.setLineDash([12*a*i.gap,10*i.gap]):i.line==="dot"?(t.setLineDash([.5,12*i.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&i.line!=="solid"&&i.line!=="taper"&&(t.lineDashOffset=-o*40*i.speed)}function Nt(t,a,o,d,i,e={}){const l=i.lut,r=i.arrow||{},f=r.w??1,C=r.speed??1,h=r.glow??1,u=e.pulse??1,n=o/256,c=n*(e.scale??1),s=a/2,L=d*.9*C%1,G=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,L/.55),k=e.prog!=null?1:L>.88?(1-L)/.12:1;t.clearRect(0,0,a,o);const m=k*(.45+.55*u),T=o-24*n,I=58*n,_=T+(I-T)*G,b=(E,R)=>l(E).replace("rgb(","rgba(").replace(")",`,${R.toFixed(3)})`),p=1.1*c*f,x=13*c*f,w=42*c*(.7+.3*f),D=!e.noTip&&G>.28?Math.min(1,(G-.28)/.22)*w*.42:0,A=_+D,y=t.createLinearGradient(0,T,0,A);y.addColorStop(0,b(.55,0)),y.addColorStop(.18,b(.64,.3*m)),y.addColorStop(.4,b(.76,.8*m)),y.addColorStop(.65,b(.88,.98*m)),y.addColorStop(1,b(.97,m));const B=e.dots?(()=>{const E=Math.abs(A-T),R=Math.max(3,Math.round(E/(9.5*c))),S=d*1.15*C%1,M=(H,U,v)=>{const P=Math.max(0,Math.min(1,(v-H)/(U-H)));return P*P*(3-2*P)},F=[];for(let H=0;H<R;H++){const U=((H+.5)/R+S/R)%1,v=1+.22*Math.sin((U*3-S*2)*Math.PI*2);F.push({y:T+(A-T)*U,r:(p/2+(x/2-p/2)*U)*v,a:(1-.35*M(.72,.92,U))*(1-M(.92,1,U))})}return F})():null;if(t.save(),t.filter=`blur(${7*c}px)`,t.globalAlpha=e.dots?.3:.55,t.fillStyle=y,e.dots){const E=t.globalAlpha;for(const R of B)t.globalAlpha=E*R.a,t.beginPath(),t.arc(s,R.y,Math.max(1.4*c,R.r*1.5),0,Math.PI*2),t.fill();t.globalAlpha=E}else t.beginPath(),t.moveTo(s-p,T),t.lineTo(s+p,T),t.lineTo(s+x*.95,A),t.lineTo(s-x*.95,A),t.closePath(),t.fill();if(t.restore(),t.globalAlpha=1,t.fillStyle=y,e.dots){for(const E of B)t.globalAlpha=E.a,t.beginPath(),t.arc(s,E.y,Math.max(.9*c,E.r*.92),0,Math.PI*2),t.fill();t.globalAlpha=1}else t.beginPath(),t.moveTo(s-p/2,T),t.lineTo(s+p/2,T),t.lineTo(s+x/2,A),t.lineTo(s-x/2,A),t.closePath(),t.fill();if(t.globalAlpha=m,G>.28&&!e.noTip){const E=w,R=Math.min(1,(G-.28)/.22)*m,S=_+E*.3;t.globalAlpha=R;const M={color:l(.95),glowColor:l(.85),glow:12*h};i.glyph&&(i.glyph(t,"LIFT_TIP",s,S,E,M)||i.glyph(t,"TIP_TRI",s,S,E*.93,M))||(t.strokeStyle=l(.95),t.lineWidth=13*c*f,t.lineCap="round",t.lineJoin="round",t.shadowColor=l(.9),t.shadowBlur=18*c*h,t.beginPath(),t.moveTo(s-26*c,S+14*c),t.lineTo(s,S-16*c),t.lineTo(s+26*c,S+14*c),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function Bt(t,a,o,d,i,e,l={}){const r=e.lut,f=e.arrow||{},C=f.w??1,h=f.glow??1,u=o/256*(l.scale??1);t.clearRect(0,0,a,o);const n=d.map(([b,p])=>[b*a,p*o]);if(n.length<2)return;const c=48,s=[],L=b=>{if(n.length===2)return[n[0][0]+(n[1][0]-n[0][0])*b,n[0][1]+(n[1][1]-n[0][1])*b];const p=b*(n.length-1),x=Math.min(n.length-2,Math.floor(p)),w=p-x,D=n[Math.max(0,x-1)],A=n[x],y=n[x+1],B=n[Math.min(n.length-1,x+2)],E=(R,S,M,F)=>.5*(2*S+(-R+M)*w+(2*R-5*S+4*M-F)*w*w+(-R+3*S-3*M+F)*w*w*w);return[E(D[0],A[0],y[0],B[0]),E(D[1],A[1],y[1],B[1])]};for(let b=0;b<=c;b++)s.push(L(b/c));const G=Math.max(0,Math.min(1,l.prog!=null?l.prog:i*.55%1)),k=Math.max(1,Math.round(c*G)),m=l.alpha??1,T=l.tail??.22;t.lineCap="round";const I=42*u*(.7+.3*C);let _=k;if(G>.28){let b=0;const p=I*.42*Math.min(1,(G-.28)/.22);for(;_>1&&b<p;)b+=Math.hypot(s[_][0]-s[_-1][0],s[_][1]-s[_-1][1]),_--}for(const b of[0,1])for(let p=1;p<=_;p++){const x=p/k,w=Math.min(1,x/T),D=w*w*(3-2*w)*m;t.globalAlpha=b?D:D*.16*x,t.strokeStyle=r(.55+.42*x),t.lineWidth=(1.1+11.9*x)*u*C*(b?1:1.9),t.beginPath(),t.moveTo(s[p-1][0],s[p-1][1]),t.lineTo(s[p][0],s[p][1]),t.stroke()}if(G>.28){const b=s[Math.max(0,k-2)][0],p=s[Math.max(0,k-2)][1],x=Math.atan2(s[k][1]-p,s[k][0]-b)+Math.PI/2,w=s[k][0]-Math.sin(x)*I*.3,D=s[k][1]+Math.cos(x)*I*.3;t.save(),t.translate(w,D),t.rotate(x),t.globalAlpha=Math.min(1,(G-.28)/.22)*m;const A={color:r(.95),glowColor:r(.85),glow:12*h};e.glyph&&(e.glyph(t,"LIFT_TIP",0,0,I,A)||e.glyph(t,"TIP_TRI",0,0,I*.93,A))||(t.strokeStyle=r(.95),t.lineWidth=9*u*C,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*u,12*u),t.lineTo(0,-14*u),t.lineTo(18*u,12*u),t.stroke()),t.restore()}t.globalAlpha=1}function Et(t,a,o,d,i,e){i=i||{};const l=e.lut,r=i.style||e.arrow.line,f=!!i.closed,C=[0];for(let c=1;c<a.length;c++)C.push(C[c-1]+Math.hypot(a[c][0]-a[c-1][0],a[c][1]-a[c-1][1]));const h=C[C.length-1]||1,u=c=>{c=(c%h+h)%h;let s=1;for(;s<C.length-1&&C[s]<c;)s++;const L=(c-C[s-1])/Math.max(1e-4,C[s]-C[s-1]);return[a[s-1][0]+(a[s][0]-a[s-1][0])*L,a[s-1][1]+(a[s][1]-a[s-1][1])*L,Math.atan2(a[s][1]-a[s-1][1],a[s][0]-a[s-1][0])]},n=e.arrow;if(r==="chevron"){const c=(26*d+8)*n.gap,s=Math.max(2,Math.floor(h/c));t.shadowColor=l(Math.min(1,n.heat+.2)),t.shadowBlur=8*d*n.glow;for(let L=0;L<s;L++){const G=L*c+o*42*n.speed%c;if(!f&&G>h-4)continue;const[k,m,T]=u(G),I=7.5*d,_=8.5*d,b=.45+.4*Math.sin(G/h*6.283-o*2.2*n.speed);t.strokeStyle=l(n.heat-.05+b*.3),t.lineWidth=3.2*d,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(k,m),t.rotate(T),t.beginPath(),t.moveTo(-_*.5,-I),t.lineTo(_*.5,0),t.lineTo(-_*.5,I),t.stroke(),t.restore()}return!0}if(r==="comet"){const c=o*.35*n.speed%1*h,s=h*n.tail,L=Math.max(24,a.length*2);t.lineCap="round";for(let m=0;m<L;m++){const T=c-m/L*s,I=c-(m+1)/L*s;if(!f&&I<0)break;const _=1-m/L,[b,p]=u(T),[x,w]=u(I);!f&&Math.hypot(x-b,w-p)>h*.4||(t.globalAlpha=Math.pow(_,1.6),t.strokeStyle=l(Math.max(.05,n.heat-.2)+_*.55),t.lineWidth=(1.5+_*4.5)*d,_>.72?(t.shadowColor=l(Math.min(1,n.heat+.3)),t.shadowBlur=_*12*d*n.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(b,p),t.lineTo(x,w),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[G,k]=u(c);return t.fillStyle=rgba(V.ink,.95),t.shadowColor=l(.9),t.shadowBlur=16*d,t.beginPath(),t.arc(G,k,2.6*d,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=i.color||l(n.heat),t.shadowColor=l(Math.min(1,n.heat+.15)),t.shadowBlur=(i.glow??8)*d*n.glow,r==="taper")for(let c=1;c<a.length;c++)t.lineWidth=(.5+c/a.length*4.5)*d,t.beginPath(),t.moveTo(a[c-1][0],a[c-1][1]),t.lineTo(a[c][0],a[c][1]),t.stroke();else Dt(t,d,o,e),t.beginPath(),a.forEach(([c,s],L)=>L?t.lineTo(c,s):t.moveTo(c,s)),f&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function to(t,a,o,d,i,e){const l=13*d.halo,r=e.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const f=a/220,C=a/2,h=18*o.round*f,u=40*f,n=48*f,c=a-80*f,s=a-96*f,L=[],G=(m,T,I,_)=>{for(let b=0;b<=1;b+=.12)L.push([m+(I-m)*b,T+(_-T)*b])};G(u+h,n,u+c-h,n),G(u+c,n+h,u+c,n+s-h),G(u+c-h,n+s,u+h,n+s),G(u,n+s-h,u,n+h),t.shadowColor=r(.6),t.shadowBlur=l*.8;const k=4*e.arrow.w*f;if(e.arrow.line==="solid"?(t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-i*22*f,t.strokeStyle=r(.45),t.lineWidth=k,t.beginPath(),t.roundRect(u,n,c,s,h),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):Et(t,L,i,e.arrow.w*f,{color:r(.45),closed:!0},e),o.prog!=null&&o.prog>.001){const m=[],T=(y,B,E,R,S)=>{for(let M=1;M<=S;M++)m.push([y+(E-y)*M/S,B+(R-B)*M/S])},I=(y,B,E,R,S)=>{for(let M=1;M<=S;M++){const F=E+(R-E)*M/S;m.push([y+h*Math.cos(F),B+h*Math.sin(F)])}},_=Math.PI/2,b=u+c,p=n+s,x=u+c/2;m.push([x,n]),T(x,n,b-h,n,8),I(b-h,n+h,-_,0,6),T(b,n+h,b,p-h,10),I(b-h,p-h,0,_,6),T(b-h,p,u+h,p,14),I(u+h,p-h,_,Math.PI,6),T(u,p-h,u,n+h,10),I(u+h,n+h,Math.PI,Math.PI+_,6),T(u+h,n,x,n,8);let w=0;for(let y=1;y<m.length;y++)w+=Math.hypot(m[y][0]-m[y-1][0],m[y][1]-m[y-1][1]);const D=w*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-(c/2-h)-i*22*f,t.strokeStyle=r(.9),t.lineWidth=k*1.3,t.lineCap="round",t.shadowColor=r(.92),t.shadowBlur=l*1.3,t.beginPath(),t.moveTo(m[0][0],m[0][1]);let A=0;for(let y=1;y<m.length&&A<D;y++){const B=Math.hypot(m[y][0]-m[y-1][0],m[y][1]-m[y-1][1]);if(A+B<=D)t.lineTo(m[y][0],m[y][1]),A+=B;else{const E=(D-A)/B;t.lineTo(m[y-1][0]+(m[y][0]-m[y-1][0])*E,m[y-1][1]+(m[y][1]-m[y-1][1])*E),A=D}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&e.foot&&(e.foot(t,!1,C-16*o.feet*f,C+6*f,26*o.feet*f),e.foot(t,!0,C+16*o.feet*f,C+6*f,26*o.feet*f)),t.shadowBlur=0}function oo(t,a,o,d,i,e,l,r){const f=13*d.halo,C=4*e.arrow.w*(a/220),h=e.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const u=a/220,n=l||[[45*u,130*u],[110*u,60*u],[175*u,110*u]],c=r??i*.5%1,s=Math.min(1,c*1.25)*(n.length-1),L=Math.min(n.length-1,Math.floor(s+.35));t.shadowColor=h(.7),t.shadowBlur=f;const G=p=>{const x=Math.max(0,Math.min(n.length-2,Math.floor(p))),w=p-x;return[n[x][0]+(n[x+1][0]-n[x][0])*w,n[x][1]+(n[x+1][1]-n[x][1])*w]},k=o.comet!=null?o.comet:1,m=o.tailLen!=null?o.tailLen:.5;if(t.save(),t.shadowBlur=0,t.globalAlpha=o.rail!=null?o.rail:.22,t.strokeStyle=h(.6),t.lineWidth=2.2*u,t.lineCap="round",t.setLineDash([.01,8*u]),t.beginPath(),n.forEach(([p,x],w)=>w?t.lineTo(p,x):t.moveTo(p,x)),t.stroke(),t.setLineDash([]),t.restore(),s>.02){const p=(x,w)=>h(x).replace("rgb(","rgba(").replace(")",`,${w.toFixed(3)})`);for(let x=0;x<26;x++){const w=x/25,D=s-m*w;if(D<=0)break;const A=G(D),y=4.7*u*k*(1-w*.75),B=y*2.1,E=(1-w)*(1-w)*.8,R=t.createRadialGradient(A[0],A[1],0,A[0],A[1],B);R.addColorStop(0,p(.55-.18*w,E)),R.addColorStop(.5,p(.5-.18*w,E*.35)),R.addColorStop(1,p(.45-.18*w,0)),t.save(),t.shadowBlur=0,t.globalAlpha=1,t.fillStyle=R,t.beginPath(),t.arc(A[0],A[1],B,0,Math.PI*2),t.fill(),t.restore()}if(s<n.length-1-.001&&s-Math.floor(s)>.03){const x=G(s);t.save(),t.fillStyle=h(.62),t.shadowColor=h(.8),t.shadowBlur=11*u*k,t.beginPath(),t.arc(x[0],x[1],5.6*u*k,0,Math.PI*2),t.fill(),t.fillStyle=h(.95),t.globalAlpha=.95,t.beginPath(),t.arc(x[0],x[1],2.1*u*k,0,Math.PI*2),t.fill(),t.restore()}}t.globalAlpha=1,t.lineCap="butt";const T=o.done!=null,I=o.done||0,_=o.vd||[],b=o.acc!=null?o.acc:n.length-1;if(n.forEach(([p,x],w)=>{const D=w<I,A=_[w]||null,y=!D&&w===L&&!T,B=y?1+Math.sin(i*6)*.14:1,E=o.pop!=null&&w===I-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,R=12*o.node*B*E*u*(w===b?1.34:1);D&&A!=="miss"&&(t.shadowBlur=f*1.4,t.shadowColor=h(.5),t.fillStyle=h(A==="near"?.5:.36),t.beginPath(),t.arc(p,x,R*.88,0,Math.PI*2),t.fill()),D||(t.save(),t.translate(p,x),N(t,h,R,y?.8:.5,y?.9:.5,C*.9,f),t.restore()),t.strokeStyle=A==="hit"?$.prism:A==="near"?$.sand:A==="miss"?V.lo:h(D?.62:y?.8:.45),t.lineWidth=C*(y?1.3:A?1.15:.9),t.shadowBlur=y?f*1.6:A&&A!=="miss"?f*1.3:f*.6,A&&A!=="miss"&&(t.shadowColor=A==="hit"?$.prism:$.sand),t.beginPath(),t.arc(p,x,R,0,Math.PI*2),t.stroke(),e.num&&(D&&A!=="miss"?(t.save(),t.globalCompositeOperation="destination-out",t.shadowBlur=0,e.num(t,String(w+1),p,x,16*o.numS*B*u,Math.round(14*o.numS*u)),t.restore()):(t.globalAlpha=w<=L?1:.6,e.num(t,String(w+1),p,x,16*o.numS*B*u,Math.round(14*o.numS*u)),t.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&I>0&&n[I-1]){const[p,x]=n[I-1],w=1-o.pop/.38,D=w*w,A=12*o.node*u*(I-1===(o.acc!=null?o.acc:n.length-1)?1.34:1);t.save();const y=A*(1.6+1.9*(1-w)),B=t.createRadialGradient(p,x,0,p,x,y);B.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*D).toFixed(3)})`),B.addColorStop(.35,h(.92).replace("rgb(","rgba(").replace(")",`,${(.8*D).toFixed(3)})`)),B.addColorStop(1,h(.7).replace("rgb(","rgba(").replace(")",",0)")),t.fillStyle=B,t.beginPath(),t.arc(p,x,y,0,Math.PI*2),t.fill(),t.strokeStyle=h(.92),t.globalAlpha=D,t.lineWidth=Math.max(1,6*u*w),t.shadowColor=h(.85),t.shadowBlur=24*u*D,t.beginPath(),t.arc(p,x,A*(1.1+3.4*(1-w)),0,Math.PI*2),t.stroke();const E=Math.max(0,w-.35)/.65;E>0&&(t.globalAlpha=E*E*.6,t.lineWidth=Math.max(1,3.5*u*E),t.beginPath(),t.arc(p,x,A*(1.1+2*(1-E)),0,Math.PI*2),t.stroke()),t.restore()}t.shadowBlur=0}function N(t,a,o,d,i,e,l,r=1){if(o<=.6)return;const f=(c,s)=>a(c).replace("rgb(","rgba(").replace(")",`,${s})`),C=e*2.6*r,h=Math.max(.1,o-C),u=o+C,n=t.createRadialGradient(0,0,h,0,0,u);n.addColorStop(0,f(d-.05,0)),n.addColorStop(.5,f(d,i*.85)),n.addColorStop(1,f(d-.05,0)),t.globalAlpha=1,t.fillStyle=n,t.shadowBlur=0,t.beginPath(),t.arc(0,0,u,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,i*1.1),t.lineWidth=e*.85,t.strokeStyle=a(Math.min(.98,d+.12)),t.shadowColor=a(.88),t.shadowBlur=l*.6,t.beginPath(),t.arc(0,0,o,0,Math.PI*2),t.stroke(),t.shadowBlur=0}const a0=t=>1-Math.pow(1-Math.max(0,Math.min(1,t)),5);function ao(t,a,o,d,i,e){const l=e.lut,r=a/512,f=e.arrow&&e.arrow.w||1,C=(S,M)=>l(S).replace("rgb(","rgba(").replace(")",","+M+")"),h=e?.day?.95:.86,u=(S,M)=>C(h,S),n=4*f*r;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const c=o.mat||{nx:.86,fx:.86,ny:-.86,fy:.86},s=o.in==null?1:Math.max(0,Math.min(1,o.in)),L=a0(s/.45),G=S=>a0((s-.28-S*.09)/.42),k=o.hit==null?9:o.hit,m=k<.34?Math.sin(Math.PI*(k/.34)):0,T=S=>a/2+S*a/2,I=S=>a/2-S*a/2,_=(S,M)=>l(S).replace("rgb(","rgba(").replace(")",","+M+")"),b=(S,M,F,H,U,v,P)=>{t.font="700 "+H+'px "Supreme", sans-serif',t.textAlign="center",t.textBaseline="middle";const O=Array.from(String(S)),W=H*v;let q=-W;for(const g of O)q+=t.measureText(g).width+W;let K=M-q/2;t.fillStyle=U;for(const g of O){const X=t.measureText(g).width;t.fillText(g,K+X/2,F),K+=X+W}},p=.05*(o.round!=null?o.round/.35:1),x=(S,M,F,H)=>{};x(-c.fx+p,c.fy-p),x(-c.nx+p*.6,c.ny+p),x(c.nx-p*.6,c.ny+p),x(c.fx-p,c.fy-p);const w=o.center?o.center.x:0,D=o.center?o.center.y:0,A=(o.center&&o.center.r!=null?o.center.r:.26)*a/2*L*(1+.055*m+.008*Math.sin(i*2.4)),y=(o.targets||[]).slice().sort((S,M)=>(S.n||0)-(M.n||0));if(y.length){t.save(),t.shadowBlur=0,t.globalAlpha=.22*a0(s/.9),t.strokeStyle=l(.6),t.lineWidth=2.2*r,t.lineCap="round",t.setLineDash([.01,8*r]);const S=o.travel||{};for(const M of y){const F=T(M.x),H=I(M.y),U=T(w)-F,v=I(D)-H,P=S.k>0&&S.k<1&&(M.n===S.from||M.n===S.to),O=Math.hypot(U,v)||1,W=(M.r!=null?M.r:.2)*a/2*1.16,q=F+U/O*W,K=H+v/O*W,g=T(w)-U/O*A*1.12,X=I(D)-v/O*A*1.12;if(t.beginPath(),t.moveTo(q,K),t.lineTo(g,X),t.stroke(),m>.01){const z=1-m,J=.34,Y=t.createLinearGradient(g,X,q,K),Z=(o0,p0)=>Y.addColorStop(Math.max(0,Math.min(1,o0)),l(.85).replace("rgb(","rgba(").replace(")",","+p0+")"));Z(z-J,0),Z(z,.9*m),Z(z+J,0),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=Y,t.lineWidth=3.4*r,t.stroke(),t.restore()}if(P){const z=t.createLinearGradient(q,K,g,X),J=Math.sin(Math.PI*S.k)*.85;z.addColorStop(0,l(.5).replace("rgb(","rgba(").replace(")",",0)")),z.addColorStop(.5,l(.9).replace("rgb(","rgba(").replace(")",","+J+")")),z.addColorStop(1,l(.5).replace("rgb(","rgba(").replace(")",",0)")),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=z,t.lineWidth=3*r,t.stroke(),t.restore()}}t.setLineDash([]),t.restore()}const B=o.travel;if(B&&B.k>.001&&B.k<1){const S=y.find(F=>F.n===B.from),M=y.find(F=>F.n===B.to);if(S&&M){const F=T(S.x),H=I(S.y),U=T(M.x),v=I(M.y),P=T(w),O=I(D),W=a0(B.k),q=Y=>Y<.5?[F+(P-F)*(Y/.5),H+(O-H)*(Y/.5)]:[P+(U-P)*((Y-.5)/.5),O+(v-O)*((Y-.5)/.5)],[K,g]=q(W),[X,z]=q(Math.max(0,W-.28)),J=t.createLinearGradient(X,z,K,g);J.addColorStop(0,l(.5).replace("rgb(","rgba(").replace(")",",0)")),J.addColorStop(1,l(.85).replace("rgb(","rgba(").replace(")",",0.85)")),t.strokeStyle=J,t.lineWidth=3.2*r,t.lineCap="round",t.beginPath(),t.moveTo(X,z),t.lineTo(K,g),t.stroke(),t.fillStyle=l(.62),t.shadowColor=l(.8),t.shadowBlur=11*r,t.beginPath(),t.arc(K,g,5.6*r,0,Math.PI*2),t.fill(),t.fillStyle=l(.95),t.globalAlpha=.95,t.shadowBlur=0,t.beginPath(),t.arc(K,g,2.1*r,0,Math.PI*2),t.fill(),t.globalAlpha=1}}const E=e?.day?1:0,R=13*d.halo*(E?.45:1);for(const S of o.targets||[]){const M=S.on!==!1,F=!!S.live,H=G(S.n?S.n-1:0);if(H<=.001)continue;const U=T(S.x),v=I(S.y),P=(S.r!=null?S.r:.2)*a/2*(F?1.34:1)*(.9+.1*H);t.globalAlpha=H*(M?1:.45),t.shadowBlur=R*1.4,t.shadowColor=l(.5),t.fillStyle=e?.day?l(F?.26:.62):l(F?.5:.36),t.beginPath(),t.arc(U,v,P*.88,0,Math.PI*2),t.fill(),t.shadowBlur=0,t.save(),t.translate(U,v),N(t,l,P,F?.8:.5,F?.9:.5,n*.9,R),t.restore(),e.num(t,S.n,U,v,P*.9,Math.round(P*.78)),t.globalAlpha=1}if(o.center&&o.hit!=null){const S=T(w),M=I(D),F=13*d.halo,H=o.per||.4,U=Math.max(0,Math.min(1,k/H)),v=A*1.9;for(let P=2;P>=0;P--){const O=Math.pow(Math.max(0,U-P*.05),1.6),W=v-(v-A)*O,q=P===0?.55+.35*O:.16/P;t.save(),t.translate(S,M),N(t,l,W,.5+.35*O,q,n*.7,F,1.15-.35*O),t.restore()}m>.01&&(t.save(),t.translate(S,M),N(t,l,A*(1+1.5*(1-m)),.92,m*.85,n*.8,F,1.1),t.restore())}if(o.center){const S=T(w),M=I(D),F=t.createRadialGradient(S,M,A*.1,S,M,A*1.6);if(F.addColorStop(0,_(.42,.3)),F.addColorStop(.6,_(.35,.12)),F.addColorStop(1,_(.3,0)),t.fillStyle=F,t.beginPath(),t.arc(S,M,A*1.6,0,Math.PI*2),t.fill(),o.center.ring!==0&&(t.strokeStyle=_(.3,.3),t.lineWidth=n*.85,t.shadowColor=l(.42),t.shadowBlur=18*r,t.beginPath(),t.arc(S,M,A,0,Math.PI*2),t.stroke(),t.shadowBlur=0),o.brand&&e.logo&&e.logo.complete&&e.logo.naturalWidth){const H=A*1.05,U=H*e.logo.naturalHeight/e.logo.naturalWidth;t.globalAlpha=.5*L,t.drawImage(e.logo,S-H/2,M-U/2,H,U),t.globalAlpha=1}if(o.center.label){const H=String(o.center.label).split(`
`);H.forEach((U,v)=>b(U,S,M+(v-(H.length-1)/2)*15*r,12*r,u(.9),.14))}}if(o.chev){const S=(M,F)=>{for(let H=0;H<2;H++){const U=H*9*r,v=11*r,P=7*r,O=M+F*U;t.beginPath(),t.moveTo(T(w)-v,O-F*P),t.lineTo(T(w),O),t.lineTo(T(w)+v,O-F*P),t.stroke()}};t.strokeStyle=u(.45+.3*Math.sin(i*2.4)),t.lineWidth=2.2*f*r,S(I(D)-A*2,-1),S(I(D)+A*2,1)}if(o.prog>.001&&o.center){const S=T(w),M=I(D),F=m;t.strokeStyle=_(.34,.9+.1*F),t.lineWidth=n*(.85+.5*F),t.lineCap="round",t.shadowColor=l(.42),t.shadowBlur=(10+16*F)*r,t.beginPath(),t.arc(S,M,A,-Math.PI/2,-Math.PI/2+Math.PI*2*Math.min(1,o.prog)),t.stroke(),t.shadowBlur=0}}function eo(t,a,o,d,i,e,l){const r=e.lut,f=13*d.halo,C=a/220,h=a/2,u=e.arrow&&e.arrow.w||1,n=(b,p)=>r(b).replace("rgb(","rgba(").replace(")",`,${p})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const c=(o.r!=null?o.r:.42)*a,s=c*(o.rt!=null?o.rt:.36),L=3.4*u*C,G=l!=null?Math.max(0,Math.min(1,l)):i*(o.tempo||.6)%1,k=Math.pow(G,1.6),m=Math.max(0,(G-.9)/.1);t.save(),t.translate(h,h);const T=(b,p,x,w=1)=>N(t,r,b,p,x,L,f,w),I=t.createRadialGradient(0,0,0,0,0,s*1.08);I.addColorStop(0,n(.6,.1+.18*m)),I.addColorStop(.65,n(.5,.05+.08*m)),I.addColorStop(1,n(.5,0)),t.globalAlpha=1,t.fillStyle=I,t.beginPath(),t.arc(0,0,s*1.08,0,Math.PI*2),t.fill();const _=1+.02*Math.sin(i*2.6);T(s*_,.55+.4*m,.5+.45*m,.9);for(let b=2;b>=0;b--){const p=Math.pow(Math.max(0,G-b*.05),1.6),x=c-(c-s)*p,w=b===0?.6+.4*k:.18/b*(1-m);T(x,.55+.4*k,w*(1-m*.45),1.15-.35*k)}m>.01&&T(s*(1+1.4*m),.9,(1-m)*.8,1.1),t.globalAlpha=.6+.3*m,t.shadowColor=r(.85),t.shadowBlur=f*(.9+m),t.fillStyle=r(.62+.3*m),t.beginPath(),t.arc(0,0,L*.85+3*C*m,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function lo(t,a,o,d,i,e,l,r){const f=e.lut,C=13*d.halo,h=a/220,u=a/2,n=e.arrow&&e.arrow.w||1,c=n*h,s=(v,P)=>f(v).replace("rgb(","rgba(").replace(")",","+P+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const L=a*.42*(o.spread!=null?o.spread:1),k=(r||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([v,P])=>[u+v*L,u+P*L]),m=80,T=[];for(let v=0;v<=m;v++){const P=v/m*(k.length-1),O=Math.min(k.length-2,Math.floor(P)),W=P-O,q=k[Math.max(0,O-1)],K=k[O],g=k[O+1],X=k[Math.min(k.length-1,O+2)],z=(J,Y,Z,o0)=>.5*(2*Y+(-J+Z)*W+(2*J-5*Y+4*Z-o0)*W*W+(-J+3*Y-3*Z+o0)*W*W*W);T.push([z(q[0],K[0],g[0],X[0]),z(q[1],K[1],g[1],X[1])])}const I=v=>{const P=Math.max(0,Math.min(m,v*m)),O=Math.floor(P),W=P-O,q=T[O],K=T[Math.min(m,O+1)];return[q[0]+(K[0]-q[0])*W,q[1]+(K[1]-q[1])*W]},_=.68;let b,p,x;if(l!=null)b=Math.max(0,Math.min(1,l)),p=1,x=0;else{const v=i*(o.tempo||.42)%1;if(v<_)b=v/_,p=1,x=0;else{const P=(v-_)/(1-_);b=1,p=1-P*P,x=P}}if(p<=.012)return;const w=b*b*b*(b*(6*b-15)+10),D=Math.min(1,16*b*b*(1-b)*(1-b));o.taper!=null&&o.taper;const A=.36*(o.tail!=null?o.tail:1),y=o.width!=null?o.width:1;{const v=t.createLinearGradient(T[0][0],T[0][1],T[m][0],T[m][1]);v.addColorStop(0,s(.46,0)),v.addColorStop(.3,s(.46,.03*p)),v.addColorStop(.8,s(.46,.045*p)),v.addColorStop(1,s(.46,0)),t.globalAlpha=1,t.strokeStyle=v,t.lineWidth=9*c,t.shadowColor=f(.6),t.shadowBlur=C*2,t.beginPath(),T.forEach(([P,O],W)=>W?t.lineTo(P,O):t.moveTo(P,O)),t.stroke(),t.shadowBlur=0}const B=40,E=Math.max(0,w-A*(1-x)),R=[];for(let v=0;v<=B;v++)R.push(I(E+(w-E)*(v/B)));const S=()=>{t.beginPath(),R.forEach(([v,P],O)=>O?t.lineTo(v,P):t.moveTo(v,P)),t.stroke()},M=()=>{const v=t.createLinearGradient(R[0][0],R[0][1],R[B][0],R[B][1]);return v.addColorStop(0,s(.55,0)),v.addColorStop(.4,s(.56,0)),v.addColorStop(.68,s(.6,.09)),v.addColorStop(.88,s(.64,.24)),v.addColorStop(1,s(.68,.44)),v},F=1+.5*D;t.globalAlpha=p,t.strokeStyle=M(),t.lineWidth=(20+10*D)*c*y,t.shadowColor=f(.72),t.shadowBlur=C*2.2,S(),t.strokeStyle=M(),t.lineWidth=(10+5*D)*c*y,t.shadowBlur=C*1,S(),t.shadowBlur=0;for(let v=1;v<=B;v++){const P=v/B;t.globalAlpha=Math.pow(P,2.2)*.95*p,t.strokeStyle=f(.55+.38*P),t.lineWidth=(1.6+6.5*Math.pow(P,.7))*c*y*F,t.beginPath(),t.moveTo(R[v-1][0],R[v-1][1]),t.lineTo(R[v][0],R[v][1]),t.stroke()}const H=R[B][0],U=R[B][1];t.globalAlpha=.8*p,t.fillStyle=f(.6),t.shadowColor=f(.8),t.shadowBlur=C*1.6,t.beginPath(),t.arc(H,U,(9+5*D)*c*y,0,Math.PI*2),t.fill(),t.globalAlpha=p,t.fillStyle=f(.93),t.shadowBlur=C*.6,t.beginPath(),t.arc(H,U,(3.4+1.8*D)*c*y,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function no(t,a,o,d,i,e,l){const r=o.r!=null?o.r:.3,f=o.dir!=null?o.dir:1,C=(o.sweep!=null?o.sweep:.66)*Math.PI*2,h=l??i*(o.tempo!=null?o.tempo:.5)%1,u=-Math.PI/2+f*h*Math.PI*2,n=16,c=[];for(let s=0;s<=n;s++){const L=u-f*(1-s/n)*C;c.push([.5+Math.cos(L)*r,.5+Math.sin(L)*r])}Bt(t,a,a,c,i,e,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}function so(t,a,o,d,i,e,l={}){const r=Math.max(2,Math.round(l.count??7)),f=l.r??4.4,C=l.flow??.35,h=l.hair??.26,u=l.style||"chain",n=l.color||"255,246,234",c=l.inset??.12,s=l.alpha??1,L=d-a,G=i-o,k=Math.hypot(L,G);if(k<.001||s<=.004)return;const m=L/k,T=G/k,I=a+L*c,_=o+G*c,b=k*(1-c*2);if(b<=0)return;t.save(),u==="chain"&&h>0&&(t.strokeStyle=`rgba(${n},${(h*s).toFixed(3)})`,t.lineWidth=Math.max(1,f*.34),t.beginPath(),t.moveTo(I,_),t.lineTo(I+m*b,_+T*b),t.stroke());const p=e*C%1;for(let x=0;x<r;x++){let w=(x+.5)/r;if(u==="pulse"||u==="dots"||u==="chain"){const R=w-.5;if(w=.5+R+Math.sign(R)*(p/r%(1/r)),w<0||w>1)continue}const D=I+m*b*w,A=_+T*b*w,y=Math.abs(w-.5)*2;let B=f,E=s;if(u==="taper"&&(B=f*(.55+.75*y)),u==="pulse"){const R=((y-p)%1+1)%1;E=s*(.35+.65*Math.max(0,1-Math.abs(R-0)*3))}t.fillStyle=`rgba(${n},${(E*.96).toFixed(3)})`,t.beginPath(),t.arc(D,A,B,0,Math.PI*2),t.fill()}t.restore()}export{f0 as A,m0 as B,Qt as C,h0 as G,Pt as M,V as N,$ as P,Kt as Q,Yt as R,qt as S,$t as Z,t0 as a,_t as b,Xt as c,zt as d,eo as e,no as f,Nt as g,lo as h,jt as i,ao as j,so as k,oo as l,Wt as m,Ut as n,to as o,Jt as p,Vt as q,n0 as r,u0 as s,Et as t,Ht as u,Ot as v,Zt as w,Gt as x,Bt as y,gt as z};
