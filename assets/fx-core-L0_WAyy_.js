const E={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},W={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},r0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],x0=Object.fromEntries(Object.entries({...E,...W}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),q=t=>`vec3(${r0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,S0=(t,a=1)=>`rgba(${r0(t).join(",")},${a})`,h0=[[E.red,0],[E.red,.3],[E.coral,.56],[E.sand,.86],[E.prism,1]],u0=1;function f0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(W).some(o=>o.toUpperCase()===a)?!0:Object.values(E).some(o=>o.toUpperCase()===a)}function C0(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>f0(o)))&&(t.stops=h0.map(o=>[...o])),t.sat=u0,t)}function e0(t,a,o,i,s){let l=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let c=1;c<s;c++){let r=(t[c]+c*c-(t[o[l]]+o[l]*o[l]))/(2*c-2*o[l]);for(;r<=i[l];)l--,r=(t[c]+c*c-(t[o[l]]+o[l]*o[l]))/(2*c-2*o[l]);l++,o[l]=c,i[l]=r,i[l+1]=1e20}l=0;for(let c=0;c<s;c++){for(;i[l+1]<c;)l++;a[c]=(c-o[l])*(c-o[l])+t[o[l]]}}function l0(t,a){const o=new Float32Array(a),i=new Int32Array(a),s=new Float32Array(a+1),l=new Float32Array(a);for(let c=0;c<a;c++){for(let r=0;r<a;r++)l[r]=t[r*a+c];e0(l,o,i,s,a);for(let r=0;r<a;r++)t[r*a+c]=o[r]}for(let c=0;c<a;c++){for(let r=0;r<a;r++)l[r]=t[c*a+r];e0(l,o,i,s,a);for(let r=0;r<a;r++)t[c*a+r]=o[r]}}function i0(t,a){const i=new Float32Array(a*a),s=new Float32Array(a*a);let l=0,c=0,r=0;for(let m=0;m<a*a;m++){const d=t[m*4+3]/255;i[m]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),s[m]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(l+=m%a,c+=m/a|0,r++)}l0(i,a),l0(s,a);const f=new Float32Array(a*a);for(let m=0;m<a*a;m++)f[m]=(Math.sqrt(i[m])-Math.sqrt(s[m]))/a;return{data:f,N:a,cx:r?l/r/a:.5,cy:r?c/r/a:.5}}function z(t,a=512){const o="_raster"+a;if(t[o])return t[o];const i=document.createElement("canvas");i.width=i.height=a;const s=i.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);s.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const c=s.getImageData(0,0,a,a).data;let r=a,f=a,m=-1,d=-1;for(let p=0;p<a;p++)for(let e=0;e<a;e++)c[(p*a+e)*4+3]>8&&(e<r&&(r=e),e>m&&(m=e),p<f&&(f=p),p>d&&(d=p));return t[o]=m<0?{canvas:i,x:0,y:0,w:a,h:a}:{canvas:i,x:r,y:f,w:m-r+1,h:d-f+1},t[o]}function I0(t,a,o=!1){const i=z(t,a),s=document.createElement("canvas");s.width=s.height=a;const l=s.getContext("2d"),c=Math.min(a*j/i.w,a*j/i.h),r=i.w*c,f=i.h*c;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(i.canvas,i.x,i.y,i.w,i.h,(a-r)/2,(a-f)/2,r,f),i0(l.getImageData(0,0,a,a).data,a)}function A0(t,a,o,i=!1){const s=z(t,o),l=a?z(a,o):null,c=Math.min(o*j/s.w,o*j/s.h),r=s.w*c,f=s.h*c,m=(o-r)/2,d=(o-f)/2,p=C=>{const M=document.createElement("canvas");M.width=M.height=o;const w=M.getContext("2d");return i&&(w.translate(0,o),w.scale(1,-1)),w.drawImage(C.canvas,s.x,s.y,s.w,s.h,m,d,r,f),i0(w.getImageData(0,0,o,o).data,o)},e=p(s),h=l?p(l):null,u=new Float32Array(o*o*2);for(let C=0;C<o*o;C++)u[C*2]=e.data[C],u[C*2+1]=h?h.data[C]:1;return{data:u,N:o,cx:e.cx,cy:e.cy,inCx:h?h.cx:e.cx,inCy:h?h.cy:e.cy,hasInner:!!h}}const v0=1.9922,d0=.78,j=.52,b0=d0/j,T0=1.18,p0={size:.85,gx:-.025,gy:.195,rot:6,shadow:"glow",shadowK:.75,blend:"add"};function M0(t,a,o,i,s=p0){const l=Math.round(o*.75),c=s.shadow==="none"?0:s.shadowK??.75,r=f=>i(t,String(a),o/2,o/2,l,f);return s.shadow==="drop"&&c>.001?(t.save(),t.globalAlpha=Math.min(1,c*.7),t.translate(o*.018,o*.024),r({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),r({glow:0,glowColor:"rgba(0,0,0,0)"})):r(s.shadow==="glow"?{glow:26*c,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),s.blend==="knock"}function R0(t,a){const o=t.getImageData(0,0,a,a),i=t.createImageData(a,a);for(let s=0;s<a*a;s++){const l=o.data[s*4+3]/255,c=Math.round(255*(1-l));i.data[s*4]=i.data[s*4+1]=i.data[s*4+2]=c,i.data[s*4+3]=255}t.putImageData(i,0,0)}const y0={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},Q=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),Z=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function n0(t,a,o){t=Q(t),a=Q(a),o=Q(o);const i=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),s=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*i+.793617785*s-.0040720468*l,1.9779984951*i-2.428592205*s+.4505937099*l,.0259040371*i+.7827717662*s-.808675766*l]}function m0(t,a,o){const i=(t+.3963377774*a+.2158037573*o)**3,s=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[Z(4.0767416621*i-3.3077115913*s+.2309699292*l),Z(-1.2684380046*i+2.6097574011*s-.3413193965*l),Z(-.0041960863*i-.7034186147*s+1.707614701*l)]}const s0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function P0(t,a=1,o=new Uint8Array(256*4)){const i=[...t].sort((s,l)=>s[1]-l[1]);for(let s=0;s<256;s++){const l=s/255;let c=0;for(;c<i.length-2&&l>i[c+1][1];)c++;const[r,f]=i[c],[m,d]=i[c+1],p=Math.max(0,Math.min(1,(l-f)/Math.max(1e-5,d-f))),e=n0(...s0(r)),h=n0(...s0(m)),u=m0(e[0]+(h[0]-e[0])*p,(e[1]+(h[1]-e[1])*p)*a,(e[2]+(h[2]-e[2])*p)*a);o.set([...u,255],s*4)}return o}const k0=`
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(t,a,o,i){t.lineWidth=4*a;const s=i.arrow;s.line==="dash"?t.setLineDash([12*a*s.gap,10*s.gap]):s.line==="dot"?(t.setLineDash([.5,12*s.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(t.lineDashOffset=-o*40*s.speed)}function F0(t,a,o,i,s,l={}){const c=s.lut,r=s.arrow||{},f=r.w??1,m=r.speed??1,d=r.glow??1,p=l.pulse??1,e=o/256,h=a/2,u=i*.9*m%1,C=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,u/.55),M=l.prog!=null?1:u>.88?(1-u)/.12:1;t.clearRect(0,0,a,o);const w=M*(.45+.55*p),n=o-24*e,S=58*e,T=n+(S-n)*C,v=(k,_)=>c(k).replace("rgb(","rgba(").replace(")",`,${_.toFixed(3)})`),x=1.1*e*f,I=13*e*f,R=t.createLinearGradient(0,n,0,T);if(R.addColorStop(0,v(.55,0)),R.addColorStop(.1,v(.64,.45*w)),R.addColorStop(.32,v(.76,.85*w)),R.addColorStop(.62,v(.88,.98*w)),R.addColorStop(1,v(.97,w)),t.globalAlpha=1,t.fillStyle=R,t.beginPath(),t.moveTo(h-x/2,n),t.lineTo(h+x/2,n),t.lineTo(h+I/2,T),t.lineTo(h-I/2,T),t.closePath(),t.fill(),t.globalAlpha=w,C>.28&&!l.noTip){const k=34*e*(.7+.3*f),_=Math.min(1,(C-.28)/.22)*w,P=T+k*.3;t.globalAlpha=_;const A={color:c(.95),glowColor:c(.85),glow:12*d};s.glyph&&(s.glyph(t,"LIFT_TIP",h,P,k,A)||s.glyph(t,"TIP_TRI",h,P,k*.93,A))||(t.strokeStyle=c(.95),t.lineWidth=13*e*f,t.lineCap="round",t.lineJoin="round",t.shadowColor=c(.9),t.shadowBlur=18*e*d,t.beginPath(),t.moveTo(h-26*e,P+14*e),t.lineTo(h,P-16*e),t.lineTo(h+26*e,P+14*e),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function B0(t,a,o,i,s,l,c={}){const r=l.lut,f=l.arrow||{},m=f.w??1,d=f.glow??1,p=o/256;t.clearRect(0,0,a,o);const e=i.map(([n,S])=>[n*a,S*o]);if(e.length<2)return;const h=48,u=[],C=n=>{if(e.length===2)return[e[0][0]+(e[1][0]-e[0][0])*n,e[0][1]+(e[1][1]-e[0][1])*n];const S=n*(e.length-1),T=Math.min(e.length-2,Math.floor(S)),v=S-T,x=e[Math.max(0,T-1)],I=e[T],R=e[T+1],k=e[Math.min(e.length-1,T+2)],_=(P,A,y,B)=>.5*(2*A+(-P+y)*v+(2*P-5*A+4*y-B)*v*v+(-P+3*A-3*y+B)*v*v*v);return[_(x[0],I[0],R[0],k[0]),_(x[1],I[1],R[1],k[1])]};for(let n=0;n<=h;n++)u.push(C(n/h));const M=Math.max(0,Math.min(1,c.prog!=null?c.prog:s*.55%1)),w=Math.max(1,Math.round(h*M));t.lineCap="round";for(let n=1;n<=w;n++){const S=n/w;t.globalAlpha=Math.pow(S,1.5),t.strokeStyle=r(.45+.5*S),t.lineWidth=(1.6+3.2*S)*p*m,t.beginPath(),t.moveTo(u[n-1][0],u[n-1][1]),t.lineTo(u[n][0],u[n][1]),t.stroke()}if(M>.25){const n=u[w][0],S=u[w][1],T=u[Math.max(0,w-2)][0],v=u[Math.max(0,w-2)][1],x=Math.atan2(S-v,n-T)+Math.PI/2,I=30*p*(.7+.3*m);t.save(),t.translate(n,S),t.rotate(x),t.globalAlpha=Math.min(1,(M-.25)/.2);const R={color:r(.95),glowColor:r(.85),glow:12*d};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,I,R)||l.glyph(t,"TIP_TRI",0,0,I*.93,R))||(t.strokeStyle=r(.95),t.lineWidth=9*p*m,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*p,12*p),t.lineTo(0,-14*p),t.lineTo(18*p,12*p),t.stroke()),t.restore()}t.globalAlpha=1}function c0(t,a,o,i,s,l){s=s||{};const c=l.lut,r=s.style||l.arrow.line,f=!!s.closed,m=[0];for(let h=1;h<a.length;h++)m.push(m[h-1]+Math.hypot(a[h][0]-a[h-1][0],a[h][1]-a[h-1][1]));const d=m[m.length-1]||1,p=h=>{h=(h%d+d)%d;let u=1;for(;u<m.length-1&&m[u]<h;)u++;const C=(h-m[u-1])/Math.max(1e-4,m[u]-m[u-1]);return[a[u-1][0]+(a[u][0]-a[u-1][0])*C,a[u-1][1]+(a[u][1]-a[u-1][1])*C,Math.atan2(a[u][1]-a[u-1][1],a[u][0]-a[u-1][0])]},e=l.arrow;if(r==="chevron"){const h=(26*i+8)*e.gap,u=Math.max(2,Math.floor(d/h));t.shadowColor=c(Math.min(1,e.heat+.2)),t.shadowBlur=8*i*e.glow;for(let C=0;C<u;C++){const M=C*h+o*42*e.speed%h;if(!f&&M>d-4)continue;const[w,n,S]=p(M),T=7.5*i,v=8.5*i,x=.45+.4*Math.sin(M/d*6.283-o*2.2*e.speed);t.strokeStyle=c(e.heat-.05+x*.3),t.lineWidth=3.2*i,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(w,n),t.rotate(S),t.beginPath(),t.moveTo(-v*.5,-T),t.lineTo(v*.5,0),t.lineTo(-v*.5,T),t.stroke(),t.restore()}return!0}if(r==="comet"){const h=o*.35*e.speed%1*d,u=d*e.tail,C=Math.max(24,a.length*2);t.lineCap="round";for(let n=0;n<C;n++){const S=h-n/C*u,T=h-(n+1)/C*u;if(!f&&T<0)break;const v=1-n/C,[x,I]=p(S),[R,k]=p(T);!f&&Math.hypot(R-x,k-I)>d*.4||(t.globalAlpha=Math.pow(v,1.6),t.strokeStyle=c(Math.max(.05,e.heat-.2)+v*.55),t.lineWidth=(1.5+v*4.5)*i,v>.72?(t.shadowColor=c(Math.min(1,e.heat+.3)),t.shadowBlur=v*12*i*e.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(x,I),t.lineTo(R,k),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[M,w]=p(h);return t.fillStyle=rgba(W.ink,.95),t.shadowColor=c(.9),t.shadowBlur=16*i,t.beginPath(),t.arc(M,w,2.6*i,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=s.color||c(e.heat),t.shadowColor=c(Math.min(1,e.heat+.15)),t.shadowBlur=(s.glow??8)*i*e.glow,r==="taper")for(let h=1;h<a.length;h++)t.lineWidth=(.5+h/a.length*4.5)*i,t.beginPath(),t.moveTo(a[h-1][0],a[h-1][1]),t.lineTo(a[h][0],a[h][1]),t.stroke();else w0(t,i,o,l),t.beginPath(),a.forEach(([h,u],C)=>C?t.lineTo(h,u):t.moveTo(h,u)),f&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function E0(t,a,o,i,s,l){const c=13*i.halo,r=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const f=a/220,m=a/2,d=18*o.round*f,p=40*f,e=48*f,h=a-80*f,u=a-96*f,C=[],M=(n,S,T,v)=>{for(let x=0;x<=1;x+=.12)C.push([n+(T-n)*x,S+(v-S)*x])};M(p+d,e,p+h-d,e),M(p+h,e+d,p+h,e+u-d),M(p+h-d,e+u,p+d,e+u),M(p,e+u-d,p,e+d),t.shadowColor=r(.6),t.shadowBlur=c*.8;const w=4*l.arrow.w*f;if(l.arrow.line==="solid"?(t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-s*22*f,t.strokeStyle=r(.45),t.lineWidth=w,t.beginPath(),t.roundRect(p,e,h,u,d),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):c0(t,C,s,l.arrow.w*f,{color:r(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const n=[],S=(A,y,B,D,G)=>{for(let O=1;O<=G;O++)n.push([A+(B-A)*O/G,y+(D-y)*O/G])},T=(A,y,B,D,G)=>{for(let O=1;O<=G;O++){const $=B+(D-B)*O/G;n.push([A+d*Math.cos($),y+d*Math.sin($)])}},v=Math.PI/2,x=p+h,I=e+u,R=p+h/2;n.push([R,e]),S(R,e,x-d,e,8),T(x-d,e+d,-v,0,6),S(x,e+d,x,I-d,10),T(x-d,I-d,0,v,6),S(x-d,I,p+d,I,14),T(p+d,I-d,v,Math.PI,6),S(p,I-d,p,e+d,10),T(p+d,e+d,Math.PI,Math.PI+v,6),S(p+d,e,R,e,8);let k=0;for(let A=1;A<n.length;A++)k+=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);const _=k*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-(h/2-d)-s*22*f,t.strokeStyle=r(.9),t.lineWidth=w*1.3,t.lineCap="round",t.shadowColor=r(.92),t.shadowBlur=c*1.3,t.beginPath(),t.moveTo(n[0][0],n[0][1]);let P=0;for(let A=1;A<n.length&&P<_;A++){const y=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);if(P+y<=_)t.lineTo(n[A][0],n[A][1]),P+=y;else{const B=(_-P)/y;t.lineTo(n[A-1][0]+(n[A][0]-n[A-1][0])*B,n[A-1][1]+(n[A][1]-n[A-1][1])*B),P=_}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&l.foot&&(l.foot(t,!1,m-16*o.feet*f,m+6*f,26*o.feet*f),l.foot(t,!0,m+16*o.feet*f,m+6*f,26*o.feet*f)),t.shadowBlur=0}function O0(t,a,o,i,s,l,c,r){const f=13*i.halo,m=4*l.arrow.w*(a/220),d=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const p=a/220,e=c||[[45*p,130*p],[110*p,60*p],[175*p,110*p]],h=r??s*.5%1,u=Math.min(1,h*1.25)*(e.length-1),C=Math.min(e.length-1,Math.floor(u+.35));t.shadowColor=d(.7),t.shadowBlur=f;const M=[[e[0][0],e[0][1]]];for(let w=1;w<=e.length-1;w++){const n=Math.max(0,Math.min(1,u-(w-1)));if(n<=0)break;M.push([e[w-1][0]+(e[w][0]-e[w-1][0])*n,e[w-1][1]+(e[w][1]-e[w-1][1])*n])}M.length>1&&c0(t,M,s,l.arrow.w*p,{color:d(.62)},l),t.setLineDash([4*p,7*p]),t.lineDashOffset=0,t.globalAlpha=.3,t.strokeStyle=d(.45),t.lineWidth=m,t.beginPath(),e.forEach(([w,n],S)=>S?t.lineTo(w,n):t.moveTo(w,n)),t.stroke(),t.globalAlpha=1,t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,e.forEach(([w,n],S)=>{const T=S===C,v=T?1+Math.sin(s*6)*.14:1;t.strokeStyle=d(T?.8:.45),t.lineWidth=m*(T?1.3:.9),t.shadowBlur=T?f*1.6:f*.6,t.beginPath(),t.arc(w,n,12*o.node*v*p,0,Math.PI*2),t.stroke(),l.num&&(t.globalAlpha=S<=C?1:.45,l.num(t,String(S+1),w,n,16*o.numS*v*p,Math.round(14*o.numS*p)),t.globalAlpha=1)}),t.shadowBlur=0}function U0(t,a,o,i,s,l,c){const r=l.lut,f=13*i.halo,m=a/220,d=a/2,p=l.arrow&&l.arrow.w||1,e=(x,I)=>r(x).replace("rgb(","rgba(").replace(")",`,${I})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const h=(o.r!=null?o.r:.42)*a,u=h*(o.rt!=null?o.rt:.36),C=3.4*p*m,M=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.6)%1,w=Math.pow(M,1.6),n=Math.max(0,(M-.9)/.1);t.save(),t.translate(d,d);const S=(x,I,R,k=1)=>{if(x<=.6)return;const _=C*2.6*k,P=Math.max(.1,x-_),A=x+_,y=t.createRadialGradient(0,0,P,0,0,A);y.addColorStop(0,e(I-.05,0)),y.addColorStop(.5,e(I,R*.85)),y.addColorStop(1,e(I-.05,0)),t.globalAlpha=1,t.fillStyle=y,t.shadowBlur=0,t.beginPath(),t.arc(0,0,A,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,R*1.1),t.lineWidth=C*.85,t.strokeStyle=r(Math.min(.98,I+.12)),t.shadowColor=r(.88),t.shadowBlur=f*.6,t.beginPath(),t.arc(0,0,x,0,Math.PI*2),t.stroke(),t.shadowBlur=0},T=t.createRadialGradient(0,0,0,0,0,u*1.08);T.addColorStop(0,e(.6,.1+.18*n)),T.addColorStop(.65,e(.5,.05+.08*n)),T.addColorStop(1,e(.5,0)),t.globalAlpha=1,t.fillStyle=T,t.beginPath(),t.arc(0,0,u*1.08,0,Math.PI*2),t.fill();const v=1+.02*Math.sin(s*2.6);S(u*v,.55+.4*n,.5+.45*n,.9);for(let x=2;x>=0;x--){const I=Math.pow(Math.max(0,M-x*.05),1.6),R=h-(h-u)*I,k=x===0?.6+.4*w:.18/x*(1-n);S(R,.55+.4*w,k*(1-n*.45),1.15-.35*w)}n>.01&&S(u*(1+1.4*n),.9,(1-n)*.8,1.1),t.globalAlpha=.6+.3*n,t.shadowColor=r(.85),t.shadowBlur=f*(.9+n),t.fillStyle=r(.62+.3*n),t.beginPath(),t.arc(0,0,C*.85+3*m*n,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function G0(t,a,o,i,s,l,c,r){const f=l.lut,m=13*i.halo,d=a/220,p=a/2,e=l.arrow&&l.arrow.w||1,h=e*d,u=(b,L)=>f(b).replace("rgb(","rgba(").replace(")",","+L+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const C=a*.42*(o.spread!=null?o.spread:1),w=(r||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([b,L])=>[p+b*C,p+L*C]),n=80,S=[];for(let b=0;b<=n;b++){const L=b/n*(w.length-1),F=Math.min(w.length-2,Math.floor(L)),U=L-F,H=w[Math.max(0,F-1)],K=w[F],N=w[F+1],t0=w[Math.min(w.length-1,F+2)],a0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*U+(2*X-5*J+4*Y-o0)*U*U+(-X+3*J-3*Y+o0)*U*U*U);S.push([a0(H[0],K[0],N[0],t0[0]),a0(H[1],K[1],N[1],t0[1])])}const T=b=>{const L=Math.max(0,Math.min(n,b*n)),F=Math.floor(L),U=L-F,H=S[F],K=S[Math.min(n,F+1)];return[H[0]+(K[0]-H[0])*U,H[1]+(K[1]-H[1])*U]},v=.68;let x,I,R;if(c!=null)x=Math.max(0,Math.min(1,c)),I=1,R=0;else{const b=s*(o.tempo||.42)%1;if(b<v)x=b/v,I=1,R=0;else{const L=(b-v)/(1-v);x=1,I=1-L*L,R=L}}if(I<=.012)return;const k=x*x*x*(x*(6*x-15)+10),_=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const P=.36*(o.tail!=null?o.tail:1),A=o.width!=null?o.width:1;{const b=t.createLinearGradient(S[0][0],S[0][1],S[n][0],S[n][1]);b.addColorStop(0,u(.46,0)),b.addColorStop(.3,u(.46,.03*I)),b.addColorStop(.8,u(.46,.045*I)),b.addColorStop(1,u(.46,0)),t.globalAlpha=1,t.strokeStyle=b,t.lineWidth=9*h,t.shadowColor=f(.6),t.shadowBlur=m*2,t.beginPath(),S.forEach(([L,F],U)=>U?t.lineTo(L,F):t.moveTo(L,F)),t.stroke(),t.shadowBlur=0}const y=40,B=Math.max(0,k-P*(1-R)),D=[];for(let b=0;b<=y;b++)D.push(T(B+(k-B)*(b/y)));const G=()=>{t.beginPath(),D.forEach(([b,L],F)=>F?t.lineTo(b,L):t.moveTo(b,L)),t.stroke()},O=()=>{const b=t.createLinearGradient(D[0][0],D[0][1],D[y][0],D[y][1]);return b.addColorStop(0,u(.55,0)),b.addColorStop(.4,u(.56,0)),b.addColorStop(.68,u(.6,.09)),b.addColorStop(.88,u(.64,.24)),b.addColorStop(1,u(.68,.44)),b},$=1+.5*_;t.globalAlpha=I,t.strokeStyle=O(),t.lineWidth=(20+10*_)*h*A,t.shadowColor=f(.72),t.shadowBlur=m*2.2,G(),t.strokeStyle=O(),t.lineWidth=(10+5*_)*h*A,t.shadowBlur=m*1,G(),t.shadowBlur=0;for(let b=1;b<=y;b++){const L=b/y;t.globalAlpha=Math.pow(L,2.2)*.95*I,t.strokeStyle=f(.55+.38*L),t.lineWidth=(1.6+6.5*Math.pow(L,.7))*h*A*$,t.beginPath(),t.moveTo(D[b-1][0],D[b-1][1]),t.lineTo(D[b][0],D[b][1]),t.stroke()}const V=D[y][0],g=D[y][1];t.globalAlpha=.8*I,t.fillStyle=f(.6),t.shadowColor=f(.8),t.shadowBlur=m*1.6,t.beginPath(),t.arc(V,g,(9+5*_)*h*A,0,Math.PI*2),t.fill(),t.globalAlpha=I,t.fillStyle=f(.93),t.shadowBlur=m*.6,t.beginPath(),t.arc(V,g,(3.4+1.8*_)*h*A,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function H0(t,a,o,i,s,l,c){const r=l.lut,f=13*i.halo,m=a/220,d=a/2,p=l.arrow&&l.arrow.w||1;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const e=(o.r!=null?o.r:.3)*a,h=o.width!=null?o.width:1,u=4.2*p*m*h,C=o.dir!=null?o.dir:1,M=(o.sweep!=null?o.sweep:.66)*Math.PI*2,w=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.5)%1,n=-Math.PI/2+C*w*Math.PI*2;t.save(),t.translate(d,d),t.globalAlpha=.16,t.lineWidth=u*.7,t.strokeStyle=r(.44),t.shadowColor=r(.6),t.shadowBlur=f*.4,t.beginPath(),t.arc(0,0,e,0,Math.PI*2),t.stroke(),t.shadowBlur=0;const S=16;for(let _=0;_<S;_++){const P=_/(S-1),A=n-C*P*M,y=n-C*(P+1.2/S)*M;t.globalAlpha=(1-P)*.9,t.strokeStyle=r(.55+.35*(1-P)),t.lineWidth=u*(.55+.55*(1-P)),t.shadowColor=r(.8),t.shadowBlur=f*(.4+.5*(1-P)),t.beginPath(),t.arc(0,0,e,Math.min(A,y),Math.max(A,y),!1),t.stroke()}t.shadowBlur=0;const T=Math.cos(n)*e,v=Math.sin(n)*e,x=n+C*Math.PI/2,I=8*m*h;t.save(),t.translate(T,v),t.rotate(x+Math.PI/2),t.globalAlpha=1;const R=3.4*I*(.7+.3*p),k={color:r(.96),glowColor:r(.9),glow:f*1.2};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,R,k)||l.glyph(t,"TIP_TRI",0,0,R*.93,k))||(t.rotate(-Math.PI/2),t.strokeStyle=r(.96),t.lineWidth=u*.9,t.shadowColor=r(.9),t.shadowBlur=f*1.2,t.beginPath(),t.moveTo(-I,-I*.9),t.lineTo(I*.5,0),t.lineTo(-I,I*.9),t.stroke()),t.restore(),t.globalAlpha=.62,t.shadowColor=r(.75),t.shadowBlur=f*.6,t.fillStyle=r(.6),t.beginPath(),t.arc(0,0,u*.6,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}export{_0 as C,p0 as G,y0 as M,W as N,E as P,b0 as Q,k0 as R,v0 as S,T0 as Z,j as a,d0 as b,A0 as c,M0 as d,I0 as e,E0 as f,O0 as g,U0 as h,R0 as i,G0 as j,H0 as k,P0 as l,F0 as m,D0 as n,z as o,c0 as p,x0 as q,B0 as r,i0 as s,S0 as t,C0 as u,L0 as v,h0 as w,u0 as x};
