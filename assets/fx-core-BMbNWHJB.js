const G={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},K={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},i0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],Rt=Object.fromEntries(Object.entries({...G,...K}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),g=t=>`vec3(${i0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,Tt=(t,a=1)=>`rgba(${i0(t).join(",")},${a})`,u0=[[G.red,0],[G.red,.3],[G.coral,.56],[G.sand,.86],[G.prism,1]],f0=1;function p0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(K).some(o=>o.toUpperCase()===a)?!0:Object.values(G).some(o=>o.toUpperCase()===a)}function Mt(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>p0(o)))&&(t.stops=u0.map(o=>[...o])),t.sat=f0,t)}const m0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",w0=.98,S0=.83,x0=-.043,C0=-.031,b0=5.5,I0=.027,v0=.25,A0=.26,R0=.3,T0=.92,M0=.038,y0=1,L0=24,P0=1,_0=.95,k0=.45,D0=.88,F0=0,B0=.5,E0=.34,G0=.1,O0=.4,U0=1,H0=1.4,q0=0,W0=3.4,g0=.01,K0=0,$0=.011,j0=-2,X0=.75,J0=-.07,Y0=.12,Q0=4,z0=.6,Z0=0,V0=1,N0="none",tt="add",at="offbit",ot=.55,et=.14,lt=.5,nt=4,st=2,rt=1,it=.32,ct=1,dt={punchLine:{node:1.58,numS:1,comet:1,tailLen:.71,rail:.6}},ht=-.095,ut=.12,ft=10,pt=-.015,mt=.12,wt=-10,St={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.9,edgeShadeW:2.45,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:0,edgeShadeCol:0,dotCol:0,ripCol:0},xt={_:m0,imp:w0,scale:S0,offx:x0,offy:C0,irot:b0,pitch:I0,dot:v0,glow:A0,shade:R0,sharp:T0,edge:M0,plantar:y0,bands:L0,bandSoft:P0,w:_0,halo:k0,pool:D0,noise:F0,rip:B0,ripReach:E0,ripWidth:G0,ripSpeed:O0,ripGrad:U0,edgeShade:H0,shadeRed:q0,shadeRedW:W0,edgeW:g0,edgeSoft:K0,dither:$0,tilt:j0,gsize:X0,gx:J0,gy:Y0,grot:Q0,gsh:z0,shadeCol:Z0,ripCol:V0,gShadow:N0,gBlend:tt,numSrc:at,prog:ot,bloom:et,blur:lt,edgeShadeW:nt,edgeShadeCol:st,edgeShadeGrad:rt,edgeShadeG0:it,edgeShadeG1:ct,prims:dt,gxL:ht,gyL:ut,grotL:ft,gxR:pt,gyR:mt,grotR:wt,tap:St};function l0(t,a,o,i,n){let l=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let r=1;r<n;r++){let h=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);for(;h<=i[l];)l--,h=(t[r]+r*r-(t[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);l++,o[l]=r,i[l]=h,i[l+1]=1e20}l=0;for(let r=0;r<n;r++){for(;i[l+1]<r;)l++;a[r]=(r-o[l])*(r-o[l])+t[o[l]]}}function n0(t,a){const o=new Float32Array(a),i=new Int32Array(a),n=new Float32Array(a+1),l=new Float32Array(a);for(let r=0;r<a;r++){for(let h=0;h<a;h++)l[h]=t[h*a+r];l0(l,o,i,n,a);for(let h=0;h<a;h++)t[h*a+r]=o[h]}for(let r=0;r<a;r++){for(let h=0;h<a;h++)l[h]=t[r*a+h];l0(l,o,i,n,a);for(let h=0;h<a;h++)t[r*a+h]=o[h]}}function c0(t,a){const i=new Float32Array(a*a),n=new Float32Array(a*a);let l=0,r=0,h=0;for(let x=0;x<a*a;x++){const d=t[x*4+3]/255;i[x]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),n[x]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(l+=x%a,r+=x/a|0,h++)}n0(i,a),n0(n,a);const f=new Float32Array(a*a);for(let x=0;x<a*a;x++)f[x]=(Math.sqrt(i[x])-Math.sqrt(n[x]))/a;return{data:f,N:a,cx:h?l/h/a:.5,cy:h?r/h/a:.5}}function Z(t,a=512){const o="_raster"+a;if(t[o])return t[o];const i=document.createElement("canvas");i.width=i.height=a;const n=i.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);n.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const r=n.getImageData(0,0,a,a).data;let h=a,f=a,x=-1,d=-1;for(let u=0;u<a;u++)for(let e=0;e<a;e++)r[(u*a+e)*4+3]>8&&(e<h&&(h=e),e>x&&(x=e),u<f&&(f=u),u>d&&(d=u));return t[o]=x<0?{canvas:i,x:0,y:0,w:a,h:a}:{canvas:i,x:h,y:f,w:x-h+1,h:d-f+1},t[o]}function yt(t,a,o=!1){const i=Z(t,a),n=document.createElement("canvas");n.width=n.height=a;const l=n.getContext("2d"),r=Math.min(a*j/i.w,a*j/i.h),h=i.w*r,f=i.h*r;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(i.canvas,i.x,i.y,i.w,i.h,(a-h)/2,(a-f)/2,h,f),c0(l.getImageData(0,0,a,a).data,a)}function Lt(t,a,o,i=!1){const n=Z(t,o),l=a?Z(a,o):null,r=Math.min(o*j/n.w,o*j/n.h),h=n.w*r,f=n.h*r,x=(o-h)/2,d=(o-f)/2,u=I=>{const P=document.createElement("canvas");P.width=P.height=o;const R=P.getContext("2d");return i&&(R.translate(0,o),R.scale(1,-1)),R.drawImage(I.canvas,n.x,n.y,n.w,n.h,x,d,h,f),c0(R.getImageData(0,0,o,o).data,o)},e=u(n),c=l?u(l):null,s=new Float32Array(o*o*2);for(let I=0;I<o*o;I++)s[I*2]=e.data[I],s[I*2+1]=c?c.data[I]:1;return{data:s,N:o,cx:e.cx,cy:e.cy,inCx:c?c.cx:e.cx,inCy:c?c.cy:e.cy,hasInner:!!c}}const Pt=1.9922,Ct=.78,j=.52,_t=Ct/j,kt=1.18,U=xt||{},d0={size:U.gsize??.85,gx:U.gx??-.025,gy:U.gy??.195,rot:U.grot??6,gxL:U.gxL,gyL:U.gyL,rotL:U.grotL,gxR:U.gxR,gyR:U.gyR,rotR:U.grotR,shadow:U.gShadow??"glow",shadowK:U.gsh??.75,blend:U.gBlend??"add"};function Dt(t,a=d0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function Ft(t,a,o,i,n=d0){const l=Math.round(o*.75),r=n.shadow==="none"?0:n.shadowK??.75,h=f=>i(t,String(a),o/2,o/2,l,f);return n.shadow==="drop"&&r>.001?(t.save(),t.globalAlpha=Math.min(1,r*.7),t.translate(o*.018,o*.024),h({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),h({glow:0,glowColor:"rgba(0,0,0,0)"})):h(n.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),n.blend==="knock"}function Bt(t,a){const o=t.getImageData(0,0,a,a),i=t.createImageData(a,a);for(let n=0;n<a*a;n++){const l=o.data[n*4+3]/255,r=Math.round(255*(1-l));i.data[n*4]=i.data[n*4+1]=i.data[n*4+2]=r,i.data[n*4+3]=255}t.putImageData(i,0,0)}const Et={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},Q=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),z=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function s0(t,a,o){t=Q(t),a=Q(a),o=Q(o);const i=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),n=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*i+.793617785*n-.0040720468*l,1.9779984951*i-2.428592205*n+.4505937099*l,.0259040371*i+.7827717662*n-.808675766*l]}function bt(t,a,o){const i=(t+.3963377774*a+.2158037573*o)**3,n=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[z(4.0767416621*i-3.3077115913*n+.2309699292*l),z(-1.2684380046*i+2.6097574011*n-.3413193965*l),z(-.0041960863*i-.7034186147*n+1.707614701*l)]}const r0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function Gt(t,a=1,o=new Uint8Array(256*4)){const i=[...t].sort((n,l)=>n[1]-l[1]);for(let n=0;n<256;n++){const l=n/255;let r=0;for(;r<i.length-2&&l>i[r+1][1];)r++;const[h,f]=i[r],[x,d]=i[r+1],u=Math.max(0,Math.min(1,(l-f)/Math.max(1e-5,d-f))),e=s0(...r0(h)),c=s0(...r0(x)),s=bt(e[0]+(c[0]-e[0])*u,(e[1]+(c[1]-e[1])*u)*a,(e[2]+(c[2]-e[2])*u)*a);o.set([...s,255],n*4)}return o}const Ot=`
