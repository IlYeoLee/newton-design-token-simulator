...
#define P_ABS   0.72    // 절대 밝기를 반영하는 비율. 0.18 이던 걸 올렸다 — 그 18% 가
                        //   옷 주름·머리카락·팔 음영을 전부 버려서 인물이 단색 실루엣이 됐다.
                        //   레퍼런스(setup-injury)는 그 밝기가 곧 색이다(듀오톤).
...
#define C_RED   ${q(O.red)}
#define C_CORAL ${q(O.coral)}
#define C_SAND  ${q(O.sand)}
#define C_ICE   ${q(O.prism)}
