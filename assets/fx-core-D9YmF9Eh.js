...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(t,a,o,i){t.lineWidth=4*a;const s=i.arrow;s.line==="dash"?t.setLineDash([12*a*s.gap,10*s.gap]):s.line==="dot"?(t.setLineDash([.5,12*s.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(t.lineDashOffset=-o*40*s.speed)}function F0(t,a,o,i,s,e={}){const c=s.lut,r=s.arrow||{},f=r.w??1,m=r.speed??1,d=r.glow??1,p=e.pulse??1,l=o/256,h=a/2,u=i*.9*m%1,C=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,u/.55),M=e.prog!=null?1:u>.88?(1-u)/.12:1;t.clearRect(0,0,a,o);const w=M*(.45+.55*p),n=o-24*l,S=58*l,T=n+(S-n)*C,b=(k,_)=>c(k).replace("rgb(","rgba(").replace(")",`,${_.toFixed(3)})`),x=1.1*l*f,I=13*l*f,R=t.createLinearGradient(0,n,0,T);if(R.addColorStop(0,b(.55,0)),R.addColorStop(.1,b(.64,.45*w)),R.addColorStop(.32,b(.76,.85*w)),R.addColorStop(.62,b(.88,.98*w)),R.addColorStop(1,b(.97,w)),t.globalAlpha=1,t.fillStyle=R,t.beginPath(),t.moveTo(h-x/2,n),t.lineTo(h+x/2,n),t.lineTo(h+I/2,T),t.lineTo(h-I/2,T),t.closePath(),t.fill(),t.globalAlpha=w,C>.28&&!e.noTip){const k=34*l*(.7+.3*f),_=Math.min(1,(C-.28)/.22)*w,P=T+k*.3;t.globalAlpha=_;const A={color:c(.95),glowColor:c(.85),glow:12*d};s.glyph&&(s.glyph(t,"LIFT_TIP",h,P,k,A)||s.glyph(t,"TIP_TRI",h,P,k*.93,A))||(t.strokeStyle=c(.95),t.lineWidth=13*l*f,t.lineCap="round",t.lineJoin="round",t.shadowColor=c(.9),t.shadowBlur=18*l*d,t.beginPath(),t.moveTo(h-26*l,P+14*l),t.lineTo(h,P-16*l),t.lineTo(h+26*l,P+14*l),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function B0(t,a,o,i,s,e,c={}){const r=e.lut,f=e.arrow||{},m=f.w??1,d=f.glow??1,p=o/256;t.clearRect(0,0,a,o);const l=i.map(([n,S])=>[n*a,S*o]);if(l.length<2)return;const h=48,u=[],C=n=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*n,l[0][1]+(l[1][1]-l[0][1])*n];const S=n*(l.length-1),T=Math.min(l.length-2,Math.floor(S)),b=S-T,x=l[Math.max(0,T-1)],I=l[T],R=l[T+1],k=l[Math.min(l.length-1,T+2)],_=(P,A,y,B)=>.5*(2*A+(-P+y)*b+(2*P-5*A+4*y-B)*b*b+(-P+3*A-3*y+B)*b*b*b);return[_(x[0],I[0],R[0],k[0]),_(x[1],I[1],R[1],k[1])]};for(let n=0;n<=h;n++)u.push(C(n/h));const M=Math.max(0,Math.min(1,c.prog!=null?c.prog:s*.55%1)),w=Math.max(1,Math.round(h*M));t.lineCap="round";for(let n=1;n<=w;n++){const S=n/w;t.globalAlpha=Math.pow(S,1.5),t.strokeStyle=r(.45+.5*S),t.lineWidth=(1.6+3.2*S)*p*m,t.beginPath(),t.moveTo(u[n-1][0],u[n-1][1]),t.lineTo(u[n][0],u[n][1]),t.stroke()}if(M>.25){const n=u[w][0],S=u[w][1],T=u[Math.max(0,w-2)][0],b=u[Math.max(0,w-2)][1],x=Math.atan2(S-b,n-T)+Math.PI/2,I=30*p*(.7+.3*m);t.save(),t.translate(n,S),t.rotate(x),t.globalAlpha=Math.min(1,(M-.25)/.2);const R={color:r(.95),glowColor:r(.85),glow:12*d};e.glyph&&(e.glyph(t,"LIFT_TIP",0,0,I,R)||e.glyph(t,"TIP_TRI",0,0,I*.93,R))||(t.strokeStyle=r(.95),t.lineWidth=9*p*m,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*p,12*p),t.lineTo(0,-14*p),t.lineTo(18*p,12*p),t.stroke()),t.restore()}t.globalAlpha=1}function c0(t,a,o,i,s,e){s=s||{};const c=e.lut,r=s.style||e.arrow.line,f=!!s.closed,m=[0];for(let h=1;h<a.length;h++)m.push(m[h-1]+Math.hypot(a[h][0]-a[h-1][0],a[h][1]-a[h-1][1]));const d=m[m.length-1]||1,p=h=>{h=(h%d+d)%d;let u=1;for(;u<m.length-1&&m[u]<h;)u++;const C=(h-m[u-1])/Math.max(1e-4,m[u]-m[u-1]);return[a[u-1][0]+(a[u][0]-a[u-1][0])*C,a[u-1][1]+(a[u][1]-a[u-1][1])*C,Math.atan2(a[u][1]-a[u-1][1],a[u][0]-a[u-1][0])]},l=e.arrow;if(r==="chevron"){const h=(26*i+8)*l.gap,u=Math.max(2,Math.floor(d/h));t.shadowColor=c(Math.min(1,l.heat+.2)),t.shadowBlur=8*i*l.glow;for(let C=0;C<u;C++){const M=C*h+o*42*l.speed%h;if(!f&&M>d-4)continue;const[w,n,S]=p(M),T=7.5*i,b=8.5*i,x=.45+.4*Math.sin(M/d*6.283-o*2.2*l.speed);t.strokeStyle=c(l.heat-.05+x*.3),t.lineWidth=3.2*i,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(w,n),t.rotate(S),t.beginPath(),t.moveTo(-b*.5,-T),t.lineTo(b*.5,0),t.lineTo(-b*.5,T),t.stroke(),t.restore()}return!0}if(r==="comet"){const h=o*.35*l.speed%1*d,u=d*l.tail,C=Math.max(24,a.length*2);t.lineCap="round";for(let n=0;n<C;n++){const S=h-n/C*u,T=h-(n+1)/C*u;if(!f&&T<0)break;const b=1-n/C,[x,I]=p(S),[R,k]=p(T);!f&&Math.hypot(R-x,k-I)>d*.4||(t.globalAlpha=Math.pow(b,1.6),t.strokeStyle=c(Math.max(.05,l.heat-.2)+b*.55),t.lineWidth=(1.5+b*4.5)*i,b>.72?(t.shadowColor=c(Math.min(1,l.heat+.3)),t.shadowBlur=b*12*i*l.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(x,I),t.lineTo(R,k),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[M,w]=p(h);return t.fillStyle=rgba(W.ink,.95),t.shadowColor=c(.9),t.shadowBlur=16*i,t.beginPath(),t.arc(M,w,2.6*i,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=s.color||c(l.heat),t.shadowColor=c(Math.min(1,l.heat+.15)),t.shadowBlur=(s.glow??8)*i*l.glow,r==="taper")for(let h=1;h<a.length;h++)t.lineWidth=(.5+h/a.length*4.5)*i,t.beginPath(),t.moveTo(a[h-1][0],a[h-1][1]),t.lineTo(a[h][0],a[h][1]),t.stroke();else w0(t,i,o,e),t.beginPath(),a.forEach(([h,u],C)=>C?t.lineTo(h,u):t.moveTo(h,u)),f&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function E0(t,a,o,i,s,e){const c=13*i.halo,r=e.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const f=a/220,m=a/2,d=18*o.round*f,p=40*f,l=48*f,h=a-80*f,u=a-96*f,C=[],M=(n,S,T,b)=>{for(let x=0;x<=1;x+=.12)C.push([n+(T-n)*x,S+(b-S)*x])};M(p+d,l,p+h-d,l),M(p+h,l+d,p+h,l+u-d),M(p+h-d,l+u,p+d,l+u),M(p,l+u-d,p,l+d),t.shadowColor=r(.6),t.shadowBlur=c*.8;const w=4*e.arrow.w*f;if(e.arrow.line==="solid"?(t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-s*22*f,t.strokeStyle=r(.45),t.lineWidth=w,t.beginPath(),t.roundRect(p,l,h,u,d),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):c0(t,C,s,e.arrow.w*f,{color:r(.45),closed:!0},e),o.prog!=null&&o.prog>.001){const n=[],S=(A,y,B,D,G)=>{for(let O=1;O<=G;O++)n.push([A+(B-A)*O/G,y+(D-y)*O/G])},T=(A,y,B,D,G)=>{for(let O=1;O<=G;O++){const $=B+(D-B)*O/G;n.push([A+d*Math.cos($),y+d*Math.sin($)])}},b=Math.PI/2,x=p+h,I=l+u,R=p+h/2;n.push([R,l]),S(R,l,x-d,l,8),T(x-d,l+d,-b,0,6),S(x,l+d,x,I-d,10),T(x-d,I-d,0,b,6),S(x-d,I,p+d,I,14),T(p+d,I-d,b,Math.PI,6),S(p,I-d,p,l+d,10),T(p+d,l+d,Math.PI,Math.PI+b,6),S(p+d,l,R,l,8);let k=0;for(let A=1;A<n.length;A++)k+=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);const _=k*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*f,8*f]),t.lineDashOffset=-(h/2-d)-s*22*f,t.strokeStyle=r(.9),t.lineWidth=w*1.3,t.lineCap="round",t.shadowColor=r(.92),t.shadowBlur=c*1.3,t.beginPath(),t.moveTo(n[0][0],n[0][1]);let P=0;for(let A=1;A<n.length&&P<_;A++){const y=Math.hypot(n[A][0]-n[A-1][0],n[A][1]-n[A-1][1]);if(P+y<=_)t.lineTo(n[A][0],n[A][1]),P+=y;else{const B=(_-P)/y;t.lineTo(n[A-1][0]+(n[A][0]-n[A-1][0])*B,n[A-1][1]+(n[A][1]-n[A-1][1])*B),P=_}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&e.foot&&(e.foot(t,!1,m-16*o.feet*f,m+6*f,26*o.feet*f),e.foot(t,!0,m+16*o.feet*f,m+6*f,26*o.feet*f)),t.shadowBlur=0}function O0(t,a,o,i,s,e,c,r){const f=13*i.halo,m=4*e.arrow.w*(a/220),d=e.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const p=a/220,l=c||[[45*p,130*p],[110*p,60*p],[175*p,110*p]],h=r??s*.5%1,u=Math.min(1,h*1.25)*(l.length-1),C=Math.min(l.length-1,Math.floor(u+.35));t.shadowColor=d(.7),t.shadowBlur=f;const M=[[l[0][0],l[0][1]]];for(let w=1;w<=l.length-1;w++){const n=Math.max(0,Math.min(1,u-(w-1)));if(n<=0)break;M.push([l[w-1][0]+(l[w][0]-l[w-1][0])*n,l[w-1][1]+(l[w][1]-l[w-1][1])*n])}M.length>1&&c0(t,M,s,e.arrow.w*p,{color:d(.62)},e),t.setLineDash([4*p,7*p]),t.lineDashOffset=0,t.globalAlpha=.3,t.strokeStyle=d(.45),t.lineWidth=m,t.beginPath(),l.forEach(([w,n],S)=>S?t.lineTo(w,n):t.moveTo(w,n)),t.stroke(),t.globalAlpha=1,t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,l.forEach(([w,n],S)=>{const T=S===C,b=T?1+Math.sin(s*6)*.14:1;t.strokeStyle=d(T?.8:.45),t.lineWidth=m*(T?1.3:.9),t.shadowBlur=T?f*1.6:f*.6,t.beginPath(),t.arc(w,n,12*o.node*b*p,0,Math.PI*2),t.stroke(),e.num&&(t.globalAlpha=S<=C?1:.45,e.num(t,String(S+1),w,n,16*o.numS*b*p,Math.round(14*o.numS*p)),t.globalAlpha=1)}),t.shadowBlur=0}function U0(t,a,o,i,s,e,c){const r=e.lut,f=13*i.halo,m=a/220,d=a/2,p=e.arrow&&e.arrow.w||1,l=(x,I)=>r(x).replace("rgb(","rgba(").replace(")",`,${I})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const h=(o.r!=null?o.r:.42)*a,u=h*(o.rt!=null?o.rt:.36),C=3.4*p*m,M=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.6)%1,w=Math.pow(M,1.6),n=Math.max(0,(M-.9)/.1);t.save(),t.translate(d,d);const S=(x,I,R,k=1)=>{if(x<=.6)return;const _=C*2.6*k,P=Math.max(.1,x-_),A=x+_,y=t.createRadialGradient(0,0,P,0,0,A);y.addColorStop(0,l(I-.05,0)),y.addColorStop(.5,l(I,R*.85)),y.addColorStop(1,l(I-.05,0)),t.globalAlpha=1,t.fillStyle=y,t.shadowBlur=0,t.beginPath(),t.arc(0,0,A,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,R*1.1),t.lineWidth=C*.85,t.strokeStyle=r(Math.min(.98,I+.12)),t.shadowColor=r(.88),t.shadowBlur=f*.6,t.beginPath(),t.arc(0,0,x,0,Math.PI*2),t.stroke(),t.shadowBlur=0},T=t.createRadialGradient(0,0,0,0,0,u*1.08);T.addColorStop(0,l(.6,.1+.18*n)),T.addColorStop(.65,l(.5,.05+.08*n)),T.addColorStop(1,l(.5,0)),t.globalAlpha=1,t.fillStyle=T,t.beginPath(),t.arc(0,0,u*1.08,0,Math.PI*2),t.fill();const b=1+.02*Math.sin(s*2.6);S(u*b,.55+.4*n,.5+.45*n,.9);for(let x=2;x>=0;x--){const I=Math.pow(Math.max(0,M-x*.05),1.6),R=h-(h-u)*I,k=x===0?.6+.4*w:.18/x*(1-n);S(R,.55+.4*w,k*(1-n*.45),1.15-.35*w)}n>.01&&S(u*(1+1.4*n),.9,(1-n)*.8,1.1),t.globalAlpha=.6+.3*n,t.shadowColor=r(.85),t.shadowBlur=f*(.9+n),t.fillStyle=r(.62+.3*n),t.beginPath(),t.arc(0,0,C*.85+3*m*n,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function G0(t,a,o,i,s,e,c,r){const f=e.lut,m=13*i.halo,d=a/220,p=a/2,l=e.arrow&&e.arrow.w||1,h=l*d,u=(v,L)=>f(v).replace("rgb(","rgba(").replace(")",","+L+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const C=a*.42*(o.spread!=null?o.spread:1),w=(r||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([v,L])=>[p+v*C,p+L*C]),n=80,S=[];for(let v=0;v<=n;v++){const L=v/n*(w.length-1),F=Math.min(w.length-2,Math.floor(L)),U=L-F,H=w[Math.max(0,F-1)],K=w[F],N=w[F+1],t0=w[Math.min(w.length-1,F+2)],a0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*U+(2*X-5*J+4*Y-o0)*U*U+(-X+3*J-3*Y+o0)*U*U*U);S.push([a0(H[0],K[0],N[0],t0[0]),a0(H[1],K[1],N[1],t0[1])])}const T=v=>{const L=Math.max(0,Math.min(n,v*n)),F=Math.floor(L),U=L-F,H=S[F],K=S[Math.min(n,F+1)];return[H[0]+(K[0]-H[0])*U,H[1]+(K[1]-H[1])*U]},b=.68;let x,I,R;if(c!=null)x=Math.max(0,Math.min(1,c)),I=1,R=0;else{const v=s*(o.tempo||.42)%1;if(v<b)x=v/b,I=1,R=0;else{const L=(v-b)/(1-b);x=1,I=1-L*L,R=L}}if(I<=.012)return;const k=x*x*x*(x*(6*x-15)+10),_=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const P=.36*(o.tail!=null?o.tail:1),A=o.width!=null?o.width:1;{const v=t.createLinearGradient(S[0][0],S[0][1],S[n][0],S[n][1]);v.addColorStop(0,u(.46,0)),v.addColorStop(.3,u(.46,.03*I)),v.addColorStop(.8,u(.46,.045*I)),v.addColorStop(1,u(.46,0)),t.globalAlpha=1,t.strokeStyle=v,t.lineWidth=9*h,t.shadowColor=f(.6),t.shadowBlur=m*2,t.beginPath(),S.forEach(([L,F],U)=>U?t.lineTo(L,F):t.moveTo(L,F)),t.stroke(),t.shadowBlur=0}const y=40,B=Math.max(0,k-P*(1-R)),D=[];for(let v=0;v<=y;v++)D.push(T(B+(k-B)*(v/y)));const G=()=>{t.beginPath(),D.forEach(([v,L],F)=>F?t.lineTo(v,L):t.moveTo(v,L)),t.stroke()},O=()=>{const v=t.createLinearGradient(D[0][0],D[0][1],D[y][0],D[y][1]);return v.addColorStop(0,u(.55,0)),v.addColorStop(.4,u(.56,0)),v.addColorStop(.68,u(.6,.09)),v.addColorStop(.88,u(.64,.24)),v.addColorStop(1,u(.68,.44)),v},$=1+.5*_;t.globalAlpha=I,t.strokeStyle=O(),t.lineWidth=(20+10*_)*h*A,t.shadowColor=f(.72),t.shadowBlur=m*2.2,G(),t.strokeStyle=O(),t.lineWidth=(10+5*_)*h*A,t.shadowBlur=m*1,G(),t.shadowBlur=0;for(let v=1;v<=y;v++){const L=v/y;t.globalAlpha=Math.pow(L,2.2)*.95*I,t.strokeStyle=f(.55+.38*L),t.lineWidth=(1.6+6.5*Math.pow(L,.7))*h*A*$,t.beginPath(),t.moveTo(D[v-1][0],D[v-1][1]),t.lineTo(D[v][0],D[v][1]),t.stroke()}const V=D[y][0],g=D[y][1];t.globalAlpha=.8*I,t.fillStyle=f(.6),t.shadowColor=f(.8),t.shadowBlur=m*1.6,t.beginPath(),t.arc(V,g,(9+5*_)*h*A,0,Math.PI*2),t.fill(),t.globalAlpha=I,t.fillStyle=f(.93),t.shadowBlur=m*.6,t.beginPath(),t.arc(V,g,(3.4+1.8*_)*h*A,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function H0(t,a,o,i,s,e,c){const r=e.lut,f=13*i.halo,m=a/220,d=a/2,p=e.arrow&&e.arrow.w||1;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const l=(o.r!=null?o.r:.3)*a,h=o.width!=null?o.width:1,u=4.2*p*m*h,C=o.dir!=null?o.dir:1,M=(o.sweep!=null?o.sweep:.66)*Math.PI*2,w=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.5)%1,n=-Math.PI/2+C*w*Math.PI*2;t.save(),t.translate(d,d),t.globalAlpha=.16,t.lineWidth=u*.7,t.strokeStyle=r(.44),t.shadowColor=r(.6),t.shadowBlur=f*.4,t.beginPath(),t.arc(0,0,l,0,Math.PI*2),t.stroke(),t.shadowBlur=0;const S=16;for(let _=0;_<S;_++){const P=_/(S-1),A=n-C*P*M,y=n-C*(P+1.2/S)*M;t.globalAlpha=(1-P)*.9,t.strokeStyle=r(.55+.35*(1-P)),t.lineWidth=u*(.55+.55*(1-P)),t.shadowColor=r(.8),t.shadowBlur=f*(.4+.5*(1-P)),t.beginPath(),t.arc(0,0,l,Math.min(A,y),Math.max(A,y),!1),t.stroke()}t.shadowBlur=0;const T=Math.cos(n)*l,b=Math.sin(n)*l,x=n+C*Math.PI/2,I=8*m*h;t.save(),t.translate(T,b),t.rotate(x+Math.PI/2),t.globalAlpha=1;const R=3.4*I*(.7+.3*p),k={color:r(.96),glowColor:r(.9),glow:f*1.2};e.glyph&&(e.glyph(t,"LIFT_TIP",0,0,R,k)||e.glyph(t,"TIP_TRI",0,0,R*.93,k))||(t.rotate(-Math.PI/2),t.strokeStyle=r(.96),t.lineWidth=u*.9,t.shadowColor=r(.9),t.shadowBlur=f*1.2,t.beginPath(),t.moveTo(-I,-I*.9),t.lineTo(I*.5,0),t.lineTo(-I,I*.9),t.stroke()),t.restore(),t.globalAlpha=.62,t.shadowColor=r(.75),t.shadowBlur=f*.6,t.fillStyle=r(.6),t.beginPath(),t.arc(0,0,u*.6,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}export{_0 as C,p0 as G,y0 as M,W as N,E as P,v0 as Q,k0 as R,b0 as S,T0 as Z,j as a,d0 as b,A0 as c,M0 as d,I0 as e,E0 as f,O0 as g,U0 as h,R0 as i,G0 as j,H0 as k,P0 as l,F0 as m,D0 as n,z as o,c0 as p,x0 as q,B0 as r,i0 as s,S0 as t,C0 as u,L0 as v,h0 as w,u0 as x};
