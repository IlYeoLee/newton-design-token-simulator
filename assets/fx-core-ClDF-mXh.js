const E={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},W={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},r0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)],x0=Object.fromEntries(Object.entries({...E,...W}).map(([a,t])=>[a,parseInt(t.slice(1),16)])),q=a=>`vec3(${r0(a).map(o=>(o/255).toFixed(4)).join(", ")})`,S0=(a,t=1)=>`rgba(${r0(a).join(",")},${t})`,u0=[[E.red,0],[E.red,.3],[E.coral,.56],[E.sand,.86],[E.prism,1]],h0=1;function f0(a){const t=String(a).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(t)||Object.values(W).some(o=>o.toUpperCase()===t)?!0:Object.values(E).some(o=>o.toUpperCase()===t)}function C0(a){return a&&((!Array.isArray(a.stops)||!a.stops.every(([o])=>f0(o)))&&(a.stops=u0.map(o=>[...o])),a.sat=h0,a)}function l0(a,t,o,i,s){let e=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let c=1;c<s;c++){let r=(a[c]+c*c-(a[o[e]]+o[e]*o[e]))/(2*c-2*o[e]);for(;r<=i[e];)e--,r=(a[c]+c*c-(a[o[e]]+o[e]*o[e]))/(2*c-2*o[e]);e++,o[e]=c,i[e]=r,i[e+1]=1e20}e=0;for(let c=0;c<s;c++){for(;i[e+1]<c;)e++;t[c]=(c-o[e])*(c-o[e])+a[o[e]]}}function e0(a,t){const o=new Float32Array(t),i=new Int32Array(t),s=new Float32Array(t+1),e=new Float32Array(t);for(let c=0;c<t;c++){for(let r=0;r<t;r++)e[r]=a[r*t+c];l0(e,o,i,s,t);for(let r=0;r<t;r++)a[r*t+c]=o[r]}for(let c=0;c<t;c++){for(let r=0;r<t;r++)e[r]=a[c*t+r];l0(e,o,i,s,t);for(let r=0;r<t;r++)a[c*t+r]=o[r]}}function i0(a,t){const i=new Float32Array(t*t),s=new Float32Array(t*t);let e=0,c=0,r=0;for(let m=0;m<t*t;m++){const d=a[m*4+3]/255;i[m]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),s[m]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(e+=m%t,c+=m/t|0,r++)}e0(i,t),e0(s,t);const f=new Float32Array(t*t);for(let m=0;m<t*t;m++)f[m]=(Math.sqrt(i[m])-Math.sqrt(s[m]))/t;return{data:f,N:t,cx:r?e/r/t:.5,cy:r?c/r/t:.5}}function z(a,t=512){const o="_raster"+t;if(a[o])return a[o];const i=document.createElement("canvas");i.width=i.height=t;const s=i.getContext("2d"),e=Math.min(t/a.naturalWidth,t/a.naturalHeight);s.drawImage(a,0,0,a.naturalWidth*e,a.naturalHeight*e);const c=s.getImageData(0,0,t,t).data;let r=t,f=t,m=-1,d=-1;for(let p=0;p<t;p++)for(let l=0;l<t;l++)c[(p*t+l)*4+3]>8&&(l<r&&(r=l),l>m&&(m=l),p<f&&(f=p),p>d&&(d=p));return a[o]=m<0?{canvas:i,x:0,y:0,w:t,h:t}:{canvas:i,x:r,y:f,w:m-r+1,h:d-f+1},a[o]}function b0(a,t,o=!1){const i=z(a,t),s=document.createElement("canvas");s.width=s.height=t;const e=s.getContext("2d"),c=Math.min(t*j/i.w,t*j/i.h),r=i.w*c,f=i.h*c;return o&&(e.translate(0,t),e.scale(1,-1)),e.drawImage(i.canvas,i.x,i.y,i.w,i.h,(t-r)/2,(t-f)/2,r,f),i0(e.getImageData(0,0,t,t).data,t)}function I0(a,t,o,i=!1){const s=z(a,o),e=t?z(t,o):null,c=Math.min(o*j/s.w,o*j/s.h),r=s.w*c,f=s.h*c,m=(o-r)/2,d=(o-f)/2,p=C=>{const M=document.createElement("canvas");M.width=M.height=o;const w=M.getContext("2d");return i&&(w.translate(0,o),w.scale(1,-1)),w.drawImage(C.canvas,s.x,s.y,s.w,s.h,m,d,r,f),i0(w.getImageData(0,0,o,o).data,o)},l=p(s),u=e?p(e):null,h=new Float32Array(o*o*2);for(let C=0;C<o*o;C++)h[C*2]=l.data[C],h[C*2+1]=u?u.data[C]:1;return{data:h,N:o,cx:l.cx,cy:l.cy,inCx:u?u.cx:l.cx,inCy:u?u.cy:l.cy,hasInner:!!u}}const A0=1.9922,d0=.78,j=.52,v0=d0/j,T0=1.18,p0={size:.85,gx:-.025,gy:.195,rot:6,shadow:"glow",shadowK:.75,blend:"add"};function M0(a,t,o,i,s=p0){const e=Math.round(o*.75),c=s.shadow==="none"?0:s.shadowK??.75,r=f=>i(a,String(t),o/2,o/2,e,f);return s.shadow==="drop"&&c>.001?(a.save(),a.globalAlpha=Math.min(1,c*.7),a.translate(o*.018,o*.024),r({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),a.restore(),r({glow:0,glowColor:"rgba(0,0,0,0)"})):r(s.shadow==="glow"?{glow:26*c,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),s.blend==="knock"}function P0(a,t){const o=a.getImageData(0,0,t,t),i=a.createImageData(t,t);for(let s=0;s<t*t;s++){const e=o.data[s*4+3]/255,c=Math.round(255*(1-e));i.data[s*4]=i.data[s*4+1]=i.data[s*4+2]=c,i.data[s*4+3]=255}a.putImageData(i,0,0)}const R0={RATIO:140/600,opacity(a){return a===0?.5:a===2||a===4?0:1},anchor(a,t,o){return{x:((t?1-a.x:a.x)-.5)*o,y:(.5-a.y)*o,s:a.s||1}}},Q=a=>(a/=255,a<=.04045?a/12.92:Math.pow((a+.055)/1.055,2.4)),Z=a=>(a=Math.max(0,Math.min(1,a)),Math.round(255*(a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055)));function n0(a,t,o){a=Q(a),t=Q(t),o=Q(o);const i=Math.cbrt(.4122214708*a+.5363325363*t+.0514459929*o),s=Math.cbrt(.2119034982*a+.6806995451*t+.1073969566*o),e=Math.cbrt(.0883024619*a+.2817188376*t+.6299787005*o);return[.2104542553*i+.793617785*s-.0040720468*e,1.9779984951*i-2.428592205*s+.4505937099*e,.0259040371*i+.7827717662*s-.808675766*e]}function m0(a,t,o){const i=(a+.3963377774*t+.2158037573*o)**3,s=(a-.1055613458*t-.0638541728*o)**3,e=(a-.0894841775*t-1.291485548*o)**3;return[Z(4.0767416621*i-3.3077115913*s+.2309699292*e),Z(-1.2684380046*i+2.6097574011*s-.3413193965*e),Z(-.0041960863*i-.7034186147*s+1.707614701*e)]}const s0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)];function y0(a,t=1,o=new Uint8Array(256*4)){const i=[...a].sort((s,e)=>s[1]-e[1]);for(let s=0;s<256;s++){const e=s/255;let c=0;for(;c<i.length-2&&e>i[c+1][1];)c++;const[r,f]=i[c],[m,d]=i[c+1],p=Math.max(0,Math.min(1,(e-f)/Math.max(1e-5,d-f))),l=n0(...s0(r)),u=n0(...s0(m)),h=m0(l[0]+(u[0]-l[0])*p,(l[1]+(u[1]-l[1])*p)*t,(l[2]+(u[2]-l[2])*p)*t);o.set([...h,255],s*4)}return o}const k0=`
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(a,t,o,i){a.lineWidth=4*t;const s=i.arrow;s.line==="dash"?a.setLineDash([12*t*s.gap,10*s.gap]):s.line==="dot"?(a.setLineDash([.5,12*s.gap]),a.lineCap="round",a.lineWidth=5*t):a.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(a.lineDashOffset=-o*40*s.speed)}function F0(a,t,o,i,s,e={}){const c=s.lut,r=s.arrow||{},f=r.w??1,m=r.speed??1,d=r.glow??1,p=e.pulse??1,l=o/256,u=t/2,h=i*.9*m%1,C=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,h/.55),M=e.prog!=null?1:h>.88?(1-h)/.12:1;a.clearRect(0,0,t,o);const w=M*(.45+.55*p),n=o-24*l,S=58*l,T=n+(S-n)*C,A=(k,L)=>c(k).replace("rgb(","rgba(").replace(")",`,${L.toFixed(3)})`),x=1.1*l*f,b=13*l*f,P=a.createLinearGradient(0,n,0,T);if(P.addColorStop(0,A(.55,0)),P.addColorStop(.1,A(.64,.45*w)),P.addColorStop(.32,A(.76,.85*w)),P.addColorStop(.62,A(.88,.98*w)),P.addColorStop(1,A(.97,w)),a.globalAlpha=1,a.fillStyle=P,a.beginPath(),a.moveTo(u-x/2,n),a.lineTo(u+x/2,n),a.lineTo(u+b/2,T),a.lineTo(u-b/2,T),a.closePath(),a.fill(),a.globalAlpha=w,C>.28&&!e.noTip){const k=34*l*(.7+.3*f),L=Math.min(1,(C-.28)/.22)*w,y=T+k*.3;a.globalAlpha=L;const I={color:c(.95),glowColor:c(.85),glow:12*d};s.glyph&&(s.glyph(a,"LIFT_TIP",u,y,k,I)||s.glyph(a,"TIP_TRI",u,y,k*.93,I))||(a.strokeStyle=c(.95),a.lineWidth=13*l*f,a.lineCap="round",a.lineJoin="round",a.shadowColor=c(.9),a.shadowBlur=18*l*d,a.beginPath(),a.moveTo(u-26*l,y+14*l),a.lineTo(u,y-16*l),a.lineTo(u+26*l,y+14*l),a.stroke())}a.globalAlpha=1,a.shadowBlur=0}function B0(a,t,o,i,s,e,c={}){const r=e.lut,f=e.arrow||{},m=f.w??1,d=f.glow??1,p=o/256;a.clearRect(0,0,t,o);const l=i.map(([n,S])=>[n*t,S*o]);if(l.length<2)return;const u=48,h=[],C=n=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*n,l[0][1]+(l[1][1]-l[0][1])*n];const S=n*(l.length-1),T=Math.min(l.length-2,Math.floor(S)),A=S-T,x=l[Math.max(0,T-1)],b=l[T],P=l[T+1],k=l[Math.min(l.length-1,T+2)],L=(y,I,R,B)=>.5*(2*I+(-y+R)*A+(2*y-5*I+4*R-B)*A*A+(-y+3*I-3*R+B)*A*A*A);return[L(x[0],b[0],P[0],k[0]),L(x[1],b[1],P[1],k[1])]};for(let n=0;n<=u;n++)h.push(C(n/u));const M=Math.max(0,Math.min(1,c.prog!=null?c.prog:s*.55%1)),w=Math.max(1,Math.round(u*M));a.lineCap="round";for(let n=1;n<=w;n++){const S=n/w;a.globalAlpha=Math.pow(S,1.5),a.strokeStyle=r(.45+.5*S),a.lineWidth=(1.6+3.2*S)*p*m,a.beginPath(),a.moveTo(h[n-1][0],h[n-1][1]),a.lineTo(h[n][0],h[n][1]),a.stroke()}if(M>.25){const n=h[w][0],S=h[w][1],T=h[Math.max(0,w-2)][0],A=h[Math.max(0,w-2)][1],x=Math.atan2(S-A,n-T)+Math.PI/2,b=30*p*(.7+.3*m);a.save(),a.translate(n,S),a.rotate(x),a.globalAlpha=Math.min(1,(M-.25)/.2);const P={color:r(.95),glowColor:r(.85),glow:12*d};e.glyph&&(e.glyph(a,"LIFT_TIP",0,0,b,P)||e.glyph(a,"TIP_TRI",0,0,b*.93,P))||(a.strokeStyle=r(.95),a.lineWidth=9*p*m,a.lineJoin="round",a.lineCap="round",a.beginPath(),a.moveTo(-18*p,12*p),a.lineTo(0,-14*p),a.lineTo(18*p,12*p),a.stroke()),a.restore()}a.globalAlpha=1}function c0(a,t,o,i,s,e){s=s||{};const c=e.lut,r=s.style||e.arrow.line,f=!!s.closed,m=[0];for(let u=1;u<t.length;u++)m.push(m[u-1]+Math.hypot(t[u][0]-t[u-1][0],t[u][1]-t[u-1][1]));const d=m[m.length-1]||1,p=u=>{u=(u%d+d)%d;let h=1;for(;h<m.length-1&&m[h]<u;)h++;const C=(u-m[h-1])/Math.max(1e-4,m[h]-m[h-1]);return[t[h-1][0]+(t[h][0]-t[h-1][0])*C,t[h-1][1]+(t[h][1]-t[h-1][1])*C,Math.atan2(t[h][1]-t[h-1][1],t[h][0]-t[h-1][0])]},l=e.arrow;if(r==="chevron"){const u=(26*i+8)*l.gap,h=Math.max(2,Math.floor(d/u));a.shadowColor=c(Math.min(1,l.heat+.2)),a.shadowBlur=8*i*l.glow;for(let C=0;C<h;C++){const M=C*u+o*42*l.speed%u;if(!f&&M>d-4)continue;const[w,n,S]=p(M),T=7.5*i,A=8.5*i,x=.45+.4*Math.sin(M/d*6.283-o*2.2*l.speed);a.strokeStyle=c(l.heat-.05+x*.3),a.lineWidth=3.2*i,a.lineJoin="round",a.lineCap="round",a.save(),a.translate(w,n),a.rotate(S),a.beginPath(),a.moveTo(-A*.5,-T),a.lineTo(A*.5,0),a.lineTo(-A*.5,T),a.stroke(),a.restore()}return!0}if(r==="comet"){const u=o*.35*l.speed%1*d,h=d*l.tail,C=Math.max(24,t.length*2);a.lineCap="round";for(let n=0;n<C;n++){const S=u-n/C*h,T=u-(n+1)/C*h;if(!f&&T<0)break;const A=1-n/C,[x,b]=p(S),[P,k]=p(T);!f&&Math.hypot(P-x,k-b)>d*.4||(a.globalAlpha=Math.pow(A,1.6),a.strokeStyle=c(Math.max(.05,l.heat-.2)+A*.55),a.lineWidth=(1.5+A*4.5)*i,A>.72?(a.shadowColor=c(Math.min(1,l.heat+.3)),a.shadowBlur=A*12*i*l.glow):a.shadowBlur=0,a.beginPath(),a.moveTo(x,b),a.lineTo(P,k),a.stroke())}a.globalAlpha=1,a.lineCap="butt",a.shadowBlur=0;const[M,w]=p(u);return a.fillStyle=rgba(W.ink,.95),a.shadowColor=c(.9),a.shadowBlur=16*i,a.beginPath(),a.arc(M,w,2.6*i,0,7),a.fill(),a.shadowBlur=0,!0}if(a.strokeStyle=s.color||c(l.heat),a.shadowColor=c(Math.min(1,l.heat+.15)),a.shadowBlur=(s.glow??8)*i*l.glow,r==="taper")for(let u=1;u<t.length;u++)a.lineWidth=(.5+u/t.length*4.5)*i,a.beginPath(),a.moveTo(t[u-1][0],t[u-1][1]),a.lineTo(t[u][0],t[u][1]),a.stroke();else w0(a,i,o,e),a.beginPath(),t.forEach(([u,h],C)=>C?a.lineTo(u,h):a.moveTo(u,h)),f&&a.closePath(),a.stroke();return a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,a.shadowBlur=0,!0}function E0(a,t,o,i,s,e){const c=13*i.halo,r=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const f=t/220,m=t/2,d=18*o.round*f,p=40*f,l=48*f,u=t-80*f,h=t-96*f,C=[],M=(n,S,T,A)=>{for(let x=0;x<=1;x+=.12)C.push([n+(T-n)*x,S+(A-S)*x])};M(p+d,l,p+u-d,l),M(p+u,l+d,p+u,l+h-d),M(p+u-d,l+h,p+d,l+h),M(p,l+h-d,p,l+d),a.shadowColor=r(.6),a.shadowBlur=c*.8;const w=4*e.arrow.w*f;if(e.arrow.line==="solid"?(a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-s*22*f,a.strokeStyle=r(.45),a.lineWidth=w,a.beginPath(),a.roundRect(p,l,u,h,d),a.stroke(),a.setLineDash([]),a.lineDashOffset=0):c0(a,C,s,e.arrow.w*f,{color:r(.45),closed:!0},e),o.prog!=null&&o.prog>.001){const n=[],S=(I,R,B,D,U)=>{for(let O=1;O<=U;O++)n.push([I+(B-I)*O/U,R+(D-R)*O/U])},T=(I,R,B,D,U)=>{for(let O=1;O<=U;O++){const $=B+(D-B)*O/U;n.push([I+d*Math.cos($),R+d*Math.sin($)])}},A=Math.PI/2,x=p+u,b=l+h,P=p+u/2;n.push([P,l]),S(P,l,x-d,l,8),T(x-d,l+d,-A,0,6),S(x,l+d,x,b-d,10),T(x-d,b-d,0,A,6),S(x-d,b,p+d,b,14),T(p+d,b-d,A,Math.PI,6),S(p,b-d,p,l+d,10),T(p+d,l+d,Math.PI,Math.PI+A,6),S(p+d,l,P,l,8);let k=0;for(let I=1;I<n.length;I++)k+=Math.hypot(n[I][0]-n[I-1][0],n[I][1]-n[I-1][1]);const L=k*Math.min(1,o.prog);a.save(),a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-(u/2-d)-s*22*f,a.strokeStyle=r(.9),a.lineWidth=w*1.3,a.lineCap="round",a.shadowColor=r(.92),a.shadowBlur=c*1.3,a.beginPath(),a.moveTo(n[0][0],n[0][1]);let y=0;for(let I=1;I<n.length&&y<L;I++){const R=Math.hypot(n[I][0]-n[I-1][0],n[I][1]-n[I-1][1]);if(y+R<=L)a.lineTo(n[I][0],n[I][1]),y+=R;else{const B=(L-y)/R;a.lineTo(n[I-1][0]+(n[I][0]-n[I-1][0])*B,n[I-1][1]+(n[I][1]-n[I-1][1])*B),y=L}}a.stroke(),a.setLineDash([]),a.restore()}o.feet>.05&&e.foot&&(e.foot(a,!1,m-16*o.feet*f,m+6*f,26*o.feet*f),e.foot(a,!0,m+16*o.feet*f,m+6*f,26*o.feet*f)),a.shadowBlur=0}function O0(a,t,o,i,s,e,c,r){const f=13*i.halo,m=4*e.arrow.w*(t/220),d=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const p=t/220,l=c||[[45*p,130*p],[110*p,60*p],[175*p,110*p]],u=r??s*.5%1,h=Math.min(1,u*1.25)*(l.length-1),C=Math.min(l.length-1,Math.floor(h+.35));a.shadowColor=d(.7),a.shadowBlur=f;const M=[[l[0][0],l[0][1]]];for(let w=1;w<=l.length-1;w++){const n=Math.max(0,Math.min(1,h-(w-1)));if(n<=0)break;M.push([l[w-1][0]+(l[w][0]-l[w-1][0])*n,l[w-1][1]+(l[w][1]-l[w-1][1])*n])}M.length>1&&c0(a,M,s,e.arrow.w*p,{color:d(.62)},e),a.setLineDash([4*p,7*p]),a.lineDashOffset=0,a.globalAlpha=.3,a.strokeStyle=d(.45),a.lineWidth=m,a.beginPath(),l.forEach(([w,n],S)=>S?a.lineTo(w,n):a.moveTo(w,n)),a.stroke(),a.globalAlpha=1,a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,l.forEach(([w,n],S)=>{const T=S===C,A=T?1+Math.sin(s*6)*.14:1;a.strokeStyle=d(T?.8:.45),a.lineWidth=m*(T?1.3:.9),a.shadowBlur=T?f*1.6:f*.6,a.beginPath(),a.arc(w,n,12*o.node*A*p,0,Math.PI*2),a.stroke(),e.num&&(a.globalAlpha=S<=C?1:.45,e.num(a,String(S+1),w,n,16*o.numS*A*p,Math.round(14*o.numS*p)),a.globalAlpha=1)}),a.shadowBlur=0}function G0(a,t,o,i,s,e,c){const r=e.lut,f=13*i.halo,m=t/220,d=t/2,p=e.arrow&&e.arrow.w||1,l=(x,b)=>r(x).replace("rgb(","rgba(").replace(")",`,${b})`);a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const u=(o.r!=null?o.r:.42)*t,h=u*(o.rt!=null?o.rt:.36),C=3.4*p*m,M=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.6)%1,w=Math.pow(M,1.6),n=Math.max(0,(M-.9)/.1);a.save(),a.translate(d,d);const S=(x,b,P,k=1)=>{if(x<=.6)return;const L=C*2.6*k,y=Math.max(.1,x-L),I=x+L,R=a.createRadialGradient(0,0,y,0,0,I);R.addColorStop(0,l(b-.05,0)),R.addColorStop(.5,l(b,P*.85)),R.addColorStop(1,l(b-.05,0)),a.globalAlpha=1,a.fillStyle=R,a.shadowBlur=0,a.beginPath(),a.arc(0,0,I,0,Math.PI*2),a.fill(),a.globalAlpha=Math.min(1,P*1.1),a.lineWidth=C*.85,a.strokeStyle=r(Math.min(.98,b+.12)),a.shadowColor=r(.88),a.shadowBlur=f*.6,a.beginPath(),a.arc(0,0,x,0,Math.PI*2),a.stroke(),a.shadowBlur=0},T=a.createRadialGradient(0,0,0,0,0,h*1.08);T.addColorStop(0,l(.6,.1+.18*n)),T.addColorStop(.65,l(.5,.05+.08*n)),T.addColorStop(1,l(.5,0)),a.globalAlpha=1,a.fillStyle=T,a.beginPath(),a.arc(0,0,h*1.08,0,Math.PI*2),a.fill();const A=1+.02*Math.sin(s*2.6);S(h*A,.55+.4*n,.5+.45*n,.9);for(let x=2;x>=0;x--){const b=Math.pow(Math.max(0,M-x*.05),1.6),P=u-(u-h)*b,k=x===0?.6+.4*w:.18/x*(1-n);S(P,.55+.4*w,k*(1-n*.45),1.15-.35*w)}n>.01&&S(h*(1+1.4*n),.9,(1-n)*.8,1.1),a.globalAlpha=.6+.3*n,a.shadowColor=r(.85),a.shadowBlur=f*(.9+n),a.fillStyle=r(.62+.3*n),a.beginPath(),a.arc(0,0,C*.85+3*m*n,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}function U0(a,t,o,i,s,e,c,r){const f=e.lut,m=13*i.halo,d=t/220,p=t/2,l=e.arrow&&e.arrow.w||1,u=l*d,h=(v,_)=>f(v).replace("rgb(","rgba(").replace(")",","+_+")");a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const C=t*.42*(o.spread!=null?o.spread:1),w=(r||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([v,_])=>[p+v*C,p+_*C]),n=80,S=[];for(let v=0;v<=n;v++){const _=v/n*(w.length-1),F=Math.min(w.length-2,Math.floor(_)),G=_-F,H=w[Math.max(0,F-1)],K=w[F],N=w[F+1],a0=w[Math.min(w.length-1,F+2)],t0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*G+(2*X-5*J+4*Y-o0)*G*G+(-X+3*J-3*Y+o0)*G*G*G);S.push([t0(H[0],K[0],N[0],a0[0]),t0(H[1],K[1],N[1],a0[1])])}const T=v=>{const _=Math.max(0,Math.min(n,v*n)),F=Math.floor(_),G=_-F,H=S[F],K=S[Math.min(n,F+1)];return[H[0]+(K[0]-H[0])*G,H[1]+(K[1]-H[1])*G]},A=.68;let x,b,P;if(c!=null)x=Math.max(0,Math.min(1,c)),b=1,P=0;else{const v=s*(o.tempo||.42)%1;if(v<A)x=v/A,b=1,P=0;else{const _=(v-A)/(1-A);x=1,b=1-_*_,P=_}}if(b<=.012)return;const k=x*x*x*(x*(6*x-15)+10),L=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const y=.36*(o.tail!=null?o.tail:1),I=o.width!=null?o.width:1;{const v=a.createLinearGradient(S[0][0],S[0][1],S[n][0],S[n][1]);v.addColorStop(0,h(.46,0)),v.addColorStop(.3,h(.46,.03*b)),v.addColorStop(.8,h(.46,.045*b)),v.addColorStop(1,h(.46,0)),a.globalAlpha=1,a.strokeStyle=v,a.lineWidth=9*u,a.shadowColor=f(.6),a.shadowBlur=m*2,a.beginPath(),S.forEach(([_,F],G)=>G?a.lineTo(_,F):a.moveTo(_,F)),a.stroke(),a.shadowBlur=0}const R=40,B=Math.max(0,k-y*(1-P)),D=[];for(let v=0;v<=R;v++)D.push(T(B+(k-B)*(v/R)));const U=()=>{a.beginPath(),D.forEach(([v,_],F)=>F?a.lineTo(v,_):a.moveTo(v,_)),a.stroke()},O=()=>{const v=a.createLinearGradient(D[0][0],D[0][1],D[R][0],D[R][1]);return v.addColorStop(0,h(.55,0)),v.addColorStop(.4,h(.56,0)),v.addColorStop(.68,h(.6,.09)),v.addColorStop(.88,h(.64,.24)),v.addColorStop(1,h(.68,.44)),v},$=1+.5*L;a.globalAlpha=b,a.strokeStyle=O(),a.lineWidth=(20+10*L)*u*I,a.shadowColor=f(.72),a.shadowBlur=m*2.2,U(),a.strokeStyle=O(),a.lineWidth=(10+5*L)*u*I,a.shadowBlur=m*1,U(),a.shadowBlur=0;for(let v=1;v<=R;v++){const _=v/R;a.globalAlpha=Math.pow(_,2.2)*.95*b,a.strokeStyle=f(.55+.38*_),a.lineWidth=(1.6+6.5*Math.pow(_,.7))*u*I*$,a.beginPath(),a.moveTo(D[v-1][0],D[v-1][1]),a.lineTo(D[v][0],D[v][1]),a.stroke()}const V=D[R][0],g=D[R][1];a.globalAlpha=.8*b,a.fillStyle=f(.6),a.shadowColor=f(.8),a.shadowBlur=m*1.6,a.beginPath(),a.arc(V,g,(9+5*L)*u*I,0,Math.PI*2),a.fill(),a.globalAlpha=b,a.fillStyle=f(.93),a.shadowBlur=m*.6,a.beginPath(),a.arc(V,g,(3.4+1.8*L)*u*I,0,Math.PI*2),a.fill(),a.globalAlpha=1,a.shadowBlur=0}function H0(a,t,o,i,s,e,c){const r=e.lut,f=13*i.halo,m=t/220,d=t/2,p=e.arrow&&e.arrow.w||1;a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const l=(o.r!=null?o.r:.3)*t,u=o.width!=null?o.width:1,h=4.2*p*m*u,C=o.dir!=null?o.dir:1,M=(o.sweep!=null?o.sweep:.66)*Math.PI*2,w=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.5)%1,n=-Math.PI/2+C*w*Math.PI*2;a.save(),a.translate(d,d),a.globalAlpha=.16,a.lineWidth=h*.7,a.strokeStyle=r(.44),a.shadowColor=r(.6),a.shadowBlur=f*.4,a.beginPath(),a.arc(0,0,l,0,Math.PI*2),a.stroke(),a.shadowBlur=0;const S=16;for(let L=0;L<S;L++){const y=L/(S-1),I=n-C*y*M,R=n-C*(y+1.2/S)*M;a.globalAlpha=(1-y)*.9,a.strokeStyle=r(.55+.35*(1-y)),a.lineWidth=h*(.55+.55*(1-y)),a.shadowColor=r(.8),a.shadowBlur=f*(.4+.5*(1-y)),a.beginPath(),a.arc(0,0,l,Math.min(I,R),Math.max(I,R),!1),a.stroke()}a.shadowBlur=0;const T=Math.cos(n)*l,A=Math.sin(n)*l,x=n+C*Math.PI/2,b=8*m*u;a.save(),a.translate(T,A),a.rotate(x+Math.PI/2),a.globalAlpha=1;const P=3.4*b*(.7+.3*p),k={color:r(.96),glowColor:r(.9),glow:f*1.2};e.glyph&&(e.glyph(a,"LIFT_TIP",0,0,P,k)||e.glyph(a,"TIP_TRI",0,0,P*.93,k))||(a.rotate(-Math.PI/2),a.strokeStyle=r(.96),a.lineWidth=h*.9,a.shadowColor=r(.9),a.shadowBlur=f*1.2,a.beginPath(),a.moveTo(-b,-b*.9),a.lineTo(b*.5,0),a.lineTo(-b,b*.9),a.stroke()),a.restore(),a.globalAlpha=.62,a.shadowColor=r(.75),a.shadowBlur=f*.6,a.fillStyle=r(.6),a.beginPath(),a.arc(0,0,h*.6,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}export{L0 as C,p0 as G,R0 as M,W as N,E as P,v0 as Q,k0 as R,A0 as S,T0 as Z,j as a,d0 as b,I0 as c,M0 as d,b0 as e,E0 as f,O0 as g,G0 as h,P0 as i,U0 as j,H0 as k,y0 as l,F0 as m,D0 as n,z as o,c0 as p,x0 as q,B0 as r,i0 as s,S0 as t,C0 as u,_0 as v,u0 as w,h0 as x};
