import{v as q,P as H,N as X}from"./palette-Bj20GXDn.js";const h0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",u0=.98,f0=.83,p0=-.043,m0=-.031,w0=5.5,S0=.027,x0=.25,C0=.26,b0=.3,I0=.92,v0=.038,R0=1,A0=24,M0=1,T0=.95,y0=.45,L0=.88,P0=0,_0=.5,k0=.34,D0=.1,B0=.4,F0=1,E0=1.4,G0=0,O0=3.4,U0=.01,H0=0,g0=.011,W0=-2,q0=.75,K0=-.07,$0=.12,X0=4,j0=.6,J0=4,Y0=1,Q0="drop",z0="add",Z0="offbit",V0=.55,N0=.14,aa=.5,ta=4,oa=4,ea=1,la=.32,na=1,sa={punchLine:{node:1.58,numS:1,comet:1,tailLen:.71,rail:.6}},ra=-.095,ia=.12,ca=10,da=-.015,ha=.12,ua=-10,fa={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15},pa={_:"바닥 전용 룩 파트(유저 08-05) — 벽과 **같은 토큰 문법**을 쓰되 렌더만 절제한다: 블룸/후광을 낮추고 선·점을 앞세운다. 형태·상태·의미는 건드리지 않는다(그래야 벽과 한 시스템으로 읽힌다).",halo:.18,glow:0,shadeRed:0,edgeShade:.9,edgeSoft:.12,sharp:.92,imp:1,dot:.28,op:.62,dither:.008},ma=1,wa=4,Sa={tap:{op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15}},xa={_:h0,imp:u0,scale:f0,offx:p0,offy:m0,irot:w0,pitch:S0,dot:x0,glow:C0,shade:b0,sharp:I0,edge:v0,plantar:R0,bands:A0,bandSoft:M0,w:T0,halo:y0,pool:L0,noise:P0,rip:_0,ripReach:k0,ripWidth:D0,ripSpeed:B0,ripGrad:F0,edgeShade:E0,shadeRed:G0,shadeRedW:O0,edgeW:U0,edgeSoft:H0,dither:g0,tilt:W0,gsize:q0,gx:K0,gy:$0,grot:X0,gsh:j0,shadeCol:J0,ripCol:Y0,gShadow:Q0,gBlend:z0,numSrc:Z0,prog:V0,bloom:N0,blur:aa,edgeShadeW:ta,edgeShadeCol:oa,edgeShadeGrad:ea,edgeShadeG0:la,edgeShadeG1:na,prims:sa,gxL:ra,gyL:ia,grotL:ca,gxR:da,gyR:ha,grotR:ua,tap:fa,floor:pa,op:ma,dotCol:wa,states:Sa};function l0(a,t,o,i,n){let l=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let r=1;r<n;r++){let h=(a[r]+r*r-(a[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);for(;h<=i[l];)l--,h=(a[r]+r*r-(a[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);l++,o[l]=r,i[l]=h,i[l+1]=1e20}l=0;for(let r=0;r<n;r++){for(;i[l+1]<r;)l++;t[r]=(r-o[l])*(r-o[l])+a[o[l]]}}function n0(a,t){const o=new Float32Array(t),i=new Int32Array(t),n=new Float32Array(t+1),l=new Float32Array(t);for(let r=0;r<t;r++){for(let h=0;h<t;h++)l[h]=a[h*t+r];l0(l,o,i,n,t);for(let h=0;h<t;h++)a[h*t+r]=o[h]}for(let r=0;r<t;r++){for(let h=0;h<t;h++)l[h]=a[r*t+h];l0(l,o,i,n,t);for(let h=0;h<t;h++)a[r*t+h]=o[h]}}function i0(a,t){const i=new Float32Array(t*t),n=new Float32Array(t*t);let l=0,r=0,h=0;for(let x=0;x<t*t;x++){const d=a[x*4+3]/255;i[x]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),n[x]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(l+=x%t,r+=x/t|0,h++)}n0(i,t),n0(n,t);const f=new Float32Array(t*t);for(let x=0;x<t*t;x++)f[x]=(Math.sqrt(i[x])-Math.sqrt(n[x]))/t;return{data:f,N:t,cx:h?l/h/t:.5,cy:h?r/h/t:.5}}function Z(a,t=512){const o="_raster"+t;if(a[o])return a[o];const i=document.createElement("canvas");i.width=i.height=t;const n=i.getContext("2d"),l=Math.min(t/a.naturalWidth,t/a.naturalHeight);n.drawImage(a,0,0,a.naturalWidth*l,a.naturalHeight*l);const r=n.getImageData(0,0,t,t).data;let h=t,f=t,x=-1,d=-1;for(let u=0;u<t;u++)for(let e=0;e<t;e++)r[(u*t+e)*4+3]>8&&(e<h&&(h=e),e>x&&(x=e),u<f&&(f=u),u>d&&(d=u));return a[o]=x<0?{canvas:i,x:0,y:0,w:t,h:t}:{canvas:i,x:h,y:f,w:x-h+1,h:d-f+1},a[o]}function Ma(a,t,o=!1){const i=Z(a,t),n=document.createElement("canvas");n.width=n.height=t;const l=n.getContext("2d"),r=Math.min(t*$/i.w,t*$/i.h),h=i.w*r,f=i.h*r;return o&&(l.translate(0,t),l.scale(1,-1)),l.drawImage(i.canvas,i.x,i.y,i.w,i.h,(t-h)/2,(t-f)/2,h,f),i0(l.getImageData(0,0,t,t).data,t)}function Ta(a,t,o,i=!1){const n=Z(a,o),l=t?Z(t,o):null,r=Math.min(o*$/n.w,o*$/n.h),h=n.w*r,f=n.h*r,x=(o-h)/2,d=(o-f)/2,u=I=>{const P=document.createElement("canvas");P.width=P.height=o;const A=P.getContext("2d");return i&&(A.translate(0,o),A.scale(1,-1)),A.drawImage(I.canvas,n.x,n.y,n.w,n.h,x,d,h,f),i0(A.getImageData(0,0,o,o).data,o)},e=u(n),c=l?u(l):null,s=new Float32Array(o*o*2);for(let I=0;I<o*o;I++)s[I*2]=e.data[I],s[I*2+1]=c?c.data[I]:1;return{data:s,N:o,cx:e.cx,cy:e.cy,inCx:c?c.cx:e.cx,inCy:c?c.cy:e.cy,hasInner:!!c}}const ya=1.9922,Ca=.78,$=.52,La=Ca/$,Pa=1.18,O=xa||{},c0={size:O.gsize??.85,gx:O.gx??-.025,gy:O.gy??.195,rot:O.grot??6,gxL:O.gxL,gyL:O.gyL,rotL:O.grotL,gxR:O.gxR,gyR:O.gyR,rotR:O.grotR,shadow:O.gShadow??"glow",shadowK:O.gsh??.75,blend:O.gBlend??"add"};function _a(a,t=c0){return a?{gx:t.gxR??-t.gx,gy:t.gyR??t.gy,rot:t.rotR??-t.rot}:{gx:t.gxL??t.gx,gy:t.gyL??t.gy,rot:t.rotL??t.rot}}function ka(a,t,o,i,n=c0){const l=Math.round(o*.75),r=n.shadow==="none"?0:n.shadowK??.75,h=f=>i(a,String(t),o/2,o/2,l,f);return n.shadow==="drop"&&r>.001?(a.save(),a.globalAlpha=Math.min(1,r*.7),a.translate(o*.018,o*.024),h({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),a.restore(),h({glow:0,glowColor:"rgba(0,0,0,0)"})):h(n.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),n.blend==="knock"}function Da(a,t){const o=a.getImageData(0,0,t,t),i=a.createImageData(t,t);for(let n=0;n<t*t;n++){const l=o.data[n*4+3]/255,r=Math.round(255*(1-l));i.data[n*4]=i.data[n*4+1]=i.data[n*4+2]=r,i.data[n*4+3]=255}a.putImageData(i,0,0)}const Ba={RATIO:140/600,opacity(a){return a===0?.5:a===2||a===4?0:1},anchor(a,t,o){return{x:((t?1-a.x:a.x)-.5)*o,y:(.5-a.y)*o,s:a.s||1}}},Q=a=>(a/=255,a<=.04045?a/12.92:Math.pow((a+.055)/1.055,2.4)),z=a=>(a=Math.max(0,Math.min(1,a)),Math.round(255*(a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055)));function s0(a,t,o){a=Q(a),t=Q(t),o=Q(o);const i=Math.cbrt(.4122214708*a+.5363325363*t+.0514459929*o),n=Math.cbrt(.2119034982*a+.6806995451*t+.1073969566*o),l=Math.cbrt(.0883024619*a+.2817188376*t+.6299787005*o);return[.2104542553*i+.793617785*n-.0040720468*l,1.9779984951*i-2.428592205*n+.4505937099*l,.0259040371*i+.7827717662*n-.808675766*l]}function ba(a,t,o){const i=(a+.3963377774*t+.2158037573*o)**3,n=(a-.1055613458*t-.0638541728*o)**3,l=(a-.0894841775*t-1.291485548*o)**3;return[z(4.0767416621*i-3.3077115913*n+.2309699292*l),z(-1.2684380046*i+2.6097574011*n-.3413193965*l),z(-.0041960863*i-.7034186147*n+1.707614701*l)]}const r0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)];function Fa(a,t=1,o=new Uint8Array(256*4)){const i=[...a].sort((n,l)=>n[1]-l[1]);for(let n=0;n<256;n++){const l=n/255;let r=0;for(;r<i.length-2&&l>i[r+1][1];)r++;const[h,f]=i[r],[x,d]=i[r+1],u=Math.max(0,Math.min(1,(l-f)/Math.max(1e-5,d-f))),e=s0(...r0(h)),c=s0(...r0(x)),s=ba(e[0]+(c[0]-e[0])*u,(e[1]+(c[1]-e[1])*u)*t,(e[2]+(c[2]-e[2])*u)*t);o.set([...s,255],n*4)}return o}const Ea=`
...
#define C_RED   ${q(H.red)}
#define C_CORAL ${q(H.coral)}
#define C_SAND  ${q(H.sand)}
#define C_ICE   ${q(H.prism)}
#define C_CREAM C_SAND
#define C_GRAYF ${q(X.hi)}
#define C_GRAYL ${q(X.lo)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function Ia(a,t,o,i){a.lineWidth=4*t;const n=i.arrow;n.line==="dash"?a.setLineDash([12*t*n.gap,10*n.gap]):n.line==="dot"?(a.setLineDash([.5,12*n.gap]),a.lineCap="round",a.lineWidth=5*t):a.setLineDash([]),o!=null&&n.line!=="solid"&&n.line!=="taper"&&(a.lineDashOffset=-o*40*n.speed)}function Ha(a,t,o,i,n,l={}){const r=n.lut,h=n.arrow||{},f=h.w??1,x=h.speed??1,d=h.glow??1,u=l.pulse??1,e=o/256,c=e*(l.scale??1),s=t/2,I=i*.9*x%1,P=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,I/.55),A=l.prog!=null?1:I>.88?(1-I)/.12:1;a.clearRect(0,0,t,o);const w=A*(.45+.55*u),T=o-24*e,_=58*e,y=T+(_-T)*P,S=(M,D)=>r(M).replace("rgb(","rgba(").replace(")",`,${D.toFixed(3)})`),p=1.1*c*f,m=13*c*f,C=42*c*(.7+.3*f),k=!l.noTip&&P>.28?Math.min(1,(P-.28)/.22)*C*.42:0,v=y+k,b=a.createLinearGradient(0,T,0,v);if(b.addColorStop(0,S(.55,0)),b.addColorStop(.18,S(.64,.3*w)),b.addColorStop(.4,S(.76,.8*w)),b.addColorStop(.65,S(.88,.98*w)),b.addColorStop(1,S(.97,w)),a.save(),a.filter=`blur(${7*c}px)`,a.globalAlpha=.55,a.fillStyle=b,a.beginPath(),a.moveTo(s-p,T),a.lineTo(s+p,T),a.lineTo(s+m*.95,v),a.lineTo(s-m*.95,v),a.closePath(),a.fill(),a.restore(),a.globalAlpha=1,a.fillStyle=b,a.beginPath(),a.moveTo(s-p/2,T),a.lineTo(s+p/2,T),a.lineTo(s+m/2,v),a.lineTo(s-m/2,v),a.closePath(),a.fill(),a.globalAlpha=w,P>.28&&!l.noTip){const M=C,D=Math.min(1,(P-.28)/.22)*w,L=y+M*.3;a.globalAlpha=D;const F={color:r(.95),glowColor:r(.85),glow:12*d};n.glyph&&(n.glyph(a,"LIFT_TIP",s,L,M,F)||n.glyph(a,"TIP_TRI",s,L,M*.93,F))||(a.strokeStyle=r(.95),a.lineWidth=13*c*f,a.lineCap="round",a.lineJoin="round",a.shadowColor=r(.9),a.shadowBlur=18*c*d,a.beginPath(),a.moveTo(s-26*c,L+14*c),a.lineTo(s,L-16*c),a.lineTo(s+26*c,L+14*c),a.stroke())}a.globalAlpha=1,a.shadowBlur=0}function va(a,t,o,i,n,l,r={}){const h=l.lut,f=l.arrow||{},x=f.w??1,d=f.glow??1,u=o/256*(r.scale??1);a.clearRect(0,0,t,o);const e=i.map(([S,p])=>[S*t,p*o]);if(e.length<2)return;const c=48,s=[],I=S=>{if(e.length===2)return[e[0][0]+(e[1][0]-e[0][0])*S,e[0][1]+(e[1][1]-e[0][1])*S];const p=S*(e.length-1),m=Math.min(e.length-2,Math.floor(p)),C=p-m,k=e[Math.max(0,m-1)],v=e[m],b=e[m+1],M=e[Math.min(e.length-1,m+2)],D=(L,F,E,g)=>.5*(2*F+(-L+E)*C+(2*L-5*F+4*E-g)*C*C+(-L+3*F-3*E+g)*C*C*C);return[D(k[0],v[0],b[0],M[0]),D(k[1],v[1],b[1],M[1])]};for(let S=0;S<=c;S++)s.push(I(S/c));const P=Math.max(0,Math.min(1,r.prog!=null?r.prog:n*.55%1)),A=Math.max(1,Math.round(c*P)),w=r.alpha??1,T=r.tail??.22;a.lineCap="round";const _=42*u*(.7+.3*x);let y=A;if(P>.28){let S=0;const p=_*.42*Math.min(1,(P-.28)/.22);for(;y>1&&S<p;)S+=Math.hypot(s[y][0]-s[y-1][0],s[y][1]-s[y-1][1]),y--}for(const S of[0,1])for(let p=1;p<=y;p++){const m=p/A,C=Math.min(1,m/T),k=C*C*(3-2*C)*w;a.globalAlpha=S?k:k*.16*m,a.strokeStyle=h(.55+.42*m),a.lineWidth=(1.1+11.9*m)*u*x*(S?1:1.9),a.beginPath(),a.moveTo(s[p-1][0],s[p-1][1]),a.lineTo(s[p][0],s[p][1]),a.stroke()}if(P>.28){const S=s[Math.max(0,A-2)][0],p=s[Math.max(0,A-2)][1],m=Math.atan2(s[A][1]-p,s[A][0]-S)+Math.PI/2,C=s[A][0]-Math.sin(m)*_*.3,k=s[A][1]+Math.cos(m)*_*.3;a.save(),a.translate(C,k),a.rotate(m),a.globalAlpha=Math.min(1,(P-.28)/.22)*w;const v={color:h(.95),glowColor:h(.85),glow:12*d};l.glyph&&(l.glyph(a,"LIFT_TIP",0,0,_,v)||l.glyph(a,"TIP_TRI",0,0,_*.93,v))||(a.strokeStyle=h(.95),a.lineWidth=9*u*x,a.lineJoin="round",a.lineCap="round",a.beginPath(),a.moveTo(-18*u,12*u),a.lineTo(0,-14*u),a.lineTo(18*u,12*u),a.stroke()),a.restore()}a.globalAlpha=1}function Ra(a,t,o,i,n,l){n=n||{};const r=l.lut,h=n.style||l.arrow.line,f=!!n.closed,x=[0];for(let c=1;c<t.length;c++)x.push(x[c-1]+Math.hypot(t[c][0]-t[c-1][0],t[c][1]-t[c-1][1]));const d=x[x.length-1]||1,u=c=>{c=(c%d+d)%d;let s=1;for(;s<x.length-1&&x[s]<c;)s++;const I=(c-x[s-1])/Math.max(1e-4,x[s]-x[s-1]);return[t[s-1][0]+(t[s][0]-t[s-1][0])*I,t[s-1][1]+(t[s][1]-t[s-1][1])*I,Math.atan2(t[s][1]-t[s-1][1],t[s][0]-t[s-1][0])]},e=l.arrow;if(h==="chevron"){const c=(26*i+8)*e.gap,s=Math.max(2,Math.floor(d/c));a.shadowColor=r(Math.min(1,e.heat+.2)),a.shadowBlur=8*i*e.glow;for(let I=0;I<s;I++){const P=I*c+o*42*e.speed%c;if(!f&&P>d-4)continue;const[A,w,T]=u(P),_=7.5*i,y=8.5*i,S=.45+.4*Math.sin(P/d*6.283-o*2.2*e.speed);a.strokeStyle=r(e.heat-.05+S*.3),a.lineWidth=3.2*i,a.lineJoin="round",a.lineCap="round",a.save(),a.translate(A,w),a.rotate(T),a.beginPath(),a.moveTo(-y*.5,-_),a.lineTo(y*.5,0),a.lineTo(-y*.5,_),a.stroke(),a.restore()}return!0}if(h==="comet"){const c=o*.35*e.speed%1*d,s=d*e.tail,I=Math.max(24,t.length*2);a.lineCap="round";for(let w=0;w<I;w++){const T=c-w/I*s,_=c-(w+1)/I*s;if(!f&&_<0)break;const y=1-w/I,[S,p]=u(T),[m,C]=u(_);!f&&Math.hypot(m-S,C-p)>d*.4||(a.globalAlpha=Math.pow(y,1.6),a.strokeStyle=r(Math.max(.05,e.heat-.2)+y*.55),a.lineWidth=(1.5+y*4.5)*i,y>.72?(a.shadowColor=r(Math.min(1,e.heat+.3)),a.shadowBlur=y*12*i*e.glow):a.shadowBlur=0,a.beginPath(),a.moveTo(S,p),a.lineTo(m,C),a.stroke())}a.globalAlpha=1,a.lineCap="butt",a.shadowBlur=0;const[P,A]=u(c);return a.fillStyle=rgba(X.ink,.95),a.shadowColor=r(.9),a.shadowBlur=16*i,a.beginPath(),a.arc(P,A,2.6*i,0,7),a.fill(),a.shadowBlur=0,!0}if(a.strokeStyle=n.color||r(e.heat),a.shadowColor=r(Math.min(1,e.heat+.15)),a.shadowBlur=(n.glow??8)*i*e.glow,h==="taper")for(let c=1;c<t.length;c++)a.lineWidth=(.5+c/t.length*4.5)*i,a.beginPath(),a.moveTo(t[c-1][0],t[c-1][1]),a.lineTo(t[c][0],t[c][1]),a.stroke();else Ia(a,i,o,l),a.beginPath(),t.forEach(([c,s],I)=>I?a.lineTo(c,s):a.moveTo(c,s)),f&&a.closePath(),a.stroke();return a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,a.shadowBlur=0,!0}function ga(a,t,o,i,n,l){const r=13*i.halo,h=l.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const f=t/220,x=t/2,d=18*o.round*f,u=40*f,e=48*f,c=t-80*f,s=t-96*f,I=[],P=(w,T,_,y)=>{for(let S=0;S<=1;S+=.12)I.push([w+(_-w)*S,T+(y-T)*S])};P(u+d,e,u+c-d,e),P(u+c,e+d,u+c,e+s-d),P(u+c-d,e+s,u+d,e+s),P(u,e+s-d,u,e+d),a.shadowColor=h(.6),a.shadowBlur=r*.8;const A=4*l.arrow.w*f;if(l.arrow.line==="solid"?(a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-n*22*f,a.strokeStyle=h(.45),a.lineWidth=A,a.beginPath(),a.roundRect(u,e,c,s,d),a.stroke(),a.setLineDash([]),a.lineDashOffset=0):Ra(a,I,n,l.arrow.w*f,{color:h(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const w=[],T=(b,M,D,L,F)=>{for(let E=1;E<=F;E++)w.push([b+(D-b)*E/F,M+(L-M)*E/F])},_=(b,M,D,L,F)=>{for(let E=1;E<=F;E++){const g=D+(L-D)*E/F;w.push([b+d*Math.cos(g),M+d*Math.sin(g)])}},y=Math.PI/2,S=u+c,p=e+s,m=u+c/2;w.push([m,e]),T(m,e,S-d,e,8),_(S-d,e+d,-y,0,6),T(S,e+d,S,p-d,10),_(S-d,p-d,0,y,6),T(S-d,p,u+d,p,14),_(u+d,p-d,y,Math.PI,6),T(u,p-d,u,e+d,10),_(u+d,e+d,Math.PI,Math.PI+y,6),T(u+d,e,m,e,8);let C=0;for(let b=1;b<w.length;b++)C+=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);const k=C*Math.min(1,o.prog);a.save(),a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-(c/2-d)-n*22*f,a.strokeStyle=h(.9),a.lineWidth=A*1.3,a.lineCap="round",a.shadowColor=h(.92),a.shadowBlur=r*1.3,a.beginPath(),a.moveTo(w[0][0],w[0][1]);let v=0;for(let b=1;b<w.length&&v<k;b++){const M=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);if(v+M<=k)a.lineTo(w[b][0],w[b][1]),v+=M;else{const D=(k-v)/M;a.lineTo(w[b-1][0]+(w[b][0]-w[b-1][0])*D,w[b-1][1]+(w[b][1]-w[b-1][1])*D),v=k}}a.stroke(),a.setLineDash([]),a.restore()}o.feet>.05&&l.foot&&(l.foot(a,!1,x-16*o.feet*f,x+6*f,26*o.feet*f),l.foot(a,!0,x+16*o.feet*f,x+6*f,26*o.feet*f)),a.shadowBlur=0}function Wa(a,t,o,i,n,l,r,h){const f=13*i.halo,x=4*l.arrow.w*(t/220),d=l.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const u=t/220,e=r||[[45*u,130*u],[110*u,60*u],[175*u,110*u]],c=h??n*.5%1,s=Math.min(1,c*1.25)*(e.length-1),I=Math.min(e.length-1,Math.floor(s+.35));a.shadowColor=d(.7),a.shadowBlur=f;const P=p=>{const m=Math.max(0,Math.min(e.length-2,Math.floor(p))),C=p-m;return[e[m][0]+(e[m+1][0]-e[m][0])*C,e[m][1]+(e[m+1][1]-e[m][1])*C]},A=o.comet!=null?o.comet:1,w=o.tailLen!=null?o.tailLen:.5;if(a.save(),a.shadowBlur=0,a.globalAlpha=o.rail!=null?o.rail:.22,a.strokeStyle=d(.6),a.lineWidth=2.2*u,a.lineCap="round",a.setLineDash([.01,8*u]),a.beginPath(),e.forEach(([p,m],C)=>C?a.lineTo(p,m):a.moveTo(p,m)),a.stroke(),a.setLineDash([]),a.restore(),s>.02){const p=(m,C)=>d(m).replace("rgb(","rgba(").replace(")",`,${C.toFixed(3)})`);for(let m=0;m<26;m++){const C=m/25,k=s-w*C;if(k<=0)break;const v=P(k),b=4.7*u*A*(1-C*.75),M=b*2.1,D=(1-C)*(1-C)*.8,L=a.createRadialGradient(v[0],v[1],0,v[0],v[1],M);L.addColorStop(0,p(.55-.18*C,D)),L.addColorStop(.5,p(.5-.18*C,D*.35)),L.addColorStop(1,p(.45-.18*C,0)),a.save(),a.shadowBlur=0,a.globalAlpha=1,a.fillStyle=L,a.beginPath(),a.arc(v[0],v[1],M,0,Math.PI*2),a.fill(),a.restore()}if(s<e.length-1-.001&&s-Math.floor(s)>.03){const m=P(s);a.save(),a.fillStyle=d(.62),a.shadowColor=d(.8),a.shadowBlur=11*u*A,a.beginPath(),a.arc(m[0],m[1],5.6*u*A,0,Math.PI*2),a.fill(),a.fillStyle=d(.95),a.globalAlpha=.95,a.beginPath(),a.arc(m[0],m[1],2.1*u*A,0,Math.PI*2),a.fill(),a.restore()}}a.globalAlpha=1,a.lineCap="butt";const T=o.done!=null,_=o.done||0,y=o.vd||[],S=o.acc!=null?o.acc:e.length-1;if(e.forEach(([p,m],C)=>{const k=C<_,v=y[C]||null,b=!k&&C===I&&!T,M=b?1+Math.sin(n*6)*.14:1,D=o.pop!=null&&C===_-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,L=12*o.node*M*D*u*(C===S?1.34:1);k&&v!=="miss"&&(a.shadowBlur=f*1.4,a.shadowColor=d(.5),a.fillStyle=d(v==="near"?.5:.36),a.beginPath(),a.arc(p,m,L*.88,0,Math.PI*2),a.fill()),k||(a.save(),a.translate(p,m),d0(a,d,L,b?.8:.5,b?.9:.5,x*.9,f),a.restore()),a.strokeStyle=v==="hit"?H.prism:v==="near"?H.sand:v==="miss"?X.lo:d(k?.62:b?.8:.45),a.lineWidth=x*(b?1.3:v?1.15:.9),a.shadowBlur=b?f*1.6:v&&v!=="miss"?f*1.3:f*.6,v&&v!=="miss"&&(a.shadowColor=v==="hit"?H.prism:H.sand),a.beginPath(),a.arc(p,m,L,0,Math.PI*2),a.stroke(),l.num&&(k&&v!=="miss"?(a.save(),a.globalCompositeOperation="destination-out",a.shadowBlur=0,l.num(a,String(C+1),p,m,16*o.numS*M*u,Math.round(14*o.numS*u)),a.restore()):(a.globalAlpha=C<=I?1:.6,l.num(a,String(C+1),p,m,16*o.numS*M*u,Math.round(14*o.numS*u)),a.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&_>0&&e[_-1]){const[p,m]=e[_-1],C=1-o.pop/.38,k=C*C,v=12*o.node*u*(_-1===(o.acc!=null?o.acc:e.length-1)?1.34:1);a.save();const b=v*(1.6+1.9*(1-C)),M=a.createRadialGradient(p,m,0,p,m,b);M.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*k).toFixed(3)})`),M.addColorStop(.35,d(.92).replace("rgb(","rgba(").replace(")",`,${(.8*k).toFixed(3)})`)),M.addColorStop(1,d(.7).replace("rgb(","rgba(").replace(")",",0)")),a.fillStyle=M,a.beginPath(),a.arc(p,m,b,0,Math.PI*2),a.fill(),a.strokeStyle=d(.92),a.globalAlpha=k,a.lineWidth=Math.max(1,6*u*C),a.shadowColor=d(.85),a.shadowBlur=24*u*k,a.beginPath(),a.arc(p,m,v*(1.1+3.4*(1-C)),0,Math.PI*2),a.stroke();const D=Math.max(0,C-.35)/.65;D>0&&(a.globalAlpha=D*D*.6,a.lineWidth=Math.max(1,3.5*u*D),a.beginPath(),a.arc(p,m,v*(1.1+2*(1-D)),0,Math.PI*2),a.stroke()),a.restore()}a.shadowBlur=0}function d0(a,t,o,i,n,l,r,h=1){if(o<=.6)return;const f=(c,s)=>t(c).replace("rgb(","rgba(").replace(")",`,${s})`),x=l*2.6*h,d=Math.max(.1,o-x),u=o+x,e=a.createRadialGradient(0,0,d,0,0,u);e.addColorStop(0,f(i-.05,0)),e.addColorStop(.5,f(i,n*.85)),e.addColorStop(1,f(i-.05,0)),a.globalAlpha=1,a.fillStyle=e,a.shadowBlur=0,a.beginPath(),a.arc(0,0,u,0,Math.PI*2),a.fill(),a.globalAlpha=Math.min(1,n*1.1),a.lineWidth=l*.85,a.strokeStyle=t(Math.min(.98,i+.12)),a.shadowColor=t(.88),a.shadowBlur=r*.6,a.beginPath(),a.arc(0,0,o,0,Math.PI*2),a.stroke(),a.shadowBlur=0}function qa(a,t,o,i,n,l,r){const h=l.lut,f=13*i.halo,x=t/220,d=t/2,u=l.arrow&&l.arrow.w||1,e=(S,p)=>h(S).replace("rgb(","rgba(").replace(")",`,${p})`);a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const c=(o.r!=null?o.r:.42)*t,s=c*(o.rt!=null?o.rt:.36),I=3.4*u*x,P=r!=null?Math.max(0,Math.min(1,r)):n*(o.tempo||.6)%1,A=Math.pow(P,1.6),w=Math.max(0,(P-.9)/.1);a.save(),a.translate(d,d);const T=(S,p,m,C=1)=>d0(a,h,S,p,m,I,f,C),_=a.createRadialGradient(0,0,0,0,0,s*1.08);_.addColorStop(0,e(.6,.1+.18*w)),_.addColorStop(.65,e(.5,.05+.08*w)),_.addColorStop(1,e(.5,0)),a.globalAlpha=1,a.fillStyle=_,a.beginPath(),a.arc(0,0,s*1.08,0,Math.PI*2),a.fill();const y=1+.02*Math.sin(n*2.6);T(s*y,.55+.4*w,.5+.45*w,.9);for(let S=2;S>=0;S--){const p=Math.pow(Math.max(0,P-S*.05),1.6),m=c-(c-s)*p,C=S===0?.6+.4*A:.18/S*(1-w);T(m,.55+.4*A,C*(1-w*.45),1.15-.35*A)}w>.01&&T(s*(1+1.4*w),.9,(1-w)*.8,1.1),a.globalAlpha=.6+.3*w,a.shadowColor=h(.85),a.shadowBlur=f*(.9+w),a.fillStyle=h(.62+.3*w),a.beginPath(),a.arc(0,0,I*.85+3*x*w,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}function Ka(a,t,o,i,n,l,r,h){const f=l.lut,x=13*i.halo,d=t/220,u=t/2,e=l.arrow&&l.arrow.w||1,c=e*d,s=(R,B)=>f(R).replace("rgb(","rgba(").replace(")",","+B+")");a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const I=t*.42*(o.spread!=null?o.spread:1),A=(h||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([R,B])=>[u+R*I,u+B*I]),w=80,T=[];for(let R=0;R<=w;R++){const B=R/w*(A.length-1),G=Math.min(A.length-2,Math.floor(B)),U=B-G,W=A[Math.max(0,G-1)],K=A[G],a0=A[G+1],t0=A[Math.min(A.length-1,G+2)],o0=(j,J,Y,e0)=>.5*(2*J+(-j+Y)*U+(2*j-5*J+4*Y-e0)*U*U+(-j+3*J-3*Y+e0)*U*U*U);T.push([o0(W[0],K[0],a0[0],t0[0]),o0(W[1],K[1],a0[1],t0[1])])}const _=R=>{const B=Math.max(0,Math.min(w,R*w)),G=Math.floor(B),U=B-G,W=T[G],K=T[Math.min(w,G+1)];return[W[0]+(K[0]-W[0])*U,W[1]+(K[1]-W[1])*U]},y=.68;let S,p,m;if(r!=null)S=Math.max(0,Math.min(1,r)),p=1,m=0;else{const R=n*(o.tempo||.42)%1;if(R<y)S=R/y,p=1,m=0;else{const B=(R-y)/(1-y);S=1,p=1-B*B,m=B}}if(p<=.012)return;const C=S*S*S*(S*(6*S-15)+10),k=Math.min(1,16*S*S*(1-S)*(1-S));o.taper!=null&&o.taper;const v=.36*(o.tail!=null?o.tail:1),b=o.width!=null?o.width:1;{const R=a.createLinearGradient(T[0][0],T[0][1],T[w][0],T[w][1]);R.addColorStop(0,s(.46,0)),R.addColorStop(.3,s(.46,.03*p)),R.addColorStop(.8,s(.46,.045*p)),R.addColorStop(1,s(.46,0)),a.globalAlpha=1,a.strokeStyle=R,a.lineWidth=9*c,a.shadowColor=f(.6),a.shadowBlur=x*2,a.beginPath(),T.forEach(([B,G],U)=>U?a.lineTo(B,G):a.moveTo(B,G)),a.stroke(),a.shadowBlur=0}const M=40,D=Math.max(0,C-v*(1-m)),L=[];for(let R=0;R<=M;R++)L.push(_(D+(C-D)*(R/M)));const F=()=>{a.beginPath(),L.forEach(([R,B],G)=>G?a.lineTo(R,B):a.moveTo(R,B)),a.stroke()},E=()=>{const R=a.createLinearGradient(L[0][0],L[0][1],L[M][0],L[M][1]);return R.addColorStop(0,s(.55,0)),R.addColorStop(.4,s(.56,0)),R.addColorStop(.68,s(.6,.09)),R.addColorStop(.88,s(.64,.24)),R.addColorStop(1,s(.68,.44)),R},g=1+.5*k;a.globalAlpha=p,a.strokeStyle=E(),a.lineWidth=(20+10*k)*c*b,a.shadowColor=f(.72),a.shadowBlur=x*2.2,F(),a.strokeStyle=E(),a.lineWidth=(10+5*k)*c*b,a.shadowBlur=x*1,F(),a.shadowBlur=0;for(let R=1;R<=M;R++){const B=R/M;a.globalAlpha=Math.pow(B,2.2)*.95*p,a.strokeStyle=f(.55+.38*B),a.lineWidth=(1.6+6.5*Math.pow(B,.7))*c*b*g,a.beginPath(),a.moveTo(L[R-1][0],L[R-1][1]),a.lineTo(L[R][0],L[R][1]),a.stroke()}const V=L[M][0],N=L[M][1];a.globalAlpha=.8*p,a.fillStyle=f(.6),a.shadowColor=f(.8),a.shadowBlur=x*1.6,a.beginPath(),a.arc(V,N,(9+5*k)*c*b,0,Math.PI*2),a.fill(),a.globalAlpha=p,a.fillStyle=f(.93),a.shadowBlur=x*.6,a.beginPath(),a.arc(V,N,(3.4+1.8*k)*c*b,0,Math.PI*2),a.fill(),a.globalAlpha=1,a.shadowBlur=0}function $a(a,t,o,i,n,l,r){const h=o.r!=null?o.r:.3,f=o.dir!=null?o.dir:1,x=(o.sweep!=null?o.sweep:.66)*Math.PI*2,d=r??n*(o.tempo!=null?o.tempo:.5)%1,u=-Math.PI/2+f*d*Math.PI*2,e=16,c=[];for(let s=0;s<=e;s++){const I=u-f*(1-s/e)*x;c.push([.5+Math.cos(I)*h,.5+Math.sin(I)*h])}va(a,t,t,c,n,l,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}export{Ga as C,c0 as G,xa as L,Ba as M,Oa as P,La as Q,Ea as R,ya as S,Pa as Z,$ as a,Ca as b,qa as c,ka as d,$a as e,Ha as f,Ka as g,Wa as h,Da as i,Ta as j,Ma as k,ga as l,Fa as m,Ua as n,Z as o,Ra as p,va as q,_a as r,i0 as s};
