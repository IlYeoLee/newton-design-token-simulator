const G={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},K={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},r0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)],C0=Object.fromEntries(Object.entries({...G,...K}).map(([a,o])=>[a,parseInt(o.slice(1),16)])),W=a=>`vec3(${r0(a).map(t=>(t/255).toFixed(4)).join(", ")})`,b0=(a,o=1)=>`rgba(${r0(a).join(",")},${o})`,d0=[[G.red,0],[G.red,.3],[G.coral,.56],[G.sand,.86],[G.prism,1]],u0=1;function h0(a){const o=String(a).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(o)||Object.values(K).some(t=>t.toUpperCase()===o)?!0:Object.values(G).some(t=>t.toUpperCase()===o)}function v0(a){return a&&((!Array.isArray(a.stops)||!a.stops.every(([t])=>h0(t)))&&(a.stops=d0.map(t=>[...t])),a.sat=u0,a)}function l0(a,o,t,i,n){let e=0;t[0]=0,i[0]=-1e20,i[1]=1e20;for(let r=1;r<n;r++){let u=(a[r]+r*r-(a[t[e]]+t[e]*t[e]))/(2*r-2*t[e]);for(;u<=i[e];)e--,u=(a[r]+r*r-(a[t[e]]+t[e]*t[e]))/(2*r-2*t[e]);e++,t[e]=r,i[e]=u,i[e+1]=1e20}e=0;for(let r=0;r<n;r++){for(;i[e+1]<r;)e++;o[r]=(r-t[e])*(r-t[e])+a[t[e]]}}function e0(a,o){const t=new Float32Array(o),i=new Int32Array(o),n=new Float32Array(o+1),e=new Float32Array(o);for(let r=0;r<o;r++){for(let u=0;u<o;u++)e[u]=a[u*o+r];l0(e,t,i,n,o);for(let u=0;u<o;u++)a[u*o+r]=t[u]}for(let r=0;r<o;r++){for(let u=0;u<o;u++)e[u]=a[r*o+u];l0(e,t,i,n,o);for(let u=0;u<o;u++)a[r*o+u]=t[u]}}function i0(a,o){const i=new Float32Array(o*o),n=new Float32Array(o*o);let e=0,r=0,u=0;for(let S=0;S<o*o;S++){const d=a[S*4+3]/255;i[S]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),n[S]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(e+=S%o,r+=S/o|0,u++)}e0(i,o),e0(n,o);const f=new Float32Array(o*o);for(let S=0;S<o*o;S++)f[S]=(Math.sqrt(i[S])-Math.sqrt(n[S]))/o;return{data:f,N:o,cx:u?e/u/o:.5,cy:u?r/u/o:.5}}function z(a,o=512){const t="_raster"+o;if(a[t])return a[t];const i=document.createElement("canvas");i.width=i.height=o;const n=i.getContext("2d"),e=Math.min(o/a.naturalWidth,o/a.naturalHeight);n.drawImage(a,0,0,a.naturalWidth*e,a.naturalHeight*e);const r=n.getImageData(0,0,o,o).data;let u=o,f=o,S=-1,d=-1;for(let h=0;h<o;h++)for(let l=0;l<o;l++)r[(h*o+l)*4+3]>8&&(l<u&&(u=l),l>S&&(S=l),h<f&&(f=h),h>d&&(d=h));return a[t]=S<0?{canvas:i,x:0,y:0,w:o,h:o}:{canvas:i,x:u,y:f,w:S-u+1,h:d-f+1},a[t]}function I0(a,o,t=!1){const i=z(a,o),n=document.createElement("canvas");n.width=n.height=o;const e=n.getContext("2d"),r=Math.min(o*j/i.w,o*j/i.h),u=i.w*r,f=i.h*r;return t&&(e.translate(0,o),e.scale(1,-1)),e.drawImage(i.canvas,i.x,i.y,i.w,i.h,(o-u)/2,(o-f)/2,u,f),i0(e.getImageData(0,0,o,o).data,o)}function A0(a,o,t,i=!1){const n=z(a,t),e=o?z(o,t):null,r=Math.min(t*j/n.w,t*j/n.h),u=n.w*r,f=n.h*r,S=(t-u)/2,d=(t-f)/2,h=v=>{const L=document.createElement("canvas");L.width=L.height=t;const T=L.getContext("2d");return i&&(T.translate(0,t),T.scale(1,-1)),T.drawImage(v.canvas,n.x,n.y,n.w,n.h,S,d,u,f),i0(T.getImageData(0,0,t,t).data,t)},l=h(n),c=e?h(e):null,s=new Float32Array(t*t*2);for(let v=0;v<t*t;v++)s[v*2]=l.data[v],s[v*2+1]=c?c.data[v]:1;return{data:s,N:t,cx:l.cx,cy:l.cy,inCx:c?c.cx:l.cx,inCy:c?c.cy:l.cy,hasInner:!!c}}const T0=1.9922,f0=.78,j=.52,M0=f0/j,R0=1.18,p0={size:.85,gx:-.025,gy:.195,rot:6,shadow:"glow",shadowK:.75,blend:"add"};function y0(a,o,t,i,n=p0){const e=Math.round(t*.75),r=n.shadow==="none"?0:n.shadowK??.75,u=f=>i(a,String(o),t/2,t/2,e,f);return n.shadow==="drop"&&r>.001?(a.save(),a.globalAlpha=Math.min(1,r*.7),a.translate(t*.018,t*.024),u({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),a.restore(),u({glow:0,glowColor:"rgba(0,0,0,0)"})):u(n.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),n.blend==="knock"}function k0(a,o){const t=a.getImageData(0,0,o,o),i=a.createImageData(o,o);for(let n=0;n<o*o;n++){const e=t.data[n*4+3]/255,r=Math.round(255*(1-e));i.data[n*4]=i.data[n*4+1]=i.data[n*4+2]=r,i.data[n*4+3]=255}a.putImageData(i,0,0)}const L0={RATIO:140/600,opacity(a){return a===0?.5:a===2||a===4?0:1},anchor(a,o,t){return{x:((o?1-a.x:a.x)-.5)*t,y:(.5-a.y)*t,s:a.s||1}}},Q=a=>(a/=255,a<=.04045?a/12.92:Math.pow((a+.055)/1.055,2.4)),Z=a=>(a=Math.max(0,Math.min(1,a)),Math.round(255*(a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055)));function n0(a,o,t){a=Q(a),o=Q(o),t=Q(t);const i=Math.cbrt(.4122214708*a+.5363325363*o+.0514459929*t),n=Math.cbrt(.2119034982*a+.6806995451*o+.1073969566*t),e=Math.cbrt(.0883024619*a+.2817188376*o+.6299787005*t);return[.2104542553*i+.793617785*n-.0040720468*e,1.9779984951*i-2.428592205*n+.4505937099*e,.0259040371*i+.7827717662*n-.808675766*e]}function m0(a,o,t){const i=(a+.3963377774*o+.2158037573*t)**3,n=(a-.1055613458*o-.0638541728*t)**3,e=(a-.0894841775*o-1.291485548*t)**3;return[Z(4.0767416621*i-3.3077115913*n+.2309699292*e),Z(-1.2684380046*i+2.6097574011*n-.3413193965*e),Z(-.0041960863*i-.7034186147*n+1.707614701*e)]}const s0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)];function P0(a,o=1,t=new Uint8Array(256*4)){const i=[...a].sort((n,e)=>n[1]-e[1]);for(let n=0;n<256;n++){const e=n/255;let r=0;for(;r<i.length-2&&e>i[r+1][1];)r++;const[u,f]=i[r],[S,d]=i[r+1],h=Math.max(0,Math.min(1,(e-f)/Math.max(1e-5,d-f))),l=n0(...s0(u)),c=n0(...s0(S)),s=m0(l[0]+(c[0]-l[0])*h,(l[1]+(c[1]-l[1])*h)*o,(l[2]+(c[2]-l[2])*h)*o);t.set([...s,255],n*4)}return t}const _0=`
...
#define C_RED   ${W(G.red)}
#define C_CORAL ${W(G.coral)}
#define C_SAND  ${W(G.sand)}
#define C_ICE   ${W(G.prism)}
#define C_CREAM C_SAND
#define C_GRAYF ${W(K.hi)}
#define C_GRAYL ${W(K.lo)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(a,o,t,i){a.lineWidth=4*o;const n=i.arrow;n.line==="dash"?a.setLineDash([12*o*n.gap,10*n.gap]):n.line==="dot"?(a.setLineDash([.5,12*n.gap]),a.lineCap="round",a.lineWidth=5*o):a.setLineDash([]),t!=null&&n.line!=="solid"&&n.line!=="taper"&&(a.lineDashOffset=-t*40*n.speed)}function E0(a,o,t,i,n,e={}){const r=n.lut,u=n.arrow||{},f=u.w??1,S=u.speed??1,d=u.glow??1,h=e.pulse??1,l=t/256,c=l*(e.scale??1),s=o/2,v=i*.9*S%1,L=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,v/.55),T=e.prog!=null?1:v>.88?(1-v)/.12:1;a.clearRect(0,0,o,t);const w=T*(.45+.55*h),R=t-24*l,P=58*l,y=R+(P-R)*L,x=(M,D)=>r(M).replace("rgb(","rgba(").replace(")",`,${D.toFixed(3)})`),p=1.1*c*f,m=13*c*f,C=42*c*(.7+.3*f),_=!e.noTip&&L>.28?Math.min(1,(L-.28)/.22)*C*.42:0,I=y+_,b=a.createLinearGradient(0,R,0,I);if(b.addColorStop(0,x(.55,0)),b.addColorStop(.18,x(.64,.3*w)),b.addColorStop(.4,x(.76,.8*w)),b.addColorStop(.65,x(.88,.98*w)),b.addColorStop(1,x(.97,w)),a.save(),a.filter=`blur(${7*c}px)`,a.globalAlpha=.55,a.fillStyle=b,a.beginPath(),a.moveTo(s-p,R),a.lineTo(s+p,R),a.lineTo(s+m*.95,I),a.lineTo(s-m*.95,I),a.closePath(),a.fill(),a.restore(),a.globalAlpha=1,a.fillStyle=b,a.beginPath(),a.moveTo(s-p/2,R),a.lineTo(s+p/2,R),a.lineTo(s+m/2,I),a.lineTo(s-m/2,I),a.closePath(),a.fill(),a.globalAlpha=w,L>.28&&!e.noTip){const M=C,D=Math.min(1,(L-.28)/.22)*w,k=y+M*.3;a.globalAlpha=D;const B={color:r(.95),glowColor:r(.85),glow:12*d};n.glyph&&(n.glyph(a,"LIFT_TIP",s,k,M,B)||n.glyph(a,"TIP_TRI",s,k,M*.93,B))||(a.strokeStyle=r(.95),a.lineWidth=13*c*f,a.lineCap="round",a.lineJoin="round",a.shadowColor=r(.9),a.shadowBlur=18*c*d,a.beginPath(),a.moveTo(s-26*c,k+14*c),a.lineTo(s,k-16*c),a.lineTo(s+26*c,k+14*c),a.stroke())}a.globalAlpha=1,a.shadowBlur=0}function x0(a,o,t,i,n,e,r={}){const u=e.lut,f=e.arrow||{},S=f.w??1,d=f.glow??1,h=t/256*(r.scale??1);a.clearRect(0,0,o,t);const l=i.map(([x,p])=>[x*o,p*t]);if(l.length<2)return;const c=48,s=[],v=x=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*x,l[0][1]+(l[1][1]-l[0][1])*x];const p=x*(l.length-1),m=Math.min(l.length-2,Math.floor(p)),C=p-m,_=l[Math.max(0,m-1)],I=l[m],b=l[m+1],M=l[Math.min(l.length-1,m+2)],D=(k,B,E,H)=>.5*(2*B+(-k+E)*C+(2*k-5*B+4*E-H)*C*C+(-k+3*B-3*E+H)*C*C*C);return[D(_[0],I[0],b[0],M[0]),D(_[1],I[1],b[1],M[1])]};for(let x=0;x<=c;x++)s.push(v(x/c));const L=Math.max(0,Math.min(1,r.prog!=null?r.prog:n*.55%1)),T=Math.max(1,Math.round(c*L)),w=r.alpha??1,R=r.tail??.22;a.lineCap="round";const P=42*h*(.7+.3*S);let y=T;if(L>.28){let x=0;const p=P*.42*Math.min(1,(L-.28)/.22);for(;y>1&&x<p;)x+=Math.hypot(s[y][0]-s[y-1][0],s[y][1]-s[y-1][1]),y--}for(const x of[0,1])for(let p=1;p<=y;p++){const m=p/T,C=Math.min(1,m/R),_=C*C*(3-2*C)*w;a.globalAlpha=x?_:_*.16*m,a.strokeStyle=u(.55+.42*m),a.lineWidth=(1.1+11.9*m)*h*S*(x?1:1.9),a.beginPath(),a.moveTo(s[p-1][0],s[p-1][1]),a.lineTo(s[p][0],s[p][1]),a.stroke()}if(L>.28){const x=s[Math.max(0,T-2)][0],p=s[Math.max(0,T-2)][1],m=Math.atan2(s[T][1]-p,s[T][0]-x)+Math.PI/2,C=s[T][0]-Math.sin(m)*P*.3,_=s[T][1]+Math.cos(m)*P*.3;a.save(),a.translate(C,_),a.rotate(m),a.globalAlpha=Math.min(1,(L-.28)/.22)*w;const I={color:u(.95),glowColor:u(.85),glow:12*d};e.glyph&&(e.glyph(a,"LIFT_TIP",0,0,P,I)||e.glyph(a,"TIP_TRI",0,0,P*.93,I))||(a.strokeStyle=u(.95),a.lineWidth=9*h*S,a.lineJoin="round",a.lineCap="round",a.beginPath(),a.moveTo(-18*h,12*h),a.lineTo(0,-14*h),a.lineTo(18*h,12*h),a.stroke()),a.restore()}a.globalAlpha=1}function S0(a,o,t,i,n,e){n=n||{};const r=e.lut,u=n.style||e.arrow.line,f=!!n.closed,S=[0];for(let c=1;c<o.length;c++)S.push(S[c-1]+Math.hypot(o[c][0]-o[c-1][0],o[c][1]-o[c-1][1]));const d=S[S.length-1]||1,h=c=>{c=(c%d+d)%d;let s=1;for(;s<S.length-1&&S[s]<c;)s++;const v=(c-S[s-1])/Math.max(1e-4,S[s]-S[s-1]);return[o[s-1][0]+(o[s][0]-o[s-1][0])*v,o[s-1][1]+(o[s][1]-o[s-1][1])*v,Math.atan2(o[s][1]-o[s-1][1],o[s][0]-o[s-1][0])]},l=e.arrow;if(u==="chevron"){const c=(26*i+8)*l.gap,s=Math.max(2,Math.floor(d/c));a.shadowColor=r(Math.min(1,l.heat+.2)),a.shadowBlur=8*i*l.glow;for(let v=0;v<s;v++){const L=v*c+t*42*l.speed%c;if(!f&&L>d-4)continue;const[T,w,R]=h(L),P=7.5*i,y=8.5*i,x=.45+.4*Math.sin(L/d*6.283-t*2.2*l.speed);a.strokeStyle=r(l.heat-.05+x*.3),a.lineWidth=3.2*i,a.lineJoin="round",a.lineCap="round",a.save(),a.translate(T,w),a.rotate(R),a.beginPath(),a.moveTo(-y*.5,-P),a.lineTo(y*.5,0),a.lineTo(-y*.5,P),a.stroke(),a.restore()}return!0}if(u==="comet"){const c=t*.35*l.speed%1*d,s=d*l.tail,v=Math.max(24,o.length*2);a.lineCap="round";for(let w=0;w<v;w++){const R=c-w/v*s,P=c-(w+1)/v*s;if(!f&&P<0)break;const y=1-w/v,[x,p]=h(R),[m,C]=h(P);!f&&Math.hypot(m-x,C-p)>d*.4||(a.globalAlpha=Math.pow(y,1.6),a.strokeStyle=r(Math.max(.05,l.heat-.2)+y*.55),a.lineWidth=(1.5+y*4.5)*i,y>.72?(a.shadowColor=r(Math.min(1,l.heat+.3)),a.shadowBlur=y*12*i*l.glow):a.shadowBlur=0,a.beginPath(),a.moveTo(x,p),a.lineTo(m,C),a.stroke())}a.globalAlpha=1,a.lineCap="butt",a.shadowBlur=0;const[L,T]=h(c);return a.fillStyle=rgba(K.ink,.95),a.shadowColor=r(.9),a.shadowBlur=16*i,a.beginPath(),a.arc(L,T,2.6*i,0,7),a.fill(),a.shadowBlur=0,!0}if(a.strokeStyle=n.color||r(l.heat),a.shadowColor=r(Math.min(1,l.heat+.15)),a.shadowBlur=(n.glow??8)*i*l.glow,u==="taper")for(let c=1;c<o.length;c++)a.lineWidth=(.5+c/o.length*4.5)*i,a.beginPath(),a.moveTo(o[c-1][0],o[c-1][1]),a.lineTo(o[c][0],o[c][1]),a.stroke();else w0(a,i,t,e),a.beginPath(),o.forEach(([c,s],v)=>v?a.lineTo(c,s):a.moveTo(c,s)),f&&a.closePath(),a.stroke();return a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,a.shadowBlur=0,!0}function G0(a,o,t,i,n,e){const r=13*i.halo,u=e.lut;a.clearRect(0,0,o,o),a.lineJoin="round";const f=o/220,S=o/2,d=18*t.round*f,h=40*f,l=48*f,c=o-80*f,s=o-96*f,v=[],L=(w,R,P,y)=>{for(let x=0;x<=1;x+=.12)v.push([w+(P-w)*x,R+(y-R)*x])};L(h+d,l,h+c-d,l),L(h+c,l+d,h+c,l+s-d),L(h+c-d,l+s,h+d,l+s),L(h,l+s-d,h,l+d),a.shadowColor=u(.6),a.shadowBlur=r*.8;const T=4*e.arrow.w*f;if(e.arrow.line==="solid"?(a.setLineDash([10*t.dash*f,8*f]),a.lineDashOffset=-n*22*f,a.strokeStyle=u(.45),a.lineWidth=T,a.beginPath(),a.roundRect(h,l,c,s,d),a.stroke(),a.setLineDash([]),a.lineDashOffset=0):S0(a,v,n,e.arrow.w*f,{color:u(.45),closed:!0},e),t.prog!=null&&t.prog>.001){const w=[],R=(b,M,D,k,B)=>{for(let E=1;E<=B;E++)w.push([b+(D-b)*E/B,M+(k-M)*E/B])},P=(b,M,D,k,B)=>{for(let E=1;E<=B;E++){const H=D+(k-D)*E/B;w.push([b+d*Math.cos(H),M+d*Math.sin(H)])}},y=Math.PI/2,x=h+c,p=l+s,m=h+c/2;w.push([m,l]),R(m,l,x-d,l,8),P(x-d,l+d,-y,0,6),R(x,l+d,x,p-d,10),P(x-d,p-d,0,y,6),R(x-d,p,h+d,p,14),P(h+d,p-d,y,Math.PI,6),R(h,p-d,h,l+d,10),P(h+d,l+d,Math.PI,Math.PI+y,6),R(h+d,l,m,l,8);let C=0;for(let b=1;b<w.length;b++)C+=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);const _=C*Math.min(1,t.prog);a.save(),a.setLineDash([10*t.dash*f,8*f]),a.lineDashOffset=-(c/2-d)-n*22*f,a.strokeStyle=u(.9),a.lineWidth=T*1.3,a.lineCap="round",a.shadowColor=u(.92),a.shadowBlur=r*1.3,a.beginPath(),a.moveTo(w[0][0],w[0][1]);let I=0;for(let b=1;b<w.length&&I<_;b++){const M=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);if(I+M<=_)a.lineTo(w[b][0],w[b][1]),I+=M;else{const D=(_-I)/M;a.lineTo(w[b-1][0]+(w[b][0]-w[b-1][0])*D,w[b-1][1]+(w[b][1]-w[b-1][1])*D),I=_}}a.stroke(),a.setLineDash([]),a.restore()}t.feet>.05&&e.foot&&(e.foot(a,!1,S-16*t.feet*f,S+6*f,26*t.feet*f),e.foot(a,!0,S+16*t.feet*f,S+6*f,26*t.feet*f)),a.shadowBlur=0}function O0(a,o,t,i,n,e,r,u){const f=13*i.halo,S=4*e.arrow.w*(o/220),d=e.lut;a.clearRect(0,0,o,o),a.lineJoin="round";const h=o/220,l=r||[[45*h,130*h],[110*h,60*h],[175*h,110*h]],c=u??n*.5%1,s=Math.min(1,c*1.25)*(l.length-1),v=Math.min(l.length-1,Math.floor(s+.35));a.shadowColor=d(.7),a.shadowBlur=f;const L=p=>{const m=Math.max(0,Math.min(l.length-2,Math.floor(p))),C=p-m;return[l[m][0]+(l[m+1][0]-l[m][0])*C,l[m][1]+(l[m+1][1]-l[m][1])*C]},T=t.comet!=null?t.comet:1,w=t.tailLen!=null?t.tailLen:.5;if(a.save(),a.shadowBlur=0,a.globalAlpha=t.rail!=null?t.rail:.22,a.strokeStyle=d(.6),a.lineWidth=2.2*h,a.lineCap="round",a.setLineDash([.01,8*h]),a.beginPath(),l.forEach(([p,m],C)=>C?a.lineTo(p,m):a.moveTo(p,m)),a.stroke(),a.setLineDash([]),a.restore(),s>.02){const p=(m,C)=>d(m).replace("rgb(","rgba(").replace(")",`,${C.toFixed(3)})`);for(let m=0;m<26;m++){const C=m/25,_=s-w*C;if(_<=0)break;const I=L(_),b=4.7*h*T*(1-C*.75),M=b*2.1,D=(1-C)*(1-C)*.8,k=a.createRadialGradient(I[0],I[1],0,I[0],I[1],M);k.addColorStop(0,p(.55-.18*C,D)),k.addColorStop(.5,p(.5-.18*C,D*.35)),k.addColorStop(1,p(.45-.18*C,0)),a.save(),a.shadowBlur=0,a.globalAlpha=1,a.fillStyle=k,a.beginPath(),a.arc(I[0],I[1],M,0,Math.PI*2),a.fill(),a.restore()}if(s<l.length-1-.001&&s-Math.floor(s)>.03){const m=L(s);a.save(),a.fillStyle=d(.62),a.shadowColor=d(.8),a.shadowBlur=11*h*T,a.beginPath(),a.arc(m[0],m[1],5.6*h*T,0,Math.PI*2),a.fill(),a.fillStyle=d(.95),a.globalAlpha=.95,a.beginPath(),a.arc(m[0],m[1],2.1*h*T,0,Math.PI*2),a.fill(),a.restore()}}a.globalAlpha=1,a.lineCap="butt";const R=t.done!=null,P=t.done||0,y=t.vd||[],x=t.acc!=null?t.acc:l.length-1;if(l.forEach(([p,m],C)=>{const _=C<P,I=y[C]||null,b=!_&&C===v&&!R,M=b?1+Math.sin(n*6)*.14:1,D=t.pop!=null&&C===P-1&&t.pop<.3?1+.35*(1-t.pop/.3):1,k=12*t.node*M*D*h*(C===x?1.34:1);_&&I!=="miss"&&(a.shadowBlur=f*1.4,a.shadowColor=d(.5),a.fillStyle=d(I==="near"?.5:.36),a.beginPath(),a.arc(p,m,k*.88,0,Math.PI*2),a.fill()),_||(a.save(),a.translate(p,m),c0(a,d,k,b?.8:.5,b?.9:.5,S*.9,f),a.restore()),a.strokeStyle=I==="hit"?G.prism:I==="near"?G.sand:I==="miss"?K.lo:d(_?.62:b?.8:.45),a.lineWidth=S*(b?1.3:I?1.15:.9),a.shadowBlur=b?f*1.6:I&&I!=="miss"?f*1.3:f*.6,I&&I!=="miss"&&(a.shadowColor=I==="hit"?G.prism:G.sand),a.beginPath(),a.arc(p,m,k,0,Math.PI*2),a.stroke(),e.num&&(_&&I!=="miss"?(a.save(),a.globalCompositeOperation="destination-out",a.shadowBlur=0,e.num(a,String(C+1),p,m,16*t.numS*M*h,Math.round(14*t.numS*h)),a.restore()):(a.globalAlpha=C<=v?1:.6,e.num(a,String(C+1),p,m,16*t.numS*M*h,Math.round(14*t.numS*h)),a.globalAlpha=1))}),t.pop!=null&&t.pop<.38&&P>0&&l[P-1]){const[p,m]=l[P-1],C=1-t.pop/.38,_=C*C,I=12*t.node*h*(P-1===(t.acc!=null?t.acc:l.length-1)?1.34:1);a.save();const b=I*(1.6+1.9*(1-C)),M=a.createRadialGradient(p,m,0,p,m,b);M.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*_).toFixed(3)})`),M.addColorStop(.35,d(.92).replace("rgb(","rgba(").replace(")",`,${(.8*_).toFixed(3)})`)),M.addColorStop(1,d(.7).replace("rgb(","rgba(").replace(")",",0)")),a.fillStyle=M,a.beginPath(),a.arc(p,m,b,0,Math.PI*2),a.fill(),a.strokeStyle=d(.92),a.globalAlpha=_,a.lineWidth=Math.max(1,6*h*C),a.shadowColor=d(.85),a.shadowBlur=24*h*_,a.beginPath(),a.arc(p,m,I*(1.1+3.4*(1-C)),0,Math.PI*2),a.stroke();const D=Math.max(0,C-.35)/.65;D>0&&(a.globalAlpha=D*D*.6,a.lineWidth=Math.max(1,3.5*h*D),a.beginPath(),a.arc(p,m,I*(1.1+2*(1-D)),0,Math.PI*2),a.stroke()),a.restore()}a.shadowBlur=0}function c0(a,o,t,i,n,e,r,u=1){if(t<=.6)return;const f=(c,s)=>o(c).replace("rgb(","rgba(").replace(")",`,${s})`),S=e*2.6*u,d=Math.max(.1,t-S),h=t+S,l=a.createRadialGradient(0,0,d,0,0,h);l.addColorStop(0,f(i-.05,0)),l.addColorStop(.5,f(i,n*.85)),l.addColorStop(1,f(i-.05,0)),a.globalAlpha=1,a.fillStyle=l,a.shadowBlur=0,a.beginPath(),a.arc(0,0,h,0,Math.PI*2),a.fill(),a.globalAlpha=Math.min(1,n*1.1),a.lineWidth=e*.85,a.strokeStyle=o(Math.min(.98,i+.12)),a.shadowColor=o(.88),a.shadowBlur=r*.6,a.beginPath(),a.arc(0,0,t,0,Math.PI*2),a.stroke(),a.shadowBlur=0}function U0(a,o,t,i,n,e,r){const u=e.lut,f=13*i.halo,S=o/220,d=o/2,h=e.arrow&&e.arrow.w||1,l=(x,p)=>u(x).replace("rgb(","rgba(").replace(")",`,${p})`);a.clearRect(0,0,o,o),a.lineJoin="round",a.lineCap="round";const c=(t.r!=null?t.r:.42)*o,s=c*(t.rt!=null?t.rt:.36),v=3.4*h*S,L=r!=null?Math.max(0,Math.min(1,r)):n*(t.tempo||.6)%1,T=Math.pow(L,1.6),w=Math.max(0,(L-.9)/.1);a.save(),a.translate(d,d);const R=(x,p,m,C=1)=>c0(a,u,x,p,m,v,f,C),P=a.createRadialGradient(0,0,0,0,0,s*1.08);P.addColorStop(0,l(.6,.1+.18*w)),P.addColorStop(.65,l(.5,.05+.08*w)),P.addColorStop(1,l(.5,0)),a.globalAlpha=1,a.fillStyle=P,a.beginPath(),a.arc(0,0,s*1.08,0,Math.PI*2),a.fill();const y=1+.02*Math.sin(n*2.6);R(s*y,.55+.4*w,.5+.45*w,.9);for(let x=2;x>=0;x--){const p=Math.pow(Math.max(0,L-x*.05),1.6),m=c-(c-s)*p,C=x===0?.6+.4*T:.18/x*(1-w);R(m,.55+.4*T,C*(1-w*.45),1.15-.35*T)}w>.01&&R(s*(1+1.4*w),.9,(1-w)*.8,1.1),a.globalAlpha=.6+.3*w,a.shadowColor=u(.85),a.shadowBlur=f*(.9+w),a.fillStyle=u(.62+.3*w),a.beginPath(),a.arc(0,0,v*.85+3*S*w,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}function H0(a,o,t,i,n,e,r,u){const f=e.lut,S=13*i.halo,d=o/220,h=o/2,l=e.arrow&&e.arrow.w||1,c=l*d,s=(A,F)=>f(A).replace("rgb(","rgba(").replace(")",","+F+")");a.clearRect(0,0,o,o),a.lineJoin="round",a.lineCap="round";const v=o*.42*(t.spread!=null?t.spread:1),T=(u||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([A,F])=>[h+A*v,h+F*v]),w=80,R=[];for(let A=0;A<=w;A++){const F=A/w*(T.length-1),O=Math.min(T.length-2,Math.floor(F)),U=F-O,q=T[Math.max(0,O-1)],$=T[O],N=T[O+1],a0=T[Math.min(T.length-1,O+2)],t0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*U+(2*X-5*J+4*Y-o0)*U*U+(-X+3*J-3*Y+o0)*U*U*U);R.push([t0(q[0],$[0],N[0],a0[0]),t0(q[1],$[1],N[1],a0[1])])}const P=A=>{const F=Math.max(0,Math.min(w,A*w)),O=Math.floor(F),U=F-O,q=R[O],$=R[Math.min(w,O+1)];return[q[0]+($[0]-q[0])*U,q[1]+($[1]-q[1])*U]},y=.68;let x,p,m;if(r!=null)x=Math.max(0,Math.min(1,r)),p=1,m=0;else{const A=n*(t.tempo||.42)%1;if(A<y)x=A/y,p=1,m=0;else{const F=(A-y)/(1-y);x=1,p=1-F*F,m=F}}if(p<=.012)return;const C=x*x*x*(x*(6*x-15)+10),_=Math.min(1,16*x*x*(1-x)*(1-x));t.taper!=null&&t.taper;const I=.36*(t.tail!=null?t.tail:1),b=t.width!=null?t.width:1;{const A=a.createLinearGradient(R[0][0],R[0][1],R[w][0],R[w][1]);A.addColorStop(0,s(.46,0)),A.addColorStop(.3,s(.46,.03*p)),A.addColorStop(.8,s(.46,.045*p)),A.addColorStop(1,s(.46,0)),a.globalAlpha=1,a.strokeStyle=A,a.lineWidth=9*c,a.shadowColor=f(.6),a.shadowBlur=S*2,a.beginPath(),R.forEach(([F,O],U)=>U?a.lineTo(F,O):a.moveTo(F,O)),a.stroke(),a.shadowBlur=0}const M=40,D=Math.max(0,C-I*(1-m)),k=[];for(let A=0;A<=M;A++)k.push(P(D+(C-D)*(A/M)));const B=()=>{a.beginPath(),k.forEach(([A,F],O)=>O?a.lineTo(A,F):a.moveTo(A,F)),a.stroke()},E=()=>{const A=a.createLinearGradient(k[0][0],k[0][1],k[M][0],k[M][1]);return A.addColorStop(0,s(.55,0)),A.addColorStop(.4,s(.56,0)),A.addColorStop(.68,s(.6,.09)),A.addColorStop(.88,s(.64,.24)),A.addColorStop(1,s(.68,.44)),A},H=1+.5*_;a.globalAlpha=p,a.strokeStyle=E(),a.lineWidth=(20+10*_)*c*b,a.shadowColor=f(.72),a.shadowBlur=S*2.2,B(),a.strokeStyle=E(),a.lineWidth=(10+5*_)*c*b,a.shadowBlur=S*1,B(),a.shadowBlur=0;for(let A=1;A<=M;A++){const F=A/M;a.globalAlpha=Math.pow(F,2.2)*.95*p,a.strokeStyle=f(.55+.38*F),a.lineWidth=(1.6+6.5*Math.pow(F,.7))*c*b*H,a.beginPath(),a.moveTo(k[A-1][0],k[A-1][1]),a.lineTo(k[A][0],k[A][1]),a.stroke()}const V=k[M][0],g=k[M][1];a.globalAlpha=.8*p,a.fillStyle=f(.6),a.shadowColor=f(.8),a.shadowBlur=S*1.6,a.beginPath(),a.arc(V,g,(9+5*_)*c*b,0,Math.PI*2),a.fill(),a.globalAlpha=p,a.fillStyle=f(.93),a.shadowBlur=S*.6,a.beginPath(),a.arc(V,g,(3.4+1.8*_)*c*b,0,Math.PI*2),a.fill(),a.globalAlpha=1,a.shadowBlur=0}function q0(a,o,t,i,n,e,r){const u=t.r!=null?t.r:.3,f=t.dir!=null?t.dir:1,S=(t.sweep!=null?t.sweep:.66)*Math.PI*2,d=r??n*(t.tempo!=null?t.tempo:.5)%1,h=-Math.PI/2+f*d*Math.PI*2,l=16,c=[];for(let s=0;s<=l;s++){const v=h-f*(1-s/l)*S;c.push([.5+Math.cos(v)*u,.5+Math.sin(v)*u])}x0(a,o,o,c,n,e,{prog:1,tail:t.tail!=null?t.tail:.68,scale:(t.scale!=null?t.scale:1)*(t.width!=null?t.width:1)})}export{D0 as C,p0 as G,L0 as M,K as N,G as P,M0 as Q,_0 as R,T0 as S,R0 as Z,j as a,f0 as b,U0 as c,y0 as d,q0 as e,E0 as f,H0 as g,O0 as h,k0 as i,A0 as j,I0 as k,G0 as l,P0 as m,B0 as n,z as o,S0 as p,C0 as q,x0 as r,i0 as s,b0 as t,v0 as u,F0 as v,d0 as w,u0 as x};
