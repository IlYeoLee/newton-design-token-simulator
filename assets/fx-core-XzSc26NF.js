const G={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},K={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},r0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)],C0=Object.fromEntries(Object.entries({...G,...K}).map(([a,t])=>[a,parseInt(t.slice(1),16)])),W=a=>`vec3(${r0(a).map(o=>(o/255).toFixed(4)).join(", ")})`,v0=(a,t=1)=>`rgba(${r0(a).join(",")},${t})`,d0=[[G.red,0],[G.red,.3],[G.coral,.56],[G.sand,.86],[G.prism,1]],f0=1;function h0(a){const t=String(a).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(t)||Object.values(K).some(o=>o.toUpperCase()===t)?!0:Object.values(G).some(o=>o.toUpperCase()===t)}function b0(a){return a&&((!Array.isArray(a.stops)||!a.stops.every(([o])=>h0(o)))&&(a.stops=d0.map(o=>[...o])),a.sat=f0,a)}function e0(a,t,o,i,n){let e=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let r=1;r<n;r++){let u=(a[r]+r*r-(a[o[e]]+o[e]*o[e]))/(2*r-2*o[e]);for(;u<=i[e];)e--,u=(a[r]+r*r-(a[o[e]]+o[e]*o[e]))/(2*r-2*o[e]);e++,o[e]=r,i[e]=u,i[e+1]=1e20}e=0;for(let r=0;r<n;r++){for(;i[e+1]<r;)e++;t[r]=(r-o[e])*(r-o[e])+a[o[e]]}}function l0(a,t){const o=new Float32Array(t),i=new Int32Array(t),n=new Float32Array(t+1),e=new Float32Array(t);for(let r=0;r<t;r++){for(let u=0;u<t;u++)e[u]=a[u*t+r];e0(e,o,i,n,t);for(let u=0;u<t;u++)a[u*t+r]=o[u]}for(let r=0;r<t;r++){for(let u=0;u<t;u++)e[u]=a[r*t+u];e0(e,o,i,n,t);for(let u=0;u<t;u++)a[r*t+u]=o[u]}}function i0(a,t){const i=new Float32Array(t*t),n=new Float32Array(t*t);let e=0,r=0,u=0;for(let w=0;w<t*t;w++){const f=a[w*4+3]/255;i[w]=f>=1?0:f<=0?1e20:Math.pow(Math.max(0,.5-f),2),n[w]=f>=1?1e20:f<=0?0:Math.pow(Math.max(0,f-.5),2),f>.5&&(e+=w%t,r+=w/t|0,u++)}l0(i,t),l0(n,t);const d=new Float32Array(t*t);for(let w=0;w<t*t;w++)d[w]=(Math.sqrt(i[w])-Math.sqrt(n[w]))/t;return{data:d,N:t,cx:u?e/u/t:.5,cy:u?r/u/t:.5}}function z(a,t=512){const o="_raster"+t;if(a[o])return a[o];const i=document.createElement("canvas");i.width=i.height=t;const n=i.getContext("2d"),e=Math.min(t/a.naturalWidth,t/a.naturalHeight);n.drawImage(a,0,0,a.naturalWidth*e,a.naturalHeight*e);const r=n.getImageData(0,0,t,t).data;let u=t,d=t,w=-1,f=-1;for(let p=0;p<t;p++)for(let l=0;l<t;l++)r[(p*t+l)*4+3]>8&&(l<u&&(u=l),l>w&&(w=l),p<d&&(d=p),p>f&&(f=p));return a[o]=w<0?{canvas:i,x:0,y:0,w:t,h:t}:{canvas:i,x:u,y:d,w:w-u+1,h:f-d+1},a[o]}function I0(a,t,o=!1){const i=z(a,t),n=document.createElement("canvas");n.width=n.height=t;const e=n.getContext("2d"),r=Math.min(t*j/i.w,t*j/i.h),u=i.w*r,d=i.h*r;return o&&(e.translate(0,t),e.scale(1,-1)),e.drawImage(i.canvas,i.x,i.y,i.w,i.h,(t-u)/2,(t-d)/2,u,d),i0(e.getImageData(0,0,t,t).data,t)}function A0(a,t,o,i=!1){const n=z(a,o),e=t?z(t,o):null,r=Math.min(o*j/n.w,o*j/n.h),u=n.w*r,d=n.h*r,w=(o-u)/2,f=(o-d)/2,p=v=>{const R=document.createElement("canvas");R.width=R.height=o;const M=R.getContext("2d");return i&&(M.translate(0,o),M.scale(1,-1)),M.drawImage(v.canvas,n.x,n.y,n.w,n.h,w,f,u,d),i0(M.getImageData(0,0,o,o).data,o)},l=p(n),c=e?p(e):null,s=new Float32Array(o*o*2);for(let v=0;v<o*o;v++)s[v*2]=l.data[v],s[v*2+1]=c?c.data[v]:1;return{data:s,N:o,cx:l.cx,cy:l.cy,inCx:c?c.cx:l.cx,inCy:c?c.cy:l.cy,hasInner:!!c}}const T0=1.9922,p0=.78,j=.52,M0=p0/j,R0=1.18,m0={size:.85,gx:-.025,gy:.195,rot:6,shadow:"glow",shadowK:.75,blend:"add"};function y0(a,t,o,i,n=m0){const e=Math.round(o*.75),r=n.shadow==="none"?0:n.shadowK??.75,u=d=>i(a,String(t),o/2,o/2,e,d);return n.shadow==="drop"&&r>.001?(a.save(),a.globalAlpha=Math.min(1,r*.7),a.translate(o*.018,o*.024),u({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),a.restore(),u({glow:0,glowColor:"rgba(0,0,0,0)"})):u(n.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),n.blend==="knock"}function P0(a,t){const o=a.getImageData(0,0,t,t),i=a.createImageData(t,t);for(let n=0;n<t*t;n++){const e=o.data[n*4+3]/255,r=Math.round(255*(1-e));i.data[n*4]=i.data[n*4+1]=i.data[n*4+2]=r,i.data[n*4+3]=255}a.putImageData(i,0,0)}const L0={RATIO:140/600,opacity(a){return a===0?.5:a===2||a===4?0:1},anchor(a,t,o){return{x:((t?1-a.x:a.x)-.5)*o,y:(.5-a.y)*o,s:a.s||1}}},Q=a=>(a/=255,a<=.04045?a/12.92:Math.pow((a+.055)/1.055,2.4)),Z=a=>(a=Math.max(0,Math.min(1,a)),Math.round(255*(a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055)));function n0(a,t,o){a=Q(a),t=Q(t),o=Q(o);const i=Math.cbrt(.4122214708*a+.5363325363*t+.0514459929*o),n=Math.cbrt(.2119034982*a+.6806995451*t+.1073969566*o),e=Math.cbrt(.0883024619*a+.2817188376*t+.6299787005*o);return[.2104542553*i+.793617785*n-.0040720468*e,1.9779984951*i-2.428592205*n+.4505937099*e,.0259040371*i+.7827717662*n-.808675766*e]}function w0(a,t,o){const i=(a+.3963377774*t+.2158037573*o)**3,n=(a-.1055613458*t-.0638541728*o)**3,e=(a-.0894841775*t-1.291485548*o)**3;return[Z(4.0767416621*i-3.3077115913*n+.2309699292*e),Z(-1.2684380046*i+2.6097574011*n-.3413193965*e),Z(-.0041960863*i-.7034186147*n+1.707614701*e)]}const s0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)];function k0(a,t=1,o=new Uint8Array(256*4)){const i=[...a].sort((n,e)=>n[1]-e[1]);for(let n=0;n<256;n++){const e=n/255;let r=0;for(;r<i.length-2&&e>i[r+1][1];)r++;const[u,d]=i[r],[w,f]=i[r+1],p=Math.max(0,Math.min(1,(e-d)/Math.max(1e-5,f-d))),l=n0(...s0(u)),c=n0(...s0(w)),s=w0(l[0]+(c[0]-l[0])*p,(l[1]+(c[1]-l[1])*p)*t,(l[2]+(c[2]-l[2])*p)*t);o.set([...s,255],n*4)}return o}const _0=`
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function x0(a,t,o,i){a.lineWidth=4*t;const n=i.arrow;n.line==="dash"?a.setLineDash([12*t*n.gap,10*n.gap]):n.line==="dot"?(a.setLineDash([.5,12*n.gap]),a.lineCap="round",a.lineWidth=5*t):a.setLineDash([]),o!=null&&n.line!=="solid"&&n.line!=="taper"&&(a.lineDashOffset=-o*40*n.speed)}function E0(a,t,o,i,n,e={}){const r=n.lut,u=n.arrow||{},d=u.w??1,w=u.speed??1,f=u.glow??1,p=e.pulse??1,l=o/256,c=l*(e.scale??1),s=t/2,v=i*.9*w%1,R=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,v/.55),M=e.prog!=null?1:v>.88?(1-v)/.12:1;a.clearRect(0,0,t,o);const m=M*(.45+.55*p),T=o-24*l,y=58*l,S=T+(y-T)*R,h=(L,F)=>r(L).replace("rgb(","rgba(").replace(")",`,${F.toFixed(3)})`),x=1.1*c*d,b=13*c*d,A=42*c*(.7+.3*d),P=!e.noTip&&R>.28?Math.min(1,(R-.28)/.22)*A*.42:0,D=S+P,C=a.createLinearGradient(0,T,0,D);if(C.addColorStop(0,h(.55,0)),C.addColorStop(.18,h(.64,.3*m)),C.addColorStop(.4,h(.76,.8*m)),C.addColorStop(.65,h(.88,.98*m)),C.addColorStop(1,h(.97,m)),a.save(),a.filter=`blur(${7*c}px)`,a.globalAlpha=.55,a.fillStyle=C,a.beginPath(),a.moveTo(s-x,T),a.lineTo(s+x,T),a.lineTo(s+b*.95,D),a.lineTo(s-b*.95,D),a.closePath(),a.fill(),a.restore(),a.globalAlpha=1,a.fillStyle=C,a.beginPath(),a.moveTo(s-x/2,T),a.lineTo(s+x/2,T),a.lineTo(s+b/2,D),a.lineTo(s-b/2,D),a.closePath(),a.fill(),a.globalAlpha=m,R>.28&&!e.noTip){const L=A,F=Math.min(1,(R-.28)/.22)*m,k=S+L*.3;a.globalAlpha=F;const B={color:r(.95),glowColor:r(.85),glow:12*f};n.glyph&&(n.glyph(a,"LIFT_TIP",s,k,L,B)||n.glyph(a,"TIP_TRI",s,k,L*.93,B))||(a.strokeStyle=r(.95),a.lineWidth=13*c*d,a.lineCap="round",a.lineJoin="round",a.shadowColor=r(.9),a.shadowBlur=18*c*f,a.beginPath(),a.moveTo(s-26*c,k+14*c),a.lineTo(s,k-16*c),a.lineTo(s+26*c,k+14*c),a.stroke())}a.globalAlpha=1,a.shadowBlur=0}function S0(a,t,o,i,n,e,r={}){const u=e.lut,d=e.arrow||{},w=d.w??1,f=d.glow??1,p=o/256*(r.scale??1);a.clearRect(0,0,t,o);const l=i.map(([h,x])=>[h*t,x*o]);if(l.length<2)return;const c=48,s=[],v=h=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*h,l[0][1]+(l[1][1]-l[0][1])*h];const x=h*(l.length-1),b=Math.min(l.length-2,Math.floor(x)),A=x-b,P=l[Math.max(0,b-1)],D=l[b],C=l[b+1],L=l[Math.min(l.length-1,b+2)],F=(k,B,E,H)=>.5*(2*B+(-k+E)*A+(2*k-5*B+4*E-H)*A*A+(-k+3*B-3*E+H)*A*A*A);return[F(P[0],D[0],C[0],L[0]),F(P[1],D[1],C[1],L[1])]};for(let h=0;h<=c;h++)s.push(v(h/c));const R=Math.max(0,Math.min(1,r.prog!=null?r.prog:n*.55%1)),M=Math.max(1,Math.round(c*R)),m=r.alpha??1,T=r.tail??.22;a.lineCap="round";const y=42*p*(.7+.3*w);let S=M;if(R>.28){let h=0;const x=y*.42*Math.min(1,(R-.28)/.22);for(;S>1&&h<x;)h+=Math.hypot(s[S][0]-s[S-1][0],s[S][1]-s[S-1][1]),S--}for(const h of[0,1])for(let x=1;x<=S;x++){const b=x/M,A=Math.min(1,b/T),P=A*A*(3-2*A)*m;a.globalAlpha=h?P:P*.16*b,a.strokeStyle=u(.55+.42*b),a.lineWidth=(1.1+11.9*b)*p*w*(h?1:1.9),a.beginPath(),a.moveTo(s[x-1][0],s[x-1][1]),a.lineTo(s[x][0],s[x][1]),a.stroke()}if(R>.28){const h=s[Math.max(0,M-2)][0],x=s[Math.max(0,M-2)][1],b=Math.atan2(s[M][1]-x,s[M][0]-h)+Math.PI/2,A=s[M][0]-Math.sin(b)*y*.3,P=s[M][1]+Math.cos(b)*y*.3;a.save(),a.translate(A,P),a.rotate(b),a.globalAlpha=Math.min(1,(R-.28)/.22)*m;const D={color:u(.95),glowColor:u(.85),glow:12*f};e.glyph&&(e.glyph(a,"LIFT_TIP",0,0,y,D)||e.glyph(a,"TIP_TRI",0,0,y*.93,D))||(a.strokeStyle=u(.95),a.lineWidth=9*p*w,a.lineJoin="round",a.lineCap="round",a.beginPath(),a.moveTo(-18*p,12*p),a.lineTo(0,-14*p),a.lineTo(18*p,12*p),a.stroke()),a.restore()}a.globalAlpha=1}function c0(a,t,o,i,n,e){n=n||{};const r=e.lut,u=n.style||e.arrow.line,d=!!n.closed,w=[0];for(let c=1;c<t.length;c++)w.push(w[c-1]+Math.hypot(t[c][0]-t[c-1][0],t[c][1]-t[c-1][1]));const f=w[w.length-1]||1,p=c=>{c=(c%f+f)%f;let s=1;for(;s<w.length-1&&w[s]<c;)s++;const v=(c-w[s-1])/Math.max(1e-4,w[s]-w[s-1]);return[t[s-1][0]+(t[s][0]-t[s-1][0])*v,t[s-1][1]+(t[s][1]-t[s-1][1])*v,Math.atan2(t[s][1]-t[s-1][1],t[s][0]-t[s-1][0])]},l=e.arrow;if(u==="chevron"){const c=(26*i+8)*l.gap,s=Math.max(2,Math.floor(f/c));a.shadowColor=r(Math.min(1,l.heat+.2)),a.shadowBlur=8*i*l.glow;for(let v=0;v<s;v++){const R=v*c+o*42*l.speed%c;if(!d&&R>f-4)continue;const[M,m,T]=p(R),y=7.5*i,S=8.5*i,h=.45+.4*Math.sin(R/f*6.283-o*2.2*l.speed);a.strokeStyle=r(l.heat-.05+h*.3),a.lineWidth=3.2*i,a.lineJoin="round",a.lineCap="round",a.save(),a.translate(M,m),a.rotate(T),a.beginPath(),a.moveTo(-S*.5,-y),a.lineTo(S*.5,0),a.lineTo(-S*.5,y),a.stroke(),a.restore()}return!0}if(u==="comet"){const c=o*.35*l.speed%1*f,s=f*l.tail,v=Math.max(24,t.length*2);a.lineCap="round";for(let m=0;m<v;m++){const T=c-m/v*s,y=c-(m+1)/v*s;if(!d&&y<0)break;const S=1-m/v,[h,x]=p(T),[b,A]=p(y);!d&&Math.hypot(b-h,A-x)>f*.4||(a.globalAlpha=Math.pow(S,1.6),a.strokeStyle=r(Math.max(.05,l.heat-.2)+S*.55),a.lineWidth=(1.5+S*4.5)*i,S>.72?(a.shadowColor=r(Math.min(1,l.heat+.3)),a.shadowBlur=S*12*i*l.glow):a.shadowBlur=0,a.beginPath(),a.moveTo(h,x),a.lineTo(b,A),a.stroke())}a.globalAlpha=1,a.lineCap="butt",a.shadowBlur=0;const[R,M]=p(c);return a.fillStyle=rgba(K.ink,.95),a.shadowColor=r(.9),a.shadowBlur=16*i,a.beginPath(),a.arc(R,M,2.6*i,0,7),a.fill(),a.shadowBlur=0,!0}if(a.strokeStyle=n.color||r(l.heat),a.shadowColor=r(Math.min(1,l.heat+.15)),a.shadowBlur=(n.glow??8)*i*l.glow,u==="taper")for(let c=1;c<t.length;c++)a.lineWidth=(.5+c/t.length*4.5)*i,a.beginPath(),a.moveTo(t[c-1][0],t[c-1][1]),a.lineTo(t[c][0],t[c][1]),a.stroke();else x0(a,i,o,e),a.beginPath(),t.forEach(([c,s],v)=>v?a.lineTo(c,s):a.moveTo(c,s)),d&&a.closePath(),a.stroke();return a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,a.shadowBlur=0,!0}function G0(a,t,o,i,n,e){const r=13*i.halo,u=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const d=t/220,w=t/2,f=18*o.round*d,p=40*d,l=48*d,c=t-80*d,s=t-96*d,v=[],R=(m,T,y,S)=>{for(let h=0;h<=1;h+=.12)v.push([m+(y-m)*h,T+(S-T)*h])};R(p+f,l,p+c-f,l),R(p+c,l+f,p+c,l+s-f),R(p+c-f,l+s,p+f,l+s),R(p,l+s-f,p,l+f),a.shadowColor=u(.6),a.shadowBlur=r*.8;const M=4*e.arrow.w*d;if(e.arrow.line==="solid"?(a.setLineDash([10*o.dash*d,8*d]),a.lineDashOffset=-n*22*d,a.strokeStyle=u(.45),a.lineWidth=M,a.beginPath(),a.roundRect(p,l,c,s,f),a.stroke(),a.setLineDash([]),a.lineDashOffset=0):c0(a,v,n,e.arrow.w*d,{color:u(.45),closed:!0},e),o.prog!=null&&o.prog>.001){const m=[],T=(C,L,F,k,B)=>{for(let E=1;E<=B;E++)m.push([C+(F-C)*E/B,L+(k-L)*E/B])},y=(C,L,F,k,B)=>{for(let E=1;E<=B;E++){const H=F+(k-F)*E/B;m.push([C+f*Math.cos(H),L+f*Math.sin(H)])}},S=Math.PI/2,h=p+c,x=l+s,b=p+c/2;m.push([b,l]),T(b,l,h-f,l,8),y(h-f,l+f,-S,0,6),T(h,l+f,h,x-f,10),y(h-f,x-f,0,S,6),T(h-f,x,p+f,x,14),y(p+f,x-f,S,Math.PI,6),T(p,x-f,p,l+f,10),y(p+f,l+f,Math.PI,Math.PI+S,6),T(p+f,l,b,l,8);let A=0;for(let C=1;C<m.length;C++)A+=Math.hypot(m[C][0]-m[C-1][0],m[C][1]-m[C-1][1]);const P=A*Math.min(1,o.prog);a.save(),a.setLineDash([10*o.dash*d,8*d]),a.lineDashOffset=-(c/2-f)-n*22*d,a.strokeStyle=u(.9),a.lineWidth=M*1.3,a.lineCap="round",a.shadowColor=u(.92),a.shadowBlur=r*1.3,a.beginPath(),a.moveTo(m[0][0],m[0][1]);let D=0;for(let C=1;C<m.length&&D<P;C++){const L=Math.hypot(m[C][0]-m[C-1][0],m[C][1]-m[C-1][1]);if(D+L<=P)a.lineTo(m[C][0],m[C][1]),D+=L;else{const F=(P-D)/L;a.lineTo(m[C-1][0]+(m[C][0]-m[C-1][0])*F,m[C-1][1]+(m[C][1]-m[C-1][1])*F),D=P}}a.stroke(),a.setLineDash([]),a.restore()}o.feet>.05&&e.foot&&(e.foot(a,!1,w-16*o.feet*d,w+6*d,26*o.feet*d),e.foot(a,!0,w+16*o.feet*d,w+6*d,26*o.feet*d)),a.shadowBlur=0}function O0(a,t,o,i,n,e,r,u){const d=13*i.halo,w=4*e.arrow.w*(t/220),f=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const p=t/220,l=r||[[45*p,130*p],[110*p,60*p],[175*p,110*p]],c=u??n*.5%1,s=Math.min(1,c*1.25)*(l.length-1),v=Math.min(l.length-1,Math.floor(s+.35));a.shadowColor=f(.7),a.shadowBlur=d;const R=[[l[0][0],l[0][1]]];for(let S=1;S<=l.length-1;S++){const h=Math.max(0,Math.min(1,s-(S-1)));if(h<=0)break;R.push([l[S-1][0]+(l[S][0]-l[S-1][0])*h,l[S-1][1]+(l[S][1]-l[S-1][1])*h])}R.length>1&&c0(a,R,n,e.arrow.w*p,{color:f(.62)},e),a.setLineDash([]),a.lineDashOffset=0,a.globalAlpha=.5,a.strokeStyle=f(.55),a.lineWidth=w*.8,a.beginPath(),l.forEach(([S,h],x)=>x?a.lineTo(S,h):a.moveTo(S,h)),a.stroke(),a.globalAlpha=1,a.lineCap="butt";const M=o.done!=null,m=o.done||0,T=o.vd||[],y=o.acc!=null?o.acc:l.length-1;l.forEach(([S,h],x)=>{const b=x<m,A=T[x]||null,P=!b&&x===v&&!M,D=P?1+Math.sin(n*6)*.14:1,C=12*o.node*D*p*(x===y?1.34:1);b&&A!=="miss"&&(a.shadowBlur=d*1.4,a.shadowColor=f(.5),a.fillStyle=f(A==="near"?.5:.36),a.beginPath(),a.arc(S,h,C*.88,0,Math.PI*2),a.fill()),a.save(),a.translate(S,h),u0(a,f,C,b?.62:P?.8:.5,P?.9:b?.7:.5,w*.9,d),a.restore(),a.strokeStyle=A==="hit"?G.prism:A==="near"?G.sand:A==="miss"?K.lo:f(b?.62:P?.8:.45),a.lineWidth=w*(P?1.3:A?1.15:.9),a.shadowBlur=P?d*1.6:A&&A!=="miss"?d*1.3:d*.6,A&&A!=="miss"&&(a.shadowColor=A==="hit"?G.prism:G.sand),a.beginPath(),a.arc(S,h,C,0,Math.PI*2),a.stroke(),e.num&&(a.globalAlpha=x<=v||b?1:.45,e.num(a,String(x+1),S,h,16*o.numS*D*p,Math.round(14*o.numS*p)),a.globalAlpha=1)}),a.shadowBlur=0}function u0(a,t,o,i,n,e,r,u=1){if(o<=.6)return;const d=(c,s)=>t(c).replace("rgb(","rgba(").replace(")",`,${s})`),w=e*2.6*u,f=Math.max(.1,o-w),p=o+w,l=a.createRadialGradient(0,0,f,0,0,p);l.addColorStop(0,d(i-.05,0)),l.addColorStop(.5,d(i,n*.85)),l.addColorStop(1,d(i-.05,0)),a.globalAlpha=1,a.fillStyle=l,a.shadowBlur=0,a.beginPath(),a.arc(0,0,p,0,Math.PI*2),a.fill(),a.globalAlpha=Math.min(1,n*1.1),a.lineWidth=e*.85,a.strokeStyle=t(Math.min(.98,i+.12)),a.shadowColor=t(.88),a.shadowBlur=r*.6,a.beginPath(),a.arc(0,0,o,0,Math.PI*2),a.stroke(),a.shadowBlur=0}function U0(a,t,o,i,n,e,r){const u=e.lut,d=13*i.halo,w=t/220,f=t/2,p=e.arrow&&e.arrow.w||1,l=(h,x)=>u(h).replace("rgb(","rgba(").replace(")",`,${x})`);a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const c=(o.r!=null?o.r:.42)*t,s=c*(o.rt!=null?o.rt:.36),v=3.4*p*w,R=r!=null?Math.max(0,Math.min(1,r)):n*(o.tempo||.6)%1,M=Math.pow(R,1.6),m=Math.max(0,(R-.9)/.1);a.save(),a.translate(f,f);const T=(h,x,b,A=1)=>u0(a,u,h,x,b,v,d,A),y=a.createRadialGradient(0,0,0,0,0,s*1.08);y.addColorStop(0,l(.6,.1+.18*m)),y.addColorStop(.65,l(.5,.05+.08*m)),y.addColorStop(1,l(.5,0)),a.globalAlpha=1,a.fillStyle=y,a.beginPath(),a.arc(0,0,s*1.08,0,Math.PI*2),a.fill();const S=1+.02*Math.sin(n*2.6);T(s*S,.55+.4*m,.5+.45*m,.9);for(let h=2;h>=0;h--){const x=Math.pow(Math.max(0,R-h*.05),1.6),b=c-(c-s)*x,A=h===0?.6+.4*M:.18/h*(1-m);T(b,.55+.4*M,A*(1-m*.45),1.15-.35*M)}m>.01&&T(s*(1+1.4*m),.9,(1-m)*.8,1.1),a.globalAlpha=.6+.3*m,a.shadowColor=u(.85),a.shadowBlur=d*(.9+m),a.fillStyle=u(.62+.3*m),a.beginPath(),a.arc(0,0,v*.85+3*w*m,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}function H0(a,t,o,i,n,e,r,u){const d=e.lut,w=13*i.halo,f=t/220,p=t/2,l=e.arrow&&e.arrow.w||1,c=l*f,s=(I,_)=>d(I).replace("rgb(","rgba(").replace(")",","+_+")");a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const v=t*.42*(o.spread!=null?o.spread:1),M=(u||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([I,_])=>[p+I*v,p+_*v]),m=80,T=[];for(let I=0;I<=m;I++){const _=I/m*(M.length-1),O=Math.min(M.length-2,Math.floor(_)),U=_-O,q=M[Math.max(0,O-1)],$=M[O],N=M[O+1],a0=M[Math.min(M.length-1,O+2)],t0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*U+(2*X-5*J+4*Y-o0)*U*U+(-X+3*J-3*Y+o0)*U*U*U);T.push([t0(q[0],$[0],N[0],a0[0]),t0(q[1],$[1],N[1],a0[1])])}const y=I=>{const _=Math.max(0,Math.min(m,I*m)),O=Math.floor(_),U=_-O,q=T[O],$=T[Math.min(m,O+1)];return[q[0]+($[0]-q[0])*U,q[1]+($[1]-q[1])*U]},S=.68;let h,x,b;if(r!=null)h=Math.max(0,Math.min(1,r)),x=1,b=0;else{const I=n*(o.tempo||.42)%1;if(I<S)h=I/S,x=1,b=0;else{const _=(I-S)/(1-S);h=1,x=1-_*_,b=_}}if(x<=.012)return;const A=h*h*h*(h*(6*h-15)+10),P=Math.min(1,16*h*h*(1-h)*(1-h));o.taper!=null&&o.taper;const D=.36*(o.tail!=null?o.tail:1),C=o.width!=null?o.width:1;{const I=a.createLinearGradient(T[0][0],T[0][1],T[m][0],T[m][1]);I.addColorStop(0,s(.46,0)),I.addColorStop(.3,s(.46,.03*x)),I.addColorStop(.8,s(.46,.045*x)),I.addColorStop(1,s(.46,0)),a.globalAlpha=1,a.strokeStyle=I,a.lineWidth=9*c,a.shadowColor=d(.6),a.shadowBlur=w*2,a.beginPath(),T.forEach(([_,O],U)=>U?a.lineTo(_,O):a.moveTo(_,O)),a.stroke(),a.shadowBlur=0}const L=40,F=Math.max(0,A-D*(1-b)),k=[];for(let I=0;I<=L;I++)k.push(y(F+(A-F)*(I/L)));const B=()=>{a.beginPath(),k.forEach(([I,_],O)=>O?a.lineTo(I,_):a.moveTo(I,_)),a.stroke()},E=()=>{const I=a.createLinearGradient(k[0][0],k[0][1],k[L][0],k[L][1]);return I.addColorStop(0,s(.55,0)),I.addColorStop(.4,s(.56,0)),I.addColorStop(.68,s(.6,.09)),I.addColorStop(.88,s(.64,.24)),I.addColorStop(1,s(.68,.44)),I},H=1+.5*P;a.globalAlpha=x,a.strokeStyle=E(),a.lineWidth=(20+10*P)*c*C,a.shadowColor=d(.72),a.shadowBlur=w*2.2,B(),a.strokeStyle=E(),a.lineWidth=(10+5*P)*c*C,a.shadowBlur=w*1,B(),a.shadowBlur=0;for(let I=1;I<=L;I++){const _=I/L;a.globalAlpha=Math.pow(_,2.2)*.95*x,a.strokeStyle=d(.55+.38*_),a.lineWidth=(1.6+6.5*Math.pow(_,.7))*c*C*H,a.beginPath(),a.moveTo(k[I-1][0],k[I-1][1]),a.lineTo(k[I][0],k[I][1]),a.stroke()}const g=k[L][0],V=k[L][1];a.globalAlpha=.8*x,a.fillStyle=d(.6),a.shadowColor=d(.8),a.shadowBlur=w*1.6,a.beginPath(),a.arc(g,V,(9+5*P)*c*C,0,Math.PI*2),a.fill(),a.globalAlpha=x,a.fillStyle=d(.93),a.shadowBlur=w*.6,a.beginPath(),a.arc(g,V,(3.4+1.8*P)*c*C,0,Math.PI*2),a.fill(),a.globalAlpha=1,a.shadowBlur=0}function q0(a,t,o,i,n,e,r){const u=o.r!=null?o.r:.3,d=o.dir!=null?o.dir:1,w=(o.sweep!=null?o.sweep:.66)*Math.PI*2,f=r??n*(o.tempo!=null?o.tempo:.5)%1,p=-Math.PI/2+d*f*Math.PI*2,l=16,c=[];for(let s=0;s<=l;s++){const v=p-d*(1-s/l)*w;c.push([.5+Math.cos(v)*u,.5+Math.sin(v)*u])}S0(a,t,t,c,n,e,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}export{D0 as C,m0 as G,L0 as M,K as N,G as P,M0 as Q,_0 as R,T0 as S,R0 as Z,j as a,p0 as b,U0 as c,y0 as d,q0 as e,O0 as f,E0 as g,H0 as h,P0 as i,A0 as j,I0 as k,G0 as l,k0 as m,B0 as n,z as o,c0 as p,C0 as q,S0 as r,i0 as s,v0 as t,b0 as u,F0 as v,d0 as w,f0 as x};
