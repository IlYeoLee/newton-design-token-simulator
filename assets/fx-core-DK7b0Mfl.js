import{v as g,P as W,N as X}from"./palette-Bj20GXDn.js";const h0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다. 2026-08-05 유저: 발자국이 캡슐 광에 비해 흐리다 → 번짐 계열(blur/halo/pool)을 낮추고 코어(glow/dot/sharp)를 올려 쨍하게. 미세 조정은 footlab 슬라이더로.",u0=.98,f0=.83,p0=-.043,m0=-.031,w0=5.5,x0=.027,S0=.34,b0=.34,C0=.3,v0=.97,I0=.038,M0=1,R0=24,A0=1,y0=.95,L0=.3,T0=.7,P0=0,_0=.5,k0=.34,D0=.1,F0=.4,B0=1,E0=1.4,G0=0,O0=3.4,U0=.01,H0=0,W0=.011,q0=-2,g0=.75,K0=-.07,$0=.12,X0=4,j0=.6,J0=4,Y0=1,z0="drop",Q0="add",Z0="offbit",V0=.55,N0=.14,aa=.26,ta=4,oa=4,ea=1,la=.32,na=1,sa={punchLine:{node:1.58,numS:1,comet:1,tailLen:.71,rail:.6}},ra=-.095,ia=.12,ca=10,da=-.015,ha=.12,ua=-10,fa={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15},pa=1,ma=4,wa={tap:{op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15}},xa=1.45,Sa=.12,ba=.55,Ca={_:h0,imp:u0,scale:f0,offx:p0,offy:m0,irot:w0,pitch:x0,dot:S0,glow:b0,shade:C0,sharp:v0,edge:I0,plantar:M0,bands:R0,bandSoft:A0,w:y0,halo:L0,pool:T0,noise:P0,rip:_0,ripReach:k0,ripWidth:D0,ripSpeed:F0,ripGrad:B0,edgeShade:E0,shadeRed:G0,shadeRedW:O0,edgeW:U0,edgeSoft:H0,dither:W0,tilt:q0,gsize:g0,gx:K0,gy:$0,grot:X0,gsh:j0,shadeCol:J0,ripCol:Y0,gShadow:z0,gBlend:Q0,numSrc:Z0,prog:V0,bloom:N0,blur:aa,edgeShadeW:ta,edgeShadeCol:oa,edgeShadeGrad:ea,edgeShadeG0:la,edgeShadeG1:na,prims:sa,gxL:ra,gyL:ia,grotL:ca,gxR:da,gyR:ha,grotR:ua,tap:fa,op:pa,dotCol:ma,states:wa,loadGain:xa,loadBase:Sa,flow:ba};function l0(a,t,o,c,s){let l=0;o[0]=0,c[0]=-1e20,c[1]=1e20;for(let r=1;r<s;r++){let u=(a[r]+r*r-(a[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);for(;u<=c[l];)l--,u=(a[r]+r*r-(a[o[l]]+o[l]*o[l]))/(2*r-2*o[l]);l++,o[l]=r,c[l]=u,c[l+1]=1e20}l=0;for(let r=0;r<s;r++){for(;c[l+1]<r;)l++;t[r]=(r-o[l])*(r-o[l])+a[o[l]]}}function n0(a,t){const o=new Float32Array(t),c=new Int32Array(t),s=new Float32Array(t+1),l=new Float32Array(t);for(let r=0;r<t;r++){for(let u=0;u<t;u++)l[u]=a[u*t+r];l0(l,o,c,s,t);for(let u=0;u<t;u++)a[u*t+r]=o[u]}for(let r=0;r<t;r++){for(let u=0;u<t;u++)l[u]=a[r*t+u];l0(l,o,c,s,t);for(let u=0;u<t;u++)a[r*t+u]=o[u]}}function i0(a,t){const c=new Float32Array(t*t),s=new Float32Array(t*t);let l=0,r=0,u=0;for(let b=0;b<t*t;b++){const h=a[b*4+3]/255;c[b]=h>=1?0:h<=0?1e20:Math.pow(Math.max(0,.5-h),2),s[b]=h>=1?1e20:h<=0?0:Math.pow(Math.max(0,h-.5),2),h>.5&&(l+=b%t,r+=b/t|0,u++)}n0(c,t),n0(s,t);const f=new Float32Array(t*t);for(let b=0;b<t*t;b++)f[b]=(Math.sqrt(c[b])-Math.sqrt(s[b]))/t;return{data:f,N:t,cx:u?l/u/t:.5,cy:u?r/u/t:.5}}function Z(a,t=512){const o="_raster"+t;if(a[o])return a[o];const c=document.createElement("canvas");c.width=c.height=t;const s=c.getContext("2d"),l=Math.min(t/a.naturalWidth,t/a.naturalHeight);s.drawImage(a,0,0,a.naturalWidth*l,a.naturalHeight*l);const r=s.getImageData(0,0,t,t).data;let u=t,f=t,b=-1,h=-1;for(let d=0;d<t;d++)for(let e=0;e<t;e++)r[(d*t+e)*4+3]>8&&(e<u&&(u=e),e>b&&(b=e),d<f&&(f=d),d>h&&(h=d));return a[o]=b<0?{canvas:c,x:0,y:0,w:t,h:t}:{canvas:c,x:u,y:f,w:b-u+1,h:h-f+1},a[o]}function La(a,t,o=!1){const c=Z(a,t),s=document.createElement("canvas");s.width=s.height=t;const l=s.getContext("2d"),r=Math.min(t*$/c.w,t*$/c.h),u=c.w*r,f=c.h*r;return o&&(l.translate(0,t),l.scale(1,-1)),l.drawImage(c.canvas,c.x,c.y,c.w,c.h,(t-u)/2,(t-f)/2,u,f),i0(l.getImageData(0,0,t,t).data,t)}function Ta(a,t,o,c=!1){const s=Z(a,o),l=t?Z(t,o):null,r=Math.min(o*$/s.w,o*$/s.h),u=s.w*r,f=s.h*r,b=(o-u)/2,h=(o-f)/2,d=M=>{const P=document.createElement("canvas");P.width=P.height=o;const y=P.getContext("2d");return c&&(y.translate(0,o),y.scale(1,-1)),y.drawImage(M.canvas,s.x,s.y,s.w,s.h,b,h,u,f),i0(y.getImageData(0,0,o,o).data,o)},e=d(s),i=l?d(l):null,n=new Float32Array(o*o*2);for(let M=0;M<o*o;M++)n[M*2]=e.data[M],n[M*2+1]=i?i.data[M]:1;return{data:n,N:o,cx:e.cx,cy:e.cy,inCx:i?i.cx:e.cx,inCy:i?i.cy:e.cy,hasInner:!!i}}const Pa=1.9922,va=.78,$=.52,_a=va/$,ka=1.18,O=Ca||{},c0={size:O.gsize??.85,gx:O.gx??-.025,gy:O.gy??.195,rot:O.grot??6,gxL:O.gxL,gyL:O.gyL,rotL:O.grotL,gxR:O.gxR,gyR:O.gyR,rotR:O.grotR,shadow:O.gShadow??"glow",shadowK:O.gsh??.75,blend:O.gBlend??"add"};function Da(a,t=c0){return a?{gx:t.gxR??-t.gx,gy:t.gyR??t.gy,rot:t.rotR??-t.rot}:{gx:t.gxL??t.gx,gy:t.gyL??t.gy,rot:t.rotL??t.rot}}function Fa(a,t,o,c,s=c0){const l=Math.round(o*.75),r=s.shadow==="none"?0:s.shadowK??.75,u=f=>c(a,String(t),o/2,o/2,l,f);return s.shadow==="drop"&&r>.001?(a.save(),a.globalAlpha=Math.min(1,r*.7),a.translate(o*.018,o*.024),u({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),a.restore(),u({glow:0,glowColor:"rgba(0,0,0,0)"})):u(s.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),s.blend==="knock"}function Ba(a,t){const o=a.getImageData(0,0,t,t),c=a.createImageData(t,t);for(let s=0;s<t*t;s++){const l=o.data[s*4+3]/255,r=Math.round(255*(1-l));c.data[s*4]=c.data[s*4+1]=c.data[s*4+2]=r,c.data[s*4+3]=255}a.putImageData(c,0,0)}const Ea={RATIO:140/600,opacity(a){return a===0?.5:a===2||a===4?0:1},anchor(a,t,o){return{x:((t?1-a.x:a.x)-.5)*o,y:(.5-a.y)*o,s:a.s||1}}},z=a=>(a/=255,a<=.04045?a/12.92:Math.pow((a+.055)/1.055,2.4)),Q=a=>(a=Math.max(0,Math.min(1,a)),Math.round(255*(a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055)));function s0(a,t,o){a=z(a),t=z(t),o=z(o);const c=Math.cbrt(.4122214708*a+.5363325363*t+.0514459929*o),s=Math.cbrt(.2119034982*a+.6806995451*t+.1073969566*o),l=Math.cbrt(.0883024619*a+.2817188376*t+.6299787005*o);return[.2104542553*c+.793617785*s-.0040720468*l,1.9779984951*c-2.428592205*s+.4505937099*l,.0259040371*c+.7827717662*s-.808675766*l]}function Ia(a,t,o){const c=(a+.3963377774*t+.2158037573*o)**3,s=(a-.1055613458*t-.0638541728*o)**3,l=(a-.0894841775*t-1.291485548*o)**3;return[Q(4.0767416621*c-3.3077115913*s+.2309699292*l),Q(-1.2684380046*c+2.6097574011*s-.3413193965*l),Q(-.0041960863*c-.7034186147*s+1.707614701*l)]}const r0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)];function Ga(a,t=1,o=new Uint8Array(256*4)){const c=[...a].sort((s,l)=>s[1]-l[1]);for(let s=0;s<256;s++){const l=s/255;let r=0;for(;r<c.length-2&&l>c[r+1][1];)r++;const[u,f]=c[r],[b,h]=c[r+1],d=Math.max(0,Math.min(1,(l-f)/Math.max(1e-5,h-f))),e=s0(...r0(u)),i=s0(...r0(b)),n=Ia(e[0]+(i[0]-e[0])*d,(e[1]+(i[1]-e[1])*d)*t,(e[2]+(i[2]-e[2])*d)*t);o.set([...n,255],s*4)}return o}const Oa=`
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function Ma(a,t,o,c){a.lineWidth=4*t;const s=c.arrow;s.line==="dash"?a.setLineDash([12*t*s.gap,10*s.gap]):s.line==="dot"?(a.setLineDash([.5,12*s.gap]),a.lineCap="round",a.lineWidth=5*t):a.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(a.lineDashOffset=-o*40*s.speed)}function qa(a,t,o,c,s,l={}){const r=s.lut,u=s.arrow||{},f=u.w??1,b=u.speed??1,h=u.glow??1,d=l.pulse??1,e=o/256,i=e*(l.scale??1),n=t/2,M=c*.9*b%1,P=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,M/.55),y=l.prog!=null?1:M>.88?(1-M)/.12:1;a.clearRect(0,0,t,o);const w=y*(.45+.55*d),R=o-24*e,_=58*e,T=R+(_-R)*P,x=(A,k)=>r(A).replace("rgb(","rgba(").replace(")",`,${k.toFixed(3)})`),p=1.1*i*f,m=13*i*f,S=42*i*(.7+.3*f),D=!l.noTip&&P>.28?Math.min(1,(P-.28)/.22)*S*.42:0,v=T+D,C=a.createLinearGradient(0,R,0,v);if(C.addColorStop(0,x(.55,0)),C.addColorStop(.18,x(.64,.3*w)),C.addColorStop(.4,x(.76,.8*w)),C.addColorStop(.65,x(.88,.98*w)),C.addColorStop(1,x(.97,w)),a.save(),a.filter=`blur(${7*i}px)`,a.globalAlpha=l.dots?.3:.55,a.fillStyle=C,l.dots){const A=Math.abs(v-R),k=Math.max(3,Math.round(A/(13*i)));for(let I=0;I<k;I++){const B=(I+.5)/k,E=R+(v-R)*B,U=(p/2+(m/2-p/2)*B)*1.5;a.beginPath(),a.arc(n,E,Math.max(1.4*i,U),0,Math.PI*2),a.fill()}}else a.beginPath(),a.moveTo(n-p,R),a.lineTo(n+p,R),a.lineTo(n+m*.95,v),a.lineTo(n-m*.95,v),a.closePath(),a.fill();if(a.restore(),a.globalAlpha=1,a.fillStyle=C,l.dots){const A=Math.abs(v-R),k=Math.max(3,Math.round(A/(13*i)));for(let I=0;I<k;I++){const B=(I+.5)/k,E=R+(v-R)*B,U=(p/2+(m/2-p/2)*B)*.92;a.beginPath(),a.arc(n,E,Math.max(.9*i,U),0,Math.PI*2),a.fill()}}else a.beginPath(),a.moveTo(n-p/2,R),a.lineTo(n+p/2,R),a.lineTo(n+m/2,v),a.lineTo(n-m/2,v),a.closePath(),a.fill();if(a.globalAlpha=w,P>.28&&!l.noTip){const A=S,k=Math.min(1,(P-.28)/.22)*w,I=T+A*.3;a.globalAlpha=k;const B={color:r(.95),glowColor:r(.85),glow:12*h};s.glyph&&(s.glyph(a,"LIFT_TIP",n,I,A,B)||s.glyph(a,"TIP_TRI",n,I,A*.93,B))||(a.strokeStyle=r(.95),a.lineWidth=13*i*f,a.lineCap="round",a.lineJoin="round",a.shadowColor=r(.9),a.shadowBlur=18*i*h,a.beginPath(),a.moveTo(n-26*i,I+14*i),a.lineTo(n,I-16*i),a.lineTo(n+26*i,I+14*i),a.stroke())}a.globalAlpha=1,a.shadowBlur=0}function Ra(a,t,o,c,s,l,r={}){const u=l.lut,f=l.arrow||{},b=f.w??1,h=f.glow??1,d=o/256*(r.scale??1);a.clearRect(0,0,t,o);const e=c.map(([x,p])=>[x*t,p*o]);if(e.length<2)return;const i=48,n=[],M=x=>{if(e.length===2)return[e[0][0]+(e[1][0]-e[0][0])*x,e[0][1]+(e[1][1]-e[0][1])*x];const p=x*(e.length-1),m=Math.min(e.length-2,Math.floor(p)),S=p-m,D=e[Math.max(0,m-1)],v=e[m],C=e[m+1],A=e[Math.min(e.length-1,m+2)],k=(I,B,E,U)=>.5*(2*B+(-I+E)*S+(2*I-5*B+4*E-U)*S*S+(-I+3*B-3*E+U)*S*S*S);return[k(D[0],v[0],C[0],A[0]),k(D[1],v[1],C[1],A[1])]};for(let x=0;x<=i;x++)n.push(M(x/i));const P=Math.max(0,Math.min(1,r.prog!=null?r.prog:s*.55%1)),y=Math.max(1,Math.round(i*P)),w=r.alpha??1,R=r.tail??.22;a.lineCap="round";const _=42*d*(.7+.3*b);let T=y;if(P>.28){let x=0;const p=_*.42*Math.min(1,(P-.28)/.22);for(;T>1&&x<p;)x+=Math.hypot(n[T][0]-n[T-1][0],n[T][1]-n[T-1][1]),T--}for(const x of[0,1])for(let p=1;p<=T;p++){const m=p/y,S=Math.min(1,m/R),D=S*S*(3-2*S)*w;a.globalAlpha=x?D:D*.16*m,a.strokeStyle=u(.55+.42*m),a.lineWidth=(1.1+11.9*m)*d*b*(x?1:1.9),a.beginPath(),a.moveTo(n[p-1][0],n[p-1][1]),a.lineTo(n[p][0],n[p][1]),a.stroke()}if(P>.28){const x=n[Math.max(0,y-2)][0],p=n[Math.max(0,y-2)][1],m=Math.atan2(n[y][1]-p,n[y][0]-x)+Math.PI/2,S=n[y][0]-Math.sin(m)*_*.3,D=n[y][1]+Math.cos(m)*_*.3;a.save(),a.translate(S,D),a.rotate(m),a.globalAlpha=Math.min(1,(P-.28)/.22)*w;const v={color:u(.95),glowColor:u(.85),glow:12*h};l.glyph&&(l.glyph(a,"LIFT_TIP",0,0,_,v)||l.glyph(a,"TIP_TRI",0,0,_*.93,v))||(a.strokeStyle=u(.95),a.lineWidth=9*d*b,a.lineJoin="round",a.lineCap="round",a.beginPath(),a.moveTo(-18*d,12*d),a.lineTo(0,-14*d),a.lineTo(18*d,12*d),a.stroke()),a.restore()}a.globalAlpha=1}function Aa(a,t,o,c,s,l){s=s||{};const r=l.lut,u=s.style||l.arrow.line,f=!!s.closed,b=[0];for(let i=1;i<t.length;i++)b.push(b[i-1]+Math.hypot(t[i][0]-t[i-1][0],t[i][1]-t[i-1][1]));const h=b[b.length-1]||1,d=i=>{i=(i%h+h)%h;let n=1;for(;n<b.length-1&&b[n]<i;)n++;const M=(i-b[n-1])/Math.max(1e-4,b[n]-b[n-1]);return[t[n-1][0]+(t[n][0]-t[n-1][0])*M,t[n-1][1]+(t[n][1]-t[n-1][1])*M,Math.atan2(t[n][1]-t[n-1][1],t[n][0]-t[n-1][0])]},e=l.arrow;if(u==="chevron"){const i=(26*c+8)*e.gap,n=Math.max(2,Math.floor(h/i));a.shadowColor=r(Math.min(1,e.heat+.2)),a.shadowBlur=8*c*e.glow;for(let M=0;M<n;M++){const P=M*i+o*42*e.speed%i;if(!f&&P>h-4)continue;const[y,w,R]=d(P),_=7.5*c,T=8.5*c,x=.45+.4*Math.sin(P/h*6.283-o*2.2*e.speed);a.strokeStyle=r(e.heat-.05+x*.3),a.lineWidth=3.2*c,a.lineJoin="round",a.lineCap="round",a.save(),a.translate(y,w),a.rotate(R),a.beginPath(),a.moveTo(-T*.5,-_),a.lineTo(T*.5,0),a.lineTo(-T*.5,_),a.stroke(),a.restore()}return!0}if(u==="comet"){const i=o*.35*e.speed%1*h,n=h*e.tail,M=Math.max(24,t.length*2);a.lineCap="round";for(let w=0;w<M;w++){const R=i-w/M*n,_=i-(w+1)/M*n;if(!f&&_<0)break;const T=1-w/M,[x,p]=d(R),[m,S]=d(_);!f&&Math.hypot(m-x,S-p)>h*.4||(a.globalAlpha=Math.pow(T,1.6),a.strokeStyle=r(Math.max(.05,e.heat-.2)+T*.55),a.lineWidth=(1.5+T*4.5)*c,T>.72?(a.shadowColor=r(Math.min(1,e.heat+.3)),a.shadowBlur=T*12*c*e.glow):a.shadowBlur=0,a.beginPath(),a.moveTo(x,p),a.lineTo(m,S),a.stroke())}a.globalAlpha=1,a.lineCap="butt",a.shadowBlur=0;const[P,y]=d(i);return a.fillStyle=rgba(X.ink,.95),a.shadowColor=r(.9),a.shadowBlur=16*c,a.beginPath(),a.arc(P,y,2.6*c,0,7),a.fill(),a.shadowBlur=0,!0}if(a.strokeStyle=s.color||r(e.heat),a.shadowColor=r(Math.min(1,e.heat+.15)),a.shadowBlur=(s.glow??8)*c*e.glow,u==="taper")for(let i=1;i<t.length;i++)a.lineWidth=(.5+i/t.length*4.5)*c,a.beginPath(),a.moveTo(t[i-1][0],t[i-1][1]),a.lineTo(t[i][0],t[i][1]),a.stroke();else Ma(a,c,o,l),a.beginPath(),t.forEach(([i,n],M)=>M?a.lineTo(i,n):a.moveTo(i,n)),f&&a.closePath(),a.stroke();return a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,a.shadowBlur=0,!0}function ga(a,t,o,c,s,l){const r=13*c.halo,u=l.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const f=t/220,b=t/2,h=18*o.round*f,d=40*f,e=48*f,i=t-80*f,n=t-96*f,M=[],P=(w,R,_,T)=>{for(let x=0;x<=1;x+=.12)M.push([w+(_-w)*x,R+(T-R)*x])};P(d+h,e,d+i-h,e),P(d+i,e+h,d+i,e+n-h),P(d+i-h,e+n,d+h,e+n),P(d,e+n-h,d,e+h),a.shadowColor=u(.6),a.shadowBlur=r*.8;const y=4*l.arrow.w*f;if(l.arrow.line==="solid"?(a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-s*22*f,a.strokeStyle=u(.45),a.lineWidth=y,a.beginPath(),a.roundRect(d,e,i,n,h),a.stroke(),a.setLineDash([]),a.lineDashOffset=0):Aa(a,M,s,l.arrow.w*f,{color:u(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const w=[],R=(C,A,k,I,B)=>{for(let E=1;E<=B;E++)w.push([C+(k-C)*E/B,A+(I-A)*E/B])},_=(C,A,k,I,B)=>{for(let E=1;E<=B;E++){const U=k+(I-k)*E/B;w.push([C+h*Math.cos(U),A+h*Math.sin(U)])}},T=Math.PI/2,x=d+i,p=e+n,m=d+i/2;w.push([m,e]),R(m,e,x-h,e,8),_(x-h,e+h,-T,0,6),R(x,e+h,x,p-h,10),_(x-h,p-h,0,T,6),R(x-h,p,d+h,p,14),_(d+h,p-h,T,Math.PI,6),R(d,p-h,d,e+h,10),_(d+h,e+h,Math.PI,Math.PI+T,6),R(d+h,e,m,e,8);let S=0;for(let C=1;C<w.length;C++)S+=Math.hypot(w[C][0]-w[C-1][0],w[C][1]-w[C-1][1]);const D=S*Math.min(1,o.prog);a.save(),a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-(i/2-h)-s*22*f,a.strokeStyle=u(.9),a.lineWidth=y*1.3,a.lineCap="round",a.shadowColor=u(.92),a.shadowBlur=r*1.3,a.beginPath(),a.moveTo(w[0][0],w[0][1]);let v=0;for(let C=1;C<w.length&&v<D;C++){const A=Math.hypot(w[C][0]-w[C-1][0],w[C][1]-w[C-1][1]);if(v+A<=D)a.lineTo(w[C][0],w[C][1]),v+=A;else{const k=(D-v)/A;a.lineTo(w[C-1][0]+(w[C][0]-w[C-1][0])*k,w[C-1][1]+(w[C][1]-w[C-1][1])*k),v=D}}a.stroke(),a.setLineDash([]),a.restore()}o.feet>.05&&l.foot&&(l.foot(a,!1,b-16*o.feet*f,b+6*f,26*o.feet*f),l.foot(a,!0,b+16*o.feet*f,b+6*f,26*o.feet*f)),a.shadowBlur=0}function Ka(a,t,o,c,s,l,r,u){const f=13*c.halo,b=4*l.arrow.w*(t/220),h=l.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const d=t/220,e=r||[[45*d,130*d],[110*d,60*d],[175*d,110*d]],i=u??s*.5%1,n=Math.min(1,i*1.25)*(e.length-1),M=Math.min(e.length-1,Math.floor(n+.35));a.shadowColor=h(.7),a.shadowBlur=f;const P=p=>{const m=Math.max(0,Math.min(e.length-2,Math.floor(p))),S=p-m;return[e[m][0]+(e[m+1][0]-e[m][0])*S,e[m][1]+(e[m+1][1]-e[m][1])*S]},y=o.comet!=null?o.comet:1,w=o.tailLen!=null?o.tailLen:.5;if(a.save(),a.shadowBlur=0,a.globalAlpha=o.rail!=null?o.rail:.22,a.strokeStyle=h(.6),a.lineWidth=2.2*d,a.lineCap="round",a.setLineDash([.01,8*d]),a.beginPath(),e.forEach(([p,m],S)=>S?a.lineTo(p,m):a.moveTo(p,m)),a.stroke(),a.setLineDash([]),a.restore(),n>.02){const p=(m,S)=>h(m).replace("rgb(","rgba(").replace(")",`,${S.toFixed(3)})`);for(let m=0;m<26;m++){const S=m/25,D=n-w*S;if(D<=0)break;const v=P(D),C=4.7*d*y*(1-S*.75),A=C*2.1,k=(1-S)*(1-S)*.8,I=a.createRadialGradient(v[0],v[1],0,v[0],v[1],A);I.addColorStop(0,p(.55-.18*S,k)),I.addColorStop(.5,p(.5-.18*S,k*.35)),I.addColorStop(1,p(.45-.18*S,0)),a.save(),a.shadowBlur=0,a.globalAlpha=1,a.fillStyle=I,a.beginPath(),a.arc(v[0],v[1],A,0,Math.PI*2),a.fill(),a.restore()}if(n<e.length-1-.001&&n-Math.floor(n)>.03){const m=P(n);a.save(),a.fillStyle=h(.62),a.shadowColor=h(.8),a.shadowBlur=11*d*y,a.beginPath(),a.arc(m[0],m[1],5.6*d*y,0,Math.PI*2),a.fill(),a.fillStyle=h(.95),a.globalAlpha=.95,a.beginPath(),a.arc(m[0],m[1],2.1*d*y,0,Math.PI*2),a.fill(),a.restore()}}a.globalAlpha=1,a.lineCap="butt";const R=o.done!=null,_=o.done||0,T=o.vd||[],x=o.acc!=null?o.acc:e.length-1;if(e.forEach(([p,m],S)=>{const D=S<_,v=T[S]||null,C=!D&&S===M&&!R,A=C?1+Math.sin(s*6)*.14:1,k=o.pop!=null&&S===_-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,I=12*o.node*A*k*d*(S===x?1.34:1);D&&v!=="miss"&&(a.shadowBlur=f*1.4,a.shadowColor=h(.5),a.fillStyle=h(v==="near"?.5:.36),a.beginPath(),a.arc(p,m,I*.88,0,Math.PI*2),a.fill()),D||(a.save(),a.translate(p,m),d0(a,h,I,C?.8:.5,C?.9:.5,b*.9,f),a.restore()),a.strokeStyle=v==="hit"?W.prism:v==="near"?W.sand:v==="miss"?X.lo:h(D?.62:C?.8:.45),a.lineWidth=b*(C?1.3:v?1.15:.9),a.shadowBlur=C?f*1.6:v&&v!=="miss"?f*1.3:f*.6,v&&v!=="miss"&&(a.shadowColor=v==="hit"?W.prism:W.sand),a.beginPath(),a.arc(p,m,I,0,Math.PI*2),a.stroke(),l.num&&(D&&v!=="miss"?(a.save(),a.globalCompositeOperation="destination-out",a.shadowBlur=0,l.num(a,String(S+1),p,m,16*o.numS*A*d,Math.round(14*o.numS*d)),a.restore()):(a.globalAlpha=S<=M?1:.6,l.num(a,String(S+1),p,m,16*o.numS*A*d,Math.round(14*o.numS*d)),a.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&_>0&&e[_-1]){const[p,m]=e[_-1],S=1-o.pop/.38,D=S*S,v=12*o.node*d*(_-1===(o.acc!=null?o.acc:e.length-1)?1.34:1);a.save();const C=v*(1.6+1.9*(1-S)),A=a.createRadialGradient(p,m,0,p,m,C);A.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*D).toFixed(3)})`),A.addColorStop(.35,h(.92).replace("rgb(","rgba(").replace(")",`,${(.8*D).toFixed(3)})`)),A.addColorStop(1,h(.7).replace("rgb(","rgba(").replace(")",",0)")),a.fillStyle=A,a.beginPath(),a.arc(p,m,C,0,Math.PI*2),a.fill(),a.strokeStyle=h(.92),a.globalAlpha=D,a.lineWidth=Math.max(1,6*d*S),a.shadowColor=h(.85),a.shadowBlur=24*d*D,a.beginPath(),a.arc(p,m,v*(1.1+3.4*(1-S)),0,Math.PI*2),a.stroke();const k=Math.max(0,S-.35)/.65;k>0&&(a.globalAlpha=k*k*.6,a.lineWidth=Math.max(1,3.5*d*k),a.beginPath(),a.arc(p,m,v*(1.1+2*(1-k)),0,Math.PI*2),a.stroke()),a.restore()}a.shadowBlur=0}function d0(a,t,o,c,s,l,r,u=1){if(o<=.6)return;const f=(i,n)=>t(i).replace("rgb(","rgba(").replace(")",`,${n})`),b=l*2.6*u,h=Math.max(.1,o-b),d=o+b,e=a.createRadialGradient(0,0,h,0,0,d);e.addColorStop(0,f(c-.05,0)),e.addColorStop(.5,f(c,s*.85)),e.addColorStop(1,f(c-.05,0)),a.globalAlpha=1,a.fillStyle=e,a.shadowBlur=0,a.beginPath(),a.arc(0,0,d,0,Math.PI*2),a.fill(),a.globalAlpha=Math.min(1,s*1.1),a.lineWidth=l*.85,a.strokeStyle=t(Math.min(.98,c+.12)),a.shadowColor=t(.88),a.shadowBlur=r*.6,a.beginPath(),a.arc(0,0,o,0,Math.PI*2),a.stroke(),a.shadowBlur=0}function $a(a,t,o,c,s,l,r){const u=l.lut,f=13*c.halo,b=t/220,h=t/2,d=l.arrow&&l.arrow.w||1,e=(x,p)=>u(x).replace("rgb(","rgba(").replace(")",`,${p})`);a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const i=(o.r!=null?o.r:.42)*t,n=i*(o.rt!=null?o.rt:.36),M=3.4*d*b,P=r!=null?Math.max(0,Math.min(1,r)):s*(o.tempo||.6)%1,y=Math.pow(P,1.6),w=Math.max(0,(P-.9)/.1);a.save(),a.translate(h,h);const R=(x,p,m,S=1)=>d0(a,u,x,p,m,M,f,S),_=a.createRadialGradient(0,0,0,0,0,n*1.08);_.addColorStop(0,e(.6,.1+.18*w)),_.addColorStop(.65,e(.5,.05+.08*w)),_.addColorStop(1,e(.5,0)),a.globalAlpha=1,a.fillStyle=_,a.beginPath(),a.arc(0,0,n*1.08,0,Math.PI*2),a.fill();const T=1+.02*Math.sin(s*2.6);R(n*T,.55+.4*w,.5+.45*w,.9);for(let x=2;x>=0;x--){const p=Math.pow(Math.max(0,P-x*.05),1.6),m=i-(i-n)*p,S=x===0?.6+.4*y:.18/x*(1-w);R(m,.55+.4*y,S*(1-w*.45),1.15-.35*y)}w>.01&&R(n*(1+1.4*w),.9,(1-w)*.8,1.1),a.globalAlpha=.6+.3*w,a.shadowColor=u(.85),a.shadowBlur=f*(.9+w),a.fillStyle=u(.62+.3*w),a.beginPath(),a.arc(0,0,M*.85+3*b*w,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}function Xa(a,t,o,c,s,l,r,u){const f=l.lut,b=13*c.halo,h=t/220,d=t/2,e=l.arrow&&l.arrow.w||1,i=e*h,n=(L,F)=>f(L).replace("rgb(","rgba(").replace(")",","+F+")");a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const M=t*.42*(o.spread!=null?o.spread:1),y=(u||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([L,F])=>[d+L*M,d+F*M]),w=80,R=[];for(let L=0;L<=w;L++){const F=L/w*(y.length-1),G=Math.min(y.length-2,Math.floor(F)),H=F-G,q=y[Math.max(0,G-1)],K=y[G],a0=y[G+1],t0=y[Math.min(y.length-1,G+2)],o0=(j,J,Y,e0)=>.5*(2*J+(-j+Y)*H+(2*j-5*J+4*Y-e0)*H*H+(-j+3*J-3*Y+e0)*H*H*H);R.push([o0(q[0],K[0],a0[0],t0[0]),o0(q[1],K[1],a0[1],t0[1])])}const _=L=>{const F=Math.max(0,Math.min(w,L*w)),G=Math.floor(F),H=F-G,q=R[G],K=R[Math.min(w,G+1)];return[q[0]+(K[0]-q[0])*H,q[1]+(K[1]-q[1])*H]},T=.68;let x,p,m;if(r!=null)x=Math.max(0,Math.min(1,r)),p=1,m=0;else{const L=s*(o.tempo||.42)%1;if(L<T)x=L/T,p=1,m=0;else{const F=(L-T)/(1-T);x=1,p=1-F*F,m=F}}if(p<=.012)return;const S=x*x*x*(x*(6*x-15)+10),D=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const v=.36*(o.tail!=null?o.tail:1),C=o.width!=null?o.width:1;{const L=a.createLinearGradient(R[0][0],R[0][1],R[w][0],R[w][1]);L.addColorStop(0,n(.46,0)),L.addColorStop(.3,n(.46,.03*p)),L.addColorStop(.8,n(.46,.045*p)),L.addColorStop(1,n(.46,0)),a.globalAlpha=1,a.strokeStyle=L,a.lineWidth=9*i,a.shadowColor=f(.6),a.shadowBlur=b*2,a.beginPath(),R.forEach(([F,G],H)=>H?a.lineTo(F,G):a.moveTo(F,G)),a.stroke(),a.shadowBlur=0}const A=40,k=Math.max(0,S-v*(1-m)),I=[];for(let L=0;L<=A;L++)I.push(_(k+(S-k)*(L/A)));const B=()=>{a.beginPath(),I.forEach(([L,F],G)=>G?a.lineTo(L,F):a.moveTo(L,F)),a.stroke()},E=()=>{const L=a.createLinearGradient(I[0][0],I[0][1],I[A][0],I[A][1]);return L.addColorStop(0,n(.55,0)),L.addColorStop(.4,n(.56,0)),L.addColorStop(.68,n(.6,.09)),L.addColorStop(.88,n(.64,.24)),L.addColorStop(1,n(.68,.44)),L},U=1+.5*D;a.globalAlpha=p,a.strokeStyle=E(),a.lineWidth=(20+10*D)*i*C,a.shadowColor=f(.72),a.shadowBlur=b*2.2,B(),a.strokeStyle=E(),a.lineWidth=(10+5*D)*i*C,a.shadowBlur=b*1,B(),a.shadowBlur=0;for(let L=1;L<=A;L++){const F=L/A;a.globalAlpha=Math.pow(F,2.2)*.95*p,a.strokeStyle=f(.55+.38*F),a.lineWidth=(1.6+6.5*Math.pow(F,.7))*i*C*U,a.beginPath(),a.moveTo(I[L-1][0],I[L-1][1]),a.lineTo(I[L][0],I[L][1]),a.stroke()}const V=I[A][0],N=I[A][1];a.globalAlpha=.8*p,a.fillStyle=f(.6),a.shadowColor=f(.8),a.shadowBlur=b*1.6,a.beginPath(),a.arc(V,N,(9+5*D)*i*C,0,Math.PI*2),a.fill(),a.globalAlpha=p,a.fillStyle=f(.93),a.shadowBlur=b*.6,a.beginPath(),a.arc(V,N,(3.4+1.8*D)*i*C,0,Math.PI*2),a.fill(),a.globalAlpha=1,a.shadowBlur=0}function ja(a,t,o,c,s,l,r){const u=o.r!=null?o.r:.3,f=o.dir!=null?o.dir:1,b=(o.sweep!=null?o.sweep:.66)*Math.PI*2,h=r??s*(o.tempo!=null?o.tempo:.5)%1,d=-Math.PI/2+f*h*Math.PI*2,e=16,i=[];for(let n=0;n<=e;n++){const M=d-f*(1-n/e)*b;i.push([.5+Math.cos(M)*u,.5+Math.sin(M)*u])}Ra(a,t,t,i,s,l,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}function Ja(a,t,o,c,s,l,r={}){const u=Math.max(2,Math.round(r.count??7)),f=r.r??4.4,b=r.flow??.35,h=r.hair??.26,d=r.style||"chain",e=r.color||"255,246,234",i=r.inset??.12,n=r.alpha??1,M=c-t,P=s-o,y=Math.hypot(M,P);if(y<.001||n<=.004)return;const w=M/y,R=P/y,_=t+M*i,T=o+P*i,x=y*(1-i*2);if(x<=0)return;a.save(),d==="chain"&&h>0&&(a.strokeStyle=`rgba(${e},${(h*n).toFixed(3)})`,a.lineWidth=Math.max(1,f*.34),a.beginPath(),a.moveTo(_,T),a.lineTo(_+w*x,T+R*x),a.stroke());const p=l*b%1;for(let m=0;m<u;m++){let S=(m+.5)/u;if(d==="pulse"||d==="dots"||d==="chain"){const I=S-.5;if(S=.5+I+Math.sign(I)*(p/u%(1/u)),S<0||S>1)continue}const D=_+w*x*S,v=T+R*x*S,C=Math.abs(S-.5)*2;let A=f,k=n;if(d==="taper"&&(A=f*(.55+.75*C)),d==="pulse"){const I=((C-p)%1+1)%1;k=n*(.35+.65*Math.max(0,1-Math.abs(I-0)*3))}a.fillStyle=`rgba(${e},${(k*.96).toFixed(3)})`,a.beginPath(),a.arc(D,v,A,0,Math.PI*2),a.fill()}a.restore()}export{Ua as C,c0 as G,Ca as M,Ha as P,_a as Q,Oa as R,Pa as S,ka as Z,$ as a,va as b,Ea as c,Fa as d,$a as e,ja as f,qa as g,Xa as h,Ba as i,Ja as j,Ka as k,Ta as l,La as m,ga as n,Ga as o,Wa as p,Z as q,Aa as r,i0 as s,Ra as t,Da as u};
