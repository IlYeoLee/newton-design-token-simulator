const $={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},Z={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},d0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],Et=Object.fromEntries(Object.entries({...$,...Z}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),Q=t=>`vec3(${d0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,Gt=(t,a=1)=>`rgba(${d0(t).join(",")},${a})`,p0=[[$.red,0],[$.red,.3],[$.coral,.56],[$.sand,.86],[$.prism,1]],f0=1;function m0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(Z).some(o=>o.toUpperCase()===a)?!0:Object.values($).some(o=>o.toUpperCase()===a)}function Ht(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>m0(o)))&&(t.stops=p0.map(o=>[...o])),t.sat=f0,t)}const x0='MARK(발형·존원) 룩 정본 — 접지 룩(2026-08-07). 이전 정본은 mark-look-classic.json. footlab "코드에 저장"이 이 파일을 덮어쓴다.',w0=0,S0=.83,b0=-.043,C0=-.031,v0=5.5,A0=.027,y0=.25,M0=0,I0=0,T0=.74,L0=.09,R0=1,k0=0,P0=0,_0=1.6,F0=0,D0=.9,B0=0,E0=0,G0=.5,H0=.125,O0=.4,U0=1,W0=.38,q0=0,K0=3.4,$0=.035,z0=1,j0=0,X0=-2,g0=.8,J0=-.085,Y0=.16,Q0=4,Z0=.6,V0=1,N0=1,tt="glow",ot="add",at="offbit",et=.55,lt=.125,nt=0,st=1,rt=0,it=1,ct=.61,dt=1,ut={punchLine:{node:1,numS:1,comet:1,tailLen:.5,rail:.22}},ht=-.095,pt=.12,ft=10,mt=-.015,xt=.12,wt=-10,St={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15},bt=.98,Ct=1,vt={0:{sharp:0},1:{},2:{glow:0,halo:.16,w:.72,shade:0,imp:1,sharp:0,edge:.004},4:{glow:0,halo:.14,w:.7,shade:0,imp:1,edgeShadeGrad:0,pitch:.048,dot:.13,irot:21,dotCol:4,edge:.004,sharp:0,plantar:1,edgeShadeCol:4},tap:{op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:0,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15}},At=1.7,yt=.1,Mt=.55,It={_:"움직임 튜닝(markmotion.js 가 읽는다). 상태 8토큰과 직교 — 여기는 '어떻게 움직이나'만.",stepLead:.3,slideDecay:3,over:.14,overAt:.78,settle:.11,settleHz:2.4,popA:.16,popB:.18,popBAt:.11,airScale:.12,spawnDur:.44,hitDur:.34,arrowRamp:.16,arrowBreath:.06},Tt=0,Lt=0,Rt=0,kt={_:x0,imp:w0,scale:S0,offx:b0,offy:C0,irot:v0,pitch:A0,dot:y0,glow:M0,shade:I0,sharp:T0,edge:L0,plantar:R0,bands:k0,bandSoft:P0,w:_0,halo:F0,pool:D0,noise:B0,rip:E0,ripReach:G0,ripWidth:H0,ripSpeed:O0,ripGrad:U0,edgeShade:W0,shadeRed:q0,shadeRedW:K0,edgeW:$0,edgeSoft:z0,dither:j0,tilt:X0,gsize:g0,gx:J0,gy:Y0,grot:Q0,gsh:Z0,shadeCol:V0,ripCol:N0,gShadow:tt,gBlend:ot,numSrc:at,prog:et,bloom:lt,blur:nt,edgeShadeW:st,edgeShadeCol:rt,edgeShadeGrad:it,edgeShadeG0:ct,edgeShadeG1:dt,prims:ut,gxL:ht,gyL:pt,grotL:ft,gxR:mt,gyR:xt,grotR:wt,tap:St,op:bt,dotCol:Ct,states:vt,loadGain:At,loadBase:yt,flow:Mt,motion:It,tLo:Tt,tHi:Lt,dotMode:Rt};function s0(t,a,o,h,r){let e=0;o[0]=0,h[0]=-1e20,h[1]=1e20;for(let n=1;n<r;n++){let i=(t[n]+n*n-(t[o[e]]+o[e]*o[e]))/(2*n-2*o[e]);for(;i<=h[e];)e--,i=(t[n]+n*n-(t[o[e]]+o[e]*o[e]))/(2*n-2*o[e]);e++,o[e]=n,h[e]=i,h[e+1]=1e20}e=0;for(let n=0;n<r;n++){for(;h[e+1]<n;)e++;a[n]=(n-o[e])*(n-o[e])+t[o[e]]}}function r0(t,a){const o=new Float32Array(a),h=new Int32Array(a),r=new Float32Array(a+1),e=new Float32Array(a);for(let n=0;n<a;n++){for(let i=0;i<a;i++)e[i]=t[i*a+n];s0(e,o,h,r,a);for(let i=0;i<a;i++)t[i*a+n]=o[i]}for(let n=0;n<a;n++){for(let i=0;i<a;i++)e[i]=t[n*a+i];s0(e,o,h,r,a);for(let i=0;i<a;i++)t[n*a+i]=o[i]}}function u0(t,a){const h=new Float32Array(a*a),r=new Float32Array(a*a);let e=0,n=0,i=0;for(let v=0;v<a*a;v++){const p=t[v*4+3]/255;h[v]=p>=1?0:p<=0?1e20:Math.pow(Math.max(0,.5-p),2),r[v]=p>=1?1e20:p<=0?0:Math.pow(Math.max(0,p-.5),2),p>.5&&(e+=v%a,n+=v/a|0,i++)}r0(h,a),r0(r,a);const x=new Float32Array(a*a);for(let v=0;v<a*a;v++)x[v]=(Math.sqrt(h[v])-Math.sqrt(r[v]))/a;return{data:x,N:a,cx:i?e/i/a:.5,cy:i?n/i/a:.5}}function n0(t,a=512){const o="_raster"+a;if(t[o])return t[o];const h=document.createElement("canvas");h.width=h.height=a;const r=h.getContext("2d"),e=Math.min(a/t.naturalWidth,a/t.naturalHeight);r.drawImage(t,0,0,t.naturalWidth*e,t.naturalHeight*e);const n=r.getImageData(0,0,a,a).data;let i=a,x=a,v=-1,p=-1;for(let u=0;u<a;u++)for(let l=0;l<a;l++)n[(u*a+l)*4+3]>8&&(l<i&&(i=l),l>v&&(v=l),u<x&&(x=u),u>p&&(p=u));return t[o]=v<0?{canvas:h,x:0,y:0,w:a,h:a}:{canvas:h,x:i,y:x,w:v-i+1,h:p-x+1},t[o]}function Ot(t,a,o=!1){const h=n0(t,a),r=document.createElement("canvas");r.width=r.height=a;const e=r.getContext("2d"),n=Math.min(a*t0/h.w,a*t0/h.h),i=h.w*n,x=h.h*n;return o&&(e.translate(0,a),e.scale(1,-1)),e.drawImage(h.canvas,h.x,h.y,h.w,h.h,(a-i)/2,(a-x)/2,i,x),u0(e.getImageData(0,0,a,a).data,a)}function Ut(t,a,o,h=!1){const r=n0(t,o),e=a?n0(a,o):null,n=Math.min(o*t0/r.w,o*t0/r.h),i=r.w*n,x=r.h*n,v=(o-i)/2,p=(o-x)/2,u=k=>{const B=document.createElement("canvas");B.width=B.height=o;const I=B.getContext("2d");return h&&(I.translate(0,o),I.scale(1,-1)),I.drawImage(k.canvas,r.x,r.y,r.w,r.h,v,p,i,x),u0(I.getImageData(0,0,o,o).data,o)},l=u(r),d=e?u(e):null,s=new Float32Array(o*o*2);for(let k=0;k<o*o;k++)s[k*2]=l.data[k],s[k*2+1]=d?d.data[k]:1;return{data:s,N:o,cx:l.cx,cy:l.cy,inCx:d?d.cx:l.cx,inCy:d?d.cy:l.cy,hasInner:!!d}}const Wt=1.9922,Pt=.78,t0=.52,qt=Pt/t0,Kt=1.18,j=kt||{},h0={size:j.gsize??.85,gx:j.gx??-.025,gy:j.gy??.195,rot:j.grot??6,gxL:j.gxL,gyL:j.gyL,rotL:j.grotL,gxR:j.gxR,gyR:j.gyR,rotR:j.grotR,shadow:j.gShadow??"glow",shadowK:j.gsh??.75,blend:j.gBlend??"add"};function $t(t,a=h0){return t?{gx:a.gxR??-a.gx,gy:a.gyR??a.gy,rot:a.rotR??-a.rot}:{gx:a.gxL??a.gx,gy:a.gyL??a.gy,rot:a.rotL??a.rot}}function zt(t,a,o,h,r=h0){const e=Math.round(o*.75),n=r.shadow==="none"?0:r.shadowK??.75,i=x=>h(t,String(a),o/2,o/2,e,x);return r.shadow==="drop"&&n>.001?(t.save(),t.globalAlpha=Math.min(1,n*.7),t.translate(o*.018,o*.024),i({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),i({glow:0,glowColor:"rgba(0,0,0,0)"})):i(r.shadow==="glow"?{glow:26*n,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),r.blend==="knock"}function jt(t,a){const o=t.getImageData(0,0,a,a),h=t.createImageData(a,a);for(let r=0;r<a*a;r++){const e=o.data[r*4+3]/255,n=Math.round(255*(1-e));h.data[r*4]=h.data[r*4+1]=h.data[r*4+2]=n,h.data[r*4+3]=255}t.putImageData(h,0,0)}const Xt={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},e0=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),l0=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function i0(t,a,o){t=e0(t),a=e0(a),o=e0(o);const h=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),r=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),e=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*h+.793617785*r-.0040720468*e,1.9779984951*h-2.428592205*r+.4505937099*e,.0259040371*h+.7827717662*r-.808675766*e]}function _t(t,a,o){const h=(t+.3963377774*a+.2158037573*o)**3,r=(t-.1055613458*a-.0638541728*o)**3,e=(t-.0894841775*a-1.291485548*o)**3;return[l0(4.0767416621*h-3.3077115913*r+.2309699292*e),l0(-1.2684380046*h+2.6097574011*r-.3413193965*e),l0(-.0041960863*h-.7034186147*r+1.707614701*e)]}const c0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function gt(t,a=1,o=new Uint8Array(256*4)){const h=[...t].sort((r,e)=>r[1]-e[1]);for(let r=0;r<256;r++){const e=r/255;let n=0;for(;n<h.length-2&&e>h[n+1][1];)n++;const[i,x]=h[n],[v,p]=h[n+1],u=Math.max(0,Math.min(1,(e-x)/Math.max(1e-5,p-x))),l=i0(...c0(i)),d=i0(...c0(v)),s=_t(l[0]+(d[0]-l[0])*u,(l[1]+(d[1]-l[1])*u)*a,(l[2]+(d[2]-l[2])*u)*a);o.set([...s,255],r*4)}return o}const Jt=`
...
#define C_RED   ${Q($.red)}
#define C_CORAL ${Q($.coral)}
#define C_SAND  ${Q($.sand)}
#define C_ICE   ${Q($.prism)}
#define C_CREAM C_SAND
#define C_GRAYF ${Q(Z.hi)}
#define C_GRAYL ${Q(Z.lo)}
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function Ft(t,a,o,h){t.lineWidth=4*a;const r=h.arrow;r.line==="dash"?t.setLineDash([12*a*r.gap,10*r.gap]):r.line==="dot"?(t.setLineDash([.5,12*r.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&r.line!=="solid"&&r.line!=="taper"&&(t.lineDashOffset=-o*40*r.speed)}function Vt(t,a,o,h,r,e={}){const n=r.lut,i=r.arrow||{},x=i.w??1,v=i.speed??1,p=i.glow??1,u=e.pulse??1,l=o/256,d=l*(e.scale??1),s=a/2,k=h*.9*v%1,B=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,k/.55),I=e.prog!=null?1:k>.88?(1-k)/.12:1;t.clearRect(0,0,a,o);const f=I*(.45+.55*u),M=o-24*l,D=58*l,E=M+(D-M)*B,w=(P,c)=>n(P).replace("rgb(","rgba(").replace(")",`,${c.toFixed(3)})`),S=1.1*d*x,m=13*d*x,b=42*d*(.7+.3*x),R=!e.noTip&&B>.28?Math.min(1,(B-.28)/.22)*b*.42:0,L=E+R,A=t.createLinearGradient(0,M,0,L);A.addColorStop(0,w(.55,0)),A.addColorStop(.18,w(.64,.3*f)),A.addColorStop(.4,w(.76,.8*f)),A.addColorStop(.65,w(.88,.98*f)),A.addColorStop(1,w(.97,f));const F=e.dots?(()=>{const P=Math.abs(L-M),c=Math.max(3,Math.round(P/(9.5*d))),y=h*1.15*v%1,T=(H,O,C)=>{const _=Math.max(0,Math.min(1,(C-H)/(O-H)));return _*_*(3-2*_)},G=[];for(let H=0;H<c;H++){const O=((H+.5)/c+y/c)%1,C=1+.22*Math.sin((O*3-y*2)*Math.PI*2);G.push({y:M+(L-M)*O,r:(S/2+(m/2-S/2)*O)*C,a:(1-.35*T(.72,.92,O))*(1-T(.92,1,O))})}return G})():null;if(t.save(),t.filter=`blur(${7*d}px)`,t.globalAlpha=e.dots?.3:.55,t.fillStyle=A,e.dots){const P=t.globalAlpha;for(const c of F)t.globalAlpha=P*c.a,t.beginPath(),t.arc(s,c.y,Math.max(1.4*d,c.r*1.5),0,Math.PI*2),t.fill();t.globalAlpha=P}else t.beginPath(),t.moveTo(s-S,M),t.lineTo(s+S,M),t.lineTo(s+m*.95,L),t.lineTo(s-m*.95,L),t.closePath(),t.fill();if(t.restore(),t.globalAlpha=1,t.fillStyle=A,e.dots){for(const P of F)t.globalAlpha=P.a,t.beginPath(),t.arc(s,P.y,Math.max(.9*d,P.r*.92),0,Math.PI*2),t.fill();t.globalAlpha=1}else t.beginPath(),t.moveTo(s-S/2,M),t.lineTo(s+S/2,M),t.lineTo(s+m/2,L),t.lineTo(s-m/2,L),t.closePath(),t.fill();if(t.globalAlpha=f,B>.28&&!e.noTip){const P=b,c=Math.min(1,(B-.28)/.22)*f,y=E+P*.3;t.globalAlpha=c;const T={color:n(.95),glowColor:n(.85),glow:12*p};r.glyph&&(r.glyph(t,"LIFT_TIP",s,y,P,T)||r.glyph(t,"TIP_TRI",s,y,P*.93,T))||(t.strokeStyle=n(.95),t.lineWidth=13*d*x,t.lineCap="round",t.lineJoin="round",t.shadowColor=n(.9),t.shadowBlur=18*d*p,t.beginPath(),t.moveTo(s-26*d,y+14*d),t.lineTo(s,y-16*d),t.lineTo(s+26*d,y+14*d),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function Dt(t,a,o,h,r,e,n={}){const i=e.lut,x=e.arrow||{},v=x.w??1,p=x.glow??1,u=o/256*(n.scale??1);t.clearRect(0,0,a,o);const l=h.map(([w,S])=>[w*a,S*o]);if(l.length<2)return;const d=48,s=[],k=w=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*w,l[0][1]+(l[1][1]-l[0][1])*w];const S=w*(l.length-1),m=Math.min(l.length-2,Math.floor(S)),b=S-m,R=l[Math.max(0,m-1)],L=l[m],A=l[m+1],F=l[Math.min(l.length-1,m+2)],P=(c,y,T,G)=>.5*(2*y+(-c+T)*b+(2*c-5*y+4*T-G)*b*b+(-c+3*y-3*T+G)*b*b*b);return[P(R[0],L[0],A[0],F[0]),P(R[1],L[1],A[1],F[1])]};for(let w=0;w<=d;w++)s.push(k(w/d));const B=Math.max(0,Math.min(1,n.prog!=null?n.prog:r*.55%1)),I=Math.max(1,Math.round(d*B)),f=n.alpha??1,M=n.tail??.22;t.lineCap="round";const D=42*u*(.7+.3*v);let E=I;if(B>.28){let w=0;const S=D*.42*Math.min(1,(B-.28)/.22);for(;E>1&&w<S;)w+=Math.hypot(s[E][0]-s[E-1][0],s[E][1]-s[E-1][1]),E--}for(const w of[0,1])for(let S=1;S<=E;S++){const m=S/I,b=Math.min(1,m/M),R=b*b*(3-2*b)*f;t.globalAlpha=w?R:R*.16*m,t.strokeStyle=i(.55+.42*m),t.lineWidth=(1.1+11.9*m)*u*v*(w?1:1.9),t.beginPath(),t.moveTo(s[S-1][0],s[S-1][1]),t.lineTo(s[S][0],s[S][1]),t.stroke()}if(B>.28){const w=s[Math.max(0,I-2)][0],S=s[Math.max(0,I-2)][1],m=Math.atan2(s[I][1]-S,s[I][0]-w)+Math.PI/2,b=s[I][0]-Math.sin(m)*D*.3,R=s[I][1]+Math.cos(m)*D*.3;t.save(),t.translate(b,R),t.rotate(m),t.globalAlpha=Math.min(1,(B-.28)/.22)*f;const L={color:i(.95),glowColor:i(.85),glow:12*p};e.glyph&&(e.glyph(t,"LIFT_TIP",0,0,D,L)||e.glyph(t,"TIP_TRI",0,0,D*.93,L))||(t.strokeStyle=i(.95),t.lineWidth=9*u*v,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*u,12*u),t.lineTo(0,-14*u),t.lineTo(18*u,12*u),t.stroke()),t.restore()}t.globalAlpha=1}function Bt(t,a,o,h,r,e){r=r||{};const n=e.lut,i=r.style||e.arrow.line,x=!!r.closed,v=[0];for(let d=1;d<a.length;d++)v.push(v[d-1]+Math.hypot(a[d][0]-a[d-1][0],a[d][1]-a[d-1][1]));const p=v[v.length-1]||1,u=d=>{d=(d%p+p)%p;let s=1;for(;s<v.length-1&&v[s]<d;)s++;const k=(d-v[s-1])/Math.max(1e-4,v[s]-v[s-1]);return[a[s-1][0]+(a[s][0]-a[s-1][0])*k,a[s-1][1]+(a[s][1]-a[s-1][1])*k,Math.atan2(a[s][1]-a[s-1][1],a[s][0]-a[s-1][0])]},l=e.arrow;if(i==="chevron"){const d=(26*h+8)*l.gap,s=Math.max(2,Math.floor(p/d));t.shadowColor=n(Math.min(1,l.heat+.2)),t.shadowBlur=8*h*l.glow;for(let k=0;k<s;k++){const B=k*d+o*42*l.speed%d;if(!x&&B>p-4)continue;const[I,f,M]=u(B),D=7.5*h,E=8.5*h,w=.45+.4*Math.sin(B/p*6.283-o*2.2*l.speed);t.strokeStyle=n(l.heat-.05+w*.3),t.lineWidth=3.2*h,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(I,f),t.rotate(M),t.beginPath(),t.moveTo(-E*.5,-D),t.lineTo(E*.5,0),t.lineTo(-E*.5,D),t.stroke(),t.restore()}return!0}if(i==="comet"){const d=o*.35*l.speed%1*p,s=p*l.tail,k=Math.max(24,a.length*2);t.lineCap="round";for(let f=0;f<k;f++){const M=d-f/k*s,D=d-(f+1)/k*s;if(!x&&D<0)break;const E=1-f/k,[w,S]=u(M),[m,b]=u(D);!x&&Math.hypot(m-w,b-S)>p*.4||(t.globalAlpha=Math.pow(E,1.6),t.strokeStyle=n(Math.max(.05,l.heat-.2)+E*.55),t.lineWidth=(1.5+E*4.5)*h,E>.72?(t.shadowColor=n(Math.min(1,l.heat+.3)),t.shadowBlur=E*12*h*l.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(w,S),t.lineTo(m,b),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[B,I]=u(d);return t.fillStyle=rgba(Z.ink,.95),t.shadowColor=n(.9),t.shadowBlur=16*h,t.beginPath(),t.arc(B,I,2.6*h,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=r.color||n(l.heat),t.shadowColor=n(Math.min(1,l.heat+.15)),t.shadowBlur=(r.glow??8)*h*l.glow,i==="taper")for(let d=1;d<a.length;d++)t.lineWidth=(.5+d/a.length*4.5)*h,t.beginPath(),t.moveTo(a[d-1][0],a[d-1][1]),t.lineTo(a[d][0],a[d][1]),t.stroke();else Ft(t,h,o,e),t.beginPath(),a.forEach(([d,s],k)=>k?t.lineTo(d,s):t.moveTo(d,s)),x&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function Nt(t,a,o,h,r,e){const n=13*h.halo,i=e.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const x=a/220,v=a/2,p=18*o.round*x,u=40*x,l=48*x,d=a-80*x,s=a-96*x,k=[],B=(f,M,D,E)=>{for(let w=0;w<=1;w+=.12)k.push([f+(D-f)*w,M+(E-M)*w])};B(u+p,l,u+d-p,l),B(u+d,l+p,u+d,l+s-p),B(u+d-p,l+s,u+p,l+s),B(u,l+s-p,u,l+p),t.shadowColor=i(.6),t.shadowBlur=n*.8;const I=4*e.arrow.w*x;if(e.arrow.line==="solid"?(t.setLineDash([10*o.dash*x,8*x]),t.lineDashOffset=-r*22*x,t.strokeStyle=i(.45),t.lineWidth=I,t.beginPath(),t.roundRect(u,l,d,s,p),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):Bt(t,k,r,e.arrow.w*x,{color:i(.45),closed:!0},e),o.prog!=null&&o.prog>.001){const f=[],M=(A,F,P,c,y)=>{for(let T=1;T<=y;T++)f.push([A+(P-A)*T/y,F+(c-F)*T/y])},D=(A,F,P,c,y)=>{for(let T=1;T<=y;T++){const G=P+(c-P)*T/y;f.push([A+p*Math.cos(G),F+p*Math.sin(G)])}},E=Math.PI/2,w=u+d,S=l+s,m=u+d/2;f.push([m,l]),M(m,l,w-p,l,8),D(w-p,l+p,-E,0,6),M(w,l+p,w,S-p,10),D(w-p,S-p,0,E,6),M(w-p,S,u+p,S,14),D(u+p,S-p,E,Math.PI,6),M(u,S-p,u,l+p,10),D(u+p,l+p,Math.PI,Math.PI+E,6),M(u+p,l,m,l,8);let b=0;for(let A=1;A<f.length;A++)b+=Math.hypot(f[A][0]-f[A-1][0],f[A][1]-f[A-1][1]);const R=b*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*x,8*x]),t.lineDashOffset=-(d/2-p)-r*22*x,t.strokeStyle=i(.9),t.lineWidth=I*1.3,t.lineCap="round",t.shadowColor=i(.92),t.shadowBlur=n*1.3,t.beginPath(),t.moveTo(f[0][0],f[0][1]);let L=0;for(let A=1;A<f.length&&L<R;A++){const F=Math.hypot(f[A][0]-f[A-1][0],f[A][1]-f[A-1][1]);if(L+F<=R)t.lineTo(f[A][0],f[A][1]),L+=F;else{const P=(R-L)/F;t.lineTo(f[A-1][0]+(f[A][0]-f[A-1][0])*P,f[A-1][1]+(f[A][1]-f[A-1][1])*P),L=R}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&e.foot&&(e.foot(t,!1,v-16*o.feet*x,v+6*x,26*o.feet*x),e.foot(t,!0,v+16*o.feet*x,v+6*x,26*o.feet*x)),t.shadowBlur=0}function to(t,a,o,h,r,e,n,i){const x=13*h.halo,v=4*e.arrow.w*(a/220),p=e.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const u=a/220,l=n||[[45*u,130*u],[110*u,60*u],[175*u,110*u]],d=i??r*.5%1,s=Math.min(1,d*1.25)*(l.length-1),k=Math.min(l.length-1,Math.floor(s+.35));t.shadowColor=p(.7),t.shadowBlur=x;const B=S=>{const m=Math.max(0,Math.min(l.length-2,Math.floor(S))),b=S-m;return[l[m][0]+(l[m+1][0]-l[m][0])*b,l[m][1]+(l[m+1][1]-l[m][1])*b]},I=o.comet!=null?o.comet:1,f=o.tailLen!=null?o.tailLen:.5;if(t.save(),t.shadowBlur=0,t.globalAlpha=o.rail!=null?o.rail:.22,t.strokeStyle=p(.6),t.lineWidth=2.2*u,t.lineCap="round",t.setLineDash([.01,8*u]),t.beginPath(),l.forEach(([S,m],b)=>b?t.lineTo(S,m):t.moveTo(S,m)),t.stroke(),t.setLineDash([]),t.restore(),s>.02){const S=(m,b)=>p(m).replace("rgb(","rgba(").replace(")",`,${b.toFixed(3)})`);for(let m=0;m<26;m++){const b=m/25,R=s-f*b;if(R<=0)break;const L=B(R),A=4.7*u*I*(1-b*.75),F=A*2.1,P=(1-b)*(1-b)*.8,c=t.createRadialGradient(L[0],L[1],0,L[0],L[1],F);c.addColorStop(0,S(.55-.18*b,P)),c.addColorStop(.5,S(.5-.18*b,P*.35)),c.addColorStop(1,S(.45-.18*b,0)),t.save(),t.shadowBlur=0,t.globalAlpha=1,t.fillStyle=c,t.beginPath(),t.arc(L[0],L[1],F,0,Math.PI*2),t.fill(),t.restore()}if(s<l.length-1-.001&&s-Math.floor(s)>.03){const m=B(s);t.save(),t.fillStyle=p(.62),t.shadowColor=p(.8),t.shadowBlur=11*u*I,t.beginPath(),t.arc(m[0],m[1],5.6*u*I,0,Math.PI*2),t.fill(),t.fillStyle=p(.95),t.globalAlpha=.95,t.beginPath(),t.arc(m[0],m[1],2.1*u*I,0,Math.PI*2),t.fill(),t.restore()}}t.globalAlpha=1,t.lineCap="butt";const M=o.done!=null,D=o.done||0,E=o.vd||[],w=o.acc!=null?o.acc:l.length-1;if(l.forEach(([S,m],b)=>{const R=b<D,L=E[b]||null,A=!R&&b===k&&!M,F=A?1+Math.sin(r*6)*.14:1,P=o.pop!=null&&b===D-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,c=12*o.node*F*P*u*(b===w?1.34:1);R&&L!=="miss"&&(t.shadowBlur=x*1.4,t.shadowColor=p(.5),t.fillStyle=p(L==="near"?.5:.36),t.beginPath(),t.arc(S,m,c*.88,0,Math.PI*2),t.fill()),R||(t.save(),t.translate(S,m),N(t,p,c,A?.8:.5,A?.9:.5,v*.9,x),t.restore()),t.strokeStyle=L==="hit"?$.prism:L==="near"?$.sand:L==="miss"?Z.lo:p(R?.62:A?.8:.45),t.lineWidth=v*(A?1.3:L?1.15:.9),t.shadowBlur=A?x*1.6:L&&L!=="miss"?x*1.3:x*.6,L&&L!=="miss"&&(t.shadowColor=L==="hit"?$.prism:$.sand),t.beginPath(),t.arc(S,m,c,0,Math.PI*2),t.stroke(),e.num&&(R&&L!=="miss"?(t.save(),t.globalCompositeOperation="destination-out",t.shadowBlur=0,e.num(t,String(b+1),S,m,16*o.numS*F*u,Math.round(14*o.numS*u)),t.restore()):(t.globalAlpha=b<=k?1:.6,e.num(t,String(b+1),S,m,16*o.numS*F*u,Math.round(14*o.numS*u)),t.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&D>0&&l[D-1]){const[S,m]=l[D-1],b=1-o.pop/.38,R=b*b,L=12*o.node*u*(D-1===(o.acc!=null?o.acc:l.length-1)?1.34:1);t.save();const A=L*(1.6+1.9*(1-b)),F=t.createRadialGradient(S,m,0,S,m,A);F.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*R).toFixed(3)})`),F.addColorStop(.35,p(.92).replace("rgb(","rgba(").replace(")",`,${(.8*R).toFixed(3)})`)),F.addColorStop(1,p(.7).replace("rgb(","rgba(").replace(")",",0)")),t.fillStyle=F,t.beginPath(),t.arc(S,m,A,0,Math.PI*2),t.fill(),t.strokeStyle=p(.92),t.globalAlpha=R,t.lineWidth=Math.max(1,6*u*b),t.shadowColor=p(.85),t.shadowBlur=24*u*R,t.beginPath(),t.arc(S,m,L*(1.1+3.4*(1-b)),0,Math.PI*2),t.stroke();const P=Math.max(0,b-.35)/.65;P>0&&(t.globalAlpha=P*P*.6,t.lineWidth=Math.max(1,3.5*u*P),t.beginPath(),t.arc(S,m,L*(1.1+2*(1-P)),0,Math.PI*2),t.stroke()),t.restore()}t.shadowBlur=0}function N(t,a,o,h,r,e,n,i=1){if(o<=.6)return;const x=(d,s)=>a(d).replace("rgb(","rgba(").replace(")",`,${s})`),v=e*2.6*i,p=Math.max(.1,o-v),u=o+v,l=t.createRadialGradient(0,0,p,0,0,u);l.addColorStop(0,x(h-.05,0)),l.addColorStop(.5,x(h,r*.85)),l.addColorStop(1,x(h-.05,0)),t.globalAlpha=1,t.fillStyle=l,t.shadowBlur=0,t.beginPath(),t.arc(0,0,u,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,r*1.1),t.lineWidth=e*.85,t.strokeStyle=a(Math.min(.98,h+.12)),t.shadowColor=a(.88),t.shadowBlur=n*.6,t.beginPath(),t.arc(0,0,o,0,Math.PI*2),t.stroke(),t.shadowBlur=0}const a0=t=>1-Math.pow(1-Math.max(0,Math.min(1,t)),5);function oo(t,a,o,h,r,e){const n=e.lut,i=a/512,x=e.arrow&&e.arrow.w||1,v=(c,y)=>n(c).replace("rgb(","rgba(").replace(")",","+y+")"),p=(c,y)=>v(.86,c),u=4*x*i;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const l=o.mat||{nx:.86,fx:.86,ny:-.86,fy:.86},d=o.in==null?1:Math.max(0,Math.min(1,o.in)),s=a0(d/.45),k=c=>a0((d-.28-c*.09)/.42),B=o.hit==null?9:o.hit,I=B<.34?Math.sin(Math.PI*(B/.34)):0,f=c=>a/2+c*a/2,M=c=>a/2-c*a/2,D=(c,y)=>n(c).replace("rgb(","rgba(").replace(")",","+y+")"),E=(c,y,T,G,H,O,C)=>{t.font="700 "+G+'px "Supreme", sans-serif',t.textAlign="center",t.textBaseline="middle";const _=Array.from(String(c)),U=G*O;let W=-U;for(const K of _)W+=t.measureText(K).width+U;let q=y-W/2;t.fillStyle=H;for(const K of _){const X=t.measureText(K).width;t.fillText(K,q+X/2,T),q+=X+U}},w=.05*(o.round!=null?o.round/.35:1),S=(c,y,T,G)=>{};S(-l.fx+w,l.fy-w),S(-l.nx+w*.6,l.ny+w),S(l.nx-w*.6,l.ny+w),S(l.fx-w,l.fy-w);const m=o.center?o.center.x:0,b=o.center?o.center.y:0,R=(o.center&&o.center.r!=null?o.center.r:.26)*a/2*s*(1+.055*I+.008*Math.sin(r*2.4)),L=o.tgK==null?1:Math.max(0,Math.min(1,o.tgK)),A=L>.004?(o.targets||[]).slice().sort((c,y)=>(c.n||0)-(y.n||0)):[];if(A.length){t.save(),t.shadowBlur=0,t.globalAlpha=.22*a0(d/.9)*L,t.strokeStyle=n(.6),t.lineWidth=2.2*i,t.lineCap="round",t.setLineDash([.01,8*i]);const c=o.travel||{};for(const y of A){const T=f(y.x),G=M(y.y),H=f(m)-T,O=M(b)-G,C=c.k>0&&c.k<1&&(y.n===c.from||y.n===c.to),_=Math.hypot(H,O)||1,U=(y.r!=null?y.r:.13)*a/2*1.25,W=T+H/_*U,q=G+O/_*U,K=f(m)-H/_*R*1.12,X=M(b)-O/_*R*1.12;if(t.beginPath(),t.moveTo(W,q),t.lineTo(K,X),t.stroke(),I>.01){const z=1-I,J=.34,g=t.createLinearGradient(K,X,W,q),Y=(V,o0)=>g.addColorStop(Math.max(0,Math.min(1,V)),n(.85).replace("rgb(","rgba(").replace(")",","+o0+")"));Y(z-J,0),Y(z,.9*I),Y(z+J,0),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=g,t.lineWidth=3.4*i,t.stroke(),t.restore()}if(C){const z=t.createLinearGradient(W,q,K,X),J=Math.sin(Math.PI*c.k)*.85;z.addColorStop(0,n(.5).replace("rgb(","rgba(").replace(")",",0)")),z.addColorStop(.5,n(.9).replace("rgb(","rgba(").replace(")",","+J+")")),z.addColorStop(1,n(.5).replace("rgb(","rgba(").replace(")",",0)")),t.save(),t.setLineDash([]),t.globalAlpha=1,t.strokeStyle=z,t.lineWidth=3*i,t.stroke(),t.restore()}}t.setLineDash([]),t.restore()}const F=o.travel;if(F&&F.k>.001&&F.k<1){const c=A.find(T=>T.n===F.from),y=A.find(T=>T.n===F.to);if(c&&y){const T=f(c.x),G=M(c.y),H=f(y.x),O=M(y.y),C=f(m),_=M(b),U=a0(F.k),W=g=>g<.5?[T+(C-T)*(g/.5),G+(_-G)*(g/.5)]:[C+(H-C)*((g-.5)/.5),_+(O-_)*((g-.5)/.5)],[q,K]=W(U),[X,z]=W(Math.max(0,U-.28)),J=t.createLinearGradient(X,z,q,K);J.addColorStop(0,n(.5).replace("rgb(","rgba(").replace(")",",0)")),J.addColorStop(1,n(.85).replace("rgb(","rgba(").replace(")",",0.85)")),t.strokeStyle=J,t.lineWidth=3.2*i,t.lineCap="round",t.beginPath(),t.moveTo(X,z),t.lineTo(q,K),t.stroke(),t.fillStyle=n(.62),t.shadowColor=n(.8),t.shadowBlur=11*i,t.beginPath(),t.arc(q,K,5.6*i,0,Math.PI*2),t.fill(),t.fillStyle=n(.95),t.globalAlpha=.95,t.shadowBlur=0,t.beginPath(),t.arc(q,K,2.1*i,0,Math.PI*2),t.fill(),t.globalAlpha=1}}const P=13*h.halo;for(const c of o.railsOnly?[]:A){const y=c.on!==!1,T=!!c.live,G=k(c.n?c.n-1:0)*L;if(G<=.001)continue;const H=f(c.x),O=M(c.y),C=(c.r!=null?c.r:.13)*a/2*(T?1.34:1)*(.9+.1*G);t.globalAlpha=G*(y?1:.4),T?(t.shadowBlur=P*1.4,t.shadowColor=n(.5),t.fillStyle=n(.36),t.beginPath(),t.arc(H,O,C*.88,0,Math.PI*2),t.fill(),t.shadowBlur=P*1.6,t.strokeStyle=n(.8),t.lineWidth=u*1.3,t.beginPath(),t.arc(H,O,C,0,Math.PI*2),t.stroke(),t.shadowBlur=0,t.save(),t.globalCompositeOperation="destination-out",e.num(t,c.n,H,O,C*.9,Math.round(C*.72)),t.restore()):(t.save(),t.translate(H,O),N(t,n,C,.5,.42,u*.75,P*.6),t.restore(),t.strokeStyle=p(.5),t.lineWidth=u*.75,t.shadowBlur=P*.5,t.shadowColor=n(.5),t.beginPath(),t.arc(H,O,C,0,Math.PI*2),t.stroke(),t.shadowBlur=0,t.globalAlpha=G*.55,e.num(t,c.n,H,O,C*.9,Math.round(C*.66))),t.globalAlpha=1}if(o.center&&o.hit!=null){const c=f(m),y=M(b),T=13*h.halo,G=o.per||.4,H=Math.max(0,Math.min(1,B/G)),O=R*1.75,C=R*1.18,_=Math.min(1,Math.max(0,(Math.pow(H,1.6)-.58)/.42));for(let U=2;U>=0&&_<1;U--){const W=Math.pow(Math.max(0,H-U*.05),1.6),q=O-(O-C)*W,K=(U===0?.5+.4*W:.16/U)*(1-_);t.save(),t.translate(c,y),N(t,n,q,.5+.35*W,K,u*.7,T,1.15-.35*W),t.restore()}I>.01&&(t.save(),t.translate(c,y),N(t,n,R*(1+1.5*(1-I)),.92,I*.85,u*.8,T,1.1),t.restore())}if(o.center){const c=f(m),y=M(b),T=t.createRadialGradient(c,y,R*.1,c,y,R*1.35);if(T.addColorStop(0,D(.45,.07)),T.addColorStop(.62,D(.38,.025)),T.addColorStop(1,D(.3,0)),t.fillStyle=T,t.beginPath(),t.arc(c,y,R*1.35,0,Math.PI*2),t.fill(),o.center.ring!==0&&(t.strokeStyle=D(.3,.18),t.lineWidth=u*.5,t.beginPath(),t.arc(c,y,R,0,Math.PI*2),t.stroke()),o.brand&&e.logo&&e.logo.complete&&e.logo.naturalWidth){const G=R*.62,H=G*e.logo.naturalHeight/e.logo.naturalWidth;t.globalAlpha=.88*s,t.drawImage(e.logo,c-G/2,y-H/2,G,H),t.globalAlpha=1}if(o.center.label){const G=String(o.center.label).split(`
`);G.forEach((H,O)=>E(H,c,y+(O-(G.length-1)/2)*15*i,12*i,p(.9),.14))}}if(o.chev){const c=(y,T)=>{for(let G=0;G<2;G++){const H=G*9*i,O=11*i,C=7*i,_=y+T*H;t.beginPath(),t.moveTo(f(m)-O,_-T*C),t.lineTo(f(m),_),t.lineTo(f(m)+O,_-T*C),t.stroke()}};t.strokeStyle=p(.45+.3*Math.sin(r*2.4)),t.lineWidth=2.2*x*i,c(M(b)-R*2,-1),c(M(b)+R*2,1)}if(o.prog>.001&&o.center){const c=f(m),y=M(b),T=I;t.strokeStyle=D(.34,.9+.1*T),t.lineWidth=u*(.85+.5*T),t.lineCap="round",t.shadowColor=n(.42),t.shadowBlur=(10+16*T)*i,t.beginPath(),t.arc(c,y,R,-Math.PI/2,-Math.PI/2+Math.PI*2*Math.min(1,o.prog)),t.stroke(),t.shadowBlur=0}}function ao(t,a,o,h,r,e,n){const i=e.lut,x=13*h.halo,v=a/220,p=a/2,u=e.arrow&&e.arrow.w||1,l=(w,S)=>i(w).replace("rgb(","rgba(").replace(")",`,${S})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const d=(o.r!=null?o.r:.42)*a,s=d*(o.rt!=null?o.rt:.36),k=3.4*u*v,B=n!=null?Math.max(0,Math.min(1,n)):r*(o.tempo||.6)%1,I=Math.pow(B,1.6),f=Math.max(0,(B-.9)/.1);t.save(),t.translate(p,p);const M=(w,S,m,b=1)=>N(t,i,w,S,m,k,x,b),D=t.createRadialGradient(0,0,0,0,0,s*1.08);D.addColorStop(0,l(.6,.1+.18*f)),D.addColorStop(.65,l(.5,.05+.08*f)),D.addColorStop(1,l(.5,0)),t.globalAlpha=1,t.fillStyle=D,t.beginPath(),t.arc(0,0,s*1.08,0,Math.PI*2),t.fill();const E=1+.02*Math.sin(r*2.6);M(s*E,.55+.4*f,.5+.45*f,.9);for(let w=2;w>=0;w--){const S=Math.pow(Math.max(0,B-w*.05),1.6),m=d-(d-s)*S,b=w===0?.6+.4*I:.18/w*(1-f);M(m,.55+.4*I,b*(1-f*.45),1.15-.35*I)}f>.01&&M(s*(1+1.4*f),.9,(1-f)*.8,1.1),t.globalAlpha=.6+.3*f,t.shadowColor=i(.85),t.shadowBlur=x*(.9+f),t.fillStyle=i(.62+.3*f),t.beginPath(),t.arc(0,0,k*.85+3*v*f,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function eo(t,a,o,h,r,e,n,i){const x=e.lut,v=13*h.halo,p=a/220,u=a/2,l=e.arrow&&e.arrow.w||1,d=l*p,s=(C,_)=>x(C).replace("rgb(","rgba(").replace(")",","+_+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const k=a*.42*(o.spread!=null?o.spread:1),I=(i||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([C,_])=>[u+C*k,u+_*k]),f=80,M=[];for(let C=0;C<=f;C++){const _=C/f*(I.length-1),U=Math.min(I.length-2,Math.floor(_)),W=_-U,q=I[Math.max(0,U-1)],K=I[U],X=I[U+1],z=I[Math.min(I.length-1,U+2)],J=(g,Y,V,o0)=>.5*(2*Y+(-g+V)*W+(2*g-5*Y+4*V-o0)*W*W+(-g+3*Y-3*V+o0)*W*W*W);M.push([J(q[0],K[0],X[0],z[0]),J(q[1],K[1],X[1],z[1])])}const D=C=>{const _=Math.max(0,Math.min(f,C*f)),U=Math.floor(_),W=_-U,q=M[U],K=M[Math.min(f,U+1)];return[q[0]+(K[0]-q[0])*W,q[1]+(K[1]-q[1])*W]},E=.68;let w,S,m;if(n!=null)w=Math.max(0,Math.min(1,n)),S=1,m=0;else{const C=r*(o.tempo||.42)%1;if(C<E)w=C/E,S=1,m=0;else{const _=(C-E)/(1-E);w=1,S=1-_*_,m=_}}if(S<=.012)return;const b=w*w*w*(w*(6*w-15)+10),R=Math.min(1,16*w*w*(1-w)*(1-w));o.taper!=null&&o.taper;const L=.36*(o.tail!=null?o.tail:1),A=o.width!=null?o.width:1;{const C=t.createLinearGradient(M[0][0],M[0][1],M[f][0],M[f][1]);C.addColorStop(0,s(.46,0)),C.addColorStop(.3,s(.46,.03*S)),C.addColorStop(.8,s(.46,.045*S)),C.addColorStop(1,s(.46,0)),t.globalAlpha=1,t.strokeStyle=C,t.lineWidth=9*d,t.shadowColor=x(.6),t.shadowBlur=v*2,t.beginPath(),M.forEach(([_,U],W)=>W?t.lineTo(_,U):t.moveTo(_,U)),t.stroke(),t.shadowBlur=0}const F=40,P=Math.max(0,b-L*(1-m)),c=[];for(let C=0;C<=F;C++)c.push(D(P+(b-P)*(C/F)));const y=()=>{t.beginPath(),c.forEach(([C,_],U)=>U?t.lineTo(C,_):t.moveTo(C,_)),t.stroke()},T=()=>{const C=t.createLinearGradient(c[0][0],c[0][1],c[F][0],c[F][1]);return C.addColorStop(0,s(.55,0)),C.addColorStop(.4,s(.56,0)),C.addColorStop(.68,s(.6,.09)),C.addColorStop(.88,s(.64,.24)),C.addColorStop(1,s(.68,.44)),C},G=1+.5*R;t.globalAlpha=S,t.strokeStyle=T(),t.lineWidth=(20+10*R)*d*A,t.shadowColor=x(.72),t.shadowBlur=v*2.2,y(),t.strokeStyle=T(),t.lineWidth=(10+5*R)*d*A,t.shadowBlur=v*1,y(),t.shadowBlur=0;for(let C=1;C<=F;C++){const _=C/F;t.globalAlpha=Math.pow(_,2.2)*.95*S,t.strokeStyle=x(.55+.38*_),t.lineWidth=(1.6+6.5*Math.pow(_,.7))*d*A*G,t.beginPath(),t.moveTo(c[C-1][0],c[C-1][1]),t.lineTo(c[C][0],c[C][1]),t.stroke()}const H=c[F][0],O=c[F][1];t.globalAlpha=.8*S,t.fillStyle=x(.6),t.shadowColor=x(.8),t.shadowBlur=v*1.6,t.beginPath(),t.arc(H,O,(9+5*R)*d*A,0,Math.PI*2),t.fill(),t.globalAlpha=S,t.fillStyle=x(.93),t.shadowBlur=v*.6,t.beginPath(),t.arc(H,O,(3.4+1.8*R)*d*A,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function lo(t,a,o,h,r,e,n){const i=o.r!=null?o.r:.3,x=o.dir!=null?o.dir:1,v=(o.sweep!=null?o.sweep:.66)*Math.PI*2,p=n??r*(o.tempo!=null?o.tempo:.5)%1,u=-Math.PI/2+x*p*Math.PI*2,l=16,d=[];for(let s=0;s<=l;s++){const k=u-x*(1-s/l)*v;d.push([.5+Math.cos(k)*i,.5+Math.sin(k)*i])}Dt(t,a,a,d,r,e,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}function no(t,a,o,h,r,e,n={}){const i=Math.max(2,Math.round(n.count??7)),x=n.r??4.4,v=n.flow??.35,p=n.hair??.26,u=n.style||"chain",l=n.color||"255,246,234",d=n.inset??.12,s=n.alpha??1,k=h-a,B=r-o,I=Math.hypot(k,B);if(I<.001||s<=.004)return;const f=k/I,M=B/I,D=a+k*d,E=o+B*d,w=I*(1-d*2);if(w<=0)return;t.save(),u==="chain"&&p>0&&(t.strokeStyle=`rgba(${l},${(p*s).toFixed(3)})`,t.lineWidth=Math.max(1,x*.34),t.beginPath(),t.moveTo(D,E),t.lineTo(D+f*w,E+M*w),t.stroke());const S=e*v%1;for(let m=0;m<i;m++){let b=(m+.5)/i;if(u==="pulse"||u==="dots"||u==="chain"){const c=b-.5;if(b=.5+c+Math.sign(c)*(S/i%(1/i)),b<0||b>1)continue}const R=D+f*w*b,L=E+M*w*b,A=Math.abs(b-.5)*2;let F=x,P=s;if(u==="taper"&&(F=x*(.55+.75*A)),u==="pulse"){const c=((A-S)%1+1)%1;P=s*(.35+.65*Math.max(0,1-Math.abs(c-0)*3))}t.fillStyle=`rgba(${l},${(P*.96).toFixed(3)})`,t.beginPath(),t.arc(R,L,F,0,Math.PI*2),t.fill()}t.restore()}export{p0 as A,f0 as B,Yt as C,h0 as G,kt as M,Z as N,$ as P,qt as Q,Jt as R,Wt as S,Kt as Z,t0 as a,Pt as b,Xt as c,zt as d,ao as e,lo as f,Vt as g,eo as h,jt as i,oo as j,no as k,to as l,Ut as m,Ot as n,Nt as o,gt as p,Zt as q,n0 as r,u0 as s,Bt as t,Gt as u,Ht as v,Qt as w,Et as x,Dt as y,$t as z};
