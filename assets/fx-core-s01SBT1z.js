const E={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},W={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},r0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)],x0=Object.fromEntries(Object.entries({...E,...W}).map(([t,a])=>[t,parseInt(a.slice(1),16)])),q=t=>`vec3(${r0(t).map(o=>(o/255).toFixed(4)).join(", ")})`,S0=(t,a=1)=>`rgba(${r0(t).join(",")},${a})`,h0=[[E.red,0],[E.red,.3],[E.coral,.56],[E.sand,.86],[E.prism,1]],u0=1;function d0(t){const a=String(t).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(a)||Object.values(W).some(o=>o.toUpperCase()===a)?!0:Object.values(E).some(o=>o.toUpperCase()===a)}function C0(t){return t&&((!Array.isArray(t.stops)||!t.stops.every(([o])=>d0(o)))&&(t.stops=h0.map(o=>[...o])),t.sat=u0,t)}function e0(t,a,o,i,s){let l=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let c=1;c<s;c++){let r=(t[c]+c*c-(t[o[l]]+o[l]*o[l]))/(2*c-2*o[l]);for(;r<=i[l];)l--,r=(t[c]+c*c-(t[o[l]]+o[l]*o[l]))/(2*c-2*o[l]);l++,o[l]=c,i[l]=r,i[l+1]=1e20}l=0;for(let c=0;c<s;c++){for(;i[l+1]<c;)l++;a[c]=(c-o[l])*(c-o[l])+t[o[l]]}}function l0(t,a){const o=new Float32Array(a),i=new Int32Array(a),s=new Float32Array(a+1),l=new Float32Array(a);for(let c=0;c<a;c++){for(let r=0;r<a;r++)l[r]=t[r*a+c];e0(l,o,i,s,a);for(let r=0;r<a;r++)t[r*a+c]=o[r]}for(let c=0;c<a;c++){for(let r=0;r<a;r++)l[r]=t[c*a+r];e0(l,o,i,s,a);for(let r=0;r<a;r++)t[c*a+r]=o[r]}}function i0(t,a){const i=new Float32Array(a*a),s=new Float32Array(a*a);let l=0,c=0,r=0;for(let m=0;m<a*a;m++){const f=t[m*4+3]/255;i[m]=f>=1?0:f<=0?1e20:Math.pow(Math.max(0,.5-f),2),s[m]=f>=1?1e20:f<=0?0:Math.pow(Math.max(0,f-.5),2),f>.5&&(l+=m%a,c+=m/a|0,r++)}l0(i,a),l0(s,a);const d=new Float32Array(a*a);for(let m=0;m<a*a;m++)d[m]=(Math.sqrt(i[m])-Math.sqrt(s[m]))/a;return{data:d,N:a,cx:r?l/r/a:.5,cy:r?c/r/a:.5}}function z(t,a=512){const o="_raster"+a;if(t[o])return t[o];const i=document.createElement("canvas");i.width=i.height=a;const s=i.getContext("2d"),l=Math.min(a/t.naturalWidth,a/t.naturalHeight);s.drawImage(t,0,0,t.naturalWidth*l,t.naturalHeight*l);const c=s.getImageData(0,0,a,a).data;let r=a,d=a,m=-1,f=-1;for(let p=0;p<a;p++)for(let e=0;e<a;e++)c[(p*a+e)*4+3]>8&&(e<r&&(r=e),e>m&&(m=e),p<d&&(d=p),p>f&&(f=p));return t[o]=m<0?{canvas:i,x:0,y:0,w:a,h:a}:{canvas:i,x:r,y:d,w:m-r+1,h:f-d+1},t[o]}function A0(t,a,o=!1){const i=z(t,a),s=document.createElement("canvas");s.width=s.height=a;const l=s.getContext("2d"),c=Math.min(a*j/i.w,a*j/i.h),r=i.w*c,d=i.h*c;return o&&(l.translate(0,a),l.scale(1,-1)),l.drawImage(i.canvas,i.x,i.y,i.w,i.h,(a-r)/2,(a-d)/2,r,d),i0(l.getImageData(0,0,a,a).data,a)}function I0(t,a,o,i=!1){const s=z(t,o),l=a?z(a,o):null,c=Math.min(o*j/s.w,o*j/s.h),r=s.w*c,d=s.h*c,m=(o-r)/2,f=(o-d)/2,p=C=>{const v=document.createElement("canvas");v.width=v.height=o;const w=v.getContext("2d");return i&&(w.translate(0,o),w.scale(1,-1)),w.drawImage(C.canvas,s.x,s.y,s.w,s.h,m,f,r,d),i0(w.getImageData(0,0,o,o).data,o)},e=p(s),h=l?p(l):null,u=new Float32Array(o*o*2);for(let C=0;C<o*o;C++)u[C*2]=e.data[C],u[C*2+1]=h?h.data[C]:1;return{data:u,N:o,cx:e.cx,cy:e.cy,inCx:h?h.cx:e.cx,inCy:h?h.cy:e.cy,hasInner:!!h}}const T0=1.9922,f0=.78,j=.52,b0=f0/j,M0=1.18,p0={size:.85,gx:-.025,gy:.195,rot:6,shadow:"glow",shadowK:.75,blend:"add"};function v0(t,a,o,i,s=p0){const l=Math.round(o*.75),c=s.shadow==="none"?0:s.shadowK??.75,r=d=>i(t,String(a),o/2,o/2,l,d);return s.shadow==="drop"&&c>.001?(t.save(),t.globalAlpha=Math.min(1,c*.7),t.translate(o*.018,o*.024),r({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),t.restore(),r({glow:0,glowColor:"rgba(0,0,0,0)"})):r(s.shadow==="glow"?{glow:26*c,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),s.blend==="knock"}function R0(t,a){const o=t.getImageData(0,0,a,a),i=t.createImageData(a,a);for(let s=0;s<a*a;s++){const l=o.data[s*4+3]/255,c=Math.round(255*(1-l));i.data[s*4]=i.data[s*4+1]=i.data[s*4+2]=c,i.data[s*4+3]=255}t.putImageData(i,0,0)}const P0={RATIO:140/600,opacity(t){return t===0?.5:t===2||t===4?0:1},anchor(t,a,o){return{x:((a?1-t.x:t.x)-.5)*o,y:(.5-t.y)*o,s:t.s||1}}},Q=t=>(t/=255,t<=.04045?t/12.92:Math.pow((t+.055)/1.055,2.4)),Z=t=>(t=Math.max(0,Math.min(1,t)),Math.round(255*(t<=.0031308?12.92*t:1.055*Math.pow(t,1/2.4)-.055)));function n0(t,a,o){t=Q(t),a=Q(a),o=Q(o);const i=Math.cbrt(.4122214708*t+.5363325363*a+.0514459929*o),s=Math.cbrt(.2119034982*t+.6806995451*a+.1073969566*o),l=Math.cbrt(.0883024619*t+.2817188376*a+.6299787005*o);return[.2104542553*i+.793617785*s-.0040720468*l,1.9779984951*i-2.428592205*s+.4505937099*l,.0259040371*i+.7827717662*s-.808675766*l]}function m0(t,a,o){const i=(t+.3963377774*a+.2158037573*o)**3,s=(t-.1055613458*a-.0638541728*o)**3,l=(t-.0894841775*a-1.291485548*o)**3;return[Z(4.0767416621*i-3.3077115913*s+.2309699292*l),Z(-1.2684380046*i+2.6097574011*s-.3413193965*l),Z(-.0041960863*i-.7034186147*s+1.707614701*l)]}const s0=t=>[parseInt(t.slice(1,3),16),parseInt(t.slice(3,5),16),parseInt(t.slice(5,7),16)];function k0(t,a=1,o=new Uint8Array(256*4)){const i=[...t].sort((s,l)=>s[1]-l[1]);for(let s=0;s<256;s++){const l=s/255;let c=0;for(;c<i.length-2&&l>i[c+1][1];)c++;const[r,d]=i[c],[m,f]=i[c+1],p=Math.max(0,Math.min(1,(l-d)/Math.max(1e-5,f-d))),e=n0(...s0(r)),h=n0(...s0(m)),u=m0(e[0]+(h[0]-e[0])*p,(e[1]+(h[1]-e[1])*p)*a,(e[2]+(h[2]-e[2])*p)*a);o.set([...u,255],s*4)}return o}const _0=`
...
vec3 personLook(float thick, float lumS, float lumB, float mIn, float face, float vTop){
  ...
  lumS *= kExp; lumB *= kExp;
  if (uPForm > 0.5) {
    // ═══ 레퍼런스 규약 — injury-check.mp4 픽셀 실측(2026-08-02) ═══════════════════
    //   레퍼런스 페이지의 CSS 는 색을 거의 안 만든다(saturate 1.55 · multiply 뿐). 룩은
    //   클립에 구워져 있어서, 그 클립의 픽셀을 직접 재봤다. 결과:
    //     · 색상  p5 6.5° / p50 12.0° / p95 14.2°  → **사실상 고정**. 8° 안에 전부 들어온다.
    //     · 명도  콘텐츠의 98.7% 가 V 0.80~0.95    → 어두운 픽셀이 **하나도 없다**.
    //     · 채도  0.44 ~ 0.68                       → 움직이는 축은 이것뿐.
    //     · 픽셀의 75% 가 mix(흰색, #E0542F, k) 라는 **한 직선** 위에 앉는다(채널별 k 오차 <0.14).
    //   즉 레퍼런스는 LUT 램프를 훑지 않는다. **색 하나를 흰색으로 희석**한 것이 전부다.
    //   RED→CORAL→SAND→ICE 로 색상을 이동시키던 기존 방식이 구조적으로 달랐던 지점이고,
    //   깊이 기반이든 휘도 기반이든 '램프를 훑는' 한 같은 그림은 안 나온다.
    //
    //   앵커 = 팔레트 RED↔CORAL 구간의 한 점(lut t≈0.50, 실측 12° 가 CORAL 15.5°보다 약간 붉다).
    //   uPCoral 의 역산 관용구를 그대로 쓴다 — uPHi 를 바꿔도 앵커가 따라온다.
    float tA = pow(0.50 / P_GAIN, 1.0 / P_GAMMA);
    vec3 anchor = personColor(clamp((tA - P_LO) / max(uPHi - P_LO, 1e-4), 0.0, 1.0));
    // k = 희석 반대량(1 = 앵커 원색, 0 = 흰색). 어두운 소스일수록 진하다: 옷이 코랄, 맨살이 뽀얗다.
    //   실측 k 분포 p5 0.38 / p50 0.87 / p95 0.99 — 몸 대부분이 원색에 가깝고 말단만 빠진다.
    //   대역은 그 중앙값에 맞춰 잡았다(kExp 가 클립 평균을 0.5 로 옮겨 두므로 기준이 성립한다).
    float lum = mix(mix(lumS, lumB, 0.35), lumB, face);
    float k = 1.0 - smoothstep(0.35, 1.15, lum);
    // 경계의 부드러움도 같은 축이다 — 어둡게가 아니라 **희석**해서 흰색으로 보낸다.
    //   thick 은 몸통 안쪽에서 1.0 에 포화하므로 이 항은 실루엣 바깥 얇은 층에만 걸린다.
    k *= smoothstep(0.15, 0.78, clamp(thick, 0.0, 1.0));
    k *= 1.0 - face * 0.45;                     // 얼굴은 더 희석 = 이목구비 은닉(제품 요구사항)
    return clamp(mix(vec3(1.0), anchor, clamp(k, 0.0, 1.0)), 0.0, 1.0);
  }
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(t,a,o,i){t.lineWidth=4*a;const s=i.arrow;s.line==="dash"?t.setLineDash([12*a*s.gap,10*s.gap]):s.line==="dot"?(t.setLineDash([.5,12*s.gap]),t.lineCap="round",t.lineWidth=5*a):t.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(t.lineDashOffset=-o*40*s.speed)}function F0(t,a,o,i,s,l={}){const c=s.lut,r=s.arrow||{},d=r.w??1,m=r.speed??1,f=r.glow??1,p=l.pulse??1,e=o/256,h=a/2,u=i*.9*m%1,C=l.prog!=null?Math.max(0,Math.min(1,l.prog)):Math.min(1,u/.55),v=l.prog!=null?1:u>.88?(1-u)/.12:1;t.clearRect(0,0,a,o);const w=v*(.45+.55*p),n=o-24*e,S=58*e,M=n+(S-n)*C,T=(_,y)=>c(_).replace("rgb(","rgba(").replace(")",`,${y.toFixed(3)})`),x=1.1*e*d,A=13*e*d,R=t.createLinearGradient(0,n,0,M);if(R.addColorStop(0,T(.55,0)),R.addColorStop(.1,T(.64,.45*w)),R.addColorStop(.32,T(.76,.85*w)),R.addColorStop(.62,T(.88,.98*w)),R.addColorStop(1,T(.97,w)),t.globalAlpha=1,t.fillStyle=R,t.beginPath(),t.moveTo(h-x/2,n),t.lineTo(h+x/2,n),t.lineTo(h+A/2,M),t.lineTo(h-A/2,M),t.closePath(),t.fill(),t.globalAlpha=w,C>.28&&!l.noTip){const _=34*e*(.7+.3*d),y=Math.min(1,(C-.28)/.22)*w,k=M+_*.3;t.globalAlpha=y;const I={color:c(.95),glowColor:c(.85),glow:12*f};s.glyph&&(s.glyph(t,"LIFT_TIP",h,k,_,I)||s.glyph(t,"TIP_TRI",h,k,_*.93,I))||(t.strokeStyle=c(.95),t.lineWidth=13*e*d,t.lineCap="round",t.lineJoin="round",t.shadowColor=c(.9),t.shadowBlur=18*e*f,t.beginPath(),t.moveTo(h-26*e,k+14*e),t.lineTo(h,k-16*e),t.lineTo(h+26*e,k+14*e),t.stroke())}t.globalAlpha=1,t.shadowBlur=0}function B0(t,a,o,i,s,l,c={}){const r=l.lut,d=l.arrow||{},m=d.w??1,f=d.glow??1,p=o/256;t.clearRect(0,0,a,o);const e=i.map(([n,S])=>[n*a,S*o]);if(e.length<2)return;const h=48,u=[],C=n=>{if(e.length===2)return[e[0][0]+(e[1][0]-e[0][0])*n,e[0][1]+(e[1][1]-e[0][1])*n];const S=n*(e.length-1),M=Math.min(e.length-2,Math.floor(S)),T=S-M,x=e[Math.max(0,M-1)],A=e[M],R=e[M+1],_=e[Math.min(e.length-1,M+2)],y=(k,I,P,B)=>.5*(2*I+(-k+P)*T+(2*k-5*I+4*P-B)*T*T+(-k+3*I-3*P+B)*T*T*T);return[y(x[0],A[0],R[0],_[0]),y(x[1],A[1],R[1],_[1])]};for(let n=0;n<=h;n++)u.push(C(n/h));const v=Math.max(0,Math.min(1,c.prog!=null?c.prog:s*.55%1)),w=Math.max(1,Math.round(h*v));t.lineCap="round";for(let n=1;n<=w;n++){const S=n/w;t.globalAlpha=Math.pow(S,1.5),t.strokeStyle=r(.45+.5*S),t.lineWidth=(1.6+3.2*S)*p*m,t.beginPath(),t.moveTo(u[n-1][0],u[n-1][1]),t.lineTo(u[n][0],u[n][1]),t.stroke()}if(v>.25){const n=u[w][0],S=u[w][1],M=u[Math.max(0,w-2)][0],T=u[Math.max(0,w-2)][1],x=Math.atan2(S-T,n-M)+Math.PI/2,A=30*p*(.7+.3*m);t.save(),t.translate(n,S),t.rotate(x),t.globalAlpha=Math.min(1,(v-.25)/.2);const R={color:r(.95),glowColor:r(.85),glow:12*f};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,A,R)||l.glyph(t,"TIP_TRI",0,0,A*.93,R))||(t.strokeStyle=r(.95),t.lineWidth=9*p*m,t.lineJoin="round",t.lineCap="round",t.beginPath(),t.moveTo(-18*p,12*p),t.lineTo(0,-14*p),t.lineTo(18*p,12*p),t.stroke()),t.restore()}t.globalAlpha=1}function c0(t,a,o,i,s,l){s=s||{};const c=l.lut,r=s.style||l.arrow.line,d=!!s.closed,m=[0];for(let h=1;h<a.length;h++)m.push(m[h-1]+Math.hypot(a[h][0]-a[h-1][0],a[h][1]-a[h-1][1]));const f=m[m.length-1]||1,p=h=>{h=(h%f+f)%f;let u=1;for(;u<m.length-1&&m[u]<h;)u++;const C=(h-m[u-1])/Math.max(1e-4,m[u]-m[u-1]);return[a[u-1][0]+(a[u][0]-a[u-1][0])*C,a[u-1][1]+(a[u][1]-a[u-1][1])*C,Math.atan2(a[u][1]-a[u-1][1],a[u][0]-a[u-1][0])]},e=l.arrow;if(r==="chevron"){const h=(26*i+8)*e.gap,u=Math.max(2,Math.floor(f/h));t.shadowColor=c(Math.min(1,e.heat+.2)),t.shadowBlur=8*i*e.glow;for(let C=0;C<u;C++){const v=C*h+o*42*e.speed%h;if(!d&&v>f-4)continue;const[w,n,S]=p(v),M=7.5*i,T=8.5*i,x=.45+.4*Math.sin(v/f*6.283-o*2.2*e.speed);t.strokeStyle=c(e.heat-.05+x*.3),t.lineWidth=3.2*i,t.lineJoin="round",t.lineCap="round",t.save(),t.translate(w,n),t.rotate(S),t.beginPath(),t.moveTo(-T*.5,-M),t.lineTo(T*.5,0),t.lineTo(-T*.5,M),t.stroke(),t.restore()}return!0}if(r==="comet"){const h=o*.35*e.speed%1*f,u=f*e.tail,C=Math.max(24,a.length*2);t.lineCap="round";for(let n=0;n<C;n++){const S=h-n/C*u,M=h-(n+1)/C*u;if(!d&&M<0)break;const T=1-n/C,[x,A]=p(S),[R,_]=p(M);!d&&Math.hypot(R-x,_-A)>f*.4||(t.globalAlpha=Math.pow(T,1.6),t.strokeStyle=c(Math.max(.05,e.heat-.2)+T*.55),t.lineWidth=(1.5+T*4.5)*i,T>.72?(t.shadowColor=c(Math.min(1,e.heat+.3)),t.shadowBlur=T*12*i*e.glow):t.shadowBlur=0,t.beginPath(),t.moveTo(x,A),t.lineTo(R,_),t.stroke())}t.globalAlpha=1,t.lineCap="butt",t.shadowBlur=0;const[v,w]=p(h);return t.fillStyle=rgba(W.ink,.95),t.shadowColor=c(.9),t.shadowBlur=16*i,t.beginPath(),t.arc(v,w,2.6*i,0,7),t.fill(),t.shadowBlur=0,!0}if(t.strokeStyle=s.color||c(e.heat),t.shadowColor=c(Math.min(1,e.heat+.15)),t.shadowBlur=(s.glow??8)*i*e.glow,r==="taper")for(let h=1;h<a.length;h++)t.lineWidth=(.5+h/a.length*4.5)*i,t.beginPath(),t.moveTo(a[h-1][0],a[h-1][1]),t.lineTo(a[h][0],a[h][1]),t.stroke();else w0(t,i,o,l),t.beginPath(),a.forEach(([h,u],C)=>C?t.lineTo(h,u):t.moveTo(h,u)),d&&t.closePath(),t.stroke();return t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,t.shadowBlur=0,!0}function E0(t,a,o,i,s,l){const c=13*i.halo,r=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const d=a/220,m=a/2,f=18*o.round*d,p=40*d,e=48*d,h=a-80*d,u=a-96*d,C=[],v=(n,S,M,T)=>{for(let x=0;x<=1;x+=.12)C.push([n+(M-n)*x,S+(T-S)*x])};v(p+f,e,p+h-f,e),v(p+h,e+f,p+h,e+u-f),v(p+h-f,e+u,p+f,e+u),v(p,e+u-f,p,e+f),t.shadowColor=r(.6),t.shadowBlur=c*.8;const w=4*l.arrow.w*d;if(l.arrow.line==="solid"?(t.setLineDash([10*o.dash*d,8*d]),t.lineDashOffset=-s*22*d,t.strokeStyle=r(.45),t.lineWidth=w,t.beginPath(),t.roundRect(p,e,h,u,f),t.stroke(),t.setLineDash([]),t.lineDashOffset=0):c0(t,C,s,l.arrow.w*d,{color:r(.45),closed:!0},l),o.prog!=null&&o.prog>.001){const n=[],S=(I,P,B,D,U)=>{for(let O=1;O<=U;O++)n.push([I+(B-I)*O/U,P+(D-P)*O/U])},M=(I,P,B,D,U)=>{for(let O=1;O<=U;O++){const $=B+(D-B)*O/U;n.push([I+f*Math.cos($),P+f*Math.sin($)])}},T=Math.PI/2,x=p+h,A=e+u,R=p+h/2;n.push([R,e]),S(R,e,x-f,e,8),M(x-f,e+f,-T,0,6),S(x,e+f,x,A-f,10),M(x-f,A-f,0,T,6),S(x-f,A,p+f,A,14),M(p+f,A-f,T,Math.PI,6),S(p,A-f,p,e+f,10),M(p+f,e+f,Math.PI,Math.PI+T,6),S(p+f,e,R,e,8);let _=0;for(let I=1;I<n.length;I++)_+=Math.hypot(n[I][0]-n[I-1][0],n[I][1]-n[I-1][1]);const y=_*Math.min(1,o.prog);t.save(),t.setLineDash([10*o.dash*d,8*d]),t.lineDashOffset=-(h/2-f)-s*22*d,t.strokeStyle=r(.9),t.lineWidth=w*1.3,t.lineCap="round",t.shadowColor=r(.92),t.shadowBlur=c*1.3,t.beginPath(),t.moveTo(n[0][0],n[0][1]);let k=0;for(let I=1;I<n.length&&k<y;I++){const P=Math.hypot(n[I][0]-n[I-1][0],n[I][1]-n[I-1][1]);if(k+P<=y)t.lineTo(n[I][0],n[I][1]),k+=P;else{const B=(y-k)/P;t.lineTo(n[I-1][0]+(n[I][0]-n[I-1][0])*B,n[I-1][1]+(n[I][1]-n[I-1][1])*B),k=y}}t.stroke(),t.setLineDash([]),t.restore()}o.feet>.05&&l.foot&&(l.foot(t,!1,m-16*o.feet*d,m+6*d,26*o.feet*d),l.foot(t,!0,m+16*o.feet*d,m+6*d,26*o.feet*d)),t.shadowBlur=0}function O0(t,a,o,i,s,l,c,r){const d=13*i.halo,m=4*l.arrow.w*(a/220),f=l.lut;t.clearRect(0,0,a,a),t.lineJoin="round";const p=a/220,e=c||[[45*p,130*p],[110*p,60*p],[175*p,110*p]],h=r??s*.5%1,u=Math.min(1,h*1.25)*(e.length-1),C=Math.min(e.length-1,Math.floor(u+.35));t.shadowColor=f(.7),t.shadowBlur=d;const v=[[e[0][0],e[0][1]]];for(let w=1;w<=e.length-1;w++){const n=Math.max(0,Math.min(1,u-(w-1)));if(n<=0)break;v.push([e[w-1][0]+(e[w][0]-e[w-1][0])*n,e[w-1][1]+(e[w][1]-e[w-1][1])*n])}v.length>1&&c0(t,v,s,l.arrow.w*p,{color:f(.62)},l),t.setLineDash([4*p,7*p]),t.lineDashOffset=0,t.globalAlpha=.3,t.strokeStyle=f(.45),t.lineWidth=m,t.beginPath(),e.forEach(([w,n],S)=>S?t.lineTo(w,n):t.moveTo(w,n)),t.stroke(),t.globalAlpha=1,t.setLineDash([]),t.lineCap="butt",t.lineDashOffset=0,e.forEach(([w,n],S)=>{const M=S===C,T=M?1+Math.sin(s*6)*.14:1;t.strokeStyle=f(M?.8:.45),t.lineWidth=m*(M?1.3:.9),t.shadowBlur=M?d*1.6:d*.6,t.beginPath(),t.arc(w,n,12*o.node*T*p,0,Math.PI*2),t.stroke(),l.num&&(t.globalAlpha=S<=C?1:.45,l.num(t,String(S+1),w,n,16*o.numS*T*p,Math.round(14*o.numS*p)),t.globalAlpha=1)}),t.shadowBlur=0}function G0(t,a,o,i,s,l,c){const r=l.lut,d=13*i.halo,m=a/220,f=a/2,p=l.arrow&&l.arrow.w||1,e=(x,A)=>r(x).replace("rgb(","rgba(").replace(")",`,${A})`);t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const h=(o.r!=null?o.r:.42)*a,u=h*(o.rt!=null?o.rt:.36),C=3.4*p*m,v=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.6)%1,w=Math.pow(v,1.6),n=Math.max(0,(v-.9)/.1);t.save(),t.translate(f,f);const S=(x,A,R,_=1)=>{if(x<=.6)return;const y=C*2.6*_,k=Math.max(.1,x-y),I=x+y,P=t.createRadialGradient(0,0,k,0,0,I);P.addColorStop(0,e(A-.05,0)),P.addColorStop(.5,e(A,R*.85)),P.addColorStop(1,e(A-.05,0)),t.globalAlpha=1,t.fillStyle=P,t.shadowBlur=0,t.beginPath(),t.arc(0,0,I,0,Math.PI*2),t.fill(),t.globalAlpha=Math.min(1,R*1.1),t.lineWidth=C*.85,t.strokeStyle=r(Math.min(.98,A+.12)),t.shadowColor=r(.88),t.shadowBlur=d*.6,t.beginPath(),t.arc(0,0,x,0,Math.PI*2),t.stroke(),t.shadowBlur=0},M=t.createRadialGradient(0,0,0,0,0,u*1.08);M.addColorStop(0,e(.6,.1+.18*n)),M.addColorStop(.65,e(.5,.05+.08*n)),M.addColorStop(1,e(.5,0)),t.globalAlpha=1,t.fillStyle=M,t.beginPath(),t.arc(0,0,u*1.08,0,Math.PI*2),t.fill();const T=1+.02*Math.sin(s*2.6);S(u*T,.55+.4*n,.5+.45*n,.9);for(let x=2;x>=0;x--){const A=Math.pow(Math.max(0,v-x*.05),1.6),R=h-(h-u)*A,_=x===0?.6+.4*w:.18/x*(1-n);S(R,.55+.4*w,_*(1-n*.45),1.15-.35*w)}n>.01&&S(u*(1+1.4*n),.9,(1-n)*.8,1.1),t.globalAlpha=.6+.3*n,t.shadowColor=r(.85),t.shadowBlur=d*(.9+n),t.fillStyle=r(.62+.3*n),t.beginPath(),t.arc(0,0,C*.85+3*m*n,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}function U0(t,a,o,i,s,l,c,r){const d=l.lut,m=13*i.halo,f=a/220,p=a/2,e=l.arrow&&l.arrow.w||1,h=e*f,u=(b,L)=>d(b).replace("rgb(","rgba(").replace(")",","+L+")");t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const C=a*.42*(o.spread!=null?o.spread:1),w=(r||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([b,L])=>[p+b*C,p+L*C]),n=80,S=[];for(let b=0;b<=n;b++){const L=b/n*(w.length-1),F=Math.min(w.length-2,Math.floor(L)),G=L-F,H=w[Math.max(0,F-1)],K=w[F],N=w[F+1],t0=w[Math.min(w.length-1,F+2)],a0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*G+(2*X-5*J+4*Y-o0)*G*G+(-X+3*J-3*Y+o0)*G*G*G);S.push([a0(H[0],K[0],N[0],t0[0]),a0(H[1],K[1],N[1],t0[1])])}const M=b=>{const L=Math.max(0,Math.min(n,b*n)),F=Math.floor(L),G=L-F,H=S[F],K=S[Math.min(n,F+1)];return[H[0]+(K[0]-H[0])*G,H[1]+(K[1]-H[1])*G]},T=.68;let x,A,R;if(c!=null)x=Math.max(0,Math.min(1,c)),A=1,R=0;else{const b=s*(o.tempo||.42)%1;if(b<T)x=b/T,A=1,R=0;else{const L=(b-T)/(1-T);x=1,A=1-L*L,R=L}}if(A<=.012)return;const _=x*x*x*(x*(6*x-15)+10),y=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const k=.36*(o.tail!=null?o.tail:1),I=o.width!=null?o.width:1;{const b=t.createLinearGradient(S[0][0],S[0][1],S[n][0],S[n][1]);b.addColorStop(0,u(.46,0)),b.addColorStop(.3,u(.46,.03*A)),b.addColorStop(.8,u(.46,.045*A)),b.addColorStop(1,u(.46,0)),t.globalAlpha=1,t.strokeStyle=b,t.lineWidth=9*h,t.shadowColor=d(.6),t.shadowBlur=m*2,t.beginPath(),S.forEach(([L,F],G)=>G?t.lineTo(L,F):t.moveTo(L,F)),t.stroke(),t.shadowBlur=0}const P=40,B=Math.max(0,_-k*(1-R)),D=[];for(let b=0;b<=P;b++)D.push(M(B+(_-B)*(b/P)));const U=()=>{t.beginPath(),D.forEach(([b,L],F)=>F?t.lineTo(b,L):t.moveTo(b,L)),t.stroke()},O=()=>{const b=t.createLinearGradient(D[0][0],D[0][1],D[P][0],D[P][1]);return b.addColorStop(0,u(.55,0)),b.addColorStop(.4,u(.56,0)),b.addColorStop(.68,u(.6,.09)),b.addColorStop(.88,u(.64,.24)),b.addColorStop(1,u(.68,.44)),b},$=1+.5*y;t.globalAlpha=A,t.strokeStyle=O(),t.lineWidth=(20+10*y)*h*I,t.shadowColor=d(.72),t.shadowBlur=m*2.2,U(),t.strokeStyle=O(),t.lineWidth=(10+5*y)*h*I,t.shadowBlur=m*1,U(),t.shadowBlur=0;for(let b=1;b<=P;b++){const L=b/P;t.globalAlpha=Math.pow(L,2.2)*.95*A,t.strokeStyle=d(.55+.38*L),t.lineWidth=(1.6+6.5*Math.pow(L,.7))*h*I*$,t.beginPath(),t.moveTo(D[b-1][0],D[b-1][1]),t.lineTo(D[b][0],D[b][1]),t.stroke()}const V=D[P][0],g=D[P][1];t.globalAlpha=.8*A,t.fillStyle=d(.6),t.shadowColor=d(.8),t.shadowBlur=m*1.6,t.beginPath(),t.arc(V,g,(9+5*y)*h*I,0,Math.PI*2),t.fill(),t.globalAlpha=A,t.fillStyle=d(.93),t.shadowBlur=m*.6,t.beginPath(),t.arc(V,g,(3.4+1.8*y)*h*I,0,Math.PI*2),t.fill(),t.globalAlpha=1,t.shadowBlur=0}function H0(t,a,o,i,s,l,c){const r=l.lut,d=13*i.halo,m=a/220,f=a/2,p=l.arrow&&l.arrow.w||1;t.clearRect(0,0,a,a),t.lineJoin="round",t.lineCap="round";const e=(o.r!=null?o.r:.3)*a,h=o.width!=null?o.width:1,u=4.2*p*m*h,C=o.dir!=null?o.dir:1,v=(o.sweep!=null?o.sweep:.66)*Math.PI*2,w=c!=null?Math.max(0,Math.min(1,c)):s*(o.tempo||.5)%1,n=-Math.PI/2+C*w*Math.PI*2;t.save(),t.translate(f,f),t.globalAlpha=.16,t.lineWidth=u*.7,t.strokeStyle=r(.44),t.shadowColor=r(.6),t.shadowBlur=d*.4,t.beginPath(),t.arc(0,0,e,0,Math.PI*2),t.stroke(),t.shadowBlur=0;const S=16;for(let y=0;y<S;y++){const k=y/(S-1),I=n-C*k*v,P=n-C*(k+1.2/S)*v;t.globalAlpha=(1-k)*.9,t.strokeStyle=r(.55+.35*(1-k)),t.lineWidth=u*(.55+.55*(1-k)),t.shadowColor=r(.8),t.shadowBlur=d*(.4+.5*(1-k)),t.beginPath(),t.arc(0,0,e,Math.min(I,P),Math.max(I,P),!1),t.stroke()}t.shadowBlur=0;const M=Math.cos(n)*e,T=Math.sin(n)*e,x=n+C*Math.PI/2,A=8*m*h;t.save(),t.translate(M,T),t.rotate(x+Math.PI/2),t.globalAlpha=1;const R=3.4*A*(.7+.3*p),_={color:r(.96),glowColor:r(.9),glow:d*1.2};l.glyph&&(l.glyph(t,"LIFT_TIP",0,0,R,_)||l.glyph(t,"TIP_TRI",0,0,R*.93,_))||(t.rotate(-Math.PI/2),t.strokeStyle=r(.96),t.lineWidth=u*.9,t.shadowColor=r(.9),t.shadowBlur=d*1.2,t.beginPath(),t.moveTo(-A,-A*.9),t.lineTo(A*.5,0),t.lineTo(-A,A*.9),t.stroke()),t.restore(),t.globalAlpha=.62,t.shadowColor=r(.75),t.shadowBlur=d*.6,t.fillStyle=r(.6),t.beginPath(),t.arc(0,0,u*.6,0,Math.PI*2),t.fill(),t.restore(),t.globalAlpha=1,t.shadowBlur=0}export{y0 as C,p0 as G,P0 as M,W as N,E as P,b0 as Q,_0 as R,T0 as S,M0 as Z,j as a,f0 as b,I0 as c,v0 as d,A0 as e,E0 as f,O0 as g,G0 as h,R0 as i,U0 as j,H0 as k,k0 as l,F0 as m,D0 as n,z as o,c0 as p,x0 as q,B0 as r,i0 as s,S0 as t,C0 as u,L0 as v,h0 as w,u0 as x};
