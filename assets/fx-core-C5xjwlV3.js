import{v as g,P as W,N as X}from"./palette-Bj20GXDn.js";const h0="MARK(발형·존원) 룩 정본. footlab.html '코드에 저장'이 이 파일을 덮어쓴다.",u0=.98,f0=.83,p0=-.043,m0=-.031,w0=5.5,S0=.027,x0=.25,C0=.26,b0=.3,I0=.92,v0=.038,R0=1,M0=24,A0=1,T0=.95,y0=.45,L0=.88,P0=0,_0=.5,k0=.34,D0=.1,B0=.4,F0=1,E0=1.4,G0=0,O0=3.4,U0=.01,H0=0,W0=.011,q0=-2,g0=.75,K0=-.07,$0=.12,X0=4,j0=.6,J0=4,Y0=1,Q0="drop",z0="add",Z0="offbit",V0=.55,N0=.14,aa=.5,ta=4,oa=4,ea=1,la=.32,na=1,sa={punchLine:{node:1.58,numS:1,comet:1,tailLen:.71,rail:.6}},ra=-.095,ia=.12,ca=10,da=-.015,ha=.12,ua=-10,fa={op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15},pa=1,ma=4,wa={tap:{op:0,imp:.98,scale:.83,pitch:.027,dot:.25,glow:0,shade:0,sharp:.64,edge:.004,plantar:0,bands:0,bandSoft:0,edgeShade:.26,edgeShadeW:4,edgeShadeGrad:0,edgeShadeG0:0,edgeShadeG1:0,dither:.011,edgeW:.01,edgeSoft:0,shadeRed:0,shadeRedW:.5,rip:.5,ripReach:.34,ripWidth:.1,ripSpeed:.4,ripGrad:1,shadeCol:4,edgeShadeCol:4,dotCol:4,ripCol:0,bloom:.165,w:1.15}},Sa={_:h0,imp:u0,scale:f0,offx:p0,offy:m0,irot:w0,pitch:S0,dot:x0,glow:C0,shade:b0,sharp:I0,edge:v0,plantar:R0,bands:M0,bandSoft:A0,w:T0,halo:y0,pool:L0,noise:P0,rip:_0,ripReach:k0,ripWidth:D0,ripSpeed:B0,ripGrad:F0,edgeShade:E0,shadeRed:G0,shadeRedW:O0,edgeW:U0,edgeSoft:H0,dither:W0,tilt:q0,gsize:g0,gx:K0,gy:$0,grot:X0,gsh:j0,shadeCol:J0,ripCol:Y0,gShadow:Q0,gBlend:z0,numSrc:Z0,prog:V0,bloom:N0,blur:aa,edgeShadeW:ta,edgeShadeCol:oa,edgeShadeGrad:ea,edgeShadeG0:la,edgeShadeG1:na,prims:sa,gxL:ra,gyL:ia,grotL:ca,gxR:da,gyR:ha,grotR:ua,tap:fa,op:pa,dotCol:ma,states:wa};function l0(a,t,o,c,s){let e=0;o[0]=0,c[0]=-1e20,c[1]=1e20;for(let i=1;i<s;i++){let h=(a[i]+i*i-(a[o[e]]+o[e]*o[e]))/(2*i-2*o[e]);for(;h<=c[e];)e--,h=(a[i]+i*i-(a[o[e]]+o[e]*o[e]))/(2*i-2*o[e]);e++,o[e]=i,c[e]=h,c[e+1]=1e20}e=0;for(let i=0;i<s;i++){for(;c[e+1]<i;)e++;t[i]=(i-o[e])*(i-o[e])+a[o[e]]}}function n0(a,t){const o=new Float32Array(t),c=new Int32Array(t),s=new Float32Array(t+1),e=new Float32Array(t);for(let i=0;i<t;i++){for(let h=0;h<t;h++)e[h]=a[h*t+i];l0(e,o,c,s,t);for(let h=0;h<t;h++)a[h*t+i]=o[h]}for(let i=0;i<t;i++){for(let h=0;h<t;h++)e[h]=a[i*t+h];l0(e,o,c,s,t);for(let h=0;h<t;h++)a[i*t+h]=o[h]}}function i0(a,t){const c=new Float32Array(t*t),s=new Float32Array(t*t);let e=0,i=0,h=0;for(let x=0;x<t*t;x++){const d=a[x*4+3]/255;c[x]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),s[x]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(e+=x%t,i+=x/t|0,h++)}n0(c,t),n0(s,t);const f=new Float32Array(t*t);for(let x=0;x<t*t;x++)f[x]=(Math.sqrt(c[x])-Math.sqrt(s[x]))/t;return{data:f,N:t,cx:h?e/h/t:.5,cy:h?i/h/t:.5}}function Z(a,t=512){const o="_raster"+t;if(a[o])return a[o];const c=document.createElement("canvas");c.width=c.height=t;const s=c.getContext("2d"),e=Math.min(t/a.naturalWidth,t/a.naturalHeight);s.drawImage(a,0,0,a.naturalWidth*e,a.naturalHeight*e);const i=s.getImageData(0,0,t,t).data;let h=t,f=t,x=-1,d=-1;for(let u=0;u<t;u++)for(let l=0;l<t;l++)i[(u*t+l)*4+3]>8&&(l<h&&(h=l),l>x&&(x=l),u<f&&(f=u),u>d&&(d=u));return a[o]=x<0?{canvas:c,x:0,y:0,w:t,h:t}:{canvas:c,x:h,y:f,w:x-h+1,h:d-f+1},a[o]}function Ma(a,t,o=!1){const c=Z(a,t),s=document.createElement("canvas");s.width=s.height=t;const e=s.getContext("2d"),i=Math.min(t*$/c.w,t*$/c.h),h=c.w*i,f=c.h*i;return o&&(e.translate(0,t),e.scale(1,-1)),e.drawImage(c.canvas,c.x,c.y,c.w,c.h,(t-h)/2,(t-f)/2,h,f),i0(e.getImageData(0,0,t,t).data,t)}function Aa(a,t,o,c=!1){const s=Z(a,o),e=t?Z(t,o):null,i=Math.min(o*$/s.w,o*$/s.h),h=s.w*i,f=s.h*i,x=(o-h)/2,d=(o-f)/2,u=v=>{const P=document.createElement("canvas");P.width=P.height=o;const y=P.getContext("2d");return c&&(y.translate(0,o),y.scale(1,-1)),y.drawImage(v.canvas,s.x,s.y,s.w,s.h,x,d,h,f),i0(y.getImageData(0,0,o,o).data,o)},l=u(s),r=e?u(e):null,n=new Float32Array(o*o*2);for(let v=0;v<o*o;v++)n[v*2]=l.data[v],n[v*2+1]=r?r.data[v]:1;return{data:n,N:o,cx:l.cx,cy:l.cy,inCx:r?r.cx:l.cx,inCy:r?r.cy:l.cy,hasInner:!!r}}const Ta=1.9922,xa=.78,$=.52,ya=xa/$,La=1.18,O=Sa||{},c0={size:O.gsize??.85,gx:O.gx??-.025,gy:O.gy??.195,rot:O.grot??6,gxL:O.gxL,gyL:O.gyL,rotL:O.grotL,gxR:O.gxR,gyR:O.gyR,rotR:O.grotR,shadow:O.gShadow??"glow",shadowK:O.gsh??.75,blend:O.gBlend??"add"};function Pa(a,t=c0){return a?{gx:t.gxR??-t.gx,gy:t.gyR??t.gy,rot:t.rotR??-t.rot}:{gx:t.gxL??t.gx,gy:t.gyL??t.gy,rot:t.rotL??t.rot}}function _a(a,t,o,c,s=c0){const e=Math.round(o*.75),i=s.shadow==="none"?0:s.shadowK??.75,h=f=>c(a,String(t),o/2,o/2,e,f);return s.shadow==="drop"&&i>.001?(a.save(),a.globalAlpha=Math.min(1,i*.7),a.translate(o*.018,o*.024),h({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),a.restore(),h({glow:0,glowColor:"rgba(0,0,0,0)"})):h(s.shadow==="glow"?{glow:26*i,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),s.blend==="knock"}function ka(a,t){const o=a.getImageData(0,0,t,t),c=a.createImageData(t,t);for(let s=0;s<t*t;s++){const e=o.data[s*4+3]/255,i=Math.round(255*(1-e));c.data[s*4]=c.data[s*4+1]=c.data[s*4+2]=i,c.data[s*4+3]=255}a.putImageData(c,0,0)}const Da={RATIO:140/600,opacity(a){return a===0?.5:a===2||a===4?0:1},anchor(a,t,o){return{x:((t?1-a.x:a.x)-.5)*o,y:(.5-a.y)*o,s:a.s||1}}},Q=a=>(a/=255,a<=.04045?a/12.92:Math.pow((a+.055)/1.055,2.4)),z=a=>(a=Math.max(0,Math.min(1,a)),Math.round(255*(a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055)));function s0(a,t,o){a=Q(a),t=Q(t),o=Q(o);const c=Math.cbrt(.4122214708*a+.5363325363*t+.0514459929*o),s=Math.cbrt(.2119034982*a+.6806995451*t+.1073969566*o),e=Math.cbrt(.0883024619*a+.2817188376*t+.6299787005*o);return[.2104542553*c+.793617785*s-.0040720468*e,1.9779984951*c-2.428592205*s+.4505937099*e,.0259040371*c+.7827717662*s-.808675766*e]}function Ca(a,t,o){const c=(a+.3963377774*t+.2158037573*o)**3,s=(a-.1055613458*t-.0638541728*o)**3,e=(a-.0894841775*t-1.291485548*o)**3;return[z(4.0767416621*c-3.3077115913*s+.2309699292*e),z(-1.2684380046*c+2.6097574011*s-.3413193965*e),z(-.0041960863*c-.7034186147*s+1.707614701*e)]}const r0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)];function Ba(a,t=1,o=new Uint8Array(256*4)){const c=[...a].sort((s,e)=>s[1]-e[1]);for(let s=0;s<256;s++){const e=s/255;let i=0;for(;i<c.length-2&&e>c[i+1][1];)i++;const[h,f]=c[i],[x,d]=c[i+1],u=Math.max(0,Math.min(1,(e-f)/Math.max(1e-5,d-f))),l=s0(...r0(h)),r=s0(...r0(x)),n=Ca(l[0]+(r[0]-l[0])*u,(l[1]+(r[1]-l[1])*u)*t,(l[2]+(r[2]-l[2])*u)*t);o.set([...n,255],s*4)}return o}const Fa=`
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function ba(a,t,o,c){a.lineWidth=4*t;const s=c.arrow;s.line==="dash"?a.setLineDash([12*t*s.gap,10*s.gap]):s.line==="dot"?(a.setLineDash([.5,12*s.gap]),a.lineCap="round",a.lineWidth=5*t):a.setLineDash([]),o!=null&&s.line!=="solid"&&s.line!=="taper"&&(a.lineDashOffset=-o*40*s.speed)}function Ua(a,t,o,c,s,e={}){const i=s.lut,h=s.arrow||{},f=h.w??1,x=h.speed??1,d=h.glow??1,u=e.pulse??1,l=o/256,r=l*(e.scale??1),n=t/2,v=c*.9*x%1,P=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,v/.55),y=e.prog!=null?1:v>.88?(1-v)/.12:1;a.clearRect(0,0,t,o);const w=y*(.45+.55*u),R=o-24*l,_=58*l,L=R+(_-R)*P,S=(A,D)=>i(A).replace("rgb(","rgba(").replace(")",`,${D.toFixed(3)})`),p=1.1*r*f,m=13*r*f,C=42*r*(.7+.3*f),k=!e.noTip&&P>.28?Math.min(1,(P-.28)/.22)*C*.42:0,I=L+k,b=a.createLinearGradient(0,R,0,I);if(b.addColorStop(0,S(.55,0)),b.addColorStop(.18,S(.64,.3*w)),b.addColorStop(.4,S(.76,.8*w)),b.addColorStop(.65,S(.88,.98*w)),b.addColorStop(1,S(.97,w)),a.save(),a.filter=`blur(${7*r}px)`,a.globalAlpha=e.dots?.3:.55,a.fillStyle=b,e.dots){const A=Math.abs(I-R),D=Math.max(3,Math.round(A/(13*r)));for(let M=0;M<D;M++){const F=(M+.5)/D,E=R+(I-R)*F,U=(p/2+(m/2-p/2)*F)*1.5;a.beginPath(),a.arc(n,E,Math.max(1.4*r,U),0,Math.PI*2),a.fill()}}else a.beginPath(),a.moveTo(n-p,R),a.lineTo(n+p,R),a.lineTo(n+m*.95,I),a.lineTo(n-m*.95,I),a.closePath(),a.fill();if(a.restore(),a.globalAlpha=1,a.fillStyle=b,e.dots){const A=Math.abs(I-R),D=Math.max(3,Math.round(A/(13*r)));for(let M=0;M<D;M++){const F=(M+.5)/D,E=R+(I-R)*F,U=(p/2+(m/2-p/2)*F)*.92;a.beginPath(),a.arc(n,E,Math.max(.9*r,U),0,Math.PI*2),a.fill()}}else a.beginPath(),a.moveTo(n-p/2,R),a.lineTo(n+p/2,R),a.lineTo(n+m/2,I),a.lineTo(n-m/2,I),a.closePath(),a.fill();if(a.globalAlpha=w,P>.28&&!e.noTip){const A=C,D=Math.min(1,(P-.28)/.22)*w,M=L+A*.3;a.globalAlpha=D;const F={color:i(.95),glowColor:i(.85),glow:12*d};s.glyph&&(s.glyph(a,"LIFT_TIP",n,M,A,F)||s.glyph(a,"TIP_TRI",n,M,A*.93,F))||(a.strokeStyle=i(.95),a.lineWidth=13*r*f,a.lineCap="round",a.lineJoin="round",a.shadowColor=i(.9),a.shadowBlur=18*r*d,a.beginPath(),a.moveTo(n-26*r,M+14*r),a.lineTo(n,M-16*r),a.lineTo(n+26*r,M+14*r),a.stroke())}a.globalAlpha=1,a.shadowBlur=0}function Ia(a,t,o,c,s,e,i={}){const h=e.lut,f=e.arrow||{},x=f.w??1,d=f.glow??1,u=o/256*(i.scale??1);a.clearRect(0,0,t,o);const l=c.map(([S,p])=>[S*t,p*o]);if(l.length<2)return;const r=48,n=[],v=S=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*S,l[0][1]+(l[1][1]-l[0][1])*S];const p=S*(l.length-1),m=Math.min(l.length-2,Math.floor(p)),C=p-m,k=l[Math.max(0,m-1)],I=l[m],b=l[m+1],A=l[Math.min(l.length-1,m+2)],D=(M,F,E,U)=>.5*(2*F+(-M+E)*C+(2*M-5*F+4*E-U)*C*C+(-M+3*F-3*E+U)*C*C*C);return[D(k[0],I[0],b[0],A[0]),D(k[1],I[1],b[1],A[1])]};for(let S=0;S<=r;S++)n.push(v(S/r));const P=Math.max(0,Math.min(1,i.prog!=null?i.prog:s*.55%1)),y=Math.max(1,Math.round(r*P)),w=i.alpha??1,R=i.tail??.22;a.lineCap="round";const _=42*u*(.7+.3*x);let L=y;if(P>.28){let S=0;const p=_*.42*Math.min(1,(P-.28)/.22);for(;L>1&&S<p;)S+=Math.hypot(n[L][0]-n[L-1][0],n[L][1]-n[L-1][1]),L--}for(const S of[0,1])for(let p=1;p<=L;p++){const m=p/y,C=Math.min(1,m/R),k=C*C*(3-2*C)*w;a.globalAlpha=S?k:k*.16*m,a.strokeStyle=h(.55+.42*m),a.lineWidth=(1.1+11.9*m)*u*x*(S?1:1.9),a.beginPath(),a.moveTo(n[p-1][0],n[p-1][1]),a.lineTo(n[p][0],n[p][1]),a.stroke()}if(P>.28){const S=n[Math.max(0,y-2)][0],p=n[Math.max(0,y-2)][1],m=Math.atan2(n[y][1]-p,n[y][0]-S)+Math.PI/2,C=n[y][0]-Math.sin(m)*_*.3,k=n[y][1]+Math.cos(m)*_*.3;a.save(),a.translate(C,k),a.rotate(m),a.globalAlpha=Math.min(1,(P-.28)/.22)*w;const I={color:h(.95),glowColor:h(.85),glow:12*d};e.glyph&&(e.glyph(a,"LIFT_TIP",0,0,_,I)||e.glyph(a,"TIP_TRI",0,0,_*.93,I))||(a.strokeStyle=h(.95),a.lineWidth=9*u*x,a.lineJoin="round",a.lineCap="round",a.beginPath(),a.moveTo(-18*u,12*u),a.lineTo(0,-14*u),a.lineTo(18*u,12*u),a.stroke()),a.restore()}a.globalAlpha=1}function va(a,t,o,c,s,e){s=s||{};const i=e.lut,h=s.style||e.arrow.line,f=!!s.closed,x=[0];for(let r=1;r<t.length;r++)x.push(x[r-1]+Math.hypot(t[r][0]-t[r-1][0],t[r][1]-t[r-1][1]));const d=x[x.length-1]||1,u=r=>{r=(r%d+d)%d;let n=1;for(;n<x.length-1&&x[n]<r;)n++;const v=(r-x[n-1])/Math.max(1e-4,x[n]-x[n-1]);return[t[n-1][0]+(t[n][0]-t[n-1][0])*v,t[n-1][1]+(t[n][1]-t[n-1][1])*v,Math.atan2(t[n][1]-t[n-1][1],t[n][0]-t[n-1][0])]},l=e.arrow;if(h==="chevron"){const r=(26*c+8)*l.gap,n=Math.max(2,Math.floor(d/r));a.shadowColor=i(Math.min(1,l.heat+.2)),a.shadowBlur=8*c*l.glow;for(let v=0;v<n;v++){const P=v*r+o*42*l.speed%r;if(!f&&P>d-4)continue;const[y,w,R]=u(P),_=7.5*c,L=8.5*c,S=.45+.4*Math.sin(P/d*6.283-o*2.2*l.speed);a.strokeStyle=i(l.heat-.05+S*.3),a.lineWidth=3.2*c,a.lineJoin="round",a.lineCap="round",a.save(),a.translate(y,w),a.rotate(R),a.beginPath(),a.moveTo(-L*.5,-_),a.lineTo(L*.5,0),a.lineTo(-L*.5,_),a.stroke(),a.restore()}return!0}if(h==="comet"){const r=o*.35*l.speed%1*d,n=d*l.tail,v=Math.max(24,t.length*2);a.lineCap="round";for(let w=0;w<v;w++){const R=r-w/v*n,_=r-(w+1)/v*n;if(!f&&_<0)break;const L=1-w/v,[S,p]=u(R),[m,C]=u(_);!f&&Math.hypot(m-S,C-p)>d*.4||(a.globalAlpha=Math.pow(L,1.6),a.strokeStyle=i(Math.max(.05,l.heat-.2)+L*.55),a.lineWidth=(1.5+L*4.5)*c,L>.72?(a.shadowColor=i(Math.min(1,l.heat+.3)),a.shadowBlur=L*12*c*l.glow):a.shadowBlur=0,a.beginPath(),a.moveTo(S,p),a.lineTo(m,C),a.stroke())}a.globalAlpha=1,a.lineCap="butt",a.shadowBlur=0;const[P,y]=u(r);return a.fillStyle=rgba(X.ink,.95),a.shadowColor=i(.9),a.shadowBlur=16*c,a.beginPath(),a.arc(P,y,2.6*c,0,7),a.fill(),a.shadowBlur=0,!0}if(a.strokeStyle=s.color||i(l.heat),a.shadowColor=i(Math.min(1,l.heat+.15)),a.shadowBlur=(s.glow??8)*c*l.glow,h==="taper")for(let r=1;r<t.length;r++)a.lineWidth=(.5+r/t.length*4.5)*c,a.beginPath(),a.moveTo(t[r-1][0],t[r-1][1]),a.lineTo(t[r][0],t[r][1]),a.stroke();else ba(a,c,o,e),a.beginPath(),t.forEach(([r,n],v)=>v?a.lineTo(r,n):a.moveTo(r,n)),f&&a.closePath(),a.stroke();return a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,a.shadowBlur=0,!0}function Ha(a,t,o,c,s,e){const i=13*c.halo,h=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const f=t/220,x=t/2,d=18*o.round*f,u=40*f,l=48*f,r=t-80*f,n=t-96*f,v=[],P=(w,R,_,L)=>{for(let S=0;S<=1;S+=.12)v.push([w+(_-w)*S,R+(L-R)*S])};P(u+d,l,u+r-d,l),P(u+r,l+d,u+r,l+n-d),P(u+r-d,l+n,u+d,l+n),P(u,l+n-d,u,l+d),a.shadowColor=h(.6),a.shadowBlur=i*.8;const y=4*e.arrow.w*f;if(e.arrow.line==="solid"?(a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-s*22*f,a.strokeStyle=h(.45),a.lineWidth=y,a.beginPath(),a.roundRect(u,l,r,n,d),a.stroke(),a.setLineDash([]),a.lineDashOffset=0):va(a,v,s,e.arrow.w*f,{color:h(.45),closed:!0},e),o.prog!=null&&o.prog>.001){const w=[],R=(b,A,D,M,F)=>{for(let E=1;E<=F;E++)w.push([b+(D-b)*E/F,A+(M-A)*E/F])},_=(b,A,D,M,F)=>{for(let E=1;E<=F;E++){const U=D+(M-D)*E/F;w.push([b+d*Math.cos(U),A+d*Math.sin(U)])}},L=Math.PI/2,S=u+r,p=l+n,m=u+r/2;w.push([m,l]),R(m,l,S-d,l,8),_(S-d,l+d,-L,0,6),R(S,l+d,S,p-d,10),_(S-d,p-d,0,L,6),R(S-d,p,u+d,p,14),_(u+d,p-d,L,Math.PI,6),R(u,p-d,u,l+d,10),_(u+d,l+d,Math.PI,Math.PI+L,6),R(u+d,l,m,l,8);let C=0;for(let b=1;b<w.length;b++)C+=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);const k=C*Math.min(1,o.prog);a.save(),a.setLineDash([10*o.dash*f,8*f]),a.lineDashOffset=-(r/2-d)-s*22*f,a.strokeStyle=h(.9),a.lineWidth=y*1.3,a.lineCap="round",a.shadowColor=h(.92),a.shadowBlur=i*1.3,a.beginPath(),a.moveTo(w[0][0],w[0][1]);let I=0;for(let b=1;b<w.length&&I<k;b++){const A=Math.hypot(w[b][0]-w[b-1][0],w[b][1]-w[b-1][1]);if(I+A<=k)a.lineTo(w[b][0],w[b][1]),I+=A;else{const D=(k-I)/A;a.lineTo(w[b-1][0]+(w[b][0]-w[b-1][0])*D,w[b-1][1]+(w[b][1]-w[b-1][1])*D),I=k}}a.stroke(),a.setLineDash([]),a.restore()}o.feet>.05&&e.foot&&(e.foot(a,!1,x-16*o.feet*f,x+6*f,26*o.feet*f),e.foot(a,!0,x+16*o.feet*f,x+6*f,26*o.feet*f)),a.shadowBlur=0}function Wa(a,t,o,c,s,e,i,h){const f=13*c.halo,x=4*e.arrow.w*(t/220),d=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const u=t/220,l=i||[[45*u,130*u],[110*u,60*u],[175*u,110*u]],r=h??s*.5%1,n=Math.min(1,r*1.25)*(l.length-1),v=Math.min(l.length-1,Math.floor(n+.35));a.shadowColor=d(.7),a.shadowBlur=f;const P=p=>{const m=Math.max(0,Math.min(l.length-2,Math.floor(p))),C=p-m;return[l[m][0]+(l[m+1][0]-l[m][0])*C,l[m][1]+(l[m+1][1]-l[m][1])*C]},y=o.comet!=null?o.comet:1,w=o.tailLen!=null?o.tailLen:.5;if(a.save(),a.shadowBlur=0,a.globalAlpha=o.rail!=null?o.rail:.22,a.strokeStyle=d(.6),a.lineWidth=2.2*u,a.lineCap="round",a.setLineDash([.01,8*u]),a.beginPath(),l.forEach(([p,m],C)=>C?a.lineTo(p,m):a.moveTo(p,m)),a.stroke(),a.setLineDash([]),a.restore(),n>.02){const p=(m,C)=>d(m).replace("rgb(","rgba(").replace(")",`,${C.toFixed(3)})`);for(let m=0;m<26;m++){const C=m/25,k=n-w*C;if(k<=0)break;const I=P(k),b=4.7*u*y*(1-C*.75),A=b*2.1,D=(1-C)*(1-C)*.8,M=a.createRadialGradient(I[0],I[1],0,I[0],I[1],A);M.addColorStop(0,p(.55-.18*C,D)),M.addColorStop(.5,p(.5-.18*C,D*.35)),M.addColorStop(1,p(.45-.18*C,0)),a.save(),a.shadowBlur=0,a.globalAlpha=1,a.fillStyle=M,a.beginPath(),a.arc(I[0],I[1],A,0,Math.PI*2),a.fill(),a.restore()}if(n<l.length-1-.001&&n-Math.floor(n)>.03){const m=P(n);a.save(),a.fillStyle=d(.62),a.shadowColor=d(.8),a.shadowBlur=11*u*y,a.beginPath(),a.arc(m[0],m[1],5.6*u*y,0,Math.PI*2),a.fill(),a.fillStyle=d(.95),a.globalAlpha=.95,a.beginPath(),a.arc(m[0],m[1],2.1*u*y,0,Math.PI*2),a.fill(),a.restore()}}a.globalAlpha=1,a.lineCap="butt";const R=o.done!=null,_=o.done||0,L=o.vd||[],S=o.acc!=null?o.acc:l.length-1;if(l.forEach(([p,m],C)=>{const k=C<_,I=L[C]||null,b=!k&&C===v&&!R,A=b?1+Math.sin(s*6)*.14:1,D=o.pop!=null&&C===_-1&&o.pop<.3?1+.35*(1-o.pop/.3):1,M=12*o.node*A*D*u*(C===S?1.34:1);k&&I!=="miss"&&(a.shadowBlur=f*1.4,a.shadowColor=d(.5),a.fillStyle=d(I==="near"?.5:.36),a.beginPath(),a.arc(p,m,M*.88,0,Math.PI*2),a.fill()),k||(a.save(),a.translate(p,m),d0(a,d,M,b?.8:.5,b?.9:.5,x*.9,f),a.restore()),a.strokeStyle=I==="hit"?W.prism:I==="near"?W.sand:I==="miss"?X.lo:d(k?.62:b?.8:.45),a.lineWidth=x*(b?1.3:I?1.15:.9),a.shadowBlur=b?f*1.6:I&&I!=="miss"?f*1.3:f*.6,I&&I!=="miss"&&(a.shadowColor=I==="hit"?W.prism:W.sand),a.beginPath(),a.arc(p,m,M,0,Math.PI*2),a.stroke(),e.num&&(k&&I!=="miss"?(a.save(),a.globalCompositeOperation="destination-out",a.shadowBlur=0,e.num(a,String(C+1),p,m,16*o.numS*A*u,Math.round(14*o.numS*u)),a.restore()):(a.globalAlpha=C<=v?1:.6,e.num(a,String(C+1),p,m,16*o.numS*A*u,Math.round(14*o.numS*u)),a.globalAlpha=1))}),o.pop!=null&&o.pop<.38&&_>0&&l[_-1]){const[p,m]=l[_-1],C=1-o.pop/.38,k=C*C,I=12*o.node*u*(_-1===(o.acc!=null?o.acc:l.length-1)?1.34:1);a.save();const b=I*(1.6+1.9*(1-C)),A=a.createRadialGradient(p,m,0,p,m,b);A.addColorStop(0,`rgba(255,255,255,${Math.min(1,1.2*k).toFixed(3)})`),A.addColorStop(.35,d(.92).replace("rgb(","rgba(").replace(")",`,${(.8*k).toFixed(3)})`)),A.addColorStop(1,d(.7).replace("rgb(","rgba(").replace(")",",0)")),a.fillStyle=A,a.beginPath(),a.arc(p,m,b,0,Math.PI*2),a.fill(),a.strokeStyle=d(.92),a.globalAlpha=k,a.lineWidth=Math.max(1,6*u*C),a.shadowColor=d(.85),a.shadowBlur=24*u*k,a.beginPath(),a.arc(p,m,I*(1.1+3.4*(1-C)),0,Math.PI*2),a.stroke();const D=Math.max(0,C-.35)/.65;D>0&&(a.globalAlpha=D*D*.6,a.lineWidth=Math.max(1,3.5*u*D),a.beginPath(),a.arc(p,m,I*(1.1+2*(1-D)),0,Math.PI*2),a.stroke()),a.restore()}a.shadowBlur=0}function d0(a,t,o,c,s,e,i,h=1){if(o<=.6)return;const f=(r,n)=>t(r).replace("rgb(","rgba(").replace(")",`,${n})`),x=e*2.6*h,d=Math.max(.1,o-x),u=o+x,l=a.createRadialGradient(0,0,d,0,0,u);l.addColorStop(0,f(c-.05,0)),l.addColorStop(.5,f(c,s*.85)),l.addColorStop(1,f(c-.05,0)),a.globalAlpha=1,a.fillStyle=l,a.shadowBlur=0,a.beginPath(),a.arc(0,0,u,0,Math.PI*2),a.fill(),a.globalAlpha=Math.min(1,s*1.1),a.lineWidth=e*.85,a.strokeStyle=t(Math.min(.98,c+.12)),a.shadowColor=t(.88),a.shadowBlur=i*.6,a.beginPath(),a.arc(0,0,o,0,Math.PI*2),a.stroke(),a.shadowBlur=0}function qa(a,t,o,c,s,e,i){const h=e.lut,f=13*c.halo,x=t/220,d=t/2,u=e.arrow&&e.arrow.w||1,l=(S,p)=>h(S).replace("rgb(","rgba(").replace(")",`,${p})`);a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const r=(o.r!=null?o.r:.42)*t,n=r*(o.rt!=null?o.rt:.36),v=3.4*u*x,P=i!=null?Math.max(0,Math.min(1,i)):s*(o.tempo||.6)%1,y=Math.pow(P,1.6),w=Math.max(0,(P-.9)/.1);a.save(),a.translate(d,d);const R=(S,p,m,C=1)=>d0(a,h,S,p,m,v,f,C),_=a.createRadialGradient(0,0,0,0,0,n*1.08);_.addColorStop(0,l(.6,.1+.18*w)),_.addColorStop(.65,l(.5,.05+.08*w)),_.addColorStop(1,l(.5,0)),a.globalAlpha=1,a.fillStyle=_,a.beginPath(),a.arc(0,0,n*1.08,0,Math.PI*2),a.fill();const L=1+.02*Math.sin(s*2.6);R(n*L,.55+.4*w,.5+.45*w,.9);for(let S=2;S>=0;S--){const p=Math.pow(Math.max(0,P-S*.05),1.6),m=r-(r-n)*p,C=S===0?.6+.4*y:.18/S*(1-w);R(m,.55+.4*y,C*(1-w*.45),1.15-.35*y)}w>.01&&R(n*(1+1.4*w),.9,(1-w)*.8,1.1),a.globalAlpha=.6+.3*w,a.shadowColor=h(.85),a.shadowBlur=f*(.9+w),a.fillStyle=h(.62+.3*w),a.beginPath(),a.arc(0,0,v*.85+3*x*w,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}function ga(a,t,o,c,s,e,i,h){const f=e.lut,x=13*c.halo,d=t/220,u=t/2,l=e.arrow&&e.arrow.w||1,r=l*d,n=(T,B)=>f(T).replace("rgb(","rgba(").replace(")",","+B+")");a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const v=t*.42*(o.spread!=null?o.spread:1),y=(h||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([T,B])=>[u+T*v,u+B*v]),w=80,R=[];for(let T=0;T<=w;T++){const B=T/w*(y.length-1),G=Math.min(y.length-2,Math.floor(B)),H=B-G,q=y[Math.max(0,G-1)],K=y[G],a0=y[G+1],t0=y[Math.min(y.length-1,G+2)],o0=(j,J,Y,e0)=>.5*(2*J+(-j+Y)*H+(2*j-5*J+4*Y-e0)*H*H+(-j+3*J-3*Y+e0)*H*H*H);R.push([o0(q[0],K[0],a0[0],t0[0]),o0(q[1],K[1],a0[1],t0[1])])}const _=T=>{const B=Math.max(0,Math.min(w,T*w)),G=Math.floor(B),H=B-G,q=R[G],K=R[Math.min(w,G+1)];return[q[0]+(K[0]-q[0])*H,q[1]+(K[1]-q[1])*H]},L=.68;let S,p,m;if(i!=null)S=Math.max(0,Math.min(1,i)),p=1,m=0;else{const T=s*(o.tempo||.42)%1;if(T<L)S=T/L,p=1,m=0;else{const B=(T-L)/(1-L);S=1,p=1-B*B,m=B}}if(p<=.012)return;const C=S*S*S*(S*(6*S-15)+10),k=Math.min(1,16*S*S*(1-S)*(1-S));o.taper!=null&&o.taper;const I=.36*(o.tail!=null?o.tail:1),b=o.width!=null?o.width:1;{const T=a.createLinearGradient(R[0][0],R[0][1],R[w][0],R[w][1]);T.addColorStop(0,n(.46,0)),T.addColorStop(.3,n(.46,.03*p)),T.addColorStop(.8,n(.46,.045*p)),T.addColorStop(1,n(.46,0)),a.globalAlpha=1,a.strokeStyle=T,a.lineWidth=9*r,a.shadowColor=f(.6),a.shadowBlur=x*2,a.beginPath(),R.forEach(([B,G],H)=>H?a.lineTo(B,G):a.moveTo(B,G)),a.stroke(),a.shadowBlur=0}const A=40,D=Math.max(0,C-I*(1-m)),M=[];for(let T=0;T<=A;T++)M.push(_(D+(C-D)*(T/A)));const F=()=>{a.beginPath(),M.forEach(([T,B],G)=>G?a.lineTo(T,B):a.moveTo(T,B)),a.stroke()},E=()=>{const T=a.createLinearGradient(M[0][0],M[0][1],M[A][0],M[A][1]);return T.addColorStop(0,n(.55,0)),T.addColorStop(.4,n(.56,0)),T.addColorStop(.68,n(.6,.09)),T.addColorStop(.88,n(.64,.24)),T.addColorStop(1,n(.68,.44)),T},U=1+.5*k;a.globalAlpha=p,a.strokeStyle=E(),a.lineWidth=(20+10*k)*r*b,a.shadowColor=f(.72),a.shadowBlur=x*2.2,F(),a.strokeStyle=E(),a.lineWidth=(10+5*k)*r*b,a.shadowBlur=x*1,F(),a.shadowBlur=0;for(let T=1;T<=A;T++){const B=T/A;a.globalAlpha=Math.pow(B,2.2)*.95*p,a.strokeStyle=f(.55+.38*B),a.lineWidth=(1.6+6.5*Math.pow(B,.7))*r*b*U,a.beginPath(),a.moveTo(M[T-1][0],M[T-1][1]),a.lineTo(M[T][0],M[T][1]),a.stroke()}const V=M[A][0],N=M[A][1];a.globalAlpha=.8*p,a.fillStyle=f(.6),a.shadowColor=f(.8),a.shadowBlur=x*1.6,a.beginPath(),a.arc(V,N,(9+5*k)*r*b,0,Math.PI*2),a.fill(),a.globalAlpha=p,a.fillStyle=f(.93),a.shadowBlur=x*.6,a.beginPath(),a.arc(V,N,(3.4+1.8*k)*r*b,0,Math.PI*2),a.fill(),a.globalAlpha=1,a.shadowBlur=0}function Ka(a,t,o,c,s,e,i){const h=o.r!=null?o.r:.3,f=o.dir!=null?o.dir:1,x=(o.sweep!=null?o.sweep:.66)*Math.PI*2,d=i??s*(o.tempo!=null?o.tempo:.5)%1,u=-Math.PI/2+f*d*Math.PI*2,l=16,r=[];for(let n=0;n<=l;n++){const v=u-f*(1-n/l)*x;r.push([.5+Math.cos(v)*h,.5+Math.sin(v)*h])}Ia(a,t,t,r,s,e,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}export{Ea as C,c0 as G,Sa as L,Da as M,Ga as P,ya as Q,Fa as R,Ta as S,La as Z,$ as a,xa as b,qa as c,_a as d,Ka as e,Ua as f,ga as g,Wa as h,ka as i,Aa as j,Ma as k,Ha as l,Ba as m,Oa as n,Z as o,va as p,Ia as q,Pa as r,i0 as s};
