const G={red:"#FA3030",coral:"#FE6E3C",sand:"#FEC389",prism:"#D1FEFF"},K={ink:"#FFFFFF",inkDark:"#0A0A0A",hi:"#ECECEC",lo:"#D0D0D0",paper:"#FAFAFA",surface:"#F2F2F2",t1:"#3B3B3B",t2:"#757575",t3:"#525252"},r0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)],C0=Object.fromEntries(Object.entries({...G,...K}).map(([a,t])=>[a,parseInt(t.slice(1),16)])),W=a=>`vec3(${r0(a).map(o=>(o/255).toFixed(4)).join(", ")})`,b0=(a,t=1)=>`rgba(${r0(a).join(",")},${t})`,d0=[[G.red,0],[G.red,.3],[G.coral,.56],[G.sand,.86],[G.prism,1]],u0=1;function f0(a){const t=String(a).toUpperCase();return/^#([0-9A-F])\1\1\1\1\1$/.test(t)||Object.values(K).some(o=>o.toUpperCase()===t)?!0:Object.values(G).some(o=>o.toUpperCase()===t)}function v0(a){return a&&((!Array.isArray(a.stops)||!a.stops.every(([o])=>f0(o)))&&(a.stops=d0.map(o=>[...o])),a.sat=u0,a)}function l0(a,t,o,i,n){let e=0;o[0]=0,i[0]=-1e20,i[1]=1e20;for(let r=1;r<n;r++){let u=(a[r]+r*r-(a[o[e]]+o[e]*o[e]))/(2*r-2*o[e]);for(;u<=i[e];)e--,u=(a[r]+r*r-(a[o[e]]+o[e]*o[e]))/(2*r-2*o[e]);e++,o[e]=r,i[e]=u,i[e+1]=1e20}e=0;for(let r=0;r<n;r++){for(;i[e+1]<r;)e++;t[r]=(r-o[e])*(r-o[e])+a[o[e]]}}function e0(a,t){const o=new Float32Array(t),i=new Int32Array(t),n=new Float32Array(t+1),e=new Float32Array(t);for(let r=0;r<t;r++){for(let u=0;u<t;u++)e[u]=a[u*t+r];l0(e,o,i,n,t);for(let u=0;u<t;u++)a[u*t+r]=o[u]}for(let r=0;r<t;r++){for(let u=0;u<t;u++)e[u]=a[r*t+u];l0(e,o,i,n,t);for(let u=0;u<t;u++)a[r*t+u]=o[u]}}function i0(a,t){const i=new Float32Array(t*t),n=new Float32Array(t*t);let e=0,r=0,u=0;for(let S=0;S<t*t;S++){const d=a[S*4+3]/255;i[S]=d>=1?0:d<=0?1e20:Math.pow(Math.max(0,.5-d),2),n[S]=d>=1?1e20:d<=0?0:Math.pow(Math.max(0,d-.5),2),d>.5&&(e+=S%t,r+=S/t|0,u++)}e0(i,t),e0(n,t);const h=new Float32Array(t*t);for(let S=0;S<t*t;S++)h[S]=(Math.sqrt(i[S])-Math.sqrt(n[S]))/t;return{data:h,N:t,cx:u?e/u/t:.5,cy:u?r/u/t:.5}}function z(a,t=512){const o="_raster"+t;if(a[o])return a[o];const i=document.createElement("canvas");i.width=i.height=t;const n=i.getContext("2d"),e=Math.min(t/a.naturalWidth,t/a.naturalHeight);n.drawImage(a,0,0,a.naturalWidth*e,a.naturalHeight*e);const r=n.getImageData(0,0,t,t).data;let u=t,h=t,S=-1,d=-1;for(let f=0;f<t;f++)for(let l=0;l<t;l++)r[(f*t+l)*4+3]>8&&(l<u&&(u=l),l>S&&(S=l),f<h&&(h=f),f>d&&(d=f));return a[o]=S<0?{canvas:i,x:0,y:0,w:t,h:t}:{canvas:i,x:u,y:h,w:S-u+1,h:d-h+1},a[o]}function I0(a,t,o=!1){const i=z(a,t),n=document.createElement("canvas");n.width=n.height=t;const e=n.getContext("2d"),r=Math.min(t*j/i.w,t*j/i.h),u=i.w*r,h=i.h*r;return o&&(e.translate(0,t),e.scale(1,-1)),e.drawImage(i.canvas,i.x,i.y,i.w,i.h,(t-u)/2,(t-h)/2,u,h),i0(e.getImageData(0,0,t,t).data,t)}function A0(a,t,o,i=!1){const n=z(a,o),e=t?z(t,o):null,r=Math.min(o*j/n.w,o*j/n.h),u=n.w*r,h=n.h*r,S=(o-u)/2,d=(o-h)/2,f=v=>{const y=document.createElement("canvas");y.width=y.height=o;const T=y.getContext("2d");return i&&(T.translate(0,o),T.scale(1,-1)),T.drawImage(v.canvas,n.x,n.y,n.w,n.h,S,d,u,h),i0(T.getImageData(0,0,o,o).data,o)},l=f(n),c=e?f(e):null,s=new Float32Array(o*o*2);for(let v=0;v<o*o;v++)s[v*2]=l.data[v],s[v*2+1]=c?c.data[v]:1;return{data:s,N:o,cx:l.cx,cy:l.cy,inCx:c?c.cx:l.cx,inCy:c?c.cy:l.cy,hasInner:!!c}}const T0=1.9922,h0=.78,j=.52,M0=h0/j,R0=1.18,p0={size:.85,gx:-.025,gy:.195,rot:6,shadow:"glow",shadowK:.75,blend:"add"};function y0(a,t,o,i,n=p0){const e=Math.round(o*.75),r=n.shadow==="none"?0:n.shadowK??.75,u=h=>i(a,String(t),o/2,o/2,e,h);return n.shadow==="drop"&&r>.001?(a.save(),a.globalAlpha=Math.min(1,r*.7),a.translate(o*.018,o*.024),u({color:"rgba(120,18,18,.95)",glow:0,glowColor:"rgba(0,0,0,0)"}),a.restore(),u({glow:0,glowColor:"rgba(0,0,0,0)"})):u(n.shadow==="glow"?{glow:26*r,glowColor:"rgba(255,140,90,.85)"}:{glow:0,glowColor:"rgba(0,0,0,0)"}),n.blend==="knock"}function L0(a,t){const o=a.getImageData(0,0,t,t),i=a.createImageData(t,t);for(let n=0;n<t*t;n++){const e=o.data[n*4+3]/255,r=Math.round(255*(1-e));i.data[n*4]=i.data[n*4+1]=i.data[n*4+2]=r,i.data[n*4+3]=255}a.putImageData(i,0,0)}const k0={RATIO:140/600,opacity(a){return a===0?.5:a===2||a===4?0:1},anchor(a,t,o){return{x:((t?1-a.x:a.x)-.5)*o,y:(.5-a.y)*o,s:a.s||1}}},Q=a=>(a/=255,a<=.04045?a/12.92:Math.pow((a+.055)/1.055,2.4)),Z=a=>(a=Math.max(0,Math.min(1,a)),Math.round(255*(a<=.0031308?12.92*a:1.055*Math.pow(a,1/2.4)-.055)));function n0(a,t,o){a=Q(a),t=Q(t),o=Q(o);const i=Math.cbrt(.4122214708*a+.5363325363*t+.0514459929*o),n=Math.cbrt(.2119034982*a+.6806995451*t+.1073969566*o),e=Math.cbrt(.0883024619*a+.2817188376*t+.6299787005*o);return[.2104542553*i+.793617785*n-.0040720468*e,1.9779984951*i-2.428592205*n+.4505937099*e,.0259040371*i+.7827717662*n-.808675766*e]}function m0(a,t,o){const i=(a+.3963377774*t+.2158037573*o)**3,n=(a-.1055613458*t-.0638541728*o)**3,e=(a-.0894841775*t-1.291485548*o)**3;return[Z(4.0767416621*i-3.3077115913*n+.2309699292*e),Z(-1.2684380046*i+2.6097574011*n-.3413193965*e),Z(-.0041960863*i-.7034186147*n+1.707614701*e)]}const s0=a=>[parseInt(a.slice(1,3),16),parseInt(a.slice(3,5),16),parseInt(a.slice(5,7),16)];function P0(a,t=1,o=new Uint8Array(256*4)){const i=[...a].sort((n,e)=>n[1]-e[1]);for(let n=0;n<256;n++){const e=n/255;let r=0;for(;r<i.length-2&&e>i[r+1][1];)r++;const[u,h]=i[r],[S,d]=i[r+1],f=Math.max(0,Math.min(1,(e-h)/Math.max(1e-5,d-h))),l=n0(...s0(u)),c=n0(...s0(S)),s=m0(l[0]+(c[0]-l[0])*f,(l[1]+(c[1]-l[1])*f)*t,(l[2]+(c[2]-l[2])*f)*t);o.set([...s,255],n*4)}return o}const _0=`
...
vec4 markState(vec2 uv, float state, float prog, float strong, float t){
  ...
  return A;
}`;function w0(a,t,o,i){a.lineWidth=4*t;const n=i.arrow;n.line==="dash"?a.setLineDash([12*t*n.gap,10*n.gap]):n.line==="dot"?(a.setLineDash([.5,12*n.gap]),a.lineCap="round",a.lineWidth=5*t):a.setLineDash([]),o!=null&&n.line!=="solid"&&n.line!=="taper"&&(a.lineDashOffset=-o*40*n.speed)}function E0(a,t,o,i,n,e={}){const r=n.lut,u=n.arrow||{},h=u.w??1,S=u.speed??1,d=u.glow??1,f=e.pulse??1,l=o/256,c=l*(e.scale??1),s=t/2,v=i*.9*S%1,y=e.prog!=null?Math.max(0,Math.min(1,e.prog)):Math.min(1,v/.55),T=e.prog!=null?1:v>.88?(1-v)/.12:1;a.clearRect(0,0,t,o);const m=T*(.45+.55*f),M=o-24*l,k=58*l,R=M+(k-M)*y,x=(P,D)=>r(P).replace("rgb(","rgba(").replace(")",`,${D.toFixed(3)})`),p=1.1*c*h,w=13*c*h,C=42*c*(.7+.3*h),L=!e.noTip&&y>.28?Math.min(1,(y-.28)/.22)*C*.42:0,I=R+L,b=a.createLinearGradient(0,M,0,I);if(b.addColorStop(0,x(.55,0)),b.addColorStop(.18,x(.64,.3*m)),b.addColorStop(.4,x(.76,.8*m)),b.addColorStop(.65,x(.88,.98*m)),b.addColorStop(1,x(.97,m)),a.save(),a.filter=`blur(${7*c}px)`,a.globalAlpha=.55,a.fillStyle=b,a.beginPath(),a.moveTo(s-p,M),a.lineTo(s+p,M),a.lineTo(s+w*.95,I),a.lineTo(s-w*.95,I),a.closePath(),a.fill(),a.restore(),a.globalAlpha=1,a.fillStyle=b,a.beginPath(),a.moveTo(s-p/2,M),a.lineTo(s+p/2,M),a.lineTo(s+w/2,I),a.lineTo(s-w/2,I),a.closePath(),a.fill(),a.globalAlpha=m,y>.28&&!e.noTip){const P=C,D=Math.min(1,(y-.28)/.22)*m,_=R+P*.3;a.globalAlpha=D;const B={color:r(.95),glowColor:r(.85),glow:12*d};n.glyph&&(n.glyph(a,"LIFT_TIP",s,_,P,B)||n.glyph(a,"TIP_TRI",s,_,P*.93,B))||(a.strokeStyle=r(.95),a.lineWidth=13*c*h,a.lineCap="round",a.lineJoin="round",a.shadowColor=r(.9),a.shadowBlur=18*c*d,a.beginPath(),a.moveTo(s-26*c,_+14*c),a.lineTo(s,_-16*c),a.lineTo(s+26*c,_+14*c),a.stroke())}a.globalAlpha=1,a.shadowBlur=0}function x0(a,t,o,i,n,e,r={}){const u=e.lut,h=e.arrow||{},S=h.w??1,d=h.glow??1,f=o/256*(r.scale??1);a.clearRect(0,0,t,o);const l=i.map(([x,p])=>[x*t,p*o]);if(l.length<2)return;const c=48,s=[],v=x=>{if(l.length===2)return[l[0][0]+(l[1][0]-l[0][0])*x,l[0][1]+(l[1][1]-l[0][1])*x];const p=x*(l.length-1),w=Math.min(l.length-2,Math.floor(p)),C=p-w,L=l[Math.max(0,w-1)],I=l[w],b=l[w+1],P=l[Math.min(l.length-1,w+2)],D=(_,B,E,H)=>.5*(2*B+(-_+E)*C+(2*_-5*B+4*E-H)*C*C+(-_+3*B-3*E+H)*C*C*C);return[D(L[0],I[0],b[0],P[0]),D(L[1],I[1],b[1],P[1])]};for(let x=0;x<=c;x++)s.push(v(x/c));const y=Math.max(0,Math.min(1,r.prog!=null?r.prog:n*.55%1)),T=Math.max(1,Math.round(c*y)),m=r.alpha??1,M=r.tail??.22;a.lineCap="round";const k=42*f*(.7+.3*S);let R=T;if(y>.28){let x=0;const p=k*.42*Math.min(1,(y-.28)/.22);for(;R>1&&x<p;)x+=Math.hypot(s[R][0]-s[R-1][0],s[R][1]-s[R-1][1]),R--}for(const x of[0,1])for(let p=1;p<=R;p++){const w=p/T,C=Math.min(1,w/M),L=C*C*(3-2*C)*m;a.globalAlpha=x?L:L*.16*w,a.strokeStyle=u(.55+.42*w),a.lineWidth=(1.1+11.9*w)*f*S*(x?1:1.9),a.beginPath(),a.moveTo(s[p-1][0],s[p-1][1]),a.lineTo(s[p][0],s[p][1]),a.stroke()}if(y>.28){const x=s[Math.max(0,T-2)][0],p=s[Math.max(0,T-2)][1],w=Math.atan2(s[T][1]-p,s[T][0]-x)+Math.PI/2,C=s[T][0]-Math.sin(w)*k*.3,L=s[T][1]+Math.cos(w)*k*.3;a.save(),a.translate(C,L),a.rotate(w),a.globalAlpha=Math.min(1,(y-.28)/.22)*m;const I={color:u(.95),glowColor:u(.85),glow:12*d};e.glyph&&(e.glyph(a,"LIFT_TIP",0,0,k,I)||e.glyph(a,"TIP_TRI",0,0,k*.93,I))||(a.strokeStyle=u(.95),a.lineWidth=9*f*S,a.lineJoin="round",a.lineCap="round",a.beginPath(),a.moveTo(-18*f,12*f),a.lineTo(0,-14*f),a.lineTo(18*f,12*f),a.stroke()),a.restore()}a.globalAlpha=1}function S0(a,t,o,i,n,e){n=n||{};const r=e.lut,u=n.style||e.arrow.line,h=!!n.closed,S=[0];for(let c=1;c<t.length;c++)S.push(S[c-1]+Math.hypot(t[c][0]-t[c-1][0],t[c][1]-t[c-1][1]));const d=S[S.length-1]||1,f=c=>{c=(c%d+d)%d;let s=1;for(;s<S.length-1&&S[s]<c;)s++;const v=(c-S[s-1])/Math.max(1e-4,S[s]-S[s-1]);return[t[s-1][0]+(t[s][0]-t[s-1][0])*v,t[s-1][1]+(t[s][1]-t[s-1][1])*v,Math.atan2(t[s][1]-t[s-1][1],t[s][0]-t[s-1][0])]},l=e.arrow;if(u==="chevron"){const c=(26*i+8)*l.gap,s=Math.max(2,Math.floor(d/c));a.shadowColor=r(Math.min(1,l.heat+.2)),a.shadowBlur=8*i*l.glow;for(let v=0;v<s;v++){const y=v*c+o*42*l.speed%c;if(!h&&y>d-4)continue;const[T,m,M]=f(y),k=7.5*i,R=8.5*i,x=.45+.4*Math.sin(y/d*6.283-o*2.2*l.speed);a.strokeStyle=r(l.heat-.05+x*.3),a.lineWidth=3.2*i,a.lineJoin="round",a.lineCap="round",a.save(),a.translate(T,m),a.rotate(M),a.beginPath(),a.moveTo(-R*.5,-k),a.lineTo(R*.5,0),a.lineTo(-R*.5,k),a.stroke(),a.restore()}return!0}if(u==="comet"){const c=o*.35*l.speed%1*d,s=d*l.tail,v=Math.max(24,t.length*2);a.lineCap="round";for(let m=0;m<v;m++){const M=c-m/v*s,k=c-(m+1)/v*s;if(!h&&k<0)break;const R=1-m/v,[x,p]=f(M),[w,C]=f(k);!h&&Math.hypot(w-x,C-p)>d*.4||(a.globalAlpha=Math.pow(R,1.6),a.strokeStyle=r(Math.max(.05,l.heat-.2)+R*.55),a.lineWidth=(1.5+R*4.5)*i,R>.72?(a.shadowColor=r(Math.min(1,l.heat+.3)),a.shadowBlur=R*12*i*l.glow):a.shadowBlur=0,a.beginPath(),a.moveTo(x,p),a.lineTo(w,C),a.stroke())}a.globalAlpha=1,a.lineCap="butt",a.shadowBlur=0;const[y,T]=f(c);return a.fillStyle=rgba(K.ink,.95),a.shadowColor=r(.9),a.shadowBlur=16*i,a.beginPath(),a.arc(y,T,2.6*i,0,7),a.fill(),a.shadowBlur=0,!0}if(a.strokeStyle=n.color||r(l.heat),a.shadowColor=r(Math.min(1,l.heat+.15)),a.shadowBlur=(n.glow??8)*i*l.glow,u==="taper")for(let c=1;c<t.length;c++)a.lineWidth=(.5+c/t.length*4.5)*i,a.beginPath(),a.moveTo(t[c-1][0],t[c-1][1]),a.lineTo(t[c][0],t[c][1]),a.stroke();else w0(a,i,o,e),a.beginPath(),t.forEach(([c,s],v)=>v?a.lineTo(c,s):a.moveTo(c,s)),h&&a.closePath(),a.stroke();return a.setLineDash([]),a.lineCap="butt",a.lineDashOffset=0,a.shadowBlur=0,!0}function G0(a,t,o,i,n,e){const r=13*i.halo,u=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const h=t/220,S=t/2,d=18*o.round*h,f=40*h,l=48*h,c=t-80*h,s=t-96*h,v=[],y=(m,M,k,R)=>{for(let x=0;x<=1;x+=.12)v.push([m+(k-m)*x,M+(R-M)*x])};y(f+d,l,f+c-d,l),y(f+c,l+d,f+c,l+s-d),y(f+c-d,l+s,f+d,l+s),y(f,l+s-d,f,l+d),a.shadowColor=u(.6),a.shadowBlur=r*.8;const T=4*e.arrow.w*h;if(e.arrow.line==="solid"?(a.setLineDash([10*o.dash*h,8*h]),a.lineDashOffset=-n*22*h,a.strokeStyle=u(.45),a.lineWidth=T,a.beginPath(),a.roundRect(f,l,c,s,d),a.stroke(),a.setLineDash([]),a.lineDashOffset=0):S0(a,v,n,e.arrow.w*h,{color:u(.45),closed:!0},e),o.prog!=null&&o.prog>.001){const m=[],M=(b,P,D,_,B)=>{for(let E=1;E<=B;E++)m.push([b+(D-b)*E/B,P+(_-P)*E/B])},k=(b,P,D,_,B)=>{for(let E=1;E<=B;E++){const H=D+(_-D)*E/B;m.push([b+d*Math.cos(H),P+d*Math.sin(H)])}},R=Math.PI/2,x=f+c,p=l+s,w=f+c/2;m.push([w,l]),M(w,l,x-d,l,8),k(x-d,l+d,-R,0,6),M(x,l+d,x,p-d,10),k(x-d,p-d,0,R,6),M(x-d,p,f+d,p,14),k(f+d,p-d,R,Math.PI,6),M(f,p-d,f,l+d,10),k(f+d,l+d,Math.PI,Math.PI+R,6),M(f+d,l,w,l,8);let C=0;for(let b=1;b<m.length;b++)C+=Math.hypot(m[b][0]-m[b-1][0],m[b][1]-m[b-1][1]);const L=C*Math.min(1,o.prog);a.save(),a.setLineDash([10*o.dash*h,8*h]),a.lineDashOffset=-(c/2-d)-n*22*h,a.strokeStyle=u(.9),a.lineWidth=T*1.3,a.lineCap="round",a.shadowColor=u(.92),a.shadowBlur=r*1.3,a.beginPath(),a.moveTo(m[0][0],m[0][1]);let I=0;for(let b=1;b<m.length&&I<L;b++){const P=Math.hypot(m[b][0]-m[b-1][0],m[b][1]-m[b-1][1]);if(I+P<=L)a.lineTo(m[b][0],m[b][1]),I+=P;else{const D=(L-I)/P;a.lineTo(m[b-1][0]+(m[b][0]-m[b-1][0])*D,m[b-1][1]+(m[b][1]-m[b-1][1])*D),I=L}}a.stroke(),a.setLineDash([]),a.restore()}o.feet>.05&&e.foot&&(e.foot(a,!1,S-16*o.feet*h,S+6*h,26*o.feet*h),e.foot(a,!0,S+16*o.feet*h,S+6*h,26*o.feet*h)),a.shadowBlur=0}function O0(a,t,o,i,n,e,r,u){const h=13*i.halo,S=4*e.arrow.w*(t/220),d=e.lut;a.clearRect(0,0,t,t),a.lineJoin="round";const f=t/220,l=r||[[45*f,130*f],[110*f,60*f],[175*f,110*f]],c=u??n*.5%1,s=Math.min(1,c*1.25)*(l.length-1),v=Math.min(l.length-1,Math.floor(s+.35));a.shadowColor=d(.7),a.shadowBlur=h;const y=p=>{const w=Math.max(0,Math.min(l.length-2,Math.floor(p))),C=p-w;return[l[w][0]+(l[w+1][0]-l[w][0])*C,l[w][1]+(l[w+1][1]-l[w][1])*C]},T=o.comet!=null?o.comet:1,m=o.tailLen!=null?o.tailLen:.5;if(a.save(),a.shadowBlur=0,a.globalAlpha=o.rail!=null?o.rail:.22,a.strokeStyle=d(.6),a.lineWidth=2.2*f,a.lineCap="round",a.setLineDash([.01,8*f]),a.beginPath(),l.forEach(([p,w],C)=>C?a.lineTo(p,w):a.moveTo(p,w)),a.stroke(),a.setLineDash([]),a.restore(),s>.02){const p=(w,C)=>d(w).replace("rgb(","rgba(").replace(")",`,${C.toFixed(3)})`);for(let w=0;w<26;w++){const C=w/25,L=s-m*C;if(L<=0)break;const I=y(L),b=4.7*f*T*(1-C*.75),P=b*2.1,D=(1-C)*(1-C)*.8,_=a.createRadialGradient(I[0],I[1],0,I[0],I[1],P);_.addColorStop(0,p(.55-.18*C,D)),_.addColorStop(.5,p(.5-.18*C,D*.35)),_.addColorStop(1,p(.45-.18*C,0)),a.save(),a.shadowBlur=0,a.globalAlpha=1,a.fillStyle=_,a.beginPath(),a.arc(I[0],I[1],P,0,Math.PI*2),a.fill(),a.restore()}if(s<l.length-1-.001&&s-Math.floor(s)>.03){const w=y(s);a.save(),a.fillStyle=d(.62),a.shadowColor=d(.8),a.shadowBlur=11*f*T,a.beginPath(),a.arc(w[0],w[1],5.6*f*T,0,Math.PI*2),a.fill(),a.fillStyle=d(.95),a.globalAlpha=.95,a.beginPath(),a.arc(w[0],w[1],2.1*f*T,0,Math.PI*2),a.fill(),a.restore()}}a.globalAlpha=1,a.lineCap="butt";const M=o.done!=null,k=o.done||0,R=o.vd||[],x=o.acc!=null?o.acc:l.length-1;if(l.forEach(([p,w],C)=>{const L=C<k,I=R[C]||null,b=!L&&C===v&&!M,P=b?1+Math.sin(n*6)*.14:1,D=12*o.node*P*f*(C===x?1.34:1);L&&I!=="miss"&&(a.shadowBlur=h*1.4,a.shadowColor=d(.5),a.fillStyle=d(I==="near"?.5:.36),a.beginPath(),a.arc(p,w,D*.88,0,Math.PI*2),a.fill()),L||(a.save(),a.translate(p,w),c0(a,d,D,b?.8:.5,b?.9:.5,S*.9,h),a.restore()),a.strokeStyle=I==="hit"?G.prism:I==="near"?G.sand:I==="miss"?K.lo:d(L?.62:b?.8:.45),a.lineWidth=S*(b?1.3:I?1.15:.9),a.shadowBlur=b?h*1.6:I&&I!=="miss"?h*1.3:h*.6,I&&I!=="miss"&&(a.shadowColor=I==="hit"?G.prism:G.sand),a.beginPath(),a.arc(p,w,D,0,Math.PI*2),a.stroke(),e.num&&(L&&I!=="miss"?(a.save(),a.globalCompositeOperation="destination-out",a.shadowBlur=0,e.num(a,String(C+1),p,w,16*o.numS*P*f,Math.round(14*o.numS*f)),a.restore()):(a.globalAlpha=C<=v?1:.6,e.num(a,String(C+1),p,w,16*o.numS*P*f,Math.round(14*o.numS*f)),a.globalAlpha=1))}),o.pop!=null&&o.pop<.32&&k>0&&l[k-1]){const[p,w]=l[k-1],C=1-o.pop/.32,L=C*C,I=12*o.node*f*(k-1===(o.acc!=null?o.acc:l.length-1)?1.34:1);a.save();const b=a.createRadialGradient(p,w,0,p,w,I*(1.4+1.2*(1-C)));b.addColorStop(0,`rgba(255,255,255,${(.95*L).toFixed(3)})`),b.addColorStop(.4,d(.9).replace("rgb(","rgba(").replace(")",`,${(.6*L).toFixed(3)})`)),b.addColorStop(1,d(.7).replace("rgb(","rgba(").replace(")",",0)")),a.fillStyle=b,a.beginPath(),a.arc(p,w,I*(1.4+1.2*(1-C)),0,Math.PI*2),a.fill(),a.strokeStyle=d(.92),a.globalAlpha=L,a.lineWidth=Math.max(1,5*f*C),a.shadowColor=d(.85),a.shadowBlur=18*f*L,a.beginPath(),a.arc(p,w,I*(1.1+2.6*(1-C)),0,Math.PI*2),a.stroke(),a.restore()}a.shadowBlur=0}function c0(a,t,o,i,n,e,r,u=1){if(o<=.6)return;const h=(c,s)=>t(c).replace("rgb(","rgba(").replace(")",`,${s})`),S=e*2.6*u,d=Math.max(.1,o-S),f=o+S,l=a.createRadialGradient(0,0,d,0,0,f);l.addColorStop(0,h(i-.05,0)),l.addColorStop(.5,h(i,n*.85)),l.addColorStop(1,h(i-.05,0)),a.globalAlpha=1,a.fillStyle=l,a.shadowBlur=0,a.beginPath(),a.arc(0,0,f,0,Math.PI*2),a.fill(),a.globalAlpha=Math.min(1,n*1.1),a.lineWidth=e*.85,a.strokeStyle=t(Math.min(.98,i+.12)),a.shadowColor=t(.88),a.shadowBlur=r*.6,a.beginPath(),a.arc(0,0,o,0,Math.PI*2),a.stroke(),a.shadowBlur=0}function U0(a,t,o,i,n,e,r){const u=e.lut,h=13*i.halo,S=t/220,d=t/2,f=e.arrow&&e.arrow.w||1,l=(x,p)=>u(x).replace("rgb(","rgba(").replace(")",`,${p})`);a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const c=(o.r!=null?o.r:.42)*t,s=c*(o.rt!=null?o.rt:.36),v=3.4*f*S,y=r!=null?Math.max(0,Math.min(1,r)):n*(o.tempo||.6)%1,T=Math.pow(y,1.6),m=Math.max(0,(y-.9)/.1);a.save(),a.translate(d,d);const M=(x,p,w,C=1)=>c0(a,u,x,p,w,v,h,C),k=a.createRadialGradient(0,0,0,0,0,s*1.08);k.addColorStop(0,l(.6,.1+.18*m)),k.addColorStop(.65,l(.5,.05+.08*m)),k.addColorStop(1,l(.5,0)),a.globalAlpha=1,a.fillStyle=k,a.beginPath(),a.arc(0,0,s*1.08,0,Math.PI*2),a.fill();const R=1+.02*Math.sin(n*2.6);M(s*R,.55+.4*m,.5+.45*m,.9);for(let x=2;x>=0;x--){const p=Math.pow(Math.max(0,y-x*.05),1.6),w=c-(c-s)*p,C=x===0?.6+.4*T:.18/x*(1-m);M(w,.55+.4*T,C*(1-m*.45),1.15-.35*T)}m>.01&&M(s*(1+1.4*m),.9,(1-m)*.8,1.1),a.globalAlpha=.6+.3*m,a.shadowColor=u(.85),a.shadowBlur=h*(.9+m),a.fillStyle=u(.62+.3*m),a.beginPath(),a.arc(0,0,v*.85+3*S*m,0,Math.PI*2),a.fill(),a.restore(),a.globalAlpha=1,a.shadowBlur=0}function H0(a,t,o,i,n,e,r,u){const h=e.lut,S=13*i.halo,d=t/220,f=t/2,l=e.arrow&&e.arrow.w||1,c=l*d,s=(A,F)=>h(A).replace("rgb(","rgba(").replace(")",","+F+")");a.clearRect(0,0,t,t),a.lineJoin="round",a.lineCap="round";const v=t*.42*(o.spread!=null?o.spread:1),T=(u||[[-.95,.5],[-.48,-.42],[0,-.8],[.48,-.42],[.95,.5]]).map(([A,F])=>[f+A*v,f+F*v]),m=80,M=[];for(let A=0;A<=m;A++){const F=A/m*(T.length-1),O=Math.min(T.length-2,Math.floor(F)),U=F-O,q=T[Math.max(0,O-1)],$=T[O],N=T[O+1],a0=T[Math.min(T.length-1,O+2)],t0=(X,J,Y,o0)=>.5*(2*J+(-X+Y)*U+(2*X-5*J+4*Y-o0)*U*U+(-X+3*J-3*Y+o0)*U*U*U);M.push([t0(q[0],$[0],N[0],a0[0]),t0(q[1],$[1],N[1],a0[1])])}const k=A=>{const F=Math.max(0,Math.min(m,A*m)),O=Math.floor(F),U=F-O,q=M[O],$=M[Math.min(m,O+1)];return[q[0]+($[0]-q[0])*U,q[1]+($[1]-q[1])*U]},R=.68;let x,p,w;if(r!=null)x=Math.max(0,Math.min(1,r)),p=1,w=0;else{const A=n*(o.tempo||.42)%1;if(A<R)x=A/R,p=1,w=0;else{const F=(A-R)/(1-R);x=1,p=1-F*F,w=F}}if(p<=.012)return;const C=x*x*x*(x*(6*x-15)+10),L=Math.min(1,16*x*x*(1-x)*(1-x));o.taper!=null&&o.taper;const I=.36*(o.tail!=null?o.tail:1),b=o.width!=null?o.width:1;{const A=a.createLinearGradient(M[0][0],M[0][1],M[m][0],M[m][1]);A.addColorStop(0,s(.46,0)),A.addColorStop(.3,s(.46,.03*p)),A.addColorStop(.8,s(.46,.045*p)),A.addColorStop(1,s(.46,0)),a.globalAlpha=1,a.strokeStyle=A,a.lineWidth=9*c,a.shadowColor=h(.6),a.shadowBlur=S*2,a.beginPath(),M.forEach(([F,O],U)=>U?a.lineTo(F,O):a.moveTo(F,O)),a.stroke(),a.shadowBlur=0}const P=40,D=Math.max(0,C-I*(1-w)),_=[];for(let A=0;A<=P;A++)_.push(k(D+(C-D)*(A/P)));const B=()=>{a.beginPath(),_.forEach(([A,F],O)=>O?a.lineTo(A,F):a.moveTo(A,F)),a.stroke()},E=()=>{const A=a.createLinearGradient(_[0][0],_[0][1],_[P][0],_[P][1]);return A.addColorStop(0,s(.55,0)),A.addColorStop(.4,s(.56,0)),A.addColorStop(.68,s(.6,.09)),A.addColorStop(.88,s(.64,.24)),A.addColorStop(1,s(.68,.44)),A},H=1+.5*L;a.globalAlpha=p,a.strokeStyle=E(),a.lineWidth=(20+10*L)*c*b,a.shadowColor=h(.72),a.shadowBlur=S*2.2,B(),a.strokeStyle=E(),a.lineWidth=(10+5*L)*c*b,a.shadowBlur=S*1,B(),a.shadowBlur=0;for(let A=1;A<=P;A++){const F=A/P;a.globalAlpha=Math.pow(F,2.2)*.95*p,a.strokeStyle=h(.55+.38*F),a.lineWidth=(1.6+6.5*Math.pow(F,.7))*c*b*H,a.beginPath(),a.moveTo(_[A-1][0],_[A-1][1]),a.lineTo(_[A][0],_[A][1]),a.stroke()}const V=_[P][0],g=_[P][1];a.globalAlpha=.8*p,a.fillStyle=h(.6),a.shadowColor=h(.8),a.shadowBlur=S*1.6,a.beginPath(),a.arc(V,g,(9+5*L)*c*b,0,Math.PI*2),a.fill(),a.globalAlpha=p,a.fillStyle=h(.93),a.shadowBlur=S*.6,a.beginPath(),a.arc(V,g,(3.4+1.8*L)*c*b,0,Math.PI*2),a.fill(),a.globalAlpha=1,a.shadowBlur=0}function q0(a,t,o,i,n,e,r){const u=o.r!=null?o.r:.3,h=o.dir!=null?o.dir:1,S=(o.sweep!=null?o.sweep:.66)*Math.PI*2,d=r??n*(o.tempo!=null?o.tempo:.5)%1,f=-Math.PI/2+h*d*Math.PI*2,l=16,c=[];for(let s=0;s<=l;s++){const v=f-h*(1-s/l)*S;c.push([.5+Math.cos(v)*u,.5+Math.sin(v)*u])}x0(a,t,t,c,n,e,{prog:1,tail:o.tail!=null?o.tail:.68,scale:(o.scale!=null?o.scale:1)*(o.width!=null?o.width:1)})}export{D0 as C,p0 as G,k0 as M,K as N,G as P,M0 as Q,_0 as R,T0 as S,R0 as Z,j as a,h0 as b,U0 as c,y0 as d,q0 as e,E0 as f,H0 as g,O0 as h,L0 as i,A0 as j,I0 as k,G0 as l,P0 as m,B0 as n,z as o,S0 as p,C0 as q,x0 as r,i0 as s,b0 as t,v0 as u,F0 as v,d0 as w,u0 as x};
